...
const shareRewardPool = 0x3646de962ff41462cc244b2379e7289b9b751be1

const mss = 0xacabd3f9b8f76ffd2724604185fa5afa5df25ac6
...
uint256 stor4;
array of address mssToWbnbRoute;
array of address mssToLp0Route;
array of address mssToLp1Route;

function mssToWbnbRoute(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < mssToWbnbRoute.length
    return mssToWbnbRoute[arg1]
}

function mssToLp0Route(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < mssToLp0Route.length
    return mssToLp0Route[arg1]
}
...
function mssToLp1Route(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < mssToLp1Route.length
    return mssToLp1Route[arg1]
}
...
function balanceOfPool() payable {
    require ext_code.size(0x3646de962ff41462cc244b2379e7289b9b751be1)
    staticcall 0x3646de962ff41462cc244b2379e7289b9b751be1.userInfo(uint256 rg1, address rg2) with:
            gas gas_remaining wei
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(0x3646de962ff41462cc244b2379e7289b9b751be1)
        call 0x3646de962ff41462cc244b2379e7289b9b751be1.deposit(uint256 rg1, uint256 rg2) with:
             gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if ext_call.return_data[0] > arg1:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(0x3646de962ff41462cc244b2379e7289b9b751be1)
        call 0x3646de962ff41462cc244b2379e7289b9b751be1.withdraw(uint256 rg1, uint256 rg2) with:
             gas gas_remaining wei
