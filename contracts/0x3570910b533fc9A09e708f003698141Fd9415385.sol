...
function sub_0f4b4f01(?) {
    ...
    if Mask(1, 12, sub_e128a991[stor8[stor8[address(arg3)]]].field_0) != 4096:
        if 4096 == Mask(1, 12, sub_e128a991[stor8[stor8[arg1]]].field_0):
            if address_belongs[address_belongs[address(arg3)]]:
                return 1
            else:
                return 0
        if 8192 == Mask(1, 13, sub_e128a991[stor8[stor8[arg1]]].field_0):
            ...
            if sub_631aa829[1].field_256 != sub_631aa829[1].field_0 and sub_e128a991[stor8[address(arg3)]].field_0:
                return 0
            if not address_belongs[address(arg2)]:
                revert with 0, 'ERR_TRANSFER_CHECK_WHITELIST'
            if sub_7fa52a8b[1]:
            ...
            while idx < sub_64a522a5[1].field_0:
                ...
                require idx < sub_64a522a5[1].field_0
                if sub_64a522a5[1][idx].field_256 == sub_64a522a5[1][idx].field_0 and sub_e128a991[stor8[address(arg2)]].field_0:
                    require idx < sub_64a522a5[1].field_0
                    require idx < sub_64a522a5[1].field_0
    ...
    if Mask(1, 12, sub_e128a991[stor8[stor8[address(arg3)]]].field_0) != 4096:
        ...
        if 8192 == Mask(1, 13, sub_e128a991[stor8[stor8[arg1]]].field_0):
            ...
            while idx < sub_64a522a5[2].field_0:
                ...
                require idx < sub_64a522a5[2].field_0
                if sub_64a522a5[2][idx].field_256 == sub_64a522a5[2][idx].field_0 and sub_e128a991[stor8[address(arg2)]].field_0:
                    require idx < sub_64a522a5[2].field_0
                    require idx < sub_64a522a5[2].field_0
    ...
    if Mask(1, 12, sub_e128a991[stor8[stor8[address(arg3)]]].field_0) != 4096:
        ...
        if 8192 == Mask(1, 13, sub_e128a991[stor8[stor8[arg1]]].field_0):
            ...
            while idx < sub_64a522a5[0].field_0:
                ...
                require idx < sub_64a522a5[0].field_0
                if sub_64a522a5[0][idx].field_256 == sub_64a522a5[0][idx].field_0 and sub_e128a991[stor8[address(arg2)]].field_0:
                    require idx < sub_64a522a5[0].field_0
                    require idx < sub_64a522a5[0].field_0
