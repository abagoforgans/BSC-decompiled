...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(0xe02df9e3e622debdd69fb838bb799e3f168902):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address rg1, uint256 rg2), 0x20ec291bb8459b6145317e71, 0, ext_call.return_data[0 len 28]
            mem[488 len 0] = 0
            call 0x00e02df9e3e622debdd69fb838bb799e3f168902.0xece5056f with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(0xe02df9e3e622debdd69fb838bb799e3f168902):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), 0x20ec291bb8459b6145317e71, 0, ext_call.return_data[0 len 28]
