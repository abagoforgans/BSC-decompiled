    ...
    if not return_data.size:
        ...
        if arg2 * sharesTotal * entranceFeeFactor / arg2 * sharesTotal != entranceFeeFactor:
            revert with 0, 
                        ...
                        0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[ceil32(return_data.size) + 394 len 31]
    ('eq', ('div', ('mul', ('param', 'arg2'), ('stor', ('name', 'sharesTotal', 9)), ('stor', ('name', 'entranceFeeFactor', 13))), ('mul', ('param', 'arg2'), ('stor', ('name', 'sharesTotal', 9)))), ('stor', ('name', 'entranceFeeFactor', 13)))
    if ext_call.return_data[0] <= 0:
        revert with 0, 'SafeMath: division by zero'
    require ext_call.return_data[0]
    ...
    if ext_call.return_data[0] <= 0:
        ...
        if controllerFee <= 0:
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(earnedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), 0
                mem[388 len 0] = 0
                call earnedAddress with:
                   funct uint32(stor7.field_0)
                     gas gas_remaining wei
                    args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), 0) << 256, mem[388 len 4]
                if not return_data.size:
                ...
                if ext_code.size(earnedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), Mask(224, 32, ext_call.return_data[0] * controllerFee / 10000) >> 32
                mem[388 len 0] = 0
                call earnedAddress with:
                   funct uint32(stor7.field_0)
                     gas gas_remaining wei
