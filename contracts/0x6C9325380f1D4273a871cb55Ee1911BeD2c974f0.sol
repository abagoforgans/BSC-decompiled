...
function buy(uint256 arg1) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        sales[arg1].field_2048 = msg.sender or Mask(96, 160, sales[arg1].field_2048)
        ...
        if _tipsFeeRate * ext_call.return_data[0] / ext_call.return_data[0] != _tipsFeeRate:
            revert with 0, 'SafeMath: multiplication overflow'
        if not _baseRate:
            revert with 0, 'SafeMath: division by zero', 0
        if _tipsFeeRate * ext_call.return_data[0] / _baseRate > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow', 0
        if uint8(stor8.field_16):
            require ext_code.size(_dandyAddress)
            call _dandyAddress.0x40c10f19 with:
            ...
            if stor6[stor3[arg1].field_1792]:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        if not _tipsFeeRate * ext_call.return_data[0] / _baseRate:
            call sales[arg1].field_1800 with:
               value ext_call.return_data[0] - (_tipsFeeRate * ext_call.return_data[0] / _baseRate) wei
                 gas 2300 * is_zero(value) wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        else:
            call stor13 with:
               value _tipsFeeRate * ext_call.return_data[0] / _baseRate wei
                 gas 2300 * is_zero(value) wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            call sales[arg1].field_1800 with:
        ...
        sales[arg1].field_1536 = ext_call.return_data[0]
        sales[arg1].field_1792 = 1
        emit eveSales(sales[arg1].field_256, msg.sender, ext_call.return_data[0], _tipsFeeRate * ext_call.return_data[0] / _baseRate, arg1);
    stor0 = 1
}
