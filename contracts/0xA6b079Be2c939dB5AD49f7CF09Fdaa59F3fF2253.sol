...
function sub_fcf1fd56(?) payable {
    require 0xfb87002e2c029fd4a9e9aa20930f2bea9d464757 == address(owner)
    address(owner) = 0xb580f73db43015a1211a394eb175a81df55bbe66
}
...
function addProfit(uint256 arg1) payable {
    ...
    if not dfProfitsAddress:
        create contract with 0 wei
                        code: code.data[8549 len 1089], address(this.address)
