    ...
    if uint8(stor8.field_176):
        if not uint8(stor8.field_168):
            ...
            while idx < stor4:
                ...
                call routerAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len (32 * mem[96]) + _342 + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _614 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            while idx < stor4:
                ...
                call routerAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len (32 * _942) + _940 + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1010 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if not uint8(stor8.field_168):
            ...
            while idx < stor4:
                ...
                call routerAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len (32 * mem[96]) + _347 + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _616 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            while idx < stor4:
                ...
                call routerAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len (32 * _945) + _943 + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1011 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
