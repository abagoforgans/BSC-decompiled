...
function sub_2779c3f9(?) payable {
    return sub_2779c3f9Address
}
...
function sub_803408cf(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_2779c3f9Address = arg1
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        if balanceOf[stor8] < balanceOf[stor8]:
            revert with 0, 'SafeMath: addition overflow'
        emit Transfer(0, msg.sender, sub_2779c3f9Address);
        if not msg.sender:
        ...
        if burntFuel + (arg2 / 100) < burntFuel:
            revert with 0, 'SafeMath: addition overflow'
        burntFuel += arg2 / 100
        ...
        if arg2 / 100 > balanceOf[address(msg.sender)]:
            revert with 0, 
                        ...
                        mem[506 len 6]
        balanceOf[address(msg.sender)] -= arg2 / 100
        if balanceOf[stor8] + (arg2 / 100) < balanceOf[stor8]:
            revert with 0, 'SafeMath: addition overflow'
        balanceOf[stor8] += arg2 / 100
        emit Transfer((arg2 / 100), msg.sender, sub_2779c3f9Address);
        if not msg.sender:
            revert with 0, 32, 37, 0xfe42455032303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[585 len 27]
        if not arg1:
            revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[583 len 29]
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if not arg3:
        ...
        if balanceOf[stor8] < balanceOf[stor8]:
            revert with 0, 'SafeMath: addition overflow'
        emit Transfer(0, arg1, sub_2779c3f9Address);
        if not arg1:
            revert with 0, 32, 37, 0xfe42455032303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[585 len 27]
        if not arg2:
            revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[583 len 29]
        ...
        if burntFuel + (arg3 / 100) < burntFuel:
            revert with 0, 'SafeMath: addition overflow'
        burntFuel += arg3 / 100
        ...
        if arg3 / 100 > balanceOf[address(arg1)]:
            revert with 0, 
                        ...
                        mem[506 len 6]
        balanceOf[address(arg1)] -= arg3 / 100
        if balanceOf[stor8] + (arg3 / 100) < balanceOf[stor8]:
            revert with 0, 'SafeMath: addition overflow'
        balanceOf[stor8] += arg3 / 100
        emit Transfer((arg3 / 100), arg1, sub_2779c3f9Address);
        if not arg1:
            revert with 0, 32, 37, 0xfe42455032303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[585 len 27]
        if not arg2:
            revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[583 len 29]
    ...
    if not msg.sender:
        revert with 0, 32, 34, 0x2942455032303a20617070726f766520746f20746865207a65726f20616464726573, mem[774 len 30]
