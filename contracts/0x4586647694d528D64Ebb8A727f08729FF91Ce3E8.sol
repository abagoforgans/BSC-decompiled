...
#  - advance()
#
const name = 32, 33, 0x6c457175696c69627269756d20446f6c6c61722050726f746f636f6c205374616b, mem[161 len 31] / 0.00390625, 0
...
function couponRedemptionPenalty(uint256 arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if block.timestamp % 3600 > (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
        return 0
    if (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 500000000000000000 * 10^18 / 720 != -epoch + arg1 + 720:
        revert with 0, 'SafeMath: multiplication overflow'
    if not (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18:
        if not (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
            revert with 0, 'SafeMath: division by zero', 0
        if not 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
            if arg2:
                if 0 / arg2:
                    revert with 0, 'SafeMath: multiplication overflow'
                else:
                ...
                return 0
        if ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 != ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600):
            revert with 0, 'SafeMath: multiplication overflow'
        if not arg2:
            return 0
        if ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / arg2 != ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18:
            revert with 0, 'SafeMath: multiplication overflow'
        return (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)
    if 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 != 10^18:
        revert with 0, 'SafeMath: multiplication overflow'
    if not (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
        revert with 0, 'SafeMath: division by zero', 0
    if not 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
        if arg2:
            if 0 / arg2:
                revert with 0, 'SafeMath: multiplication overflow'
            else:
            ...
            return 0
    if ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 != ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600):
        revert with 0, 'SafeMath: multiplication overflow'
    if not arg2:
        return 0
    if ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / arg2 != ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18:
        revert with 0, 'SafeMath: multiplication overflow'
    return (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)
}
...
function unbondUnderlying(uint256 arg1) payable {
    ...
    if epoch + 30 < epoch:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(msg.sender)].field_1024 = epoch + 30
    if not arg1:
        if not totalBonded:
            revert with 0, 'SafeMath: division by zero', 0
        if arg1 + balanceOf[address(msg.sender)].field_0 < balanceOf[address(msg.sender)].field_0:
        ...
        totalStaged += arg1
        if arg1 > totalBonded:
            revert with 0, 32, 34, 0x65426f6e64696e673a20696e73756666696369656e7420746f74616c20626f6e6465, mem[226 len 30] >> 16, 0
        totalBonded -= arg1
    ...
    if not totalSupply:
        ...
        if not totalBonded:
            ...
            if not arg1:
                ...
                totalStaged += 0 / balanceOf[address(msg.sender)].field_256
                if 0 / balanceOf[address(msg.sender)].field_256 > totalBonded:
                    revert with 0, 32, 34, 0x65426f6e64696e673a20696e73756666696369656e7420746f74616c20626f6e6465, mem[290 len 30] >> 16, 0
                totalBonded -= 0 / balanceOf[address(msg.sender)].field_256
                if arg1 > balanceOf[address(msg.sender)].field_256:
                    revert with 0, 'Bonding: insufficient balance', 0
                balanceOf[address(msg.sender)].field_256 -= arg1
        ...
        if not (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18:
            ...
            if not 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
                ...
                if not arg2:
                    ...
                    call dollarAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(return_data.size) + 1376] = 42
                    mem[ceil32(return_data.size) + 1408 len 42] = 0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18) > totalRedeemable:
                        revert with 0, 
                                    32,
                                    42,
                                    0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63, mem[ceil32(return_data.size) + 1450 len 22] >> 80,
                                    0
                    totalRedeemable = totalRedeemable - arg2 + (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)
                    if totalStaged + totalBonded < totalBonded:
                        revert with 0, 'SafeMath: addition overflow'
                    if totalRedeemable < 0:
                        revert with 0, 'SafeMath: addition overflow'
                    ...
                    require ext_call.return_data[0] == ext_call.return_data[0]
                    if ext_call.return_data[0] >= totalRedeemable + totalStaged + totalBonded:
                        if ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18:
                            emit CouponBurn((((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18), msg.sender, arg1);
                        emit CouponRedemption((arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)), msg.sender, arg1);
        else:
            if 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 != 10^18:
                revert with 0, 'SafeMath: multiplication overflow'
            if not (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
            ...
            if not 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
                ...
                if not arg2:
                    ...
                    call dollarAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(return_data.size) + 1376] = 42
                    mem[ceil32(return_data.size) + 1408 len 42] = 0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18) > totalRedeemable:
                        revert with 0, 
                                    32,
                                    42,
                                    0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63, mem[ceil32(return_data.size) + 1450 len 22] >> 80,
                                    0
                    totalRedeemable = totalRedeemable - arg2 + (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)
                    if totalStaged + totalBonded < totalBonded:
                        revert with 0, 'SafeMath: addition overflow'
                    if totalRedeemable < 0:
                        revert with 0, 'SafeMath: addition overflow'
                    ...
                    if ext_call.return_data[0] >= totalRedeemable + totalStaged + totalBonded:
                        if ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18:
                            emit CouponBurn((((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18), msg.sender, arg1);
                        emit CouponRedemption((arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (-694444444444444444444444444444444 * epoch) + (0x223d1f04f089caf80d719c71c71c * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18)), msg.sender, arg1);
    ...
    if not periodFor[address(arg1)].field_0:
        ...
        if epoch <= periodFor[address(arg1)].field_256 + periodFor[address(arg1)].field_0 - 1:
            ...
            if not periodFor[address(arg1)].field_768 + periodFor[address(arg1)].field_512:
                ...
                if 43 * 10^16 == 0 / couponsExpiration[stor14[address(arg1)].field_256 + stor14[address(arg1)].field_0 - 1].field_0:
                    ...
                    if 0 / couponsExpiration[stor14[address(arg1)].field_256 + stor14[address(arg1)].field_0 - 1].field_0 <= 43 * 10^16:
                        mem[384] = 0x476f7665726e0000000000000000000000000000000000000000000000000000
                        mem[352] = 32
                        mem[64] = 416
                        idx = 32
                ...
                if 43 * 10^16 == (10^18 * periodFor[address(arg1)].field_768) + (10^18 * periodFor[address(arg1)].field_512) / couponsExpiration[stor14[address(arg1)].field_256 + stor14[address(arg1)].field_0 - 1].field_0:
                    mem[384] = 0x476f7665726e0000000000000000000000000000000000000000000000000000
                    mem[352] = 32
                    mem[64] = 416
                    idx = 32
                    ...
                    if (10^18 * periodFor[address(arg1)].field_768) + (10^18 * periodFor[address(arg1)].field_512) / couponsExpiration[stor14[address(arg1)].field_256 + stor14[address(arg1)].field_0 - 1].field_0 <= 43 * 10^16:
                        mem[384] = 0x476f7665726e0000000000000000000000000000000000000000000000000000
                        mem[352] = 32
                        mem[64] = 416
                        idx = 32
...
function redeemCoupons(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp % 3600 > (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
        ...
        mem[640] = 500000000000000000 * 10^18 / 720
        mem[736] = 0
        if (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 500000000000000000 * 10^18 / 720 != -epoch + arg1 + 720:
            revert with 0, 'SafeMath: multiplication overflow'
        mem[800] = 26
        mem[832] = 'SafeMath: division by zero'
        mem[768] = (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18
        mem[864] = 0
        mem[896] = ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600)
        mem[928] = (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720
        mem[960] = 0
        if not (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18:
            mem[1024] = 26
            ...
            if not (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
                revert with 0, 'SafeMath: division by zero', 0
            mem[992] = 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720
            mem[1088] = 0
            if not 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
                mem[1152] = 26
                ...
                mem[1152] = 26
                mem[1184] = 'SafeMath: division by zero'
                mem[1120] = ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18
                mem[1216] = arg2
                mem[1248] = 0
                if not arg2:
                    mem[1312] = 26
                    ...
                    mem[1312] = 26
                    mem[1344] = 'SafeMath: division by zero'
                    mem[1280] = ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18) < arg3:
                        mem[1408] = 0x4d61726b65740000000000000000000000000000000000000000000000000000
                        mem[1376] = 32
                        mem[64] = 1440
                        idx = 32
            ...
            if not (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
                revert with 0, 'SafeMath: division by zero', 0
            mem[992] = 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720
            mem[1088] = 0
            if not 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720:
                mem[1152] = 26
                mem[1184] = 'SafeMath: division by zero'
                ...
                mem[1152] = 26
                mem[1184] = 'SafeMath: division by zero'
                mem[1120] = ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18
                mem[1216] = arg2
                mem[1248] = 0
                if not arg2:
                    mem[1312] = 26
                    ...
                    mem[1312] = 26
                    mem[1344] = 'SafeMath: division by zero'
                    mem[1280] = ((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) - (block.timestamp % 3600 * 10^18 * (720 * 500000000000000000 * 10^18 / 720) - (epoch * 500000000000000000 * 10^18 / 720) + (arg1 * 500000000000000000 * 10^18 / 720) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (720 * 24 * 3600) / 720) / 10^18 * arg2 / 10^18) < arg3:
                        mem[1408] = 0x4d61726b65740000000000000000000000000000000000000000000000000000
                        mem[1376] = 32
                        mem[64] = 1440
                        idx = 32
    ...
    if balanceOf[address(msg.sender)].field_1280 > epoch:
        ...
        if periodFor[address(arg1)].field_0:
            ...
            if not balanceOf[address(msg.sender)].field_256:
                ...
                periodFor[address(arg1)].field_256 = 20
                emit Proposal(20, arg1, msg.sender, epoch);
                mem[0] = arg1
                mem[32] = 14
                if periodFor[address(arg1)].field_256 + periodFor[address(arg1)].field_0 < periodFor[address(arg1)].field_0:
                    revert with 0, 'SafeMath: addition overflow'
