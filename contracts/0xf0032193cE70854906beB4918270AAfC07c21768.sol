...
function purchaseNFT(uint256 arg1, uint256 arg2) {
    ...
    if not cardBasePrice[arg1].field_1536:
        ...
        staticcall cardBasePrice[arg1].field_1280.0x70a08231 with:
                gas gas_remaining wei
               args msg.sender
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] + eth.balance(msg.sender) < cardBasePrice[arg1].field_1792:
        ...
        if not cardBasePrice[arg1].field_1536:
            ...
            if ext_call.return_data[0] < 0:
                revert with 0, 'Do not have enough funds'
            require ext_code.size(cardBasePrice[arg1].field_1280)
            staticcall cardBasePrice[arg1].field_1280.0xdd62ed3e with:
                    gas gas_remaining wei
                   args msg.sender, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            require ext_code.size(cardBasePrice[arg1].field_1280)
            call cardBasePrice[arg1].field_1280.0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(stor2.field_0), 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            call cardBasePrice[arg1].field_1280.0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(stor2.field_0), arg2 * cardBasePrice[arg1].field_1536
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
    ...
    require ext_code.size(cardBasePrice[arg1].field_256)
    call cardBasePrice[arg1].field_256.0xf242432a with:
         gas gas_remaining wei
