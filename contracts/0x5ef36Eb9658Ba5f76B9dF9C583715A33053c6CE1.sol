...
function sub_7462bb3d(?) payable {
    ...
    if not arg1.length:
        ...
        if not arg1.length:
            ...
            while idx < arg1.length:
                ...
                call address(_247).borrowBalanceStored(address rg1) with:
                     gas gas_remaining wei
                    args address(arg2)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
        ...
        while idx < arg1.length:
            ...
            call address(_253).borrowBalanceStored(address rg1) with:
                 gas gas_remaining wei
                args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            call address(_259).borrowBalanceStored(address rg1) with:
                 gas gas_remaining wei
                args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    while idx < arg1.length:
        ...
        call address(_265).borrowBalanceStored(address rg1) with:
             gas gas_remaining wei
            args address(arg2)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
