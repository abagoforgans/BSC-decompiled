...
function initialize(address arg1) payable {
    ...
    stor15[address(arg1)] = 0x123456789abcdf0123456789abcdf0123456789abcd55af8d4bb539d000000 * 3600
...
function rebase(uint256 arg1, uint256 arg2) payable {
    ...
    if not arg1:
        ...
        if not totalSupply - (stor15[stor10] / stor14):
            ...
            if not totalSupply:
                revert with 0, 'SafeMath: division by zero'
            stor14 = 0x123456789abcdf0123456789abcdf0123456789abcd55af8d4bb539d000000 * 3600 / totalSupply
            if not arg1:
                if not totalSupply - (stor15[stor10] / stor14):
                    revert with 0, 'SafeMath: division by zero'
                if not stor14:
