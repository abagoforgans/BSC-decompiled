...
#
const name = 'ScoobyDooInu', 0

const totalSupply = 10^15

const decimals = 9

const symbol = 'SCOOBY', 0
...
function setMaxTxPercent(uint256 arg1, uint256 arg2) {
    ...
    if not arg2:
        revert with 'NH{q', 18
    _maxTxAmount = 10^15 * arg1 / arg2
}

function getCirculatingSupply() {
    if balanceOf[57005] > 10^15:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if 10^15 < balanceOf[57005]:
        revert with 'NH{q', 17
    if balanceOf[0] > -balanceOf[57005] + 10^15:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if -balanceOf[57005] + 10^15 < balanceOf[0]:
        revert with 'NH{q', 17
    return (-balanceOf[57005] + -balanceOf[0] + 10^15)
}

function sub_33d39074(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not balanceOf[stor30]:
        ...
        if -balanceOf[57005] + -balanceOf[0] + 10^15 <= 0:
            revert with 0, 'SafeMath: division by zero', 0
        if not -balanceOf[57005] + -balanceOf[0] + 10^15:
            revert with 'NH{q', 18
        return (0 / -balanceOf[57005] + -balanceOf[0] + 10^15)
    ...
    if not -balanceOf[57005] + -balanceOf[0] + 10^15:
        revert with 'NH{q', 18
    return (arg1 * 2 * balanceOf[stor30] / -balanceOf[57005] + -balanceOf[0] + 10^15)
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not balanceOf[stor30]:
        ...
        if not -balanceOf[57005] + -balanceOf[0] + 10^15:
            revert with 'NH{q', 18
        return (0 / -balanceOf[57005] + -balanceOf[0] + 10^15 > arg1)
    if balanceOf[stor30] and 2 > -1 / balanceOf[stor30]:
        revert with 'NH{q', 17
    if not balanceOf[stor30]:
        revert with 'NH{q', 18
    ...
    if not -balanceOf[57005] + -balanceOf[0] + 10^15:
        revert with 'NH{q', 18
    return (arg2 * 2 * balanceOf[stor30] / -balanceOf[57005] + -balanceOf[0] + 10^15 > arg1)
}
...
function airDrop(address arg1, address[] arg2, uint256[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        mem[64] = mem[64] + 64
        mem[_19] = 20
        mem[_19 + 32] = 'Insufficient Balance'
        mem[32] = 2
