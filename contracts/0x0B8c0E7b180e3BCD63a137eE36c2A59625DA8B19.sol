...
#  - advance()
#
const name = 'Test Dollar ABC Stake', 0

const decimals = 18

const epochTime = (block.timestamp - 1610353800 / 300)
...
function couponRedemptionPenalty(uint256 arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if block.timestamp % 300 > (-300 * epoch) + (300 * arg1) + 900 / 3:
        return 0
    if (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 500000000000000000 * 10^18 / 3 != -epoch + arg1 + 3:
        revert with 0, 'SafeMath: multiplication overflow'
    if not (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18:
        if not (-300 * epoch) + (300 * arg1) + 900 / 3:
            revert with 0, 'SafeMath: division by zero', 0
        if not 0 / (-300 * epoch) + (300 * arg1) + 900 / 3:
            if arg2:
                if 0 / arg2:
                    revert with 0, 'SafeMath: multiplication overflow'
                else:
                ...
                return 0
        if ((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 0 / (-300 * epoch) + (300 * arg1) + 900 / 3 != ((-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300):
            revert with 0, 'SafeMath: multiplication overflow'
        if not arg2:
            return 0
        if ((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / arg2 != ((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18:
            revert with 0, 'SafeMath: multiplication overflow'
        return (((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18)
    if 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 != 10^18:
        revert with 0, 'SafeMath: multiplication overflow'
    if not (-300 * epoch) + (300 * arg1) + 900 / 3:
        revert with 0, 'SafeMath: division by zero', 0
    if not 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3:
        if arg2:
            if 0 / arg2:
                revert with 0, 'SafeMath: multiplication overflow'
            else:
            ...
            return 0
    if ((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3 != ((-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300):
        revert with 0, 'SafeMath: multiplication overflow'
    if not arg2:
        return 0
    if ((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / arg2 != ((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18:
        revert with 0, 'SafeMath: multiplication overflow'
    return (((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (-166666666666666666666666666666666666 * epoch) + (0x20194d14a1812e488c9a82aaaaaaaa * arg1) + 0x604be73de4838ad9a5cf87fffffffe / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (-166666666666666666666666666666666666 * epoch) + (0x20194d14a1812e488c9a82aaaaaaaa * arg1) + 0x604be73de4838ad9a5cf87fffffffe / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18)
}
...
function unbondUnderlying(uint256 arg1) payable {
    ...
    if epoch + 1 < epoch:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(msg.sender)].field_1024 = epoch + 1
    if not arg1:
        if not totalBonded:
            revert with 0, 'SafeMath: division by zero', 0
        if arg1 + balanceOf[address(msg.sender)].field_0 < balanceOf[address(msg.sender)].field_0:
        ...
        if not (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18:
            ...
            if not 0 / (-300 * epoch) + (300 * arg1) + 900 / 3:
                ...
                if not arg2:
                    ...
                    call dollarAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, arg2 - (((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(return_data.size) + 1376] = 42
                    mem[ceil32(return_data.size) + 1408 len 42] = 0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63
                    if arg2 - (((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18) > totalRedeemable:
                        revert with 0, 
                                    32,
                                    42,
                                    0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63, mem[ceil32(return_data.size) + 1450 len 22] >> 80,
                                    0
                    totalRedeemable = totalRedeemable - arg2 + (((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18)
                    if totalStaged + totalBonded < totalBonded:
                        revert with 0, 'SafeMath: addition overflow'
                    if totalRedeemable < 0:
                        revert with 0, 'SafeMath: addition overflow'
                    ...
                    require ext_call.return_data[0] == ext_call.return_data[0]
                    if ext_call.return_data[0] >= totalRedeemable + totalStaged + totalBonded:
                        if ((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18:
                            emit CouponBurn((((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18), msg.sender, arg1);
                        emit CouponRedemption((arg2 - (((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18)), msg.sender, arg1);
        else:
            if 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 != 10^18:
                revert with 0, 'SafeMath: multiplication overflow'
            if not (-300 * epoch) + (300 * arg1) + 900 / 3:
            ...
            if not 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3:
                ...
                if not arg2:
                    ...
                    call dollarAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, arg2 - (((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (-166666666666666666666666666666666666 * epoch) + (0x20194d14a1812e488c9a82aaaaaaaa * arg1) + 0x604be73de4838ad9a5cf87fffffffe / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (-166666666666666666666666666666666666 * epoch) + (0x20194d14a1812e488c9a82aaaaaaaa * arg1) + 0x604be73de4838ad9a5cf87fffffffe / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(return_data.size) + 1376] = 42
                    mem[ceil32(return_data.size) + 1408 len 42] = 0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63
                    if arg2 - (((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18) > totalRedeemable:
                        revert with 0, 
                                    32,
                                    42,
                                    0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63, mem[ceil32(return_data.size) + 1450 len 22] >> 80,
                                    0
                    totalRedeemable = totalRedeemable - arg2 + (((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18)
                    if totalStaged + totalBonded < totalBonded:
                        revert with 0, 'SafeMath: addition overflow'
                    if totalRedeemable < 0:
                        revert with 0, 'SafeMath: addition overflow'
                    ...
                    if ext_call.return_data[0] >= totalRedeemable + totalStaged + totalBonded:
                        if ((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18:
                            emit CouponBurn((((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (-166666666666666666666666666666666666 * epoch) + (0x20194d14a1812e488c9a82aaaaaaaa * arg1) + 0x604be73de4838ad9a5cf87fffffffe / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (-166666666666666666666666666666666666 * epoch) + (0x20194d14a1812e488c9a82aaaaaaaa * arg1) + 0x604be73de4838ad9a5cf87fffffffe / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18), msg.sender, arg1);
...
function initialize() payable {
    ...
    if periodFor[address(stor3608)].field_1280:
        ...
        if epoch <= 2:
            ...
            if totalDebt + 100 * 10^18 < totalDebt:
                revert with 0, 'SafeMath: addition overflow'
            totalDebt += 100 * 10^18
...
function emergencyCommit(address arg1) payable {
    ...
    if not periodFor[address(arg1)].field_0:
        ...
        if 1610353800 > block.timestamp:
            revert with 0, 'SafeMath: subtraction overflow', 0
        mem[448] = 26
        mem[480] = 'SafeMath: division by zero'
        if block.timestamp - 1610353800 / 300 < block.timestamp - 1610353800 / 300:
            revert with 0, 'SafeMath: addition overflow'
        if block.timestamp - 1610353800 / 300 <= epoch + 6:
...
function redeemCoupons(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp % 300 > (-300 * epoch) + (300 * arg1) + 900 / 3:
        ...
        mem[640] = 500000000000000000 * 10^18 / 3
        mem[736] = 0
        if (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 500000000000000000 * 10^18 / 3 != -epoch + arg1 + 3:
            revert with 0, 'SafeMath: multiplication overflow'
        mem[800] = 26
        mem[832] = 'SafeMath: division by zero'
        mem[768] = (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18
        mem[864] = 0
        mem[896] = ((-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300)
        mem[928] = (-300 * epoch) + (300 * arg1) + 900 / 3
        mem[960] = 0
        if not (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18:
            mem[1024] = 26
            ...
            if not (-300 * epoch) + (300 * arg1) + 900 / 3:
                revert with 0, 'SafeMath: division by zero', 0
            mem[992] = 0 / (-300 * epoch) + (300 * arg1) + 900 / 3
            mem[1088] = 0
            if not 0 / (-300 * epoch) + (300 * arg1) + 900 / 3:
                mem[1152] = 26
                ...
                mem[1152] = 26
                mem[1184] = 'SafeMath: division by zero'
                mem[1120] = ((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18
                mem[1216] = arg2
                mem[1248] = 0
                if not arg2:
                    mem[1312] = 26
                    ...
                    mem[1312] = 26
                    mem[1344] = 'SafeMath: division by zero'
                    mem[1280] = ((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18
                    if arg2 - (((-300 * epoch) + (300 * arg1) + 900 / 3 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 0 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18) < arg3:
                        mem[1408] = 0x4d61726b65740000000000000000000000000000000000000000000000000000
                        mem[1376] = 32
                        mem[64] = 1440
                        idx = 32
            ...
            if not (-300 * epoch) + (300 * arg1) + 900 / 3:
                revert with 0, 'SafeMath: division by zero', 0
            mem[992] = 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3
            mem[1088] = 0
            if not 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3:
                mem[1152] = 26
                mem[1184] = 'SafeMath: division by zero'
                ...
                if not arg2:
                    ...
                    mem[1344] = 'SafeMath: division by zero'
                    mem[1280] = ((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18
                    if arg2 - (((-300 * epoch) + (300 * arg1) + 900 / 3 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) - (block.timestamp % 300 * 10^18 * (3 * 500000000000000000 * 10^18 / 3) - (epoch * 500000000000000000 * 10^18 / 3) + (arg1 * 500000000000000000 * 10^18 / 3) / 10^18 / (-300 * epoch) + (300 * arg1) + 900 / 3) / 10^18 * arg2 / 10^18) < arg3:
                        mem[1408] = 0x4d61726b65740000000000000000000000000000000000000000000000000000
                        mem[1376] = 32
                        mem[64] = 1440
                        idx = 32
