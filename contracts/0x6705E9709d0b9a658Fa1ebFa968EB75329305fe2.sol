...
function sub_529d8719(?) payable {
    ...
    if 9975 * _70 / 10000 and 9975 > -1 / 9975 * _70 / 10000:
        revert with 'NH{q', 17
    if 9975 * 9975 * _70 / 10000 / 10000 and mem[_73] > -1 / 9975 * 9975 * _70 / 10000 / 10000:
        revert with 'NH{q', 17
    _75 = mem[64]
    mem[mem[64]] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
    mem[mem[64] + 4] = 9975 * 9975 * _70 / 10000 / 10000 * _74 / 10^18
    mem[mem[64] + 36] = 64
    ...
    staticcall 0x10ed43c718714eb63d5aa57b78b54704e256024e.mem[mem[64] len 4] with:
            gas gas_remaining wei
           args mem[mem[64] + 4 len _75 + (32 * stor3.length) + -mem[64] + 96]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _99 = mem[64]
    ...
    if 1 >= _101:
        revert with 'NH{q', 50
    _126 = mem[_99 + ceil32(return_data.size) + 64]
    ...
    return _126, _74, 9975 * _70 / 10000, 9975 * 9975 * _70 / 10000 / 10000 * _74 / 10^18, _130
}
