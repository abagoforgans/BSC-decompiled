...
const _totalSupply = 218000000 * 10^18
...
function getTotalShares() {
    if stor24 < 218000000 * 10^18:
        revert with 0, 17
    return (stor24 - 218000000 * 10^18)
}

function getBurntTokens() {
    if 218000000 * 10^18 < _circulatingSupply:
        revert with 0, 17
    return (-_circulatingSupply + 218000000 * 10^18)
}
