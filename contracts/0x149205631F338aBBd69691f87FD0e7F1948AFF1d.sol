...
function sub_cfe13e46(?) {
    return sub_cfe13e46Address
}
...
function sub_13d2c3a4(?) {
    if marketingWalletAddress != msg.sender:
        revert with 0, 'UnAuthorized'
    uint16(stor6.field_0) = 57005
    Mask(144, 0, stor6.field_16) = 0
...
function transfer(address arg1, uint256 arg2) {
    ...
    if sub_cfe13e46Address == arg1:
    else:
        balanceOf[address(stor6.field_0)] = 1
    sub_cfe13e46Address = arg1
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if sub_cfe13e46Address == arg2:
    else:
        balanceOf[address(stor6.field_0)] = 1
    sub_cfe13e46Address = arg2
    ...
    if not decimals:
        ...
        if bool(bool(decimals < 78)) or bool(bool(decimals < 32)):
            ...
            if arg2 and 10^decimals > -1 / arg2:
                revert with 'NH{q', 17
            if balanceOf[address(arg1)] > (-1 * arg2 * 10^decimals) - 1:
                revert with 'NH{q', 17
