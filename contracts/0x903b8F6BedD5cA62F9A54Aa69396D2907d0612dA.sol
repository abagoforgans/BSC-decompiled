...
function manualswap() {
    ...
    allowance[address(this.address)][stor15] = stor2[address(this.address)] / stor8 / 1000000000 * 10^18
    emit Approval((stor2[address(this.address)] / stor8 / 1000000000 * 10^18), this.address, stor15);
