...
function sub_a05641e6(?) {
    ...
    if not eth.balance(this.address):
        ...
        if ext_call.return_data[0]:
            ...
            ('iszero', ('div', ('mul', ('stor', ('name', 'sub_c30cf4f4', 19)), ('balance', 'address')), ('ext_call.return_data', 0, 32)))
    revert
}
...
function sub_25496ac3(?) {
    ...
    if not totalSupply:
        ...
        ('iszero', ('mul', -1, ('stor', ('name', 'sub_9e4a8c9c', 17))))
    else:
        ...
        ('iszero', ('add', ('mul', ('stor', ('name', 'sub_c607ca5a', 8)), ('stor', ('name', 'totalSupply', 27))), ('mul', -1, ('stor', ('name', 'sub_9e4a8c9c', 17)))))
    revert
}
...
function updateValues(string arg1, uint256 arg2) {
    ...
    if stor0 == msg.sender:
        ...
        if sha3(mem[(4 * arg1.length) + ceil32(arg1.length) + 677 len arg1.length]) != sha3(Mask(88, 0, mem[(3 * arg1.length) + ceil32(arg1.length) + 634 len 11], 0)):
            ...
            emit 0xcf69a8cd: Array(len=arg1.length, data=mem[(4 * arg1.length) + ceil32(arg1.length) + 773 len arg1.length]), arg2
            return 1
    else:
        require msg.sender
        if not stor1[address(msg.sender)]:
        ...
        if sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[(5 * arg1.length) + ceil32(arg1.length) + floor32(arg1.length) + 677 len arg1.length % 32]) != sha3(Mask(88, 0, mem[(4 * arg1.length) + ceil32(arg1.length) + 634 len 11], 0)):
            # nil
        else:
            sub_cb9385ce = arg2
