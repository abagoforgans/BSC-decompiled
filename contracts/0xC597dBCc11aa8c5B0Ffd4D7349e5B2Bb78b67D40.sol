...
function transfer(address arg1, uint256 arg2) {
    ...
    if stor8:
        ...
        if stor7 >= stor13[address(arg1)]:
            ...
            if stor13[address(msg.sender)] > stor7:
                stor8 = 1
                mem[128] = this.address
                staticcall routerAddress.WETH() with:
                        gas gas_remaining wei
    ...
    if unknown_0x70a08231(?????) <= uint32(call.func_hash) >> 224:
        ...
        if stor8:
            if not stor13[address(msg.sender)]:
                ...
                if address(arg1) == uniswapV2PairAddress:
                    if stor13[address(msg.sender)]:
                        stor14[stor12[stor7]] = stor7
                        stor12[stor7] = address(arg1)
                        if not sub_32e35d19:
        ...
        if stor8:
            if not stor13[address(arg1)]:
                ...
                if address(arg2) == uniswapV2PairAddress:
                    if stor13[address(arg1)]:
                        stor14[stor12[stor7]] = stor7
                        stor12[stor7] = address(arg2)
                        if not sub_32e35d19:
