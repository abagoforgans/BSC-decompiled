...
function setOwnerAddress(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function sub_529f4f7d(?) {
    ...
    while idx < sub_17b8e1cf.length:
        ...
        if sub_17b8e1cf[idx].field_256:
            mem[0] = sha3(8) + (2 * idx) + 1
            mem[_16 + 32] = stor[sha3(('name', 'sub_17b8e1cf', 8) + (2 * idx) + 1)].field_0
            t = _16 + 32
            u = sha3(mem[0])
...
function sub_086d7308(?) {
    ...
    if not ('cd', 36).length:
        ...
        while sub_17b8e1cf[sub_17b8e1cf.length].field_256 > idx:
            stor[idx + sha3((2 * sub_17b8e1cf.length) + ('name', 'sub_17b8e1cf', 8) + 1)].field_0 = 0
            idx = idx + 1
            continue 
    else:
        s = 0
        ...
        while (32 * ('cd', 36).length) + 128 > idx:
            stor[s + sha3((2 * sub_17b8e1cf.length) + ('name', 'sub_17b8e1cf', 8) + 1)].field_0 = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
