...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if pairAddress != arg1:
        ...
        emit Transfer(100, msg.sender, arg1);
    else:
        if not arg2:
            if 0 > arg2:
                revert with 0, 'SafeMath: subtraction overflow'
            if pairAddress != msg.sender:
                if balanceOf[this.address] < swapThreshold:
                    if pairAddress != msg.sender:
                        if stor19 + stor18 <= block.number:
                            if eth.balance(this.address) >= stor17:
                                mem[548 len 0] = None
            ...
            emit Transfer((arg2 - (buybackFee * arg2 / 100)), msg.sender, arg1);
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if -1 == allowance[address(arg1)][msg.sender]:
        ...
        if pairAddress != arg2:
            if balanceOf[address(arg2)] + 100 < balanceOf[address(arg2)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(arg2)] += 100
            emit Transfer(100, arg1, arg2);
        else:
            if not arg3:
                if 0 > arg3:
                    revert with 0, 'SafeMath: subtraction overflow'
                ...
                emit Transfer((arg3 - (buybackFee * arg3 / 100)), arg1, arg2);
    else:
