...
function sub_84a0dcbf(?) payable {
    ...
    mem[128 len 4] = 2201135459
    mem[floor32(arg3.length) + 292 len floor32(floor32(arg3.length) + 164)] = 2201135459, arg2, Array(len=arg5, data=mem[260 len floor32(floor32(arg3.length) + 164) - 132]), address(arg4)
    mem[floor32(arg3.length) + floor32(floor32(arg3.length) + 164) + -(floor32(arg3.length) + 164 % 32) + 324 len floor32(arg3.length) + 164 % 32] = mem[(2 * floor32(floor32(arg3.length) + 164)) + -(floor32(arg3.length) + 164 % 32) + -floor32(arg3.length) - 36 len floor32(arg3.length) + 164 % 32]
    ...
    if not return_data.size:
        ...
        require 2201135459, Mask(224, 32, arg2) >> 32 <= 4294967296
        require 2201135459, Mask(224, 32, arg2) >> 32 + 160 <= floor32(arg3.length) + 292
        require mem[2201135459, Mask(224, 32, arg2) >> 32 + 128] <= 4294967296 and 2201135459, Mask(224, 32, arg2) >> 32 + (32 * mem[2201135459, Mask(224, 32, arg2) >> 32 + 128]) + 160 <= floor32(arg3.length) + 292
        mem[floor32(arg3.length) + 292] = mem[2201135459, Mask(224, 32, arg2) >> 32 + 128]
        _46 = mem[2201135459, Mask(224, 32, arg2) >> 32 + 128]
        mem[floor32(arg3.length) + 324 len floor32(mem[2201135459, Mask(224, 32, arg2) >> 32 + 128])] = mem[2201135459, Mask(224, 32, arg2) >> 32 + 160 len floor32(mem[2201135459, Mask(224, 32, arg2) >> 32 + 128])]
...
function swapTokensForExactTokens(address arg1, uint256 arg2, uint256 arg3, address[] arg4, address arg5, uint256 arg6) {
    ...
    mem[floor32(arg4.length) + floor32(floor32(arg4.length) + 196) + -(floor32(arg4.length) + 196 % 32) + 356 len floor32(arg4.length) + 196 % 32] = mem[(2 * floor32(floor32(arg4.length) + 196)) + -(floor32(arg4.length) + 196 % 32) + -floor32(arg4.length) - 68 len floor32(arg4.length) + 196 % 32]
    ...
    if not return_data.size:
        ...
        mem[64] = floor32(arg4.length) + ceil32(return_data.size) + 325
