...
function sub_23550b91(?) {
    ...
    mem[388 len 0] = None
    require ext_code.size(stor4)
    call stor4.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args 0, 0, 160, stor7, -1, 2, mem[388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function sub_e9e1831a(?) {
    ...
    require return_data.size >= 32
    require ext_code.size(stor4)
    call stor4.addLiquidity(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint256 rg8) with:
         gas gas_remaining wei
        args 0, uint32(stor0.field_0), address(ext_call.return_data[0]), 0, 0, 0, 0, stor7, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    if eth.balance(stor7) > 0:
        call msg.sender with:
           value eth.balance(stor7) wei
             gas gas_remaining wei
        if not ext_call.success:
