...
function theValue(bool arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    stor7 = uint8(arg1)
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if 0x10ed43c718714eb63d5aa57b78b54704e256024e == msg.sender:
        ...
        require ext_code.size(0x58bc58a2d268fe63550918cce7b6816edff6cd17)
        staticcall 0x58bc58a2d268fe63550918cce7b6816edff6cd17.getPair(address arg1, address arg2) with:
