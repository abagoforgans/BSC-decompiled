...
function emergencyWithdraw(uint256 arg1) payable {
    ...
    if not userInfo[arg1][address(msg.sender)].field_0:
        ...
        call poolInfo[arg1].field_1024.0x2e1a7d4d with:
             gas gas_remaining wei
            args (userInfo[arg1][address(msg.sender)].field_0 * ext_call.return_data[0] / ext_call.return_data[0])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if eth.balance(this.address) < 0:
...
function migrateToAUTOv2(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(stor1) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[456 len 96] = unknown_0x23b872dd(?????), msg.sender, address(stor3), Mask(224, 32, arg1) >> 32
        mem[580 len 4] = 0
        mem[552 len 0] = 0
        call stor1 with:
           funct uint32(stor3)
        ...
        if return_data.size <= 0:
            ...
            if ext_code.size(stor1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 457 len 96] = unknown_0x23b872dd(?????), msg.sender, address(stor3), Mask(224, 32, arg1) >> 32
        ...
        while idx < poolInfo.length:
            ...
            if ext_call.return_data[0] >= aUTOMaxSupply:
                ...
                if totalAllocPoint <= 0:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_340 + idx + 68] = mem[_339 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    if not 0 / totalAllocPoint:
                        ...
                        idx = 0
                        while idx < 26:
                            mem[_426 + idx + 68] = mem[_415 + idx + 32]
                            idx = idx + 32
                            continue 
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_437 + idx + 68] = mem[_425 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_434 + idx + 68] = mem[_424 + idx + 32]
                        idx = idx + 32
                        continue 
                    mem[_434 + 68] = mem[_434 + 74 len 26]
                    revert with memory
                ...
                idx = 0
                while idx < 26:
                    mem[_448 + idx + 68] = mem[_433 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            if poolInfo[idx].field_512 > block.number:
                ...
                idx = 0
                while idx < 30:
                    mem[_330 + idx + 68] = mem[_329 + idx + 32]
                    idx = idx + 32
                    continue 
                mem[_330 + 68] = mem[_330 + 70 len 30]
                revert with memory
                  from mem[64]
                   len _330 + -mem[64] + 100
            if not block.number - poolInfo[idx].field_512:
                ...
                if totalAllocPoint <= 0:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_351 + idx + 68] = mem[_344 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    if not 0 / totalAllocPoint:
                        ...
                        idx = 0
                        while idx < 26:
                            mem[_457 + idx + 68] = mem[_441 + idx + 32]
                            idx = idx + 32
                            continue 
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_483 + idx + 68] = mem[_456 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_480 + idx + 68] = mem[_455 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[_511 + idx + 68] = mem[_479 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * aUTOPerBlock) - (poolInfo[idx].field_512 * aUTOPerBlock):
                ...
                if totalAllocPoint <= 0:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_355 + idx + 68] = mem[_350 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    if not 0 / totalAllocPoint:
                        ...
                        idx = 0
                        while idx < 26:
                            mem[_476 + idx + 68] = mem[_454 + idx + 32]
                            idx = idx + 32
                            continue 
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_507 + idx + 68] = mem[_475 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_504 + idx + 68] = mem[_474 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[_535 + idx + 68] = mem[_503 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            if totalAllocPoint <= 0:
                ...
                idx = 0
                while idx < 26:
                    mem[_361 + idx + 68] = mem[_354 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * aUTOPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * aUTOPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                if not (block.number * aUTOPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * aUTOPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_500 + idx + 68] = mem[_473 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[_531 + idx + 68] = mem[_499 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * aUTOPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * aUTOPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[_528 + idx + 68] = mem[_498 + idx + 32]
                    idx = idx + 32
                    continue 
