...
function sub_b6140c0f(?) {
    ...
    require 0 < arg2.length
    mem[(32 * arg2.length) + (32 * arg3.length) + 288] = mem[140 len 20]
    mem[(32 * arg2.length) + (32 * arg3.length) + 320] = stor3
    mem[(32 * arg2.length) + (32 * arg3.length) + 352] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
    ...
    require 1 < mem[(32 * arg2.length) + (32 * arg3.length) + ceil32(return_data.size) + 352]
    ...
    call sushiRouterAddress.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value arg1 wei
         gas gas_remaining wei
        args mem[(32 * arg2.length) + (32 * arg3.length) + ceil32(return_data.size) + 416], Array(len=2, data=mem[(32 * _131) + (32 * arg2.length) + (32 * arg3.length) + ceil32(return_data.size) + 548 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require 0 < arg2.length
    ...
    if not ext_call.return_data[0]:
        revert with 0, 'Approval failed'
    mem[(32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (4 * ceil32(return_data.size)) + 448] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
    ...
    mem[(32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (4 * ceil32(return_data.size)) + 516] = arg3.length
    mem[(32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (4 * ceil32(return_data.size)) + 548 len floor32(arg3.length)] = call.data[arg3 + 36 len floor32(arg3.length)]
    require ext_code.size(pancakeRouterAddress)
    staticcall pancakeRouterAddress.getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args ext_call.return_data[0], Array(len=arg3.length, data=call.data[arg3 + 36 len floor32(arg3.length)], mem[(32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (4 * ceil32(return_data.size)) + floor32(arg3.length) + 548 len (32 * arg3.length) - floor32(arg3.length)])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require 1 < mem[(32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (6 * ceil32(return_data.size)) + 448]
    _737 = mem[(32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (6 * ceil32(return_data.size)) + 512]
    ...
    call pancakeRouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args mem[(32 * _775) + (32 * _700) + (32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (8 * ceil32(return_data.size)) + 576] * uint8(-arg4 + 100) / 100, _799, Array(len=2, data=mem[(32 * _824) + (32 * _775) + (32 * _700) + (32 * _579) + (32 * _432) + (32 * _131) + (32 * arg2.length) + (32 * arg3.length) + (8 * ceil32(return_data.size)) + 740 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
