        ...
        if block.timestamp < periodFinish:
            ...
            if not msg.sender:
                ...
                if not totalSupply:
                    ...
                    if ext_code.size(stakingTokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[516 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, arg1) >> 32
                    mem[580 len 0] = 0
                    call stakingTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                    ...
                    if not msg.sender:
                        ...
                        if not totalSupply:
                            ...
                            if block.timestamp < periodFinish:
                                ...
                                if ext_code.size(stakingTokenAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[772 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, arg1) >> 32
                                mem[836 len 0] = 0
                            else:
                                if lastUpdateTime > periodFinish:
                                    revert with 0, 'SafeMath: subtraction overflow'
