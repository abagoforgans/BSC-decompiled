...
#  - uri(uint256 arg1)
#
const contractURI = Array(len=36, data=0x45687474703a2f2f31382e3230392e382e3235322f6170692f636f6e74726163742f6a67, mem[164 len 28], mem[220 len 4])
...
function balanceOfBatch(address[] arg1, uint256[] arg2) payable {
    ...
    if arg1.length:
        mem[(32 * arg1.length) + (32 * arg2.length) + 192 len 32 * arg1.length] = code.data[10729 len 32 * arg1.length]
    idx = 0
