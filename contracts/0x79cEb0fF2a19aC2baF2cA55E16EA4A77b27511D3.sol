...
function sub_c9ec965c(?) payable {
    ...
    mem[(32 * _53) + ceil32(return_data.size) + 324] = mem[ceil32(return_data.size) + 224]
    mem[(32 * _53) + ceil32(return_data.size) + 356] = 8 * msg.value / 10
    ...
    call stor0.swapExactTokensForETH(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args mem[ceil32(return_data.size) + 224], 8 * msg.value / 10, Array(len=2, data=mem[(32 * _53) + ceil32(return_data.size) + 516 len 64]), msg.sender, arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _115 = mem[(32 * _53) + ceil32(return_data.size) + 320 len 4], mem[ceil32(return_data.size) + 224 len 28]
    require mem[(32 * _53) + ceil32(return_data.size) + 320 len 4], mem[ceil32(return_data.size) + 224 len 28] <= 4294967296
    require mem[(32 * _53) + ceil32(return_data.size) + 320 len 4], mem[ceil32(return_data.size) + 224 len 28] + 32 <= return_data.size
    require mem[mem[(32 * _53) + ceil32(return_data.size) + 320 len 4], mem[ceil32(return_data.size) + 224 len 28] + (32 * _53) + ceil32(return_data.size) + 320] <= 4294967296 and mem[(32 * _53) + ceil32(return_data.size) + 320 len 4], mem[ceil32(return_data.size) + 224 len 28] + (32 * mem[mem[(32 * _53) + ceil32(return_data.size) + 320 len 4], mem[ceil32(return_data.size) + 224 len 28] + (32 * _53) + ceil32(return_data.size) + 320]) + 32 <= return_data.size
    mem[(32 * _53) + (2 * ceil32(return_data.size)) + 320] = mem[mem[(32 * _53) + ceil32(return_data.size) + 320 len 4], mem[ceil32(return_data.size) + 224 len 28] + (32 * _53) + ceil32(return_data.size) + 320]
