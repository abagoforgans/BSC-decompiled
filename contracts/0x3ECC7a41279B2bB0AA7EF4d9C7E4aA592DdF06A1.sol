...
function sub_7ffd3806(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 32, 32, code.data[15136 len 32]
    create contract with 0 wei
                    code: code.data[4695 len 10403], 0x10747e2045a0ef884a0586ac81558f43285ea3c7, address(arg1), address(arg2), 0x6decba7a077cb103f47ee136cba0118a5741861
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0x6decba7a077cb103f47ee136cba0118a5741861)
    call 0x06decba7a077cb103f47ee136cba0118a5741861.0xe9333fab with:
         gas gas_remaining wei
        args address(create.new_address)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
