...
function sub_f3fc7361(?) payable {
    ...
    if not collateralPerUnit:
        ...
        call collateralTokenAddress with:
             gas gas_remaining wei
            args Mask(480, -256, unknown_0xa9059cbb(?????), address(arg1) << 64, 0, 0) << 256, mem[260 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
            if not unknown_0xa9059cbb(?????), address(arg1) << 64:
        ...
        if settlementPrice < priceFloor:
            if not collateralPerUnit:
                ...
                while u >= 32:
                    ...
                    u = u - 32
                    continue 
                mem[mem[64] + floor32(mem[_207])] = mem[_207 + floor32(mem[_207]) + -(mem[_207] % 32) + 64 len mem[_207] % 32] or Mask(8 * -(mem[_207] % 32) + 32, -(8 * -(mem[_207] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_207])])
                call collateralTokenAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _230 + _206 + -mem[64] + 96]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if mem[96] > 0:
                ...
                while u >= 32:
                    ...
                    u = u - 32
                    continue 
                mem[mem[64] + floor32(mem[_219])] = mem[_219 + floor32(mem[_219]) + -(mem[_219] % 32) + 64 len mem[_219] % 32] or Mask(8 * -(mem[_219] % 32) + 32, -(8 * -(mem[_219] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_219])])
                call collateralTokenAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _244 + _218 + -mem[64] + 96]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if mem[96] > 0:
            ...
            if settlementPrice <= priceCap:
                ...
                while u >= 32:
                    ...
                    u = u - 32
                    continue 
                mem[mem[64] + floor32(mem[_192])] = mem[_192 + floor32(mem[_192]) + -(mem[_192] % 32) + 64 len mem[_192] % 32] or Mask(8 * -(mem[_192] % 32) + 32, -(8 * -(mem[_192] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_192])])
                call collateralTokenAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _210 + _191 + -mem[64] + 96]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if mem[96] > 0:
                ...
                if not collateralPerUnit:
                    ...
                    call collateralTokenAddress.mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _257 + _226 + -mem[64] + 96]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if mem[96] > 0:
