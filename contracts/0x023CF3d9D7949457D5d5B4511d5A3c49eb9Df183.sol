        ...
        if ext_call.return_data[0]:
            if block.number <= bonusEndBlock:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(kiwiAddress)
                    call kiwiAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if (block.number * kiwiPerBlock) - (poolInfo[arg1].field_512 * kiwiPerBlock) / block.number - poolInfo[arg1].field_512 != kiwiPerBlock:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (block.number * kiwiPerBlock) - (poolInfo[arg1].field_512 * kiwiPerBlock):
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(kiwiAddress)
                            call kiwiAddress.0x40c10f19 with:
                            ...
                            if (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / (block.number * kiwiPerBlock) - (poolInfo[arg1].field_512 * kiwiPerBlock) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(kiwiAddress)
                            call kiwiAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(kiwiAddress)
                            call kiwiAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args this.address, (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if 10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
            else:
                if poolInfo[arg1].field_512 >= bonusEndBlock:
                    ...
                    if not bonusEndBlock - poolInfo[arg1].field_512:
                        ...
                        if not block.number - bonusEndBlock:
                            ...
                            if (block.number * kiwiPerBlock) - (bonusEndBlock * kiwiPerBlock) / block.number - bonusEndBlock != kiwiPerBlock:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            if not (block.number * kiwiPerBlock) - (bonusEndBlock * kiwiPerBlock):
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_code.size(kiwiAddress)
                                call kiwiAddress.0x40c10f19 with:
                                ...
                                if (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / (block.number * kiwiPerBlock) - (bonusEndBlock * kiwiPerBlock) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_code.size(kiwiAddress)
                                call kiwiAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devaddr, (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(kiwiAddress)
                                call kiwiAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args this.address, (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    ...
                                    if 10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                    else:
...
function pendingKiwi(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if block.number <= bonusEndBlock:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            if userInfo[arg1][address(arg2)].field_256 > 0:
                revert with 0, 'SafeMath: subtraction overflow'
            return -userInfo[arg1][address(arg2)].field_256
        if (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    else:
        if poolInfo[arg1].field_512 >= bonusEndBlock:
            if poolInfo[arg1].field_512 > block.number:
            ...
            if not bonusEndBlock - poolInfo[arg1].field_512:
                ...
                if not userInfo[arg1][address(arg2)].field_0:
                    if userInfo[arg1][address(arg2)].field_256 > 0:
                        revert with 0, 'SafeMath: subtraction overflow'
                    return -userInfo[arg1][address(arg2)].field_256
                if (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
                    revert with 0, 'SafeMath: subtraction overflow'
                return (((10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
            if bonusEndBlock - poolInfo[arg1].field_512 / bonusEndBlock - poolInfo[arg1].field_512 != 1:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
            if block.number < bonusEndBlock:
                revert with 0, 'SafeMath: addition overflow'
            ...
            if (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
    ('eq', ('div', ('add', ('mul', ('div', ('mul', 1000000000000, ('div', ('add', ('mul', 'number', ('stor', ('name', 'kiwiPerBlock', 4)), ('field', 256, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6))))), ('mul', -1, ('field', 512, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6)))), ('stor', ('name', 'kiwiPerBlock', 4)), ('field', 256, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6)))))), ('stor', ('name', 'totalAllocPoint', 8)))), ('ext_call.return_data', 0, 32)), ('field', 0, ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('map', ('param', 'arg1'), ('name', 'userInfo', 7)))))), ('mul', ('field', 768, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6)))), ('field', 0, ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('map', ('param', 'arg1'), ('name', 'userInfo', 7))))))), ('field', 0, ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('map', ('param', 'arg1'), ('name', 'userInfo', 7)))))), ('add', ('div', ('mul', 1000000000000, ('div', ('add', ('mul', 'number', ('stor', ('name', 'kiwiPerBlock', 4)), ('field', 256, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6))))), ('mul', -1, ('field', 512, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6)))), ('stor', ('name', 'kiwiPerBlock', 4)), ('field', 256, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6)))))), ('stor', ('name', 'totalAllocPoint', 8)))), ('ext_call.return_data', 0, 32)), ('field', 768, ('stor', ('array', ('mul', 4, ('param', 'arg1')), ('name', 'poolInfo', 6))))))
    if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((10^12 * (block.number * kiwiPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * kiwiPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
        ...
        if block.number <= bonusEndBlock:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                revert with memory
                  from mem[64]
                   len _856 + -mem[64] + 100
            if (block.number * kiwiPerBlock) - (poolInfo[idx].field_512 * kiwiPerBlock) / block.number - poolInfo[idx].field_512 != kiwiPerBlock:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            if not (block.number * kiwiPerBlock) - (poolInfo[idx].field_512 * kiwiPerBlock):
                _620 = mem[64]
                mem[64] = mem[64] + 64
                mem[_620] = 26
                ...
                revert with memory
                  from mem[64]
                   len _873 + -mem[64] + 100
            if (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / (block.number * kiwiPerBlock) - (poolInfo[idx].field_512 * kiwiPerBlock) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _629 = mem[64]
            mem[64] = mem[64] + 64
            mem[_629] = 26
            ...
            call kiwiAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(kiwiAddress)
            call kiwiAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                _831 = mem[64]
                mem[64] = mem[64] + 64
                mem[_831] = 26
                ...
                revert with memory
                  from mem[64]
                   len _870 + -mem[64] + 100
            if 10^12 * (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _852 = mem[64]
            mem[64] = mem[64] + 64
            mem[_852] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _885 = mem[64]
        ...
        if not bonusEndBlock - poolInfo[idx].field_512:
            ...
            if not (block.number * kiwiPerBlock) - (bonusEndBlock * kiwiPerBlock):
                ...
                revert with memory
                  from mem[64]
                   len _978 + -mem[64] + 100
            if (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / (block.number * kiwiPerBlock) - (bonusEndBlock * kiwiPerBlock) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _685 = mem[64]
            mem[64] = mem[64] + 64
            mem[_685] = 26
            ...
            call kiwiAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(kiwiAddress)
            call kiwiAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                _949 = mem[64]
                mem[64] = mem[64] + 64
                mem[_949] = 26
                ...
                revert with memory
                  from mem[64]
                   len _975 + -mem[64] + 100
            if 10^12 * (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _961 = mem[64]
            mem[64] = mem[64] + 64
            mem[_961] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * kiwiPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * kiwiPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _989 = mem[64]
        ...
        if not userInfo[arg1][msg.sender].field_0:
            ...
            if not userInfo[arg1][msg.sender].field_0:
                if userInfo[arg1][msg.sender].field_256 > 0:
                    revert with 0, 'SafeMath: subtraction overflow'
                require ext_code.size(kiwiAddress)
                staticcall kiwiAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
                    call kiwiAddress.0xa9059cbb with:
                         gas gas_remaining wei
