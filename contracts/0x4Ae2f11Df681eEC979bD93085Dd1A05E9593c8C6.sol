...
function executeNewDelay() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor12 + approvalDelay < stor12:
        revert with 0, 'SafeMath: addition overflow'
    if stor12 + approvalDelay >= block.timestamp:
        revert with 0, 'Delay has not passed'
    approvalDelay = stor11
    emit NewDelay(stor11);
}
...
function executeTransfer() payable {
    ...
    if stor10 + approvalDelay < stor10:
        revert with 0, 'SafeMath: addition overflow'
    if stor10 + approvalDelay >= block.timestamp:
        revert with 0, 'Delay has not passed'
    emit 0xa1580639: stor9
