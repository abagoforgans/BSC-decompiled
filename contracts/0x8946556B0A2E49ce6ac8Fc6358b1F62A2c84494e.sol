...
function sub_0f5a57a6(?) payable {
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_ce638feb(?) payable {
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_dca64fdb(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_7c026440(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    stor5 = arg1
