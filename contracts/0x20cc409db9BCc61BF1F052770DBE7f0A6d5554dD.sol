...
function sub_83ab15bd(?) payable {
    ...
    while uint8(idx) < sub_8c42d7c4.length:
        ...
        if not ext_call.return_data[0]:
            ...
            if (2 * ext_call.return_data[0]) + (_35 * None) < _35 * None:
                revert with 0, 'SafeMath: addition overflow'
        idx = idx + 1
        s = ext_call.return_data[0]
        continue 
...
function sub_917d9692(?) payable {
    ...
    while uint8(idx) < sub_8c42d7c4.length:
        ...
        if not ext_call.return_data[0]:
            ...
            if 2 * ext_call.return_data[0] / ext_call.return_data[0] != 2:
                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
            if (2 * ext_call.return_data[0]) + (_38 * None) < _38 * None:
                revert with 0, 'SafeMath: addition overflow'
        idx = idx + 1
        s = ext_call.return_data[0]
        continue 
...
function invest(uint256 arg1) payable {
    ...
    if stor19[address(msg.sender)]:
        ...
        while uint8(idx) < sub_8c42d7c4.length:
            ...
            require return_data.size >= 256
            if not ext_call.return_data[0]:
                if _938 * None < _938 * None:
                    revert with 0, 'SafeMath: addition overflow'
            else:
                if 2 * ext_call.return_data[0] / ext_call.return_data[0] != 2:
                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
                if (2 * ext_call.return_data[0]) + (_938 * None) < _938 * None:
                    revert with 0, 'SafeMath: addition overflow'
            idx = idx + 1
            s = ext_call.return_data[0]
            continue 
        ...
        if _938 * None >= sub_fa1ec3f9:
            ...
            if _938 * None >= sub_fa1ec3f9:
                ...
                if not ext_code.size(sub_126b88feAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[292 len 96] = 0, msg.sender, address(this.address), stor10
                mem[416 len 4] = 0
                call sub_126b88feAddress with:
                     gas gas_remaining wei
