...
#  - _fallback()
#
const name = 'Tiger Chinese', 0

const SellLimitDivider = 100

const InitialSupply = 10^14
...
function getBurnedTokens() {
    if 10^14 < totalSupply:
        revert with 0, 17
    return (-totalSupply + 10^14 / 10^9)
}
...
function TeamChangeStakingShare(uint8 arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function TeamWithdrawALLMarketingBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    marketingBalance = 0
    if marketingBalance > 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
        revert with 0, 17
    call marketingAddress with:
       value 2 * marketingBalance / 5 wei
...
function TeamApproveReduction(bool arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function TeamCreateLPandBNB() {
    ...
    if balanceOf[this.address] >= sellLimit:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            if sellLimit and uint8(stor19.field_32) > -1 / sellLimit:
                revert with 0, 17
            if not uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 18
            if sellLimit < sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 17
            if sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) < sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2:
                revert with 0, 17
            if (sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > !(sellLimit - (sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)))):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = -(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit
            emit Approval((-(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit), this.address, address(stor20.field_0));
            ...
            mem[ceil32(return_data.size) + 196] = -(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit
            idx = 0
            s = 128
            ...
            call address(stor20.field_0).swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args -(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit:
                revert with 0, 18
            if totalLPBNB > !(0 / -(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit):
                revert with 0, 17
            totalLPBNB += 0 / -(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][address(stor20.field_0)].field_255 = 0
            emit Approval((sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, address(stor20.field_0));
            require ext_code.size(address(stor20.field_0))
            call address(stor20.field_0).addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / -(sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + sellLimit wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, sellLimit * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function Rewards() {
    ...
    if stor12[address(msg.sender)]:
        ...
        if stor27[address(msg.sender)]:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            emit OnWithdrawBTC(stor27[address(msg.sender)], msg.sender);
    else:
        ...
        if profitPerShare * balanceOf[address(msg.sender)] < stor26[address(msg.sender)]:
            ...
            if stor27[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor26[address(msg.sender)]) >> 64):
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit OnWithdrawBTC(stor27[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor26[address(msg.sender)]) >> 64), msg.sender);
