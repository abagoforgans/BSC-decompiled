...
const sub_9ad51991(?) = 0x3047799262d8d2ef41ed2a222205968bc9b0d895
...
function withdraw() {
    ...
    call ????????????????????????????????????????.withdraw(address rg1) with:
...
function work(address arg1) {
    ...
    if ext_call.return_data[0] >= 0:
        ...
        call ????????????????????????????????????????.approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args 0x3047799262d8d2ef41ed2a222205968bc9b0d895, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        mem[420] = 2
        mem[452 len 0] = None
        require ext_code.size(0x3047799262d8d2ef41ed2a222205968bc9b0d895)
        call 0x3047799262d8d2ef41ed2a222205968bc9b0d895.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
