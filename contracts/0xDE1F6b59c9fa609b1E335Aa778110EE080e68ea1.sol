...
function init() {
    ...
    if totalSupply + 10000000000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 10000000000 * 10^18
    if balanceOf[stor5] + 10000000000 * 10^18 < balanceOf[stor5]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[stor5] += 10000000000 * 10^18
    emit Transfer(10000000000 * 10^18, 0, owner);
}
