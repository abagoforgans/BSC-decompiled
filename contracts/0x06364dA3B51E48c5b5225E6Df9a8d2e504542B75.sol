        ...
        if not return_data.size:
            ...
            if not msg.sender, Mask(96, 64, arg1) >> 64:
                revert with 0, 
                            ...
                            uint32(arg2),
                            mem[712 len 4]
            mem[716 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg3) >> 32
            mem[840 len 4] = uint32(arg3)
            call address(stor3) with:
                 gas gas_remaining wei
                args Mask(224, 32, arg3) << 480, mem[812 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
            ...
            if return_data.size:
                ...
                if not mem[616]:
                    revert with 0, 
                                ...
                                0x775472616e7366657248656c7065723a205452414e534645525f46524f4d5f4641494c45,
                                mem[ceil32(return_data.size) + 689 len 28]
            mem[ceil32(return_data.size) + 717 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg3) >> 32
            mem[ceil32(return_data.size) + 841 len 4] = uint32(arg3)
            call address(stor3) with:
                 gas gas_remaining wei
                args Mask(224, 32, arg3) << 480, mem[ceil32(return_data.size) + 813 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
            ...
            if not return_data.size:
                ...
                if not ext_call.success:
                    revert with 0, 
                                ...
                                36,
                                0x775472616e7366657248656c7065723a205452414e534645525f46524f4d5f4641494c45,
                                mem[(2 * ceil32(return_data.size)) + 822 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 28]
                if return_data.size:
                    require return_data.size >= 32
                    if not mem[ceil32(return_data.size) + 749]:
                        revert with 0, 
                ...
                if not sub_9575a5f2[arg4][address(arg1)][address(msg.sender)].field_256 + arg3:
                    ...
                    if (99 * sub_9575a5f2[arg4][address(arg1)][address(msg.sender)].field_256) + (99 * arg3) / sub_9575a5f2[arg4][address(arg1)][address(msg.sender)].field_256 + arg3 != 99:
                        revert with 0, 
                                    ...
                                    33,
                                    0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(2 * ceil32(return_data.size)) + 819 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 31]
                    sub_9575a5f2[arg4][address(arg1)][address(msg.sender)].field_256 = (99 * sub_9575a5f2[arg4][address(arg1)][address(msg.sender)].field_256) + (99 * arg3) / 100
                emit 0x328221d9: arg2, arg3, block.timestamp, arg4, mem[(2 * ceil32(return_data.size)) + 846 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))], msg.sender, arg1
}
