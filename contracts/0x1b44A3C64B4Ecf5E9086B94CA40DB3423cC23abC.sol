...
function airdrop(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[64] = mem[64] + 96
        mem[_89] = 38
        mem[_89 + 32 len 38] = 0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63
        mem[32] = 1
        if _86 > balanceOf[address(msg.sender)]:
            _93 = mem[64]
            ...
            idx = 0
            while idx < 38:
                mem[_93 + idx + 68] = mem[_89 + idx + 32]
                idx = idx + 32
                continue 
            mem[_93 + 100] = mem[_93 + 126 len 6]
            revert with memory
              from mem[64]
               len _93 + -mem[64] + 132
        balanceOf[address(msg.sender)] -= _86
        if balanceOf[address(_84)] + _86 < balanceOf[address(_84)]:
            revert with 0, 'SafeMath: addition overflow'
        mem[0] = address(_84)
        mem[32] = 1
        balanceOf[address(_84)] += _86
        mem[mem[64]] = _86
        emit Transfer(_86, msg.sender, address(_84));
        idx = idx + 1
        continue 
    return 1
}
