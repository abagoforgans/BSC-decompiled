...
function sub_ad7dfbcb(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        while idx < 1:
            ...
            idx = idx + 1
            continue 
        mem[192] = cd[100] / 100 * msg.value
        require mem[(32 * ('cd', 36).length) + 288] - 1 < mem[(32 * ('cd', 36).length) + 288]
        if mem[(32 * mem[(32 * ('cd', 36).length) + 288] - 1) + (32 * ('cd', 36).length) + 320] < cd[4]:
            revert with 0, '-,'
        if mem[(64 * ('cd', 36).length) + 480] < cd[100] / 100 * msg.value:
            revert with 0, '-,'
        ...
        while idx < ('cd', 36).length - 1:
            ...
            if mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20] < mem[(32 * idx + 1) + (64 * ('cd', 36).length) + 556 len 20]:
                if not mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20]:
                    revert with 0, 'PancakeLibrary: ZERO_ADDRESS'
                require idx + 1 < mem[(32 * ('cd', 36).length) + 288]
                _2393 = mem[(32 * idx + 1) + (32 * ('cd', 36).length) + 320]
                if mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20] == mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20]:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        ...
                        mem[_2459 + 36] = 0
                        mem[_2459 + 68] = _2393
                        mem[_2459 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2459 + 132] = 128
                        ...
                        if not mem[_2459] % 32:
                            ...
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2393, address(ext_call.return_data[12 len 20]), 128, mem[_2459 + 164 len mem[_2459] + 32]
                        else:
                            mem[floor32(mem[_2459]) + _2459 + 196] = mem[floor32(mem[_2459]) + _2459 + -(mem[_2459] % 32) + 228 len mem[_2459] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2393, address(ext_call.return_data[12 len 20]), 128, mem[_2459], mem[_2459 + 196 len floor32(mem[_2459]) + 32]
                    else:
                        _2463 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        if not mem[_2463] % 32:
                            ...
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2393, address(this.address), 128, mem[_2463 + 164 len mem[_2463] + 32]
                        else:
                            mem[floor32(mem[_2463]) + _2463 + 196] = mem[floor32(mem[_2463]) + _2463 + -(mem[_2463] % 32) + 228 len mem[_2463] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2393, address(this.address), 128, mem[_2463], mem[_2463 + 196 len floor32(mem[_2463]) + 32]
                else:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        _2467 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        mem[_2467 + 36] = _2393
                        mem[_2467 + 68] = 0
                        mem[_2467 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2467 + 132] = 128
                        ...
                        if not mem[_2467] % 32:
                            ...
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2393, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2467 + 164 len mem[_2467] + 32]
                        else:
                            mem[floor32(mem[_2467]) + _2467 + 196] = mem[floor32(mem[_2467]) + _2467 + -(mem[_2467] % 32) + 228 len mem[_2467] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2393, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2467], mem[_2467 + 196 len floor32(mem[_2467]) + 32]
                    else:
                        _2471 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        if not mem[_2471] % 32:
                            ...
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2393, 0, address(this.address), 128, mem[_2471 + 164 len mem[_2471] + 32]
                        else:
                            mem[floor32(mem[_2471]) + _2471 + 196] = mem[floor32(mem[_2471]) + _2471 + -(mem[_2471] % 32) + 228 len mem[_2471] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2393, 0, address(this.address), 128, mem[_2471], mem[_2471 + 196 len floor32(mem[_2471]) + 32]
            else:
                if not mem[(32 * idx + 1) + (64 * ('cd', 36).length) + 556 len 20]:
                    revert with 0, 'PancakeLibrary: ZERO_ADDRESS'
                require idx + 1 < mem[(32 * ('cd', 36).length) + 288]
                _2394 = mem[(32 * idx + 1) + (32 * ('cd', 36).length) + 320]
                if mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20] == mem[(32 * idx + 1) + (64 * ('cd', 36).length) + 556 len 20]:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        _2475 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        mem[_2475 + 36] = 0
                        mem[_2475 + 68] = _2394
                        mem[_2475 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2475 + 132] = 128
                        ...
                        if not mem[_2475] % 32:
                            ...
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2394, address(ext_call.return_data[12 len 20]), 128, mem[_2475 + 164 len mem[_2475] + 32]
                        else:
                            mem[floor32(mem[_2475]) + _2475 + 196] = mem[floor32(mem[_2475]) + _2475 + -(mem[_2475] % 32) + 228 len mem[_2475] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2394, address(ext_call.return_data[12 len 20]), 128, mem[_2475], mem[_2475 + 196 len floor32(mem[_2475]) + 32]
                    else:
                        _2479 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        s = 0
                        while s < mem[_2479]:
                            mem[s + _2479 + 196] = mem[s + _2479 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2479] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2394, address(this.address), 128, mem[_2479 + 164 len mem[_2479] + 32]
                        else:
                            mem[floor32(mem[_2479]) + _2479 + 196] = mem[floor32(mem[_2479]) + _2479 + -(mem[_2479] % 32) + 228 len mem[_2479] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2394, address(this.address), 128, mem[_2479], mem[_2479 + 196 len floor32(mem[_2479]) + 32]
                else:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        _2483 = mem[64]
                        mem[64] = mem[64] + 32
                        mem[_2483 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                        mem[_2483 + 36] = _2394
                        mem[_2483 + 68] = 0
                        mem[_2483 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2483 + 132] = 128
                        mem[_2483 + 164] = mem[_2483]
                        s = 0
                        while s < mem[_2483]:
                            mem[s + _2483 + 196] = mem[s + _2483 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2483] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2394, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2483 + 164 len mem[_2483] + 32]
                        else:
                            mem[floor32(mem[_2483]) + _2483 + 196] = mem[floor32(mem[_2483]) + _2483 + -(mem[_2483] % 32) + 228 len mem[_2483] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2394, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2483], mem[_2483 + 196 len floor32(mem[_2483]) + 32]
                    else:
                        _2487 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        if not mem[_2487] % 32:
                            ...
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2394, 0, address(this.address), 128, mem[_2487 + 164 len mem[_2487] + 32]
                        else:
                            mem[floor32(mem[_2487]) + _2487 + 196] = mem[floor32(mem[_2487]) + _2487 + -(mem[_2487] % 32) + 228 len mem[_2487] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2394, 0, address(this.address), 128, mem[_2487], mem[_2487 + 196 len floor32(mem[_2487]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            continue 
        ...
        _2311 = mem[96]
        require mem[(32 * ('cd', 36).length) + 288] - 1 < mem[(32 * ('cd', 36).length) + 288]
        _2330 = mem[(32 * mem[(32 * ('cd', 36).length) + 288] - 1) + (32 * ('cd', 36).length) + 320]
        mem[mem[64]] = 0x3f4e48bb00000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = address(_2311)
        mem[mem[64] + 36] = _2330
        mem[mem[64] + 68] = msg.value * cd[132] / 100
        mem[mem[64] + 132] = this.address
        mem[mem[64] + 100] = 160
        mem[mem[64] + 164] = mem[(64 * ('cd', 36).length) + 320]
        _2334 = mem[(64 * ('cd', 36).length) + 320]
        mem[mem[64] + 196 len floor32(mem[(64 * ('cd', 36).length) + 320])] = mem[(64 * ('cd', 36).length) + 352 len floor32(mem[(64 * ('cd', 36).length) + 320])]
        require ext_code.size(this.address)
        call this.address.0x3f4e48bb with:
             gas gas_remaining wei
            args address(_2311), _2330, msg.value * cd[132] / 100, 160, address(this.address), mem[mem[64] + 164 len (32 * _2334) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _2800 = mem[64]
        ...
        require return_data.size >= 32
        require mem[_2800] <= 4294967296
        require mem[_2800] + 32 <= return_data.size
        require mem[_2800 + mem[_2800]] <= 4294967296 and mem[_2800] + (32 * mem[_2800 + mem[_2800]]) + 32 <= return_data.size
    else:
        ...
        mem[(64 * ('cd', 36).length) + 384] = address(('cd', 36)[0])
        require mem[(32 * ('cd', 36).length) + 288] - 1 < mem[(32 * ('cd', 36).length) + 288]
        _886 = mem[(32 * mem[(32 * ('cd', 36).length) + 288] - 1) + (32 * ('cd', 36).length) + 320]
        mem[(64 * ('cd', 36).length) + 416] = 2
        mem[(64 * ('cd', 36).length) + 448 len 64] = call.data[calldata.size len 64]
        mem[(64 * ('cd', 36).length) + 448] = _886
        idx = 0
        while idx < 1:
            require idx < 2
            if mem[(32 * idx) + (64 * ('cd', 36).length) + 448] <= 0:
        ...
        while idx < ('cd', 36).length - 1:
            ...
            if mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20] < mem[(32 * idx + 1) + (64 * ('cd', 36).length) + 556 len 20]:
                if not mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20]:
                    revert with 0, 'PancakeLibrary: ZERO_ADDRESS'
                require idx + 1 < mem[(32 * ('cd', 36).length) + 288]
                _2401 = mem[(32 * idx + 1) + (32 * ('cd', 36).length) + 320]
                if mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20] == mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20]:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        _2523 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        mem[_2523 + 36] = 0
                        mem[_2523 + 68] = _2401
                        mem[_2523 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2523 + 132] = 128
                        mem[_2523 + 164] = mem[_2523]
                        s = 0
                        while s < mem[_2523]:
                            mem[s + _2523 + 196] = mem[s + _2523 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2523] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2401, address(ext_call.return_data[12 len 20]), 128, mem[_2523 + 164 len mem[_2523] + 32]
                        else:
                            mem[floor32(mem[_2523]) + _2523 + 196] = mem[floor32(mem[_2523]) + _2523 + -(mem[_2523] % 32) + 228 len mem[_2523] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2401, address(ext_call.return_data[12 len 20]), 128, mem[_2523], mem[_2523 + 196 len floor32(mem[_2523]) + 32]
                    else:
                        _2527 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        s = 0
                        while s < mem[_2527]:
                            mem[s + _2527 + 196] = mem[s + _2527 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2527] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2401, address(this.address), 128, mem[_2527 + 164 len mem[_2527] + 32]
                        else:
                            mem[floor32(mem[_2527]) + _2527 + 196] = mem[floor32(mem[_2527]) + _2527 + -(mem[_2527] % 32) + 228 len mem[_2527] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2401, address(this.address), 128, mem[_2527], mem[_2527 + 196 len floor32(mem[_2527]) + 32]
                else:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        _2531 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        mem[_2531 + 36] = _2401
                        mem[_2531 + 68] = 0
                        mem[_2531 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2531 + 132] = 128
                        mem[_2531 + 164] = mem[_2531]
                        s = 0
                        while s < mem[_2531]:
                            mem[s + _2531 + 196] = mem[s + _2531 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2531] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2401, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2531 + 164 len mem[_2531] + 32]
                        else:
                            mem[floor32(mem[_2531]) + _2531 + 196] = mem[floor32(mem[_2531]) + _2531 + -(mem[_2531] % 32) + 228 len mem[_2531] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2401, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2531], mem[_2531 + 196 len floor32(mem[_2531]) + 32]
                    else:
                        _2535 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        s = 0
                        while s < mem[_2535]:
                            mem[s + _2535 + 196] = mem[s + _2535 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2535] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2401, 0, address(this.address), 128, mem[_2535 + 164 len mem[_2535] + 32]
                        else:
                            mem[floor32(mem[_2535]) + _2535 + 196] = mem[floor32(mem[_2535]) + _2535 + -(mem[_2535] % 32) + 228 len mem[_2535] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2401, 0, address(this.address), 128, mem[_2535], mem[_2535 + 196 len floor32(mem[_2535]) + 32]
            else:
                if not mem[(32 * idx + 1) + (64 * ('cd', 36).length) + 556 len 20]:
                    revert with 0, 'PancakeLibrary: ZERO_ADDRESS'
                require idx + 1 < mem[(32 * ('cd', 36).length) + 288]
                _2402 = mem[(32 * idx + 1) + (32 * ('cd', 36).length) + 320]
                if mem[(32 * idx) + (64 * ('cd', 36).length) + 556 len 20] == mem[(32 * idx + 1) + (64 * ('cd', 36).length) + 556 len 20]:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        _2539 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        mem[_2539 + 36] = 0
                        mem[_2539 + 68] = _2402
                        mem[_2539 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2539 + 132] = 128
                        mem[_2539 + 164] = mem[_2539]
                        s = 0
                        while s < mem[_2539]:
                            mem[s + _2539 + 196] = mem[s + _2539 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2539] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2402, address(ext_call.return_data[12 len 20]), 128, mem[_2539 + 164 len mem[_2539] + 32]
                        else:
                            mem[floor32(mem[_2539]) + _2539 + 196] = mem[floor32(mem[_2539]) + _2539 + -(mem[_2539] % 32) + 228 len mem[_2539] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2402, address(ext_call.return_data[12 len 20]), 128, mem[_2539], mem[_2539 + 196 len floor32(mem[_2539]) + 32]
                    else:
                        _2543 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        s = 0
                        while s < mem[_2543]:
                            mem[s + _2543 + 196] = mem[s + _2543 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2543] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2402, address(this.address), 128, mem[_2543 + 164 len mem[_2543] + 32]
                        else:
                            mem[floor32(mem[_2543]) + _2543 + 196] = mem[floor32(mem[_2543]) + _2543 + -(mem[_2543] % 32) + 228 len mem[_2543] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, _2402, address(this.address), 128, mem[_2543], mem[_2543 + 196 len floor32(mem[_2543]) + 32]
                else:
                    if idx < mem[(64 * ('cd', 36).length) + 512] - 2:
                        _2547 = mem[64]
                        mem[64] = mem[64] + 32
                        mem[_2547 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                        mem[_2547 + 36] = _2402
                        mem[_2547 + 68] = 0
                        mem[_2547 + 100] = address(ext_call.return_data[12 len 20])
                        mem[_2547 + 132] = 128
                        mem[_2547 + 164] = mem[_2547]
                        s = 0
                        while s < mem[_2547]:
                            mem[s + _2547 + 196] = mem[s + _2547 + 32]
                            s = s + 32
                            continue 
                        if not mem[_2547] % 32:
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2402, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2547 + 164 len mem[_2547] + 32]
                        else:
                            mem[floor32(mem[_2547]) + _2547 + 196] = mem[floor32(mem[_2547]) + _2547 + -(mem[_2547] % 32) + 228 len mem[_2547] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2402, 0, address(ext_call.return_data[12 len 20]), 128, mem[_2547], mem[_2547 + 196 len floor32(mem[_2547]) + 32]
                    else:
                        _2551 = mem[64]
                        mem[64] = mem[64] + 32
                        ...
                        if not mem[_2551] % 32:
                            ...
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2402, 0, address(this.address), 128, mem[_2551 + 164 len mem[_2551] + 32]
                        else:
                            mem[floor32(mem[_2551]) + _2551 + 196] = mem[floor32(mem[_2551]) + _2551 + -(mem[_2551] % 32) + 228 len mem[_2551] % 32]
                            require ext_code.size(address(ext_call.return_data[12 len 20]))
                            call address(ext_call.return_data[12 len 20]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args _2402, 0, address(this.address), 128, mem[_2551], mem[_2551 + 196 len floor32(mem[_2551]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            continue 
        ...
        _2319 = mem[96]
        require mem[(32 * ('cd', 36).length) + 288] - 1 < mem[(32 * ('cd', 36).length) + 288]
        _2344 = mem[(32 * mem[(32 * ('cd', 36).length) + 288] - 1) + (32 * ('cd', 36).length) + 320]
        mem[mem[64]] = 0x3f4e48bb00000000000000000000000000000000000000000000000000000000
        ...
        mem[mem[64] + 100] = 160
        mem[mem[64] + 164] = mem[(64 * ('cd', 36).length) + 320]
        _2348 = mem[(64 * ('cd', 36).length) + 320]
        mem[mem[64] + 196 len floor32(mem[(64 * ('cd', 36).length) + 320])] = mem[(64 * ('cd', 36).length) + 352 len floor32(mem[(64 * ('cd', 36).length) + 320])]
        require ext_code.size(this.address)
        call this.address.0x3f4e48bb with:
             gas gas_remaining wei
            args address(_2319), _2344, msg.value * cd[132] / 100, 160, address(this.address), mem[mem[64] + 164 len (32 * _2348) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _2818 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        require mem[_2818] <= 4294967296
        require mem[_2818] + 32 <= return_data.size
        require mem[_2818 + mem[_2818]] <= 4294967296 and mem[_2818] + (32 * mem[_2818 + mem[_2818]]) + 32 <= return_data.size
}
...
function sub_3f4e48bb(?) {
    ...
    if not ('cd', 100).length:
        ...
        if return_data.size:
            ...
            if not return_data.size:
                ...
                mem[mem[64]] = 0
                mem[64] = mem[64] + 32
                mem[_3439 + floor32(mem[_3439]) + -(mem[_3439] % 32) + 64 len mem[_3439] % 32] = mem[_3439 + -(mem[_3439] % 32) + floor32(mem[_3439]) + 64 len mem[_3439] % 32]
                call address(cd[132]).mem[_3439 + 32 len 4] with:
                   value _3427 wei
                     gas gas_remaining wei
                    args mem[_3439 + 36 len mem[_3439] - 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 32, 35, 0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45, mem[_3439 + 135 len 29]
                    mem[_3439 + 32] = 32
                    mem[_3439 + 64] = mem[(32 * ('cd', 100).length) + 128]
                    _4559 = mem[(32 * ('cd', 100).length) + 128]
                    mem[_3439 + 96 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
                    return memory
                      from mem[64]
                       len (32 * _4559) + _3439 + -mem[64] + 96
                mem[64] = _3439 + ceil32(return_data.size) + 33
                mem[_3439 + 32] = return_data.size
                mem[_3439 + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    revert with 0, 
                                32,
                                35,
                                0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                                mem[_3439 + ceil32(return_data.size) + 136 len 29]
                mem[_3439 + ceil32(return_data.size) + 33] = 32
                mem[_3439 + ceil32(return_data.size) + 65] = mem[(32 * ('cd', 100).length) + 128]
                _4562 = mem[(32 * ('cd', 100).length) + 128]
                mem[_3439 + ceil32(return_data.size) + 97 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
                return 32, mem[_3439 + ceil32(return_data.size) + 65 len (32 * _4562) + 32]
            require return_data.size >= 32
        ...
        if not ('cd', 100).length:
            ...
            mem[mem[64]] = 0
            mem[64] = mem[64] + 32
            mem[_3433 + floor32(mem[_3433]) + -(mem[_3433] % 32) + 64 len mem[_3433] % 32] = mem[_3433 + -(mem[_3433] % 32) + floor32(mem[_3433]) + 64 len mem[_3433] % 32]
            call address(cd[132]).mem[_3433 + 32 len 4] with:
               value _3425 wei
                 gas gas_remaining wei
                args mem[_3433 + 36 len mem[_3433] - 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 32, 35, 0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45, mem[_3433 + 135 len 29]
                mem[_3433 + 32] = 32
                mem[_3433 + 64] = mem[(32 * ('cd', 100).length) + 128]
                _4547 = mem[(32 * ('cd', 100).length) + 128]
                mem[_3433 + 96 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
                return memory
                  from mem[64]
                   len (32 * _4547) + _3433 + -mem[64] + 96
            mem[64] = _3433 + ceil32(return_data.size) + 33
            mem[_3433 + 32] = return_data.size
            mem[_3433 + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                revert with 0, 
                            32,
                            35,
                            0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                            mem[_3433 + ceil32(return_data.size) + 136 len 29]
            mem[_3433 + ceil32(return_data.size) + 33] = 32
            mem[_3433 + ceil32(return_data.size) + 65] = mem[(32 * ('cd', 100).length) + 128]
            _4550 = mem[(32 * ('cd', 100).length) + 128]
            mem[_3433 + ceil32(return_data.size) + 97 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
            return 32, mem[_3433 + ceil32(return_data.size) + 65 len (32 * _4550) + 32]
    ...
    if not return_data.size:
        ...
        if not ('cd', 100).length:
            ...
            mem[mem[64]] = 0
            mem[64] = mem[64] + 32
            mem[_3445 + floor32(mem[_3445]) + -(mem[_3445] % 32) + 64 len mem[_3445] % 32] = mem[_3445 + -(mem[_3445] % 32) + floor32(mem[_3445]) + 64 len mem[_3445] % 32]
            call address(cd[132]).mem[_3445 + 32 len 4] with:
               value _3429 wei
                 gas gas_remaining wei
                args mem[_3445 + 36 len mem[_3445] - 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 32, 35, 0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45, mem[_3445 + 135 len 29]
                mem[_3445 + 32] = 32
                mem[_3445 + 64] = mem[(32 * ('cd', 100).length) + 128]
                _4571 = mem[(32 * ('cd', 100).length) + 128]
                mem[_3445 + 96 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
                return memory
                  from mem[64]
                   len (32 * _4571) + _3445 + -mem[64] + 96
            mem[64] = _3445 + ceil32(return_data.size) + 33
            mem[_3445 + 32] = return_data.size
            mem[_3445 + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                revert with 0, 
                            32,
                            35,
                            0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                            mem[_3445 + ceil32(return_data.size) + 136 len 29]
            mem[_3445 + ceil32(return_data.size) + 33] = 32
            mem[_3445 + ceil32(return_data.size) + 65] = mem[(32 * ('cd', 100).length) + 128]
            _4574 = mem[(32 * ('cd', 100).length) + 128]
            mem[_3445 + ceil32(return_data.size) + 97 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
            return 32, mem[_3445 + ceil32(return_data.size) + 65 len (32 * _4574) + 32]
        require ('cd', 100).length >= 32
        if not mem[128]:
            revert with 0, 
                        32,
    ...
    if not return_data.size:
        ...
        mem[mem[64]] = 0
        mem[64] = mem[64] + 32
        mem[_3451 + floor32(mem[_3451]) + -(mem[_3451] % 32) + 64 len mem[_3451] % 32] = mem[_3451 + -(mem[_3451] % 32) + floor32(mem[_3451]) + 64 len mem[_3451] % 32]
        call address(cd[132]).mem[_3451 + 32 len 4] with:
           value _3431 wei
             gas gas_remaining wei
            args mem[_3451 + 36 len mem[_3451] - 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 32, 35, 0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45, mem[_3451 + 135 len 29]
            mem[_3451 + 32] = 32
            mem[_3451 + 64] = mem[(32 * ('cd', 100).length) + 128]
            _4583 = mem[(32 * ('cd', 100).length) + 128]
            mem[_3451 + 96 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
            return memory
              from mem[64]
               len (32 * _4583) + _3451 + -mem[64] + 96
        mem[64] = _3451 + ceil32(return_data.size) + 33
        mem[_3451 + 32] = return_data.size
        mem[_3451 + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            revert with 0, 
                        32,
                        35,
                        0x535472616e7366657248656c7065723a204554485f5452414e534645525f4641494c45,
                        mem[_3451 + ceil32(return_data.size) + 136 len 29]
        mem[_3451 + ceil32(return_data.size) + 33] = 32
        mem[_3451 + ceil32(return_data.size) + 65] = mem[(32 * ('cd', 100).length) + 128]
        _4586 = mem[(32 * ('cd', 100).length) + 128]
        mem[_3451 + ceil32(return_data.size) + 97 len floor32(mem[(32 * ('cd', 100).length) + 128])] = mem[(32 * ('cd', 100).length) + 160 len floor32(mem[(32 * ('cd', 100).length) + 128])]
        return 32, mem[_3451 + ceil32(return_data.size) + 65 len (32 * _4586) + 32]
    require return_data.size >= 32
    if not mem[(64 * ('cd', 100).length) + 324]:
        revert with 0, 
                    32,
