...
function downAllowance(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1
...
function upAllowance(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1
...
function destroyFrom(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
