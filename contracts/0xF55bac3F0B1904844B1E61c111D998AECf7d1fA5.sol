...
function sub_31f17857(?) payable {
    ...
    require ext_code.size(0x8a9b372af104c0c716a21b060e6f9de551b78f5d)
    delegate 0x8a9b372af104c0c716a21b060e6f9de551b78f5d.0x13d674fe with:
...
function sub_7f2f97b1(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0x6258f207b592c962232fec2147c5480637dcf720)
        delegate 0x6258f207b592c962232fec2147c5480637dcf720.0xfb960466 with:
             gas gas_remaining wei
...
function sub_5126dad7(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
        delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
        delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) payable {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0x37dbedcf9c63ac84b458fe0fa049e0bc242a3aa9)
        delegate 0x37dbedcf9c63ac84b458fe0fa049e0bc242a3aa9.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_f090df5d(?) payable {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0x37dbedcf9c63ac84b458fe0fa049e0bc242a3aa9)
        delegate 0x37dbedcf9c63ac84b458fe0fa049e0bc242a3aa9.0xc2d5b6ab with:
             gas gas_remaining wei
...
function sub_528f6b54(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x2c9e7d133c477e426c793371fda336fe1dde4fd2)
        delegate 0x2c9e7d133c477e426c793371fda336fe1dde4fd2.0xa7b9a567 with:
             gas gas_remaining wei
...
function sub_594161f8(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0x6258f207b592c962232fec2147c5480637dcf720)
        delegate 0x6258f207b592c962232fec2147c5480637dcf720.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
        delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x8c58f75038e8e8881cb0531722d26a369ec42e81)
            delegate 0x8c58f75038e8e8881cb0531722d26a369ec42e81.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
        delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) payable {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
        delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_c8d49a06(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x2c9e7d133c477e426c793371fda336fe1dde4fd2)
        delegate 0x2c9e7d133c477e426c793371fda336fe1dde4fd2.0x0 with:
             gas gas_remaining wei
...
function sub_d32ea8b6(?) payable {
    ...
    mem[516] = arg1
    require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
    delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_3367ad09(?) payable {
    ...
    require ('cd', 4)[13] < 21
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d)
    delegate 0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) payable {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d)
    delegate 0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) payable {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0x6258f207b592c962232fec2147c5480637dcf720)
        delegate 0x6258f207b592c962232fec2147c5480637dcf720.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
        delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_4dc26ae8(?) payable {
    ...
    mem[132] = 19
    require ext_code.size(0x2c9e7d133c477e426c793371fda336fe1dde4fd2)
    delegate 0x2c9e7d133c477e426c793371fda336fe1dde4fd2.0x45d85d80 with:
         gas gas_remaining wei
        args 19
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) payable {
    ...
    mem[132] = 14
    require ext_code.size(0x3b9898833f810f326d3192c0849dbd18d0a98277)
    delegate 0x3b9898833f810f326d3192c0849dbd18d0a98277.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_a05e1c7d(?) payable {
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[4] <= 0:
            ...
            require ext_code.size(0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d)
            delegate 0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d.mem[mem[64] len 4] with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d)
            delegate 0xb8ceaf0412838970afc54f5a57f556d00b8e6b6d.mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 640 len 4] with:
                 gas gas_remaining wei
...
function sub_a89a8884(?) payable {
    ...
    require ext_code.size(0x8a9b372af104c0c716a21b060e6f9de551b78f5d)
    delegate 0x8a9b372af104c0c716a21b060e6f9de551b78f5d.0x2d130914 with:
         gas gas_remaining wei
