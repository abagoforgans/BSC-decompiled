...
function sub_31f17857(?) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0xb3e7b14d84c8c3788fe2c452b46fa4ac625d4852)
    delegate 0xb3e7b14d84c8c3788fe2c452b46fa4ac625d4852.0x13d674fe with:
...
function approve(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0xd60d0aa5833070797309195ebd70b988aebacaef)
    delegate 0xd60d0aa5833070797309195ebd70b988aebacaef.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0xed1fcdb0d361538880cce340eabfade7add4e744)
        delegate 0xed1fcdb0d361538880cce340eabfade7add4e744.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    require arg2 == arg2
    require ext_code.size(0xd60d0aa5833070797309195ebd70b988aebacaef)
    delegate 0xd60d0aa5833070797309195ebd70b988aebacaef.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_5126dad7(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
        delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
        delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x9103502724441f0fc94f2485caf58adca4c61e01)
        delegate 0x9103502724441f0fc94f2485caf58adca4c61e01.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_f090df5d(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x9103502724441f0fc94f2485caf58adca4c61e01)
        delegate 0x9103502724441f0fc94f2485caf58adca4c61e01.0xc2d5b6ab with:
             gas gas_remaining wei
...
function sub_528f6b54(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x7b929a73a44740d0c7c8b7c429687e04e6bfb810)
        delegate 0x7b929a73a44740d0c7c8b7c429687e04e6bfb810.0xa7b9a567 with:
             gas gas_remaining wei
...
function sub_594161f8(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0xed1fcdb0d361538880cce340eabfade7add4e744)
        delegate 0xed1fcdb0d361538880cce340eabfade7add4e744.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
        delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0xd60d0aa5833070797309195ebd70b988aebacaef)
            delegate 0xd60d0aa5833070797309195ebd70b988aebacaef.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
        delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) payable {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
        delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_c8d49a06(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x7b929a73a44740d0c7c8b7c429687e04e6bfb810)
        delegate 0x7b929a73a44740d0c7c8b7c429687e04e6bfb810.0x0 with:
             gas gas_remaining wei
...
function sub_3367ad09(?) payable {
    ...
    require ('cd', 4)[13] < 20
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0x8419b2b733acb760e02b54ee792d4d0f1f6c95a9)
    delegate 0x8419b2b733acb760e02b54ee792d4d0f1f6c95a9.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) payable {
    ...
    require ('cd', 4)[13] < 20
    require ext_code.size(0x8419b2b733acb760e02b54ee792d4d0f1f6c95a9)
    delegate 0x8419b2b733acb760e02b54ee792d4d0f1f6c95a9.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) payable {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0xed1fcdb0d361538880cce340eabfade7add4e744)
        delegate 0xed1fcdb0d361538880cce340eabfade7add4e744.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_a05e1c7d(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + 608]:
            mem[t] = mem[s]
            idx = idx + 1
            s = s + 32
            t = t + 32
        ...
        require ('cd', 4)[13] < 20
        require ext_code.size(0x8419b2b733acb760e02b54ee792d4d0f1f6c95a9)
        delegate 0x8419b2b733acb760e02b54ee792d4d0f1f6c95a9.0x3b7e41e6 with:
             gas gas_remaining wei
            args 3, 14, 19, 21, 160, address(('cd', 4).length), address(('cd', 4)[0]), ('cd', 4)[1], 480, ('cd', 4)[3], ('cd', 4)[4], (32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + 512, ('cd', 4)[6], ('cd', 4)[7], ('cd', 4)[8], ('cd', 4)[9], ('cd', 4)[10], bool(('cd', 4)[11]), stor0, ('cd', 4)[13], cd[(cd[4] + ('cd', 4)[2] + 4)], mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 1316 len (32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + 608]) + 32]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
    revert with 0, 'Restricted'
}
...
function sub_017cbc35(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
        delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d32ea8b6(?) payable {
    ...
    mem[516] = arg1
    require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
    delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) payable {
    ...
    mem[132] = 14
    require ext_code.size(0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87)
    delegate 0x56d5b5cab7d339ce6e79bb6771ceb310ce9d1f87.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    while idx < _8:
        ...
        mem[_80] = mem[_5 + _7 + _66 + mem[_5 + _7 + _66 + 192] + 160]
...
function sub_4dc26ae8(?) payable {
    ...
    mem[132] = 19
    require ext_code.size(0x7b929a73a44740d0c7c8b7c429687e04e6bfb810)
    delegate 0x7b929a73a44740d0c7c8b7c429687e04e6bfb810.0x45d85d80 with:
         gas gas_remaining wei
        args 19
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) payable {
    ...
    mem[388] = arg1
    require ext_code.size(0xb3e7b14d84c8c3788fe2c452b46fa4ac625d4852)
    delegate 0xb3e7b14d84c8c3788fe2c452b46fa4ac625d4852.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0xd60d0aa5833070797309195ebd70b988aebacaef)
    delegate 0xd60d0aa5833070797309195ebd70b988aebacaef.0xc5bb51da with:
         gas gas_remaining wei
