...
function sub_be67c6c1(?) {
    ...
    require ext_code.size(0x131ffdef7756a8008378651c70bd355d4f43114e)
    delegate 0x131ffdef7756a8008378651c70bd355d4f43114e.0xcd7db54c with:
...
function sub_31f17857(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(0x308d4c8f57b0830dd04e20061e4195e7fe81bcf7)
    delegate 0x308d4c8f57b0830dd04e20061e4195e7fe81bcf7.0x13d674fe with:
         gas gas_remaining wei
...
function sub_b97c41a5(?) {
    if not sub_26f05442Address:
        return -1
    require ext_code.size(0x131ffdef7756a8008378651c70bd355d4f43114e)
    delegate 0x131ffdef7756a8008378651c70bd355d4f43114e.0xcc23f384 with:
         gas gas_remaining wei
...
function approve(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x738468d110beb57a76cdda60930b13c782a250a2)
    delegate 0x738468d110beb57a76cdda60930b13c782a250a2.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0x83c219bbbe2687135a8c70c8d9c2a386d908d9f9)
        delegate 0x83c219bbbe2687135a8c70c8d9c2a386d908d9f9.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2 == arg2
    require ext_code.size(0x738468d110beb57a76cdda60930b13c782a250a2)
    delegate 0x738468d110beb57a76cdda60930b13c782a250a2.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_5126dad7(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
        delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
        delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x54abcdf80a3e2afc17a8ae4e3ec87f8fc923b064)
        delegate 0x54abcdf80a3e2afc17a8ae4e3ec87f8fc923b064.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_a9f1866b(?) {
    require ext_code.size(0x131ffdef7756a8008378651c70bd355d4f43114e)
    delegate 0x131ffdef7756a8008378651c70bd355d4f43114e.0x5bb709aa with:
         gas gas_remaining wei
        args 3, 30
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_594161f8(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0x83c219bbbe2687135a8c70c8d9c2a386d908d9f9)
        delegate 0x83c219bbbe2687135a8c70c8d9c2a386d908d9f9.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
        delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x738468d110beb57a76cdda60930b13c782a250a2)
            delegate 0x738468d110beb57a76cdda60930b13c782a250a2.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
        delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
        delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_3367ad09(?) {
    ...
    require ('cd', 4)[13] < 21
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0xd5e1825fab991ea1fb59729ed8519168902ca068)
    delegate 0xd5e1825fab991ea1fb59729ed8519168902ca068.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0xd5e1825fab991ea1fb59729ed8519168902ca068)
    delegate 0xd5e1825fab991ea1fb59729ed8519168902ca068.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0x83c219bbbe2687135a8c70c8d9c2a386d908d9f9)
        delegate 0x83c219bbbe2687135a8c70c8d9c2a386d908d9f9.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
        delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d32ea8b6(?) {
    ...
    mem[516] = arg1
    require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
    delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) {
    ...
    mem[132] = 14
    require ext_code.size(0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f)
    delegate 0xce62b2eb2f952a60ae2be30e9cdc0d7ccb38977f.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    ...
    mem[388] = arg1
    require ext_code.size(0x308d4c8f57b0830dd04e20061e4195e7fe81bcf7)
    delegate 0x308d4c8f57b0830dd04e20061e4195e7fe81bcf7.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x738468d110beb57a76cdda60930b13c782a250a2)
    delegate 0x738468d110beb57a76cdda60930b13c782a250a2.0xc5bb51da with:
         gas gas_remaining wei
...
function sub_a05e1c7d(?) {
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[4] <= 0:
            ...
            require ('cd', 4)[13] < 21
            require ext_code.size(0xd5e1825fab991ea1fb59729ed8519168902ca068)
            delegate 0xd5e1825fab991ea1fb59729ed8519168902ca068.0x3b7e41e6 with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0xd5e1825fab991ea1fb59729ed8519168902ca068)
            delegate 0xd5e1825fab991ea1fb59729ed8519168902ca068.mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 640 len 4] with:
                 gas gas_remaining wei
