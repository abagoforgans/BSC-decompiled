...
function sub_c7fc51e6(?) {
    ...
    call sub_a3f38bb4Address.transferOwnership(address rg1) with:
...
function sub_4724930b(?) {
    ...
    require arg1 == address(arg1)
    require ext_code.size(sub_a3f38bb4Address)
    staticcall sub_a3f38bb4Address.balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(arg1)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function endCrowdsale() {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(sub_a3f38bb4Address)
        call sub_a3f38bb4Address.burn(uint256 rg1) with:
             gas gas_remaining wei
...
function sub_9e14aff5(?) payable {
    ...
    if not msg.value:
        ...
        require ext_code.size(sub_a3f38bb4Address)
        call sub_a3f38bb4Address.transfer(address rg1, uint256 rg2) with:
             gas gas_remaining wei
