...
#  - _fallback()
#
const name = 'Traditional Grimace', 0

const decimals = 9

const symbol = 'TRAMACE', 0
...
function setAutoBuybackSettings(bool arg1, uint256 arg2, uint256 arg3, uint256 arg4, bool arg5) {
    ...
    Mask(248, 0, stor29.field_8) = Mask(248, 0, arg5)
...
function getMultipliedFee() {
    ...
    if not stor17:
        ...
        if not stor28:
            revert with 0, 'SafeMath: division by zero', 0
        if stor17 > !((stor27 * 0 / stor26) + (stor28 * 0 / stor26) - (block.timestamp * 0 / stor26) - (stor27 * stor17) - (stor28 * stor17) + (block.timestamp * stor17) / stor28):
            revert with 0, 17
    ...
    if not stor28:
        revert with 0, 'SafeMath: division by zero', 0
    if stor17 > !((stor27 * stor17 * stor25 / stor26) + (stor28 * stor17 * stor25 / stor26) - (block.timestamp * stor17 * stor25 / stor26) - (stor27 * stor17) - (stor28 * stor17) + (block.timestamp * stor17) / stor28):
        revert with 0, 17
