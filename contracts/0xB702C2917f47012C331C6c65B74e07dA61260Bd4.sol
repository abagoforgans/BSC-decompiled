...
function transfer(address arg1, uint256 arg2) {
    ...
    require arg1 == arg1
    require arg2 == arg2
    revert with 0, 'Not transferable'
}

function toggleWhitelisting() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint256(stor19.field_0) = not bool(onlyWhitelisted) or Mask(248, 8, uint256(stor19.field_0))
}
...
function buyTokens() payable {
    ...
    if totalSupply > -(msg.value * rate / 10^18) - 1:
        revert with 'NH{q', 17
    totalSupply += msg.value * rate / 10^18
    if balanceOf[address(msg.sender)] > -(msg.value * rate / 10^18) - 1:
        revert with 'NH{q', 17
