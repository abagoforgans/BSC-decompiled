...
function sub_281a320f(?) {
    ...
    if sub_2d7f13afAddress != sub_cc2ca7a5Address:
        ...
        if sub_2d7f13afAddress == sub_cc2ca7a5Address:
            ...
            if _269 - 1 >= mem[ceil32(return_data.size) + 224]:
                revert with 'NH{q', 50
            return memory
              from (32 * _269 - 1) + ceil32(return_data.size) + 256
               len 32
        _182 = mem[64]
        mem[mem[64]] = 3
        mem[64] = mem[64] + 128
        ...
        if _268 - 1 >= mem[ceil32(return_data.size) + 224]:
            revert with 'NH{q', 50
        return memory
          from (32 * _268 - 1) + ceil32(return_data.size) + 256
           len 32
    mem[96] = 2
    mem[128] = sub_cc2ca7a5Address
    mem[160] = stor6
    ...
    if sub_2d7f13afAddress == sub_cc2ca7a5Address:
        ...
        if _271 - 1 >= mem[ceil32(return_data.size) + 192]:
            revert with 'NH{q', 50
        return memory
          from (32 * _271 - 1) + ceil32(return_data.size) + 224
           len 32
    _184 = mem[64]
    mem[mem[64]] = 3
    mem[64] = mem[64] + 128
...
function sub_13dab3c8(?) {
    ...
    if sub_2d7f13afAddress != sub_cc2ca7a5Address:
        ...
        mem[(2 * ceil32(return_data.size)) + 224] = _108
        ...
        if sub_2d7f13afAddress == sub_cc2ca7a5Address:
            ...
            if _273 - 1 >= mem[(2 * ceil32(return_data.size)) + 224]:
                revert with 'NH{q', 50
            return (mem[(32 * _273 - 1) + (2 * ceil32(return_data.size)) + 256] > ext_call.return_data[0])
        _186 = mem[64]
        mem[mem[64]] = 3
        mem[64] = mem[64] + 128
        if 0 >= mem[_186]:
        ...
        if _272 - 1 >= mem[(2 * ceil32(return_data.size)) + 224]:
            revert with 'NH{q', 50
        return (mem[(32 * _272 - 1) + (2 * ceil32(return_data.size)) + 256] > ext_call.return_data[0])
    ...
    if sub_2d7f13afAddress == sub_cc2ca7a5Address:
        ...
        if _275 - 1 >= mem[(2 * ceil32(return_data.size)) + 192]:
            revert with 'NH{q', 50
        return (mem[(32 * _275 - 1) + (2 * ceil32(return_data.size)) + 224] > ext_call.return_data[0])
    _188 = mem[64]
    mem[mem[64]] = 3
    mem[64] = mem[64] + 128
    if 0 >= mem[_188]:
