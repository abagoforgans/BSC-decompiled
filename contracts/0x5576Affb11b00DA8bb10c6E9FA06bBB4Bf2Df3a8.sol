...
function sub_0381eebf(?) payable {
    require ext_code.size(stor0)
    staticcall stor0.0x65555bcc with:
            gas gas_remaining wei
           args 64, 128, 3, 'XXX', 3, 'XXX'
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    require bool(ceil32(return_data.size) + 288 <= test266151307())
...
function sub_09ec1383(?) payable {
    require ext_code.size(stor0)
    staticcall stor0.0x65555bcc with:
            gas gas_remaining wei
           args 64, 128, 3, 'XXX', 3, 'USD'
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    require bool(ceil32(return_data.size) + 288 <= test266151307())
...
function sub_c2573642(?) payable {
    require ext_code.size(stor0)
    staticcall stor0.0x65555bcc with:
            gas gas_remaining wei
           args 64, 128, 3, 'USD', 3, 'XXX'
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    require bool(ceil32(return_data.size) + 288 <= test266151307())
