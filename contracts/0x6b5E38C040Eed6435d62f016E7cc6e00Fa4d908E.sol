...
const sub_850c0bd6(?) = 80, 30, 40, 0, 0, 150, 1000
    ...
    if not stor16:
        call routerAddress.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
           value eth.balance(this.address) wei
            ...
            args 0, 0, balanceOf[this.address].field_0, balanceOf[this.address].field_0, eth.balance(this.address), stor1, block.timestamp
