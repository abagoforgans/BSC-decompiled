        ...
        if not return_data.size:
            ...
            if not msg.sender, Mask(96, 64, arg1) >> 64:
                revert with 0, 
                            ...
                            uint32(arg2),
                            mem[712 len 4]
            mem[716 len 96] = unknown_0x23b872dd(?????), msg.sender, address(deadAddress), Mask(224, 32, arg3) >> 32
            ...
            if not ext_call.success:
                revert with 0, 
                            ...
                            mem[ceil32(return_data.size) + 689 len 28]
            if not return_data.size:
                mem[ceil32(return_data.size) + 717 len 96] = unknown_0x23b872dd(?????), msg.sender, address(deadAddress), Mask(224, 32, arg3) >> 32
