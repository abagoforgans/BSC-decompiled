...
const autov2 = 0xa184088a740c695e156f91f5cc086a06bb78b827
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        if not return_data.size:
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address rg1, uint256 rg2), 0x895196562c7868c5be92459, 0, ext_call.return_data[0 len 28]
            call lpPairAddress.0xed450452 with:
                 gas gas_remaining wei
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), 0x895196562c7868c5be92459, 0, ext_call.return_data[0 len 28]
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor2)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 617 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor2)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 617 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor2)
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 617 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), Mask(224, 32, arg1 - (50 * arg1 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor2)
                     gas gas_remaining wei
