    ...
    if not arg3:
        ...
        if poolInfo[arg1].field_256 != arg2:
            ...
            while idx < poolInfo.length:
                ...
                continue 
            if -stor[(4 * stor6.length) + _207 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _207 + 1]):
                require 0 < poolInfo.length
                if uint256(poolInfo.field_256) > totalAllocPoint:
                    revert with 0, 'SafeMath: subtraction overflow'
                if -stor[(4 * stor6.length) + _207 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _207 + 1]) / 3 < 0:
                    revert with 0, 'SafeMath: addition overflow'
                totalAllocPoint = (-stor[(4 * stor6.length) + _207 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _207 + 1]) / 3) + totalAllocPoint - uint256(poolInfo.field_256)
                require 0 < poolInfo.length
                uint256(poolInfo.field_256) = -stor[(4 * stor6.length) + _207 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _207 + 1]) / 3
    else:
        idx = 0
        while idx < poolInfo.length:
            mem[0] = 6
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _275 + 68] = mem[idx + _270 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _345 + 68] = mem[idx + _332 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER):
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _279 + 68] = mem[idx + _273 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _352 + 68] = mem[idx + _336 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * BONUS_MULTIPLIER * cakePerBlock) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * cakePerBlock):
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _349 + 68] = mem[idx + _335 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _359 + 68] = mem[idx + _341 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _286 + 68] = mem[idx + _278 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * BONUS_MULTIPLIER * cakePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * cakePerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _356 + 68] = mem[idx + _340 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _366 + 68] = mem[idx + _348 + 32]
                idx = idx + 32
                continue 
        ...
        if poolInfo[arg1].field_256 != arg2:
            ...
            while idx < poolInfo.length:
                ...
                s = poolInfo[idx].field_256 + s
                continue 
            if -stor[(4 * stor6.length) + _429 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _429 + 1]):
                require 0 < poolInfo.length
                if uint256(poolInfo.field_256) > totalAllocPoint:
                    revert with 0, 'SafeMath: subtraction overflow'
                if -stor[(4 * stor6.length) + _429 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _429 + 1]) / 3 < 0:
                    revert with 0, 'SafeMath: addition overflow'
                totalAllocPoint = (-stor[(4 * stor6.length) + _429 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _429 + 1]) / 3) + totalAllocPoint - uint256(poolInfo.field_256)
                require 0 < poolInfo.length
                uint256(poolInfo.field_256) = -stor[(4 * stor6.length) + _429 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _429 + 1]) / 3
}
    ...
    if not arg3:
        ...
        if block.number > startBlock:
            ...
            while idx < poolInfo.length:
                ...
                s = poolInfo[idx].field_256 + s
                continue 
            if -stor[(4 * stor6.length) + _433 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _433 + 1]):
                require 0 < poolInfo.length
                if uint256(poolInfo.field_256) > totalAllocPoint:
                    revert with 0, 'SafeMath: subtraction overflow'
                if -stor[(4 * stor6.length) + _433 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _433 + 1]) / 3 < 0:
                    revert with 0, 'SafeMath: addition overflow'
                totalAllocPoint = (-stor[(4 * stor6.length) + _433 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _433 + 1]) / 3) + totalAllocPoint - uint256(poolInfo.field_256)
                require 0 < poolInfo.length
                uint256(poolInfo.field_256) = -stor[(4 * stor6.length) + _433 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _433 + 1]) / 3
        else:
            ...
            while idx < poolInfo.length:
                ...
                s = poolInfo[idx].field_256 + s
                continue 
            if -stor[(4 * stor6.length) + _434 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _434 + 1]):
                require 0 < poolInfo.length
                if uint256(poolInfo.field_256) > totalAllocPoint:
                    revert with 0, 'SafeMath: subtraction overflow'
                if -stor[(4 * stor6.length) + _434 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _434 + 1]) / 3 < 0:
                    revert with 0, 'SafeMath: addition overflow'
                totalAllocPoint = (-stor[(4 * stor6.length) + _434 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _434 + 1]) / 3) + totalAllocPoint - uint256(poolInfo.field_256)
                require 0 < poolInfo.length
                uint256(poolInfo.field_256) = -stor[(4 * stor6.length) + _434 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _434 + 1]) / 3
    else:
        idx = 0
        while idx < poolInfo.length:
            mem[0] = 6
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _283 + 68] = mem[idx + _278 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _345 + 68] = mem[idx + _336 + 32]
                        idx = idx + 32
                        continue 
                    mem[_345 + 68] = mem[_345 + 74 len 26]
                    revert with memory
            ...
            if not (block.number * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER):
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _287 + 68] = mem[idx + _281 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _350 + 68] = mem[idx + _339 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _360 + 68] = mem[idx + _344 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * BONUS_MULTIPLIER * cakePerBlock) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * cakePerBlock):
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _290 + 68] = mem[idx + _282 + 32]
                        idx = idx + 32
                        continue 
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _294 + 68] = mem[idx + _286 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _374 + 68] = mem[idx + _356 + 32]
                idx = idx + 32
                continue 
        ...
        if block.number > startBlock:
            ...
            while idx < poolInfo.length:
                ...
                s = poolInfo[idx].field_256 + s
                continue 
            if -stor[(4 * stor6.length) + _541 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _541 + 1]):
                require 0 < poolInfo.length
                if uint256(poolInfo.field_256) > totalAllocPoint:
                    revert with 0, 'SafeMath: subtraction overflow'
                if -stor[(4 * stor6.length) + _541 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _541 + 1]) / 3 < 0:
                    revert with 0, 'SafeMath: addition overflow'
                totalAllocPoint = (-stor[(4 * stor6.length) + _541 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _541 + 1]) / 3) + totalAllocPoint - uint256(poolInfo.field_256)
                require 0 < poolInfo.length
                uint256(poolInfo.field_256) = -stor[(4 * stor6.length) + _541 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _541 + 1]) / 3
        else:
            storF652[stor6.length] = startBlock
            storF652[stor6.length] = 0
            idx = 1
            ...
            while idx < poolInfo.length:
                ...
                s = poolInfo[idx].field_256 + s
                continue 
            if -stor[(4 * stor6.length) + _542 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _542 + 1]):
                require 0 < poolInfo.length
                if uint256(poolInfo.field_256) > totalAllocPoint:
                    revert with 0, 'SafeMath: subtraction overflow'
                if -stor[(4 * stor6.length) + _542 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _542 + 1]) / 3 < 0:
                    revert with 0, 'SafeMath: addition overflow'
                totalAllocPoint = (-stor[(4 * stor6.length) + _542 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _542 + 1]) / 3) + totalAllocPoint - uint256(poolInfo.field_256)
                require 0 < poolInfo.length
                uint256(poolInfo.field_256) = -stor[(4 * stor6.length) + _542 + 1] + (poolInfo.length * stor[(4 * stor6.length) + _542 + 1]) / 3
}
            ...
            if not block.number - uint256(poolInfo.field_512):
                ...
                if not (block.number * BONUS_MULTIPLIER) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER):
                    ...
                    if not (block.number * BONUS_MULTIPLIER * cakePerBlock) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * cakePerBlock):
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if (block.number * BONUS_MULTIPLIER * cakePerBlock * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * cakePerBlock * uint256(poolInfo.field_256)) / totalAllocPoint:
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    if arg1 >= poolInfo.length:
        revert with 0, 'validatePool: pool exists?'
    if not arg1:
        revert with 0, 'withdraw BANANA by unstaking'
    require arg1 < poolInfo.length
            ...
            if not block.number - poolInfo[arg1].field_512:
                ...
                if not (block.number * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER):
                    ...
                    if not (block.number * BONUS_MULTIPLIER * cakePerBlock) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * cakePerBlock):
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if (block.number * BONUS_MULTIPLIER * cakePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * cakePerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                            if 10^12 * (block.number * BONUS_MULTIPLIER * cakePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * cakePerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * BONUS_MULTIPLIER * cakePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * cakePerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                            if not ext_call.return_data[0]:
                                revert with 0, 'SafeMath: division by zero'
...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    if arg1 >= poolInfo.length:
        revert with 0, 'validatePool: pool exists?'
    if not arg1:
        revert with 0, 'deposit BANANA by staking'
    require arg1 < poolInfo.length
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][msg.sender].field_0:
            if not arg2:
