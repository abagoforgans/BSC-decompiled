...
function sub_072f07d3(?) payable {
    ...
    if arg1 > allowance[address(arg2)][address(msg.sender)]:
    ...
    allowance[address(arg2)][address(msg.sender)] -= arg1
    emit Approval((allowance[address(arg2)][address(msg.sender)] - arg1), arg2, msg.sender);
    return 1
}
