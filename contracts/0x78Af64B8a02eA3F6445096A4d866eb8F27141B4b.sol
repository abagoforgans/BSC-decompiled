...
function setPrices(address[] arg1, uint256[] arg2) {
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            mem[_5601 + 160] = 0
            mem[_5601 + 192] = 0
            mem[_5601 + 128] = (block.number / 240) + 1
            mem[0] = address(_5587)
    ...
    mem[(32 * arg2.length) + (32 * arg1.length) + 192 len 32 * arg1.length] = code.data[5426 len 32 * arg1.length]
    idx = 0
    while idx < arg1.length:
        require idx < mem[96]
        ...
        mem[_5604 + 160] = 0
        mem[_5604 + 192] = 0
        mem[_5604 + 128] = (block.number / 240) + 1
        mem[0] = address(_5589)
                                    ...
                                    if not _5598:
                                        ...
                                        if not pendingAnchors[address(_5589)]:
                                            if (block.number / 240) + 1 <= 0:
                                                ...
                                                _6167 = mem[64]
                                                mem[64] = mem[64] + 64
                                                mem[_6167] = (block.number / 240) + 1
                                                mem[_6167 + 32] = _5598
                                                anchors[address(_5589)].field_0 = (block.number / 240) + 1
                ...
                if not anchors[address(_5589)].field_0:
                    ...
                    if not _5598:
                        ...
                        if not _5598:
                            ...
                            mem[32] = 8
                            if not pendingAnchors[address(_5589)]:
                                if (block.number / 240) + 1 <= anchors[address(_5589)].field_0:
                                    mem[0] = address(_5589)
                                    _5730 = mem[64]
                                    mem[64] = mem[64] + 32
                                    mem[_5730] = _5598
