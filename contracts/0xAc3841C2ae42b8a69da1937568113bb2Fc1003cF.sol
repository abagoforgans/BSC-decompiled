...
function pendingRewards(address arg1) payable {
    ...
    staticcall stor11.0xa230c524 with:
            gas gas_remaining wei
           args arg1
    ...
    mem[64] = ceil32(return_data.size) + (32 * userInfo[address(arg1)].field_768) + 256
    mem[ceil32(return_data.size) + 224] = userInfo[address(arg1)].field_768
    s = ceil32(return_data.size) + 256
    idx = 0
    while idx < userInfo[address(arg1)].field_768:
        mem[0] = sha3(address(arg1), 1) + 3
        _23 = mem[64]
        mem[64] = mem[64] + 64
        mem[_23] = stor[(2 * idx) + ('array', 3, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'userInfo', 1)))].field_0
        mem[_23 + 32] = stor[(2 * idx) + ('array', 3, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'userInfo', 1)))].field_256
        mem[s] = _23
        s = s + 32
        idx = idx + 1
        continue 
    mem[ceil32(return_data.size) + 192] = ceil32(return_data.size) + 224
    ...
    if block.timestamp >= sub_76bf0884 + poolDuration:
        ...
        if not ext_call.return_data[0]:
            mem[mem[64]] = (sub_76bf0884 * mem[ceil32(return_data.size) + 96] * stor6) + (poolDuration * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18
        else:
            if (sub_76bf0884 * mem[ceil32(return_data.size) + 96] * stor6) + (poolDuration * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18 and stor10 > -1 / (sub_76bf0884 * mem[ceil32(return_data.size) + 96] * stor6) + (poolDuration * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18:
                revert with 'NH{q', 17
            mem[mem[64]] = (sub_76bf0884 * mem[ceil32(return_data.size) + 96] * stor6) + (poolDuration * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18 * stor10 / 100
    else:
        ...
        if (block.timestamp * mem[ceil32(return_data.size) + 96]) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96]) and stor6 > -1 / (block.timestamp * mem[ceil32(return_data.size) + 96]) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96]):
            revert with 'NH{q', 17
        if not ext_call.return_data[0]:
            mem[mem[64]] = (block.timestamp * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18
        else:
            if (block.timestamp * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18 and stor10 > -1 / (block.timestamp * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18:
                revert with 'NH{q', 17
            mem[mem[64]] = (block.timestamp * mem[ceil32(return_data.size) + 96] * stor6) - (mem[ceil32(return_data.size) + 128] * mem[ceil32(return_data.size) + 96] * stor6) / 10^18 * stor10 / 100
    return memory
      from mem[64]
       len 32
}
...
function withdraw(uint256 arg1) payable {
        ...
        if block.timestamp >= sub_76bf0884 + poolDuration:
            ...
            if (sub_76bf0884 * userInfo[address(msg.sender)].field_0 * stor6) + (poolDuration * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18 > 0:
                if not ext_call.return_data[0]:
                    ...
                    call stor5.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, (sub_76bf0884 * userInfo[address(msg.sender)].field_0 * stor6) + (poolDuration * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18
                else:
                    if (sub_76bf0884 * userInfo[address(msg.sender)].field_0 * stor6) + (poolDuration * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18 and stor10 > -1 / (sub_76bf0884 * userInfo[address(msg.sender)].field_0 * stor6) + (poolDuration * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18:
                        revert with 'NH{q', 17
                    require ext_code.size(stor5)
                    call stor5.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, (sub_76bf0884 * userInfo[address(msg.sender)].field_0 * stor6) + (poolDuration * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18 * stor10 / 100
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
            ...
            if (block.timestamp * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18 > 0:
                if not ext_call.return_data[0]:
                    ...
                    call stor5.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, (block.timestamp * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18
                else:
                    if (block.timestamp * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18 and stor10 > -1 / (block.timestamp * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18:
                        revert with 'NH{q', 17
                    require ext_code.size(stor5)
                    call stor5.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, (block.timestamp * userInfo[address(msg.sender)].field_0 * stor6) - (userInfo[address(msg.sender)].field_256 * userInfo[address(msg.sender)].field_0 * stor6) / 10^18 * stor10 / 100
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    if arg1 > 0:
        ...
        stor[(2 * userInfo[address(msg.sender)].field_768) + ('array', 3, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'userInfo', 1)))].field_0 = userInfo[address(msg.sender)].field_0
        stor[(2 * userInfo[address(msg.sender)].field_768) + ('array', 3, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'userInfo', 1)))].field_256 = block.timestamp
}
...
function deposit(uint256 arg1) payable {
    ...
    if arg1 > 0:
        ...
        if stakedAmount + arg1 > sub_05fa32fd:
            revert with 0, 'Staking: Max staking limit has been reached.'
        if sub_76bf0884 > -poolDuration - 1:
            revert with 'NH{q', 17
        if sub_76bf0884 + poolDuration < block.timestamp:
            revert with 0, 'Staking: Staking has already ended.'
        require ext_code.size(stakeTokenAddress)
