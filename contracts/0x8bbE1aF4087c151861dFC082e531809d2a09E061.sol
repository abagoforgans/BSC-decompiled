...
#  - _fallback()
#
const name = 'Firstdogking', 0

const totalSupply = 10000000 * 10^18

const decimals = 9

const symbol = 'Fdogking', 0
...
function balanceOf(address arg1) {
    ...
    if not stor6 / 10000000 * 10^18:
        revert with 0, 'SafeMath: division by zero', 0
    return (stor2[address(arg1)] / stor6 / 10000000 * 10^18)
}
...
function manualswap() {
    ...
    allowance[address(this.address)][stor16] = stor2[address(this.address)] / stor6 / 10000000 * 10^18
    emit Approval((stor2[address(this.address)] / stor6 / 10000000 * 10^18), this.address, uniswapV2RouterAddress);
    mem[ceil32(return_data.size) + 384] = 0x791ac94700000000000000000000000000000000000000000000000000000000
    mem[ceil32(return_data.size) + 388] = stor2[address(this.address)] / stor6 / 10000000 * 10^18
    idx = 0
    ...
    call uniswapV2RouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args stor2[address(this.address)] / stor6 / 10000000 * 10^18, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 580 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
