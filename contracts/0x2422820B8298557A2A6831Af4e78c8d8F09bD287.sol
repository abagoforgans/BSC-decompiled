...
function _fallback() payable {
    ...
    mem[96 len -5530] = code.data[6040 len -5530]
    mem[64] = -5434
    stor0 = msg.sender
...
function AirTransfer(address[] arg1, uint256[] arg2, address arg3) {
    ...
    while idx < arg1.length:
        ...
        mem[(32 * arg1.length) + (32 * arg2.length) + 164] = address(_15)
        mem[(32 * arg1.length) + (32 * arg2.length) + 196] = 10^18 * _17
        require ext_code.size(arg3)
        call arg3.0xa9059cbb with:
             gas gas_remaining - 710 wei
            args address(_15), 10^18 * _17
        require ext_call.success
        idx = idx + 1
        continue 
    return 1
