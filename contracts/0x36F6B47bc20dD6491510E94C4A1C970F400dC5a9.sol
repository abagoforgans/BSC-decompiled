...
function unlock() payable {
    ...
    if block.number < lockFromBlock:
        ...
        if 0 <= balanceOf[address(this.address)]:
            ...
            if not this.address:
                if balanceOf[address(this.address)] + totalSupply < totalSupply:
                    revert with 0, 'SafeMath: addition overflow'
                if balanceOf[address(this.address)] + totalSupply > cap:
                    revert with 0, 'ERC20Capped: cap exceeded'
        ...
        if block.number >= lockToBlock:
            ...
            if lockOf[address(msg.sender)] <= balanceOf[address(this.address)]:
                if not this.address:
                    if lockOf[address(msg.sender)] + totalSupply < totalSupply:
                        revert with 0, 'SafeMath: addition overflow'
                    if lockOf[address(msg.sender)] + totalSupply > cap:
                        revert with 0, 'ERC20Capped: cap exceeded'
                if lockOf[address(msg.sender)] > balanceOf[address(this.address)]:
                    revert with 0, 
                                32,
            ...
            if not lockOf[address(msg.sender)]:
                ...
                if 0 / lockToBlock - lastUnlockBlock[address(msg.sender)] <= balanceOf[address(this.address)]:
                    if not this.address:
                        if (0 / lockToBlock - lastUnlockBlock[address(msg.sender)]) + totalSupply < totalSupply:
                            revert with 0, 'SafeMath: addition overflow'
                        if (0 / lockToBlock - lastUnlockBlock[address(msg.sender)]) + totalSupply > cap:
                            revert with 0, 'ERC20Capped: cap exceeded'
                    if 0 / lockToBlock - lastUnlockBlock[address(msg.sender)] > balanceOf[address(this.address)]:
                        revert with 0, 
                                    32,
                ...
                if (block.number * lockOf[address(msg.sender)]) - (lastUnlockBlock[address(msg.sender)] * lockOf[address(msg.sender)]) / lockToBlock - lastUnlockBlock[address(msg.sender)] <= balanceOf[address(this.address)]:
                    if not this.address:
                        if ((block.number * lockOf[address(msg.sender)]) - (lastUnlockBlock[address(msg.sender)] * lockOf[address(msg.sender)]) / lockToBlock - lastUnlockBlock[address(msg.sender)]) + totalSupply < totalSupply:
                            revert with 0, 'SafeMath: addition overflow'
                        if ((block.number * lockOf[address(msg.sender)]) - (lastUnlockBlock[address(msg.sender)] * lockOf[address(msg.sender)]) / lockToBlock - lastUnlockBlock[address(msg.sender)]) + totalSupply > cap:
                            revert with 0, 'ERC20Capped: cap exceeded'
                    if (block.number * lockOf[address(msg.sender)]) - (lastUnlockBlock[address(msg.sender)] * lockOf[address(msg.sender)]) / lockToBlock - lastUnlockBlock[address(msg.sender)] > balanceOf[address(this.address)]:
                        revert with 0, 
                                    32,
