...
function pancakeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) {
    ...
    if msg.sender != 0xa527a61703d82139f8a06bc30097cc9caa2df5a6:
...
function sub_baab6892(?) {
    ...
    if mem[(32 * _50 - 1) + ceil32(return_data.size) + 128] <= cd[68] + (3 * cd[36] / 997) + 1:
        revert with 0, 'U1'
    require ext_code.size(0xa527a61703d82139f8a06bc30097cc9caa2df5a6)
    staticcall 0xa527a61703d82139f8a06bc30097cc9caa2df5a6.token0() with:
            gas gas_remaining wei
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(0xa527a61703d82139f8a06bc30097cc9caa2df5a6)
    staticcall 0xa527a61703d82139f8a06bc30097cc9caa2df5a6.token1() with:
            gas gas_remaining wei
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if address(cd[4]) == address(_99):
        if address(cd[4]) == mem[_102 + 12 len 20]:
            ...
            require ext_code.size(0xa527a61703d82139f8a06bc30097cc9caa2df5a6)
            call 0xa527a61703d82139f8a06bc30097cc9caa2df5a6.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                 gas gas_remaining wei
