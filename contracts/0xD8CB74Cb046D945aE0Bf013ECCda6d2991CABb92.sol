                    ...
                    if idx:
                        ...
                        if arg2.length == 1:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_1790])] = 256^(-(mem[_1790] % 32) + 32) - 1 and mem[mem[64] + floor32(mem[_1790])] or mem[_1790 + floor32(mem[_1790]) + 32] and !(256^(-(mem[_1790] % 32) + 32) - 1)
                            mem[0] = sha3(mem[mem[64] len _1789 + _1792 + -mem[64] + 66])
                            mem[32] = 2
                            nextValidator[mem[0]] = 0xffffffffffffffffffffffffffffffffffffffff
                else:
                    _841 = mem[64]
