                        ...
                        if s <= ext_call.return_data[0]:
                            if not s / 100:
                                ...
                                if not return_data.size:
                                    ...
                                    if not unknown_0xa9059cbb(?????), Mask(224, 0, stor2):
                                        revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                    mem[296 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, s - (5 * s / 100)) >> 32
                                    call tokenAAddress with:
                                       funct uint32(stor1)
                                         gas gas_remaining wei
                                        args Mask(224, 32, s - (5 * s / 100)) << 224, mem[360 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor2):
                                    ...
                                    if return_data.size:
                                        ...
                                        if not mem[228]:
                                            revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                    mem[ceil32(return_data.size) + 297 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, s - (5 * s / 100)) >> 32
                                    mem[ceil32(return_data.size) + 389 len 4] = Mask(32, 64, s - (5 * s / 100)) >> 64
                                    call tokenAAddress with:
                                       funct uint32(stor1)
                                         gas gas_remaining wei
                                        args Mask(224, 32, s - (5 * s / 100)) << 224, mem[ceil32(return_data.size) + 361 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor2):
                                        ...
                                        if return_data.size:
                                            ...
                                            if not mem[ceil32(return_data.size) + 329]:
                                                revert with 0, 
                                                            'TransferHelper: TRANSFER_FAILED',
                                                            mem[(2 * ceil32(return_data.size)) + 398 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                                        emit 0xc1cb9884: s, block.timestamp, mem[(2 * ceil32(return_data.size)) + 362 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        else:
                        ...
                        if sub_7393716a[stor5 + stor6 - stor4 / stor7].field_0 > ext_call.return_data[0]:
                            ...
                            if not sub_7393716a[stor5 + stor6 - stor4 / stor7].field_0 / 100:
                                ...
                                if not return_data.size:
                                    ...
                                    if not unknown_0xa9059cbb(?????), Mask(224, 0, stor2):
                                        revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                    mem[296 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), sub_7393716a[stor5 + stor6 - stor4 / stor7].field_32
                                    call tokenAAddress with:
                                       funct uint32(stor1)
                                         gas gas_remaining wei
                                        args sub_7393716a[stor5 + stor6 - stor4 / stor7].field_0, mem[360 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor2):
                                    ...
                                    if return_data.size:
                                        ...
                                        if not mem[228]:
                                            revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                    mem[ceil32(return_data.size) + 297 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), sub_7393716a[stor5 + stor6 - stor4 / stor7].field_32
                                    mem[ceil32(return_data.size) + 389 len 4] = sub_7393716a[stor5 + stor6 - stor4 / stor7].field_64
                                    call tokenAAddress with:
                                       funct uint32(stor1)
                                         gas gas_remaining wei
                                        args sub_7393716a[stor5 + stor6 - stor4 / stor7].field_0, mem[ceil32(return_data.size) + 361 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor2):
