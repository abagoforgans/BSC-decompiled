...
function sub_ae3fd8bb(?) {
    return sub_ae3fd8bbAddress
}
...
function sub_69e90869(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}

function sub_7cf2bd30(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}

function sub_94c4667f(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}
...
function MarketingFee(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_000619c5 = arg1
        ...
        if unknown_0xa9059cbb(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x8da5cb5b(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x715018a6(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0x728d41c9(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 32
                        if owner != msg.sender:
                            revert with 0, 'Ownable: caller is not the owner'
                        ...
                        if uint32(call.func_hash) >> 224 != unknown_0x7cf2bd30(?????):
            ...
            if unknown_0x8da5cb5b(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return owner
            if unknown_0x94c4667f(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 32
                if owner != msg.sender:
                    revert with 0, 'Ownable: caller is not the owner'
            ...
            if unknown_0x97603560(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 32
                if owner != msg.sender:
                    revert with 0, 'Ownable: caller is not the owner'
            ...
            if unknown_0xdd62ed3e(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0xdd62ed3e(?????) == uint32(call.func_hash) >> 224:
                    ...
                    return allowance[address(arg1)][address(arg2)]
                if unknown_0xeb33de19(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 32
                    if owner != msg.sender:
                        revert with 0, 'Ownable: caller is not the owner'
            ...
            if uint32(call.func_hash) >> 224 != unknown_0xa9059cbb(?????):
                if unknown_0xae3fd8bb(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return sub_ae3fd8bbAddress
                if unknown_0xd621e813(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return bool(stor15)
                require unknown_0xd78ddca7(?????) == uint32(call.func_hash) >> 224
                require not msg.value
                return taxLiquidity
            require not msg.value
            require calldata.size - 4 >= 64
            ...
            if not arg2:
                ...
                if pairAddress == msg.sender:
                    ...
                    if sub_ae3fd8bbAddress == msg.sender:
                        if not stor11[address(arg1)]:
                            stor11[address(arg1)] = block.number
                if stor12[address(arg1)]:
                    if not msg.sender:
                    ...
                    if stor12[address(msg.sender)]:
                        ...
                        if pairAddress == address(arg1):
                            ...
                            if sub_ae3fd8bbAddress != address(arg1):
                                if pairAddress == msg.sender:
                                    if not arg2:
                                        if 0 > arg2:
                                            revert with 0, 'SafeMath: subtraction overflow', 0
        ...
        if unknown_0x2bb14e1d(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0x39509351(?????) > uint32(call.func_hash) >> 224:
                ...
                if unknown_0x313ce567(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return decimals
                require unknown_0x3736421b(?????) == uint32(call.func_hash) >> 224
                require not msg.value
                return pairAddress
            if uint32(call.func_hash) >> 224 != unknown_0x39509351(?????):
                ...
                if unknown_0x47062402(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return buyFee
                if unknown_0x69e90869(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 32
                    if owner != msg.sender:
                        revert with 0, 'Ownable: caller is not the owner'
            ...
            if unknown_0x18160ddd(?????) > uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != name():
                    if uint32(call.func_hash) >> 224 != approve(address arg1, uint256 arg2):
                        require unknown_0x175eee4b(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        require calldata.size - 4 >= 32
                        if owner != msg.sender:
                            revert with 0, 'Ownable: caller is not the owner'
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x23b872dd(?????):
                require unknown_0x266388c4(?????) == uint32(call.func_hash) >> 224
                require not msg.value
                require calldata.size - 4 >= 64
                require arg1 == address(arg1)
                require arg2 == bool(arg2)
                ...
                if stor12[address(arg2)]:
                    ...
                    if stor12[address(arg1)]:
                        ...
                        if pairAddress == address(arg2):
                            ...
                            if sub_ae3fd8bbAddress != address(arg2):
                                if pairAddress == address(arg1):
                                    if not arg3:
                                        if 0 > arg3:
                                            revert with 0, 'SafeMath: subtraction overflow', 0
