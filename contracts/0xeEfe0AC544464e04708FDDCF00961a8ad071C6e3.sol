...
function sellToken() {
    ...
    mem[ceil32(return_data.size) + 132] = 100 * 10^18
    require ext_code.size(tokenAddress)
    ...
    call 0x10ed43c718714eb63d5aa57b78b54704e256024e.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args 100 * 10^18, 0, 160, address(this.address), block.timestamp + 15, 2, mem[(2 * ceil32(return_data.size)) + 388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if (4 * ceil32(return_data.size)) + floor32(mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], 23283064365 + 192]) + 193 > test266151307() or floor32(mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], 23283064365 + 192]) + 1 < 0:
        revert with 0, 65
    require return_data.size >= mem[(2 * ceil32(return_data.size)) + 192 len 4], 23283064365 + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], 23283064365 + 192]) + 32
}
