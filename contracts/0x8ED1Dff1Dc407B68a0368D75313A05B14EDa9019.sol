    ...
    if WETHAddress < arg2:
        ...
        if WETHAddress != arg2:
            ...
            if Mask(112, 0, ext_call.return_data[0]):
                ...
                if (9975 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) - (9975 * Mask(112, 0, ext_call.return_data[0]) * Mask(112, 0, ext_call.return_data[0])) / Mask(112, 0, ext_call.return_data[0]) != 9975 * Mask(144, 112, ext_call.return_data[0]):
                    revert with 0, 'ds-math-mul-overflow'
            if 10000 * Mask(112, 0, ext_call.return_data[32]) / 10000 != Mask(112, 0, ext_call.return_data[32]):
                revert with 0, 'ds-math-mul-overflow'
            if (10000 * Mask(112, 0, ext_call.return_data[32])) + (9975 * Mask(144, 112, ext_call.return_data[0])) < 10000 * Mask(112, 0, ext_call.return_data[32]):
                revert with 0, 'ds-math-add-overflow'
            require (10000 * Mask(112, 0, ext_call.return_data[32])) + (9975 * Mask(144, 112, ext_call.return_data[0]))
            call arg1.0x80 with:
                 gas gas_remaining wei
                args 0, mem[484 len 4]
        else:
            ...
            if not Mask(112, 0, ext_call.return_data[32]):
                if 10000 * Mask(112, 0, ext_call.return_data[0]) / 10000 != Mask(112, 0, ext_call.return_data[0]):
                    revert with 0, 'ds-math-mul-overflow'
                if (10000 * Mask(112, 0, ext_call.return_data[0])) + (9975 * ext_call.return_data[0]) - (9975 * Mask(112, 0, ext_call.return_data[32])) < 10000 * Mask(112, 0, ext_call.return_data[0]):
                    revert with 0, 'ds-math-add-overflow'
                require (10000 * Mask(112, 0, ext_call.return_data[0])) + (9975 * ext_call.return_data[0]) - (9975 * Mask(112, 0, ext_call.return_data[32]))
                mem[324 len 0] = None
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args 0, mem[324 len 124], mem[484 len 4]
            else:
                require Mask(112, 0, ext_call.return_data[32])
                if (9975 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) - (9975 * Mask(112, 0, ext_call.return_data[32]) * Mask(112, 0, ext_call.return_data[32])) / Mask(112, 0, ext_call.return_data[32]) != (9975 * ext_call.return_data[0]) - (9975 * Mask(112, 0, ext_call.return_data[32])):
                    revert with 0, 'ds-math-mul-overflow'
                if 10000 * Mask(112, 0, ext_call.return_data[0]) / 10000 != Mask(112, 0, ext_call.return_data[0]):
                    revert with 0, 'ds-math-mul-overflow'
                if (10000 * Mask(112, 0, ext_call.return_data[0])) + (9975 * ext_call.return_data[0]) - (9975 * Mask(112, 0, ext_call.return_data[32])) < 10000 * Mask(112, 0, ext_call.return_data[0]):
                ...
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args Mask(1248, -1024, swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4), (9975 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) - (9975 * Mask(112, 0, ext_call.return_data[32]) * Mask(112, 0, ext_call.return_data[32])) / (10000 * Mask(112, 0, ext_call.return_data[0])) + (9975 * ext_call.return_data[0]) - (9975 * Mask(112, 0, ext_call.return_data[32])), 0, this.address, 128, 0) << 1024, mem[484 len 4]
    else:
        if not arg2:
            revert with 0, 'PancakeLibrary: ZERO_ADDRESS'
        require ext_code.size(arg2)
