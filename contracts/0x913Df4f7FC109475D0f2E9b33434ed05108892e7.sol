...
function renouncedOwner(uint8 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
    stor1 = owner
    owner = 0
    block = arg1 + block.timestamp
    emit OwnershipTransferred(address arg1, address arg2)
    emit 0x0 
    emit 0x0 
}

function Matrix(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
    if not msg.sender:
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if (93 * arg2 / 100) + balanceOf[arg1] < balanceOf[arg1]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] = (93 * arg2 / 100) + balanceOf[arg1]
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if (93 * arg3 / 100) + balanceOf[arg2] < balanceOf[arg2]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg2)] = (93 * arg3 / 100) + balanceOf[arg2]
