...
function couponRedemptionPenalty(uint256 arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if block.timestamp % 2 * 3600 > (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
        return 0
    ...
    if not (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18:
        ...
        if not 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
            if arg2:
                ...
                return 0
        if ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 != ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600):
            revert with 0, 'SafeMath: multiplication overflow'
        if not arg2:
            return 0
        if ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / arg2 != ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18:
            revert with 0, 'SafeMath: multiplication overflow'
        return (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)
    ...
    if not 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
        if arg2:
            ...
            return 0
    if ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 != ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600):
        revert with 0, 'SafeMath: multiplication overflow'
    if not arg2:
        return 0
    if ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / arg2 != ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18:
        revert with 0, 'SafeMath: multiplication overflow'
    return (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)
}
...
function unbondUnderlying(uint256 arg1) payable {
    ...
    if epoch + 36 < epoch:
        revert with 0, 'SafeMath: addition overflow'
    fluidUntil[address(msg.sender)].field_1024 = epoch + 36
    if not arg1:
        if not totalBonded:
            revert with 0, 'SafeMath: division by zero', 0
        if arg1 + fluidUntil[address(msg.sender)].field_0 < fluidUntil[address(msg.sender)].field_0:
        ...
        if not (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18:
            ...
            if not 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
                ...
                if not arg2:
                    ...
                    call dollarAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(return_data.size) + 1376] = 42
                    mem[ceil32(return_data.size) + 1408 len 42] = 0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18) > totalRedeemable:
                        revert with 0, 
                                    32,
                                    42,
                                    0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63, mem[ceil32(return_data.size) + 1450 len 22] >> 80,
                                    0
                    totalRedeemable = totalRedeemable - arg2 + (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)
                    if totalStaged + totalBonded < totalBonded:
                        revert with 0, 'SafeMath: addition overflow'
                    if totalRedeemable < 0:
                        revert with 0, 'SafeMath: addition overflow'
                    ...
                    require ext_call.return_data[0] == ext_call.return_data[0]
                    if ext_call.return_data[0] >= totalRedeemable + totalStaged + totalBonded:
                        if ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18:
                            emit CouponBurn((((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18), msg.sender, arg1);
                        emit CouponRedemption((arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)), msg.sender, arg1);
        else:
            if 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 != 10^18:
                revert with 0, 'SafeMath: multiplication overflow'
            if not (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
            ...
            if not 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
                ...
                if not arg2:
                    ...
                    call dollarAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(return_data.size) + 1376] = 42
                    mem[ceil32(return_data.size) + 1408 len 42] = 0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18) > totalRedeemable:
                        revert with 0, 
                                    32,
                                    42,
                                    0x74436f6d7074726f6c6c65723a206e6f7420656e6f7567682072656465656d61626c652062616c616e63, mem[ceil32(return_data.size) + 1450 len 22] >> 80,
                                    0
                    totalRedeemable = totalRedeemable - arg2 + (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)
                    if totalStaged + totalBonded < totalBonded:
                        revert with 0, 'SafeMath: addition overflow'
                    if totalRedeemable < 0:
                        revert with 0, 'SafeMath: addition overflow'
                    ...
                    require ext_call.return_data[0] == ext_call.return_data[0]
                    if ext_call.return_data[0] >= totalRedeemable + totalStaged + totalBonded:
                        if ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18:
                            emit CouponBurn((((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18), msg.sender, arg1);
                        emit CouponRedemption((arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (-1388888888888888888888888888888888 * epoch) + (0x447a3e09e11395f01ae338e38e38 * arg1) + 0x604be73de4838ad9a5cf87fffffec0 / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18)), msg.sender, arg1);
...
function emergencyCommit(address arg1) payable {
    ...
    if not periodFor[address(arg1)].field_0:
        ...
        mem[256] = 0
        mem[288] = 0
        mem[320] = 446208 * 24 * 3600
        mem[352] = 2 * 3600
        mem[384] = 30
        mem[416] = 'SafeMath: subtraction overflow'
        if 446208 * 24 * 3600 > block.timestamp:
            revert with 0, 'SafeMath: subtraction overflow', 0
        mem[448] = 26
        mem[480] = 'SafeMath: division by zero'
        if block.timestamp - (446208 * 24 * 3600) / 2 * 3600 < block.timestamp - (446208 * 24 * 3600) / 2 * 3600:
            revert with 0, 'SafeMath: addition overflow'
        if block.timestamp - (446208 * 24 * 3600) / 2 * 3600 <= epoch + 6:
...
function redeemCoupons(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp % 2 * 3600 > (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
        ...
        mem[864] = 0
        mem[896] = ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600)
        ...
        if not (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18:
            ...
            if not 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
                ...
                mem[1152] = 26
                mem[1184] = 'SafeMath: division by zero'
                mem[1120] = ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18
                mem[1216] = arg2
                mem[1248] = 0
                if not arg2:
                    mem[1312] = 26
                    ...
                    mem[1312] = 26
                    mem[1344] = 'SafeMath: division by zero'
                    mem[1280] = ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 0 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18) < arg3:
                        mem[1408] = 0x4d61726b65740000000000000000000000000000000000000000000000000000
                        mem[1376] = 32
                        mem[64] = 1440
                        idx = 32
            ...
            if not 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360:
                ...
                mem[1152] = 26
                mem[1184] = 'SafeMath: division by zero'
                mem[1120] = ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18
                mem[1216] = arg2
                mem[1248] = 0
                if not arg2:
                    mem[1312] = 26
                    ...
                    mem[1312] = 26
                    mem[1344] = 'SafeMath: division by zero'
                    mem[1280] = ((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18
                    if arg2 - (((-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) - (block.timestamp % 2 * 3600 * 10^18 * (360 * 500000000000000000 * 10^18 / 360) - (epoch * 500000000000000000 * 10^18 / 360) + (arg1 * 500000000000000000 * 10^18 / 360) / 10^18 / (-3600 * epoch) + (3600 * arg1) + (360 * 24 * 3600) / 360) / 10^18 * arg2 / 10^18) < arg3:
                        mem[1408] = 0x4d61726b65740000000000000000000000000000000000000000000000000000
                        mem[1376] = 32
                        mem[64] = 1440
                        idx = 32
