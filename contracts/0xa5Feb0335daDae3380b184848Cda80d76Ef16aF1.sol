            ...
            if poolAddress != arg1:
                ...
                if not arg2:
                    if not arg2:
                        ...
                        if not stor8:
                            revert with 0, 'ERC20: transfer to the zero address'
                        if 15 * arg2 / 100 > balanceOf[address(msg.sender)]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        balanceOf[address(msg.sender)] -= 15 * arg2 / 100
                        if (15 * arg2 / 100) + balanceOf[stor8] < balanceOf[stor8]:
                            revert with 0, 'SafeMath: addition overflow'
                        balanceOf[stor8] += 15 * arg2 / 100
                        emit Transfer((15 * arg2 / 100), msg.sender, stor8);
                    if not msg.sender:
                        revert with 0, 'ERC20: transfer from the zero address'
                    if not arg1:
                        revert with 0, 'ERC20: transfer to the zero address'
                    ...
                    if (85 * arg2 / 100) + balanceOf[arg1] < balanceOf[arg1]:
                        revert with 0, 'SafeMath: addition overflow'
                    balanceOf[address(arg1)] = (85 * arg2 / 100) + balanceOf[arg1]
