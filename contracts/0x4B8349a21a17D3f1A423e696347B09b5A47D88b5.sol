            ...
            if DGASAddress < WETHAddress:
                ...
                if DGASAddress < WETHAddress:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_code.size(uint64(sha3(0, FACTORYAddress, sha3(DGASAddress, WETHAddress), ext_call.return_data[0])))
                    staticcall uint64(sha3(0, FACTORYAddress, sha3(DGASAddress, WETHAddress), ext_call.return_data[0])).getReserves() with:
                            gas gas_remaining wei
                else:
                    if not WETHAddress:
                        revert with 0, 'DemaxSwapLibrary: ZERO_ADDRESS'
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_code.size(uint64(sha3(0, FACTORYAddress, sha3(WETHAddress, DGASAddress), ext_call.return_data[0])))
                    staticcall uint64(sha3(0, FACTORYAddress, sha3(WETHAddress, DGASAddress), ext_call.return_data[0])).getReserves() with:
                            gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if ext_call.return_data[0]:
                        ...
                        if ext_call.return_data[12 len 20] != arg2:
                            ...
                            if not arg4:
                                ...
                                require arg4
                                if arg4 * Mask(112, 0, ext_call.return_data[32]) / arg4 != Mask(112, 0, ext_call.return_data[32]):
                                    revert with 0, 32, 33, 0x54536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[386 len 31]
                                require Mask(112, 0, ext_call.return_data[0])
                                require ext_code.size(DGASAddress)
                                call DGASAddress.increaseProductivity(address rg1, uint256 rg2) with:
                                     gas gas_remaining wei
                                    args address(arg2), arg4 * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0])
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                else:
                    if ext_call.return_data[0]:
                        ...
                        if ext_call.return_data[12 len 20] != arg2:
                            ...
                            if not arg4:
                                ...
                                require arg4
                                if arg4 * Mask(112, 0, ext_call.return_data[0]) / arg4 != Mask(112, 0, ext_call.return_data[0]):
                                    revert with 0, 32, 33, 0x54536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[386 len 31]
                                require Mask(112, 0, ext_call.return_data[32])
                                require ext_code.size(DGASAddress)
                                call DGASAddress.increaseProductivity(address rg1, uint256 rg2) with:
                                     gas gas_remaining wei
                                    args address(arg2), arg4 * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32])
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
            else:
            ...
            if ext_call.return_data[0]:
                ...
                if ext_call.return_data[12 len 20] != arg1:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if ext_call.return_data[0] + arg4 < ext_call.return_data[0]:
                        revert with 0, 'SafeMath: addition overflow'
                    if not arg4:
                        require ext_call.return_data[0] + arg4
                        if 0 / ext_call.return_data[0] + arg4 > 0:
                            require ext_code.size(DGASAddress)
                            call DGASAddress.decreaseProductivity(address rg1, uint256 rg2) with:
                                 gas gas_remaining wei
                                args address(arg1), 0 / ext_call.return_data[0] + arg4
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                    else:
                        require arg4
                        if arg4 * ext_call.return_data[0] / arg4 != ext_call.return_data[0]:
                            revert with 0, 32, 33, 0x54536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[386 len 31]
                        require ext_call.return_data[0] + arg4
                        if arg4 * ext_call.return_data[0] / ext_call.return_data[0] + arg4 > 0:
                            require ext_code.size(DGASAddress)
                            call DGASAddress.decreaseProductivity(address rg1, uint256 rg2) with:
                                 gas gas_remaining wei
                                args address(arg1), arg4 * ext_call.return_data[0] / ext_call.return_data[0] + arg4
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
