...
function sub_bdd03900(?) {
    require calldata.size - 4 >= 128
    if bool(stor9[msg.sender]) != 1:
        revert with 0, 'Only Authorized'
    require ext_code.size(arg1)
    staticcall arg1.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if uint8(stor8.field_176):
        if not uint8(stor8.field_168):
            ...
            while idx < stor4:
                ...
                call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args stor3 / stor4, stor5, 160, stor10, block.timestamp, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _614 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                require return_data.size >= 32
                _618 = mem[_614]
                require mem[_614] <= 4294967296
                require mem[_614] + 32 <= return_data.size
                require mem[_614 + mem[_614]] <= 4294967296 and mem[_614] + (32 * mem[_614 + mem[_614]]) + 32 <= return_data.size
                mem[_614 + ceil32(return_data.size)] = mem[_614 + mem[_614]]
                _634 = mem[_614 + _618]
                s = 0
                while s < 32 * _634:
                    mem[s + _614 + ceil32(return_data.size) + 32] = mem[s + _614 + _618 + 32]
                    s = s + 32
                    continue 
                mem[64] = (32 * _634) + _614 + ceil32(return_data.size) + 32
                idx = idx + 1
                continue 
        else:
            ...
            mem[64] = ceil32(return_data.size) + 192
            require return_data.size >= 32
            _364 = mem[192 len 4], Mask(224, 0, stor6.field_32)
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _387) + ceil32(return_data.size) + 224] = 2
            mem[(32 * _387) + ceil32(return_data.size) + 256] = address(stor8.field_0)
            mem[(32 * _387) + ceil32(return_data.size) + 288] = stor7
            mem[(32 * _387) + ceil32(return_data.size) + 420] = this.address
            mem[(32 * _387) + ceil32(return_data.size) + 452] = block.timestamp
            mem[(32 * _387) + ceil32(return_data.size) + 388] = 160
            mem[(32 * _387) + ceil32(return_data.size) + 484] = 2
            mem[(32 * _387) + ceil32(return_data.size) + 516 len 0] = None
            require ext_code.size(routerAddress)
            call routerAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp, 2, mem[(32 * _387) + ceil32(return_data.size) + 516 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require ext_code.size(stor7)
            staticcall stor7.0x70a08231 with:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _387) + ceil32(return_data.size) + 320] = 2
            mem[64] = (32 * _387) + ceil32(return_data.size) + 416
            mem[(32 * _387) + ceil32(return_data.size) + 352] = stor7
            mem[(32 * _387) + ceil32(return_data.size) + 384] = address(stor8.field_0)
            require stor4
            idx = 0
            while idx < stor4:
                mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                ...
                mem[mem[64] + 132] = block.timestamp
                mem[mem[64] + 68] = 160
                mem[mem[64] + 164] = mem[(32 * _387) + ceil32(return_data.size) + 320]
                _942 = mem[(32 * _387) + ceil32(return_data.size) + 320]
                s = 0
                while s < 32 * _942:
                    mem[s + mem[64] + 196] = mem[s + (32 * _387) + ceil32(return_data.size) + 352]
                    s = s + 32
                    continue 
                require ext_code.size(routerAddress)
                call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args stor3 / stor4, stor5, 160, stor10, block.timestamp, mem[mem[64] + 164 len (32 * _942) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1010 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                require return_data.size >= 32
                _1012 = mem[_1010]
                require mem[_1010] <= 4294967296
                require mem[_1010] + 32 <= return_data.size
                require mem[_1010 + mem[_1010]] <= 4294967296 and mem[_1010] + (32 * mem[_1010 + mem[_1010]]) + 32 <= return_data.size
                mem[_1010 + ceil32(return_data.size)] = mem[_1010 + mem[_1010]]
                _1018 = mem[_1010 + _1012]
                s = 0
                while s < 32 * _1018:
                    mem[s + _1010 + ceil32(return_data.size) + 32] = mem[s + _1010 + _1012 + 32]
                    s = s + 32
                    continue 
                mem[64] = (32 * _1018) + _1010 + ceil32(return_data.size) + 32
                idx = idx + 1
                continue 
    else:
        ...
        if not uint8(stor8.field_168):
            ...
            while idx < stor4:
                ...
                require return_data.size >= 32
                _621 = mem[_616]
                require mem[_616] <= 4294967296
                require mem[_616] + 32 <= return_data.size
                require mem[_616 + mem[_616]] <= 4294967296 and mem[_616] + (32 * mem[_616 + mem[_616]]) + 32 <= return_data.size
                mem[_616 + ceil32(return_data.size)] = mem[_616 + mem[_616]]
                _635 = mem[_616 + _621]
                s = 0
                while s < 32 * _635:
                    mem[s + _616 + ceil32(return_data.size) + 32] = mem[s + _616 + _621 + 32]
                    s = s + 32
                    continue 
                mem[64] = (32 * _635) + _616 + ceil32(return_data.size) + 32
                idx = idx + 1
                continue 
        else:
            uint8(stor8.field_184) = 1
            ...
            mem[64] = ceil32(return_data.size) + 192
            require return_data.size >= 32
            _368 = mem[192 len 4], Mask(224, 0, stor6.field_32)
            require mem[192 len 4], Mask(224, 0, stor6.field_32) <= 4294967296
            require mem[192 len 4], Mask(224, 0, stor6.field_32) + 32 <= return_data.size
            require mem[mem[192 len 4], Mask(224, 0, stor6.field_32) + 192] <= 4294967296 and mem[192 len 4], Mask(224, 0, stor6.field_32) + (32 * mem[mem[192 len 4], Mask(224, 0, stor6.field_32) + 192]) + 32 <= return_data.size
            mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], Mask(224, 0, stor6.field_32) + 192]
            _391 = mem[_368 + 192]
            mem[ceil32(return_data.size) + 224 len floor32(mem[_368 + 192])] = mem[_368 + 224 len floor32(mem[_368 + 192])]
            require ext_code.size(address(stor8.field_0))
            staticcall address(stor8.field_0).0x70a08231 with:
                    gas gas_remaining wei
                   args this.address
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _391) + ceil32(return_data.size) + 224] = 2
            mem[(32 * _391) + ceil32(return_data.size) + 256] = address(stor8.field_0)
            mem[(32 * _391) + ceil32(return_data.size) + 288] = stor7
            mem[(32 * _391) + ceil32(return_data.size) + 420] = this.address
            mem[(32 * _391) + ceil32(return_data.size) + 452] = block.timestamp
            mem[(32 * _391) + ceil32(return_data.size) + 388] = 160
            mem[(32 * _391) + ceil32(return_data.size) + 484] = 2
            mem[(32 * _391) + ceil32(return_data.size) + 516 len 0] = None
            require ext_code.size(routerAddress)
            call routerAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp, 2, mem[(32 * _391) + ceil32(return_data.size) + 516 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require ext_code.size(stor7)
            staticcall stor7.0x70a08231 with:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _391) + ceil32(return_data.size) + 320] = 2
            mem[64] = (32 * _391) + ceil32(return_data.size) + 416
            mem[(32 * _391) + ceil32(return_data.size) + 352] = stor7
            mem[(32 * _391) + ceil32(return_data.size) + 384] = address(stor8.field_0)
            require stor4
            idx = 0
            while idx < stor4:
                mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                ...
                mem[mem[64] + 132] = block.timestamp
                mem[mem[64] + 68] = 160
                mem[mem[64] + 164] = mem[(32 * _391) + ceil32(return_data.size) + 320]
                _945 = mem[(32 * _391) + ceil32(return_data.size) + 320]
                s = 0
                while s < 32 * _945:
                    mem[s + mem[64] + 196] = mem[s + (32 * _391) + ceil32(return_data.size) + 352]
                    s = s + 32
                    continue 
                require ext_code.size(routerAddress)
                call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args stor3 / stor4, stor5, 160, stor10, block.timestamp, mem[mem[64] + 164 len (32 * _945) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1011 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                require return_data.size >= 32
                _1014 = mem[_1011]
                require mem[_1011] <= 4294967296
                require mem[_1011] + 32 <= return_data.size
                require mem[_1011 + mem[_1011]] <= 4294967296 and mem[_1011] + (32 * mem[_1011 + mem[_1011]]) + 32 <= return_data.size
                mem[_1011 + ceil32(return_data.size)] = mem[_1011 + mem[_1011]]
                _1019 = mem[_1011 + _1014]
                s = 0
                while s < 32 * _1019:
                    mem[s + _1011 + ceil32(return_data.size) + 32] = mem[s + _1011 + _1014 + 32]
                    s = s + 32
                    continue 
                mem[64] = (32 * _1019) + _1011 + ceil32(return_data.size) + 32
                idx = idx + 1
                continue 
