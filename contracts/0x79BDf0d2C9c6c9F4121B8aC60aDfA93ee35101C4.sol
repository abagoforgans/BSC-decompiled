...
function sub_fe0070d3(?) {
    ...
    while idx < stor4.length:
        ...
        continue 
    mem[736 len 0] = None
    return Array(len=10, data=mem[736 len 320])
}
...
function sub_29b15aa6(?) {
    ...
    while idx < stor4.length:
        ...
        if not stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)]:
            ...
            mem[512] = tokens[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor6', 6))[uint8(idx)]]
            if idx >= stor4.length:
                revert with 0, 'cAlena'
            if contracts.length <= stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]:
                revert with 0, 'cslencAlen'
            ...
            staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                   ...
                   args arg1, 64, mem[mem[64] + 68 len (32 * _124) + 32]
            if not ext_call.success:
                idx = idx + 1
                s = s
                t = 448
            ...
            _180 = mem[_177]
            require mem[_177] <= 4294967296
            require mem[_177] + 32 <= return_data.size
            require mem[_177 + mem[_177]] <= 4294967296 and mem[_177] + (32 * mem[_177 + mem[_177]]) + 32 <= return_data.size
            mem[_177 + ceil32(return_data.size)] = mem[_177 + mem[_177]]
            _185 = mem[_177 + _180]
            s = 0
            while s < 32 * _185:
                mem[s + _177 + ceil32(return_data.size) + 32] = mem[s + _177 + _180 + 32]
                s = s + 32
                continue 
            mem[64] = (32 * _185) + _177 + ceil32(return_data.size) + 32
            require idx < stor8.length
        ...
        t = 0
        while t < 32 * _129:
            mem[t + mem[64] + 100] = mem[t + 576]
            t = t + 32
            continue 
        require ext_code.size(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]])
        staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                gas gas_remaining wei
               args arg1, 64, mem[mem[64] + 68 len (32 * _129) + 32]
        if not ext_call.success:
            idx = idx + 1
            s = s
            t = 544
        ...
        require return_data.size >= 32
        _178 = mem[_176]
        require mem[_176] <= 4294967296
        require mem[_176] + 32 <= return_data.size
        require mem[_176 + mem[_176]] <= 4294967296 and mem[_176] + (32 * mem[_176 + mem[_176]]) + 32 <= return_data.size
        mem[_176 + ceil32(return_data.size)] = mem[_176 + mem[_176]]
        _184 = mem[_176 + _178]
        s = 0
        while s < 32 * _184:
            mem[s + _176 + ceil32(return_data.size) + 32] = mem[s + _176 + _178 + 32]
            s = s + 32
            continue 
        mem[64] = (32 * _184) + _176 + ceil32(return_data.size) + 32
        require idx < stor8.length
        require idx < stor9.length
        require stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor8', 8))[uint8(idx)] < tokens.length
        if not stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor9', 9))[uint8(idx)]:
...
function sub_90b16fee(?) {
    ...
    while idx < stor4.length:
        ...
        if not stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)]:
            ...
            staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                    gas gas_remaining wei
                   args arg1, 64, mem[mem[64] + 68 len (32 * _216) + 32]
            if not ext_call.success:
                idx = idx + 1
                s = s
                t = 448
            ...
            require mem[_361 + mem[_361]] <= 4294967296 and mem[_361] + (32 * mem[_361 + mem[_361]]) + 32 <= return_data.size
            mem[_361 + ceil32(return_data.size)] = mem[_361 + mem[_361]]
            _369 = mem[_361 + _364]
            s = 0
            while s < 32 * _369:
                mem[s + _361 + ceil32(return_data.size) + 32] = mem[s + _361 + _364 + 32]
                s = s + 32
                continue 
            mem[64] = (32 * _369) + _361 + ceil32(return_data.size) + 32
            require idx < stor8.length
            require idx < stor9.length
            require stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor8', 8))[uint8(idx)] < tokens.length
            if not stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor9', 9))[uint8(idx)]:
                ...
                mem[512] = tokens[uint8(stor12.field_0)]
                if idx >= stor5.length:
                    revert with 0, 'cBlena'
                if contracts.length <= stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]:
                    revert with 0, 'cslencBlen'
                require idx < stor5.length
                require stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)] < contracts.length
                mem[0] = 1
                require mem[_361 + ceil32(return_data.size)] - 1 < mem[_361 + ceil32(return_data.size)]
                _546 = mem[(32 * mem[_361 + ceil32(return_data.size)] - 1) + _361 + ceil32(return_data.size) + 32]
                mem[(32 * _369) + _361 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                mem[(32 * _369) + _361 + ceil32(return_data.size) + 36] = _546
                mem[(32 * _369) + _361 + ceil32(return_data.size) + 68] = 64
                mem[(32 * _369) + _361 + ceil32(return_data.size) + 100] = mem[448]
                _549 = mem[448]
                s = 0
                while s < 32 * _549:
                    mem[s + (32 * _369) + _361 + ceil32(return_data.size) + 132] = mem[s + 480]
                    s = s + 32
                    continue 
                ...
                staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                        gas gas_remaining wei
                       args _546, 64, mem[(32 * _369) + _361 + ceil32(return_data.size) + 100 len (32 * _549) + 32]
                if ext_call.success:
                    mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    mem[64] = (32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32
                    require return_data.size >= 32
                    _624 = mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _546) >> 32
                    require mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _546) >> 32 <= 4294967296
                    require mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _546) >> 32 + 32 <= return_data.size
                    require mem[(32 * _369) + _361 + ceil32(return_data.size) + mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _546) >> 32 + 32] <= 4294967296 and mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _546) >> 32 + (32 * mem[(32 * _369) + _361 + ceil32(return_data.size) + mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _546) >> 32 + 32]) + 32 <= return_data.size
                    mem[(32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _369) + _361 + ceil32(return_data.size) + mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _546) >> 32 + 32]
                    _633 = mem[(32 * _369) + _361 + ceil32(return_data.size) + _624 + 32]
                    s = 0
                    while s < 32 * _633:
                        mem[s + (32 * _369) + _361 + (2 * ceil32(return_data.size)) + 64] = mem[s + (32 * _369) + _361 + ceil32(return_data.size) + _624 + 64]
                        s = s + 32
                        continue 
                    mem[64] = (32 * _633) + (32 * _369) + _361 + (2 * ceil32(return_data.size)) + 64
                    require mem[(32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32]
                idx = idx + 1
                s = 448
                t = 448
                continue 
            ...
            mem[0] = 1
            require mem[_361 + ceil32(return_data.size)] - 1 < mem[_361 + ceil32(return_data.size)]
            _560 = mem[(32 * mem[_361 + ceil32(return_data.size)] - 1) + _361 + ceil32(return_data.size) + 32]
            mem[(32 * _369) + _361 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            mem[(32 * _369) + _361 + ceil32(return_data.size) + 36] = _560
            mem[(32 * _369) + _361 + ceil32(return_data.size) + 68] = 64
            mem[(32 * _369) + _361 + ceil32(return_data.size) + 100] = mem[544]
            _563 = mem[544]
            s = 0
            while s < 32 * _563:
                mem[s + (32 * _369) + _361 + ceil32(return_data.size) + 132] = mem[s + 576]
                s = s + 32
                continue 
            require ext_code.size(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]])
            staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                    gas gas_remaining wei
                   args _560, 64, mem[(32 * _369) + _361 + ceil32(return_data.size) + 100 len (32 * _563) + 32]
            if ext_call.success:
                mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = (32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32
                require return_data.size >= 32
                _622 = mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _560) >> 32
                require mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _560) >> 32 <= 4294967296
                require mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _560) >> 32 + 32 <= return_data.size
                require mem[(32 * _369) + _361 + ceil32(return_data.size) + mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _560) >> 32 + 32] <= 4294967296 and mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _560) >> 32 + (32 * mem[(32 * _369) + _361 + ceil32(return_data.size) + mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _560) >> 32 + 32]) + 32 <= return_data.size
                mem[(32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _369) + _361 + ceil32(return_data.size) + mem[(32 * _369) + _361 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _560) >> 32 + 32]
                _632 = mem[(32 * _369) + _361 + ceil32(return_data.size) + _622 + 32]
                s = 0
                while s < 32 * _632:
                    mem[s + (32 * _369) + _361 + (2 * ceil32(return_data.size)) + 64] = mem[s + (32 * _369) + _361 + ceil32(return_data.size) + _622 + 64]
                    s = s + 32
                    continue 
                mem[64] = (32 * _632) + (32 * _369) + _361 + (2 * ceil32(return_data.size)) + 64
                require mem[(32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _369) + _361 + (2 * ceil32(return_data.size)) + 32]
            idx = idx + 1
            s = 544
            t = 448
        ...
        staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                gas gas_remaining wei
               args arg1, 64, mem[mem[64] + 68 len (32 * _221) + 32]
        if not ext_call.success:
            idx = idx + 1
            s = s
            t = 544
        ...
        require mem[_360 + mem[_360]] <= 4294967296 and mem[_360] + (32 * mem[_360 + mem[_360]]) + 32 <= return_data.size
        mem[_360 + ceil32(return_data.size)] = mem[_360 + mem[_360]]
        _368 = mem[_360 + _362]
        s = 0
        while s < 32 * _368:
            mem[s + _360 + ceil32(return_data.size) + 32] = mem[s + _360 + _362 + 32]
            s = s + 32
            continue 
        mem[64] = (32 * _368) + _360 + ceil32(return_data.size) + 32
        require idx < stor8.length
        require idx < stor9.length
        require stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor8', 8))[uint8(idx)] < tokens.length
        if not stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor9', 9))[uint8(idx)]:
            ...
            require stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)] < contracts.length
            mem[0] = 1
            require mem[_360 + ceil32(return_data.size)] - 1 < mem[_360 + ceil32(return_data.size)]
            _541 = mem[(32 * mem[_360 + ceil32(return_data.size)] - 1) + _360 + ceil32(return_data.size) + 32]
            mem[(32 * _368) + _360 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            mem[(32 * _368) + _360 + ceil32(return_data.size) + 36] = _541
            mem[(32 * _368) + _360 + ceil32(return_data.size) + 68] = 64
            mem[(32 * _368) + _360 + ceil32(return_data.size) + 100] = mem[448]
            _544 = mem[448]
            s = 0
            while s < 32 * _544:
                mem[s + (32 * _368) + _360 + ceil32(return_data.size) + 132] = mem[s + 480]
                s = s + 32
                continue 
            require ext_code.size(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]])
            staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                    gas gas_remaining wei
                   args _541, 64, mem[(32 * _368) + _360 + ceil32(return_data.size) + 100 len (32 * _544) + 32]
            if ext_call.success:
                mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = (32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32
                require return_data.size >= 32
                _620 = mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _541) >> 32
                require mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _541) >> 32 <= 4294967296
                require mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _541) >> 32 + 32 <= return_data.size
                require mem[(32 * _368) + _360 + ceil32(return_data.size) + mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _541) >> 32 + 32] <= 4294967296 and mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _541) >> 32 + (32 * mem[(32 * _368) + _360 + ceil32(return_data.size) + mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _541) >> 32 + 32]) + 32 <= return_data.size
                mem[(32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _368) + _360 + ceil32(return_data.size) + mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _541) >> 32 + 32]
                _631 = mem[(32 * _368) + _360 + ceil32(return_data.size) + _620 + 32]
                s = 0
                while s < 32 * _631:
                    mem[s + (32 * _368) + _360 + (2 * ceil32(return_data.size)) + 64] = mem[s + (32 * _368) + _360 + ceil32(return_data.size) + _620 + 64]
                    s = s + 32
                    continue 
                mem[64] = (32 * _631) + (32 * _368) + _360 + (2 * ceil32(return_data.size)) + 64
                require mem[(32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32]
            idx = idx + 1
            s = 448
            t = 544
            continue 
        ...
        mem[0] = 1
        require mem[_360 + ceil32(return_data.size)] - 1 < mem[_360 + ceil32(return_data.size)]
        _554 = mem[(32 * mem[_360 + ceil32(return_data.size)] - 1) + _360 + ceil32(return_data.size) + 32]
        mem[(32 * _368) + _360 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
        mem[(32 * _368) + _360 + ceil32(return_data.size) + 36] = _554
        mem[(32 * _368) + _360 + ceil32(return_data.size) + 68] = 64
        mem[(32 * _368) + _360 + ceil32(return_data.size) + 100] = mem[544]
        _557 = mem[544]
        s = 0
        while s < 32 * _557:
            mem[s + (32 * _368) + _360 + ceil32(return_data.size) + 132] = mem[s + 576]
            s = s + 32
            continue 
        require ext_code.size(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]])
        staticcall contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                gas gas_remaining wei
               args _554, 64, mem[(32 * _368) + _360 + ceil32(return_data.size) + 100 len (32 * _557) + 32]
        if ext_call.success:
            mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32
            require return_data.size >= 32
            _618 = mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _554) >> 32
            require mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _554) >> 32 <= 4294967296
            require mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _554) >> 32 + 32 <= return_data.size
            require mem[(32 * _368) + _360 + ceil32(return_data.size) + mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _554) >> 32 + 32] <= 4294967296 and mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _554) >> 32 + (32 * mem[(32 * _368) + _360 + ceil32(return_data.size) + mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _554) >> 32 + 32]) + 32 <= return_data.size
            mem[(32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _368) + _360 + ceil32(return_data.size) + mem[(32 * _368) + _360 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _554) >> 32 + 32]
            _630 = mem[(32 * _368) + _360 + ceil32(return_data.size) + _618 + 32]
            s = 0
            while s < 32 * _630:
                mem[s + (32 * _368) + _360 + (2 * ceil32(return_data.size)) + 64] = mem[s + (32 * _368) + _360 + ceil32(return_data.size) + _618 + 64]
                s = s + 32
                continue 
            mem[64] = (32 * _630) + (32 * _368) + _360 + (2 * ceil32(return_data.size)) + 64
            require mem[(32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _368) + _360 + (2 * ceil32(return_data.size)) + 32]
        idx = idx + 1
        s = 544
        t = 544
    ...
    while idx < stor10.length:
        ...
        while t < stor4.length:
            ...
            if not stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor7', 7))[uint8(t)]:
                ...
                mem[_499 + 384] = tokens[uint8(stor12.field_0)]
                require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor6', 6))[uint8(t)] < tokens.length
                require 1 < mem[_499 + 352]
                mem[_499 + 416] = tokens[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor6', 6))[uint8(t)]]
                ...
                staticcall contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor4', 4))[uint8(t)]].getAmountsOut(uint256 rg1, address[] rg2) with:
                        gas gas_remaining wei
                ...
                if not stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor9', 9))[uint8(t)]:
                    require mem[_499 + 352]
                    mem[_499 + 384] = tokens[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor8', 8))[uint8(t)]]
                    require baseToken < tokens.length
                    require 1 < mem[_499 + 352]
                    mem[_499 + 416] = tokens[uint8(stor12.field_0)]
                ...
                mem[_499 + 480] = tokens[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor8', 8))[uint8(t)]]
                require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor9', 9))[uint8(t)] < tokens.length
                require 1 < mem[_499 + 448]
                mem[_499 + 512] = tokens[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor9', 9))[uint8(t)]]
                require baseToken < tokens.length
                require 2 < mem[_499 + 448]
                mem[_499 + 544] = tokens[uint8(stor12.field_0)]
                require t < stor5.length
                require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)] < contracts.length
                mem[0] = 1
                require mem[_1483 + ceil32(return_data.size)] - 1 < mem[_1483 + ceil32(return_data.size)]
                ...
                continue 
            require mem[_499 + 448]
            mem[_499 + 480] = tokens[uint8(stor12.field_0)]
            require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor6', 6))[uint8(t)] < tokens.length
            require 1 < mem[_499 + 448]
            mem[_499 + 512] = tokens[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor6', 6))[uint8(t)]]
            require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor7', 7))[uint8(t)] < tokens.length
            require 2 < mem[_499 + 448]
            mem[_499 + 544] = tokens[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor7', 7))[uint8(t)]]
            require t < stor4.length
            require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor4', 4))[uint8(t)] < contracts.length
            mem[0] = 1
            _1025 = mem[64]
            ...
            staticcall contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor4', 4))[uint8(t)]].mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len (32 * _1027) + _1025 + -mem[64] + 96]
            if not ext_call.success:
                t = t + 1
                u = u
                v = v
