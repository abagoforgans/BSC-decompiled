...
function sub_d50a2664(?) {
    ...
    require not stor2[this.address][arg1][arg2][arg3][arg4][arg5][arg6][arg7]
    signer = erecover(sha3(0x19457468657265756d205369676e6564204d6573736167, sha3(this.address, arg1, arg2, arg3, arg4, arg5, arg6, arg7)), arg8 << 248, arg9, arg10) 
...
function sub_dab70e3c(?) {
    ...
    if not address(stor9[arg1].field_256):
        ...
        call address(stor9[arg1].field_256).transfer(address rg1, uint256 rg2) with:
             gas gas_remaining - 710 wei
