...
function sub_3f5d7602(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    address(stor152.field_0) = arg1
    Mask(96, 0, stor152.field_160) = 1
}
...
function sub_83d7f85d(?) {
    ...
    mem[arg1.length + ceil32(arg1.length) + 128] = 153
...
function getRates() {
    ...
    staticcall address(stor152.field_0).latestRoundData() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 160
    require ext_code.size(address(stor152.field_0))
    staticcall address(stor152.field_0).0x313ce567 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    return (ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]))
}
...
function sub_b4227957(?) {
    ...
    mem[arg1.length + ceil32(arg1.length) + 192] = 153
    ...
    if not arg1.length % 32:
        emit EnabledToken(Array(len=mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32], data=Mask(8 * arg1.length % 32, 0, 153), mem[ceil32(arg1.length) + arg1.length + 224 len 64]), mem[ceil32(arg1.length) + 224 len floor32(arg1.length) - (arg1.length % 32)], arg2);
    else:
        ...
        emit EnabledToken(Array(len=mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32], data=Mask(8 * arg1.length % 32, 0, 153), mem[ceil32(arg1.length) + arg1.length + 224 len -(arg1.length % 32) + 96]), mem[ceil32(arg1.length) + 224 len floor32(arg1.length) - (arg1.length % 32)], arg2);
}
...
function sub_9403585c(?) {
    ...
    if not uint8(stor152.field_160):
    ...
    mem[arg2.length + ceil32(arg2.length) + 128] = 153
    if not stor[mem[arg2.length + 160 len ceil32(arg2.length)]][Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0)]:
        revert with 0, 'Crowdsale: project NOT exists'
    mem[ceil32(arg2.length) + 128 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
    mem[ceil32(arg2.length) + floor32(arg2.length) + -(arg2.length % 32) + 160 len arg2.length % 32] = mem[-(arg2.length % 32) + floor32(arg2.length) + 160 len arg2.length % 32]
    mem[arg2.length + ceil32(arg2.length) + 128] = 153
    _137 = sha3(Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), mem[arg2.length + 160 len ceil32(arg2.length)])
    require ext_code.size(address(stor152.field_0))
    staticcall address(stor152.field_0).latestRoundData() with:
            gas gas_remaining wei
    ...
    require return_data.size >= 32
    if not ext_call.return_data[32]:
        if not uint256(stor1[_137].field_0):
            if arg1:
                require arg1
                if 0 / arg1:
        ...
        require uint256(stor1[_137].field_0)
        if uint256(stor1[_137].field_0) * 10^stor151 / uint256(stor1[_137].field_0) != 10^stor151:
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
        if arg1:
            require arg1
            if 0 / arg1:
                revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
        if uint256(stor1[_137].field_0) * 10^stor151 <= 0:
            revert with 0, 'SafeMath: division by zero'
        require uint256(stor1[_137].field_0) * 10^stor151
        mem[ceil32(arg2.length) + 128] = 0 / uint256(stor1[_137].field_0) * 10^stor151
    else:
        require ext_call.return_data[32]
        if ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]) / ext_call.return_data[32] != 10^(stor151 - ext_call.return_data[31 len 1]):
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
        if not uint256(stor1[_137].field_0):
            if arg1:
                require arg1
                if arg1 * ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]) / arg1 != ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]):
                    revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
            revert with 0, 'SafeMath: division by zero'
        require uint256(stor1[_137].field_0)
        if uint256(stor1[_137].field_0) * 10^stor151 / uint256(stor1[_137].field_0) != 10^stor151:
        ...
        if not arg1:
            ...
            if uint256(stor1[_137].field_0) * 10^stor151 <= 0:
                revert with 0, 'SafeMath: division by zero'
            require uint256(stor1[_137].field_0) * 10^stor151
            mem[ceil32(arg2.length) + 128] = arg1 * ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]) / uint256(stor1[_137].field_0) * 10^stor151
...
function sub_97492c7a(?) payable {
    ...
    mem[ceil32(arg1.length) + floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[arg1.length + ceil32(arg1.length) + 128] = 153
    _323 = sha3(Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len ceil32(arg1.length)])
    require ext_code.size(address(stor152.field_0))
    staticcall address(stor152.field_0).latestRoundData() with:
            gas gas_remaining wei
    ...
    require return_data.size >= 32
    if not ext_call.return_data[32]:
        if not uint256(stor1[_323].field_0):
            if msg.value:
                require msg.value
                if 0 / msg.value:
                    revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
            revert with 0, 'SafeMath: division by zero'
        require uint256(stor1[_323].field_0)
        if uint256(stor1[_323].field_0) * 10^stor151 / uint256(stor1[_323].field_0) != 10^stor151:
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
        if msg.value:
            require msg.value
            if 0 / msg.value:
                revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
        if uint256(stor1[_323].field_0) * 10^stor151 <= 0:
            revert with 0, 'SafeMath: division by zero'
        require uint256(stor1[_323].field_0) * 10^stor151
        ...
        call stor[mem[ceil32(arg1.length) + floor32(arg1.length) + 192 len (arg1.length % 32) + 32]][call.data[arg1 + 36 len floor32(arg1.length)]].mint(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args msg.sender, 0 / uint256(stor1[_323].field_0) * 10^stor151
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        call owner with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        emit Contribution(Array(len=arg1.length, data=arg1[all]), msg.value, 0 / uint256(stor1[_323].field_0) * 10^stor151, msg.sender);
        return (0 / uint256(stor1[_323].field_0) * 10^stor151)
    require ext_call.return_data[32]
    if ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]) / ext_call.return_data[32] != 10^(stor151 - ext_call.return_data[31 len 1]):
        revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
    if not uint256(stor1[_323].field_0):
        if msg.value:
            require msg.value
            if msg.value * ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]) / msg.value != ext_call.return_data[32] * 10^(stor151 - ext_call.return_data[31 len 1]):
                revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, ext_call.return_data[101 len 31]
        revert with 0, 'SafeMath: division by zero'
    require uint256(stor1[_323].field_0)
    if uint256(stor1[_323].field_0) * 10^stor151 / uint256(stor1[_323].field_0) != 10^stor151:
    ...
    call stor[mem[ceil32(arg1.length) + floor32(arg1.length) + 192 len (arg1.length % 32) + 32]][call.data[arg1 + 36 len floor32(arg1.length)]].mint(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args msg.sender, msg.value * ext_call.return_data[32] * 10^(stor151 - uint8(ext_call.return_data[0])) / uint256(stor1[_323].field_0) * 10^stor151
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    call owner with:
       value msg.value wei
         gas 2300 * is_zero(value) wei
    emit Contribution(Array(len=arg1.length, data=arg1[all]), msg.value, msg.value * ext_call.return_data[32] * 10^(stor151 - uint8(ext_call.return_data[0])) / uint256(stor1[_323].field_0) * 10^stor151, msg.sender);
    return (msg.value * ext_call.return_data[32] * 10^(stor151 - uint8(ext_call.return_data[0])) / uint256(stor1[_323].field_0) * 10^stor151)
}
