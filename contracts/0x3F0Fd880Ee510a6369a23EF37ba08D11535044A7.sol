...
function _currentTokenID() payable {
...
function setProxyAddress(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor6 = arg1
...
function balanceOfBatch(address[] arg1, uint256[] arg2) payable {
    ...
    if arg1.length:
        mem[(32 * arg1.length) + (32 * arg2.length) + 192 len 32 * arg1.length] = code.data[16501 len 32 * arg1.length]
    idx = 0
...
function mint(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    if creators[arg2] != msg.sender:
        revert with 0, 'You-are-not-creator'
...
function create(uint256 arg1, uint256 arg2, string arg3, bytes arg4) payable {
    ...
    if arg2 > arg1:
        revert with 0, 
                    ...
                    mem[ceil32(arg3.length) + ceil32(arg4.length) + 273 len 19]
    ...
    if arg3.length <= 0:
        if not arg2:
            ...
            mem[ceil32(arg3.length) + ceil32(arg4.length) + 160] = currentTokenID + 1
        ...
        emit TransferSingle(Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[ceil32(arg3.length) + arg4.length + 192 len -arg4.length + ceil32(arg4.length) + 32], msg.sender, 0, msg.sender);
        ...
        if ext_code.hash(msg.sender) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
            ...
            return Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), 
                   mem[ceil32(arg3.length) + arg4.length + 192 len -arg4.length + ceil32(arg4.length)]
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 160] = 0xf23a6e6100000000000000000000000000000000000000000000000000000000
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 356 len ceil32(arg4.length)] = arg4[all], mem[ceil32(arg3.length) + arg4.length + 160 len ceil32(arg4.length) - arg4.length]
        if not arg4.length % 32:
            require ext_code.size(msg.sender)
            call msg.sender with:
                 gas gas_remaining wei
                args msg.sender, 0, currentTokenID + 1, arg2, 160, arg4.length, Mask(8 * arg4.length, -(8 * arg4.length) + 256, arg4[all], mem[ceil32(arg3.length) + arg4.length + 160 len ceil32(arg4.length) - arg4.length]) << (8 * arg4.length) - 256
        else:
            mem[floor32(arg4.length) + ceil32(arg3.length) + ceil32(arg4.length) + 356] = mem[floor32(arg4.length) + ceil32(arg3.length) + ceil32(arg4.length) + -(arg4.length % 32) + 388 len arg4.length % 32]
            require ext_code.size(msg.sender)
            call msg.sender with:
                 gas gas_remaining wei
                args msg.sender, 0, currentTokenID + 1, arg2, 160, arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[ceil32(arg3.length) + arg4.length + 160 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[ceil32(arg3.length) + (2 * ceil32(arg4.length)) + 356 len floor32(arg4.length) + -ceil32(arg4.length) + 32]
    else:
        ...
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 228] = currentTokenID + 1
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 260] = arg2
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 292] = 160
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 324] = Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)]
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 356 len ceil32(Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)])] = mem[ceil32(arg3.length) + 160 len ceil32(Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)])]
        if not Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)] % 32:
            require ext_code.size(msg.sender)
            call msg.sender with:
                 gas gas_remaining wei
                args mem[ceil32(arg3.length) + ceil32(arg4.length) + 164 len Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)] + 192]
        else:
            mem[floor32(Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)]) + ceil32(arg3.length) + ceil32(arg4.length) + 356] = mem[floor32(Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)]) + ceil32(arg3.length) + ceil32(arg4.length) + -(Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)] % 32) + 388 len Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)] % 32]
            require ext_code.size(msg.sender)
            call msg.sender with:
                 gas gas_remaining wei
                args mem[ceil32(arg3.length) + ceil32(arg4.length) + 164 len floor32(Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)]) + 224]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if Mask(32, 224, ext_call.return_data[0]) != 0xf23a6e6100000000000000000000000000000000000000000000000000000000:
    ...
    totalSupply[stor7 + 1] = arg2
    maxSupply[stor7 + 1] = arg1
    return 0, Mask(224, 0, currentTokenID + 1)
}
