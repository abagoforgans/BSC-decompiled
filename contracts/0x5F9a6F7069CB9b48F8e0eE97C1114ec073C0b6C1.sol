...
array of struct stor94029185606696244996515478518301360031312099976060629666899178486830056775142;
...
function BRIDGE_ADDRESS() payable {
...
function transferToEth(uint256 arg1) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(sub_c947576aAddress)
    call sub_c947576aAddress.transferAndCall(address rg1, uint256 rg2, bytes rg3) with:
         gas gas_remaining wei
        args BRIDGE_ADDRESS, arg1, 96, 20, Mask(160, 32, msg.sender, 0) >> 32, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function transferToEth(uint256 arg1, address arg2) payable {
    ...
    call sub_c947576aAddress.transferAndCall(address rg1, uint256 rg2, bytes rg3) with:
         gas gas_remaining wei
        args BRIDGE_ADDRESS, arg1, 96, 20, Mask(160, 32, arg2, 0) >> 32, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function addProfit(uint256 arg1) payable {
    ...
    if not dfProfitsAddress:
        create contract with 0 wei
                        code: code.data[8472 len 1089], address(this.address)
    ...
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    profits.length++
    storCFE2[stor158.length].field_0 = uint64(block.number)
    storCFE2[stor158.length].field_64 = uint64(arg1 / 10^12)
    require ext_code.size(sub_f76fd0f4Address)
