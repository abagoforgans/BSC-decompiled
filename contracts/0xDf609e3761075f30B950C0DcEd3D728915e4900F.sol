...
function sub_c10d4062(?) payable {
    ...
    if adminAddress != msg.sender:
        revert with 0, 'Admin required'
    address(borrowerAddress) = 0x5752395eeb1ea1f3645214fc827cf29fafe40677
    if 0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c == stor1:
        ...
        require return_data.size >= 32
        require ext_code.size(address(stor0))
        if 0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c == address(ext_call.return_data[0]):
