...
function changeMasterCopy(address arg1) payable {
    require calldata.size - 4 >= 32
    if address(managerAddress) != msg.sender:
...
function getTransactionHash(address arg1, uint256 arg2, bytes arg3, uint8 arg4, uint256 arg5) payable {
    ...
    mem[ceil32(arg3.length) + 162] = this.address << 96
...
function execTransaction(address arg1, uint256 arg2, bytes arg3, uint8 arg4, uint256 arg5, bytes arg6) payable {
    ...
    mem[ceil32(arg3.length) + ceil32(arg6.length) + 194] = this.address << 96
    ...
    _54 = sha3(mem[ceil32(arg3.length) + ceil32(arg6.length) + 192 len Mask(8 * -ceil32(arg6.length) + arg6.length + 32, 0, 0), mem[ceil32(arg3.length) + arg6.length + 192 len -arg6.length + ceil32(arg6.length)]])
    ...
    require ext_code.size(address(managerAddress))
    staticcall address(managerAddress).0xe75235b8 with:
    ...
    while idx < ext_call.return_data[0]:
        _97 = mem[(65 * idx) + ceil32(arg3.length) + 160]
        _98 = mem[(65 * idx) + ceil32(arg3.length) + 192]
        _99 = mem[(65 * idx) + ceil32(arg3.length) + 193]
        _100 = mem[64]
        mem[mem[64]] = 0
        mem[64] = mem[64] + 32
        mem[_100 + 64] = uint8(_99)
        mem[_100 + 96] = _97
        mem[_100 + 128] = _98
        signer = erecover(_54, _99 << 248, _97, _98) 
        mem[_100] = signer
        if not erecover.result:
            revert with ext_call.return_data[0 len return_data.size]
        mem[_100 + 36] = address(signer)
        require ext_code.size(address(managerAddress))
        staticcall address(managerAddress).0x2f54bf6e with:
                gas gas_remaining wei
               args address(signer)
        mem[_100 + 32] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
    ...
    if not mem[96] % 32:
        require ext_code.size(address(managerAddress))
        call address(managerAddress).0x468721a7 with:
             gas gas_remaining wei
