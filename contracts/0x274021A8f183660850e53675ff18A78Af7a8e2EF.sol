...
address owner;
address fxswapAddress;
address devaddr;
uint256 bonusEndBlock;
uint256 fxswapPerBlock;
uint32 stor5;
...
function fxswap() payable {
    return fxswapAddress
}
...
function fxswapPerBlock() payable {
    return fxswapPerBlock
}
        ...
        if ext_call.return_data[0]:
            if block.number <= bonusEndBlock:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(fxswapAddress)
                    call fxswapAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if not uint255(block.number - poolInfo[arg1].field_512):
                        ...
                        if 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock / 2 * block.number - poolInfo[arg1].field_512 != fxswapPerBlock:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock:
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            require ext_code.size(fxswapAddress)
                            ...
                            require 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock
                            if 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            ...
                            call fxswapAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(fxswapAddress)
                            call fxswapAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args address(this.address), 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                ...
                                require 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint
                                if 10^12 * 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]
            else:
                if poolInfo[arg1].field_512 >= bonusEndBlock:
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        require block.number - poolInfo[arg1].field_512
                        if (block.number * fxswapPerBlock) - (poolInfo[arg1].field_512 * fxswapPerBlock) / block.number - poolInfo[arg1].field_512 != fxswapPerBlock:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (block.number * fxswapPerBlock) - (poolInfo[arg1].field_512 * fxswapPerBlock):
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            require ext_code.size(fxswapAddress)
                            ...
                            require (block.number * fxswapPerBlock) - (poolInfo[arg1].field_512 * fxswapPerBlock)
                            if (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / (block.number * fxswapPerBlock) - (poolInfo[arg1].field_512 * fxswapPerBlock) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            ...
                            call fxswapAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(fxswapAddress)
                            call fxswapAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args address(this.address), (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                ...
                                require (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if 10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                else:
                    ...
                    if not bonusEndBlock - poolInfo[arg1].field_512:
                        ...
                        if not block.number - bonusEndBlock:
                            ...
                            if (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock) / block.number - bonusEndBlock != fxswapPerBlock:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            if not (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock):
                                if totalAllocPoint <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require totalAllocPoint
                                require ext_code.size(fxswapAddress)
                                ...
                                require (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock)
                                if (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                if totalAllocPoint <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require totalAllocPoint
                                ...
                                call fxswapAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devaddr, (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(fxswapAddress)
                                call fxswapAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args address(this.address), (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    ...
                                    require (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                    if 10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if poolInfo[arg1].field_768 + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                    else:
                        ...
                        if not (2 * bonusEndBlock - poolInfo[arg1].field_512) + block.number - bonusEndBlock:
                            ...
                            if (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock) / (2 * bonusEndBlock - poolInfo[arg1].field_512) + block.number - bonusEndBlock != fxswapPerBlock:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            if not (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock):
                                if totalAllocPoint <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require totalAllocPoint
                                require ext_code.size(fxswapAddress)
                                ...
                                require (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock)
                                if (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                if totalAllocPoint <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require totalAllocPoint
                                ...
                                call fxswapAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devaddr, (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(fxswapAddress)
                                call fxswapAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args address(this.address), (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    ...
                                    require (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                    if 10^12 * (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                                    if ext_call.return_data[0] <= 0:
                                        revert with 0, 'SafeMath: division by zero'
                                    require ext_call.return_data[0]
                                    if poolInfo[arg1].field_768 + (10^12 * (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function pendingFxswap(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if block.number <= bonusEndBlock:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            ...
            return -userInfo[arg1][address(arg2)].field_256
        require userInfo[arg1][address(arg2)].field_0
        if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]):
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * 2 * block.number - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if poolInfo[arg1].field_512 >= bonusEndBlock:
        if poolInfo[arg1].field_512 > block.number:
            revert with 0, 'SafeMath: subtraction overflow'
        if not block.number - poolInfo[arg1].field_512:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            ...
            return -userInfo[arg1][address(arg2)].field_256
        require userInfo[arg1][address(arg2)].field_0
        if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if bonusEndBlock > block.number:
        revert with 0, 'SafeMath: subtraction overflow'
    if poolInfo[arg1].field_512 > bonusEndBlock:
        revert with 0, 'SafeMath: subtraction overflow'
    if not bonusEndBlock - poolInfo[arg1].field_512:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            ...
            return -userInfo[arg1][address(arg2)].field_256
        require userInfo[arg1][address(arg2)].field_0
        if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    require bonusEndBlock - poolInfo[arg1].field_512
    if 2 * bonusEndBlock - poolInfo[arg1].field_512 / bonusEndBlock - poolInfo[arg1].field_512 != 2:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if (2 * bonusEndBlock - poolInfo[arg1].field_512) + block.number - bonusEndBlock < 2 * bonusEndBlock - poolInfo[arg1].field_512:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (2 * bonusEndBlock - poolInfo[arg1].field_512 * fxswapPerBlock * poolInfo[arg1].field_256) + (block.number * fxswapPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if block.number <= bonusEndBlock:
            ...
            if 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock / 2 * block.number - poolInfo[idx].field_512 != fxswapPerBlock:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            if not 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock:
                _597 = mem[64]
                mem[64] = mem[64] + 64
                mem[_597] = 26
                ...
                revert with memory
                  from mem[64]
                   len _858 + -mem[64] + 100
            require 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock
            if 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _611 = mem[64]
            mem[64] = mem[64] + 64
            mem[_611] = 26
            ...
            call fxswapAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint
            require ext_code.size(fxswapAddress)
            call fxswapAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args address(this.address), 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint:
                _824 = mem[64]
                mem[64] = mem[64] + 64
                mem[_824] = 26
                ...
                revert with memory
                  from mem[64]
                   len _855 + -mem[64] + 100
            require 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint
            if 10^12 * 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint / 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _854 = mem[64]
            mem[64] = mem[64] + 64
            mem[_854] = 26
            ...
            if ext_call.return_data[0] > 0:
                require ext_call.return_data[0]
                if poolInfo[idx].field_768 + (10^12 * 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * 2 * block.number - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256 / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _881 = mem[64]
        ...
        if poolInfo[idx].field_512 >= bonusEndBlock:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                revert with memory
                  from mem[64]
                   len _745 + -mem[64] + 100
            require block.number - poolInfo[idx].field_512
            if (block.number * fxswapPerBlock) - (poolInfo[idx].field_512 * fxswapPerBlock) / block.number - poolInfo[idx].field_512 != fxswapPerBlock:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            if not (block.number * fxswapPerBlock) - (poolInfo[idx].field_512 * fxswapPerBlock):
                _569 = mem[64]
                mem[64] = mem[64] + 64
                mem[_569] = 26
                ...
                revert with memory
                  from mem[64]
                   len _768 + -mem[64] + 100
            require (block.number * fxswapPerBlock) - (poolInfo[idx].field_512 * fxswapPerBlock)
            if (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / (block.number * fxswapPerBlock) - (poolInfo[idx].field_512 * fxswapPerBlock) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _574 = mem[64]
            mem[64] = mem[64] + 64
            mem[_574] = 26
            ...
            call fxswapAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(fxswapAddress)
            call fxswapAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args address(this.address), (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                _740 = mem[64]
                mem[64] = mem[64] + 64
                mem[_740] = 26
                ...
                revert with memory
                  from mem[64]
                   len _765 + -mem[64] + 100
            require (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if 10^12 * (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _764 = mem[64]
            mem[64] = mem[64] + 64
            mem[_764] = 26
            ...
            if ext_call.return_data[0] > 0:
                require ext_call.return_data[0]
                if poolInfo[idx].field_768 + (10^12 * (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _799 = mem[64]
        ...
        if not bonusEndBlock - poolInfo[idx].field_512:
            ...
            if not (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock):
                ...
                revert with memory
                  from mem[64]
                   len _947 + -mem[64] + 100
            require (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock)
            if (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _663 = mem[64]
            mem[64] = mem[64] + 64
            mem[_663] = 26
            ...
            call fxswapAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(fxswapAddress)
            call fxswapAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args address(this.address), (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                _914 = mem[64]
                mem[64] = mem[64] + 64
                mem[_914] = 26
                ...
                revert with memory
                  from mem[64]
                   len _944 + -mem[64] + 100
            require (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if 10^12 * (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _943 = mem[64]
            mem[64] = mem[64] + 64
            mem[_943] = 26
            ...
            if ext_call.return_data[0] > 0:
                require ext_call.return_data[0]
                if poolInfo[idx].field_768 + (10^12 * (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _973 = mem[64]
        ...
        if (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock) / (2 * bonusEndBlock - poolInfo[idx].field_512) + block.number - bonusEndBlock != fxswapPerBlock:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock):
            _659 = mem[64]
            mem[64] = mem[64] + 64
            mem[_659] = 26
            ...
            revert with memory
              from mem[64]
               len _967 + -mem[64] + 100
        require (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock)
        if (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock) + (block.number * fxswapPerBlock) - (bonusEndBlock * fxswapPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _676 = mem[64]
        mem[64] = mem[64] + 64
        mem[_676] = 26
        ...
        call fxswapAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devaddr, (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(fxswapAddress)
        call fxswapAddress.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _934 = mem[64]
            mem[64] = mem[64] + 64
            mem[_934] = 26
            ...
            revert with memory
              from mem[64]
               len _964 + -mem[64] + 100
        require (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^12 * (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _963 = mem[64]
        mem[64] = mem[64] + 64
        mem[_963] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^12 * (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (2 * bonusEndBlock - poolInfo[idx].field_512 * fxswapPerBlock * poolInfo[idx].field_256) + (block.number * fxswapPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * fxswapPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _994 = mem[64]
        ...
        if userInfo[arg1][address(msg.sender)].field_0 <= 0:
            ...
            if not userInfo[arg1][address(msg.sender)].field_0:
                if userInfo[arg1][address(msg.sender)].field_256 > 0:
                    revert with 0, 'SafeMath: subtraction overflow'
                require ext_code.size(fxswapAddress)
                staticcall fxswapAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                    call fxswapAddress.0xa9059cbb with:
                         gas gas_remaining wei
