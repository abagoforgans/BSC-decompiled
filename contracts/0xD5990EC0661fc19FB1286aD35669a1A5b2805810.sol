...
function getBurnedTokens() {
    if 500 * 10^18 < totalSupply:
        revert with 0, 17
    return (-totalSupply + 500 * 10^18 / 10^9)
}
...
function TeamWithdrawALLMarketingBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor25 = 0
    if stor25 > 0x3a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a8:
        revert with 0, 17
    call stor13 with:
       value 70 * stor25 / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if stor25 > 0x888888888888888888888888888888888888888888888888888888888888888:
        revert with 0, 17
    call stor14 with:
       value 30 * stor25 / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function TeamWithdrawXMarketingBNB(uint256 arg1) {
    ...
    if stor25 < arg1:
        revert with 0, 17
    stor25 -= arg1
    if arg1 > 0x3a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a83a8:
        revert with 0, 17
    call stor13 with:
       value 70 * arg1 / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if arg1 > 0x888888888888888888888888888888888888888888888888888888888888888:
        revert with 0, 17
    call stor14 with:
       value 30 * arg1 / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function TeamCreateLPandBNB() {
    ...
    if balanceOf[this.address] >= 2 * 10^18:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            ...
            if not stor20:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor20].field_0 = -(2 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 2 * 10^18
            emit Approval((-(2 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 2 * 10^18), this.address, stor20);
            ...
            if not stor20:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor20].field_0 = 2 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][stor20].field_255 = 0
            emit Approval((2 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, stor20);
            require ext_code.size(stor20)
