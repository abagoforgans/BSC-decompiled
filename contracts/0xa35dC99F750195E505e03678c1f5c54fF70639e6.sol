...
function transfer(address arg1, uint256 arg2) {
    ...
    if stor7 >= stor14[address(arg1)]:
            ...
            if not stor14[address(msg.sender)]:
                if uniswapV2PairAddress != msg.sender:
                    if stor13[address(msg.sender)]:
                        if not stor14[address(msg.sender)]:
                            revert with 0, 18
                        stor13[address(msg.sender)] = stor13[address(msg.sender)] / stor14[address(msg.sender)]
            stor13[stor12[stor7]] = stor7
            stor12[stor7] = arg1
            if stor14[address(msg.sender)]:
                ...
                if stor8:
                    ...
                    if stor14[address(arg1)]:
                        ...
                        if arg2 and _tax > -1 / arg2:
                            revert with 0, 17
                        if arg2 < arg2 * _tax / 100:
                            revert with 0, 17
                        if balanceOf[address(msg.sender)] < arg2 * _tax / 100:
                            revert with 0, 17
                        balanceOf[address(msg.sender)] -= arg2 * _tax / 100
                        if balanceOf[address(msg.sender)] < arg2 - (arg2 * _tax / 100):
                            revert with 0, 17
                        balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - arg2 + (arg2 * _tax / 100)
                        if balanceOf[address(arg1)] > !(arg2 - (arg2 * _tax / 100)):
                            revert with 0, 17
                        balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (arg2 * _tax / 100)
                        emit Transfer((arg2 - (arg2 * _tax / 100)), msg.sender, arg1);
        else:
        ...
        if stor14[address(msg.sender)] > stor7:
            stor8 = 1
            ...
            if not stor14[address(arg1)]:
                if uniswapV2PairAddress != arg1:
                    if stor13[address(arg1)]:
                        if not stor14[address(arg1)]:
                            revert with 0, 18
                        stor13[address(arg1)] = stor13[address(arg1)] / stor14[address(arg1)]
            stor13[stor12[stor7]] = stor7
            stor12[stor7] = arg2
            if stor14[address(arg1)]:
                ...
                if stor8:
                    ...
                    if stor14[address(arg2)]:
                        ...
                        if arg3 and _tax > -1 / arg3:
                            revert with 0, 17
                        if arg3 < arg3 * _tax / 100:
                            revert with 0, 17
                        if balanceOf[address(arg1)] < arg3 * _tax / 100:
                            revert with 0, 17
                        balanceOf[address(arg1)] -= arg3 * _tax / 100
                        if balanceOf[address(arg1)] < arg3 - (arg3 * _tax / 100):
                            revert with 0, 17
                        balanceOf[address(arg1)] = balanceOf[address(arg1)] - arg3 + (arg3 * _tax / 100)
                        if balanceOf[address(arg2)] > !(arg3 - (arg3 * _tax / 100)):
                            revert with 0, 17
                        balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (arg3 * _tax / 100)
                        emit Transfer((arg3 - (arg3 * _tax / 100)), arg1, arg2);
        else:
    ...
    if unknown_0x715018a6(?????) <= uint32(call.func_hash) >> 224:
        if unknown_0xdd62ed3e(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xdd62ed3e(?????) == uint32(call.func_hash) >> 224:
                ...
                return allowance[address(arg1)][address(arg2)]
            if unknown_0xe751d508(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return _tax
                    ...
                    if stor8:
                        ...
                        if stor14[address(arg1)]:
                            ...
                            if balanceOf[address(arg1)] > !(arg2 - (arg2 * _tax / 100)):
                                revert with 0, 17
                            balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (arg2 * _tax / 100)
                            emit Transfer((arg2 - (arg2 * _tax / 100)), msg.sender, address(arg1));
            else:
                    ...
                    if stor8:
                        ...
                        if stor14[address(arg2)]:
                            ...
                            if balanceOf[address(arg2)] > !(arg3 - (arg3 * _tax / 100)):
                                revert with 0, 17
                            balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (arg3 * _tax / 100)
                            emit Transfer((arg3 - (arg3 * _tax / 100)), address(arg1), address(arg2));
            else:
