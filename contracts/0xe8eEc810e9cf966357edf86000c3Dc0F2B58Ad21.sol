...
function getUserLevelState(address arg1) {
    ...
    if block.timestamp < startTime + duration - sub_3d7faab9 + stor7:
        ...
        if ceil32(_156) <= _156:
            ...
            mem[mem[64] + 32] = 27, address(arg1) << 64
            mem[_475 + 64] = 0, Mask(224, 32, block.timestamp < startTime + duration) >> 32
            mem[_475 + 96] = bool(uint32(block.timestamp < startTime + duration), 0)
            return memory
              from mem[64]
               len ceil32(_156) + _475 + -mem[64] + 160
        ...
        mem[_156 + mem[64] + 160] = 0
        mem[mem[64] + 32] = 27, address(arg1) << 64
        mem[_476 + 64] = 0, Mask(224, 32, block.timestamp < startTime + duration) >> 32
        mem[_476 + 96] = bool(uint32(block.timestamp < startTime + duration), 0)
        return memory
          from mem[64]
           len ceil32(_156) + _476 + -mem[64] + 160
    if stor7 > 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
        revert with 0, 17
    if startTime + duration - sub_3d7faab9 > !(2 * stor7):
        revert with 0, 17
