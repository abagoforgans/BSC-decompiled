...
function sub_b66f2f67(?) {
    ...
    if msg.sender != this.address:
        revert with 0, 'ONLY_WALLET_ERROR'
    mem[ceil32(arg1.length) + 128] = sha3(Mask(8 * arg1.length, -(8 * arg1.length) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * arg1.length) - 256)
    mem[ceil32(arg1.length) + 160] = 64
    emergencyCalls.length++
    emergencyCalls[emergencyCalls.length].field_0 = Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]
    emergencyCalls[emergencyCalls.length].field_256 = 64
}
            ...
            if not unlockTimes[arg1]:
                ...
                while idx < emergencyCalls.length:
                    ...
                    if Mask(8, 248, mem[128]):
                        ...
                        continue 
                    require 1 < mem[96]
                    if Mask(8, 248, mem[129]) != Mask(8, -(('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) + 256, 1) << (('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) - 8:
                        idx = idx + 1
                        continue 
                    require 2 < mem[96]
                    if Mask(8, 248, mem[130]) != Mask(8, -(('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) + 256, 2) << (('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) - 8:
                        idx = idx + 1
                        continue 
                    require 3 < mem[96]
                    if Mask(8, 248, mem[131]) != Mask(8, -(('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) + 256, 3) << (('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) - 8:
                        idx = idx + 1
                        continue 
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3) {
    ...
    while idx < owners.length:
        ...
        if not stor2[stor7][address(stor5[idx].field_0)]:
            ...
            mem[ceil32(arg3.length) + 288] = stor1[stor7][2].field_0
            ...
            while idx < emergencyCalls.length:
                ...
                if Mask(8, 248, mem[ceil32(arg3.length) + 288]):
                    idx = idx + 1
                    continue 
                require 1 < mem[ceil32(arg3.length) + 256]
                if Mask(8, 248, mem[ceil32(arg3.length) + 289]) != Mask(8, -(('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) + 256, 1) << (('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) - 8:
                    idx = idx + 1
                    continue 
                require 2 < mem[ceil32(arg3.length) + 256]
                if Mask(8, 248, mem[ceil32(arg3.length) + 290]) != Mask(8, -(('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) + 256, 2) << (('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) - 8:
                    idx = idx + 1
                    continue 
                require 3 < mem[ceil32(arg3.length) + 256]
                if Mask(8, 248, mem[ceil32(arg3.length) + 291]) != Mask(8, -(('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) + 256, 3) << (('field', 3, ('stor', ('array', ('mul', 2, ('var', 0)), ('name', 'emergencyCalls', 8)))), 0) - 8:
                    idx = idx + 1
                    continue 
                return transactionCount
        else:
