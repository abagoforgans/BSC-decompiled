...
function sub_af3585fe(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == arg2
    stor13[arg2].field_0++
    stor13[arg2][stor13[arg2].field_0].field_0 = address(arg1)
    return 1
}
...
function getTrack(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    mem[64] = (32 * stor13[arg1].field_0) + 128
    mem[96] = stor13[arg1].field_0
    if not stor13[arg1].field_0:
        mem[(32 * stor13[arg1].field_0) + 128] = 32
        mem[(32 * stor13[arg1].field_0) + 160] = stor13[arg1].field_0
        idx = 0
        s = 128
        t = (32 * stor13[arg1].field_0) + 192
        while idx < stor13[arg1].field_0:
            ...
            continue 
        return memory
          from (32 * stor13[arg1].field_0) + 128
           len (96 * stor13[arg1].field_0) + 64
    mem[128] = stor13[arg1].field_0
    idx = 128
    s = 0
    while (32 * stor13[arg1].field_0) + 96 > idx:
    ...
    return memory
      from mem[64]
       len (64 * stor13[arg1].field_0) + -mem[64] + 192
}
...
function tokenURIs(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
