...
function burn(uint256 arg1) payable {
    ...
    if stor2[msg.sender]:
        ...
        call sub_4df0f898Address.safeTransferFrom(address rg1, address rg2, uint256 rg3) with:
        ...
        if not sub_cf61cbe4[arg1].field_1024:
            ...
            stor[sha3(mem[ceil32(stor3[arg1][6].length) + 576 len stor3[arg1][6].length + 32])] = 0
        else:
