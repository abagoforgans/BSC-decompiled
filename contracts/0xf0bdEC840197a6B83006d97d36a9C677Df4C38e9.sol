...
const sub_34b1a50c(?) = 'https://www.metacrypt.org', 0

const sub_49b0db14(?) = '', 0

const version = '', 0

const generator = 'https://www.metacrypt.org', 0

const createdByMetacrypt = 1
...
function getIdentifier() payable {
