...
const name = 'BengalsSB'

const decimals = 9

const symbol = 'BengalsSB'
...
function getUnpaidEarnings(address arg1) {
    ...
    if not stor4[address(msg.sender)]:
        return 0
    if 10 > stor4[address(arg1)]:
        revert with 0, 'SafeMath: subtraction overflow'
    return (stor4[address(arg1)] - 10)
}
...
function sub_69ec98b2(?) {
    ...
    if stor4[address(msg.sender)]:
        if stor4[address(msg.sender)]:
            if 10 > stor4[address(arg1)]:
                revert with 0, 'SafeMath: subtraction overflow'
            if stor4[address(arg1)] - 10 > 0:
                if stor4[address(msg.sender)] + stor4[address(arg1)] - 10 < stor4[address(msg.sender)]:
                    revert with 0, 'SafeMath: addition overflow'
                stor4[address(msg.sender)] = stor4[address(msg.sender)] + stor4[address(arg1)] - 10
                require ext_code.size(stor8)
                call stor8.0xa9059cbb with:
                     gas gas_remaining wei
                    args address(arg1), stor4[address(arg1)] - 10
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
}

function sub_4efd98ba(?) payable {
    require ext_code.size(stor8)
...
function transfer(address arg1, uint256 arg2) {
    ...
    if stor3[address(msg.sender)]:
        ...
        if mem[ceil32(return_data.size) + 672] > 0:
            ...
            if mem[ceil32(return_data.size) + 704] + mem[ceil32(return_data.size) + 576] < mem[ceil32(return_data.size) + 704]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(msg.sender)] = mem[ceil32(return_data.size) + 704] + mem[ceil32(return_data.size) + 576]
            require 4 < mem[ceil32(return_data.size) + 512]
            if balanceOf[stor0] + mem[ceil32(return_data.size) + 672] < balanceOf[stor0]:
                revert with 0, 'SafeMath: addition overflow'
    ...
    if balanceOf[address(arg1)] + mem[ceil32(return_data.size) + 576] < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if stor3[address(arg1)]:
        ...
        if mem[ceil32(return_data.size) + 672] > 0:
            ...
            if mem[ceil32(return_data.size) + 704] + mem[ceil32(return_data.size) + 576] < mem[ceil32(return_data.size) + 704]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(arg1)] = mem[ceil32(return_data.size) + 704] + mem[ceil32(return_data.size) + 576]
            require 4 < mem[ceil32(return_data.size) + 512]
            if balanceOf[stor0] + mem[ceil32(return_data.size) + 672] < balanceOf[stor0]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[stor0] += mem[ceil32(return_data.size) + 672]
        ...
        balanceOf[address(arg1)] -= mem[ceil32(return_data.size) + 576]
        if balanceOf[address(arg2)] + mem[ceil32(return_data.size) + 576] < balanceOf[address(arg2)]:
            revert with 0, 'SafeMath: addition overflow'
        balanceOf[address(arg2)] += mem[ceil32(return_data.size) + 576]
