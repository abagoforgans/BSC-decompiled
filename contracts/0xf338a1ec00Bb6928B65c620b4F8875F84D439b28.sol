            ...
            if block.timestamp >= sub_47334aca[address(arg1)] + sub_e43db193:
                ...
                if not sub_df8d8b05:
                    ...
                    if uint8(24 * sub_df8d8b05) > 18:
                        revert with 0, 17
                    if sub_47334aca[address(arg1)] + sub_e43db193 < block.timestamp:
                        revert with 0, 17
                    if sub_47334aca[address(arg1)] + sub_e43db193 - block.timestamp < uint16(3600 * uint8(24 * sub_df8d8b05)):
                        if sub_47334aca[address(arg1)] > !uint16(3600 * uint8(24 * sub_df8d8b05)):
                            revert with 0, 17
                        sub_47334aca[address(arg1)] += uint16(3600 * uint8(24 * sub_df8d8b05))
                        if block.timestamp < sub_47334aca[address(arg1)]:
                            sub_47334aca[address(arg1)] = block.timestamp
            if not sub_47334aca[address(arg1)]:
                userInfo[address(arg1)].field_256 = 0
