...
function sub_7452df57(?) {
    ...
    while idx < stor4.length:
        _67 = mem[96]
        require mem[96] < mem[96]
        mem[(32 * mem[96]) + 128] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]
        require idx < stor5.length
        require mem[96] < mem[96]
        mem[(32 * mem[96]) + 128] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]
        require idx < stor6.length
        require mem[96] < mem[96]
        mem[(32 * mem[96]) + 128] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor6', 6))[uint8(idx)]
        require idx < stor7.length
        require mem[96] < mem[96]
        mem[(32 * mem[96]) + 128] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)]
        require idx < stor6.length
        ...
        staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]].field_0).mem[mem[64] len 4] with:
               ...
               args mem[mem[64] + 4 len _92 + (32 * _94) + -mem[64] + 96]
        if ext_call.success:
            _137 = mem[64]
            ...
            _141 = mem[_137 + mem[_137]]
            require mem[_137 + mem[_137]] <= test266151307()
            require (32 * mem[_137 + mem[_137]]) + 32 >= 0 and _137 + ceil32(return_data.size) + (32 * mem[_137 + mem[_137]]) + 32 <= test266151307()
            ...
            if 99 == stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)]:
                require _141 - 1 < _141
                require _67 < mem[96]
                mem[(32 * _67) + 128] = mem[(32 * _141 - 1) + _137 + ceil32(return_data.size) + 32]
            else:
                require idx < stor6.length
                require idx < stor7.length
                require stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor6', 6))[uint8(idx)] < tokens.length
                ...
                mem[0] = 1
                require _141 - 1 < _141
                _200 = mem[(32 * _141 - 1) + _137 + ceil32(return_data.size) + 32]
                _201 = mem[64]
                mem[mem[64]] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = _200
                mem[mem[64] + 36] = 64
                ...
                staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]].field_0).mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _201 + (32 * _202) + -mem[64] + 96]
                if ext_call.success:
                    _219 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    ...
                    mem[_219 + ceil32(return_data.size)] = _223
                    ...
                    require _223 - 1 < _223
                    require _67 < mem[96]
                    mem[(32 * _67) + 128] = mem[(32 * _223 - 1) + _219 + ceil32(return_data.size) + 32]
        idx = idx + 1
        continue 
    _68 = mem[64]
    mem[mem[64]] = 160
    ...
    mem[mem[64] + (32 * mem[96]) + 224 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
    var20007 = mem[64] + (64 * mem[96]) + 224
    mem[mem[64] + 64] = (64 * mem[96]) + 224
    _179 = mem[96]
    mem[mem[64] + (64 * mem[96]) + 224] = mem[96]
    mem[var20007 + 32 len 32 * _179] = mem[128 len 32 * _179]
    mem[_68 + 96] = var20007 + (32 * _179) + -_68 + 32
    _216 = mem[96]
    mem[var20007 + (32 * _179) + 32] = mem[96]
    mem[var20007 + (32 * _179) + 64 len 32 * _216] = mem[128 len 32 * _216]
    mem[_68 + 128] = var20007 + (32 * _179) + (32 * _216) + -_68 + 64
    _233 = mem[96]
    mem[var20007 + (32 * _179) + (32 * _216) + 64] = mem[96]
    mem[var20007 + (32 * _179) + (32 * _216) + 96 len 32 * _233] = mem[128 len 32 * _233]
    return memory
      from mem[64]
       len var20007 + (32 * _179) + (32 * _216) + (32 * _233) + -mem[64] + 96
}
