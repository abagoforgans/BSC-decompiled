...
function sub_7b854541(?) {
    ...
    call packages[arg1].field_0.0xa9059cbb with:
         gas gas_remaining wei
...
function sub_bcb21edd(?) {
    ...
    require ext_code.size(packages[arg1].field_0)
    call packages[arg1].field_0.0x23b872dd with:
         gas gas_remaining wei
...
function sub_8f61717c(?) {
    ...
    require return_data.size >= 32
    if not ext_call.return_data[0]:
        revert with 0, 32, 37, 0x5943524f535346494e204641524d3a205452414e5346455220544f4b454e30204641494c45, mem[521 len 27]
    require ext_code.size(packages[arg1].field_0)
    ...
    require return_data.size >= 32
    if not ext_call.return_data[0]:
        revert with 0, 32, 37, 0x4f43524f535346494e204641524d3a205452414e5346455220544f4b454e31204641494c45, mem[521 len 27]
    if not arg2:
        if 0 > arg2:
            revert with 0, 'SafeMath: subtraction overflow'
        if not arg2:
