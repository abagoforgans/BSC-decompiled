...
function query() payable {
    ...
    staticcall shareTokenAddress.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function mint() payable {
    ...
    if not totalProductivity:
        ...
        if not users[address(msg.sender)].field_0:
            ...
            mem[(2 * ceil32(return_data.size)) + 260 len 96] = transfer(address rg1, uint256 rg2), msg.sender, users[address(msg.sender)].field_512, mem[(2 * ceil32(return_data.size)) + 260 len 28]
            ...
            if not users[address(msg.sender)].field_512:
                revert with 0, 'NOTHING TO MINT'
            mem[(2 * ceil32(return_data.size)) + 452 len 96] = transfer(address rg1, uint256 rg2), msg.sender, users[address(msg.sender)].field_512, mem[(2 * ceil32(return_data.size)) + 452 len 28]
        ...
        if not users[address(msg.sender)].field_0:
            if not users[address(msg.sender)].field_512:
                revert with 0, 'NOTHING TO MINT'
            mem[(2 * ceil32(return_data.size)) + 324 len 96] = transfer(address rg1, uint256 rg2), msg.sender, users[address(msg.sender)].field_512, mem[(2 * ceil32(return_data.size)) + 324 len 28]
            ...
            if not users[address(msg.sender)].field_512:
                revert with 0, 'NOTHING TO MINT'
            mem[(2 * ceil32(return_data.size)) + 516 len 96] = transfer(address rg1, uint256 rg2), msg.sender, users[address(msg.sender)].field_512, mem[(2 * ceil32(return_data.size)) + 516 len 28]
