...
function sub_165fd13f(?) {
    ...
    if arg2.length != 64:
        revert with 0, 'C1 - Invalid hash provided'
    if not stor13[msg.sender]:
        revert with 0, 32, 33, 0x6e4332202d20556e7665726966696564207075626c697368657220616464726573, mem[ceil32(arg2.length) + 229 len 31]
    ...
    if stor10[stor2]:
        ...
        emit Transfer(this.address, msg.sender, sub_0a72fb86);
        uint256(tokenCreator[stor2]) = msg.sender or Mask(96, 160, uint256(tokenCreator[stor2]))
        uint256(tokenHash[stor2][]) = Array(len=arg2.length, data=arg2[all])
        mem[ceil32(arg2.length) + 128 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
        mem[ceil32(arg2.length) + floor32(arg2.length) + 128] = 256^(-(arg2.length % 32) + 32) - 1 and mem[ceil32(arg2.length) + floor32(arg2.length) + 128] or call.data[arg2 + floor32(arg2.length) + 36 len arg2.length % 32], Mask(8 * -(arg2.length % 32) + 32, -(8 * -(arg2.length % 32) + 32) + 256, 0) << (8 * -(arg2.length % 32) + 32) - 256 and !(256^(-(arg2.length % 32) + 32) - 1)
        mem[ceil32(arg2.length) + arg2.length + 128] = 6
        stor[mem[arg2.length + 160 len ceil32(arg2.length)]][Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0)] = sub_0a72fb86
        sub_0a72fb86++
        mem[ceil32(arg2.length) + 128 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
        mem[ceil32(arg2.length) + floor32(arg2.length) + 128] = mem[ceil32(arg2.length) + floor32(arg2.length) + 128] and 256^(-(arg2.length % 32) + 32) - 1 or call.data[arg2 + floor32(arg2.length) + 36 len arg2.length % 32], Mask(8 * -(arg2.length % 32) + 32, -(8 * -(arg2.length % 32) + 32) + 256, 0) << (8 * -(arg2.length % 32) + 32) - 256 and !(256^(-(arg2.length % 32) + 32) - 1)
        emit sub_0a72fb86: sha3(call.data[arg2 + 36 len floor32(arg2.length)], mem[ceil32(arg2.length) + floor32(arg2.length) + 128 len arg2.length % 32])
        if sub_0a72fb86 <= 0:
            revert with 0, 'C0 - NFT not created'
        if not stor10[stor2]:
            revert with 0, 
                        32,
                        41,
        ...
        if not stor10[stor2]:
            revert with 0, 
                        ...
                        41,
                        0x734552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65,
                        mem[ceil32(arg2.length) + 297 len 23],
                        mem[ceil32(arg2.length) + 343 len 9]
    else:
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length].field_0 = sub_0a72fb86
        address(tokenByIndex[tokenByIndex.length].field_256) = msg.sender
        ...
        mem[ceil32(arg2.length) + arg2.length + 192] = 6
        stor[mem[ceil32(arg2.length) + floor32(arg2.length) + 192 len (arg2.length % 32) + 32]][call.data[arg2 + 36 len floor32(arg2.length)]] = sub_0a72fb86
        sub_0a72fb86++
        mem[ceil32(arg2.length) + 192 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
        mem[ceil32(arg2.length) + floor32(arg2.length) + 192] = mem[ceil32(arg2.length) + floor32(arg2.length) + 192] and 256^(-(arg2.length % 32) + 32) - 1 or call.data[arg2 + floor32(arg2.length) + 36 len arg2.length % 32], Mask(8 * -(arg2.length % 32) + 32, -(8 * -(arg2.length % 32) + 32) + 256, 0) << (8 * -(arg2.length % 32) + 32) - 256 and !(256^(-(arg2.length % 32) + 32) - 1)
        emit sub_0a72fb86: sha3(call.data[arg2 + 36 len floor32(arg2.length)], mem[ceil32(arg2.length) + floor32(arg2.length) + 192 len arg2.length % 32])
        if sub_0a72fb86 <= 0:
            revert with 0, 'C0 - NFT not created'
        if not stor10[stor2]:
            revert with 0, 
                        ...
                        41,
                        0x734552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65,
                        mem[ceil32(arg2.length) + 265 len 23],
                        mem[ceil32(arg2.length) + 311 len 9]
        require stor10[stor2] - 1 < tokenByIndex.length
        if address(tokenByIndex[stor10[stor2] - 1].field_256) != msg.sender:
            revert with 0, 
                        32,
        ...
        if not arg1:
            revert with 0, 
                        ...
                        36,
                        0x734552433732313a207472616e7366657220746f20746865207a65726f20616464726573,
                        mem[ceil32(arg2.length) + 392 len 28]
        approved[stor2] = 0
        if not stor10[stor2]:
            revert with 0, 
                        32,
                        41,
                        0x734552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65,
                        mem[ceil32(arg2.length) + 361 len 23],
                        mem[ceil32(arg2.length) + 407 len 9]
    ('bool', ('stor', ('map', ('stor', ('name', 'stor2', 2)), ('name', 'stor10', 10))))
    require stor10[stor2] - 1 < tokenByIndex.length
    emit Approval(address(tokenByIndex[stor10[stor2] - 1].field_256), 0, sub_0a72fb86);
    if tokenOfOwnerByIndex[address(msg.sender)][1][stor2]:
        require tokenOfOwnerByIndex[address(msg.sender)] - 1 < tokenOfOwnerByIndex[address(msg.sender)]
        require tokenOfOwnerByIndex[address(msg.sender)][1][stor2] - 1 < tokenOfOwnerByIndex[address(msg.sender)]
        tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)][1][stor2]] = tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)]]
        tokenOfOwnerByIndex[address(msg.sender)][1][tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)]]] = tokenOfOwnerByIndex[address(msg.sender)][1][stor2]
        ...
        tokenOfOwnerByIndex[address(msg.sender)]--
        tokenOfOwnerByIndex[address(msg.sender)][1][stor2] = 0
    if not tokenOfOwnerByIndex[address(arg1)][1][stor2]:
        tokenOfOwnerByIndex[address(arg1)]++
        tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = sub_0a72fb86
        tokenOfOwnerByIndex[address(arg1)][1][stor2] = tokenOfOwnerByIndex[address(arg1)]
    if stor10[stor2]:
        require stor10[stor2] - 1 < tokenByIndex.length
        address(tokenByIndex[stor10[stor2] - 1].field_256) = arg1
        Mask(96, 0, tokenByIndex[stor10[stor2] - 1].field_416) = 0
    else:
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length].field_0 = sub_0a72fb86
        ...
        Mask(96, 0, tokenByIndex[tokenByIndex.length].field_416) = 0
        stor10[stor2] = tokenByIndex.length
    emit Transfer(msg.sender, arg1, sub_0a72fb86);
    return sub_0a72fb86
}
