...
#
const name = 'SquidKing', 0

const InitialSupply = 10^16

const decimals = 8

const TeamWallet = 0x5ebce955d4c34cfb120ccc35afd59c40e88b86cc

const symbol = 'SquidKing', 0
...
function getBurnedTokens() {
    if 10^16 < totalSupply:
        revert with 'NH{q', 17
    return (-totalSupply + 10^16 / 100 * 10^6)
}
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x5ebce955d4c34cfb120ccc35afd59c40e88b86cc with:
