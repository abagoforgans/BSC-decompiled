...
function buyCooldownEnabled() {
    return bool(uint8(stor28.field_0))
}
...
function cooldownEnabled(bool arg1, uint8 arg2) {
    ...
    Mask(240, 0, stor28.field_16) = Mask(240, 16, arg1) >> 16
}
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not arg1:
        if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
            revert with 0, 'SafeMath: division by zero'
        return (0 / totalSupply - balanceOf[stor4] - balanceOf[stor5])
    if 2 * balanceOf[address(stor25.field_0)] * arg1 / arg1 != 2 * balanceOf[address(stor25.field_0)]:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[address(stor25.field_0)] * arg1 / totalSupply - balanceOf[stor4] - balanceOf[stor5])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not arg2:
        if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
            revert with 0, 'SafeMath: division by zero'
        return (0 / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
    if 2 * balanceOf[address(stor25.field_0)] * arg2 / arg2 != 2 * balanceOf[address(stor25.field_0)]:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[address(stor25.field_0)] * arg2 / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
}

function sub_21e1fa54(?) payable {
    mem[64] = 96
    ...
    mem[0] = address(cd[4])
    mem[32] = 9
    if balanceOf[address(cd[4])] < cd[((32 * ('cd', 36).length) + cd[68] + 36)] * ('cd', 36).length:
        revert with 0, 'Not enough tokens to approve'
    idx = 0
    while idx < ('cd', 36).length:
        require idx < ('cd', 68).length
        _63 = mem[64]
        ...
        if cd[((32 * idx) + cd[68] + 36)] + balanceOf[address(cd[((32 * idx) + cd[36] + 36)])] < balanceOf[address(cd[((32 * idx) + cd[36] + 36)])]:
            revert with 0, 'SafeMath: addition overflow'
        ...
        mem[32] = 14
        if not stor14[address(cd[((32 * idx) + cd[36] + 36)])]:
            require idx < ('cd', 36).length
            mem[0] = address(cd[((32 * idx) + cd[36] + 36)])
            mem[32] = 9
