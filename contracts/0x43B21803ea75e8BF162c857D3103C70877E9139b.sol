...
function sub_805f4202(?) {
    ...
    idx = 0
    while idx < arg1:
        mem[96 len 3688] = code.data[19958 len 3688]
        create contract with 0 wei
                        code: code.data[19958 len 3688]
...
function sub_13dab3c8(?) {
    ...
    if sub_2d7f13afAddress == sub_cc2ca7a5Address:
        ...
        mem[(2 * ceil32(return_data.size)) + 192] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, (-1 * 10^10 * stor10) + 10^14 / 10000) >> 32 + 192]
