...
function sub_3247d940(?) payable {
    ...
    if ('cd', 4).length:
        mem[128 len 32 * ('cd', 4).length] = code.data[13776 len 32 * ('cd', 4).length]
...
function sub_89b27b0b(?) payable {
    if not stor0.length:
        ...
        return 128, 
               ...
               mem[256 len 3968]
    mem[96] = stor0.length
    mem[128 len 32 * stor0.length] = code.data[13776 len 32 * stor0.length]
    mem[(32 * stor0.length) + 128] = stor0.length
    mem[(32 * stor0.length) + 160 len 32 * stor0.length] = code.data[13776 len 32 * stor0.length]
    mem[(64 * stor0.length) + 160] = stor0.length
    mem[(64 * stor0.length) + 192 len 32 * stor0.length] = code.data[13776 len 32 * stor0.length]
    mem[(98 * stor0.length) + 192] = stor0.length
    mem[64] = (131 * stor0.length) + 224
    mem[(98 * stor0.length) + 224 len 32 * stor0.length] = code.data[13776 len 32 * stor0.length]
    idx = 0
