...
#  - advance()
#
const name = 'Circle Dollar Stake', 0

const decimals = 18

const epochTime = (block.timestamp - (447589 * 3600) / 5400)
...
function unbondUnderlying(uint256 arg1) payable {
    ...
    if epoch + 16 < epoch:
        revert with 0, 'SafeMath: addition overflow'
    fluidUntil[address(msg.sender)].field_1024 = epoch + 16
    if not arg1:
        if not totalBonded:
            revert with 0, 'SafeMath: division by zero', 0
        if arg1 + fluidUntil[address(msg.sender)].field_0 < fluidUntil[address(msg.sender)].field_0:
...
function emergencyCommit(address arg1) payable {
    ...
    if not periodFor[address(arg1)].field_0:
        ...
        if 447589 * 3600 > block.timestamp:
            revert with 0, 'SafeMath: subtraction overflow', 0
        mem[448] = 26
        mem[480] = 'SafeMath: division by zero'
        if block.timestamp - (447589 * 3600) / 5400 < block.timestamp - (447589 * 3600) / 5400:
            revert with 0, 'SafeMath: addition overflow'
        if block.timestamp - (447589 * 3600) / 5400 <= epoch + 2:
            ...
            if not periodFor[address(arg1)].field_512:
                ...
                if 55 * 10^16 == 10^18 * periodFor[address(arg1)].field_512 / totalSupply:
                    mem[736] = 0x476f7665726e0000000000000000000000000000000000000000000000000000
                    mem[704] = 32
                    mem[64] = 768
                    idx = 32
                    ...
                    if 10^18 * periodFor[address(arg1)].field_512 / totalSupply <= 55 * 10^16:
                        mem[736] = 0x476f7665726e0000000000000000000000000000000000000000000000000000
                        mem[704] = 32
                        mem[64] = 768
                        idx = 32
