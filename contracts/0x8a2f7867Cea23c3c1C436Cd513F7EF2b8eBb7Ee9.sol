...
address owner;
address fireAddress;
address sub_f0ccc911Address;
address devaddr;
uint256 sub_28ea4251;
...
function sub_f0ccc911(?) payable {
    return sub_f0ccc911Address
}
    ...
    if block.number > poolInfo[arg1].field_512:
        ...
        if ext_call.return_data[0]:
            ...
            if not block.number - poolInfo[arg1].field_512:
                ...
                require ext_code.size(fireAddress)
                call fireAddress.0x40c10f19 with:
                     gas gas_remaining wei
                ...
                call fireAddress.0x40c10f19 with:
                     gas gas_remaining wei
                    args sub_f0ccc911Address, 0 / totalAllocPoint
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if not (block.number * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER):
                    ...
                    if (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251) / (block.number * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER) != sub_28ea4251:
                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                    if not (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251):
                        if not totalAllocPoint:
                            revert with 0, 'SafeMath: division by zero'
                        require ext_code.size(fireAddress)
                        call fireAddress.0x40c10f19 with:
                        ...
                        if (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251) != poolInfo[arg1].field_256:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not totalAllocPoint:
                            revert with 0, 'SafeMath: division by zero'
                        require ext_code.size(fireAddress)
                        call fireAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args devaddr, (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(fireAddress)
                        call fireAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args sub_f0ccc911Address, (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if not (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint:
                            if not ext_call.return_data[0]:
                                revert with 0, 'SafeMath: division by zero'
                            if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            ...
                            if 10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                            if not ext_call.return_data[0]:
                                revert with 0, 'SafeMath: division by zero'
                            if (10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[arg1].field_768 += 10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function sub_5b21d0e3(?) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(address(poolInfo[arg1].field_0))
    staticcall address(poolInfo[arg1].field_0).0x70a08231 with:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        if userInfo[arg1][address(arg2)].field_256 > 0:
            revert with 0, 'SafeMath: subtraction overflow'
        return -userInfo[arg1][address(arg2)].field_256
    if (10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            mem[mem[64] + 4] = sub_f0ccc911Address
        ...
        if not (block.number * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER):
            ...
            revert with memory
              from mem[64]
               len _267 + -mem[64] + 100
        if (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251) / (block.number * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER) != sub_28ea4251:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251):
            _189 = mem[64]
            mem[64] = mem[64] + 64
            mem[_189] = 26
            ...
            revert with memory
              from mem[64]
               len _274 + -mem[64] + 100
        if (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _193 = mem[64]
        mem[64] = mem[64] + 64
        mem[_193] = 26
        ...
        call fireAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devaddr, (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = sub_f0ccc911Address
        mem[mem[64] + 36] = (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(fireAddress)
        call fireAddress.0x40c10f19 with:
             gas gas_remaining wei
            args sub_f0ccc911Address, (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint:
            _255 = mem[64]
            mem[64] = mem[64] + 64
            mem[_255] = 26
            ...
            revert with memory
              from mem[64]
               len _271 + -mem[64] + 100
        if 10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint / (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _263 = mem[64]
        mem[64] = mem[64] + 64
        mem[_263] = 26
        ...
        if ext_call.return_data[0]:
            if (10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_28ea4251 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _281 = mem[64]
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if not arg1:
        revert with 0, 'withdraw FIRE by unstaking'
    require arg1 < poolInfo.length
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][msg.sender].field_0:
            ...
            if not -userInfo[arg1][msg.sender].field_256:
                ...
                require ext_code.size(sub_f0ccc911Address)
                call sub_f0ccc911Address.0x764985c5 with:
                     gas gas_remaining wei
...
function deposit(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if not arg1:
        revert with 0, 'deposit FIRE by staking'
    require arg1 < poolInfo.length
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][msg.sender].field_0:
            if not arg2:
        ...
        if not ext_call.return_data[0]:
            ...
            if not block.number - uint256(poolInfo.field_512):
                ...
                if not (block.number * BONUS_MULTIPLIER) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER):
                    ...
                    if (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251) / (block.number * BONUS_MULTIPLIER) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER) != sub_28ea4251:
                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                    if not (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251):
                        if not totalAllocPoint:
                            revert with 0, 'SafeMath: division by zero'
                        require ext_code.size(fireAddress)
                        call fireAddress.0x40c10f19 with:
                        ...
                        if (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / (block.number * BONUS_MULTIPLIER * sub_28ea4251) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251) != uint256(poolInfo.field_256):
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not totalAllocPoint:
                            revert with 0, 'SafeMath: division by zero'
                        require ext_code.size(fireAddress)
                        call fireAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args devaddr, (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / totalAllocPoint / 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(fireAddress)
                        call fireAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args sub_f0ccc911Address, (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / totalAllocPoint
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if not (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / totalAllocPoint:
                            if not ext_call.return_data[0]:
                                revert with 0, 'SafeMath: division by zero'
                            if (0 / ext_call.return_data[0]) + uint256(poolInfo.field_768) < uint256(poolInfo.field_768):
                                revert with 0, 'SafeMath: addition overflow'
                            ...
                            if 10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / totalAllocPoint / (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / totalAllocPoint != 10^12:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                            if not ext_call.return_data[0]:
                                revert with 0, 'SafeMath: division by zero'
                            if (10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / totalAllocPoint / ext_call.return_data[0]) + uint256(poolInfo.field_768) < uint256(poolInfo.field_768):
                                revert with 0, 'SafeMath: addition overflow'
                            uint256(poolInfo.field_768) += 10^12 * (block.number * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * BONUS_MULTIPLIER * sub_28ea4251 * uint256(poolInfo.field_256)) / totalAllocPoint / ext_call.return_data[0]
                            uint256(poolInfo.field_512) = block.number
                            if not userInfo[0][msg.sender].field_0:
                                if userInfo[0][msg.sender].field_256 > 0:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                ...
                                if not arg1:
                                    ...
                                    if not userInfo[0][msg.sender].field_0:
                                        ...
                                        userInfo[0][msg.sender].field_256 = uint256(poolInfo.field_768) * userInfo[0][msg.sender].field_0 / 10^12
    require ext_code.size(sub_f0ccc911Address)
    call sub_f0ccc911Address.0x9dc29fac with:
         gas gas_remaining wei
