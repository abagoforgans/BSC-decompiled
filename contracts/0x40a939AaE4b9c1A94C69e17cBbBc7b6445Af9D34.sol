...
function sub_ab57d832(?) {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_33bce082Address)
    call sub_33bce082Address.burn(address rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function sub_d84eac00(?) {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_33bce082Address)
    call sub_33bce082Address.mint(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args address(arg1), arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_60dd02ef(?) {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_33bce082Address)
    call sub_33bce082Address.withdraw(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args address(arg1), arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_af5b8c82(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_33bce082Address)
    call sub_33bce082Address.deposit(address rg1, uint256 rg2) with:
       value msg.value wei
         gas gas_remaining wei
        args address(arg1), arg2
    if not ext_call.success:
...
function sub_4188bf5e(?) payable {
    require calldata.size - 4 >= 96
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_33bce082Address)
    call sub_33bce082Address.open(address rg1, uint256 rg2, uint256 rg3) with:
       value msg.value wei
         gas gas_remaining wei
...
function sub_c59091f9(?) {
    ...
    while idx < ('cd', 68).length:
        ...
        continue 
    require ext_code.size(sub_33bce082Address)
    call sub_33bce082Address.exchange(uint256 rg1, address rg2, address[] rg3) with:
         gas gas_remaining wei
        args cd[4], address(cd[36]), Array(len=('cd', 68).length, data=mem[228 len 32 * ('cd', 68).length])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function set(address arg1, address arg2, address arg3, address arg4) {
    ...
    WETHAddress = arg3
    sub_33bce082Address = arg4
    require ext_code.size(arg4)
    staticcall arg4.0x9dca0032 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
