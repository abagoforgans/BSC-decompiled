...
function earn() payable {
    ...
    mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), ext_call.return_data[0 len 28]
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), ext_call.return_data[0]
...
function depositAll() payable {
    ...
    if not return_data.size:
        ...
        if not totalSupply:
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[520 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor7.field_0)
                 gas gas_remaining wei
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[584 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor7.field_0)
                 gas gas_remaining wei
        ...
        if not totalSupply:
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 521 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor7.field_0)
                 gas gas_remaining wei
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 585 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7.field_0), uint32(stor7.field_0), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor7.field_0)
                 gas gas_remaining wei
