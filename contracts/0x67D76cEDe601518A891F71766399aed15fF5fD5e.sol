...
function sub_31f17857(?) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0x5e09381febfacc93925fb2d111a7eba211334bc9)
    delegate 0x5e09381febfacc93925fb2d111a7eba211334bc9.0x13d674fe with:
...
function approve(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434)
    delegate 0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0x9fd1ebb052e12ee4cb16d04a10466a6fe5d77ac6)
        delegate 0x9fd1ebb052e12ee4cb16d04a10466a6fe5d77ac6.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    require arg2 == arg2
    require ext_code.size(0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434)
    delegate 0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_5126dad7(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
        delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
        delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x4051a30492a17dd6bbaa3ad041cac1bfbd3e347c)
        delegate 0x4051a30492a17dd6bbaa3ad041cac1bfbd3e347c.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_f090df5d(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x4051a30492a17dd6bbaa3ad041cac1bfbd3e347c)
        delegate 0x4051a30492a17dd6bbaa3ad041cac1bfbd3e347c.0xc2d5b6ab with:
             gas gas_remaining wei
...
function sub_528f6b54(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x6ba57ffe8a1b2ec83f116373e71a58808fae2bd9)
        delegate 0x6ba57ffe8a1b2ec83f116373e71a58808fae2bd9.0xa7b9a567 with:
             gas gas_remaining wei
...
function sub_594161f8(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0x9fd1ebb052e12ee4cb16d04a10466a6fe5d77ac6)
        delegate 0x9fd1ebb052e12ee4cb16d04a10466a6fe5d77ac6.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
        delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434)
            delegate 0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
        delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) payable {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
        delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_c8d49a06(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x6ba57ffe8a1b2ec83f116373e71a58808fae2bd9)
        delegate 0x6ba57ffe8a1b2ec83f116373e71a58808fae2bd9.mem[ceil32(arg1.length) + ceil32(arg2.length) + 160 len 4] with:
             gas gas_remaining wei
...
function sub_a05e1c7d(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < cd[(cd[4] + ('cd', 4)[5] + 4)]:
            ...
            continue 
        require ('cd', 4)[13] < 21
        require ext_code.size(0x7f5cd8b520e2b3e944a5d80ef437576dd90399e0)
        delegate 0x7f5cd8b520e2b3e944a5d80ef437576dd90399e0.0x3b7e41e6 with:
             gas gas_remaining wei
...
function sub_3367ad09(?) payable {
    ...
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0x7f5cd8b520e2b3e944a5d80ef437576dd90399e0)
    delegate 0x7f5cd8b520e2b3e944a5d80ef437576dd90399e0.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) payable {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0x7f5cd8b520e2b3e944a5d80ef437576dd90399e0)
    delegate 0x7f5cd8b520e2b3e944a5d80ef437576dd90399e0.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) payable {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0x9fd1ebb052e12ee4cb16d04a10466a6fe5d77ac6)
        delegate 0x9fd1ebb052e12ee4cb16d04a10466a6fe5d77ac6.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
        delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d32ea8b6(?) payable {
    ...
    mem[516] = arg1
    require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
    delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_4dc26ae8(?) payable {
    ...
    mem[132] = 19
    require ext_code.size(0x6ba57ffe8a1b2ec83f116373e71a58808fae2bd9)
    delegate 0x6ba57ffe8a1b2ec83f116373e71a58808fae2bd9.0x45d85d80 with:
         gas gas_remaining wei
        args 19
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) payable {
    ...
    mem[132] = 14
    require ext_code.size(0xf54fd21f99dcd8289d68df8dcab157e5ee788aec)
    delegate 0xf54fd21f99dcd8289d68df8dcab157e5ee788aec.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) payable {
    ...
    mem[388] = arg1
    require ext_code.size(0x5e09381febfacc93925fb2d111a7eba211334bc9)
    delegate 0x5e09381febfacc93925fb2d111a7eba211334bc9.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434)
    delegate 0x15ec63400f2dcffbd3319d7ef1d73e52dee8a434.0xc5bb51da with:
         gas gas_remaining wei
