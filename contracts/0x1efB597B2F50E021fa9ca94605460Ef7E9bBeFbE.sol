...
uint256 stor7;
uint256 round;
mapping of struct yourStakedUNEX;
...
function yourStakedUNEX(address arg1) payable {
    require calldata.size - 4 >= 32
    return yourStakedUNEX[address(arg1)].field_0
}
...
function yourUNEXBalance(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(UNEXAddress)
    staticcall UNEXAddress.0x70a08231 with:
...
function ADDFUNDS(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(UNEXAddress)
    call UNEXAddress.0x23b872dd with:
         gas gas_remaining wei
...
function getPendingReward(address arg1) payable {
    ...
    if not totalDividends - payouts[stor9[address(arg1)].field_768 - 1]:
        ...
        if not totalDividends - payouts[stor9[address(arg1)].field_768 - 1]:
            if stor7:
                return (yourStakedUNEX[address(arg1)].field_1024 + (0 % stor7) + (0 / stor7))
        else:
            if (totalDividends * yourStakedUNEX[address(arg1)].field_0) - (payouts[stor9[address(arg1)].field_768 - 1] * yourStakedUNEX[address(arg1)].field_0) / totalDividends - payouts[stor9[address(arg1)].field_768 - 1] != yourStakedUNEX[address(arg1)].field_0:
                revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
            if stor7:
                return (yourStakedUNEX[address(arg1)].field_1024 + ((totalDividends * yourStakedUNEX[address(arg1)].field_0) - (payouts[stor9[address(arg1)].field_768 - 1] * yourStakedUNEX[address(arg1)].field_0) % stor7) + (0 / stor7))
    else:
        if (totalDividends * yourStakedUNEX[address(arg1)].field_0) - (payouts[stor9[address(arg1)].field_768 - 1] * yourStakedUNEX[address(arg1)].field_0) / totalDividends - payouts[stor9[address(arg1)].field_768 - 1] != yourStakedUNEX[address(arg1)].field_0:
        ...
        if not totalDividends - payouts[stor9[address(arg1)].field_768 - 1]:
            if stor7:
                return (yourStakedUNEX[address(arg1)].field_1024 + (0 % stor7) + ((totalDividends * yourStakedUNEX[address(arg1)].field_0) - (payouts[stor9[address(arg1)].field_768 - 1] * yourStakedUNEX[address(arg1)].field_0) / stor7))
        else:
            if (totalDividends * yourStakedUNEX[address(arg1)].field_0) - (payouts[stor9[address(arg1)].field_768 - 1] * yourStakedUNEX[address(arg1)].field_0) / totalDividends - payouts[stor9[address(arg1)].field_768 - 1] != yourStakedUNEX[address(arg1)].field_0:
                revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
            if stor7:
                return (yourStakedUNEX[address(arg1)].field_1024 + ((totalDividends * yourStakedUNEX[address(arg1)].field_0) - (payouts[stor9[address(arg1)].field_768 - 1] * yourStakedUNEX[address(arg1)].field_0) % stor7) + ((totalDividends * yourStakedUNEX[address(arg1)].field_0) - (payouts[stor9[address(arg1)].field_768 - 1] * yourStakedUNEX[address(arg1)].field_0) / stor7))
    ('iszero', ('stor', ('name', 'stor7', 7)))
    revert
}

function CLAIMREWARD() payable {
    if totalDividends > yourStakedUNEX[msg.sender].field_512:
        ...
        if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
            ...
            if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
                require stor7
                yourStakedUNEX[address(msg.sender)].field_1024 += 0 % stor7
            else:
                if (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1] != yourStakedUNEX[address(msg.sender)].field_0:
                    revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                require stor7
                yourStakedUNEX[address(msg.sender)].field_1024 += (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) % stor7
            if yourStakedUNEX[msg.sender].field_1024 + (0 / stor7) < 0 / stor7:
                revert with 0, 'SafeMath: addition overflow'
            yourStakedUNEX[msg.sender].field_1024 = 0
            require ext_code.size(UNEXAddress)
            call UNEXAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, yourStakedUNEX[msg.sender].field_1024 + (0 / stor7)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if not ext_call.return_data[0]:
            ...
            emit CLAIMEDREWARD(msg.sender, yourStakedUNEX[msg.sender].field_1024 + (0 / stor7));
            yourStakedUNEX[msg.sender].field_256 = yourStakedUNEX[msg.sender].field_1024 + (0 / stor7)
        else:
            if (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1] != yourStakedUNEX[address(msg.sender)].field_0:
                revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
            if not stor7:
            ...
            if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
                ...
                require stor7
                yourStakedUNEX[address(msg.sender)].field_1024 += (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) % stor7
            if yourStakedUNEX[msg.sender].field_1024 + ((totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / stor7) < (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / stor7:
                revert with 0, 'SafeMath: addition overflow'
            yourStakedUNEX[msg.sender].field_1024 = 0
            require ext_code.size(UNEXAddress)
            call UNEXAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, yourStakedUNEX[msg.sender].field_1024 + ((totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / stor7)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if not ext_call.return_data[0]:
                revert with 0, 32, 44, 0xfe4552524f523a206572726f7220696e2073656e64696e67207265776172642066726f6d20636f6e74726163, mem[400 len 20]
            emit CLAIMEDREWARD(msg.sender, yourStakedUNEX[msg.sender].field_1024 + ((totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / stor7));
            yourStakedUNEX[msg.sender].field_256 = yourStakedUNEX[msg.sender].field_1024 + ((totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / stor7)
        yourStakedUNEX[msg.sender].field_768 = round
        yourStakedUNEX[msg.sender].field_512 = totalDividends
}

function WITHDRAW(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if arg1 > yourStakedUNEX[msg.sender].field_0:
    ...
    if not 100 * arg1 + 99 / 100:
        ...
        if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
            ...
            if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
                ...
                require stor7
                yourStakedUNEX[address(msg.sender)].field_1024 += (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) % stor7
            yourStakedUNEX[msg.sender].field_1024 += 0 / stor7
            if 0 > arg1:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(UNEXAddress)
            call UNEXAddress.0xa9059cbb with:
            ...
            if arg1 > yourStakedUNEX[msg.sender].field_0:
                revert with 0, 'SafeMath: subtraction overflow'
            yourStakedUNEX[msg.sender].field_0 -= arg1
            yourStakedUNEX[msg.sender].field_256 = 0 / stor7
        else:
            if (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1] != yourStakedUNEX[address(msg.sender)].field_0:
                revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
            if not stor7:
            ...
            if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
                ...
                require stor7
                yourStakedUNEX[address(msg.sender)].field_1024 += (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) % stor7
            yourStakedUNEX[msg.sender].field_1024 += (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / stor7
            if 0 > arg1:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(UNEXAddress)
            call UNEXAddress.0xa9059cbb with:
            ...
            if arg1 > yourStakedUNEX[msg.sender].field_0:
                revert with 0, 'SafeMath: subtraction overflow'
            yourStakedUNEX[msg.sender].field_0 -= arg1
            yourStakedUNEX[msg.sender].field_256 = (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / stor7
        yourStakedUNEX[msg.sender].field_512 = totalDividends
        yourStakedUNEX[msg.sender].field_768 = round
        if arg1 > totalStakes:
            revert with 0, 'SafeMath: subtraction overflow'
...
function STAKE(uint256 arg1) payable {
    ...
    if not totalStakes:
        ...
        if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
            ...
            if 0 > arg1:
                revert with 0, 'SafeMath: subtraction overflow'
            if yourStakedUNEX[msg.sender].field_0 + arg1 < arg1:
                revert with 0, 'SafeMath: addition overflow'
            yourStakedUNEX[msg.sender].field_0 += arg1
            yourStakedUNEX[msg.sender].field_256 = 0 / stor7
        else:
                ...
                if not totalStakes:
                    ...
                    if not totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1]:
                        ...
                        if stor3 * 10000 * arg1 + 99 / 100 / 10000 / 10 > arg1:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if yourStakedUNEX[msg.sender].field_0 < 0:
                            revert with 0, 'SafeMath: addition overflow'
                        yourStakedUNEX[msg.sender].field_0 = yourStakedUNEX[msg.sender].field_0 + arg1 - (stor3 * 10000 * arg1 + 99 / 100 / 10000 / 10)
                        yourStakedUNEX[msg.sender].field_256 = 0 / stor7
                    else:
                        if (totalDividends * yourStakedUNEX[address(msg.sender)].field_0) - (payouts[stor9[address(msg.sender)].field_768 - 1] * yourStakedUNEX[address(msg.sender)].field_0) / totalDividends - payouts[stor9[address(msg.sender)].field_768 - 1] != yourStakedUNEX[address(msg.sender)].field_0:
                            revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
