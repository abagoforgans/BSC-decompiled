    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = approve(address rg1, uint256 rg2), 0x73feaa1ee314f8c655e35423, 0, ext_call.return_data[0 len 28]
                mem[488 len 0] = 0
            call wantAddress.0x93c9e24e with:
                 gas gas_remaining wei
    ...
    if ext_call.return_data[0] >= arg1:
        if not withdrawalFee:
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
                mem[488 len 0] = 0
                call wantAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
                call wantAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[ceil32(return_data.size) + 489 len 4]
            ...
            if not arg1:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 489 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
                call wantAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
        ...
        if not withdrawalFee:
            ...
            if not arg1:
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
                    call wantAddress with:
                       funct uint32(stor6)
                         gas gas_remaining wei
