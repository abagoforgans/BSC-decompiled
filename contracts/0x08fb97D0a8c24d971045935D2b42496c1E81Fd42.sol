...
const getTokenInterfacesVersion = 2, 1, 0
...
function burn(uint256 arg1) {
    ...
    emit code.data[5044 len 32]: arg1, msg.sender, 0
}
...
function mint(address arg1, uint256 arg2) {
    ...
    emit Mint(arg2, arg1);
    emit code.data[5044 len 32]: arg2, 0, arg1
    return 1
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    emit code.data[5044 len 32]: arg2, msg.sender, arg1
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    emit code.data[5044 len 32]: arg3, arg1, arg2
    if ext_code.size(arg2) > 0:
        ...
        call arg2.mem[292 len 4] with:
            ...
            args mem[296 len 156]
        if not ext_call.success:
            require bridgeContractAddress != arg2
    ...
    if not arg1:
        ...
        if not ext_call.success:
            create contract with ('balance', 'address') wei
                            code: code.data[5011 len 33], arg2
