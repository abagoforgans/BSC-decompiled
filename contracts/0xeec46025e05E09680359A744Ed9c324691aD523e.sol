...
function sub_e41c3e2e(?) {
    ...
    mem[ceil32(arg2.length) + 132] = address(stor[mem[arg2.length + 160 len ceil32(arg2.length)]][Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0)])
    require ext_code.size(address(arg1))
    call address(arg1).approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args mem[ceil32(arg2.length) + 132], -1
