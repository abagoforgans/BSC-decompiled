...
function sub_c0eb67ef(?) {
    ...
    if ext_call.return_data[0]:
        ...
        staticcall sub_7ef560eeAddress.getTokenToEthInputPrice(uint256 rg1) with:
                gas gas_remaining wei
...
function trade(uint256 arg1) {
    ...
    if arg1 < eth.balance(this.address):
        if arg1:
            if arg1 + 999 < arg1:
                revert with 0, 'SafeMath: addition overflow'
            if arg1 + 999 / 1000 > arg1:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(exchangeAddress)
            staticcall exchangeAddress.getEthToTokenInputPrice(uint256 rg1) with:
                    gas gas_remaining wei
                   args (arg1 - (arg1 + 999 / 1000))
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(exchangeAddress)
            call exchangeAddress.ethToTokenSwapInput(uint256 rg1, uint256 rg2) with:
               value arg1 wei
                 gas gas_remaining wei
                args ext_call.return_data[0], block.timestamp + 600
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] + 999 < ext_call.return_data[0]:
        ...
        if eth.balance(this.address):
            if eth.balance(this.address) + 999 < eth.balance(this.address):
                revert with 0, 'SafeMath: addition overflow'
            if eth.balance(this.address) + 999 / 1000 > eth.balance(this.address):
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(exchangeAddress)
            staticcall exchangeAddress.getEthToTokenInputPrice(uint256 rg1) with:
                    gas gas_remaining wei
                   args (eth.balance(this.address) - (eth.balance(this.address) + 999 / 1000))
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(exchangeAddress)
