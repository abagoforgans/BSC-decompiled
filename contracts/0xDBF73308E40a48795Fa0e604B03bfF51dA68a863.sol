    ...
    if not balanceOf[stor31]:
        ...
        if balanceOf[stor31]:
            ...
            if not arg1:
                ...
                if arg1:
                    if arg1 * 2 * balanceOf[stor31] / arg1 != 2 * balanceOf[stor31]:
                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                    if totalSupply - balanceOf[stor4] - balanceOf[stor5] <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    if totalSupply - balanceOf[stor4] - balanceOf[stor5]:
                        return (arg1 * 2 * balanceOf[stor31] / totalSupply - balanceOf[stor4] - balanceOf[stor5])
    revert
}
    ...
    if not balanceOf[stor31]:
        ...
        if balanceOf[stor31]:
            ...
            if not arg2:
                ...
                if arg2:
                    if arg2 * 2 * balanceOf[stor31] / arg2 != 2 * balanceOf[stor31]:
                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                    if totalSupply - balanceOf[stor4] - balanceOf[stor5] <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    if totalSupply - balanceOf[stor4] - balanceOf[stor5]:
                        return (arg2 * 2 * balanceOf[stor31] / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
    revert
}
