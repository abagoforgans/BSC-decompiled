...
#
const name = 'BabbyHitlerInu'

const decimals = 4

const symbol = 'BabbyHitlerInu'
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[stor28] * arg1 / totalSupply - balanceOf[stor4] - balanceOf[stor5])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[stor28] * arg2 / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
}
