...
function sub_f73f6b80(?) payable {
    ...
    staticcall sub_1d73112cAddress.balanceOf(address arg1) with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(sub_1d73112cAddress)
    staticcall sub_1d73112cAddress.allowance(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    if uint256(auction[arg1].field_512) < uint256(auction[arg1].field_512) * sub_25e24977 / 100:
        revert with 0, 17
    require ext_code.size(sub_1d73112cAddress)
    call sub_1d73112cAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
...
function sub_fdee61c6(?) {
    ...
    if not ('cd', 4).length:
        ...
        if not ('cd', 4).length:
            ...
            if not ('cd', 4).length:
                ...
                while idx < _884:
                    ...
                    t = t + 32
                    continue 
                mem[_808 + 32] = (32 * _884) + 160
                _1136 = mem[(64 * ('cd', 4).length) + 160]
                mem[_808 + (32 * _884) + 160] = mem[(64 * ('cd', 4).length) + 160]
                mem[_808 + (32 * _884) + 192 len 32 * _1136] = mem[(64 * ('cd', 4).length) + 192 len 32 * _1136]
                var35001 = _1136
                mem[_808 + 64] = (32 * _884) + (32 * _1136) + 192
                _1264 = mem[(98 * ('cd', 4).length) + 192]
                mem[_808 + (32 * _884) + (32 * _1136) + 192] = mem[(98 * ('cd', 4).length) + 192]
                mem[_808 + (32 * _884) + (32 * _1136) + 224 len 32 * _1264] = mem[(98 * ('cd', 4).length) + 224 len 32 * _1264]
                mem[_808 + 96] = (32 * _884) + (32 * _1136) + (32 * _1264) + 224
                _1360 = mem[(131 * ('cd', 4).length) + 224]
                mem[_808 + (32 * _884) + (32 * _1136) + (32 * _1264) + 224] = mem[(131 * ('cd', 4).length) + 224]
                mem[_808 + (32 * _884) + (32 * _1136) + (32 * _1264) + 256 len 32 * _1360] = mem[(131 * ('cd', 4).length) + 256 len 32 * _1360]
                return memory
                  from mem[64]
                   len _808 + (32 * _884) + (32 * _1136) + (32 * _1264) + (32 * _1360) + -mem[64] + 256
            mem[(131 * ('cd', 4).length) + 256 len 32 * ('cd', 4).length] = call.data[calldata.size len 32 * ('cd', 4).length]
            idx = 0
            while idx < ('cd', 4).length:
                if idx >= mem[96]:
        ...
        if not ('cd', 4).length:
            ...
            if not ('cd', 4).length:
                ...
                while idx < _890:
                    ...
                    t = t + 32
                    continue 
                mem[_818 + 32] = (32 * _890) + 160
                _1138 = mem[(64 * ('cd', 4).length) + 160]
                mem[_818 + (32 * _890) + 160] = mem[(64 * ('cd', 4).length) + 160]
                mem[_818 + (32 * _890) + 192 len 32 * _1138] = mem[(64 * ('cd', 4).length) + 192 len 32 * _1138]
                var35001 = _1138
                mem[_818 + 64] = (32 * _890) + (32 * _1138) + 192
                _1266 = mem[(98 * ('cd', 4).length) + 192]
                mem[_818 + (32 * _890) + (32 * _1138) + 192] = mem[(98 * ('cd', 4).length) + 192]
                mem[_818 + (32 * _890) + (32 * _1138) + 224 len 32 * _1266] = mem[(98 * ('cd', 4).length) + 224 len 32 * _1266]
                mem[_818 + 96] = (32 * _890) + (32 * _1138) + (32 * _1266) + 224
                _1362 = mem[(128 * ('cd', 4).length) + 224]
                mem[_818 + (32 * _890) + (32 * _1138) + (32 * _1266) + 224] = mem[(128 * ('cd', 4).length) + 224]
                mem[_818 + (32 * _890) + (32 * _1138) + (32 * _1266) + 256 len 32 * _1362] = mem[(128 * ('cd', 4).length) + 256 len 32 * _1362]
                return memory
                  from mem[64]
                   len _818 + (32 * _890) + (32 * _1138) + (32 * _1266) + (32 * _1362) + -mem[64] + 256
        ...
        if not ('cd', 4).length:
            ...
            while idx < _896:
                ...
                t = t + 32
                continue 
            mem[_828 + 32] = (32 * _896) + 160
            _1140 = mem[(64 * ('cd', 4).length) + 160]
            mem[_828 + (32 * _896) + 160] = mem[(64 * ('cd', 4).length) + 160]
            mem[_828 + (32 * _896) + 192 len 32 * _1140] = mem[(64 * ('cd', 4).length) + 192 len 32 * _1140]
            var36001 = _1140
            mem[_828 + 64] = (32 * _896) + (32 * _1140) + 192
            _1268 = mem[(98 * ('cd', 4).length) + 192]
            mem[_828 + (32 * _896) + (32 * _1140) + 192] = mem[(98 * ('cd', 4).length) + 192]
            mem[_828 + (32 * _896) + (32 * _1140) + 224 len 32 * _1268] = mem[(98 * ('cd', 4).length) + 224 len 32 * _1268]
            mem[_828 + 96] = (32 * _896) + (32 * _1140) + (32 * _1268) + 224
            _1364 = mem[(128 * ('cd', 4).length) + 224]
            mem[_828 + (32 * _896) + (32 * _1140) + (32 * _1268) + 224] = mem[(128 * ('cd', 4).length) + 224]
            mem[_828 + (32 * _896) + (32 * _1140) + (32 * _1268) + 256 len 32 * _1364] = mem[(128 * ('cd', 4).length) + 256 len 32 * _1364]
            return memory
              from mem[64]
               len _828 + (32 * _896) + (32 * _1140) + (32 * _1268) + (32 * _1364) + -mem[64] + 256
        mem[(128 * ('cd', 4).length) + 256 len 32 * ('cd', 4).length] = call.data[calldata.size len 32 * ('cd', 4).length]
        idx = 0
        while idx < ('cd', 4).length:
            if idx >= mem[96]:
        ...
        while idx < _899:
            ...
            t = t + 32
            continue 
        mem[_833 + 32] = (32 * _899) + 160
        _1141 = mem[(64 * ('cd', 4).length) + 160]
        mem[_833 + (32 * _899) + 160] = mem[(64 * ('cd', 4).length) + 160]
        mem[_833 + (32 * _899) + 192 len 32 * _1141] = mem[(64 * ('cd', 4).length) + 192 len 32 * _1141]
        var37001 = _1141
        mem[_833 + 64] = (32 * _899) + (32 * _1141) + 192
        _1269 = mem[(98 * ('cd', 4).length) + 192]
        mem[_833 + (32 * _899) + (32 * _1141) + 192] = mem[(98 * ('cd', 4).length) + 192]
        mem[_833 + (32 * _899) + (32 * _1141) + 224 len 32 * _1269] = mem[(98 * ('cd', 4).length) + 224 len 32 * _1269]
        mem[_833 + 96] = (32 * _899) + (32 * _1141) + (32 * _1269) + 224
        _1365 = mem[(128 * ('cd', 4).length) + 224]
        mem[_833 + (32 * _899) + (32 * _1141) + (32 * _1269) + 224] = mem[(128 * ('cd', 4).length) + 224]
        mem[_833 + (32 * _899) + (32 * _1141) + (32 * _1269) + 256 len 32 * _1365] = mem[(128 * ('cd', 4).length) + 256 len 32 * _1365]
        return memory
          from mem[64]
           len _833 + (32 * _899) + (32 * _1141) + (32 * _1269) + (32 * _1365) + -mem[64] + 256
    mem[(32 * ('cd', 4).length) + 160 len 32 * ('cd', 4).length] = call.data[calldata.size len 32 * ('cd', 4).length]
    if ('cd', 4).length > test266151307():
        revert with 0, 65
    mem[(64 * ('cd', 4).length) + 160] = ('cd', 4).length
    if not ('cd', 4).length:
        ...
        if not ('cd', 4).length:
            ...
            while idx < _905:
                ...
                t = t + 32
                continue 
            mem[_843 + 32] = (32 * _905) + 160
            _1143 = mem[(64 * ('cd', 4).length) + 160]
            mem[_843 + (32 * _905) + 160] = mem[(64 * ('cd', 4).length) + 160]
            mem[_843 + (32 * _905) + 192 len 32 * _1143] = mem[(64 * ('cd', 4).length) + 192 len 32 * _1143]
            var36001 = _1143
            mem[_843 + 64] = (32 * _905) + (32 * _1143) + 192
            _1271 = mem[(98 * ('cd', 4).length) + 192]
            mem[_843 + (32 * _905) + (32 * _1143) + 192] = mem[(98 * ('cd', 4).length) + 192]
            mem[_843 + (32 * _905) + (32 * _1143) + 224 len 32 * _1271] = mem[(98 * ('cd', 4).length) + 224 len 32 * _1271]
            mem[_843 + 96] = (32 * _905) + (32 * _1143) + (32 * _1271) + 224
            _1367 = mem[(131 * ('cd', 4).length) + 224]
            mem[_843 + (32 * _905) + (32 * _1143) + (32 * _1271) + 224] = mem[(131 * ('cd', 4).length) + 224]
            mem[_843 + (32 * _905) + (32 * _1143) + (32 * _1271) + 256 len 32 * _1367] = mem[(131 * ('cd', 4).length) + 256 len 32 * _1367]
            return memory
              from mem[64]
               len _843 + (32 * _905) + (32 * _1143) + (32 * _1271) + (32 * _1367) + -mem[64] + 256
        mem[(98 * ('cd', 4).length) + 224 len 32 * ('cd', 4).length] = call.data[calldata.size len 32 * ('cd', 4).length]
        if ('cd', 4).length > test266151307():
            revert with 0, 65
        mem[(131 * ('cd', 4).length) + 224] = ('cd', 4).length
        ...
        while idx < _911:
            ...
            t = t + 32
            continue 
        mem[_853 + 32] = (32 * _911) + 160
        _1145 = mem[(64 * ('cd', 4).length) + 160]
        mem[_853 + (32 * _911) + 160] = mem[(64 * ('cd', 4).length) + 160]
        mem[_853 + (32 * _911) + 192 len 32 * _1145] = mem[(64 * ('cd', 4).length) + 192 len 32 * _1145]
        var37001 = _1145
        mem[_853 + 64] = (32 * _911) + (32 * _1145) + 192
        _1273 = mem[(98 * ('cd', 4).length) + 192]
        mem[_853 + (32 * _911) + (32 * _1145) + 192] = mem[(98 * ('cd', 4).length) + 192]
        mem[_853 + (32 * _911) + (32 * _1145) + 224 len 32 * _1273] = mem[(98 * ('cd', 4).length) + 224 len 32 * _1273]
        mem[_853 + 96] = (32 * _911) + (32 * _1145) + (32 * _1273) + 224
        _1369 = mem[(131 * ('cd', 4).length) + 224]
        mem[_853 + (32 * _911) + (32 * _1145) + (32 * _1273) + 224] = mem[(131 * ('cd', 4).length) + 224]
        mem[_853 + (32 * _911) + (32 * _1145) + (32 * _1273) + 256 len 32 * _1369] = mem[(131 * ('cd', 4).length) + 256 len 32 * _1369]
        return memory
          from mem[64]
           len _853 + (32 * _911) + (32 * _1145) + (32 * _1273) + (32 * _1369) + -mem[64] + 256
    mem[(64 * ('cd', 4).length) + 192 len 32 * ('cd', 4).length] = call.data[calldata.size len 32 * ('cd', 4).length]
    if ('cd', 4).length > test266151307():
        revert with 0, 65
    mem[(98 * ('cd', 4).length) + 192] = ('cd', 4).length
    ...
    if ('cd', 4).length:
        ...
        while idx < _923:
            ...
            t = t + 32
            continue 
        mem[mem[64] + 32] = (32 * _923) + 160
        _1149 = mem[(64 * ('cd', 4).length) + 160]
        mem[mem[64] + (32 * _923) + 160] = mem[(64 * ('cd', 4).length) + 160]
        mem[mem[64] + (32 * _923) + 192 len 32 * _1149] = mem[(64 * ('cd', 4).length) + 192 len 32 * _1149]
        mem[mem[64] + 64] = (32 * _923) + (32 * _1149) + 192
        _1277 = mem[(98 * ('cd', 4).length) + 192]
        mem[mem[64] + (32 * _923) + (32 * _1149) + 192] = mem[(98 * ('cd', 4).length) + 192]
        mem[mem[64] + (32 * _923) + (32 * _1149) + 224 len 32 * _1277] = mem[(98 * ('cd', 4).length) + 224 len 32 * _1277]
        mem[mem[64] + 96] = (32 * _923) + (32 * _1149) + (32 * _1277) + 224
        _1373 = mem[(131 * ('cd', 4).length) + 224]
        mem[mem[64] + (32 * _923) + (32 * _1149) + (32 * _1277) + 224] = mem[(131 * ('cd', 4).length) + 224]
        mem[mem[64] + (32 * _923) + (32 * _1149) + (32 * _1277) + 256 len 32 * _1373] = mem[(131 * ('cd', 4).length) + 256 len 32 * _1373]
        return 128, 
               (32 * _923) + 160,
               (32 * _923) + (32 * _1149) + 192,
               (32 * _923) + (32 * _1149) + (32 * _1277) + 224,
               mem[mem[64] + 128 len (32 * _923) + (32 * _1149) + (32 * _1277) + (32 * _1373) + 128]
    idx = 0
    while idx < ('cd', 4).length:
        if idx >= mem[96]:
            revert with 0, 50
