...
function changePrimaryOwner() payable {
    if primaryOwner != msg.sender:
        revert with 0, 32, 27, code.data[4915 len 27]
...
function sub_272860fd(?) payable {
    ...
    if sub_b88da759[arg1]:
        revert with 0, 32, 40, code.data[4870 len 40], mem[332 len 24]
...
function sub_32b90e72(?) payable {
    ...
    create contract with 0 wei
                    code: code.data[3829 len 1041], arg1
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x3a5d4213 with:
         gas gas_remaining wei
        args 0, arg2, arg3, arg4, arg5, address(arg6), arg7, address(arg8), arg9
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    currentVersion = arg1
