...
uint256 totalVolume;
uint256 totalFees;
uint256 sub_5355b0aa;
uint256 sub_55155495;
uint256 swapTx;
...
function sub_5355b0aa(?) {
    return sub_5355b0aa
}

function sub_55155495(?) {
    return sub_55155495
}
...
function sub_b3858487(?) {
    ...
    require ext_code.size(address(arg1))
    staticcall address(arg1).0x5355b0aa with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    sub_5355b0aa = ext_call.return_data[0]
    require ext_code.size(address(arg1))
    staticcall address(arg1).0x55155495 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    sub_55155495 = ext_call.return_data[0]
    require ext_code.size(address(arg1))
