...
function sub_85b52d82(?) payable {
    return sub_85b52d82Address
}
...
function withdraw(uint256 arg1) payable {
    ...
    if not 2 * ext_call.return_data[0]:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(sub_85b52d82Address)
        staticcall sub_85b52d82Address.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(address(strategyAddress))
        call address(strategyAddress).0x441a3e70 with:
             gas gas_remaining wei
            args 0 / totalSupply, arg1 / totalSupply
    else:
        ...
        call address(strategyAddress).0x441a3e70 with:
             gas gas_remaining wei
            args (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalSupply, arg1 / totalSupply
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(sub_85b52d82Address)
    staticcall sub_85b52d82Address.0x70a08231 with:
    ...
    if not ext_code.size(sub_85b52d82Address):
        revert with 0, 'Address: call to non-contract'
    mem[ceil32(return_data.size) + 841 len 64] = unknown_0xa9059cbb(?????), msg.sender, 0
    call sub_85b52d82Address with:
       funct uint32(msg.sender)
         gas gas_remaining wei
        args 0, mem[ceil32(return_data.size) + 905 len 4]
    if not return_data.size:
        require not ext_call.success
        revert with 'SafeMath: division by zero'
...
function withdrawAll() payable {
    ...
    if not 2 * ext_call.return_data[0]:
        ...
        call address(strategyAddress).0x441a3e70 with:
             gas gas_remaining wei
            args 0 / totalSupply, balanceOf[address(msg.sender)] / totalSupply
    else:
        ...
        call address(strategyAddress).0x441a3e70 with:
             gas gas_remaining wei
            args (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply, balanceOf[address(msg.sender)] / totalSupply
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(sub_85b52d82Address)
    staticcall sub_85b52d82Address.0x70a08231 with:
...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if not totalSupply:
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[520 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[584 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor7)
                 gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if not totalSupply:
                ...
                if not ext_code.size(tokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 521 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), ext_call.return_data[0 len 28]
                call tokenAddress with:
                   funct uint32(stor7)
                     gas gas_remaining wei
                ...
                if not ext_code.size(tokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 585 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), ext_call.return_data[0 len 28]
