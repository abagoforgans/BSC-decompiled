...
const unirouter = 0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6
...
function swapToken(address arg1) {
    ...
    if ext_code.hash(arg1) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
        revert with 0, 'SafeERC20: call to non-contract'
    mem[196 len 64] = approve(address rg1, uint256 rg2), 0x75ca8f6c82df5fdfd09049f4, 0, 0
    call arg1.0xb0a53bf6 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), 0x75ca8f6c82df5fdfd09049f4, 0, 0) << 256, mem[260 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with 0, 'SafeERC20: low-level call failed'
        if not approve(address rg1, uint256 rg2), 0x75ca8f6c82df5fdfd09049f4:
            revert with 0, 32, 42, 0xfe5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[306 len 22]
        require ext_code.size(arg1)
        staticcall arg1.0xdd62ed3e with:
                gas gas_remaining wei
               args this.address, 0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0]:
        ...
        if ext_code.hash(arg1) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
            revert with 0, 'SafeERC20: call to non-contract'
        mem[296 len 64] = 0, 0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call arg1.0xb0a53bf6 with:
             gas gas_remaining wei
            args -1, Mask(224, 32, 0, 0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) >> 32, mem[360 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
            if not approve(address rg1, uint256 rg2), 0x75ca8f6c82df5fdfd09049f4:
            ...
            if not swap2TokenRouting.length:
                require ext_code.size(0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6)
                call 0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
        ...
        if ext_code.hash(arg1) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
            revert with 0, 'SafeERC20: call to non-contract'
        mem[ceil32(return_data.size) + 297 len 64] = 0, 0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call arg1.0xb0a53bf6 with:
             gas gas_remaining wei
            args -1, Mask(224, 32, 0, 0x75ca8f6c82df5fdfd09049f46ad5d072b0a53bf6, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) >> 32, mem[ceil32(return_data.size) + 361 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
            if not approve(address rg1, uint256 rg2), 0x75ca8f6c82df5fdfd09049f4:
