    ...
    if stor3[address(msg.sender)]:
        ...
        if stor3[address(arg1)]:
            ...
            if not arg2:
                ...
                if balanceOf[stor13] + (arg2 * devFee / 100) < balanceOf[stor13]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor13] += arg2 * devFee / 100
            ...
            if balanceOf[stor12] + (arg2 * sub_a14c80fb / 100) < balanceOf[stor12]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[stor12] += arg2 * sub_a14c80fb / 100
    ...
    if stor3[address(msg.sender)]:
        ...
        if stor3[address(arg2)]:
            ...
            if not arg3:
                ...
                if balanceOf[stor13] + (arg3 * devFee / 100) < balanceOf[stor13]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor13] += arg3 * devFee / 100
            ...
            if balanceOf[stor12] + (arg3 * sub_a14c80fb / 100) < balanceOf[stor12]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[stor12] += arg3 * sub_a14c80fb / 100
