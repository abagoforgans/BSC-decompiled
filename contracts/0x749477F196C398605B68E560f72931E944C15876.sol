...
function swapAndLiquifyByLimitOnly() {
    return bool(uint8(stor24.field_16))
}
...
function changeSwapBackSettings(bool arg1, uint256 arg2, bool arg3) {
    ...
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    swapThreshold = arg2
    uint8(stor24.field_8) = uint8(arg1)
    Mask(240, 0, stor24.field_16) = Mask(240, 0, arg3)
    Mask(232, 0, stor24.field_24) = Mask(232, 16, arg1) >> 16
}
...
function changeFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    ...
    if arg2 < 0:
        revert with 0, 'SafeMath: addition overflow'
    totalFee = arg1 + arg3 + arg2
    if arg1 + arg3 + arg2 > !extraFeeOnSell:
        revert with 0, 17
    if extraFeeOnSell < 0:
        revert with 0, 'SafeMath: addition overflow'
    totalFeeIfSelling = arg1 + arg3 + arg2 + extraFeeOnSell
}
