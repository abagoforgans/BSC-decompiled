...
function getLiquidityBacking(uint256 arg1) {
    ...
    if balanceOf[stor4] > totalSupply - balanceOf[stor3]:
        revert with 0, 'SafeMath: subtraction overflow'
    if not balanceOf[address(stor30.field_0)]:
        if arg1:
            if 0 / arg1:
    ...
    if 2 * balanceOf[address(stor30.field_0)] / balanceOf[address(stor30.field_0)] != 2:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not arg1:
        if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
            revert with 0, 'SafeMath: division by zero'
        return (0 / totalSupply - balanceOf[stor3] - balanceOf[stor4])
    if 2 * balanceOf[address(stor30.field_0)] * arg1 / arg1 != 2 * balanceOf[address(stor30.field_0)]:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[address(stor30.field_0)] * arg1 / totalSupply - balanceOf[stor3] - balanceOf[stor4])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not arg2:
        if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
            revert with 0, 'SafeMath: division by zero'
        return (0 / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
    if 2 * balanceOf[address(stor30.field_0)] * arg2 / arg2 != 2 * balanceOf[address(stor30.field_0)]:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[address(stor30.field_0)] * arg2 / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
}
...
function multiTransfer_fixed(address arg1, address[] arg2, uint256 arg3) payable {
    ...
    while idx < arg2.length:
        ...
        mem[64] = mem[64] + 64
        mem[_36] = 20
        mem[_36 + 32] = 'Insufficient Balance' << 96
        mem[32] = 9
        ...
        mem[32] = 16
        if not stor16[address(cd[((32 * idx) + arg2 + 36)])]:
            require idx < arg2.length
            mem[0] = address(cd[((32 * idx) + arg2 + 36)])
            mem[32] = 9
