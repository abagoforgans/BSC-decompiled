...
function notifyReward(uint256 arg1) payable {
    ...
    if 0 and sub_3b2cbb3a > -1 / 0:
        revert with 0, 17
    if block.timestamp >= _periodFinish:
        _rewardRate = (ext_call.return_data[0] * sub_3b2cbb3a) - (ext_call.return_data[0] * sub_3b2cbb3a) / 168 * 24 * 3600
    else:
        ...
        if (ext_call.return_data[0] * sub_3b2cbb3a) - (ext_call.return_data[0] * sub_3b2cbb3a) > !((_periodFinish * _rewardRate) - (block.timestamp * _rewardRate)):
            revert with 0, 17
        _rewardRate = (ext_call.return_data[0] * sub_3b2cbb3a) - (ext_call.return_data[0] * sub_3b2cbb3a) + (_periodFinish * _rewardRate) - (block.timestamp * _rewardRate) / 168 * 24 * 3600
    _lastUpdateTime = block.timestamp
...
function unstake(uint256 arg1) payable {
    ...
    if _gegoMapIndex[arg1] >= _playerGego[address(msg.sender)].field_0:
        revert with 0, 50
    _playerGego[address(msg.sender)][stor33[arg1]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + 128]
    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
        revert with 0, 50
    ...
    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + 128]] = _gegoMapIndex[arg1]
                    ...
                    if block.timestamp < _periodFinish:
                        ...
                        if not msg.sender:
                            ...
                            if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                revert with 0, 50
                            _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _926 + 32]
                            if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                revert with 0, 50
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            if not _playerGego[msg.sender].field_0:
                            ...
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            _playerGego[msg.sender].field_0--
                            _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _926 + 32]] = _gegoMapIndex[_921]
                        else:
                            if not _totalWeight:
                                if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                    revert with 0, 17
                                ...
                                if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _992 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _992 + 32]] = _gegoMapIndex[_921]
                            else:
                                if block.timestamp < _periodFinish:
                                    if block.timestamp < _lastUpdateTime:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1217 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1217 + 32]] = _gegoMapIndex[_921]
                                else:
                                    if _periodFinish < _lastUpdateTime:
                                        revert with 0, 17
                                    if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1240 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1240 + 32]] = _gegoMapIndex[_921]
                    else:
                        _lastUpdateTime = _periodFinish
                        if not msg.sender:
                            if block.timestamp <= _startTime:
                            ...
                            if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                revert with 0, 50
                            _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _937 + 32]
                            if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                revert with 0, 50
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            if not _playerGego[msg.sender].field_0:
                            ...
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            _playerGego[msg.sender].field_0--
                            _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _937 + 32]] = _gegoMapIndex[_921]
                        else:
                            if not _totalWeight:
                                if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                    revert with 0, 17
                                ...
                                if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1001 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1001 + 32]] = _gegoMapIndex[_921]
                            else:
                                if block.timestamp < _periodFinish:
                                    if block.timestamp < _lastUpdateTime:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1244 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1244 + 32]] = _gegoMapIndex[_921]
                                else:
                                    if _periodFinish < _lastUpdateTime:
                                        revert with 0, 17
                                    if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1274 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1274 + 32]] = _gegoMapIndex[_921]
                else:
                    if block.timestamp < _periodFinish:
                        if block.timestamp < _lastUpdateTime:
                            revert with 0, 17
                        ...
                        if block.timestamp < _periodFinish:
                            ...
                            if not msg.sender:
                                ...
                                if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1014 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1014 + 32]] = _gegoMapIndex[_921]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1212 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1212 + 32]] = _gegoMapIndex[_921]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1502 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1502 + 32]] = _gegoMapIndex[_921]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1519 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1519 + 32]] = _gegoMapIndex[_921]
                        else:
                            _lastUpdateTime = _periodFinish
                            if not msg.sender:
                                if block.timestamp <= _startTime:
                                ...
                                if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1032 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1032 + 32]] = _gegoMapIndex[_921]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1228 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1228 + 32]] = _gegoMapIndex[_921]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1523 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1523 + 32]] = _gegoMapIndex[_921]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1546 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1546 + 32]] = _gegoMapIndex[_921]
                    else:
                        if _periodFinish < _lastUpdateTime:
                            revert with 0, 17
                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                        ...
                        if block.timestamp < _periodFinish:
                            ...
                            if not msg.sender:
                                ...
                                if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1035 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1035 + 32]] = _gegoMapIndex[_921]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1231 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1231 + 32]] = _gegoMapIndex[_921]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1527 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1527 + 32]] = _gegoMapIndex[_921]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1555 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1555 + 32]] = _gegoMapIndex[_921]
                        else:
                            _lastUpdateTime = _periodFinish
                            if not msg.sender:
                                if block.timestamp <= _startTime:
                                ...
                                if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1056 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1056 + 32]] = _gegoMapIndex[_921]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1260 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1260 + 32]] = _gegoMapIndex[_921]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1559 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1559 + 32]] = _gegoMapIndex[_921]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_921] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_921]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _1589 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _1589 + 32]] = _gegoMapIndex[_921]
                    ...
                    if block.timestamp < _periodFinish:
                        ...
                        if not msg.sender:
                            ...
                            if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                revert with 0, 50
                            _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3204 + 32]
                            if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                revert with 0, 50
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            if not _playerGego[msg.sender].field_0:
                            ...
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            _playerGego[msg.sender].field_0--
                            _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3204 + 32]] = _gegoMapIndex[_2887]
                        else:
                            if not _totalWeight:
                                if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                    revert with 0, 17
                                ...
                                if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3486 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3486 + 32]] = _gegoMapIndex[_2887]
                            else:
                                if block.timestamp < _periodFinish:
                                    if block.timestamp < _lastUpdateTime:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3711 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3711 + 32]] = _gegoMapIndex[_2887]
                                else:
                                    if _periodFinish < _lastUpdateTime:
                                        revert with 0, 17
                                    if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3734 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3734 + 32]] = _gegoMapIndex[_2887]
                    else:
                        _lastUpdateTime = _periodFinish
                        if not msg.sender:
                            if block.timestamp <= _startTime:
                            ...
                            if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                revert with 0, 50
                            _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3215 + 32]
                            if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                revert with 0, 50
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            if not _playerGego[msg.sender].field_0:
                            ...
                            _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                            _playerGego[msg.sender].field_0--
                            _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3215 + 32]] = _gegoMapIndex[_2887]
                        else:
                            if not _totalWeight:
                                if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                    revert with 0, 17
                                ...
                                if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3495 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3495 + 32]] = _gegoMapIndex[_2887]
                            else:
                                if block.timestamp < _periodFinish:
                                    if block.timestamp < _lastUpdateTime:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3738 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3738 + 32]] = _gegoMapIndex[_2887]
                                else:
                                    if _periodFinish < _lastUpdateTime:
                                        revert with 0, 17
                                    if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3768 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3768 + 32]] = _gegoMapIndex[_2887]
                else:
                    if block.timestamp < _periodFinish:
                        if block.timestamp < _lastUpdateTime:
                            revert with 0, 17
                        ...
                        if block.timestamp < _periodFinish:
                            ...
                            if not msg.sender:
                                ...
                                if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3508 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3508 + 32]] = _gegoMapIndex[_2887]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3706 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3706 + 32]] = _gegoMapIndex[_2887]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3996 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3996 + 32]] = _gegoMapIndex[_2887]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _4013 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _4013 + 32]] = _gegoMapIndex[_2887]
                        else:
                            _lastUpdateTime = _periodFinish
                            if not msg.sender:
                                if block.timestamp <= _startTime:
                                ...
                                if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3526 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3526 + 32]] = _gegoMapIndex[_2887]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3722 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3722 + 32]] = _gegoMapIndex[_2887]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _4017 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _4017 + 32]] = _gegoMapIndex[_2887]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _4040 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _4040 + 32]] = _gegoMapIndex[_2887]
                    else:
                        if _periodFinish < _lastUpdateTime:
                            revert with 0, 17
                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                        ...
                        if block.timestamp < _periodFinish:
                            ...
                            if not msg.sender:
                                ...
                                if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3529 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3529 + 32]] = _gegoMapIndex[_2887]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3725 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3725 + 32]] = _gegoMapIndex[_2887]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _4021 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _4021 + 32]] = _gegoMapIndex[_2887]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _4049 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _4049 + 32]] = _gegoMapIndex[_2887]
                        else:
                            _lastUpdateTime = _periodFinish
                            if not msg.sender:
                                if block.timestamp <= _startTime:
                                ...
                                if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                    revert with 0, 50
                                _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3550 + 32]
                                if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                    revert with 0, 50
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                if not _playerGego[msg.sender].field_0:
                                ...
                                _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                _playerGego[msg.sender].field_0--
                                _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3550 + 32]] = _gegoMapIndex[_2887]
                            else:
                                if not _totalWeight:
                                    if _rewardPerTokenStored < _userRewardPerTokenPaid[address(msg.sender)]:
                                        revert with 0, 17
                                    ...
                                    if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                        revert with 0, 50
                                    _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _3754 + 32]
                                    if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                        revert with 0, 50
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    if not _playerGego[msg.sender].field_0:
                                    ...
                                    _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                    _playerGego[msg.sender].field_0--
                                    _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _3754 + 32]] = _gegoMapIndex[_2887]
                                else:
                                    if block.timestamp < _periodFinish:
                                        if block.timestamp < _lastUpdateTime:
                                            revert with 0, 17
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _4053 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _4053 + 32]] = _gegoMapIndex[_2887]
                                    else:
                                        if _periodFinish < _lastUpdateTime:
                                            revert with 0, 17
                                        if _periodFinish - _lastUpdateTime and _rewardRate > -1 / _periodFinish - _lastUpdateTime:
                                        ...
                                        if _gegoMapIndex[_2887] >= _playerGego[address(msg.sender)].field_0:
                                            revert with 0, 50
                                        _playerGego[address(msg.sender)][stor33[_2887]].field_0 = mem[(32 * _playerGego[msg.sender].field_0 - 1) + _4083 + 32]
                                        if _playerGego[msg.sender].field_0 - 1 >= _playerGego[msg.sender].field_0:
                                            revert with 0, 50
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        if not _playerGego[msg.sender].field_0:
                                        ...
                                        _playerGego[msg.sender][_playerGego[msg.sender].field_0].field_0 = 0
                                        _playerGego[msg.sender].field_0--
                                        _gegoMapIndex[mem[(32 * stor32[msg.sender].field_0 - 1) + _4083 + 32]] = _gegoMapIndex[_2887]
