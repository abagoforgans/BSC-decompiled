...
#
const name = 'TanjiroINU'

const decimals = 9

const symbol = '$TANJIRO'
...
function tradingStatus(bool arg1, uint256 arg2) {
    ...
    if owner != msg.sender:
        revert with 0, '!OWNER'
    Mask(96, 0, stor34.field_160) = Mask(96, 0, arg1)
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if balanceOf[stor5] > totalSupply - balanceOf[stor4]:
        revert with 0, 'SafeMath: subtraction overflow'
    if not balanceOf[address(stor34.field_0)]:
        if arg1:
            if 0 / arg1:
    ...
    if 2 * balanceOf[address(stor34.field_0)] / balanceOf[address(stor34.field_0)] != 2:
        revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not arg1:
        if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
            revert with 0, 'SafeMath: division by zero'
        return (0 / totalSupply - balanceOf[stor4] - balanceOf[stor5])
    if 2 * balanceOf[address(stor34.field_0)] * arg1 / arg1 != 2 * balanceOf[address(stor34.field_0)]:
        revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[address(stor34.field_0)] * arg1 / totalSupply - balanceOf[stor4] - balanceOf[stor5])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not arg2:
        if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
            revert with 0, 'SafeMath: division by zero'
        return (0 / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
    if 2 * balanceOf[address(stor34.field_0)] * arg2 / arg2 != 2 * balanceOf[address(stor34.field_0)]:
        revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[address(stor34.field_0)] * arg2 / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
}
