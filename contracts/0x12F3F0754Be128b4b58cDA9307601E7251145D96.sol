...
function sub_99d9c4b0(?) {
    ...
    require ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + 192 <= test266151307() and ceil32(arg4.length) + 192 >= 160
    ...
    if address(stor0 xor 0xc65275b5d8d66f561f57731c0ec7000b6e6ba1f209c22e4251977a89261ff4f) != tx.origin:
        revert with 0, 'Caller'
    mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + 192] = arg3.length + arg1.length
    idx = 0
    while idx < arg3.length + 31 / 32:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * idx + 1) + 192] = mem[ceil32(arg1.length) + (32 * idx + 1) + 128]
        idx = idx + 1
        continue 
    idx = 0
    while idx < arg1.length + 31 / 32:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * idx + 1) + arg3.length + 192] = mem[(32 * idx + 1) + 96]
        idx = idx + 1
        continue 
    mem[64] = ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224
    _104 = Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[ceil32(arg1.length) + arg3.length + 192 len -arg3.length + ceil32(arg3.length)]
    _105 = Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[ceil32(arg1.length) + ceil32(arg3.length) + arg4.length + 224 len -arg4.length + ceil32(arg4.length)]
    _107 = Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[ceil32(arg1.length) + ceil32(arg3.length) + arg4.length + 224 len -arg4.length + ceil32(arg4.length)]
    mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224] = Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[ceil32(arg1.length) + arg3.length + 192 len -arg3.length + ceil32(arg3.length)] + Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), mem[ceil32(arg1.length) + ceil32(arg3.length) + arg4.length + 224 len -arg4.length + ceil32(arg4.length)]
    idx = 0
    while idx < mem[ceil32(arg1.length) + ceil32(arg3.length) + 160] + 31 / 32:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + (32 * idx + 1) + 224] = mem[ceil32(arg1.length) + ceil32(arg3.length) + (32 * idx + 1) + 160]
        idx = idx + 1
        continue 
    idx = 0
    while idx < _107 + 31 / 32:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + (32 * idx + 1) + mem[ceil32(arg1.length) + ceil32(arg3.length) + 160] + 224] = mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + (32 * idx + 1) + 192]
        idx = idx + 1
        continue 
    if address(stor0 xor 0xc65275b5d8d66f561f57731c0ec7000b6e6ba1f209c22e4251977a89261ff4f) != tx.origin:
        revert with 0, 'Caller'
    mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + 256 len ceil32(mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224])] = mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 256 len ceil32(mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224])]
    if ceil32(mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224]) > mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224]:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224] + 256] = 0
    call address(address(arg2) xor tx.origin).mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + 256 len 4] with:
         gas gas_remaining wei
        args mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + 260 len mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + 224] - 4]
    if not ext_call.success:
        revert with 0, 'call failed'
    if return_data.size:
        return Array(len=return_data.size, data=ext_call.return_data[0 len return_data.size])
    mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + 256] = 32
    mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + 288] = mem[96]
    mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + 320 len ceil32(mem[96])] = mem[128 len ceil32(mem[96])]
    if ceil32(mem[96]) > mem[96]:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + mem[96] + 320] = 0
    return Array(len=mem[96], data=mem[ceil32(arg1.length) + ceil32(arg3.length) + ceil32(arg4.length) + arg3.length + arg1.length + _104 + _105 + 320 len ceil32(mem[96])]), 
}
