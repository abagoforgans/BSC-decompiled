    ...
    if not arg1.length:
        ...
        while idx < mem[(32 * arg1.length) + 128]:
            ...
            if not mem[(32 * idx) + (64 * arg1.length) + 204 len 20]:
                ...
                emit TransferBnb(mem[(98 * arg1.length) + 192], address(stor2.field_0));
            else:
                mem[(98 * arg1.length) + 196] = address(stor2.field_0)
                mem[(98 * arg1.length) + 228] = _112
                require ext_code.size(address(_116))
                call address(_116).0xa9059cbb with:
                     gas gas_remaining wei
                    args address(stor2.field_0), _112
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(98 * arg1.length) + 192] = _112
                emit 0x52a1ece0: _112, address(stor2.field_0), address(_116)
            idx = idx + 1
            s = _116
            s = _112
            continue 
    else:
        mem[(32 * arg1.length) + 160 len 32 * arg1.length] = code.data[15951 len 32 * arg1.length]
        require 0 < arg1.length
        mem[(32 * arg1.length) + 160] = eth.balance(this.address)
        s = 0
        s = 0
        ...
        while idx < mem[(32 * arg1.length) + 128]:
            ...
            if not mem[(32 * idx) + (64 * arg1.length) + 204 len 20]:
                ...
                call address(_117).0xa9059cbb with:
                     gas gas_remaining wei
                    args address(stor2.field_0), _114
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(98 * arg1.length) + 192] = _114
                emit 0x52a1ece0: _114, address(stor2.field_0), address(_117)
            idx = idx + 1
            s = _117
            s = _114
            continue 
...
function sub_280e03d7(?) {
    ...
    if not arg2.length:
        ...
        mem[(32 * arg2.length) + 160 len 32 * arg2.length] = code.data[15951 len 32 * arg2.length]
        require 0 < arg2.length
        mem[(32 * arg2.length) + 160] = eth.balance(this.address)
        s = 0
        s = 0
        ...
        if status == 5:
            ...
            while idx < arg1:
                ...
                if not sub_d1107238[sub_d1107238.length].field_0:
                    ...
                    mem[_417 + 32 len 32 * sub_d1107238[sub_d1107238.length].field_0] = code.data[15951 len 32 * sub_d1107238[sub_d1107238.length].field_0]
                    t = 0
                    while t < sub_d1107238[sub_d1107238.length].field_0:
                        require t < sub_d1107238[sub_d1107238.length].field_0
                        mem[0] = (3 * sub_d1107238.length) + sha3(4) - 2
            ...
            while idx < arg1:
                ...
                if not sub_d1107238[sub_d1107238.length].field_0:
                    ...
                    mem[_422 + 32 len 32 * sub_d1107238[sub_d1107238.length].field_0] = code.data[15951 len 32 * sub_d1107238[sub_d1107238.length].field_0]
                    t = 0
                    while t < sub_d1107238[sub_d1107238.length].field_0:
                        require t < sub_d1107238[sub_d1107238.length].field_0
                        mem[0] = (3 * sub_d1107238.length) + sha3(4) - 2
        ...
        if status == 5:
            ...
            while idx < arg1:
                ...
                if not sub_d1107238[sub_d1107238.length].field_0:
                    ...
                    mem[_427 + 32 len 32 * sub_d1107238[sub_d1107238.length].field_0] = code.data[15951 len 32 * sub_d1107238[sub_d1107238.length].field_0]
                    t = 0
                    while t < sub_d1107238[sub_d1107238.length].field_0:
                        require t < sub_d1107238[sub_d1107238.length].field_0
                        mem[0] = (3 * sub_d1107238.length) + sha3(4) - 2
            ...
            while idx < arg1:
                ...
                if not sub_d1107238[sub_d1107238.length].field_0:
                    ...
                    mem[_432 + 32 len 32 * sub_d1107238[sub_d1107238.length].field_0] = code.data[15951 len 32 * sub_d1107238[sub_d1107238.length].field_0]
                    t = 0
                    while t < sub_d1107238[sub_d1107238.length].field_0:
                        require t < sub_d1107238[sub_d1107238.length].field_0
                        mem[0] = (3 * sub_d1107238.length) + sha3(4) - 2
