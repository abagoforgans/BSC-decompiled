...
#  - withdrawEarly(address arg1, uint256 arg2)
#  - earn()
#
...
function sub_f541bd30(?) payable {
    stopAt++
}

function sub_7a8edba9(?) payable {
    require calldata.size - 4 >= 32
    stopAt = arg1
}
...
function sub_3279043f(?) payable {
    ...
    if not arg1:
        ...
        if wantLockedTotal <= 0:
            revert with 0, 'SafeMath: division by zero'
        if wantLockedTotal:
            return (ext_call.return_data[0] * arg1 / wantLockedTotal)
    ('iszero', ('stor', ('name', 'wantLockedTotal', 20)))
    revert
}
                ...
                if not return_data.size:
                    ...
                    if stopAt != 13:
                        if stopAt != 15:
                            ...
                            if not ext_code.size(wantAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(2 * ceil32(return_data.size)) + 456 len 128] = 0, msg.sender, address(this.address), ext_call.return_data[0], 0
                            ...
                            if stopAt != 16:
                                ...
                                call farmContractAddress.deposit(uint256 arg1, uint256 arg2) with:
                                     gas gas_remaining wei
                                    args ext_call.return_data[0], pid
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                else:
                    ...
                    if stopAt != 13:
                        if stopAt != 15:
                            ...
                            if not ext_code.size(wantAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 457 len 128] = 0, msg.sender, address(this.address), ext_call.return_data[0], 0
                            ...
                            if not return_data.size:
                                ...
                                if stopAt != 16:
                                    ...
                                    mem[(4 * ceil32(return_data.size)) + 494] = pid
                                    require ext_code.size(farmContractAddress)
                                    call farmContractAddress.deposit(uint256 arg1, uint256 arg2) with:
                                         gas gas_remaining wei
        ...
        if 10000 <= withdrawFeeFactor:
            ...
            if not arg2:
                ...
                if not uint8(stor8.field_24):
                    ...
                    call farmContractAddress.withdraw(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args withdrawFeeFactor * arg2 / 10000, pid
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[100] = this.address
                    require ext_code.size(wantAddress)
