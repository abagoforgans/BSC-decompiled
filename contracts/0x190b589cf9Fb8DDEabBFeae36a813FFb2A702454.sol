...
const INITIAL_DISTRIBUTION = 210000 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    stor6 = 1
    if totalSupply + 210000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 210000 * 10^18
    if balanceOf[address(arg1)] + 210000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 210000 * 10^18
    emit Transfer(210000 * 10^18, 0, arg1);
}
