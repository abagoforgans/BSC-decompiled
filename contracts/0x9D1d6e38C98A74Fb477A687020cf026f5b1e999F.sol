...
function withdraw(uint256 arg1) payable {
    ...
    if 2 * ext_call.return_data[0]:
        ...
        if not userInfo[msg.sender].field_0:
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[612 len 64] = unknown_0xa9059cbb(?????), msg.sender, 0
            call tokenAddress with:
            ...
            if not arg1:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not ext_code.size(tokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[868 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                    call tokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[932 len 4]
                    if not return_data.size:
                        require not ext_call.success
                        revert with 'SafeMath: division by zero'
                    ...
                    if not sub_9a68480e.length:
                        ...
                        require return_data.size >= 32
                        _664 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        ...
                        _739 = mem[_664 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_664 + 640])] = mem[_664 + 672 len floor32(mem[_664 + 640])]
                        if -0 / userInfo[msg.sender].field_256 / 100 > 0:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _739) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _739) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _739) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _739) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _739) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                    else:
                        mem[0] = 9
                        ...
                        mem[64] = ceil32(return_data.size) + 640
                        require return_data.size >= 32
                        _3494 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                        _3631 = mem[_3494 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_3494 + 640])] = mem[_3494 + 672 len floor32(mem[_3494 + 640])]
                        if -0 / userInfo[msg.sender].field_256 / 100 > 0:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _3631) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _3631) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _3631) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _3631) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _3631) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
            else:
                ...
                if not 100 * arg1:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _763) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _763) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _763) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _763) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _763) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3485 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3628 = mem[_3485 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3485 + 640])] = mem[_3485 + 672 len floor32(mem[_3485 + 640])]
                            if -0 / userInfo[msg.sender].field_256 / 100 > 0:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3628) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _3628) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3628) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3628) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3628) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                else:
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[868 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) << 224, mem[932 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[900 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _712 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            ...
                            _774 = mem[_712 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_712 + 640])] = mem[_712 + 672 len floor32(mem[_712 + 640])]
                            if -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100 > 0:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _774) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _774) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _774) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _774) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _774) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3476 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3625 = mem[_3476 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3476 + 640])] = mem[_3476 + 672 len floor32(mem[_3476 + 640])]
                            if -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100 > 0:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3625) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _3625) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3625) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3625) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3625) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
    else:
        mem[96] = 26
        mem[128] = 'SafeMath: division by zero'
        if not totalSupply:
            ...
            if not arg1:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not sub_9a68480e.length:
                        ...
                        mem[64] = ceil32(return_data.size) + 640
                        require return_data.size >= 32
                        _655 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                        _730 = mem[_655 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_655 + 640])] = mem[_655 + 672 len floor32(mem[_655 + 640])]
                        if -0 / userInfo[msg.sender].field_256 / 100 > 0:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _730) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _730) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _730) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _730) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _730) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                    else:
                        mem[0] = 9
                        mem[836] = address(sub_9a68480e.field_0)
                        idx = 836
                        ...
                        mem[64] = ceil32(return_data.size) + 640
                        require return_data.size >= 32
                        _3530 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                        _3643 = mem[_3530 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_3530 + 640])] = mem[_3530 + 672 len floor32(mem[_3530 + 640])]
                        if -0 / userInfo[msg.sender].field_256 / 100 > 0:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _3643) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _3643) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _3643) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _3643) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _3643) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
            else:
                if 100 * arg1 / arg1 != 100:
                    revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[485 len 31]
                if not 100 * arg1:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _668 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _751 = mem[_668 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_668 + 640])] = mem[_668 + 672 len floor32(mem[_668 + 640])]
                            if -0 / userInfo[msg.sender].field_256 / 100 > 0:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _751) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _751) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _751) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _751) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _751) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3521 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3640 = mem[_3521 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3521 + 640])] = mem[_3521 + 672 len floor32(mem[_3521 + 640])]
                            if -0 / userInfo[msg.sender].field_256 / 100 > 0:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3640) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) >> 32
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 0 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _3640) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3640) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3640) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3640) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                else:
                    if 100 * userInfo[msg.sender].field_0 * arg1 / 100 * arg1 != userInfo[msg.sender].field_0:
                        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[485 len 31]
                    mem[384] = 26
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _693 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _768 = mem[_693 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_693 + 640])] = mem[_693 + 672 len floor32(mem[_693 + 640])]
                            if -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100 > 0:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _768) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _768) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _768) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _768) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _768) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3512 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3637 = mem[_3512 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3512 + 640])] = mem[_3512 + 672 len floor32(mem[_3512 + 640])]
                            if -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100 > 0:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3637) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            mem[(32 * _3637) + ceil32(return_data.size) + 964 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, 100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) << 224, mem[(32 * _3637) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3637) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3637) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3637) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
