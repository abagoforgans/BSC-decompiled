        ...
        if not userInfo[msg.sender].field_0:
            ...
            if not arg1:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not ext_code.size(tokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[868 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                    call tokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[932 len 4]
                    if not return_data.size:
                        require not ext_call.success
                        revert with 'SafeMath: division by zero'
                    ...
                    if not sub_9a68480e.length:
                        ...
                        require return_data.size >= 32
                        _600 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        ...
                        _633 = mem[_600 + 704]
                        mem[ceil32(return_data.size) + 736 len floor32(mem[_600 + 704])] = mem[_600 + 736 len floor32(mem[_600 + 704])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _633) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _633) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _633) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _633) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _633) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                    else:
                        mem[0] = 9
                        ...
                        mem[64] = ceil32(return_data.size) + 704
                        require return_data.size >= 32
                        _2242 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                        _2355 = mem[_2242 + 704]
                        mem[ceil32(return_data.size) + 736 len floor32(mem[_2242 + 704])] = mem[_2242 + 736 len floor32(mem[_2242 + 704])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _2355) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        mem[(32 * _2355) + ceil32(return_data.size) + 964 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _2355) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _2355) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _2355) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _2355) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
            else:
                ...
                if not 100 * arg1:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _615 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                            _637 = mem[_615 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_615 + 704])] = mem[_615 + 736 len floor32(mem[_615 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _637) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _637) + ceil32(return_data.size) + 964 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _637) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _637) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _637) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _637) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[900] = address(sub_9a68480e.field_0)
                            idx = 900
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _2238 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                            _2352 = mem[_2238 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_2238 + 704])] = mem[_2238 + 736 len floor32(mem[_2238 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _2352) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _2352) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _2352) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _2352) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _2352) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                else:
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _625 = mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            ...
                            _640 = mem[_625 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_625 + 704])] = mem[_625 + 736 len floor32(mem[_625 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _640) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _640) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _640) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _640) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _640) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[900] = address(sub_9a68480e.field_0)
                            idx = 900
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _2234 = mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                            _2349 = mem[_2234 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_2234 + 704])] = mem[_2234 + 736 len floor32(mem[_2234 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _2349) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _2349) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _2349) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _2349) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _2349) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
    else:
            ...
            if not arg1:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not sub_9a68480e.length:
                        ...
                        mem[64] = ceil32(return_data.size) + 704
                        require return_data.size >= 32
                        _608 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                        _635 = mem[_608 + 704]
                        mem[ceil32(return_data.size) + 736 len floor32(mem[_608 + 704])] = mem[_608 + 736 len floor32(mem[_608 + 704])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _635) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _635) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _635) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _635) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _635) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                    else:
                        mem[0] = 9
                        mem[900] = address(sub_9a68480e.field_0)
                        idx = 900
                        ...
                        mem[64] = ceil32(return_data.size) + 704
                        require return_data.size >= 32
                        _2226 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                        _2343 = mem[_2226 + 704]
                        mem[ceil32(return_data.size) + 736 len floor32(mem[_2226 + 704])] = mem[_2226 + 736 len floor32(mem[_2226 + 704])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _2343) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _2343) + ceil32(return_data.size) + 964 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _2343) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _2343) + ceil32(return_data.size) + 932]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _2343) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
            else:
                if 100 * arg1 / arg1 != 100:
                    revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[549 len 31]
                if not 100 * arg1:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _622 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                            _639 = mem[_622 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_622 + 704])] = mem[_622 + 736 len floor32(mem[_622 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _639) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _639) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _639) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _639) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _639) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[900] = address(sub_9a68480e.field_0)
                            idx = 900
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _2222 = mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                            _2340 = mem[_2222 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_2222 + 704])] = mem[_2222 + 736 len floor32(mem[_2222 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _2340) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _2340) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _2340) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _2340) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _2340) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                else:
                    if 100 * userInfo[msg.sender].field_0 * arg1 / 100 * arg1 != userInfo[msg.sender].field_0:
                        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[549 len 31]
                    mem[448] = 26
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _629 = mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                            _646 = mem[_629 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_629 + 704])] = mem[_629 + 736 len floor32(mem[_629 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _646) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _646) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _646) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _646) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _646) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
                        else:
                            mem[0] = 9
                            mem[900] = address(sub_9a68480e.field_0)
                            idx = 900
                            ...
                            mem[64] = ceil32(return_data.size) + 704
                            require return_data.size >= 32
                            _2218 = mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704] <= 4294967296 and mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 704] = mem[mem[704 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100) >> 32 + 704]
                            _2337 = mem[_2218 + 704]
                            mem[ceil32(return_data.size) + 736 len floor32(mem[_2218 + 704])] = mem[_2218 + 736 len floor32(mem[_2218 + 704])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _2337) + ceil32(return_data.size) + 900 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _2337) + ceil32(return_data.size) + 964 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _2337) + ceil32(return_data.size) + 932 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _2337) + ceil32(return_data.size) + 932]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _2337) + ceil32(return_data.size) + ceil32(return_data.size) + 1011 len 22]
}
