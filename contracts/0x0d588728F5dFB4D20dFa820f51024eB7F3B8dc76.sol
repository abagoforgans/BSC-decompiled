...
function BPDisabledForever() payable {
...
function setBPAddrss(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if uint8(stor6.field_160):
        if not uint8(stor6.field_168):
            require ext_code.size(BPAddress)
            call BPAddress.protect(address arg1, address arg2, uint256 arg3) with:
