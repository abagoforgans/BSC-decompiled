    ...
    if bool(stor3.length):
        ...
        if not ('cd', 68).length:
            ...
            while cd[68] + ('cd', 68).length + 36 > idx:
                uint256(stor3[s].field_0) = cd[idx]
                s = s + 1
                idx = idx + 32
                continue 
...
function sub_89deebf3(?) {
    ...
    mem[ceil32(return_data.size) + 132] = stor7
    require ext_code.size(address(('cd', 4)[0]))
    call address(('cd', 4)[0]).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0xfe00000000000000000000000010ed43c718714eb63d5aa57b78b54704e25602, stor7
...
function sub_9a8e7862(?) {
    ...
    call ????????????????????????????????????????.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp, ('cd', 36).length, mem[mem[64] + 196 len 32 * ('cd', 36).length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if 1 >= ('cd', 36).length:
        revert with 0, 50
...
function sub_64bdc0b0(?) {
    ...
    staticcall 0xfe00000000000000000000000010ed43c718714eb63d5aa57b78b54704e25602.mem[mem[64] len 4] with:
            gas gas_remaining wei
           args mem[mem[64] + 4 len _224 + (32 * stor2.length) + -mem[64] + 96]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _250 = mem[64]
    ...
    while idx < stor2.length:
        ...
        t = t + 32
        continue 
    mem[_271 + 100] = this.address
    mem[_271 + 132] = block.timestamp
    require ext_code.size(0xfe00000000000000000000000010ed43c718714eb63d5aa57b78b54704e25602)
    call ????????????????????????????????????????.mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len _271 + (32 * stor2.length) + -mem[64] + 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if 0 >= ('cd', 36).length:
        revert with 0, 50
