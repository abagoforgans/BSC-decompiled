...
function sub_e2d63fdf(?) {
    require calldata.size - 4 >= 128
    if bool(stor9[msg.sender]) != 1:
        revert with 0, 'Only Pandas'
    require ext_code.size(arg1)
    staticcall arg1.0x70a08231 with:
            gas gas_remaining wei
           args this.address
        ...
        if not uint8(stor8.field_168):
            ...
            if arg1.length != 2:
                if arg1.length != 3:
                    ...
                    mem[(32 * arg1.length) + 192] = mem[172 len 20]
                    require 0 < arg1.length
                ...
                if arg1.length != 3:
                    ...
                    mem[(32 * arg1.length) + 224] = 3
                    require 2 < arg1.length
                    mem[(32 * arg1.length) + 256] = mem[204 len 20]
                    require 1 < arg1.length
                    mem[(32 * arg1.length) + 288] = mem[172 len 20]
                    require 0 < arg1.length
