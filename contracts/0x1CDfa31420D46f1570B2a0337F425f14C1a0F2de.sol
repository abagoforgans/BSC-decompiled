...
function sub_0c6008af(?) {
    ...
    mem[4704 len 4480] = code.data[5254 len 4452], mem[4580 len 28]
    mem[9156] = address(arg1)
    mem[9188] = 32
    mem[9220] = mem[4672]
    mem[9252 len ceil32(mem[4672])] = mem[4704 len ceil32(mem[4672])]
    if ceil32(mem[4672]) > mem[4672]:
        mem[mem[4672] + 9252] = 0
    return Array(len=mem[4672], data=mem[9252 len ceil32(mem[4672])])
}
        ...
        if unknown_0x94ca2cb5(?????) <= uint32(call.func_hash) >> 224:
            ...
            if unknown_0x390f336b(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x0c6008af(?????) == uint32(call.func_hash) >> 224:
                    ...
                    require calldata.size - 4 >= 32
                    require cd[4] == address(cd[4])
                    mem[4736 len 4480] = code.data[5254 len 4452], mem[4612 len 28]
                    mem[9188] = address(cd[4])
                    mem[9220] = 32
                    mem[9252] = mem[4704]
                    mem[9284 len ceil32(mem[4704])] = mem[4736 len ceil32(mem[4704])]
                    if ceil32(mem[4704]) > mem[4704]:
                        mem[mem[4704] + 9284] = 0
                    return Array(len=mem[4704], data=mem[9284 len ceil32(mem[4704])])
