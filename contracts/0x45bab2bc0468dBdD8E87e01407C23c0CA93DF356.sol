...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    call routerAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, 0, 160, address(arg2), block.timestamp, mem[(4 * ceil32(return_data.size)) + 452 len (32 * mem[(2 * ceil32(return_data.size)) + 192]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if allowance[address(arg1)][msg.sender] < arg3:
        revert with 0, 17
    ...
    mem[(4 * ceil32(return_data.size)) + 356] = 'ERC20: approve from the zero add'
    mem[(4 * ceil32(return_data.size)) + 388] = 0x7265737300000000000000000000000000000000000000000000000000000000
    revert with memory
...
function _fallback() payable {
                        ...
                        if stor6 >= stor13[address(arg1)]:
                            ...
                            if stor13[address(msg.sender)] <= stor6:
                                ...
                                while idx < mem[(2 * ceil32(return_data.size)) + 224]:
                                    ...
                                    t = t + 32
                                    continue 
                                mem[(4 * ceil32(return_data.size)) + 420] = address(arg1)
    ...
    call routerAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, 0, 160, address(arg2), block.timestamp, mem[(4 * ceil32(return_data.size)) + 484 len (32 * mem[(2 * ceil32(return_data.size)) + 224]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if allowance[address(arg1)][msg.sender] < arg3:
        revert with 0, 17
    ...
    mem[(4 * ceil32(return_data.size)) + 356] = 36
    mem[(4 * ceil32(return_data.size)) + 388] = 'ERC20: approve from the zero add'
    mem[(4 * ceil32(return_data.size)) + 420] = 0x7265737300000000000000000000000000000000000000000000000000000000
    revert with memory
