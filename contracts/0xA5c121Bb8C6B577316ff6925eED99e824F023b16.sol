...
function sub_028d2c3e(?) payable {
    require calldata.size - 4 >= 64
    return 0
}

function sub_0c44c130(?) payable {
    require calldata.size - 4 >= 64
    return 0
}

function sub_6014a5e9(?) payable {
    require calldata.size - 4 >= 32
    return 0
}

function sub_240e5fb4(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_707bd6ec(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_936ccbca(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_e1eb4a48(?) payable {
    require calldata.size - 4 >= 64
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_1bbb52bd(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    stor5 = arg1
