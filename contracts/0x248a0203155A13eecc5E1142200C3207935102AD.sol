...
#
const name = 'Golden Tiger', 0

const totalSupply = 10^18

const decimals = 9

const symbol = 'TIGER', 0
...
function sub_cb0da419(?) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint64(stor24.field_192) = uint64(bool(arg1))
}
...
function setFee(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    if stor8 > -stor9 - 1:
        revert with 'NH{q', 17
    if stor8 + stor9 > -arg5 - 1:
        revert with 'NH{q', 17
    if stor8 + stor9 + arg5 > 20:
        revert with 0, 'max 20%'
    if stor10 > -stor11 - 1:
        revert with 'NH{q', 17
    if stor10 + stor11 > -arg5 - 1:
        revert with 'NH{q', 17
