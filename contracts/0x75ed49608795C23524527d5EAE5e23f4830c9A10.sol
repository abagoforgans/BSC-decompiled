        ...
        if 0 < balanceOf[address(arg1)]:
            ...
            if stor152 * balanceOf[address(arg1)] < 0:
                ...
                if stor153[address(arg1)] + (stor152 * balanceOf[address(arg1)]) < stor153[address(arg1)]:
                    ...
                    require stor153[address(arg1)] + (stor152 * balanceOf[address(arg1)]) < stor153[address(arg1)]
            stor153[address(arg1)] += stor152 * balanceOf[address(arg1)]
    require ext_code.size(0xaccb295057124f8d9b7687739e49f772dc0f767a)
    delegate 0xaccb295057124f8d9b7687739e49f772dc0f767a.0x4c60db9c with:
         gas gas_remaining wei
        args 156, arg1
...
function getAccount(address arg1) payable {
    ...
    require arg1 == arg1
    require ext_code.size(0xaccb295057124f8d9b7687739e49f772dc0f767a)
    delegate 0xaccb295057124f8d9b7687739e49f772dc0f767a.0x17e142d1 with:
         gas gas_remaining wei
        args 156, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getAccountAtIndex(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xaccb295057124f8d9b7687739e49f772dc0f767a)
    delegate 0xaccb295057124f8d9b7687739e49f772dc0f767a.0xdeb3d896 with:
         gas gas_remaining wei
        args 156
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(0xaccb295057124f8d9b7687739e49f772dc0f767a)
    delegate 0xaccb295057124f8d9b7687739e49f772dc0f767a.0xd1aa9e7e with:
         gas gas_remaining wei
        args 156, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
