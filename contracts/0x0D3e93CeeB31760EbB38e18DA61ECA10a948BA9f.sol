...
function balanceOfBatch(address[] arg1, uint256[] arg2) payable {
    ...
    if not arg1.length:
        ...
        while idx < arg2.length:
            ...
            staticcall address(_51).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(_56)
            mem[(64 * arg1.length) + (32 * arg2.length) + 192] = ext_call.return_data[0]
            if not ext_call.success:
...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if arg1 == msg.sender:
        ...
        while idx < arg3.length:
            ...
            _64 = mem[(32 * idx) + (32 * arg3.length) + 160]
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 196] = arg1
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 228] = arg2
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 260] = _64
            require ext_code.size(address(_60))
            call address(_60).transferFrom(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining wei
                args address(arg1), address(arg2), _64
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 192] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
        ...
        while idx < arg3.length:
            ...
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 228] = -1
            require ext_code.size(address(_51))
            call address(_51).approve(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args address(arg1), -1
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 192] = ext_call.return_data[0]
            if not ext_call.success:
            ...
            _62 = mem[(32 * idx) + 128]
            require idx < arg4.length
            _67 = mem[(32 * idx) + (32 * arg3.length) + 160]
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 196] = arg1
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 228] = arg2
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 260] = _67
            require ext_code.size(address(_62))
            call address(_62).transferFrom(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining wei
                args address(arg1), address(arg2), _67
            mem[(32 * arg3.length) + (32 * arg4.length) + ceil32(arg5.length) + 192] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
