...
address sub_7b7985adAddress;
uint256 stor13; offset 32
uint256 mintFee;
big736 stor13;
uint256 sub_bf0ffc7a;
uint256 sub_66a101ce;
mapping of uint8 stor16;
uint256 sub_0f34bfc6;
...
function sub_7b7985ad(?) payable {
    return sub_7b7985adAddress
}
...
function buy() payable {
    require sub_66a101ce <= sub_bf0ffc7a
    sub_66a101ce++
    if eth.balance(this.address) < 0:
        revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[398 len 26]
    if not ext_code.size(exchangeTokenAddress):
        revert with 0, 'Address: call to non-contract'
    mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 0, stor13.field_32)
    mem[416 len 4] = 0
    call exchangeTokenAddress with:
         gas gas_remaining wei
        args Mask(736, 0, stor13.field_0), mem[388 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), mintFee
    ...
    call exchangeTokenAddress.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args _routerAddress, mintFee
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(_routerAddress)
    call _routerAddress.0x690cae20 with:
         gas gas_remaining wei
        args mintFee
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not tokenOfOwnerByIndex[address(msg.sender)][1][stor15]:
        tokenOfOwnerByIndex[address(msg.sender)]++
        tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)]] = sub_66a101ce
    ...
    if stor3[stor15]:
        ...
        tokenByIndex[stor3[stor15] - 1].field_256 = msg.sender
        tokenByIndex[stor3[stor15] - 1].field_416 = 0
    else:
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length].field_0 = sub_66a101ce
        tokenByIndex[tokenByIndex.length].field_256 = msg.sender
        tokenByIndex[tokenByIndex.length].field_416 = 0
        stor3[stor15] = tokenByIndex.length
    emit Transfer(0, msg.sender, sub_66a101ce);
    if not stor16[msg.sender]:
        if sub_0f34bfc6 + 1 < sub_0f34bfc6:
...
function tokensOf(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if not arg2 - 1:
        ...
        if -arg3 + (arg2 * arg3) / arg2 - 1 != arg3:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[(32 * arg3) + 229 len 31]
        if not arg1:
            revert with 0, 
                        32,
                        42,
        ...
        while idx < arg3:
            if idx < 0:
                revert with 0, 'SafeMath: addition overflow'
            if idx - arg3 + (arg2 * arg3) >= tokenOfOwnerByIndex[address(arg1)]:
                mem[(32 * arg3) + 128] = 32
                mem[(32 * arg3) + 160] = arg3
                idx = 0
                s = mem[64] + 64
            ...
            mem[0] = sha3(address(arg1), 1)
            require idx < arg3
            mem[(32 * idx) + 128] = stor[('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'tokenOfOwnerByIndex', 1)) + idx - arg3 + (arg2 * arg3)]
            idx = idx + 1
            continue 
