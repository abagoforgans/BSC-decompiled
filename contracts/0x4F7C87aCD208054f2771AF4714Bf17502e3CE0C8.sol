...
function sub_79d8306d(?) payable {
    return sub_79d8306dAddress
}
...
function withdraw(uint256 arg1) payable {
    ...
    if not totalSupply:
        ...
        if not msg.sender:
            ...
            if not ext_code.hash(sub_79d8306dAddress):
                revert with 0, 'SafeERC20: call to non-contract'
            if ext_code.hash(sub_79d8306dAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[324 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, arg1) >> 32
            call sub_79d8306dAddress with:
