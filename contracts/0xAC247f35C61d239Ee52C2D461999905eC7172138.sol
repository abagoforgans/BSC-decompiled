...
function sub_1a04cfb4(?) {
    require ext_code.size(sub_9bb9994cAddress)
    staticcall sub_9bb9994cAddress.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function claim() {
    ...
    staticcall creamAddress.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0]:
        require ext_code.size(creamAddress)
        call creamAddress.transfer(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args userAddress, ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_fc1fa25a(?) {
    ...
    staticcall compAddress.compSupplierIndex(address rg1, address rg2) with:
            gas gas_remaining wei
           args sub_9bb9994cAddress, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0]:
        ...
        if -Mask(32, 224, ext_call.return_data[0]) / 1000000000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] != -Mask(32, 224, ext_call.return_data[0]) / 1000000000000000000 * 10^18:
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
        require ext_code.size(compAddress)
        staticcall compAddress.compAccrued(address rg1) with:
                gas gas_remaining wei
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if (-Mask(32, 224, ext_call.return_data[0]) / 1000000000000000000 * 10^18 * ext_call.return_data[0]) + ext_call.return_data[0] < ext_call.return_data[0]:
            revert with 0, 'SafeMath: addition overflow'
        return ((-Mask(32, 224, ext_call.return_data[0]) / 1000000000000000000 * 10^18 * ext_call.return_data[0]) + ext_call.return_data[0])
    ...
    if not ext_call.return_data[0]:
        ...
        if 0 / 1000000000000000000 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] != 0 / 1000000000000000000 * 10^18:
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
        require ext_code.size(compAddress)
        staticcall compAddress.compAccrued(address rg1) with:
                gas gas_remaining wei
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if (0 / 1000000000000000000 * 10^18 * ext_call.return_data[0]) + ext_call.return_data[0] < ext_call.return_data[0]:
            revert with 0, 'SafeMath: addition overflow'
    return ext_call.return_data[0]
}
...
function sub_2a5c1ebe(?) {
    ...
    if ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] < 0:
            revert with 0, 'SafeMath: addition overflow'
        return ((2 * ext_call.return_data[0]) + (-Mask(32, 224, ext_call.return_data[0]) / 1000000000000000000 * 10^18 * ext_call.return_data[0]))
    if Mask(224, 0, ext_call.return_data[0]) <= 0:
        require ext_code.size(sub_9bb9994cAddress)
        staticcall sub_9bb9994cAddress.balanceOf(address rg1) with:
                gas gas_remaining wei
