...
#  - exit()
#
const sub_5767d534(?) = 0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3
...
function unApprove(address arg1) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        revert with 0, 'only commander'
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3):
        revert with 0, 'SafeERC20: call to non-contract'
    if not ext_code.hash(0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3):
        revert with 0, 'SafeERC20: call to non-contract'
    mem[196 len 64] = approve(address rg1, uint256 rg2), address(arg1) << 64, 0, 0
    call 0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3 with:
         gas gas_remaining wei
...
function newMission(address arg1) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        revert with 0, 'only commander'
    require ext_code.size(0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3)
    staticcall 0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3.0xdd62ed3e with:
            gas gas_remaining wei
