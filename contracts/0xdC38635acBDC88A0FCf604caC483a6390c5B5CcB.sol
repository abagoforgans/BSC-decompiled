...
#
#  - listToken(address arg1, uint256 arg2, bool arg3, string arg4, string arg5)
#
...
function updateDgasGovernor(address arg1) payable {
    ...
    call baseTokenAddress.upgradeGovernance(address rg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function auditConfig(address arg1) payable {
    ...
    if configBallots[address(arg1)] == 0x554e5354414b455f4455524154494f4e00000000000000000000000000000000:
        ...
        if configBallots[address(arg1)] == 'PRODUCE_DGAS_RATE' << 120:
            require ext_code.size(baseTokenAddress)
            call baseTokenAddress.changeInterestRatePerBlock(uint256 rg1) with:
                 gas gas_remaining wei
...
function createConfigBallot(bytes32 arg1, uint256 arg2, uint256 arg3, bool arg4, string arg5, string arg6) payable {
    ...
    if not arg3:
        ...
        call ballotFactoryAddr.create(address rg1, uint256 rg2, uint256 rg3, string rg4, string rg5) with:
             gas gas_remaining wei
        ...
        if not arg4:
            ...
            call baseTokenAddress with:
               funct ext_call.return_data[132 len 4]
                 gas gas_remaining wei
...
function auditListToken(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(arg1)
    call arg1.end() with:
         gas gas_remaining wei
...
function createTokenBallot(address arg1, uint256 arg2, uint256 arg3, bool arg4, string arg5, string arg6) payable {
    ...
    if not arg3:
        ...
        if not arg4:
            ...
            mem[(32 * _7) + ceil32(return_data.size) + 228] = arg3
            ...
            if not return_data.size:
                ...
                mem[32] = 17
                rewardOf[stor10].field_0 += arg3
                mem[(32 * _7) + ceil32(return_data.size) + 260] = arg5.length
                mem[(32 * _7) + ceil32(return_data.size) + 292 len arg5.length] = arg5[all]
                mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 292] = 0
                mem[64] = (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 324
                ...
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 328] = msg.sender
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 360] = arg2
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 392] = block.number + ext_call.return_data[0]
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 424] = 160
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 488] = arg5.length
                ...
                if not arg5.length % 32:
                    mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 456] = arg5.length + 192
                    mem[arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 520] = Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]
                    mem[arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 552 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)])] = mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + 324 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)])]
                    if not Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] % 32:
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 328 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] + arg5.length + 224]
                    else:
                        mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]) + arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 552] = mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]) + arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + -(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] % 32) + 584 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] % 32]
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 328 len floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]) + arg5.length + 256]
                else:
                    mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 520] = mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + -(arg5.length % 32) + 552 len arg5.length % 32]
                    mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 456] = floor32(arg5.length) + 224
                    mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 552] = Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]
                    mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 584 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)])] = mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + 324 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)])]
                    if not Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] % 32:
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 328 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] + floor32(arg5.length) + 256]
                    else:
                        mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]) + floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 584] = mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]) + floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + -(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] % 32) + 616 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)] % 32]
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 328 len floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + arg5.length + 324 len -arg5.length + ceil32(arg5.length)]) + floor32(arg5.length) + 288]
            else:
                ...
                mem[32] = 17
                rewardOf[stor10].field_0 += arg3
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + 261] = arg5.length
                ...
                mem[64] = (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 325
                ...
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 329] = msg.sender
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 361] = arg2
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 393] = block.number + ext_call.return_data[0]
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 425] = 160
                mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 489] = arg5.length
                ...
                if not arg5.length % 32:
                    mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 457] = arg5.length + 192
                    mem[arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 521] = Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]
                    mem[arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 553 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)])] = mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + 325 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)])]
                    if not Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] % 32:
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 329 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] + arg5.length + 224]
                    else:
                        mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]) + arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 553] = mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]) + arg5.length + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + -(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] % 32) + 585 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] % 32]
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 329 len floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]) + arg5.length + 256]
                else:
                    mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 521] = mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + -(arg5.length % 32) + 553 len arg5.length % 32]
                    mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 457] = floor32(arg5.length) + 224
                    mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 553] = Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]
                    mem[floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 585 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)])] = mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + 325 len ceil32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)])]
                    if not Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] % 32:
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 329 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] + floor32(arg5.length) + 256]
                    else:
                        mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]) + floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 585] = mem[floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]) + floor32(arg5.length) + (32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + -(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] % 32) + 617 len Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)] % 32]
                        require ext_code.size(ballotFactoryAddr)
                        call ballotFactoryAddr with:
                             gas gas_remaining wei
                            args mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + ceil32(arg5.length) + ceil32(arg6.length) + 329 len floor32(Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[(32 * _7) + ceil32(return_data.size) + ceil32(return_data.size) + arg5.length + 325 len -arg5.length + ceil32(arg5.length)]) + floor32(arg5.length) + 288]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ballotOf[address(ext_call.return_data[0])] = rewardOf[stor10].field_0
