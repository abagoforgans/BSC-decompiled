...
function sub_1266b1b9(?) payable {
    return sub_1266b1b9Address
}
...
function withdraw(uint256 arg1) payable {
    ...
    if not totalSupply:
        ...
        if not msg.sender:
            ...
            if not ext_code.hash(sub_1266b1b9Address):
                revert with 0, 'SafeERC20: call to non-contract'
            if ext_code.hash(sub_1266b1b9Address) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[324 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
            call sub_1266b1b9Address with:
