...
function updateTokenURI(uint256 arg1, string arg2) payable {
    ...
    stor9[arg1][] = Array(len=arg2.length, data=arg2[all])
}
...
function tokensOfOwner(address arg1) payable {
    ...
    if not tokenOfOwnerByIndex[address(arg1)]:
        ...
        while idx <= tokenByIndex.length:
            ...
            mem[64] = mem[64] + 96
            mem[_45] = 41
            mem[_45 + 32 len 41] = 0x734552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65
            mem[32] = 4
            if stor4[idx]:
                require stor4[idx] - 1 < tokenByIndex.length
                mem[0] = 3
                if tokenByIndex[stor4[idx] - 1].field_256 != arg1:
                    idx = idx + 1
                    s = s
                    continue 
                require s < mem[96]
            ...
            idx = 0
            while idx < 41:
                mem[_57 + idx + 68] = mem[_45 + idx + 32]
                idx = idx + 32
                continue 
            mem[_57 + 100] = mem[_57 + 123 len 9]
            revert with memory
              from mem[64]
               len _57 + -mem[64] + 132
    else:
        ...
        while idx <= tokenByIndex.length:
            ...
            mem[64] = mem[64] + 96
            mem[_46] = 41
            mem[_46 + 32 len 41] = 0x734552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65
            mem[32] = 4
            if stor4[idx]:
                require stor4[idx] - 1 < tokenByIndex.length
                mem[0] = 3
            ...
            idx = 0
            while idx < 41:
                mem[_62 + idx + 68] = mem[_46 + idx + 32]
                idx = idx + 32
                continue 
            mem[_62 + 100] = mem[_62 + 123 len 9]
            revert with memory
              from mem[64]
               len _62 + -mem[64] + 132
    mem[mem[64]] = 32
...
function rewardToken(address arg1, string arg2) payable {
    require calldata.size - 4 >= 64
    require arg2 <= 4294967296
    require arg2 + 36 <= calldata.size
    require arg2.length <= 4294967296 and arg2 + arg2.length + 36 <= calldata.size
                ...
                if not return_data.size:
                    ...
                    if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 
                                    ...
                                    mem[ceil32(arg2.length) + 438 len 14]
                    if not stor4[stor11]:
                        revert with 0, 'nERC721Metadata: URI set of nonexistent tokeemente', mem[ceil32(arg2.length) + 438 len 14]
                else:
    ...
    stor9[stor11][] = Array(len=arg2.length, data=arg2[all])
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not stor4[arg2]:
        revert with 0, 
                    ...
                    mem[247 len 9]
    require stor4[arg2] - 1 < tokenByIndex.length
    if msg.sender == tokenByIndex[stor4[arg2] - 1].field_256:
        if not stor4[arg2]:
            revert with 0, 
                        32,
                        41,
        ...
        if not tokenOfOwnerByIndex[address(msg.sender)][1][arg2]:
