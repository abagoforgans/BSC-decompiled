            ...
            if stor4[arg1]:
                ...
                if block.timestamp >= sub_b40d09e2 + (12 * 3600):
                    ...
                    if balanceOf[address(msg.sender)] < arg2:
                        revert with 0, 17
                    balanceOf[address(msg.sender)] -= arg2
                    if balanceOf[this.address] > !((500 * marketingTax * arg2) + (500 * liquidityTax * arg2) - (marketingTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg2) - (liquidityTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg2) / 10^6):
                        revert with 0, 17
                    balanceOf[this.address] += (500 * marketingTax * arg2) + (500 * liquidityTax * arg2) - (marketingTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg2) - (liquidityTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg2) / 10^6
            ...
            if stor4[arg2]:
                ...
                if block.timestamp >= sub_b40d09e2 + (12 * 3600):
                    ...
                    if (500 * arg3) - ((500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) and marketingTax + liquidityTax > -1 / (500 * arg3) - ((500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3):
                        revert with 0, 17
                    if (500 * arg3 * burnTax) - ((500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3 * burnTax) / 10^6 > !((500 * marketingTax * arg3) + (500 * liquidityTax * arg3) - (marketingTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) - (liquidityTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) / 10^6):
                        revert with 0, 17
                    ...
                    if balanceOf[address(arg1)] < arg3:
                        revert with 0, 17
                    balanceOf[address(arg1)] -= arg3
                    if balanceOf[this.address] > !((500 * marketingTax * arg3) + (500 * liquidityTax * arg3) - (marketingTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) - (liquidityTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) / 10^6):
                        revert with 0, 17
                    balanceOf[this.address] += (500 * marketingTax * arg3) + (500 * liquidityTax * arg3) - (marketingTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) - (liquidityTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) / 10^6
                    ...
                    if balanceOf[address(arg2)] > !(arg3 - ((500 * arg3 * burnTax) - ((500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3 * burnTax) / 10^6) - ((500 * marketingTax * arg3) + (500 * liquidityTax * arg3) - (marketingTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) - (liquidityTax * (500 * block.timestamp) - (500 * sub_b40d09e2) - (block.timestamp * sellTax) + (sub_b40d09e2 * sellTax) / 12 * 3600 * arg3) / 10^6)):
                        revert with 0, 17
