...
#  - _fallback()
#
const name = 'HaloInifniteFloki', 0
...
function tradingEnabled() {
    return bool(uint8(stor33.field_8))
}
...
function TeamReleaseLiquidity() {
    ...
    if block.timestamp < stor34:
        revert with 0, 'Not yet unlocked'
    require ext_code.size(address(stor33.field_16))
    staticcall address(stor33.field_16).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(address(stor33.field_16))
    call address(stor33.field_16).0xa9059cbb with:
         gas gas_remaining wei
...
function TeamRemoveLiquidity(bool arg1) {
    ...
    require return_data.size >= 32
    require ext_code.size(address(stor33.field_16))
    call address(stor33.field_16).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
