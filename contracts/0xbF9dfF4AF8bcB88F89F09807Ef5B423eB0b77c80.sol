...
uint256 totalSupply;
uint256 basePercent;
uint256 _burnStopAmount;
uint256 _lastTokenSupply;
...
function _burnStopAmount() payable {
    return _burnStopAmount
}
...
function _lastTokenSupply() payable {
    return _lastTokenSupply
}
