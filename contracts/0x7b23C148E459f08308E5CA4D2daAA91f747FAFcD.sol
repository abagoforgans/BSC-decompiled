...
function sub_58cea492(?) {
    return address(sub_58cea492Address)
}
...
function lpToken() {
    ...
    staticcall 0xbcfccbde45ce874adcb698cc183debcf17952812.getPair(address rg1, address rg2) with:
           ...
           args address(sub_58cea492Address), wETHAddress
...
function makeUnchangeable() {
    require ext_code.size(0xca9e630e8048bfb5e4f9aa0ea3b49c5dedbc87f1)
    staticcall 0xca9e630e8048bfb5e4f9aa0ea3b49c5dedbc87f1.primary() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function setTokenAddress(address arg1) {
    ...
    address(sub_58cea492Address) = arg1
}
...
function price() {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sub_58cea492Address))
    staticcall address(sub_58cea492Address).0x70a08231 with:
            gas gas_remaining wei
           args address(ext_call.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawRewardTokens(uint256 arg1) {
    ...
    require ext_code.size(address(sub_58cea492Address))
    call address(sub_58cea492Address).mint(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args msg.sender, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function stake() payable {
    ...
    call 0xca9e630e8048bfb5e4f9aa0ea3b49c5dedbc87f1 with:
    ...
    if not return_data.size:
        ...
        require return_data.size >= 32
        require ext_code.size(address(sub_58cea492Address))
        call address(sub_58cea492Address).approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
        ...
        call 0x05ff2b0db69458a0750badebc4f9e13add608c7f.addLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
           value eth.balance(this.address) wei
             gas gas_remaining wei
            args address(sub_58cea492Address), ext_call.return_data[0], 1, 1, address(this.address), 33136721748
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 96
        require ext_code.size(address(ext_call.return_data[0]))
