...
address owner;
address sub_07c19689Address;

function sub_07c19689(?) payable {
    return sub_07c19689Address
}
...
function approveRecipient(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_07c19689Address)
    staticcall sub_07c19689Address.0xdd62ed3e with:
    ...
    if not ext_code.size(sub_07c19689Address):
