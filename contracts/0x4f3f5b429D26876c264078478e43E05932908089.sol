...
#
const BRIDGE_ADDRESS = 0xd83893f31aa1b6b9d97c9c70d3492fe38d24d218
...
function transferToEth(uint256 arg1) payable {
    ...
    call sub_c947576aAddress.transferAndCall(address rg1, uint256 rg2, bytes rg3) with:
         gas gas_remaining wei
        args 0xd83893f31aa1b6b9d97c9c70d3492fe38d24d218, arg1, 96, 20, Mask(160, 96, msg.sender, 0, 0) >> 96, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function transferToEth(uint256 arg1, address arg2) payable {
    ...
    call sub_c947576aAddress.transferAndCall(address rg1, uint256 rg2, bytes rg3) with:
         gas gas_remaining wei
        args 0xd83893f31aa1b6b9d97c9c70d3492fe38d24d218, arg1, 96, 20, Mask(160, 96, arg2, 0, 0) >> 96, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function addProfit(uint256 arg1) payable {
    ...
    if not dfProfitsAddress:
        create contract with 0 wei
                        code: code.data[8497 len 1089], address(this.address)
    ...
    storD26E[stor157.length].field_64 = uint64(arg1 / 10^12)
    require ext_code.size(sub_f76fd0f4Address)
