...
function sub_be67c6c1(?) {
    ...
    require ext_code.size(0xf3fc285458eec4aeb626320c2486dea77d3f1276)
    delegate 0xf3fc285458eec4aeb626320c2486dea77d3f1276.0xcd7db54c with:
...
function sub_31f17857(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(0x67d14fbb486ad99fbc55f29f34a08f82f7ea5d35)
    delegate 0x67d14fbb486ad99fbc55f29f34a08f82f7ea5d35.0x13d674fe with:
         gas gas_remaining wei
...
function sub_b97c41a5(?) {
    if not sub_26f05442Address:
        return -1
    require ext_code.size(0xf3fc285458eec4aeb626320c2486dea77d3f1276)
    delegate 0xf3fc285458eec4aeb626320c2486dea77d3f1276.0xcc23f384 with:
         gas gas_remaining wei
...
function approve(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x3649163a61205a73ec16ba7be5b1687f012de84a)
    delegate 0x3649163a61205a73ec16ba7be5b1687f012de84a.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0x48b54c3e44265f6643b2f38ba2f8310c6c274b9)
        delegate 0x48b54c3e44265f6643b2f38ba2f8310c6c274b9.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2 == arg2
    require ext_code.size(0x3649163a61205a73ec16ba7be5b1687f012de84a)
    delegate 0x3649163a61205a73ec16ba7be5b1687f012de84a.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_5126dad7(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
        delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
        delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x8f326eb57429854726b192a38cd451e970bc5225)
        delegate 0x8f326eb57429854726b192a38cd451e970bc5225.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_a9f1866b(?) {
    require ext_code.size(0xf3fc285458eec4aeb626320c2486dea77d3f1276)
    delegate 0xf3fc285458eec4aeb626320c2486dea77d3f1276.0x5bb709aa with:
         gas gas_remaining wei
        args 3, 30
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_594161f8(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0x48b54c3e44265f6643b2f38ba2f8310c6c274b9)
        delegate 0x48b54c3e44265f6643b2f38ba2f8310c6c274b9.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
        delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x3649163a61205a73ec16ba7be5b1687f012de84a)
            delegate 0x3649163a61205a73ec16ba7be5b1687f012de84a.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
        delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
        delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_d32ea8b6(?) {
    ...
    mem[516] = arg1
    require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
    delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_3367ad09(?) {
    ...
    require ('cd', 4)[13] < 21
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a)
    delegate 0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a)
    delegate 0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0x48b54c3e44265f6643b2f38ba2f8310c6c274b9)
        delegate 0x48b54c3e44265f6643b2f38ba2f8310c6c274b9.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
        delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) {
    ...
    mem[132] = 14
    require ext_code.size(0x99883352b65c0dd46f09a740daa7041f6a8660e5)
    delegate 0x99883352b65c0dd46f09a740daa7041f6a8660e5.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    ...
    mem[388] = arg1
    require ext_code.size(0x67d14fbb486ad99fbc55f29f34a08f82f7ea5d35)
    delegate 0x67d14fbb486ad99fbc55f29f34a08f82f7ea5d35.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x3649163a61205a73ec16ba7be5b1687f012de84a)
    delegate 0x3649163a61205a73ec16ba7be5b1687f012de84a.0xc5bb51da with:
         gas gas_remaining wei
...
function sub_a05e1c7d(?) {
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[4] <= 0:
            ...
            require ext_code.size(0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a)
            delegate 0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a.mem[mem[64] len 4] with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a)
            delegate 0x579b9515d1abb06ac6284b590cc6989f5e1c6b7a.mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 640 len 4] with:
                 gas gas_remaining wei
