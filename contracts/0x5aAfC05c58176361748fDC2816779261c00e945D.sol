...
function manualswap() {
    ...
    allowance[address(this.address)][stor16] = stor2[address(this.address)] / stor6 / 100 * 10^18
    emit Approval((stor2[address(this.address)] / stor6 / 100 * 10^18), this.address, uniswapV2RouterAddress);
