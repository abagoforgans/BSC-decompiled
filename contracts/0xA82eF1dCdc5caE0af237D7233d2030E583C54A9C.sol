    ...
    while idx < ('cd', 164).length:
        ...
        if address(_563) != mem[(32 * idx) + 140 len 20]:
            if not stor2[address(mem[(32 * idx) + 128])]:
                require (10^6 * mem[_572 + 50 len 14]) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
                mem[0] = mem[(32 * idx + 1) + 140 len 20]
                mem[32] = 2
                if not stor2[mem[(32 * idx + 1) + 140 len 20]]:
                    idx = idx + 1
                    s = s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _573) / (10^6 * Mask(112, 0, _576)) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
                    continue 
                mem[0] = mem[(32 * idx + 1) + 140 len 20]
                mem[32] = 2
                idx = idx + 1
                s = (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _573) / (10^6 * Mask(112, 0, _576)) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])) - (stor2[mem[(32 * idx + 1) + 140 len 20]] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _573) / (10^6 * Mask(112, 0, _576)) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])) / 1000
                continue 
            require (10^6 * mem[_572 + 50 len 14]) + (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]]) - (stor2[address(mem[(32 * idx) + 128])] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
            mem[0] = mem[(32 * idx + 1) + 140 len 20]
            mem[32] = 2
            if not stor2[mem[(32 * idx + 1) + 140 len 20]]:
                idx = idx + 1
                s = (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _573)) - (stor2[address(mem[(32 * idx) + 128])] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _573)) / (10^6 * Mask(112, 0, _576)) + (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]]) - (stor2[address(mem[(32 * idx) + 128])] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
                continue 
            mem[0] = mem[(32 * idx + 1) + 140 len 20]
            mem[32] = 2
            idx = idx + 1
            ...
            continue 
        if not stor2[address(mem[(32 * idx) + 128])]:
            require (10^6 * mem[_572 + 18 len 14]) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
            mem[0] = mem[(32 * idx + 1) + 140 len 20]
            mem[32] = 2
            if not stor2[mem[(32 * idx + 1) + 140 len 20]]:
                idx = idx + 1
                s = s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _576) / (10^6 * Mask(112, 0, _573)) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
                continue 
            mem[0] = mem[(32 * idx + 1) + 140 len 20]
            mem[32] = 2
            idx = idx + 1
            s = (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _576) / (10^6 * Mask(112, 0, _573)) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])) - (stor2[mem[(32 * idx + 1) + 140 len 20]] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _576) / (10^6 * Mask(112, 0, _573)) + (s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])) / 1000
            continue 
        require (10^6 * mem[_572 + 18 len 14]) + (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]]) - (stor2[address(mem[(32 * idx) + 128])] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
        mem[0] = mem[(32 * idx + 1) + 140 len 20]
        mem[32] = 2
        if not stor2[mem[(32 * idx + 1) + 140 len 20]]:
            idx = idx + 1
            s = (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _576)) - (stor2[address(mem[(32 * idx) + 128])] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]] * Mask(112, 0, _576)) / (10^6 * Mask(112, 0, _573)) + (1000 * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]]) - (stor2[address(mem[(32 * idx) + 128])] * s * stor1[mem[(32 * idx) + (32 * ('cd', 68).length) + 172 len 20]])
            continue 
        mem[0] = mem[(32 * idx + 1) + 140 len 20]
        mem[32] = 2
        idx = idx + 1
    ...
    if not s:
        ...
        while idx < _697:
            ...
            if idx != mem[(32 * ('cd', 68).length) + 128] - 1:
                ...
                call address(_815).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args s, 0, 160, address(t), cd[100], mem[mem[64] + 164 len (32 * _841) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require idx + 1 < mem[96]
            ...
            if mem[_742] >= s:
                ...
                call address(_761).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args s, 0, 160, address(cd[36]), cd[100], mem[mem[64] + 164 len (32 * _789) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require idx + 1 < mem[96]
            ...
            call address(_820).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args s, 0, 160, address(cd[36]), cd[100], mem[mem[64] + 164 len (32 * _851) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require idx + 1 < mem[96]
            ...
            while idx < _1225:
                ...
                if idx == mem[(32 * ('cd', 68).length) + 128] - 1:
                    ...
                    if mem[_1273] >= s:
                        ...
                        call address(_1297).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args s, 0, 160, address(cd[36]), cd[100], mem[mem[64] + 164 len (32 * _1313) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require idx + 1 < mem[96]
                    ...
                    call address(_1339).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args s, 0, 160, address(cd[36]), cd[100], mem[mem[64] + 164 len (32 * _1362) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require idx + 1 < mem[96]
                ...
                while s < _1359:
                    ...
                    v = v + 32
                    continue 
                mem[_1334 + 100] = address(t)
                mem[_1334 + 132] = cd[100]
                require ext_code.size(address(_1333))
                call address(_1333).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _1334 + (32 * _1359) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require idx + 1 < mem[96]
            ...
            while idx < _1226:
                ...
                if idx != mem[(32 * ('cd', 68).length) + 128] - 1:
                    ...
                    if mem[_1272] >= s:
                        ...
                        call address(_1289).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args s, 0, 160, address(t), cd[100], mem[mem[64] + 164 len (32 * _1312) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require idx + 1 < mem[96]
