...
function sub_00722765(?) {
    ...
    if (32 * ('cd', 196).length) + 160 < 128 or (32 * ('cd', 164).length) + (32 * ('cd', 196).length) + 160 > test266151307():
        revert with 0, 65
    mem[64] = (32 * ('cd', 164).length) + (32 * ('cd', 196).length) + 160
    ...
    if not ('cd', 196).length:
        ...
        if not ('cd', 164).length:
            ...
            _188 = mem[(32 * ('cd', 164).length) + 128]
            mem[(64 * ('cd', 164).length) + (32 * ('cd', 196).length) + 416] = mem[(32 * ('cd', 164).length) + 128]
            idx = 0
            s = (32 * ('cd', 164).length) + 160
            t = (64 * ('cd', 164).length) + (32 * ('cd', 196).length) + 448
            while idx < mem[(32 * ('cd', 164).length) + 128]:
                mem[t] = mem[s + 12 len 20]
                idx = idx + 1
                s = s + 32
                t = t + 32
                continue 
            emit 0xe517d267: mem[mem[64] len (64 * ('cd', 164).length) + (32 * ('cd', 196).length) + (32 * _188) + -mem[64] + 448]
        else:
            s = 0
            idx = 128
            ...
            while idx < mem[(32 * ('cd', 164).length) + 128]:
                ...
                t = t + 32
                continue 
            emit 0xe517d267: mem[mem[64] len (64 * ('cd', 164).length) + (32 * ('cd', 196).length) + (32 * _213) + -mem[64] + 448]
    else:
        s = 0
        ...
        if not ('cd', 164).length:
            ...
            while idx < mem[(32 * ('cd', 164).length) + 128]:
                ...
                t = t + 32
                continue 
            emit 0xe517d267: mem[mem[64] len (64 * ('cd', 164).length) + (32 * ('cd', 196).length) + (32 * _214) + -mem[64] + 448]
        else:
            s = 0
            idx = 128
            while (32 * ('cd', 164).length) + 128 > idx:
            ...
            while idx < mem[(32 * ('cd', 164).length) + 128]:
                ...
                t = t + 32
                continue 
            emit 0xe517d267: mem[mem[64] len (64 * ('cd', 164).length) + (32 * ('cd', 196).length) + (32 * _230) + -mem[64] + 448]
}
