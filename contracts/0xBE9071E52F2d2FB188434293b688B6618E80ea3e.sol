...
function sub_37117de6(?) payable {
    ...
    mem[64] = ceil32(return_data.size) + 288
    require return_data.size >= 32
    _221 = mem[288 len 4], Mask(224, 32, arg5) >> 32
    require mem[288 len 4], Mask(224, 32, arg5) >> 32 <= 4294967296
    require mem[288 len 4], Mask(224, 32, arg5) >> 32 + 32 <= return_data.size
    require mem[mem[288 len 4], Mask(224, 32, arg5) >> 32 + 288] <= 4294967296 and mem[288 len 4], Mask(224, 32, arg5) >> 32 + (32 * mem[mem[288 len 4], Mask(224, 32, arg5) >> 32 + 288]) + 32 <= return_data.size
    mem[ceil32(return_data.size) + 288] = mem[mem[288 len 4], Mask(224, 32, arg5) >> 32 + 288]
    _224 = mem[_221 + 288]
    mem[ceil32(return_data.size) + 320 len floor32(mem[_221 + 288])] = mem[_221 + 320 len floor32(mem[_221 + 288])]
    mem[(32 * _224) + ceil32(return_data.size) + 320] = 30
    mem[(32 * _224) + ceil32(return_data.size) + 352] = 'SafeMath: subtraction overflow'
    if slippage > 1000:
        revert with 0, 'SafeMath: subtraction overflow'
    require 1 < mem[ceil32(return_data.size) + 288]
    if not mem[ceil32(return_data.size) + 352]:
        mem[(32 * _224) + ceil32(return_data.size) + 384] = 26
        mem[(32 * _224) + ceil32(return_data.size) + 416] = 'SafeMath: division by zero'
        mem[(32 * _224) + ceil32(return_data.size) + 448] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(32 * _224) + ceil32(return_data.size) + 452] = arg5
        mem[(32 * _224) + ceil32(return_data.size) + 484] = 0
        mem[(32 * _224) + ceil32(return_data.size) + 548] = this.address
        mem[(32 * _224) + ceil32(return_data.size) + 580] = block.timestamp + 10
        mem[(32 * _224) + ceil32(return_data.size) + 516] = 160
        mem[(32 * _224) + ceil32(return_data.size) + 612] = 2
        mem[(32 * _224) + ceil32(return_data.size) + 644 len 0] = None
        require ext_code.size(arg3)
        call arg3.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args arg5, 0, 160, address(this.address), block.timestamp + 10, 2, mem[(32 * _224) + ceil32(return_data.size) + 644 len 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * _224) + ceil32(return_data.size) + 448 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (32 * _224) + (2 * ceil32(return_data.size)) + 448
        require return_data.size >= 32
        _631 = mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32
        require mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 <= 4294967296
        require mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * _224) + ceil32(return_data.size) + 448] <= 4294967296 and mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * mem[mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * _224) + ceil32(return_data.size) + 448]) + 32 <= return_data.size
        mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448] = mem[mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * _224) + ceil32(return_data.size) + 448]
        _636 = mem[_631 + (32 * _224) + ceil32(return_data.size) + 448]
        mem[(32 * _224) + (2 * ceil32(return_data.size)) + 480 len floor32(mem[_631 + (32 * _224) + ceil32(return_data.size) + 448])] = mem[_631 + (32 * _224) + ceil32(return_data.size) + 480 len floor32(mem[_631 + (32 * _224) + ceil32(return_data.size) + 448])]
        if 1 < mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448]:
            _804 = mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512]
            if mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512] <= 0:
                revert with 0, 'input amount is zero'
            require ext_code.size(arg2)
            call arg2.approve(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 480] = 2
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 512] = arg2
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 544] = arg1
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 580] = _804
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 612] = 64
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 644] = 2
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 676 len 0] = None
            require ext_code.size(arg4)
            staticcall arg4.getAmountsOut(uint256 rg1, address[] rg2) with:
                    gas gas_remaining wei
                   args _804, Array(len=2, data=mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 676 len 64])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 576
            require return_data.size >= 32
            _969 = mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _804) >> 32
            require mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _804) >> 32 <= 4294967296
            require mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _804) >> 32 + 32 <= return_data.size
            require mem[mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _804) >> 32 + (32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576] <= 4294967296 and mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _804) >> 32 + (32 * mem[mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _804) >> 32 + (32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576]) + 32 <= return_data.size
            mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 576] = mem[mem[(32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _804) >> 32 + (32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576]
            _974 = mem[_969 + (32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576]
            mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 608 len floor32(mem[_969 + (32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576])] = mem[_969 + (32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 608 len floor32(mem[_969 + (32 * _636) + (32 * _224) + (2 * ceil32(return_data.size)) + 576])]
            mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 608] = 30
            mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640] = 'SafeMath: subtraction overflow'
            if slippage > 1000:
                revert with 0, 'SafeMath: subtraction overflow'
            if 1 < mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 576]:
                if not mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]:
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 672] = 26
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 704] = 'SafeMath: division by zero'
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 740] = _804
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 772] = 0
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 836] = this.address
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 868] = block.timestamp + 10
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 804] = 160
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 900] = 2
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 932 len 0] = None
                    require ext_code.size(arg4)
                    call arg4.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args _804, 0, 160, address(this.address), block.timestamp + 10, 2, mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 932 len 64]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    mem[64] = (32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736
                    require return_data.size >= 32
                    _1237 = mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32
                    require mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 <= 4294967296
                    require mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + 32 <= return_data.size
                    require mem[mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] <= 4294967296 and mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * mem[mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]) + 32 <= return_data.size
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736] = mem[mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                    _1246 = mem[_1237 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                    mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 768 len floor32(mem[_1237 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])] = mem[_1237 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 768 len floor32(mem[_1237 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])]
                    if 1 < mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                        if mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] <= arg5:
                            revert with 0, 'loss money'
                        mem[(32 * _1246) + (32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 768] = arg5
                        if 1 < mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448]:
                            mem[(32 * _1246) + (32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] = mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512]
                            if 1 < mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                                return arg5, 
                                       mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512],
                                       mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 800]
                else:
                    if mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]:
                        if (1000 * mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) - (slippage * mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) / mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640] != -slippage + 1000:
                            revert with 0, 
                                        32,
                                        33,
                                        0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 773 len 31]
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 672] = 26
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 704] = 'SafeMath: division by zero'
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 740] = _804
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 772] = (1000 * mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) - (slippage * mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) / 1000
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 836] = this.address
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 868] = block.timestamp + 10
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 804] = 160
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 900] = 2
                        ...
                        call arg4.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args _804, (1000 * mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) - (slippage * mem[(32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) / 1000, Array(len=2, data=mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 932 len 64]), address(this.address), block.timestamp + 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        mem[64] = (32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736
                        require return_data.size >= 32
                        _1235 = mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32
                        require mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 <= 4294967296
                        require mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + 32 <= return_data.size
                        require mem[mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] <= 4294967296 and mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * mem[mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]) + 32 <= return_data.size
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736] = mem[mem[(32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _804) >> 32 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                        _1245 = mem[_1235 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                        mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 768 len floor32(mem[_1235 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])] = mem[_1235 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 768 len floor32(mem[_1235 + (32 * _974) + (32 * _636) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])]
                        if 1 < mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                            if mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] <= arg5:
                                revert with 0, 'loss money'
                            mem[(32 * _1245) + (32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 768] = arg5
                            if 1 < mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448]:
                                mem[(32 * _1245) + (32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] = mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512]
                                if 1 < mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                                    return arg5, 
                                           mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512],
                                           mem[(32 * _974) + (32 * _636) + (32 * _224) + (6 * ceil32(return_data.size)) + 800]
        ...
        if mem[ceil32(return_data.size) + 352]:
            if (1000 * mem[ceil32(return_data.size) + 352]) - (slippage * mem[ceil32(return_data.size) + 352]) / mem[ceil32(return_data.size) + 352] != -slippage + 1000:
                revert with 0, 
                            ...
                            33,
                            0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[(32 * _224) + ceil32(return_data.size) + 485 len 31]
            mem[(32 * _224) + ceil32(return_data.size) + 384] = 26
            mem[(32 * _224) + ceil32(return_data.size) + 416] = 'SafeMath: division by zero'
            mem[(32 * _224) + ceil32(return_data.size) + 448] = 0x38ed173900000000000000000000000000000000000000000000000000000000
            mem[(32 * _224) + ceil32(return_data.size) + 452] = arg5
            mem[(32 * _224) + ceil32(return_data.size) + 484] = (1000 * mem[ceil32(return_data.size) + 352]) - (slippage * mem[ceil32(return_data.size) + 352]) / 1000
            mem[(32 * _224) + ceil32(return_data.size) + 548] = this.address
            mem[(32 * _224) + ceil32(return_data.size) + 580] = block.timestamp + 10
            mem[(32 * _224) + ceil32(return_data.size) + 516] = 160
            mem[(32 * _224) + ceil32(return_data.size) + 612] = 2
            ...
            call arg3.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args arg5, (1000 * mem[ceil32(return_data.size) + 352]) - (slippage * mem[ceil32(return_data.size) + 352]) / 1000, Array(len=2, data=mem[(32 * _224) + ceil32(return_data.size) + 644 len 64]), address(this.address), block.timestamp + 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(32 * _224) + ceil32(return_data.size) + 448 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (32 * _224) + (2 * ceil32(return_data.size)) + 448
            require return_data.size >= 32
            _629 = mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32
            require mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 <= 4294967296
            require mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + 32 <= return_data.size
            require mem[mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * _224) + ceil32(return_data.size) + 448] <= 4294967296 and mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * mem[mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * _224) + ceil32(return_data.size) + 448]) + 32 <= return_data.size
            mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448] = mem[mem[(32 * _224) + ceil32(return_data.size) + 448 len 4], Mask(224, 32, arg5) >> 32 + (32 * _224) + ceil32(return_data.size) + 448]
            _635 = mem[_629 + (32 * _224) + ceil32(return_data.size) + 448]
            mem[(32 * _224) + (2 * ceil32(return_data.size)) + 480 len floor32(mem[_629 + (32 * _224) + ceil32(return_data.size) + 448])] = mem[_629 + (32 * _224) + ceil32(return_data.size) + 480 len floor32(mem[_629 + (32 * _224) + ceil32(return_data.size) + 448])]
            if 1 < mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448]:
                _803 = mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512]
                if mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512] <= 0:
                    revert with 0, 'input amount is zero'
                require ext_code.size(arg2)
                call arg2.approve(address rg1, uint256 rg2) with:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 480] = 2
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 512] = arg2
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 544] = arg1
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 580] = _803
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 612] = 64
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 644] = 2
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 676 len 0] = None
                require ext_code.size(arg4)
                staticcall arg4.getAmountsOut(uint256 rg1, address[] rg2) with:
                        gas gas_remaining wei
                       args _803, Array(len=2, data=mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 676 len 64])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 576
                require return_data.size >= 32
                _967 = mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _803) >> 32
                require mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _803) >> 32 <= 4294967296
                require mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _803) >> 32 + 32 <= return_data.size
                require mem[mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _803) >> 32 + (32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576] <= 4294967296 and mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _803) >> 32 + (32 * mem[mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _803) >> 32 + (32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576]) + 32 <= return_data.size
                mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 576] = mem[mem[(32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576 len 4], Mask(224, 32, _803) >> 32 + (32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576]
                _973 = mem[_967 + (32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576]
                mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 608 len floor32(mem[_967 + (32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576])] = mem[_967 + (32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 608 len floor32(mem[_967 + (32 * _635) + (32 * _224) + (2 * ceil32(return_data.size)) + 576])]
                mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 608] = 30
                mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640] = 'SafeMath: subtraction overflow'
                if slippage > 1000:
                    revert with 0, 'SafeMath: subtraction overflow'
                if 1 < mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 576]:
                    if not mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]:
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 672] = 26
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 704] = 'SafeMath: division by zero'
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 740] = _803
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 772] = 0
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 836] = this.address
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 868] = block.timestamp + 10
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 804] = 160
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 900] = 2
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 932 len 0] = None
                        require ext_code.size(arg4)
                        call arg4.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args _803, 0, 160, address(this.address), block.timestamp + 10, 2, mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 932 len 64]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        mem[64] = (32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736
                        require return_data.size >= 32
                        _1233 = mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32
                        require mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 <= 4294967296
                        require mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + 32 <= return_data.size
                        require mem[mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] <= 4294967296 and mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * mem[mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]) + 32 <= return_data.size
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736] = mem[mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                        _1244 = mem[_1233 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                        mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 768 len floor32(mem[_1233 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])] = mem[_1233 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 768 len floor32(mem[_1233 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])]
                        if 1 < mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                            if mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] <= arg5:
                                revert with 0, 'loss money'
                            mem[(32 * _1244) + (32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 768] = arg5
                            if 1 < mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448]:
                                mem[(32 * _1244) + (32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] = mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512]
                                if 1 < mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                                    return arg5, 
                                           mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512],
                                           mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 800]
                    else:
                        if mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]:
                            if (1000 * mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) - (slippage * mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) / mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640] != -slippage + 1000:
                                revert with 0, 
                                            32,
                                            33,
                                            0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 773 len 31]
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 672] = 26
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 704] = 'SafeMath: division by zero'
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 740] = _803
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 772] = (1000 * mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) - (slippage * mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) / 1000
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 836] = this.address
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 868] = block.timestamp + 10
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 804] = 160
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 900] = 2
                            ...
                            call arg4.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                 gas gas_remaining wei
                                args _803, (1000 * mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) - (slippage * mem[(32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 640]) / 1000, Array(len=2, data=mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 932 len 64]), address(this.address), block.timestamp + 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            mem[64] = (32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736
                            require return_data.size >= 32
                            _1231 = mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32
                            require mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 <= 4294967296
                            require mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + 32 <= return_data.size
                            require mem[mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736] <= 4294967296 and mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * mem[mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]) + 32 <= return_data.size
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736] = mem[mem[(32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736 len 4], Mask(224, 32, _803) >> 32 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                            _1243 = mem[_1231 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736]
                            mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 768 len floor32(mem[_1231 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])] = mem[_1231 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 768 len floor32(mem[_1231 + (32 * _973) + (32 * _635) + (32 * _224) + (4 * ceil32(return_data.size)) + 736])]
                            if 1 < mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                                if mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] <= arg5:
                                    revert with 0, 'loss money'
                                mem[(32 * _1243) + (32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 768] = arg5
                                if 1 < mem[(32 * _224) + (2 * ceil32(return_data.size)) + 448]:
                                    mem[(32 * _1243) + (32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 800] = mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512]
                                    if 1 < mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 736]:
                                        return arg5, 
                                               mem[(32 * _224) + (2 * ceil32(return_data.size)) + 512],
                                               mem[(32 * _973) + (32 * _635) + (32 * _224) + (6 * ceil32(return_data.size)) + 800]
