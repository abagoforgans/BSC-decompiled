...
function getReward() payable {
    if not sub_b208319f:
        ...
        if 0 < userRewardPerTokenPaid[address(msg.sender)]:
            revert with 'NH{q', 17
        if sub_a399b20f[address(msg.sender)] and -userRewardPerTokenPaid[address(msg.sender)] > -1 / sub_a399b20f[address(msg.sender)]:
            revert with 'NH{q', 17
        if -1 * sub_a399b20f[address(msg.sender)] * userRewardPerTokenPaid[address(msg.sender)] / 10^18 > -rewards[address(msg.sender)] - 1:
            revert with 'NH{q', 17
        rewards[address(msg.sender)] += -1 * sub_a399b20f[address(msg.sender)] * userRewardPerTokenPaid[address(msg.sender)] / 10^18
    else:
        if block.timestamp < lastUpdateTime:
            revert with 'NH{q', 17
        if block.timestamp - lastUpdateTime and rewardRate > -1 / block.timestamp - lastUpdateTime:
        ...
        if rewardPerTokenStored > -((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f) - 1:
            revert with 'NH{q', 17
        rewardPerTokenStored += (10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f
        lastUpdateTime = block.timestamp
        if not sub_b208319f:
            if 0 < userRewardPerTokenPaid[address(msg.sender)]:
                revert with 'NH{q', 17
            ...
            if rewardPerTokenStored > -((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f) - 1:
                revert with 'NH{q', 17
            if rewardPerTokenStored + ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f) < userRewardPerTokenPaid[address(msg.sender)]:
                revert with 'NH{q', 17
            if sub_a399b20f[address(msg.sender)] and rewardPerTokenStored + ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f) - userRewardPerTokenPaid[address(msg.sender)] > -1 / sub_a399b20f[address(msg.sender)]:
                revert with 'NH{q', 17
            if (rewardPerTokenStored * sub_a399b20f[address(msg.sender)]) + ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f * sub_a399b20f[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sub_a399b20f[address(msg.sender)]) / 10^18 > -rewards[address(msg.sender)] - 1:
                revert with 'NH{q', 17
            rewards[address(msg.sender)] += (rewardPerTokenStored * sub_a399b20f[address(msg.sender)]) + ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f * sub_a399b20f[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sub_a399b20f[address(msg.sender)]) / 10^18
...
function withdraw(uint256 arg1) payable {
    ...
    if not sub_b208319f:
        ...
        if not sub_b208319f:
            ...
            rewards[address(msg.sender)] += (rewardPerTokenStored * sub_a399b20f[address(msg.sender)]) + ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / sub_b208319f * sub_a399b20f[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sub_a399b20f[address(msg.sender)]) / 10^18
    userRewardPerTokenPaid[address(msg.sender)] = rewardPerTokenStored
    if sub_b208319f < arg1:
        revert with 'NH{q', 17
    sub_b208319f -= arg1
    if sub_a399b20f[address(msg.sender)] < arg1:
        revert with 'NH{q', 17
    sub_a399b20f[address(msg.sender)] -= arg1
...
function stake(uint256 arg1) payable {
    ...
    if sub_b208319f > -arg1 - 1:
        revert with 'NH{q', 17
    sub_b208319f += arg1
    if sub_a399b20f[address(msg.sender)] > -arg1 - 1:
        revert with 'NH{q', 17
    sub_a399b20f[address(msg.sender)] += arg1
    require ext_code.size(stakingTokenAddress)
