...
function farm() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] < 10^11:
        require ext_code.size(0xf508fcd89b8bd15579dc79a6827cb4686a3592c8)
        call 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8.balanceOfUnderlying(address rg1) with:
             gas gas_remaining wei
            args this.address
...
function pause() {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if ext_code.size(0x2170ed0880ac9a755fd29b2688956bd959f933f8) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8, 0
            call 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0x6a3592c8 with:
                 gas gas_remaining wei
            ...
            if ext_code.size(0x2170ed0880ac9a755fd29b2688956bd959f933f8) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 589 len 64] = 0, 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8, 0
            call 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0x6a3592c8 with:
                 gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if ext_code.size(0x2170ed0880ac9a755fd29b2688956bd959f933f8) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len 64] = 0, 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8, 0
            call 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0x6a3592c8 with:
                 gas gas_remaining wei
...
function unpause() {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            staticcall 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0xdd62ed3e with:
                    gas gas_remaining wei
                   args address(this.address), 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0]:
            ...
            if ext_code.size(0x2170ed0880ac9a755fd29b2688956bd959f933f8) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = 0, 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0x6a3592c8 with:
                 gas gas_remaining wei
            ...
            if ext_code.size(0x2170ed0880ac9a755fd29b2688956bd959f933f8) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 589 len 64] = 0, 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0x6a3592c8 with:
                 gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            staticcall 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0xdd62ed3e with:
                    gas gas_remaining wei
                   args address(this.address), 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8, mem[(2 * ceil32(return_data.size)) + 494 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0]:
            ...
            if ext_code.size(0x2170ed0880ac9a755fd29b2688956bd959f933f8) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 590 len 64] = 0, 0xf508fcd89b8bd15579dc79a6827cb4686a3592c8, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call 0x2170ed0880ac9a755fd29b2688956bd959f933f8.0x6a3592c8 with:
                 gas gas_remaining wei
