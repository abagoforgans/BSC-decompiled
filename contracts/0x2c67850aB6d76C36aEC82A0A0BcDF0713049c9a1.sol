    ...
    if totalAmount <= raisingAmount:
        if not userInfo[address(msg.sender)].field_0:
            ...
            if totalAmount <= raisingAmount:
                ...
                if not ext_code.hash(offeringTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, 0 / raisingAmount) >> 32
                call offeringTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                ...
                if not userInfo[address(msg.sender)].field_0:
                    ...
                    if not raisingAmount:
                        ...
                        if not ext_code.hash(offeringTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[580 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, 0 / raisingAmount) >> 32
                        mem[644 len 0] = 0
                        call offeringTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            if userInfo[address(msg.sender)].field_0 - (0 / totalAmount / 10^6 * raisingAmount / 10^6):
                                ...
                                if not ext_code.hash(lpTokenAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 745 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, userInfo[address(msg.sender)].field_0 - (0 / totalAmount / 10^6 * raisingAmount / 10^6)) >> 32
                    ...
                    if not raisingAmount:
                        ...
                        if not userInfo[address(msg.sender)].field_0:
                            ...
                            if not ext_code.hash(lpTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 745 len 64] = transfer(address rg1, uint256 rg2), msg.sender, userInfo[address(msg.sender)].field_32
                            mem[ceil32(return_data.size) + 837 len 4] = 0
                            call lpTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                        ...
                        if not userInfo[address(msg.sender)].field_0 - (10^12 * userInfo[address(msg.sender)].field_0 / totalAmount / 10^6 * raisingAmount / 10^6):
                            ...
                            if not ext_code.hash(lpTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 745 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, userInfo[address(msg.sender)].field_0 - (10^12 * userInfo[address(msg.sender)].field_0 / totalAmount / 10^6 * raisingAmount / 10^6)) >> 32
                            mem[ceil32(return_data.size) + 837 len 4] = 0
                            call lpTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
            ...
            if totalAmount <= raisingAmount:
                ...
                if not ext_code.hash(offeringTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, offeringAmount * userInfo[address(msg.sender)].field_0 / raisingAmount) >> 32
                call offeringTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                ...
                if not userInfo[address(msg.sender)].field_0:
                    ...
                    if not raisingAmount:
                        ...
                        if not ext_code.hash(offeringTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[580 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, offeringAmount * userInfo[address(msg.sender)].field_0 / raisingAmount) >> 32
                        mem[644 len 0] = 0
                        call offeringTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
        ...
        if not userInfo[address(msg.sender)].field_0:
            ...
            if not offeringAmount:
                if totalAmount <= raisingAmount:
                    ...
                    if not ext_code.hash(offeringTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address rg1, uint256 rg2), msg.sender, 0
                    call offeringTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                    ...
                    if not userInfo[address(msg.sender)].field_0:
                        ...
                        if not raisingAmount:
                            ...
                            if not ext_code.hash(offeringTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[708 len 64] = transfer(address rg1, uint256 rg2), msg.sender, 0
                            call offeringTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                            ...
                            if not return_data.size:
                                if not userInfo[address(msg.sender)].field_0:
                                    ...
                                    if not ext_code.hash(lpTokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[ceil32(return_data.size) + 873 len 64] = transfer(address rg1, uint256 rg2), msg.sender, userInfo[address(msg.sender)].field_32
                            ...
                            if not return_data.size:
                                if not userInfo[address(msg.sender)].field_0 - (0 / totalAmount / 10^6 * raisingAmount / 10^6):
                                    ...
                                    if not ext_code.hash(lpTokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[ceil32(return_data.size) + 873 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, userInfo[address(msg.sender)].field_0 - (0 / totalAmount / 10^6 * raisingAmount / 10^6)) >> 32
                                    mem[ceil32(return_data.size) + 965 len 4] = 0
                                    call lpTokenAddress with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
                        ...
                        if not raisingAmount:
                            ...
                            call offeringTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, transfer(address rg1, uint256 rg2), msg.sender, 0) << 256, mem[772 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[740 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            ...
                            if not userInfo[address(msg.sender)].field_0 - (10^12 * userInfo[address(msg.sender)].field_0 / totalAmount / 10^6 * raisingAmount / 10^6):
                                ...
                                if not ext_code.hash(lpTokenAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 873 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, userInfo[address(msg.sender)].field_0 - (10^12 * userInfo[address(msg.sender)].field_0 / totalAmount / 10^6 * raisingAmount / 10^6)) >> 32
                                mem[ceil32(return_data.size) + 965 len 4] = 0
                                call lpTokenAddress with:
                                   funct uint32(msg.sender)
                                     gas gas_remaining wei
                ...
                if totalAmount <= raisingAmount:
                    ...
                    if not ext_code.hash(offeringTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, 0 / totalAmount / 10^6 * offeringAmount / 10^6) >> 32
                    call offeringTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                    ...
                    if not userInfo[address(msg.sender)].field_0:
                        ...
                        if not raisingAmount:
                            ...
                            if not ext_code.hash(offeringTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[708 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, 0 / totalAmount / 10^6 * offeringAmount / 10^6) >> 32
                            call offeringTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
            ...
            if not offeringAmount:
                ...
                if totalAmount <= raisingAmount:
                    ...
                    if not ext_code.hash(offeringTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, 10^12 * userInfo[address(msg.sender)].field_0 / totalAmount / 10^6 * offeringAmount / 10^6) >> 32
                    call offeringTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                    ...
                    if not userInfo[address(msg.sender)].field_0:
                        ...
                        if not raisingAmount:
                            ...
                            if not ext_code.hash(offeringTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[708 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, 10^12 * userInfo[address(msg.sender)].field_0 / totalAmount / 10^6 * offeringAmount / 10^6) >> 32
                            call offeringTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
