...
function sub_fb801972(?) payable {
    ...
    call sub_d56022d7Address.0xf242432a with:
         gas gas_remaining wei
        args this.address, address(arg2), tokenId, arg1, Array(len=arg3.length, data=arg3[all])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0x93f7ac0b: arg1, msg.sender, address(arg2), Array(len=arg3.length, data=arg3[all])
}
