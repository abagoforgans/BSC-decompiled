...
#  - _fallback()
#
const name = 'Whale King', 0

const decimals = 18

const symbol = 'WhaleKing', 0
...
uint256 stor54; offset 16
address routerAddress;
address pairAddress;
uint256 launchedAt;
uint8 tradingOpen;
uint8 swapEnabled; offset 8
uint8 stor59; offset 16
...
function setAutoBuybackSettings(bool arg1, uint256 arg2, uint256 arg3, uint256 arg4, bool arg5) {
    ...
    Mask(248, 0, stor46.field_8) = Mask(248, 0, arg5)
    Mask(240, 0, stor46.field_16) = Mask(240, 16, arg1) >> 16
}
...
function setBuyFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    if arg4 < 0:
        revert with 0, 'SafeMath: addition overflow'
    if arg1 + arg2 + arg3 + arg4 > !stor24:
        revert with 0, 17
    if stor24 < 0:
        revert with 0, 'SafeMath: addition overflow'
    stor25 = arg1 + arg2 + arg3 + arg4 + stor24
    stor38 = arg5
}
...
function setSellFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    if arg4 < 0:
        revert with 0, 'SafeMath: addition overflow'
    if arg1 + arg2 + arg3 + arg4 > !stor30:
        revert with 0, 17
    if stor30 < 0:
        revert with 0, 'SafeMath: addition overflow'
    stor31 = arg1 + arg2 + arg3 + arg4 + stor30
    stor38 = arg5
}
...
function getMultipliedFee() {
    ...
    if not stor37:
        ...
        if not stor45:
            revert with 0, 'SafeMath: division by zero', 0
        if stor37 > !((stor44 * 0 / stor43) + (stor45 * 0 / stor43) - (block.timestamp * 0 / stor43) - (stor44 * stor37) - (stor45 * stor37) + (block.timestamp * stor37) / stor45):
            revert with 0, 17
    ...
    if not stor45:
        revert with 0, 'SafeMath: division by zero', 0
    if stor37 > !((stor44 * stor37 * stor42 / stor43) + (stor45 * stor37 * stor42 / stor43) - (block.timestamp * stor37 * stor42 / stor43) - (stor44 * stor37) - (stor45 * stor37) + (block.timestamp * stor37) / stor45):
        revert with 0, 17
