...
function sub_40482946(?) payable {
    ...
    mem[(32 * arg3.length) + 224 len 4] = Mask(32, 224, sha3('getAmountsOut(uint256,address[])')) >> 224
    ...
    mem[(64 * arg3.length) + 388 len floor32((32 * arg3.length) + 100)] = Mask(32, 224, sha3('getAmountsOut(uint256,address[])')) >> 224, arg2, 64, mem[(32 * arg3.length) + 292 len floor32((32 * arg3.length) + 100) - 68]
