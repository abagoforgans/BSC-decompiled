...
function earn() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        call tokenAddress with:
           funct uint32(stor9)
             gas gas_remaining wei
            args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), 0) << 256, mem[324 len 4]
        ...
        if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
            revert with 0, 'SafeERC20: call to non-contract'
        mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
        call tokenAddress with:
           funct uint32(stor9)
             gas gas_remaining wei
        ...
        if not totalSupply:
            ...
            if ext_call.return_data[0] > earnLowerlimit:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[456 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                    call tokenAddress with:
                       funct uint32(stor9)
                         gas gas_remaining wei
            ...
            if ext_call.return_data[0] > earnLowerlimit:
                ...
                if not ext_call.return_data[0]:
                    ...
                    call tokenAddress with:
                       funct uint32(stor9)
                         gas gas_remaining wei
                        args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), 0) << 256, mem[584 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[520 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                    call tokenAddress with:
                       funct uint32(stor9)
                         gas gas_remaining wei
            ...
            if not totalSupply:
                ...
                if ext_call.return_data[0] > earnLowerlimit:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                            revert with 0, 'SafeERC20: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
                ...
                if ext_call.return_data[0] > earnLowerlimit:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        call tokenAddress with:
                           funct uint32(stor9)
                             gas gas_remaining wei
                            args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), 0) << 256, mem[ceil32(return_data.size) + 585 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                            revert with 0, 'SafeERC20: call to non-contract'
                        mem[ceil32(return_data.size) + 521 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), Mask(224, 32, ext_call.return_data[0] * min / 10000) >> 32
