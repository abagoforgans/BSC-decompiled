...
function withdraw(uint256 arg1) payable {
    ...
    if arg1 > ext_call.return_data[0]:
        ...
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[324 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor7), uint32(stor7), Mask(224, 0, stor11.field_32)
        call wantAddress with:
           funct uint32(stor7)
             gas gas_remaining wei
...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if not wantLockedTotal:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 31, ext_call.return_data[0]) >> 31
            mem[520 len 0] = 0
            call wantAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
        ...
        if not arg1:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[520 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 31, ext_call.return_data[0]) >> 31
            call wantAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
    ...
    if not return_data.size:
        if not wantLockedTotal:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 457 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 31, ext_call.return_data[0]) >> 31
        ...
        if not arg1:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 521 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 31, ext_call.return_data[0]) >> 31
