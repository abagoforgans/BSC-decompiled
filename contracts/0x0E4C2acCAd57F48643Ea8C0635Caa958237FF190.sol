...
uint8 decimals;
address sub_442ca6bfAddress; offset 8
...
function sub_442ca6bf(?) payable {
    return sub_442ca6bfAddress
}
...
function leave(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(sub_442ca6bfAddress)
    staticcall sub_442ca6bfAddress.0x70a08231 with:
    ...
    if not arg1:
        ...
        require ext_code.size(sub_442ca6bfAddress)
        call sub_442ca6bfAddress.0xa9059cbb with:
             gas gas_remaining wei
...
function enter(uint256 arg1) payable {
    ...
    require ext_code.size(sub_442ca6bfAddress)
    call sub_442ca6bfAddress.0x23b872dd with:
         gas gas_remaining wei
