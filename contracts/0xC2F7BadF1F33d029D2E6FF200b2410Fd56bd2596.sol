...
function add(address arg1, uint256 arg2, bool arg3) {
...
function scheduleSet(address arg1, uint256 arg2, uint256 arg3, bool arg4, bytes32 arg5, bytes32 arg6) {
    ...
    if block.timestamp + stor3 < block.timestamp:
        revert with 0, 'SafeMath: addition overflow'
    timestamp[address(arg1)][arg2][arg3][arg4][arg5][arg6] = block.timestamp + stor3
    emit SetScheduled(arg2, arg3, arg4, arg5, stor3, sha3(address(arg1), arg2, arg3, arg4, arg5, arg6), 0);
}
        ...
        if not arg4:
            ...
            while idx < arg1.length:
                ...
                call address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                   value cd[((32 * idx) + arg2 + 36)] wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _300 + cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)] + -mem[64] - 4]
                if return_data.size:
                    _308 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
