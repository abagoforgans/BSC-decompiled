...
function substring(string arg1, uint256 arg2, uint256 arg3) {
    ...
    if not arg3 - arg2:
        ...
        return 32, mem[mem[64] + 32 len floor32(_31) + 64]
    mem[ceil32(arg1.length) + 160 len arg3 - arg2] = code.data[12696 len arg3 - arg2]
    idx = arg2
    while idx < arg3:
        require idx < mem[96]
        require idx - arg2 < mem[ceil32(arg1.length) + 128]
...
function sub_d8c981a3(?) {
    ...
    mem[arg1.length + ceil32(arg1.length) + 192 len 2] = code.data[12696 len 2]
    idx = 0
    while idx < 2:
        require idx < arg1.length
        require idx < 2
...
function sub_a8cc80db(?) payable {
    ...
    if not arg1:
        ...
        if 5 * 10^18 * arg1 / arg1 != 5 * 10^18:
            revert with 0, 'err3 error'
        if not totalSupply:
            revert with 0, 'err4 error'
        if (5 * 10^18 * arg1 / 1000 / totalSupply) + sub_c1006679 < sub_c1006679:
            revert with 0, 'err5 error'
        sub_c1006679 += 5 * 10^18 * arg1 / 1000 / totalSupply
    stor0 = 1
    return 1
}
