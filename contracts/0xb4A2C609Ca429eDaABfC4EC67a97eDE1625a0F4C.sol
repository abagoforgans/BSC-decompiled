...
const name = 'Arachnida', 0

const decimals = 9

const symbol = 'Arachnida', 0
...
function deliver(address arg1, uint256 arg2) {
    ...
    if balanceOf[address(arg1)]:
        if balanceOf[address(arg1)] and arg2 > -1 / balanceOf[address(arg1)]:
            revert with 0, 17
        if balanceOf[address(arg1)] * arg2 > -1:
            revert with 0, 17
        if not balanceOf[address(arg1)]:
            revert with 0, 18
        if balanceOf[address(arg1)] * arg2 / balanceOf[address(arg1)] != arg2:
...
function transfer(address arg1, uint256 arg2) {
    ...
    if 5 * 10^9 <= balanceOf[this.address]:
        if not stor13:
            if uniswapV2PairAddress != msg.sender:
                if owner != msg.sender:
                    if owner != arg1:
...
function _fallback() payable {
    ...
    if unknown_0x6bc87c3a(?????) <= uint32(call.func_hash) >> 224:
        if unknown_0x95d89b41(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x73fee090(?????) <= uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != unknown_0x73fee090(?????):
        ...
        if unknown_0x313ce567(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0x3a537b0c(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x313ce567(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return 9
                if unknown_0x333c39a5(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 32
                    if owner != msg.sender:
                        revert with 0, 'Ownable: caller is not the owner'
                ...
                emit Approval((allowance[msg.sender][address(arg1)] + arg2), msg.sender, address(arg1));
                return 1
            if uint32(call.func_hash) >> 224 != unknown_0x3a537b0c(?????):
        ...
        if approve(address arg1, uint256 arg2) == uint32(call.func_hash) >> 224:
            ...
            if unknown_0x18160ddd(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return totalSupply
            if unknown_0x22976e0d(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return _marketingFee
