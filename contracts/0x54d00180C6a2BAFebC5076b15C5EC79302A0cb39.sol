...
#  - farm(bool arg1)
#  - earn()
#  - rebalance(uint256 arg1, uint256 arg2)
...
const AUTOAddress = 0x2099a8bfe7487455a26341d1ddaf2d1fcab62a85

const venusDistributionAddress = 0xfd36e2c2a6789db23113685031d7f16329158384
...
const earnedAddress = 0xcf6bb5389c92bdda8a3747ddb454cb7a64626c63

const entranceFeeFactorMax = 10000

const autoFarmAddress = 0x25f9b77ef2d13d16fd0f5bdb3f84df82ba00a89e

const BORROW_RATE_MAX = 595

const BORROW_RATE_MAX_HARD = 599

const BORROW_DEPTH_MAX = 6

const MIN_LEVERAGE_AMOUNT = 10^11
...
function vTokenAddress() {
    return address(vTokenAddress)
}
...
function updateBalance() {
    require ext_code.size(address(vTokenAddress))
    call address(vTokenAddress).balanceOfUnderlying(address rg1) with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(address(vTokenAddress))
    call address(vTokenAddress).borrowBalanceCurrent(address rg1) with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not borrowBal:
        ...
        require borrowRate
        supplyBalTargeted = 0 / borrowRate
    else:
        require borrowBal
        ...
        if borrowRate <= 0:
            revert with 0, 'SafeMath: division by zero'
        require borrowRate
        supplyBalTargeted = 1000 * borrowBal / borrowRate
    if not borrowBal:
        supplyBalMin = 0
    else:
        require borrowBal
        ...
        supplyBalMin = 1000 * borrowBal / 599
}
...
function inCaseTokensGetStuck(address arg1, uint256 arg2, address arg3) {
    ...
    if govAddress != msg.sender:
        revert with 0, '!gov'
    if arg1 == 0xcf6bb5389c92bdda8a3747ddb454cb7a64626c63:
        revert with 0, '!safe'
    if arg1 == wantAddress:
        revert with 0, '!safe'
    if arg1 == address(vTokenAddress):
        revert with 0, '!safe'
    if eth.balance(this.address) < 0:
...
function deleverageOnce() {
    ...
    if supplyBal > supplyBalTargeted:
        if supplyBalTargeted > supplyBal:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(address(vTokenAddress))
        call address(vTokenAddress).redeemUnderlying(uint256 rg1) with:
             gas gas_remaining wei
            args (supplyBal - supplyBalTargeted)
    else:
        if supplyBalMin > supplyBal:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(address(vTokenAddress))
        call address(vTokenAddress).redeemUnderlying(uint256 rg1) with:
             gas gas_remaining wei
    ...
    if not uint8(stor0.field_168):
        require ext_code.size(address(vTokenAddress))
        call address(vTokenAddress).repayBorrow(uint256 rg1) with:
             gas gas_remaining wei
            args ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require ext_code.size(address(vTokenAddress))
        if uint8(stor0.field_168):
            call address(vTokenAddress).repayBorrow() with:
               value eth.balance(this.address) + ext_call.return_data[0] wei
                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        else:
...
function pause() {
    ...
    if not return_data.size:
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0
        ...
        if not return_data.size:
            ...
            if not uint8(stor0.field_168):
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[588 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2), uint32(stor2), 0
                call wantAddress with:
                   funct uint32(stor2)
                     gas gas_remaining wei
            ...
            if not uint8(stor0.field_168):
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 589 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2), uint32(stor2), 0
                call wantAddress with:
                   funct uint32(stor2)
                     gas gas_remaining wei
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0
        ...
        if not return_data.size:
            ...
            if not uint8(stor0.field_168):
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 590 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2), uint32(stor2), Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, 0) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
                call wantAddress with:
...
function unpause() {
    ...
    if not return_data.size:
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call wantAddress with:
           funct uint32(stor4)
             gas gas_remaining wei
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        mem[ceil32(return_data.size) + 517 len 4] = 0
        call wantAddress with:
           funct uint32(stor4)
             gas gas_remaining wei
