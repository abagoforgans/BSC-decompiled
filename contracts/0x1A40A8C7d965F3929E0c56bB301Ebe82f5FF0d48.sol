...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if not wantLockedTotal:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = 0, address(farmContractAddress), ext_call.return_data[0 len 28]
            call wantAddress with:
               funct uint32(stor3)
                 gas gas_remaining wei
        ...
        if not arg1:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[520 len 64] = 0, address(farmContractAddress), ext_call.return_data[0 len 28]
            call wantAddress with:
               funct uint32(stor3)
                 gas gas_remaining wei
        ...
        if not return_data.size:
            if not wantLockedTotal:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = 0, address(farmContractAddress), ext_call.return_data[0 len 28]
            ...
            if arg1:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 521 len 64] = 0, address(farmContractAddress), ext_call.return_data[0 len 28]
