...
function getClaimAmount(uint256 arg1) payable {
    ...
    if block.timestamp < sub_893a5771[arg1].field_0:
        return 0
    if sub_893a5771[arg1].field_0 < 60:
        revert with 0, 17
    if block.timestamp < sub_893a5771[arg1].field_0 - 60:
        revert with 0, 17
    if block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60 >= sub_893a5771[arg1].field_512:
        if sub_893a5771[arg1].field_256 < sub_893a5771[arg1].field_768:
            revert with 0, 17
        return (sub_893a5771[arg1].field_256 - sub_893a5771[arg1].field_768)
    if block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60 < sub_893a5771[arg1].field_528:
        revert with 0, 17
    if 100 < rate:
        revert with 0, 17
    ...
    if not sub_893a5771[arg1].field_512:
        revert with 0, 18
    if uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) and (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512 > -1 / uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528):
        revert with 0, 17
    return (uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) * (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512)
}
...
function claimVestedTokens(uint256 arg1) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    if not sub_893a5771[arg1].field_256:
        if sub_cdaf9975 > 1092:
            revert with 0, 17
        if block.timestamp > !uint16(60 * sub_cdaf9975):
            revert with 0, 17
        if ext_call.return_data[96] and rate > -1 / ext_call.return_data[96]:
            revert with 0, 17
        sub_893a5771[arg1].field_0 = block.timestamp + uint16(60 * sub_cdaf9975)
    ...
    if block.timestamp >= sub_893a5771[arg1].field_0:
        ...
        if block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60 >= sub_893a5771[arg1].field_512:
            ...
            if uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) and (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512 > -1 / uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528):
                revert with 0, 17
            if uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) * (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512:
                if sub_893a5771[arg1].field_528 > !uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528):
                    revert with 0, 17
                sub_893a5771[arg1].field_528 = uint16(sub_893a5771[arg1].field_528 + uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528))
                if sub_893a5771[arg1].field_768 > !(uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) * (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512):
                    revert with 0, 17
                sub_893a5771[arg1].field_768 += uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) * (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512
                require ext_code.size(tokenAddress)
                call tokenAddress.0xa9059cbb with:
                     gas gas_remaining wei
                    args address(ext_call.return_data[0]), uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) * (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                if not ext_call.return_data[0]:
                    revert with 0, 'no tokens'
                emit 0x5e14852d: address(ext_call.return_data[0]), uint16((block.timestamp + -sub_893a5771[arg1].field_0 + 60 / 60) - sub_893a5771[arg1].field_528) * (100 * sub_893a5771[arg1].field_256) - (rate * sub_893a5771[arg1].field_256) / 100 / sub_893a5771[arg1].field_512, arg1
}
