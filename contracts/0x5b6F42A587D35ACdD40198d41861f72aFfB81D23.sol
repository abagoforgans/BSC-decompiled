...
function stake(uint256 arg1, bytes arg2) payable {
    ...
    if totalStakingShares <= 0:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require (stor14 * arg1) + stor15[address(msg.sender)].field_0 >= stor15[address(msg.sender)].field_0
        stor15[address(msg.sender)].field_0 += stor14 * arg1
        stor15[address(msg.sender)].field_512 = block.timestamp
        stor16[address(msg.sender)].field_0++
        stor16[address(msg.sender)][stor16[address(msg.sender)].field_0].field_0 = stor14 * arg1
        stor16[address(msg.sender)][stor16[address(msg.sender)].field_0].field_256 = block.timestamp
        require (stor14 * arg1) + totalStakingShares >= totalStakingShares
        totalStakingShares += stor14 * arg1
    else:
        require ext_code.size(stakingTokenAddress)
        staticcall stakingTokenAddress.0x70a08231 with:
                gas gas_remaining wei
        ...
        if not totalStakingShares:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (0 / ext_call.return_data[0]) + stor15[address(msg.sender)].field_0 >= stor15[address(msg.sender)].field_0
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (arg1 * totalStakingShares / ext_call.return_data[0]) + stor15[address(msg.sender)].field_0 >= stor15[address(msg.sender)].field_0
            stor15[address(msg.sender)].field_0 += arg1 * totalStakingShares / ext_call.return_data[0]
            stor15[address(msg.sender)].field_512 = block.timestamp
            stor16[address(msg.sender)].field_0++
            stor16[address(msg.sender)][stor16[address(msg.sender)].field_0].field_0 = arg1 * totalStakingShares / ext_call.return_data[0]
            stor16[address(msg.sender)][stor16[address(msg.sender)].field_0].field_256 = block.timestamp
    ...
    if totalStakingShares <= 0:
        ...
        if not ext_call.return_data[0]:
            ...
            require stor15[address(msg.sender)].field_0 * ext_call.return_data[0] / ext_call.return_data[0] == stor15[address(msg.sender)].field_0
            require totalStakingShares > 0
            require totalStakingShares
            emit Staked(address rg1, uint256 rg2, uint256 rg3, bytes rg4):
                        arg1,
                        stor15[address(msg.sender)].field_0 * ext_call.return_data[0] / totalStakingShares,
                        96,
                        0,
                        mem[352],
                        msg.sender,
