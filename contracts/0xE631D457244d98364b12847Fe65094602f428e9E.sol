...
function swapETH(address arg1, uint256 arg2) payable {
    ...
    require return_data.size >= 32
    _126 = mem[320 len 4], Mask(224, 32, msg.value) >> 32
    ...
    if mem[(32 * _129) + (2 * ceil32(return_data.size)) + 416] > msg.value:
        require 2 < mem[ceil32(return_data.size) + 320]
        ...
        mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 452] = msg.sender
        mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 484] = arg2
        ...
        call stor0.swapExactETHForTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
           value msg.value wei
             gas gas_remaining wei
            args _443, Array(len=3, data=mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 548 len 96]), msg.sender, arg2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[(32 * _544) + (32 * _346) + (32 * _129) + (4 * ceil32(return_data.size)) + 516] = msg.sender
        mem[(32 * _544) + (32 * _346) + (32 * _129) + (4 * ceil32(return_data.size)) + 548] = arg2
        ...
        call stor0.swapExactTokensForETH(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args _613, _615, Array(len=2, data=mem[(32 * _544) + (32 * _346) + (32 * _129) + (4 * ceil32(return_data.size)) + 612 len 64]), msg.sender, arg2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 448] = arg1
        mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 480] = 3
        mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 512] = arg1
        ...
        mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 612] = msg.value
        ...
        staticcall stor0.getAmountsOut(uint256 rg1, address[] rg2) with:
                gas gas_remaining wei
               args msg.value, Array(len=2, data=mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 708 len 64])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        _537 = mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608 len 4], Mask(224, 32, msg.value) >> 32
        require mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608 len 4], Mask(224, 32, msg.value) >> 32 <= 4294967296
        require mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608 len 4], Mask(224, 32, msg.value) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608 len 4], Mask(224, 32, msg.value) >> 32 + (32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608] <= 4294967296 and mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608 len 4], Mask(224, 32, msg.value) >> 32 + (32 * mem[mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608 len 4], Mask(224, 32, msg.value) >> 32 + (32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608]) + 32 <= return_data.size
        mem[(32 * _346) + (32 * _129) + (4 * ceil32(return_data.size)) + 608] = mem[mem[(32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608 len 4], Mask(224, 32, msg.value) >> 32 + (32 * _346) + (32 * _129) + (2 * ceil32(return_data.size)) + 608]
        ...
        if mem[(32 * _543) + (32 * _346) + (32 * _129) + (6 * ceil32(return_data.size)) + 736] > msg.value:
            require 1 < mem[(32 * _346) + (32 * _129) + (4 * ceil32(return_data.size)) + 608]
            ...
            mem[(32 * _677) + (32 * _543) + (32 * _346) + (32 * _129) + (6 * ceil32(return_data.size)) + 740] = msg.sender
            mem[(32 * _677) + (32 * _543) + (32 * _346) + (32 * _129) + (6 * ceil32(return_data.size)) + 772] = arg2
            ...
            call stor0.swapExactETHForTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
               value msg.value wei
                 gas gas_remaining wei
                args _716, Array(len=2, data=mem[(32 * _677) + (32 * _543) + (32 * _346) + (32 * _129) + (6 * ceil32(return_data.size)) + 836 len 64]), msg.sender, arg2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[(32 * _749) + (32 * _677) + (32 * _543) + (32 * _346) + (32 * _129) + (7 * ceil32(return_data.size)) + 804] = msg.sender
            mem[(32 * _749) + (32 * _677) + (32 * _543) + (32 * _346) + (32 * _129) + (7 * ceil32(return_data.size)) + 836] = arg2
            ...
            call stor0.swapExactTokensForETH(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args mem[(32 * _346) + (32 * _129) + (4 * ceil32(return_data.size)) + 672], _770, Array(len=3, data=mem[(32 * _749) + (32 * _677) + (32 * _543) + (32 * _346) + (32 * _129) + (7 * ceil32(return_data.size)) + 900 len 96]), msg.sender, arg2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
