...
function sub_fb6efac7(?) {
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    if sub_b98fb234:
        revert with 0, 'Already Named'
    mem[128 len 33] = 0xfe5553204465657020537061636520436c696d617465204f627365727661746f72
    ...
    if bool(stor6.length):
        ...
        stor6.length.field_8 = 'DSCOVR' / 256
        idx = 0
