...
#
const _totalSupply = 16000

const sub_d28f6afc(?) = 1024
...
function pause() payable {
    ...
    emit 0x9b597f36: 96, 160, block.timestamp, 14, 'Open Function ', 5, 'pause', 1000, msg.sender
}
...
function unpause() payable {
    ...
    emit 0x9b597f36: 96, 160, block.timestamp, 15, 'Close function ', 7, 'unpause', 1001, msg.sender
}
...
function safeMint(address arg1, string arg2) payable {
    ...
    stor13++
    if stor13 >= 16000:
        revert with 0, 'F3NFT: tokenId not less than total supply'
    if not arg1:
    ...
    if stor10[stor13].field_0:
        if stor10[stor13].field_0 == stor10[stor13].field_1 < 32:
            revert with 'NH{q', 34
        if arg2.length:
            stor10[stor13][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
