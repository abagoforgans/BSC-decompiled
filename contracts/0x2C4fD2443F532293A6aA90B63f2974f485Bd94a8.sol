    ...
    if ext_call.return_data[0] >= arg1:
        if not withdrawalFee:
            ...
            if not arg1:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), Mask(224, 32, ext_call.return_data[0] - (withdrawalFee * arg1 / 10000)) >> 32
                call wantAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
        ...
        if not withdrawalFee:
            ...
            if not arg1:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), Mask(224, 32, ext_call.return_data[0] - (withdrawalFee * arg1 / 10000)) >> 32
                mem[516 len 0] = 0
                call wantAddress with:
                   funct uint32(stor6)
                     gas gas_remaining wei
