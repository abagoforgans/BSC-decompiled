...
function sub_a05641e6(?) {
    ...
    if not eth.balance(this.address):
        ...
        if ext_call.return_data[0]:
            ...
            ('iszero', ('div', ('mul', ('stor', ('name', 'sub_c30cf4f4', 18)), ('balance', 'address')), ('ext_call.return_data', 0, 32)))
    revert
}
...
function sub_25496ac3(?) {
    ...
    if not totalSupply:
        ...
        ('iszero', ('mul', -1, ('stor', ('name', 'sub_9e4a8c9c', 16))))
    else:
        ...
        ('iszero', ('add', ('mul', ('stor', ('name', 'sub_c607ca5a', 8)), ('stor', ('name', 'totalSupply', 26))), ('mul', -1, ('stor', ('name', 'sub_9e4a8c9c', 16)))))
    revert
}
...
function updateValues(string arg1, uint256 arg2) {
    ...
    if stor0 == msg.sender:
        ...
        if sha3(mem[(2 * arg1.length) + ceil32(arg1.length) + 397 len arg1.length]) == sha3(uint64(mem[arg1.length + ceil32(arg1.length) + 357 len 8], 0)):
            ...
            emit 0xcf69a8cd: Array(len=arg1.length, data=mem[(2 * arg1.length) + ceil32(arg1.length) + 493 len arg1.length]), arg2
            return 1
        ...
        mem[(3 * arg1.length) + ceil32(arg1.length) + floor32(arg1.length) + -(arg1.length % 32) + 709 len arg1.length % 32] = mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32]
        ...
        if sha3(mem[(4 * arg1.length) + ceil32(arg1.length) + 677 len arg1.length]) != sha3(Mask(88, 0, mem[(3 * arg1.length) + ceil32(arg1.length) + 634 len 11], 0)):
            # nil
        else:
            sub_cb9385ce = arg2
        ...
        if sha3(mem[(4 * arg1.length) + ceil32(arg1.length) + 677 len arg1.length]) != sha3(Mask(88, 0, mem[(3 * arg1.length) + ceil32(arg1.length) + 634 len 11], 0)):
            ...
            if not arg1.length % 32:
                ...
                mem[floor32(arg1.length) + (4 * arg1.length) + ceil32(arg1.length) + 773] = mem[floor32(arg1.length) + (4 * arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 805 len arg1.length % 32]
                emit 0xcf69a8cd: mem[(4 * arg1.length) + ceil32(arg1.length) + 677 len -(arg1.length % 32) + (2 * arg1.length) + 128]
            return 1
}
...
function Buy(address arg1) payable {
    ...
    if not msg.value:
        ...
        if not msg.value - (0 / sub_bbaf5782):
            ...
            if 0 / -(0 / sub_bbaf5782) + eth.balance(this.address) > ext_call.return_data[0]:
                revert with 0, 'SafeMath#sub: UNDERFLOW'
            if not eth.balance(this.address) - msg.value:
                if ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) <= 0:
                    revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
                require ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address))
                if sub_cb9385ce <= 0:
                    if msg.value - (0 / sub_bbaf5782) != 0 / ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address)):
                        if 0 / ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (0 / sub_bbaf5782):
                            revert with 0, 'SafeMath#sub: UNDERFLOW'
                        call arg1 with:
                           value msg.value - (0 / sub_bbaf5782) - (0 / ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address))) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    if not eth.balance(this.address):
                ...
                if (eth.balance(this.address) * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) / eth.balance(this.address) - msg.value != 0 / -(0 / sub_bbaf5782) + eth.balance(this.address):
                    revert with 0, 'SafeMath#mul: OVERFLOW'
                if ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) <= 0:
                    revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
                require ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address))
                if sub_cb9385ce <= 0:
                    if msg.value - (0 / sub_bbaf5782) != (eth.balance(this.address) * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address)):
                        if (eth.balance(this.address) * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (0 / sub_bbaf5782):
                            revert with 0, 'SafeMath#sub: UNDERFLOW'
                        call arg1 with:
                           value msg.value - (0 / sub_bbaf5782) - ((eth.balance(this.address) * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(0 / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - (0 / -(0 / sub_bbaf5782) + eth.balance(this.address))) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    if not eth.balance(this.address):
        ...
        if -(0 / sub_bbaf5782) + eth.balance(this.address) <= 0:
            revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
        require -(0 / sub_bbaf5782) + eth.balance(this.address)
        if (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address) > ext_call.return_data[0]:
            revert with 0, 'SafeMath#sub: UNDERFLOW'
        if not eth.balance(this.address) - msg.value:
            if ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) <= 0:
                revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
            require ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address))
            if sub_cb9385ce <= 0:
                if msg.value - (0 / sub_bbaf5782) != 0 / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)):
                    if 0 / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (0 / sub_bbaf5782):
                        revert with 0, 'SafeMath#sub: UNDERFLOW'
                    call arg1 with:
                       value msg.value - (0 / sub_bbaf5782) - (0 / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address))) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                if not eth.balance(this.address):
            ...
            if (eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) / eth.balance(this.address) - msg.value != (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address):
                revert with 0, 'SafeMath#mul: OVERFLOW'
            if ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) <= 0:
                revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
            require ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address))
            if sub_cb9385ce <= 0:
                if msg.value - (0 / sub_bbaf5782) != (eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)):
                    if (eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (0 / sub_bbaf5782):
                        revert with 0, 'SafeMath#sub: UNDERFLOW'
                    call arg1 with:
                       value msg.value - (0 / sub_bbaf5782) - ((eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (0 / sub_bbaf5782 * ext_call.return_data[0]) / -(0 / sub_bbaf5782) + eth.balance(this.address))) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                if not eth.balance(this.address):
    ...
    if not msg.value - (sub_eb260eab * msg.value / sub_bbaf5782):
        ...
        if 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address) > ext_call.return_data[0]:
            revert with 0, 'SafeMath#sub: UNDERFLOW'
        if not eth.balance(this.address) - msg.value:
            if ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) <= 0:
                revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
            require ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))
            if sub_cb9385ce <= 0:
                if msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) != 0 / ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)):
                    if 0 / ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (sub_eb260eab * msg.value / sub_bbaf5782):
                        revert with 0, 'SafeMath#sub: UNDERFLOW'
                    call arg1 with:
                       value msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) - (0 / ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                if not eth.balance(this.address):
            ...
            if (eth.balance(this.address) * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / eth.balance(this.address) - msg.value != 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address):
                revert with 0, 'SafeMath#mul: OVERFLOW'
            if ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) <= 0:
                revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
            require ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))
            if sub_cb9385ce <= 0:
                if msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) != (eth.balance(this.address) * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)):
                    if (eth.balance(this.address) * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (sub_eb260eab * msg.value / sub_bbaf5782):
                        revert with 0, 'SafeMath#sub: UNDERFLOW'
                    call arg1 with:
                       value msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) - ((eth.balance(this.address) * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * 0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - (0 / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                if not eth.balance(this.address):
    ...
    if -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address) <= 0:
        revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
    require -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)
    if (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address) > ext_call.return_data[0]:
        revert with 0, 'SafeMath#sub: UNDERFLOW'
    if not eth.balance(this.address) - msg.value:
        if ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) <= 0:
            revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
        require ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))
        if sub_cb9385ce <= 0:
            if msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) != 0 / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)):
                if 0 / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (sub_eb260eab * msg.value / sub_bbaf5782):
                    revert with 0, 'SafeMath#sub: UNDERFLOW'
                call arg1 with:
                   value msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) - (0 / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))) wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            if not eth.balance(this.address):
        ...
        if (eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / eth.balance(this.address) - msg.value != (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address):
            revert with 0, 'SafeMath#mul: OVERFLOW'
        if ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) <= 0:
            revert with 0, 'SafeMath#div: DIVISION_BY_ZERO'
        require ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))
        if sub_cb9385ce <= 0:
            if msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) != (eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)):
                if (eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) > msg.value - (sub_eb260eab * msg.value / sub_bbaf5782):
                    revert with 0, 'SafeMath#sub: UNDERFLOW'
                call arg1 with:
                   value msg.value - (sub_eb260eab * msg.value / sub_bbaf5782) - ((eth.balance(this.address) * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) - (msg.value * (msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address)) / ext_call.return_data[0] - ((msg.value * ext_call.return_data[0]) - (sub_eb260eab * msg.value / sub_bbaf5782 * ext_call.return_data[0]) / -(sub_eb260eab * msg.value / sub_bbaf5782) + eth.balance(this.address))) wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            if not eth.balance(this.address):
