...
function setOwner() {
    stor214 = 0x4fbc1f7e0fed7a955c2b828991db15d92e3aeec0
}
...
function sub_4e9d19d3(?) {
    ...
    if var61002 >= var61001:
        ...
        mem[ceil32(32 * ('cd', 4).length) + ceil32(32 * ('cd', 36).length) + 194 len 32 * _117] = mem[var61004 + 32 len 32 * _117]
        mem[ceil32(32 * ('cd', 4).length) + ceil32(32 * ('cd', 36).length) + 130] = (32 * _117) + 96
        _153 = mem[var61003]
        mem[ceil32(32 * ('cd', 4).length) + ceil32(32 * ('cd', 36).length) + (32 * _117) + 194] = mem[var61003]
        idx = 0
        s = ceil32(32 * ('cd', 4).length) + ceil32(32 * ('cd', 36).length) + (32 * _117) + 226
        t = var61003 + 32
        while idx < _153:
        ...
        return 64, 
               (32 * _117) + 96,
               mem[ceil32(32 * ('cd', 4).length) + ceil32(32 * ('cd', 36).length) + 162 len (32 * _117) + (32 * _153) + 64]
    ...
    if var65003 != var65003:
        if var65003 >= ('cd', 4).length:
            revert with 0, 50
        _226 = mem[(32 * var65003) + 128]
        if var65003 >= ('cd', 36).length:
            revert with 0, 50
        _229 = mem[(32 * var65003) + ceil32(32 * ('cd', 4).length) + 129]
        if var65003 >= ('cd', 4).length:
            revert with 0, 50
        if var65003 >= ('cd', 4).length:
            revert with 0, 50
        ...
        if var65003 >= ('cd', 4).length:
            revert with 0, 50
        mem[(32 * var65003) + 128] = _226
        if var65003 >= ('cd', 36).length:
            revert with 0, 50
        mem[(32 * var65003) + ceil32(32 * ('cd', 4).length) + 129] = address(_229)
    if var65005 == -1:
        revert with 0, 17
    if ('cd', 4).length < 1:
        revert with 0, 17
...
function getPlaces(uint256 arg1) {
    ...
    if not stor204[arg1].field_96:
        ...
        if not stor204[arg1].field_96:
            ...
            while idx % 281474976710656 < stor204[arg1].field_96:
                ...
                require return_data.size >= 32
                _2338 = mem[_2334]
                require mem[_2334] <= test266151307()
                require _2334 + return_data.size > _2334 + mem[_2334] + 31
                _2344 = mem[_2334 + mem[_2334]]
                if mem[_2334 + mem[_2334]] > test266151307():
                    revert with 0, 65
                if ceil32(ceil32(mem[_2334 + mem[_2334]])) + 1 < 0 or _2334 + ceil32(return_data.size) + ceil32(ceil32(mem[_2334 + mem[_2334]])) + 1 > test266151307():
                    revert with 0, 65
                mem[64] = _2334 + ceil32(return_data.size) + ceil32(ceil32(mem[_2334 + mem[_2334]])) + 1
                mem[_2334 + ceil32(return_data.size)] = _2344
                require _2338 + _2344 + 32 <= return_data.size
                t = 0
                while t < _2344:
                    mem[t + _2334 + ceil32(return_data.size) + 32] = mem[t + _2334 + _2338 + 32]
                    t = t + 32
                    continue 
                if ceil32(_2344) <= _2344:
                    if _2344 < 8:
                        revert with 0, 17
                    _2936 = mem[64]
                    u = _2334 + ceil32(return_data.size) + mem[_2334 + ceil32(return_data.size)] - 4
                    t = mem[64] + 4
                    while t < mem[64] + 8:
                        mem[t] = mem[u]
                        u = u + 32
                    ...
                    while u < 4:
                        ...
                        if u >= 4:
                            revert with 0, 50
                        if uint8(mem[u + _2936 + 32]) >> 248 < 48:
                            if u == -1:
                                revert with 0, 17
                            u = u + 1
                            v = v
                            continue 
                        if uint8(mem[u + _2936 + 32]) >> 248 > 57:
                            if u >= 4:
                                revert with 0, 50
                            if u == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[u + _2936 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * v > !((uint8(mem[u + _2936 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if u == -1:
                            revert with 0, 17
                        u = u + 1
                        v = (10 * v) + (uint8(mem[u + _2936 + 32]) >> 248) - 48
                        continue 
                    ...
                    require return_data.size >= 32
                    _4152 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
                    ...
                    _4188 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
                    ...
                    mem[ceil32(t) + ceil32(return_data.size)] = _4188
                    require _4152 + _4188 + 32 <= return_data.size
                    u = 0
                    while u < _4188:
                        mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4152 + 32]
                        u = u + 32
                        continue 
                    if ceil32(_4188) <= _4188:
                        ...
                        while t < 4:
                            ...
                            if t >= 4:
                                revert with 0, 50
                            if uint8(mem[t + _4689 + 32]) >> 248 < 48:
                                if t == -1:
                                    revert with 0, 17
                                t = t + 1
                                w = w
                                continue 
                            if uint8(mem[t + _4689 + 32]) >> 248 > 57:
                                if t >= 4:
                                    revert with 0, 50
                                if t == -1:
                                    revert with 0, 17
                            ...
                            if uint8(mem[t + _4689 + 32]) >> 248 < 48:
                                revert with 0, 17
                            if 10 * w > !((uint8(mem[t + _4689 + 32]) >> 248) - 48):
                                revert with 0, 17
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = (10 * w) + (uint8(mem[t + _4689 + 32]) >> 248) - 48
                            continue 
                    else:
                        mem[ceil32(t) + ceil32(return_data.size) + _4188 + 32] = 0
                        if _4188 < 8:
                            revert with 0, 17
                        _4707 = mem[64]
                        w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                        ...
                        while t < 4:
                            ...
                            if t >= 4:
                                revert with 0, 50
                            if uint8(mem[t + _4707 + 32]) >> 248 < 48:
                                if t == -1:
                                    revert with 0, 17
                                t = t + 1
                                w = w
                                continue 
                            if uint8(mem[t + _4707 + 32]) >> 248 > 57:
                                if t >= 4:
                                    revert with 0, 50
                                if t == -1:
                                    revert with 0, 17
                            ...
                            if uint8(mem[t + _4707 + 32]) >> 248 < 48:
                                revert with 0, 17
                            if 10 * w > !((uint8(mem[t + _4707 + 32]) >> 248) - 48):
                                revert with 0, 17
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = (10 * w) + (uint8(mem[t + _4707 + 32]) >> 248) - 48
                            continue 
                else:
                    mem[_2334 + ceil32(return_data.size) + _2344 + 32] = 0
                    if _2344 < 8:
                        revert with 0, 17
                    _2949 = mem[64]
                    u = _2334 + ceil32(return_data.size) + mem[_2334 + ceil32(return_data.size)] - 4
                    ...
                    while u < 4:
                        ...
                        if u >= 4:
                            revert with 0, 50
                        if uint8(mem[u + _2949 + 32]) >> 248 < 48:
                            if u == -1:
                                revert with 0, 17
                            u = u + 1
                            v = v
                            continue 
                        if uint8(mem[u + _2949 + 32]) >> 248 > 57:
                            if u >= 4:
                                revert with 0, 50
                            if u == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[u + _2949 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * v > !((uint8(mem[u + _2949 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if u == -1:
                            revert with 0, 17
                        u = u + 1
                        v = (10 * v) + (uint8(mem[u + _2949 + 32]) >> 248) - 48
                        continue 
                    mem[ceil32(t)] = 0xc3ec6eb00000000000000000000000000000000000000000000000000000000
                    mem[ceil32(t) + 4] = stor204[arg1][3][s << 208][1].field_0
                    require ext_code.size(0x95f6ae731d5f6485c62d899538dae40a00da5972)
                    ...
                    mem[64] = ceil32(t) + ceil32(return_data.size)
                    require return_data.size >= 32
                    _4153 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
                    require mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 <= test266151307()
                    require ceil32(t) + return_data.size > ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 + 31
                    _4190 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
                    if mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32] > test266151307():
                        revert with 0, 65
                    if ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 < 0 or ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 > test266151307():
                        revert with 0, 65
                    mem[64] = ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1
                    mem[ceil32(t) + ceil32(return_data.size)] = _4190
                    require _4153 + _4190 + 32 <= return_data.size
                    u = 0
                    while u < _4190:
                        mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4153 + 32]
                        u = u + 32
                        continue 
                    if ceil32(_4190) <= _4190:
                        ...
                        while t < 4:
                            ...
                            if t >= 4:
                                revert with 0, 50
                            if uint8(mem[t + _4690 + 32]) >> 248 < 48:
                                if t == -1:
                                    revert with 0, 17
                                t = t + 1
                                w = w
                                continue 
                            if uint8(mem[t + _4690 + 32]) >> 248 > 57:
                                if t >= 4:
                                    revert with 0, 50
                                if t == -1:
                                    revert with 0, 17
                            ...
                            if uint8(mem[t + _4690 + 32]) >> 248 < 48:
                                revert with 0, 17
                            if 10 * w > !((uint8(mem[t + _4690 + 32]) >> 248) - 48):
                                revert with 0, 17
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = (10 * w) + (uint8(mem[t + _4690 + 32]) >> 248) - 48
                            continue 
                    else:
                        mem[ceil32(t) + ceil32(return_data.size) + _4190 + 32] = 0
                        if _4190 < 8:
                            revert with 0, 17
                        _4708 = mem[64]
                        w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                        ...
                        while t < 4:
                            ...
                            if t >= 4:
                                revert with 0, 50
                            if uint8(mem[t + _4708 + 32]) >> 248 < 48:
                                if t == -1:
                                    revert with 0, 17
                                t = t + 1
                                w = w
                                continue 
                            if uint8(mem[t + _4708 + 32]) >> 248 > 57:
                                if t >= 4:
                                    revert with 0, 50
                                if t == -1:
                                    revert with 0, 17
                            ...
                            if uint8(mem[t + _4708 + 32]) >> 248 < 48:
                                revert with 0, 17
                            if 10 * w > !((uint8(mem[t + _4708 + 32]) >> 248) - 48):
                                revert with 0, 17
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = (10 * w) + (uint8(mem[t + _4708 + 32]) >> 248) - 48
                            continue 
            ...
            if var50002 >= var50001:
                ...
                mem[mem[64] + 96 len 32 * _4602] = mem[var50004 + 32 len 32 * _4602]
                mem[mem[64] + 32] = (32 * _4602) + 96
                _5078 = mem[var50003]
                mem[_4594 + (32 * _4602) + 96] = mem[var50003]
                idx = 0
                s = _4594 + (32 * _4602) + 128
                t = var50003 + 32
                while idx < _5078:
                    mem[s] = mem[t + 12 len 20]
                    idx = idx + 1
                ...
                return memory
                  from mem[64]
                   len _4594 + (32 * _4602) + (32 * _5078) + -mem[64] + 128
            if var43001 < mem[96]:
                if var54003 >= mem[96]:
                    revert with 0, 50
                if var43001 >= mem[96]:
            ...
            if var54003 == var54003:
                ...
                _6066 = mem[(32 * stor204[arg1].field_96) + 128]
                mem[_6014 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
                idx = 0
                s = _6014 + (32 * _6018) + 128
                ...
                return memory
                  from mem[64]
                   len _6014 + (32 * _6018) + (32 * _6066) + -mem[64] + 128
            if var54003 >= mem[96]:
                revert with 0, 50
            ...
            mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
            mem[mem[64] + 32] = (32 * mem[96]) + 96
            _6068 = mem[(32 * stor204[arg1].field_96) + 128]
            mem[_6042 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
            idx = 0
            s = _6042 + (32 * _6046) + 128
            t = (32 * stor204[arg1].field_96) + 160
            while idx < _6068:
                mem[s] = mem[t + 12 len 20]
                idx = idx + 1
            ...
            return memory
              from mem[64]
               len _6042 + (32 * _6046) + (32 * _6068) + -mem[64] + 128
        ...
        while idx % 281474976710656 < stor204[arg1].field_96:
            ...
            require return_data.size >= 32
            _2339 = mem[_2335]
            require mem[_2335] <= test266151307()
            require _2335 + return_data.size > _2335 + mem[_2335] + 31
            _2347 = mem[_2335 + mem[_2335]]
            if mem[_2335 + mem[_2335]] > test266151307():
                revert with 0, 65
            if ceil32(ceil32(mem[_2335 + mem[_2335]])) + 1 < 0 or _2335 + ceil32(return_data.size) + ceil32(ceil32(mem[_2335 + mem[_2335]])) + 1 > test266151307():
                revert with 0, 65
            mem[64] = _2335 + ceil32(return_data.size) + ceil32(ceil32(mem[_2335 + mem[_2335]])) + 1
            mem[_2335 + ceil32(return_data.size)] = _2347
            require _2339 + _2347 + 32 <= return_data.size
            t = 0
            while t < _2347:
                mem[t + _2335 + ceil32(return_data.size) + 32] = mem[t + _2335 + _2339 + 32]
                t = t + 32
                continue 
            if ceil32(_2347) <= _2347:
                if _2347 < 8:
                    revert with 0, 17
                _2939 = mem[64]
                u = _2335 + ceil32(return_data.size) + mem[_2335 + ceil32(return_data.size)] - 4
                t = mem[64] + 4
                while t < mem[64] + 8:
                    mem[t] = mem[u]
                    u = u + 32
                ...
                while u < 4:
                    ...
                    if u >= 4:
                        revert with 0, 50
                    if uint8(mem[u + _2939 + 32]) >> 248 < 48:
                        if u == -1:
                            revert with 0, 17
                        u = u + 1
                        v = v
                        continue 
                    if uint8(mem[u + _2939 + 32]) >> 248 > 57:
                        if u >= 4:
                            revert with 0, 50
                        if u == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[u + _2939 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * v > !((uint8(mem[u + _2939 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if u == -1:
                        revert with 0, 17
                    u = u + 1
                    v = (10 * v) + (uint8(mem[u + _2939 + 32]) >> 248) - 48
                    continue 
                mem[ceil32(t)] = 0xc3ec6eb00000000000000000000000000000000000000000000000000000000
                mem[ceil32(t) + 4] = stor204[arg1][3][s << 208][1].field_0
                require ext_code.size(0x95f6ae731d5f6485c62d899538dae40a00da5972)
                ...
                mem[64] = ceil32(t) + ceil32(return_data.size)
                require return_data.size >= 32
                _4156 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
                require mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 <= test266151307()
                require ceil32(t) + return_data.size > ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 + 31
                _4194 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
                if mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32] > test266151307():
                    revert with 0, 65
                if ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 < 0 or ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 > test266151307():
                    revert with 0, 65
                mem[64] = ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1
                mem[ceil32(t) + ceil32(return_data.size)] = _4194
                require _4156 + _4194 + 32 <= return_data.size
                u = 0
                while u < _4194:
                    mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4156 + 32]
                    u = u + 32
                    continue 
                if ceil32(_4194) <= _4194:
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4694 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4694 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4694 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4694 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4694 + 32]) >> 248) - 48
                        continue 
                else:
                    mem[ceil32(t) + ceil32(return_data.size) + _4194 + 32] = 0
                    if _4194 < 8:
                        revert with 0, 17
                    _4710 = mem[64]
                    w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4710 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4710 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4710 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4710 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4710 + 32]) >> 248) - 48
                        continue 
            else:
                mem[_2335 + ceil32(return_data.size) + _2347 + 32] = 0
                if _2347 < 8:
                    revert with 0, 17
                _2953 = mem[64]
                u = _2335 + ceil32(return_data.size) + mem[_2335 + ceil32(return_data.size)] - 4
                ...
                while u < 4:
                    ...
                    if u >= 4:
                        revert with 0, 50
                    if uint8(mem[u + _2953 + 32]) >> 248 < 48:
                        if u == -1:
                            revert with 0, 17
                        u = u + 1
                        v = v
                        continue 
                    if uint8(mem[u + _2953 + 32]) >> 248 > 57:
                        if u >= 4:
                            revert with 0, 50
                        if u == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[u + _2953 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * v > !((uint8(mem[u + _2953 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if u == -1:
                        revert with 0, 17
                    u = u + 1
                    v = (10 * v) + (uint8(mem[u + _2953 + 32]) >> 248) - 48
                    continue 
                mem[ceil32(t)] = 0xc3ec6eb00000000000000000000000000000000000000000000000000000000
                mem[ceil32(t) + 4] = stor204[arg1][3][s << 208][1].field_0
                require ext_code.size(0x95f6ae731d5f6485c62d899538dae40a00da5972)
                ...
                mem[64] = ceil32(t) + ceil32(return_data.size)
                require return_data.size >= 32
                _4157 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
                require mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 <= test266151307()
                require ceil32(t) + return_data.size > ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 + 31
                _4196 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
                if mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32] > test266151307():
                    revert with 0, 65
                if ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 < 0 or ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 > test266151307():
                    revert with 0, 65
                mem[64] = ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1
                mem[ceil32(t) + ceil32(return_data.size)] = _4196
                require _4157 + _4196 + 32 <= return_data.size
                u = 0
                while u < _4196:
                    mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4157 + 32]
                    u = u + 32
                    continue 
                if ceil32(_4196) <= _4196:
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4695 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4695 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4695 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4695 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4695 + 32]) >> 248) - 48
                        continue 
                else:
                    mem[ceil32(t) + ceil32(return_data.size) + _4196 + 32] = 0
                    if _4196 < 8:
                        revert with 0, 17
                    _4711 = mem[64]
                    w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4711 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4711 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4711 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4711 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4711 + 32]) >> 248) - 48
                        continue 
            if v % 281474976710656 > -(w % 281474976710656) + test266151307():
                revert with 0, 17
            mem[0] = arg1
        ...
        if var51002 >= var51001:
            ...
            mem[mem[64] + 96 len 32 * _4604] = mem[var51004 + 32 len 32 * _4604]
            mem[mem[64] + 32] = (32 * _4604) + 96
            _5084 = mem[var51003]
            mem[_4596 + (32 * _4604) + 96] = mem[var51003]
            idx = 0
            s = _4596 + (32 * _4604) + 128
            t = var51003 + 32
            while idx < _5084:
                mem[s] = mem[t + 12 len 20]
                idx = idx + 1
            ...
            return memory
              from mem[64]
               len _4596 + (32 * _4604) + (32 * _5084) + -mem[64] + 128
        if var44001 < mem[96]:
            if var55003 >= mem[96]:
                revert with 0, 50
            if var44001 >= mem[96]:
        ...
        if var55003 == var55003:
            ...
            mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
            mem[mem[64] + 32] = (32 * mem[96]) + 96
            _6070 = mem[(32 * stor204[arg1].field_96) + 128]
            mem[_6015 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
            idx = 0
            s = _6015 + (32 * _6019) + 128
            t = (32 * stor204[arg1].field_96) + 160
            while idx < _6070:
                mem[s] = mem[t + 12 len 20]
                idx = idx + 1
            ...
            return memory
              from mem[64]
               len _6015 + (32 * _6019) + (32 * _6070) + -mem[64] + 128
        if var55003 >= mem[96]:
            revert with 0, 50
        ...
        mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
        mem[mem[64] + 32] = (32 * mem[96]) + 96
        _6072 = mem[(32 * stor204[arg1].field_96) + 128]
        mem[_6043 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
        idx = 0
        s = _6043 + (32 * _6047) + 128
        t = (32 * stor204[arg1].field_96) + 160
        while idx < _6072:
            mem[s] = mem[t + 12 len 20]
            idx = idx + 1
        ...
        return memory
          from mem[64]
           len _6043 + (32 * _6047) + (32 * _6072) + -mem[64] + 128
    ...
    if not stor204[arg1].field_96:
        ...
        while idx % 281474976710656 < stor204[arg1].field_96:
            ...
            require return_data.size >= 32
            _2340 = mem[_2336]
            require mem[_2336] <= test266151307()
            require _2336 + return_data.size > _2336 + mem[_2336] + 31
            _2350 = mem[_2336 + mem[_2336]]
            if mem[_2336 + mem[_2336]] > test266151307():
                revert with 0, 65
            if ceil32(ceil32(mem[_2336 + mem[_2336]])) + 1 < 0 or _2336 + ceil32(return_data.size) + ceil32(ceil32(mem[_2336 + mem[_2336]])) + 1 > test266151307():
                revert with 0, 65
            mem[64] = _2336 + ceil32(return_data.size) + ceil32(ceil32(mem[_2336 + mem[_2336]])) + 1
            mem[_2336 + ceil32(return_data.size)] = _2350
            require _2340 + _2350 + 32 <= return_data.size
            t = 0
            while t < _2350:
                mem[t + _2336 + ceil32(return_data.size) + 32] = mem[t + _2336 + _2340 + 32]
                t = t + 32
                continue 
            if ceil32(_2350) <= _2350:
                if _2350 < 8:
                    revert with 0, 17
                _2942 = mem[64]
                u = _2336 + ceil32(return_data.size) + mem[_2336 + ceil32(return_data.size)] - 4
                t = mem[64] + 4
                while t < mem[64] + 8:
                    mem[t] = mem[u]
                    u = u + 32
                ...
                while u < 4:
                    ...
                    if u >= 4:
                        revert with 0, 50
                    if uint8(mem[u + _2942 + 32]) >> 248 < 48:
                        if u == -1:
                            revert with 0, 17
                        u = u + 1
                        v = v
                        continue 
                    if uint8(mem[u + _2942 + 32]) >> 248 > 57:
                        if u >= 4:
                            revert with 0, 50
                        if u == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[u + _2942 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * v > !((uint8(mem[u + _2942 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if u == -1:
                        revert with 0, 17
                    u = u + 1
                    v = (10 * v) + (uint8(mem[u + _2942 + 32]) >> 248) - 48
                    continue 
                mem[ceil32(t)] = 0xc3ec6eb00000000000000000000000000000000000000000000000000000000
                mem[ceil32(t) + 4] = stor204[arg1][3][s << 208][1].field_0
                require ext_code.size(0x95f6ae731d5f6485c62d899538dae40a00da5972)
                ...
                mem[64] = ceil32(t) + ceil32(return_data.size)
                require return_data.size >= 32
                _4160 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
                require mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 <= test266151307()
                require ceil32(t) + return_data.size > ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 + 31
                _4200 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
                if mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32] > test266151307():
                    revert with 0, 65
                if ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 < 0 or ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 > test266151307():
                    revert with 0, 65
                mem[64] = ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1
                mem[ceil32(t) + ceil32(return_data.size)] = _4200
                require _4160 + _4200 + 32 <= return_data.size
                u = 0
                while u < _4200:
                    mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4160 + 32]
                    u = u + 32
                    continue 
                if ceil32(_4200) <= _4200:
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4699 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4699 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4699 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4699 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4699 + 32]) >> 248) - 48
                        continue 
                else:
                    mem[ceil32(t) + ceil32(return_data.size) + _4200 + 32] = 0
                    if _4200 < 8:
                        revert with 0, 17
                    _4713 = mem[64]
                    w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4713 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4713 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4713 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4713 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4713 + 32]) >> 248) - 48
                        continue 
            else:
                mem[_2336 + ceil32(return_data.size) + _2350 + 32] = 0
                if _2350 < 8:
                    revert with 0, 17
                _2957 = mem[64]
                u = _2336 + ceil32(return_data.size) + mem[_2336 + ceil32(return_data.size)] - 4
                ...
                while u < 4:
                    ...
                    if u >= 4:
                        revert with 0, 50
                    if uint8(mem[u + _2957 + 32]) >> 248 < 48:
                        if u == -1:
                            revert with 0, 17
                        u = u + 1
                        v = v
                        continue 
                    if uint8(mem[u + _2957 + 32]) >> 248 > 57:
                        if u >= 4:
                            revert with 0, 50
                        if u == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[u + _2957 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * v > !((uint8(mem[u + _2957 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if u == -1:
                        revert with 0, 17
                    u = u + 1
                    v = (10 * v) + (uint8(mem[u + _2957 + 32]) >> 248) - 48
                    continue 
                mem[ceil32(t)] = 0xc3ec6eb00000000000000000000000000000000000000000000000000000000
                mem[ceil32(t) + 4] = stor204[arg1][3][s << 208][1].field_0
                require ext_code.size(0x95f6ae731d5f6485c62d899538dae40a00da5972)
                ...
                mem[64] = ceil32(t) + ceil32(return_data.size)
                require return_data.size >= 32
                _4161 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
                require mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 <= test266151307()
                require ceil32(t) + return_data.size > ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 + 31
                _4202 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
                if mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32] > test266151307():
                    revert with 0, 65
                if ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 < 0 or ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 > test266151307():
                    revert with 0, 65
                mem[64] = ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1
                mem[ceil32(t) + ceil32(return_data.size)] = _4202
                require _4161 + _4202 + 32 <= return_data.size
                u = 0
                while u < _4202:
                    mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4161 + 32]
                    u = u + 32
                    continue 
                if ceil32(_4202) <= _4202:
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4700 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4700 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4700 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4700 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4700 + 32]) >> 248) - 48
                        continue 
                else:
                    mem[ceil32(t) + ceil32(return_data.size) + _4202 + 32] = 0
                    if _4202 < 8:
                        revert with 0, 17
                    _4714 = mem[64]
                    w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                    ...
                    while t < 4:
                        ...
                        if t >= 4:
                            revert with 0, 50
                        if uint8(mem[t + _4714 + 32]) >> 248 < 48:
                            if t == -1:
                                revert with 0, 17
                            t = t + 1
                            w = w
                            continue 
                        if uint8(mem[t + _4714 + 32]) >> 248 > 57:
                            if t >= 4:
                                revert with 0, 50
                            if t == -1:
                                revert with 0, 17
                        ...
                        if uint8(mem[t + _4714 + 32]) >> 248 < 48:
                            revert with 0, 17
                        if 10 * w > !((uint8(mem[t + _4714 + 32]) >> 248) - 48):
                            revert with 0, 17
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = (10 * w) + (uint8(mem[t + _4714 + 32]) >> 248) - 48
                        continue 
            if v % 281474976710656 > -(w % 281474976710656) + test266151307():
                revert with 0, 17
            mem[0] = arg1
        ...
        if var51002 >= var51001:
            ...
            _4606 = mem[var51004]
            mem[mem[64] + 64] = mem[var51004]
            mem[mem[64] + 96 len 32 * _4606] = mem[var51004 + 32 len 32 * _4606]
            mem[mem[64] + 32] = (32 * _4606) + 96
            _5090 = mem[var51003]
            mem[_4598 + (32 * _4606) + 96] = mem[var51003]
            idx = 0
            s = _4598 + (32 * _4606) + 128
            t = var51003 + 32
            while idx < _5090:
                mem[s] = mem[t + 12 len 20]
                idx = idx + 1
            ...
            return memory
              from mem[64]
               len _4598 + (32 * _4606) + (32 * _5090) + -mem[64] + 128
        if var44001 < mem[96]:
            if var55003 >= mem[96]:
                revert with 0, 50
            if var44001 >= mem[96]:
        ...
        if var55003 == var55003:
            ...
            mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
            mem[mem[64] + 32] = (32 * mem[96]) + 96
            _6074 = mem[(32 * stor204[arg1].field_96) + 128]
            mem[_6016 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
            idx = 0
            s = _6016 + (32 * _6020) + 128
            t = (32 * stor204[arg1].field_96) + 160
            while idx < _6074:
                mem[s] = mem[t + 12 len 20]
                idx = idx + 1
            ...
            return memory
              from mem[64]
               len _6016 + (32 * _6020) + (32 * _6074) + -mem[64] + 128
        if var55003 >= mem[96]:
            revert with 0, 50
        if var55003 >= mem[(32 * stor204[arg1].field_96) + 128]:
            revert with 0, 50
        ...
        mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
        mem[mem[64] + 32] = (32 * mem[96]) + 96
        _6076 = mem[(32 * stor204[arg1].field_96) + 128]
        mem[_6044 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
        idx = 0
        s = _6044 + (32 * _6048) + 128
        t = (32 * stor204[arg1].field_96) + 160
        while idx < _6076:
            mem[s] = mem[t + 12 len 20]
            idx = idx + 1
        ...
        return memory
          from mem[64]
           len _6044 + (32 * _6048) + (32 * _6076) + -mem[64] + 128
    mem[(32 * stor204[arg1].field_96) + 160 len 32 * stor204[arg1].field_96] = call.data[calldata.size len 32 * stor204[arg1].field_96]
    idx = 0
    s = 1
    while idx % 281474976710656 < stor204[arg1].field_96:
        ...
        require return_data.size >= 32
        _2341 = mem[_2337]
        require mem[_2337] <= test266151307()
        require _2337 + return_data.size > _2337 + mem[_2337] + 31
        _2353 = mem[_2337 + mem[_2337]]
        if mem[_2337 + mem[_2337]] > test266151307():
            revert with 0, 65
        if ceil32(ceil32(mem[_2337 + mem[_2337]])) + 1 < 0 or _2337 + ceil32(return_data.size) + ceil32(ceil32(mem[_2337 + mem[_2337]])) + 1 > test266151307():
            revert with 0, 65
        mem[64] = _2337 + ceil32(return_data.size) + ceil32(ceil32(mem[_2337 + mem[_2337]])) + 1
        mem[_2337 + ceil32(return_data.size)] = _2353
        require _2341 + _2353 + 32 <= return_data.size
        t = 0
        while t < _2353:
            mem[t + _2337 + ceil32(return_data.size) + 32] = mem[t + _2337 + _2341 + 32]
            t = t + 32
            continue 
        if ceil32(_2353) <= _2353:
            if _2353 < 8:
                revert with 0, 17
            _2945 = mem[64]
            u = _2337 + ceil32(return_data.size) + mem[_2337 + ceil32(return_data.size)] - 4
            t = mem[64] + 4
            while t < mem[64] + 8:
                mem[t] = mem[u]
                u = u + 32
            ...
            while u < 4:
                ...
                if u >= 4:
                    revert with 0, 50
                if uint8(mem[u + _2945 + 32]) >> 248 < 48:
                    if u == -1:
                        revert with 0, 17
                    u = u + 1
                    v = v
                    continue 
                if uint8(mem[u + _2945 + 32]) >> 248 > 57:
                    if u >= 4:
                        revert with 0, 50
                    if u == -1:
                        revert with 0, 17
                ...
                if uint8(mem[u + _2945 + 32]) >> 248 < 48:
                    revert with 0, 17
                if 10 * v > !((uint8(mem[u + _2945 + 32]) >> 248) - 48):
                    revert with 0, 17
                if u == -1:
                    revert with 0, 17
                u = u + 1
                v = (10 * v) + (uint8(mem[u + _2945 + 32]) >> 248) - 48
                continue 
            mem[ceil32(t)] = 0xc3ec6eb00000000000000000000000000000000000000000000000000000000
            mem[ceil32(t) + 4] = stor204[arg1][3][s << 208][1].field_0
            require ext_code.size(0x95f6ae731d5f6485c62d899538dae40a00da5972)
            ...
            mem[64] = ceil32(t) + ceil32(return_data.size)
            require return_data.size >= 32
            _4164 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
            require mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 <= test266151307()
            require ceil32(t) + return_data.size > ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 + 31
            _4206 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
            if mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32] > test266151307():
                revert with 0, 65
            if ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 < 0 or ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 > test266151307():
                revert with 0, 65
            mem[64] = ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1
            mem[ceil32(t) + ceil32(return_data.size)] = _4206
            require _4164 + _4206 + 32 <= return_data.size
            u = 0
            while u < _4206:
                mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4164 + 32]
                u = u + 32
                continue 
            if ceil32(_4206) <= _4206:
                ...
                while t < 4:
                    ...
                    if t >= 4:
                        revert with 0, 50
                    if uint8(mem[t + _4704 + 32]) >> 248 < 48:
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = w
                        continue 
                    if uint8(mem[t + _4704 + 32]) >> 248 > 57:
                        if t >= 4:
                            revert with 0, 50
                        if t == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[t + _4704 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * w > !((uint8(mem[t + _4704 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if t == -1:
                        revert with 0, 17
                    t = t + 1
                    w = (10 * w) + (uint8(mem[t + _4704 + 32]) >> 248) - 48
                    continue 
            else:
                mem[ceil32(t) + ceil32(return_data.size) + _4206 + 32] = 0
                if _4206 < 8:
                    revert with 0, 17
                _4716 = mem[64]
                w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                ...
                while t < 4:
                    ...
                    if t >= 4:
                        revert with 0, 50
                    if uint8(mem[t + _4716 + 32]) >> 248 < 48:
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = w
                        continue 
                    if uint8(mem[t + _4716 + 32]) >> 248 > 57:
                        if t >= 4:
                            revert with 0, 50
                        if t == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[t + _4716 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * w > !((uint8(mem[t + _4716 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if t == -1:
                        revert with 0, 17
                    t = t + 1
                    w = (10 * w) + (uint8(mem[t + _4716 + 32]) >> 248) - 48
                    continue 
        else:
            mem[_2337 + ceil32(return_data.size) + _2353 + 32] = 0
            if _2353 < 8:
                revert with 0, 17
            _2961 = mem[64]
            u = _2337 + ceil32(return_data.size) + mem[_2337 + ceil32(return_data.size)] - 4
            ...
            while u < 4:
                ...
                if u >= 4:
                    revert with 0, 50
                if uint8(mem[u + _2961 + 32]) >> 248 < 48:
                    if u == -1:
                        revert with 0, 17
                    u = u + 1
                    v = v
                    continue 
                if uint8(mem[u + _2961 + 32]) >> 248 > 57:
                    if u >= 4:
                        revert with 0, 50
                    if u == -1:
                        revert with 0, 17
                ...
                if uint8(mem[u + _2961 + 32]) >> 248 < 48:
                    revert with 0, 17
                if 10 * v > !((uint8(mem[u + _2961 + 32]) >> 248) - 48):
                    revert with 0, 17
                if u == -1:
                    revert with 0, 17
                u = u + 1
                v = (10 * v) + (uint8(mem[u + _2961 + 32]) >> 248) - 48
                continue 
            mem[ceil32(t)] = 0xc3ec6eb00000000000000000000000000000000000000000000000000000000
            mem[ceil32(t) + 4] = stor204[arg1][3][s << 208][1].field_0
            require ext_code.size(0x95f6ae731d5f6485c62d899538dae40a00da5972)
            ...
            mem[64] = ceil32(t) + ceil32(return_data.size)
            require return_data.size >= 32
            _4165 = mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32
            require mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 <= test266151307()
            require ceil32(t) + return_data.size > ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32 + 31
            _4208 = mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32]
            if mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32] > test266151307():
                revert with 0, 65
            if ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 < 0 or ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1 > test266151307():
                revert with 0, 65
            mem[64] = ceil32(t) + ceil32(return_data.size) + ceil32(ceil32(mem[ceil32(t) + mem[ceil32(t) len 4], stor204[arg1][3][s << 208][1].field_32])) + 1
            mem[ceil32(t) + ceil32(return_data.size)] = _4208
            require _4165 + _4208 + 32 <= return_data.size
            u = 0
            while u < _4208:
                mem[u + ceil32(t) + ceil32(return_data.size) + 32] = mem[u + ceil32(t) + _4165 + 32]
                u = u + 32
                continue 
            if ceil32(_4208) <= _4208:
                ...
                while t < 4:
                    ...
                    if t >= 4:
                        revert with 0, 50
                    if uint8(mem[t + _4705 + 32]) >> 248 < 48:
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = w
                        continue 
                    if uint8(mem[t + _4705 + 32]) >> 248 > 57:
                        if t >= 4:
                            revert with 0, 50
                        if t == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[t + _4705 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * w > !((uint8(mem[t + _4705 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if t == -1:
                        revert with 0, 17
                    t = t + 1
                    w = (10 * w) + (uint8(mem[t + _4705 + 32]) >> 248) - 48
                    continue 
            else:
                mem[ceil32(t) + ceil32(return_data.size) + _4208 + 32] = 0
                if _4208 < 8:
                    revert with 0, 17
                _4717 = mem[64]
                w = ceil32(t) + ceil32(return_data.size) + mem[ceil32(t) + ceil32(return_data.size)] - 4
                ...
                while t < 4:
                    ...
                    if t >= 4:
                        revert with 0, 50
                    if uint8(mem[t + _4717 + 32]) >> 248 < 48:
                        if t == -1:
                            revert with 0, 17
                        t = t + 1
                        w = w
                        continue 
                    if uint8(mem[t + _4717 + 32]) >> 248 > 57:
                        if t >= 4:
                            revert with 0, 50
                        if t == -1:
                            revert with 0, 17
                    ...
                    if uint8(mem[t + _4717 + 32]) >> 248 < 48:
                        revert with 0, 17
                    if 10 * w > !((uint8(mem[t + _4717 + 32]) >> 248) - 48):
                        revert with 0, 17
                    if t == -1:
                        revert with 0, 17
                    t = t + 1
                    w = (10 * w) + (uint8(mem[t + _4717 + 32]) >> 248) - 48
                    continue 
        if v % 281474976710656 > -(w % 281474976710656) + test266151307():
            revert with 0, 17
        mem[0] = arg1
    ...
    if var52002 >= var52001:
        ...
        mem[mem[64] + 96 len 32 * _4608] = mem[var52004 + 32 len 32 * _4608]
        mem[mem[64] + 32] = (32 * _4608) + 96
        _5096 = mem[var52003]
        mem[_4600 + (32 * _4608) + 96] = mem[var52003]
        idx = 0
        s = _4600 + (32 * _4608) + 128
        t = var52003 + 32
        while idx < _5096:
            mem[s] = mem[t + 12 len 20]
            idx = idx + 1
        ...
        return memory
          from mem[64]
           len _4600 + (32 * _4608) + (32 * _5096) + -mem[64] + 128
    if var45001 < mem[96]:
        if var56003 >= mem[96]:
            revert with 0, 50
        if var45001 >= mem[96]:
    ...
    if var56003 == var56003:
        ...
        mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
        mem[mem[64] + 32] = (32 * mem[96]) + 96
        _6078 = mem[(32 * stor204[arg1].field_96) + 128]
        mem[_6017 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
        idx = 0
        s = _6017 + (32 * _6021) + 128
        t = (32 * stor204[arg1].field_96) + 160
        while idx < _6078:
            mem[s] = mem[t + 12 len 20]
            idx = idx + 1
        ...
        return memory
          from mem[64]
           len _6017 + (32 * _6021) + (32 * _6078) + -mem[64] + 128
    if var56003 >= mem[96]:
        revert with 0, 50
    ...
    mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
    mem[mem[64] + 32] = (32 * mem[96]) + 96
    _6080 = mem[(32 * stor204[arg1].field_96) + 128]
    mem[_6045 + (32 * mem[96]) + 96] = mem[(32 * stor204[arg1].field_96) + 128]
    idx = 0
    s = _6045 + (32 * _6049) + 128
    t = (32 * stor204[arg1].field_96) + 160
    while idx < _6080:
        mem[s] = mem[t + 12 len 20]
        idx = idx + 1
    ...
    return memory
      from mem[64]
       len _6045 + (32 * _6049) + (32 * _6080) + -mem[64] + 128
}
...
function sub_0632c859(?) payable {
    ...
    if not return_data.size:
                ...
                if ceil32(_3376) <= _3376:
                    ...
                    if mem[_3324 + 32] <= mem[ceil32(idx) + 160]:
                        ...
                        if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10597] == bool(mem[_10597])
                        else:
                            stor204[stor207].field_48 = block.timestamp % 281474976710656
                            mem[0] = sub_af5537fa
                            mem[32] = 204
                        ...
                        if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10598] == bool(mem[_10598])
                        else:
                            stor204[stor207].field_48 = block.timestamp % 281474976710656
                            mem[0] = sub_af5537fa
                            mem[32] = 204
            ...
            if ceil32(_3353) <= _3353:
                ...
                if mem[ceil32(var49003) + 160] <= mem[ceil32(var95003) + 160]:
                    ...
                    if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10593] == bool(mem[_10593])
                    else:
                        stor204[stor207].field_48 = block.timestamp % 281474976710656
                        mem[0] = sub_af5537fa
                        mem[32] = 204
                    ...
                    if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10594] == bool(mem[_10594])
                    else:
                        stor204[stor207].field_48 = block.timestamp % 281474976710656
                        mem[0] = sub_af5537fa
                        mem[32] = 204
        ...
        mem[ceil32(return_data.size) + ceil32(return_data.size) + 97] = _20
        ...
        if ceil32(_20) <= _20:
            if _20 < 8:
                revert with 0, 17
            _860 = mem[64]
            mem[mem[64] + 4] = mem[ceil32(return_data.size) + ceil32(return_data.size) + _20 + 93]
            var48003 = mem[64] + 36
            mem[mem[64]] = 4
            mem[64] = floor32(mem[64] + 67)
            idx = 0
                ...
                if ceil32(_3377) <= _3377:
                    ...
                    if mem[_3327 + 32] <= mem[ceil32(idx) + 160]:
                        ...
                        if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10605] == bool(mem[_10605])
                        else:
                            stor204[stor207].field_48 = block.timestamp % 281474976710656
                            mem[0] = sub_af5537fa
                            mem[32] = 204
                        ...
                        if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10606] == bool(mem[_10606])
                        else:
                            stor204[stor207].field_48 = block.timestamp % 281474976710656
                            mem[0] = sub_af5537fa
                            mem[32] = 204
            ...
            if ceil32(_3355) <= _3355:
                ...
                if mem[ceil32(var48003) + 160] <= mem[ceil32(var94003) + 160]:
                    ...
                    if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10602] == bool(mem[_10602])
                    else:
                        stor204[stor207].field_48 = block.timestamp % 281474976710656
                        mem[0] = sub_af5537fa
                        mem[32] = 204
                ...
                if ceil32(_3378) <= _3378:
                    ...
                    while s <= 5:
                        ...
                        if mem[_3330 + 32] <= stor202[s].field_256:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10573] >= stor204[stor207].field_256
                            require not stor206[stor207][address(msg.sender)]
                            stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10574] >= stor204[stor207].field_256
                            require not stor206[stor207][address(msg.sender)]
                            stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                    ...
                    while s <= 5:
                        ...
                        if mem[_3330 + 32] <= stor202[s].field_256:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10581] >= stor204[stor207].field_256
                            require not stor206[stor207][address(msg.sender)]
                            stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10582] >= stor204[stor207].field_256
                            require not stor206[stor207][address(msg.sender)]
                            stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                            stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                    ...
                    if mem[_3330 + 32] <= mem[ceil32(idx) + 160]:
                        ...
                        if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10613] == bool(mem[_10613])
                        else:
                            stor204[stor207].field_48 = block.timestamp % 281474976710656
                            mem[0] = sub_af5537fa
                            mem[32] = 204
                        ...
                        if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_10614] == bool(mem[_10614])
                        else:
                            stor204[stor207].field_48 = block.timestamp % 281474976710656
                            mem[0] = sub_af5537fa
                            mem[32] = 204
            ...
            if ceil32(_3357) <= _3357:
                ...
                while idx <= 5:
                    ...
                    if mem[ceil32(var49003) + 160] <= stor202[idx].field_256:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10557] >= stor204[stor207].field_256
                        require not stor206[stor207][address(msg.sender)]
                        stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10558] >= stor204[stor207].field_256
                        require not stor206[stor207][address(msg.sender)]
                        stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                ...
                while idx <= 5:
                    ...
                    if mem[ceil32(var49003) + 160] <= stor202[idx].field_256:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10565] >= stor204[stor207].field_256
                        require not stor206[stor207][address(msg.sender)]
                        stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10566] >= stor204[stor207].field_256
                        require not stor206[stor207][address(msg.sender)]
                        stor204[stor207][2][stor204[stor207].field_96 + 1 << 208].field_0 = msg.sender
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][0].field_0 = arg3
                        stor204[stor207][3][stor204[stor207].field_96 + 1 << 208][1].field_0 = arg4
                ...
                if mem[ceil32(var49003) + 160] <= mem[ceil32(var95003) + 160]:
                    ...
                    if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10609] == bool(mem[_10609])
                    else:
                        stor204[stor207].field_48 = block.timestamp % 281474976710656
                        mem[0] = sub_af5537fa
                        mem[32] = 204
                    ...
                    if stor204[stor207].field_0 != stor204[stor207].field_96 + 1 % 281474976710656:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_10610] == bool(mem[_10610])
                    else:
                        stor204[stor207].field_48 = block.timestamp % 281474976710656
                        mem[0] = sub_af5537fa
                        mem[32] = 204
