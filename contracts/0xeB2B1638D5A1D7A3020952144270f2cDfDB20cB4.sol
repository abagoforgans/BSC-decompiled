...
function sub_65f3a67e(?) payable {
    ...
    while idx < arg1.length:
        ...
        mem[64] = mem[64] + 96
        mem[_36] = 38
        mem[_36 + 32 len 38] = 0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63
        mem[32] = 1
        if arg2 > balanceOf[address(msg.sender)]:
            _38 = mem[64]
            ...
            idx = 0
            while idx < 38:
                mem[_38 + idx + 68] = mem[_36 + idx + 32]
                idx = idx + 32
                continue 
            mem[_38 + 100] = mem[_38 + 126 len 6]
            revert with memory
              from mem[64]
               len _38 + -mem[64] + 132
        balanceOf[address(msg.sender)] -= arg2
