...
#
const name = 'Papa WAGMI', 0

const MarketingWallet = 0xb0a67abea36d125e93dc5a498ee5d92cf8514b47

const decimals = 9

const sub_504762e7(?) = 1000 * 10^18

const symbol = 'PAPAWAGMI', 0
...
function sub_218f8a1d(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0xb0a67abea36d125e93dc5a498ee5d92cf8514b47 with:
