...
function mint(address arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        mem[64] = ceil32(s) + 128
        if s:
            mem[128 len s] = code.data[15341 len s]
        t = s - 1
        idx = arg2
        while idx:
            require t < mem[96]
        ...
        stor12[arg2][].field_0 = Array(len=mem[96], data=mem[128 len mem[96]])
    return 1
}
...
function tokenURI(uint256 arg1) payable {
    ...
    while ceil32(stor12[arg1].length) + baseURI.length + 128 > idx:
        ...
        s = s + 1
        continue 
    mem[ceil32(stor12[arg1].length) + baseURI.length + 160 len floor32(mem[96])] = mem[128 len floor32(mem[96])]
    mem[ceil32(stor12[arg1].length) + baseURI.length + floor32(mem[96]) + -(mem[96] % 32) + 192 len mem[96] % 32] = mem[floor32(mem[96]) + -(mem[96] % 32) + 160 len mem[96] % 32]
    _310 = mem[64]
    mem[64] = mem[96] + ceil32(stor12[arg1].length) + baseURI.length + 160
    mem[mem[96] + ceil32(stor12[arg1].length) + baseURI.length + 160] = 32
    mem[mem[96] + ceil32(stor12[arg1].length) + baseURI.length + 192] = mem[_310]
    _320 = mem[_310]
    mem[mem[96] + ceil32(stor12[arg1].length) + baseURI.length + 224 len ceil32(mem[_310])] = mem[_310 + 32 len ceil32(mem[_310])]
    if not _320 % 32:
        return 32, mem[mem[96] + ceil32(stor12[arg1].length) + baseURI.length + 192 len _320 + 32]
    mem[floor32(_320) + mem[96] + ceil32(stor12[arg1].length) + baseURI.length + 224] = mem[floor32(_320) + mem[96] + ceil32(stor12[arg1].length) + baseURI.length + -(_320 % 32) + 256 len _320 % 32]
    return 32, mem[mem[96] + ceil32(stor12[arg1].length) + baseURI.length + 192 len floor32(_320) + 64]
}
...
function safeMint(address arg1, uint256 arg2) payable {
    ...
    if ext_code.hash(arg1) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
        if not arg2:
            ...
            mem[64] = ceil32(s) + 160
            if s:
                mem[160 len s] = code.data[15341 len s]
            t = s - 1
            idx = arg2
            while idx:
                require t < mem[128]
                mem[t + 160 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
                t = t - 1
                idx = idx / 10
                continue 
            if not ownerOf[arg2]:
                revert with 0, 
                            ...
                            0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                            mem[mem[64] + 112 len 20]
            stor12[arg2][].field_0 = Array(len=mem[128], data=mem[160 len mem[128]])
    else:
        if not ext_code.hash(arg1):
            ...
            mem[324 len 160] = onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4), msg.sender, 0, arg2, 128, 0
            mem[512 len 4] = 0
            call arg1.0x80 with:
                 gas gas_remaining wei
                args Mask(1248, -1024, onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4), msg.sender, 0, arg2, 128, 0) << 1024, mem[484 len 4]
            if not return_data.size:
                ...
                revert with 0, 
                            ...
                            Mask(112, -800, onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4), msg.sender, 0, arg2, 128, 0) << 800
            ...
            if not ext_call.success:
                ...
                revert with 0, 
                            ...
                            50,
                            0x734552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465,
                            mem[ceil32(return_data.size) + 443 len 14]
            ...
            if not arg2:
                if not ownerOf[arg2]:
                    revert with 0, 
                                ...
                                44,
                                0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                                mem[ceil32(return_data.size) + 501 len 20]
                stor12[arg2].field_0 = 0
                stor12[arg2].field_1 = 1
                stor12[arg2].field_8 = '0' / 256
                idx = 0
                ...
                while idx:
                    ...
                    continue 
                if s:
                    mem[ceil32(return_data.size) + 357 len s] = code.data[15341 len s]
                t = s - 1
                idx = arg2
                while idx:
                    require t < s
                    mem[t + ceil32(return_data.size) + 357 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
                    t = t - 1
                    idx = idx / 10
                    continue 
                if not ownerOf[arg2]:
                    revert with 0, 
                                ...
                                44,
                                0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                                mem[ceil32(return_data.size) + ceil32(s) + 469 len 20]
                stor12[arg2][].field_0 = Array(len=s, data=mem[ceil32(return_data.size) + 357 len s])
    return 1
}
...
function safeMint(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    if ext_code.hash(arg1) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
        if not arg2:
            ...
            if s:
                mem[ceil32(arg3.length) + 160 len s] = code.data[15341 len s]
            t = s - 1
            idx = arg2
            while idx:
        ...
        if not ext_code.hash(arg1):
            ...
            if not arg3.length % 32:
                ...
                mem[ceil32(arg3.length) + 160 len 4] = onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4)
                ...
                if not return_data.size:
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[arg3.length + ceil32(arg3.length) + 356 len s] = code.data[15341 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                            mem[t + arg3.length + ceil32(arg3.length) + 356 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
                            t = t - 1
                            idx = idx / 10
                            continue 
                        if not ownerOf[arg2]:
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[arg3.length + ceil32(arg3.length) + ceil32(return_data.size) + 357 len s] = code.data[15341 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                            mem[t + arg3.length + ceil32(arg3.length) + ceil32(return_data.size) + 357 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
                            t = t - 1
                            idx = idx / 10
                            continue 
                        if not ownerOf[arg2]:
                ...
                if not return_data.size:
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[floor32(arg3.length) + ceil32(arg3.length) + 388 len s] = code.data[15341 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                            mem[t + floor32(arg3.length) + ceil32(arg3.length) + 388 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
                            t = t - 1
                            idx = idx / 10
                            continue 
                        if not ownerOf[arg2]:
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[floor32(arg3.length) + ceil32(arg3.length) + ceil32(return_data.size) + 389 len s] = code.data[15341 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                            mem[t + floor32(arg3.length) + ceil32(arg3.length) + ceil32(return_data.size) + 389 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
                            t = t - 1
                            idx = idx / 10
                            continue 
                        if not ownerOf[arg2]:
