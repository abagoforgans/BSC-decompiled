...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if ext_call.return_data[0] > balanceOf[stor9]:
        ...
        if balanceOf[stor9] > ext_call.return_data[0]:
            ...
            if balanceOf[stor9] - ext_call.return_data[0] > balanceOf[address(stor0.field_0)]:
                revert with 0, 'SafeMath: subtraction overflow', 0
            if balanceOf[address(stor0.field_0)] < balanceOf[stor9] - ext_call.return_data[0]:
                revert with 'NH{q', 17
            balanceOf[address(stor0.field_0)] = balanceOf[address(stor0.field_0)] - balanceOf[stor9] + ext_call.return_data[0]
