...
function sub_be67c6c1(?) {
    ...
    require ext_code.size(0xcf9d05b96f9b8004ff47a486d0c3d90e462e6f57)
    delegate 0xcf9d05b96f9b8004ff47a486d0c3d90e462e6f57.0xcd7db54c with:
...
function sub_31f17857(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(0x1ebd46b75f131c7ed169a98beddd81c9cc86eee3)
    delegate 0x1ebd46b75f131c7ed169a98beddd81c9cc86eee3.0x13d674fe with:
         gas gas_remaining wei
...
function sub_b97c41a5(?) {
    if not sub_26f05442Address:
        return -1
    require ext_code.size(0xcf9d05b96f9b8004ff47a486d0c3d90e462e6f57)
    delegate 0xcf9d05b96f9b8004ff47a486d0c3d90e462e6f57.0xcc23f384 with:
         gas gas_remaining wei
...
function approve(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x1d37f3534c5046b39aa629887efefbb43213a510)
    delegate 0x1d37f3534c5046b39aa629887efefbb43213a510.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0xab6cd232242b919d2a9b465d7898542cb66d069f)
        delegate 0xab6cd232242b919d2a9b465d7898542cb66d069f.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2 == arg2
    require ext_code.size(0x1d37f3534c5046b39aa629887efefbb43213a510)
    delegate 0x1d37f3534c5046b39aa629887efefbb43213a510.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_5126dad7(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
        delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
        delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x3f589a62f77dbc3ccf26b2a95551dc064d0d9fed)
        delegate 0x3f589a62f77dbc3ccf26b2a95551dc064d0d9fed.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_a9f1866b(?) {
    require ext_code.size(0xcf9d05b96f9b8004ff47a486d0c3d90e462e6f57)
    delegate 0xcf9d05b96f9b8004ff47a486d0c3d90e462e6f57.0x5bb709aa with:
         gas gas_remaining wei
        args 3, 30
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_594161f8(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0xab6cd232242b919d2a9b465d7898542cb66d069f)
        delegate 0xab6cd232242b919d2a9b465d7898542cb66d069f.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
        delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x1d37f3534c5046b39aa629887efefbb43213a510)
            delegate 0x1d37f3534c5046b39aa629887efefbb43213a510.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
        delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
        delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_3367ad09(?) {
    ...
    require ('cd', 4)[13] < 21
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0x4f0cad20066350d145f837bed97199a0f8f7d5db)
    delegate 0x4f0cad20066350d145f837bed97199a0f8f7d5db.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0x4f0cad20066350d145f837bed97199a0f8f7d5db)
    delegate 0x4f0cad20066350d145f837bed97199a0f8f7d5db.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0xab6cd232242b919d2a9b465d7898542cb66d069f)
        delegate 0xab6cd232242b919d2a9b465d7898542cb66d069f.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
        delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d32ea8b6(?) {
    ...
    mem[516] = arg1
    require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
    delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) {
    ...
    mem[132] = 14
    require ext_code.size(0x4179d98eaca8ce5b13670f7134c3922db3f83197)
    delegate 0x4179d98eaca8ce5b13670f7134c3922db3f83197.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    ...
    mem[388] = arg1
    require ext_code.size(0x1ebd46b75f131c7ed169a98beddd81c9cc86eee3)
    delegate 0x1ebd46b75f131c7ed169a98beddd81c9cc86eee3.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x1d37f3534c5046b39aa629887efefbb43213a510)
    delegate 0x1d37f3534c5046b39aa629887efefbb43213a510.0xc5bb51da with:
         gas gas_remaining wei
...
function sub_a05e1c7d(?) {
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[1] <= 0:
            ...
            require ext_code.size(0x4f0cad20066350d145f837bed97199a0f8f7d5db)
            delegate 0x4f0cad20066350d145f837bed97199a0f8f7d5db.mem[mem[64] len 4] with:
                 gas gas_remaining wei
            ...
            if ('cd', 4)[4] <= 0:
                ...
                require ext_code.size(0x4f0cad20066350d145f837bed97199a0f8f7d5db)
                delegate 0x4f0cad20066350d145f837bed97199a0f8f7d5db.mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 640 len 4] with:
                     gas gas_remaining wei
