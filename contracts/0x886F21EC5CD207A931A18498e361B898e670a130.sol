...
address sub_4057be98Address;
address sub_8db01478Address;
uint256 _rate;
uint256 sub_6f4246e2;
uint256 _weiRaised;
uint256 endIDO;
uint256 minPurchase;
uint256 maxPurchase;
...
function sub_4057be98(?) {
    return sub_4057be98Address
}
...
function sub_f7cc2134(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    require ext_code.size(sub_4057be98Address)
    staticcall sub_4057be98Address.0xab0ced0e with:
...
function sub_d711c66e(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    require ext_code.size(sub_8db01478Address)
...
function checkContribution(address arg1) {
    ...
    if bool(bool(stor6 < 78)) or bool(bool(stor6 < 32)):
        if 10^stor6 > -1:
            revert with 'NH{q', 17
        if _contributions[address(arg1)] and _rate > -1 / _contributions[address(arg1)]:
            revert with 'NH{q', 17
        if not 10^stor6:
            revert with 'NH{q', 18
        return (_contributions[address(arg1)] * _rate / 10^stor6)
    s = 10
    t = 1
    idx = stor6
    while idx > 1:
...
function setWhitelist(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        idx = idx + 1
        continue 
    stor21.length = arg1.length
    if not arg1.length:
        s = sha3(21)
        while sha3(21) + stor21.length > arg1.length:
            stor[arg1.length] = 0
            s = arg1.length + 1
            continue 
    else:
        ...
        while (32 * arg1.length) + 128 > idx:
            address(stor21[s]) = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
        idx = Mask(251, 0, (32 * arg1.length) + 31) >> 5
        while stor21.length > idx:
            uint256(stor21[idx]) = 0
            idx = idx + 1
            continue 
}
    ...
    if not stor6:
        ...
        if bool(bool(stor6 < 78)) or bool(bool(stor6 < 32)):
            ...
            if _weiRaised > -msg.value - 1:
                revert with 'NH{q', 17
            _weiRaised += msg.value
            if purchasedTokens > -(msg.value * _rate / 10^stor6) - 1:
                revert with 'NH{q', 17
            purchasedTokens += msg.value * _rate / 10^stor6
            if _contributions[address(msg.sender)] > -msg.value - 1:
                revert with 'NH{q', 17
            _contributions[address(msg.sender)] += msg.value
            emit TokensPurchased(msg.sender, msg.value, msg.value * _rate / 10^stor6);
        else:
            s = 10
            t = 1
            idx = stor6
