...
function harvest() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit Harvested(ext_call.return_data[0]);
    require ext_code.size(0x73feaa1ee314f8c655e354234017be2193c9e24e)
...
function deposit(uint256 arg1) payable {
    ...
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
        revert with 0, 'Address: call to non-contract'
    if not ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
        revert with 0, 'Address: call to non-contract'
    ...
    if not return_data.size:
        ...
        if return_data.size:
            ...
            if not mem[(2 * ceil32(return_data.size)) + 324]:
                revert with 0, 'SafeBEP20: BEP20 operation did not succeed'
    if 0 == totalShares:
        if arg1 + totalShares < totalShares:
            revert with 0, 'SafeMath: addition overflow'
        totalShares += arg1
        ...
        if not arg1:
            ...
            if not 2 * ext_call.return_data[0]:
                revert with 0, 'SafeMath: division by zero', 0
            if (totalShares * arg1 / 2 * ext_call.return_data[0]) + totalShares < totalShares:
                revert with 0, 'SafeMath: addition overflow'
            totalShares += totalShares * arg1 / 2 * ext_call.return_data[0]
            if (totalShares * arg1 / 2 * ext_call.return_data[0]) + sharesOf[address(msg.sender)] < sharesOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            sharesOf[address(msg.sender)] += totalShares * arg1 / 2 * ext_call.return_data[0]
    require ext_code.size(0x73feaa1ee314f8c655e354234017be2193c9e24e)
    call 0x73feaa1ee314f8c655e354234017be2193c9e24e.enterStaking(uint256 rg1) with:
         gas gas_remaining wei
        args arg1
    ...
    if not stor153[address(msg.sender)]:
        if arg1 + principalOf[msg.sender] < principalOf[msg.sender]:
            revert with 0, 'SafeMath: addition overflow'
...
function depositAll() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if not stor153[address(msg.sender)]:
        if ext_call.return_data[0] + principalOf[msg.sender] < principalOf[msg.sender]:
            revert with 0, 'SafeMath: addition overflow'
        principalOf[msg.sender] += ext_call.return_data[0]
        depositedAt[msg.sender] = block.timestamp
}
...
function withdraw(uint256 arg1) payable {
    ...
    if not 2 * ext_call.return_data[0]:
        ...
        if 0 / totalShares <= ext_call.return_data[0]:
            ...
            mem[(4 * ceil32(return_data.size)) + 356] = 0 / totalShares
            mem[(4 * ceil32(return_data.size)) + 288] = 68
            mem[(4 * ceil32(return_data.size)) + 324 len 28] = Mask(224, 32, msg.sender) >> 32
            mem[(4 * ceil32(return_data.size)) + 320 len 4] = unknown_0xa9059cbb(?????)
            mem[(4 * ceil32(return_data.size)) + 388] = 32
            mem[(4 * ceil32(return_data.size)) + 420] = 'SafeBEP20: low-level call failed'
            if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
                revert with 0, 'Address: call to non-contract'
            if not ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), msg.sender, 0 / totalShares, 0
            mem[(4 * ceil32(return_data.size)) + 520] = 0
            call 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82 with:
               funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, 0 / totalShares, 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, 0 / totalShares, 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
            ...
            if ext_call.return_data[0] > 0 / totalShares:
                revert with 0, 'SafeMath: subtraction overflow', 0
            require ext_code.size(0x73feaa1ee314f8c655e354234017be2193c9e24e)
            call 0x73feaa1ee314f8c655e354234017be2193c9e24e.leaveStaking(uint256 rg1) with:
                 gas gas_remaining wei
                args ((0 / totalShares) - ext_call.return_data[0])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(4 * ceil32(return_data.size)) + 388] = msg.sender
            mem[(4 * ceil32(return_data.size)) + 420] = 0 / totalShares
            ...
            mem[(4 * ceil32(return_data.size)) + 484] = 'SafeBEP20: low-level call failed'
            if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
                revert with 0, 'Address: call to non-contract'
            if not ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 516 len 96] = unknown_0xa9059cbb(?????), msg.sender, 0 / totalShares, 0
        ...
        if (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares <= ext_call.return_data[0]:
            mem[(4 * ceil32(return_data.size)) + 324] = msg.sender
            mem[(4 * ceil32(return_data.size)) + 356] = (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares
            mem[(4 * ceil32(return_data.size)) + 288] = 68
            mem[(4 * ceil32(return_data.size)) + 324 len 28] = Mask(224, 32, msg.sender) >> 32
            mem[(4 * ceil32(return_data.size)) + 320 len 4] = unknown_0xa9059cbb(?????)
            mem[(4 * ceil32(return_data.size)) + 388] = 32
            ...
            if not ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), msg.sender, (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares, 0
            mem[(4 * ceil32(return_data.size)) + 520] = 0
            call 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82 with:
               funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares, 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares, 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(4 * ceil32(return_data.size)) + 388] = msg.sender
            mem[(4 * ceil32(return_data.size)) + 420] = (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares
            mem[(4 * ceil32(return_data.size)) + 352] = 68
            mem[(4 * ceil32(return_data.size)) + 388 len 28] = Mask(224, 32, msg.sender) >> 32
            mem[(4 * ceil32(return_data.size)) + 384 len 4] = unknown_0xa9059cbb(?????)
            mem[(4 * ceil32(return_data.size)) + 452] = 32
            ...
            if not ext_code.hash(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 516 len 96] = unknown_0xa9059cbb(?????), msg.sender, (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares, 0
            mem[(4 * ceil32(return_data.size)) + 584] = 0
            call 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82 with:
               funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares, 0) >> 224
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if return_data.size:
                    ...
                    if not mem[(4 * ceil32(return_data.size)) + 548]:
                        revert with 0, 'SafeBEP20: BEP20 operation did not succeed'
        emit Withdrawn((ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalShares, 0, msg.sender);
    require ext_code.size(0x73feaa1ee314f8c655e354234017be2193c9e24e)
    call 0x73feaa1ee314f8c655e354234017be2193c9e24e.leaveStaking(uint256 rg1) with:
         gas gas_remaining wei
        args 0
