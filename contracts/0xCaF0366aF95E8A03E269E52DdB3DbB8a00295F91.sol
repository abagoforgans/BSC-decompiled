...
function calcValueInBaseWithPool(address arg1, uint256 arg2) payable {
    ...
    staticcall arg1.baseAmount() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(arg1)
    staticcall arg1.tokenAmount() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function calcLiquidityShare(uint256 arg1, address arg2, address arg3, address arg4) payable {
...
function calcValueInBase(address arg1, uint256 arg2) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).baseAmount() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).tokenAmount() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getPoolData(address arg1) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).baseAmountPooled() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).tokenAmountPooled() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getGlobalDetails() payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).totalPooled() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).removeLiquidityTx() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).addLiquidityTx() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getSlipAdustment(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) payable {
    require calldata.size - 4 >= 128
    if not arg2:
        if not arg1:
            require arg2 >= 0
            ...
            if not arg2:
                revert with 0, '', 0
            if (arg4 * arg2) + (arg3 * arg2) / arg2 != arg4 + arg3:
                revert with 0, 'SafeMath'
            if not (arg4 * arg2) + (arg3 * arg2):
                revert with 0, '', 0
            if 0 / (arg4 * arg2) + (arg3 * arg2) > one:
                revert with 0, '', 0
            return (one - (0 / (arg4 * arg2) + (arg3 * arg2)))
        ...
        if not arg1:
            ...
            if 0 <= arg4 * arg1:
                if not arg2:
                    if arg4 * arg1:
                        if one * arg4 * arg1 / arg4 * arg1 != one:
                            revert with 0, 'SafeMath'
                    revert with 0, '', 0
                if (arg4 * arg2) + (arg3 * arg2) / arg2 != arg4 + arg3:
                    revert with 0, 'SafeMath'
                ...
                if not (arg4 * arg2) + (arg3 * arg2):
                    revert with 0, '', 0
                if one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) > one:
                    revert with 0, '', 0
                return (one - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)))
            if arg4 * arg1 > 0:
                revert with 0, '', 0
            if not arg2:
                if -1 * arg4 * arg1:
                    if -1 * one * arg4 * arg1 / -1 * arg4 * arg1 != one:
                        revert with 0, 'SafeMath'
                revert with 0, '', 0
            if (arg4 * arg2) + (arg3 * arg2) / arg2 != arg4 + arg3:
                revert with 0, 'SafeMath'
            ...
            if not (arg4 * arg2) + (arg3 * arg2):
                revert with 0, '', 0
            if -1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) > one:
                revert with 0, '', 0
            return (one - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)))
        if 2 * arg1 / arg1 != 2:
            revert with 0, 'SafeMath'
        require arg2 + (2 * arg1) >= 2 * arg1
        require arg4 + arg3 >= arg3
        if 0 <= arg4 * arg1:
            if not arg2 + (2 * arg1):
                if arg4 * arg1:
                    if one * arg4 * arg1 / arg4 * arg1 != one:
                        revert with 0, 'SafeMath'
                revert with 0, '', 0
            if (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) / arg2 + (2 * arg1) != arg4 + arg3:
                revert with 0, 'SafeMath'
            if not arg4 * arg1:
                if not (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3):
                    revert with 0, '', 0
                if 0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) > one:
                    revert with 0, '', 0
                return (one - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)))
            if one * arg4 * arg1 / arg4 * arg1 != one:
                revert with 0, 'SafeMath'
            if not (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3):
                revert with 0, '', 0
            if one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) > one:
                revert with 0, '', 0
            return (one - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)))
        if arg4 * arg1 > 0:
            revert with 0, '', 0
        if not arg2 + (2 * arg1):
            if -1 * arg4 * arg1:
        ...
        if not (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3):
            revert with 0, '', 0
        if -1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) > one:
            revert with 0, '', 0
        return (one - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)))
    if arg3 * arg2 / arg2 != arg3:
        revert with 0, 'SafeMath'
    if not arg1:
        require arg2 >= 0
        ...
        if arg3 * arg2 <= 0:
            if not arg2:
                if -1 * arg3 * arg2:
                    if -1 * one * arg3 * arg2 / -1 * arg3 * arg2 != one:
                        revert with 0, 'SafeMath'
                revert with 0, '', 0
            if (arg4 * arg2) + (arg3 * arg2) / arg2 != arg4 + arg3:
                revert with 0, 'SafeMath'
            ...
            if not (arg4 * arg2) + (arg3 * arg2):
                revert with 0, '', 0
            if -1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) > one:
                revert with 0, '', 0
            return (one - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)))
        if 0 > arg3 * arg2:
            revert with 0, '', 0
        if not arg2:
            if arg3 * arg2:
                if one * arg3 * arg2 / arg3 * arg2 != one:
                    revert with 0, 'SafeMath'
            revert with 0, '', 0
        if (arg4 * arg2) + (arg3 * arg2) / arg2 != arg4 + arg3:
            revert with 0, 'SafeMath'
        ...
        if not (arg4 * arg2) + (arg3 * arg2):
            revert with 0, '', 0
        if one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) > one:
            revert with 0, '', 0
        return (one - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)))
    if arg4 * arg1 / arg1 != arg4:
        revert with 0, 'SafeMath'
    if not arg1:
        require arg2 >= 0
        ...
        if arg3 * arg2 <= arg4 * arg1:
            if not arg2:
                if (arg4 * arg1) - (arg3 * arg2):
                    if (arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg1) - (arg3 * arg2) != one:
                        revert with 0, 'SafeMath'
                revert with 0, '', 0
            if (arg4 * arg2) + (arg3 * arg2) / arg2 != arg4 + arg3:
                revert with 0, 'SafeMath'
            if not (arg4 * arg1) - (arg3 * arg2):
                if not (arg4 * arg2) + (arg3 * arg2):
                    revert with 0, '', 0
                if 0 / (arg4 * arg2) + (arg3 * arg2) > one:
                    revert with 0, '', 0
            ...
            if not (arg4 * arg2) + (arg3 * arg2):
                revert with 0, '', 0
            if (arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2) > one:
                revert with 0, '', 0
            return (one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2)))
        if arg4 * arg1 > arg3 * arg2:
            revert with 0, '', 0
        if not arg2:
            if (arg3 * arg2) - (arg4 * arg1):
                if (arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg3 * arg2) - (arg4 * arg1) != one:
                    revert with 0, 'SafeMath'
            revert with 0, '', 0
        if (arg4 * arg2) + (arg3 * arg2) / arg2 != arg4 + arg3:
            revert with 0, 'SafeMath'
        if not (arg3 * arg2) - (arg4 * arg1):
            if not (arg4 * arg2) + (arg3 * arg2):
                revert with 0, '', 0
            if 0 / (arg4 * arg2) + (arg3 * arg2) > one:
                revert with 0, '', 0
        ...
        if not (arg4 * arg2) + (arg3 * arg2):
            revert with 0, '', 0
        if (arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2) > one:
            revert with 0, '', 0
        return (one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2)))
    if 2 * arg1 / arg1 != 2:
        revert with 0, 'SafeMath'
    require arg2 + (2 * arg1) >= 2 * arg1
    require arg4 + arg3 >= arg3
    if arg3 * arg2 <= arg4 * arg1:
        ...
        if not (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3):
            revert with 0, '', 0
        if (arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) > one:
            revert with 0, '', 0
        return (one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)))
    if arg4 * arg1 > arg3 * arg2:
        revert with 0, '', 0
    if not arg2 + (2 * arg1):
        if (arg3 * arg2) - (arg4 * arg1):
    ...
    if not (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3):
        revert with 0, '', 0
    if (arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) > one:
        revert with 0, '', 0
    return (one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)))
}
...
function getTokenDetailsWithMember(address arg1, address arg2) payable {
    ...
    mem[256] = 0
    if not arg1:
        return 32, 192, 256, 18, 100 * 10^6 * one, eth.balance(msg.sender), uint64(arg1) << 96, 12, 0, 0, 3, 0, 0
    ...
    if ceil32(_11) <= _11:
        ...
        mem[mem[64] + 64] = ceil32(_511) + 224
        mem[ceil32(_511) + _505 + 256] = _239
        mem[ceil32(_511) + _505 + 288 len ceil32(_239)] = mem[_232 + ceil32(return_data.size) + 32 len ceil32(_239)]
        if ceil32(_239) > _239:
            mem[ceil32(_511) + _505 + _239 + 288] = 0
        mem[_505 + 96] = mem[160]
        mem[_505 + 128] = mem[192]
        mem[_505 + 160] = mem[224]
        mem[_505 + 192] = uint64(arg1) << 96
        return memory
          from mem[64]
           len ceil32(_239) + ceil32(_511) + _505 + -mem[64] + 288
    ...
    mem[mem[64] + 64] = ceil32(_516) + 224
    mem[ceil32(_516) + _510 + 256] = _241
    mem[ceil32(_516) + _510 + 288 len ceil32(_241)] = mem[_234 + ceil32(return_data.size) + 32 len ceil32(_241)]
    if ceil32(_241) > _241:
        mem[ceil32(_516) + _510 + _241 + 288] = 0
    mem[_510 + 96] = mem[160]
    mem[_510 + 128] = mem[192]
    mem[_510 + 160] = mem[224]
    mem[_510 + 192] = uint64(arg1) << 96
    return memory
      from mem[64]
       len ceil32(_241) + ceil32(_516) + _510 + -mem[64] + 288
}

function getUnclaimedAssetWithBalance(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    mem[128] = 96
    ...
    mem[256] = 0
    mem[288] = 0
    mem[320] = 0x6fdde0300000000000000000000000000000000000000000000000000000000
    require ext_code.size(arg1)
    staticcall arg1.name() with:
            gas gas_remaining wei
    if not ext_call.success:
    ...
    require mem[320] + 351 < return_data.size + 320
    _6 = mem[mem[320] + 320]
    require mem[mem[320] + 320] <= test266151307()
    require ceil32(mem[mem[320] + 320]) + 32 >= 0 and ceil32(return_data.size) + ceil32(mem[mem[320] + 320]) + 352 <= test266151307()
    mem[64] = ceil32(return_data.size) + ceil32(mem[mem[320] + 320]) + 352
    mem[ceil32(return_data.size) + 320] = mem[mem[320] + 320]
    require return_data.size >= _6 + _5 + 32
    mem[ceil32(return_data.size) + 352 len ceil32(_6)] = mem[_5 + 352 len ceil32(_6)]
    if ceil32(_6) <= _6:
        mem[96] = ceil32(return_data.size) + 320
        mem[mem[64]] = 0x95d89b4100000000000000000000000000000000000000000000000000000000
        require ext_code.size(arg1)
        staticcall arg1.0x95d89b41 with:
                gas gas_remaining wei
        ...
        require mem[_228 + mem[_228]] <= test266151307()
        require ceil32(mem[_228 + mem[_228]]) + 32 >= 0 and _228 + ceil32(return_data.size) + ceil32(mem[_228 + mem[_228]]) + 32 <= test266151307()
        mem[64] = _228 + ceil32(return_data.size) + ceil32(mem[_228 + mem[_228]]) + 32
        mem[_228 + ceil32(return_data.size)] = _232
        require return_data.size >= _232 + _230 + 32
        mem[_228 + ceil32(return_data.size) + 32 len ceil32(_232)] = mem[_228 + _230 + 32 len ceil32(_232)]
        if ceil32(_232) <= _232:
            mem[128] = _228 + ceil32(return_data.size)
            require ext_code.size(arg1)
            staticcall arg1.0x313ce567 with:
                    gas gas_remaining wei
            mem[mem[64]] = ext_call.return_data[0]
            ...
            mem[256] = arg1
            require ext_code.size(arg2)
            staticcall arg2.mapAddressHasClaimed() with:
                    gas gas_remaining wei
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[288] = bool(mem[_496])
            mem[mem[64]] = 32
            mem[mem[64] + 32] = 224
            _510 = mem[ceil32(return_data.size) + 320]
            mem[mem[64] + 256] = mem[ceil32(return_data.size) + 320]
            mem[mem[64] + 288 len ceil32(_510)] = mem[ceil32(return_data.size) + 352 len ceil32(_510)]
            if ceil32(_510) <= _510:
                mem[mem[64] + 64] = ceil32(_510) + 256
                mem[ceil32(_510) + mem[64] + 288] = _232
                mem[ceil32(_510) + mem[64] + 320 len ceil32(_232)] = mem[_228 + ceil32(return_data.size) + 32 len ceil32(_232)]
                if ceil32(_232) > _232:
                    mem[ceil32(_510) + mem[64] + _232 + 320] = 0
                mem[mem[64] + 96] = mem[160]
                mem[mem[64] + 128] = mem[192]
                mem[mem[64] + 160] = mem[224]
                mem[mem[64] + 192] = uint64(arg1) << 96
                mem[mem[64] + 224] = bool(mem[288])
                return 32, 224, 
                       ceil32(_510) + 256,
                       mem[mem[64] + 96 len 64],
                       mem[224],
                       arg1 << 192,
                       bool(mem[288]),
                       mem[mem[64] + 256 len ceil32(_510) + 32],
                       _232,
                       mem[mem[64] + ceil32(_510) + 320 len ceil32(_232)]
            mem[mem[64] + _510 + 288] = 0
            mem[mem[64] + 64] = ceil32(_510) + 256
            mem[ceil32(_510) + mem[64] + 288] = _232
            mem[ceil32(_510) + mem[64] + 320 len ceil32(_232)] = mem[_228 + ceil32(return_data.size) + 32 len ceil32(_232)]
            if ceil32(_232) > _232:
            ...
            return 32, 224, 
                   ...
                   arg1 << 192,
                   bool(mem[288]),
                   mem[mem[64] + 256 len _510 + 32],
                   0,
                   mem[mem[64] + _510 + 320 len ceil32(_232) + ceil32(_510) - _510]
        mem[_228 + ceil32(return_data.size) + _232 + 32] = 0
        mem[128] = _228 + ceil32(return_data.size)
        require ext_code.size(arg1)
        staticcall arg1.0x313ce567 with:
                gas gas_remaining wei
        ...
        mem[288] = bool(mem[_498])
        _507 = mem[64]
        mem[mem[64]] = 32
        mem[mem[64] + 32] = 224
        _514 = mem[ceil32(return_data.size) + 320]
        mem[mem[64] + 256] = mem[ceil32(return_data.size) + 320]
        mem[mem[64] + 288 len ceil32(_514)] = mem[ceil32(return_data.size) + 352 len ceil32(_514)]
        if ceil32(_514) <= _514:
            mem[mem[64] + 64] = ceil32(_514) + 256
            mem[ceil32(_514) + mem[64] + 288] = _232
            mem[ceil32(_514) + mem[64] + 320 len ceil32(_232)] = mem[_228 + ceil32(return_data.size) + 32 len ceil32(_232)]
            if ceil32(_232) > _232:
                mem[ceil32(_514) + mem[64] + _232 + 320] = 0
            mem[mem[64] + 96] = mem[160]
            mem[mem[64] + 128] = mem[192]
            mem[mem[64] + 160] = mem[224]
            mem[mem[64] + 192] = uint64(arg1) << 96
            ...
            return 32, 224, 
                   ...
                   arg1 << 192,
                   bool(mem[288]),
                   mem[mem[64] + 256 len ceil32(_514) + 32],
                   _232,
                   mem[mem[64] + ceil32(_514) + 320 len ceil32(_232)]
        mem[mem[64] + _514 + 288] = 0
        mem[mem[64] + 64] = ceil32(_514) + 256
        mem[ceil32(_514) + _507 + 288] = _232
        mem[ceil32(_514) + _507 + 320 len ceil32(_232)] = mem[_228 + ceil32(return_data.size) + 32 len ceil32(_232)]
        if ceil32(_232) > _232:
            mem[ceil32(_514) + _507 + _232 + 320] = 0
        mem[_507 + 96] = mem[160]
        mem[_507 + 128] = mem[192]
        mem[_507 + 160] = mem[224]
        mem[_507 + 192] = uint64(arg1) << 96
        mem[_507 + 224] = bool(mem[288])
        return memory
          from mem[64]
           len ceil32(_232) + ceil32(_514) + _507 + -mem[64] + 320
    mem[ceil32(return_data.size) + _6 + 352] = 0
    mem[96] = ceil32(return_data.size) + 320
    mem[mem[64]] = 0x95d89b4100000000000000000000000000000000000000000000000000000000
    require ext_code.size(arg1)
    staticcall arg1.0x95d89b41 with:
    ...
    _234 = mem[_229 + mem[_229]]
    require mem[_229 + mem[_229]] <= test266151307()
    require ceil32(mem[_229 + mem[_229]]) + 32 >= 0 and _229 + ceil32(return_data.size) + ceil32(mem[_229 + mem[_229]]) + 32 <= test266151307()
    mem[64] = _229 + ceil32(return_data.size) + ceil32(mem[_229 + mem[_229]]) + 32
    mem[_229 + ceil32(return_data.size)] = _234
    require return_data.size >= _234 + _231 + 32
    mem[_229 + ceil32(return_data.size) + 32 len ceil32(_234)] = mem[_229 + _231 + 32 len ceil32(_234)]
    if ceil32(_234) <= _234:
        mem[128] = _229 + ceil32(return_data.size)
        require ext_code.size(arg1)
        staticcall arg1.0x313ce567 with:
                gas gas_remaining wei
        mem[mem[64]] = ext_call.return_data[0]
        ...
        mem[288] = bool(mem[_497])
        _505 = mem[64]
        mem[mem[64]] = 32
        mem[mem[64] + 32] = 224
        _512 = mem[ceil32(return_data.size) + 320]
        mem[mem[64] + 256] = mem[ceil32(return_data.size) + 320]
        mem[mem[64] + 288 len ceil32(_512)] = mem[ceil32(return_data.size) + 352 len ceil32(_512)]
        if ceil32(_512) <= _512:
            mem[mem[64] + 64] = ceil32(_512) + 256
            mem[ceil32(_512) + mem[64] + 288] = _234
            mem[ceil32(_512) + mem[64] + 320 len ceil32(_234)] = mem[_229 + ceil32(return_data.size) + 32 len ceil32(_234)]
            if ceil32(_234) > _234:
                mem[ceil32(_512) + mem[64] + _234 + 320] = 0
            mem[mem[64] + 96] = mem[160]
            mem[mem[64] + 128] = mem[192]
            mem[mem[64] + 160] = mem[224]
            mem[mem[64] + 192] = uint64(arg1) << 96
            ...
            return 32, 224, 
                   ...
                   arg1 << 192,
                   bool(mem[288]),
                   mem[mem[64] + 256 len ceil32(_512) + 32],
                   _234,
                   mem[mem[64] + ceil32(_512) + 320 len ceil32(_234)]
        mem[mem[64] + _512 + 288] = 0
        mem[mem[64] + 64] = ceil32(_512) + 256
        mem[ceil32(_512) + _505 + 288] = _234
        mem[ceil32(_512) + _505 + 320 len ceil32(_234)] = mem[_229 + ceil32(return_data.size) + 32 len ceil32(_234)]
        if ceil32(_234) > _234:
            mem[ceil32(_512) + _505 + _234 + 320] = 0
        mem[_505 + 96] = mem[160]
        mem[_505 + 128] = mem[192]
        mem[_505 + 160] = mem[224]
        mem[_505 + 192] = uint64(arg1) << 96
        mem[_505 + 224] = bool(mem[288])
        return memory
          from mem[64]
           len ceil32(_234) + ceil32(_512) + _505 + -mem[64] + 320
    mem[_229 + ceil32(return_data.size) + _234 + 32] = 0
    mem[128] = _229 + ceil32(return_data.size)
    require ext_code.size(arg1)
    staticcall arg1.0x313ce567 with:
            gas gas_remaining wei
    ...
    mem[288] = bool(mem[_499])
    mem[mem[64]] = 32
    mem[mem[64] + 32] = 224
    _515 = mem[ceil32(return_data.size) + 320]
    mem[mem[64] + 256] = mem[ceil32(return_data.size) + 320]
    mem[mem[64] + 288 len ceil32(_515)] = mem[ceil32(return_data.size) + 352 len ceil32(_515)]
    if ceil32(_515) <= _515:
        mem[mem[64] + 64] = ceil32(_515) + 256
        mem[ceil32(_515) + mem[64] + 288] = _234
        mem[ceil32(_515) + mem[64] + 320 len ceil32(_234)] = mem[_229 + ceil32(return_data.size) + 32 len ceil32(_234)]
        if ceil32(_234) > _234:
            mem[ceil32(_515) + mem[64] + _234 + 320] = 0
        mem[mem[64] + 96] = mem[160]
        mem[mem[64] + 128] = mem[192]
        mem[mem[64] + 160] = mem[224]
        mem[mem[64] + 192] = uint64(arg1) << 96
        ...
        return 32, 224, 
               ...
               arg1 << 192,
               bool(mem[288]),
               mem[mem[64] + 256 len ceil32(_515) + 32],
               _234,
               mem[mem[64] + ceil32(_515) + 320 len ceil32(_234)]
    mem[mem[64] + _515 + 288] = 0
    mem[mem[64] + 64] = ceil32(_515) + 256
    mem[ceil32(_515) + mem[64] + 288] = _234
    mem[ceil32(_515) + mem[64] + 320 len ceil32(_234)] = mem[_229 + ceil32(return_data.size) + 32 len ceil32(_234)]
    if ceil32(_234) > _234:
    ...
    return 32, 224, 
           ...
           arg1 << 192,
           bool(mem[288]),
           mem[mem[64] + 256 len _515 + 32],
           0,
           mem[mem[64] + _515 + 320 len ceil32(_234) + ceil32(_515) - _515]
}
...
function calcLiquidityUnits(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) payable {
    ...
    if not arg2:
        if not arg1:
            ...
            if not arg3:
                ...
                if not arg4:
                    require arg1 * arg4 >= 0
                    if arg5:
                        if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                            revert with 0, 'SafeMath'
                    revert with 0, '', 0
                ...
                if not arg2 * arg4:
                    ...
                    if arg5:
                        if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                            revert with 0, 'SafeMath'
                    revert with 0, '', 0
                if 2 * arg2 * arg4 / arg2 * arg4 != 2:
                    revert with 0, 'SafeMath'
                require arg1 * arg4 >= 0
                if not arg5:
                    if not 2 * arg2 * arg4:
                        revert with 0, '', 0
                    if not 0 / 2 * arg2 * arg4:
                        if not one:
                            revert with 0, '', 0
                        return (0 / one)
                    if (one * 0 / 2 * arg2 * arg4) - (0 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (0 / (arg4 * arg2) + (arg3 * arg2)):
                        revert with 0, 'SafeMath'
                    if not one:
                        revert with 0, '', 0
                    return ((one * 0 / 2 * arg2 * arg4) - (0 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / one)
                if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                    revert with 0, 'SafeMath'
                if not 2 * arg2 * arg4:
                    revert with 0, '', 0
                if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (0 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (0 / (arg4 * arg2) + (arg3 * arg2)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (0 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
            if arg2 * arg3 / arg3 != arg2:
                revert with 0, 'SafeMath'
            if not arg4:
                require arg2 * arg3 >= arg2 * arg3
                if arg5:
                    if arg2 * arg3 * arg5 / arg5 != arg2 * arg3:
                        revert with 0, 'SafeMath'
                revert with 0, '', 0
            if arg1 * arg4 / arg4 != arg1:
                revert with 0, 'SafeMath'
            if not arg4:
                ...
                if arg5:
                    if (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / arg5 != (arg1 * arg4) + (arg2 * arg3):
                        revert with 0, 'SafeMath'
                revert with 0, '', 0
            if arg2 * arg4 / arg4 != arg2:
                revert with 0, 'SafeMath'
            ...
            if not 2 * arg2 * arg4:
                revert with 0, '', 0
            if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (0 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (0 / (arg4 * arg2) + (arg3 * arg2)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (0 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
        if arg4 * arg1 / arg1 != arg4:
            revert with 0, 'SafeMath'
        if not arg1:
            require arg2 >= 0
            ...
            if 0 <= arg4 * arg1:
                ...
                if not arg3:
                    ...
                    if not arg5:
                        ...
                        if not 0 / 2 * arg2 * arg4:
                            if not one:
                                revert with 0, '', 0
                            return (0 / one)
                        if (one * 0 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)):
                            revert with 0, 'SafeMath'
                        if not one:
                            revert with 0, '', 0
                        return ((one * 0 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / one)
                    if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                        revert with 0, 'SafeMath'
                    if not 2 * arg2 * arg4:
                        revert with 0, '', 0
                    if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                        if not one:
                            revert with 0, '', 0
                        return (0 / one)
                    if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)):
                        revert with 0, 'SafeMath'
                    if not one:
                        revert with 0, '', 0
                    return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
                if arg2 * arg3 / arg3 != arg2:
                    revert with 0, 'SafeMath'
                if not arg4:
                    require arg2 * arg3 >= arg2 * arg3
                ...
                if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
            if arg4 * arg1 > 0:
                revert with 0, '', 0
            if not arg2:
                if -1 * arg4 * arg1:
            ...
            if not arg3:
                ...
                if not arg5:
                    ...
                    if not 0 / 2 * arg2 * arg4:
                        if not one:
                            revert with 0, '', 0
                        return (0 / one)
                    if (one * 0 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)):
                        revert with 0, 'SafeMath'
                    if not one:
                        revert with 0, '', 0
                    return ((one * 0 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / one)
                if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                    revert with 0, 'SafeMath'
                if not 2 * arg2 * arg4:
                    revert with 0, '', 0
                if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
            if arg2 * arg3 / arg3 != arg2:
                revert with 0, 'SafeMath'
            if not arg4:
                require arg2 * arg3 >= arg2 * arg3
            ...
            if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
        if 2 * arg1 / arg1 != 2:
            revert with 0, 'SafeMath'
        require arg2 + (2 * arg1) >= 2 * arg1
        require arg4 + arg3 >= arg3
        if 0 <= arg4 * arg1:
            ...
            if not arg4 * arg1:
                ...
                if not arg3:
                    ...
                    if not arg5:
                        ...
                        if not 0 / 2 * arg2 * arg4:
                            if not one:
                                revert with 0, '', 0
                            return (0 / one)
                        if (one * 0 / 2 * arg2 * arg4) - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                            revert with 0, 'SafeMath'
                        if not one:
                            revert with 0, '', 0
                        return ((one * 0 / 2 * arg2 * arg4) - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / one)
                    if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                        revert with 0, 'SafeMath'
                    if not 2 * arg2 * arg4:
                        revert with 0, '', 0
                    if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                        if not one:
                            revert with 0, '', 0
                        return (0 / one)
                    if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                        revert with 0, 'SafeMath'
                    if not one:
                        revert with 0, '', 0
                    return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
                if arg2 * arg3 / arg3 != arg2:
                    revert with 0, 'SafeMath'
                if not arg4:
                    require arg2 * arg3 >= arg2 * arg3
                ...
                if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (0 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
            if one * arg4 * arg1 / arg4 * arg1 != one:
                revert with 0, 'SafeMath'
            if not (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3):
                revert with 0, '', 0
            ...
            if not arg3:
                ...
                if not arg5:
                    ...
                    if not 0 / 2 * arg2 * arg4:
                        if not one:
                            revert with 0, '', 0
                        return (0 / one)
                    if (one * 0 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                        revert with 0, 'SafeMath'
                    if not one:
                        revert with 0, '', 0
                    return ((one * 0 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / one)
                if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                    revert with 0, 'SafeMath'
                if not 2 * arg2 * arg4:
                    revert with 0, '', 0
                if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
            if arg2 * arg3 / arg3 != arg2:
                revert with 0, 'SafeMath'
            if not arg4:
                require arg2 * arg3 >= arg2 * arg3
            ...
            if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
        if arg4 * arg1 > 0:
            revert with 0, '', 0
        if not arg2 + (2 * arg1):
            if -1 * arg4 * arg1:
        ...
        if not arg3:
            ...
            if not arg5:
                ...
                if not 0 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * 0 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * 0 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / one)
            if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                revert with 0, 'SafeMath'
            if not 2 * arg2 * arg4:
                revert with 0, '', 0
            if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
        if arg2 * arg3 / arg3 != arg2:
            revert with 0, 'SafeMath'
        if not arg4:
            require arg2 * arg3 >= arg2 * arg3
        ...
        if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
            if not one:
                revert with 0, '', 0
            return (0 / one)
        if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
            revert with 0, 'SafeMath'
        if not one:
            revert with 0, '', 0
        return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (-1 * one * arg4 * arg1 / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
    if arg3 * arg2 / arg2 != arg3:
        revert with 0, 'SafeMath'
    if not arg1:
        require arg2 >= 0
        ...
        if arg3 * arg2 <= 0:
            ...
            if not arg3:
                ...
                if not arg5:
                    ...
                    if not 0 / 2 * arg2 * arg4:
                        if not one:
                            revert with 0, '', 0
                        return (0 / one)
                    if (one * 0 / 2 * arg2 * arg4) - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)):
                        revert with 0, 'SafeMath'
                    if not one:
                        revert with 0, '', 0
                    return ((one * 0 / 2 * arg2 * arg4) - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / one)
                if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                    revert with 0, 'SafeMath'
                if not 2 * arg2 * arg4:
                    revert with 0, '', 0
                if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
            if arg2 * arg3 / arg3 != arg2:
                revert with 0, 'SafeMath'
            if not arg4:
                require arg2 * arg3 >= arg2 * arg3
            ...
            if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (-1 * one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
        if 0 > arg3 * arg2:
            revert with 0, '', 0
        if not arg2:
            if arg3 * arg2:
        ...
        if not arg3:
            ...
            if not arg5:
                ...
                if not 0 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * 0 / 2 * arg2 * arg4) - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * 0 / 2 * arg2 * arg4) - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / one)
            if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                revert with 0, 'SafeMath'
            if not 2 * arg2 * arg4:
                revert with 0, '', 0
            if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
        if arg2 * arg3 / arg3 != arg2:
            revert with 0, 'SafeMath'
        if not arg4:
            require arg2 * arg3 >= arg2 * arg3
        ...
        if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
            if not one:
                revert with 0, '', 0
            return (0 / one)
        if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2)):
            revert with 0, 'SafeMath'
        if not one:
            revert with 0, '', 0
        return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - (one * arg3 * arg2 / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
    if arg4 * arg1 / arg1 != arg4:
        revert with 0, 'SafeMath'
    if not arg1:
        require arg2 >= 0
        ...
        if arg3 * arg2 <= arg4 * arg1:
            ...
            if not arg3:
                ...
                if not arg5:
                    ...
                    if not 0 / 2 * arg2 * arg4:
                        if not one:
                            revert with 0, '', 0
                        return (0 / one)
                    if (one * 0 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2)):
                        revert with 0, 'SafeMath'
                    if not one:
                        revert with 0, '', 0
                    return ((one * 0 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / one)
                if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                    revert with 0, 'SafeMath'
                if not 2 * arg2 * arg4:
                    revert with 0, '', 0
                if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
            if arg2 * arg3 / arg3 != arg2:
                revert with 0, 'SafeMath'
            if not arg4:
                require arg2 * arg3 >= arg2 * arg3
            ...
            if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
        if arg4 * arg1 > arg3 * arg2:
            revert with 0, '', 0
        if not arg2:
            if (arg3 * arg2) - (arg4 * arg1):
        ...
        if not arg3:
            ...
            if not arg5:
                ...
                if not 0 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * 0 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * 0 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2) * 0 / 2 * arg2 * arg4) / one)
            if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                revert with 0, 'SafeMath'
            if not 2 * arg2 * arg4:
                revert with 0, '', 0
            if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
        if arg2 * arg3 / arg3 != arg2:
            revert with 0, 'SafeMath'
        if not arg4:
            require arg2 * arg3 >= arg2 * arg3
        ...
        if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
            if not one:
                revert with 0, '', 0
            return (0 / one)
        if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2)):
            revert with 0, 'SafeMath'
        if not one:
            revert with 0, '', 0
        return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg4 * arg2) + (arg3 * arg2) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
    if 2 * arg1 / arg1 != 2:
        revert with 0, 'SafeMath'
    require arg2 + (2 * arg1) >= 2 * arg1
    require arg4 + arg3 >= arg3
    if arg3 * arg2 <= arg4 * arg1:
        ...
        if not arg3:
            ...
            if not arg5:
                ...
                if not 0 / 2 * arg2 * arg4:
                    if not one:
                        revert with 0, '', 0
                    return (0 / one)
                if (one * 0 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                    revert with 0, 'SafeMath'
                if not one:
                    revert with 0, '', 0
                return ((one * 0 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / one)
            if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
                revert with 0, 'SafeMath'
            if not 2 * arg2 * arg4:
                revert with 0, '', 0
            if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
        if arg2 * arg3 / arg3 != arg2:
            revert with 0, 'SafeMath'
        if not arg4:
            require arg2 * arg3 >= arg2 * arg3
        ...
        if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
            if not one:
                revert with 0, '', 0
            return (0 / one)
        if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
            revert with 0, 'SafeMath'
        if not one:
            revert with 0, '', 0
        return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg4 * arg1 * one) - (arg3 * arg2 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
    if arg4 * arg1 > arg3 * arg2:
        revert with 0, '', 0
    if not arg2 + (2 * arg1):
        if (arg3 * arg2) - (arg4 * arg1):
    ...
    if not arg3:
        ...
        if not arg5:
            ...
            if not 0 / 2 * arg2 * arg4:
                if not one:
                    revert with 0, '', 0
                return (0 / one)
            if (one * 0 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / 0 / 2 * arg2 * arg4 != one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
                revert with 0, 'SafeMath'
            if not one:
                revert with 0, '', 0
            return ((one * 0 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * 0 / 2 * arg2 * arg4) / one)
        if arg1 * arg4 * arg5 / arg5 != arg1 * arg4:
            revert with 0, 'SafeMath'
        if not 2 * arg2 * arg4:
            revert with 0, '', 0
        if not arg1 * arg4 * arg5 / 2 * arg2 * arg4:
            if not one:
                revert with 0, '', 0
            return (0 / one)
        if (one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / arg1 * arg4 * arg5 / 2 * arg2 * arg4 != one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
            revert with 0, 'SafeMath'
        if not one:
            revert with 0, '', 0
        return ((one * arg1 * arg4 * arg5 / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * arg1 * arg4 * arg5 / 2 * arg2 * arg4) / one)
    if arg2 * arg3 / arg3 != arg2:
        revert with 0, 'SafeMath'
    if not arg4:
        require arg2 * arg3 >= arg2 * arg3
    ...
    if not (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4:
        if not one:
            revert with 0, '', 0
        return (0 / one)
    if (one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4 != one - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3)):
        revert with 0, 'SafeMath'
    if not one:
        revert with 0, '', 0
    return ((one * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) - ((arg3 * arg2 * one) - (arg4 * arg1 * one) / (arg2 * arg4) + (2 * arg1 * arg4) + (arg2 * arg3) + (2 * arg1 * arg3) * (arg1 * arg4 * arg5) + (arg2 * arg3 * arg5) / 2 * arg2 * arg4) / one)
}
