...
#
const name = 'Trident Capitals Gold'
...
const TOKEN_NAME = 'Trident Capitals Gold'

const TOKEN_SYMBOL = 'TDG'

const TOKEN_DECIMAL_MULTIPLIER = 100 * 10^6

const TOKEN_DECIMALS = 8

const TARGET_USER = 0xfa7cf08709ee1139dc1066862e22ee304077bab1
