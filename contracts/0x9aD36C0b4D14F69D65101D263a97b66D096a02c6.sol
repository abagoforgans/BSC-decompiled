...
function sub_ede432dd(?) {
    mem[96] = arg1.length
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    mem[(32 * arg1.length) + 128] = 2
    mem[(32 * arg1.length) + 160 len 64] = code.data[15610 len 64]
    ...
    mem[(32 * arg1.length) + ceil32(return_data.size) + 260] = _43
    ...
    call stor6.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], _43, Array(len=2, data=mem[(32 * arg1.length) + ceil32(return_data.size) + 420 len 64]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_a203e687(?) {
    ...
    mem[(32 * arg1.length) + ceil32(return_data.size) + 228] = _58
    ...
    call stor6.swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value 10^14 wei
         gas gas_remaining wei
        args _58, Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + ceil32(return_data.size) + floor32(arg1.length) + 388 len (32 * arg1.length) - floor32(arg1.length)]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * arg1.length) + ceil32(return_data.size) + 224 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * arg1.length) + (2 * ceil32(return_data.size)) + 224
    require return_data.size >= 32
    require mem[(32 * arg1.length) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _58) >> 32 <= 4294967296
    require mem[(32 * arg1.length) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _58) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * arg1.length) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _58) >> 32 + (32 * arg1.length) + ceil32(return_data.size) + 224] <= 4294967296 and mem[(32 * arg1.length) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _58) >> 32 + (32 * mem[mem[(32 * arg1.length) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _58) >> 32 + (32 * arg1.length) + ceil32(return_data.size) + 224]) + 32 <= return_data.size
    require 1 < arg1.length
    ...
    mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 260] = _128
...
function sub_f392b216(?) {
    ...
    mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 228] = ext_call.return_data[0]
    mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 260] = _232
    mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 324] = this.address
    mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 356] = block.timestamp + 15
    mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 292] = 160
    ...
    mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 356] = _322
    ...
    call stor6.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], _322, Array(len=2, data=mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 516 len 64]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_fc4344d4(?) payable {
    ...
    if operatorAddress == msg.sender:
        ...
        _424 = mem[mem[(32 * arg1.length) + 320 len 4], 232830643 + (32 * arg1.length) + 384]
        ...
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 320] = 2
        require 1 < arg1.length
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 352] = mem[172 len 20]
        require 0 < arg1.length
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 384] = mem[140 len 20]
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 420] = 10^14
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 452] = 64
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 484] = arg1.length
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 516 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
        require ext_code.size(stor6)
        call stor6.getAmountsOut(uint256 arg1, address[] arg2) with:
             gas gas_remaining wei
            args 10^14, 64, arg1.length, call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + floor32(arg1.length) + 516 len (32 * arg1.length) - floor32(arg1.length)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416
        require return_data.size >= 32
        require mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 <= 4294967296
        require mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + 32 <= return_data.size
        require mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 416]
        if mem[mem[(32 * arg1.length) + ceil32(return_data.size) + 320 len 4], 232830643 + (32 * arg1.length) + ceil32(return_data.size) + 384] * _424 / 10^18 > arg2 * sub_0ae8a68e:
            _1176 = mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 480]
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] = 0x7ff36ab500000000000000000000000000000000000000000000000000000000
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 420] = _1176
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 484] = this.address
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 516] = block.timestamp + 15
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 452] = 128
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 548] = arg1.length
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 580 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
            require ext_code.size(stor6)
            call stor6.swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value 10^14 wei
                 gas gas_remaining wei
                args mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 420 len (32 * arg1.length) + (5 * ceil32(return_data.size)) + 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416
            require return_data.size >= 32
            require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1176) >> 32 <= 4294967296
            require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1176) >> 32 + 32 <= return_data.size
            require mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1176) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1176) >> 32 + (32 * mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1176) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
            require 1 < arg1.length
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 452] = -1
            require ext_code.size(mem[172 len 20])
            call mem[172 len 20].approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args stor4, -1, mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 484 len 9 * ceil32(return_data.size)]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(mem[172 len 20])
            call mem[172 len 20].0x70a08231 with:
                 gas gas_remaining wei
                args address(this.address), mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 452 len 9 * ceil32(return_data.size)]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 420] = ext_call.return_data[0]
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 452] = 64
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 484] = 2
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 516 len 0] = None
            require ext_code.size(stor6)
            call stor6.getAmountsOut(uint256 arg1, address[] arg2) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], Array(len=2, data=mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 516 len (9 * ceil32(return_data.size)) + 64])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416
            require return_data.size >= 32
            require mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] <= 4294967296
            require mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
            require mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
            require 1 < mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]
            _1744 = mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 480]
            mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 0] = None
            require ext_code.size(stor6)
            call stor6.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], _1744, Array(len=2, data=mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 64]), address(this.address), block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            revert with 0, 'err2'
        _1172 = mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 480]
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] = 0x7ff36ab500000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 420] = _1172
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 484] = this.address
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 516] = block.timestamp + 15
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 452] = 128
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 548] = arg1.length
        ...
        mem[64] = (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416
        require return_data.size >= 32
        require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1172) >> 32 <= 4294967296
        require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1172) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1172) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1172) >> 32 + (32 * mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1172) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < arg1.length
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 452] = -1
        require ext_code.size(mem[172 len 20])
        call mem[172 len 20].approve(address arg1, uint256 arg2) with:
        ...
        require mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]
        _1740 = mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 480]
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 516] = this.address
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 548] = block.timestamp + 15
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 580] = 2
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 0] = None
        require ext_code.size(stor6)
        call stor6.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], _1740, Array(len=2, data=mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 64]), address(this.address), block.timestamp + 15
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 420] = msg.value
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 452] = 64
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 484] = arg1.length
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 516 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
        require ext_code.size(stor6)
        call stor6.getAmountsOut(uint256 arg1, address[] arg2) with:
             gas gas_remaining wei
            args msg.value, Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + floor32(arg1.length) + 516 len (32 * arg1.length) - floor32(arg1.length)])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 <= 4294967296
        require mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416]
        _2084 = mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 480]
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416] = 0x7ff36ab500000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 420] = _2084 - (_2084 * arg3 / 1000)
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 484] = this.address
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 516] = block.timestamp + 15
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 452] = 128
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 548] = arg1.length
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 580 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
        require ext_code.size(stor6)
        call stor6.swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
           value msg.value wei
             gas gas_remaining wei
            args mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 420 len (32 * arg1.length) + ceil32(return_data.size) + 160]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2084 - (_2084 * arg3 / 1000)) >> 32 <= 4294967296
        require mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2084 - (_2084 * arg3 / 1000)) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2084 - (_2084 * arg3 / 1000)) >> 32 + (32 * arg1.length) + (8 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2084 - (_2084 * arg3 / 1000)) >> 32 + (32 * mem[mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2084 - (_2084 * arg3 / 1000)) >> 32 + (32 * arg1.length) + (8 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
    else:
        if stor0 != msg.sender:
            revert with 0, 'fuck2'
        mem[(32 * arg1.length) + 128] = 2
        ...
        require mem[mem[(32 * arg1.length) + 320 len 4], 232830643 + (32 * arg1.length) + 320] <= 4294967296 and mem[(32 * arg1.length) + 320 len 4], 232830643 + (32 * mem[mem[(32 * arg1.length) + 320 len 4], 232830643 + (32 * arg1.length) + 320]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + 320 len 4], 232830643 + (32 * arg1.length) + 320]
        _428 = mem[mem[(32 * arg1.length) + 320 len 4], 232830643 + (32 * arg1.length) + 384]
        mem[(32 * arg1.length) + ceil32(return_data.size) + 320] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + ceil32(return_data.size) + 324] = 10^18
        mem[(32 * arg1.length) + ceil32(return_data.size) + 356] = 64
        mem[(32 * arg1.length) + ceil32(return_data.size) + 388] = 2
        ...
        require mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 416]
        if mem[mem[(32 * arg1.length) + ceil32(return_data.size) + 320 len 4], 232830643 + (32 * arg1.length) + ceil32(return_data.size) + 384] * _428 / 10^18 > arg2 * sub_0ae8a68e:
            _1184 = mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 480]
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] = 0x7ff36ab500000000000000000000000000000000000000000000000000000000
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 420] = _1184
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 484] = this.address
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 516] = block.timestamp + 15
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 452] = 128
            mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 548] = arg1.length
            ...
            mem[64] = (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416
            require return_data.size >= 32
            require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1184) >> 32 <= 4294967296
            require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1184) >> 32 + 32 <= return_data.size
            require mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1184) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1184) >> 32 + (32 * mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1184) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
            require 1 < arg1.length
            mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 452] = -1
            require ext_code.size(mem[172 len 20])
            call mem[172 len 20].approve(address arg1, uint256 arg2) with:
            ...
            require mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
            require 1 < mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]
            _1752 = mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 480]
            mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 0] = None
            require ext_code.size(stor6)
            call stor6.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], _1752, Array(len=2, data=mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 64]), address(this.address), block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            revert with 0, 'err2'
        _1180 = mem[mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 416 len 4], 23283 + (32 * arg1.length) + (2 * ceil32(return_data.size)) + 480]
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] = 0x7ff36ab500000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 420] = _1180
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 484] = this.address
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 516] = block.timestamp + 15
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 452] = 128
        mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 548] = arg1.length
        ...
        mem[64] = (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416
        require return_data.size >= 32
        require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1180) >> 32 <= 4294967296
        require mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1180) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1180) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1180) >> 32 + (32 * mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _1180) >> 32 + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < arg1.length
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 452] = -1
        require ext_code.size(mem[172 len 20])
        call mem[172 len 20].approve(address arg1, uint256 arg2) with:
        ...
        require mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 416]
        _1748 = mem[mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (6 * ceil32(return_data.size)) + 480]
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 516] = this.address
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 548] = block.timestamp + 15
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 580] = 2
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 0] = None
        ...
        call stor6.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], _1748, Array(len=2, data=mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 612 len 64]), address(this.address), block.timestamp + 15
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 420] = msg.value
        ...
        require mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416]
        _2086 = mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, msg.value) >> 32 + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 480]
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416] = 0x7ff36ab500000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 420] = _2086 - (_2086 * arg3 / 1000)
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 484] = this.address
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 516] = block.timestamp + 15
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 452] = 128
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 548] = arg1.length
        ...
        mem[64] = (32 * arg1.length) + (10 * ceil32(return_data.size)) + 416
        require return_data.size >= 32
        require mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2086 - (_2086 * arg3 / 1000)) >> 32 <= 4294967296
        require mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2086 - (_2086 * arg3 / 1000)) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2086 - (_2086 * arg3 / 1000)) >> 32 + (32 * arg1.length) + (8 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2086 - (_2086 * arg3 / 1000)) >> 32 + (32 * mem[mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416 len 4], Mask(224, 32, _2086 - (_2086 * arg3 / 1000)) >> 32 + (32 * arg1.length) + (8 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
    require 1 < arg1.length
    require ext_code.size(mem[172 len 20])
    call mem[172 len 20].0x70a08231 with:
         gas gas_remaining wei
        args address(this.address), mem[(32 * arg1.length) + (10 * ceil32(return_data.size)) + 452 len 17 * ceil32(return_data.size)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(mem[172 len 20])
    call mem[172 len 20].0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, ext_call.return_data[0], mem[(32 * arg1.length) + (10 * ceil32(return_data.size)) + 484 len 17 * ceil32(return_data.size)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require 0 < arg1.length
    require 1 < arg1.length
    mem[(32 * arg1.length) + (10 * ceil32(return_data.size)) + 416] = mem[140 len 20]
    mem[(32 * arg1.length) + (10 * ceil32(return_data.size)) + 448] = mem[172 len 20]
    emit 0xa699432c: mem[(32 * arg1.length) + (10 * ceil32(return_data.size)) + 416 len 64], msg.value, ext_call.return_data[0], mem[(32 * arg1.length) + (10 * ceil32(return_data.size)) + 544 len 17 * ceil32(return_data.size)]
}
...
function sub_0b72b9e7(?) payable {
    ...
    if operatorAddress == msg.sender:
        ...
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 324] = ext_call.return_data[0]
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 356] = _2260
        ...
        call stor6.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], _2260, Array(len=arg1.length, data=mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 516 len (32 * arg1.length) + (9 * ceil32(return_data.size))]), address(this.address), block.timestamp + 15
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 320 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (32 * arg1.length) + (7 * ceil32(return_data.size)) + 320
        ...
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 452] = _3092
        ...
        require mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 320 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 320] <= 4294967296 and mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 320 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 320 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 320]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 320 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 320]
        _2268 = mem[mem[(32 * arg1.length) + (4 * ceil32(return_data.size)) + 320 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (4 * ceil32(return_data.size)) + 384]
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 320] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 324] = ext_call.return_data[0]
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 356] = _2268
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 420] = this.address
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 452] = block.timestamp + 15
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 388] = 160
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 484] = arg1.length
        ...
        call stor6.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], _2268, Array(len=arg1.length, data=mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 516 len (32 * arg1.length) + (9 * ceil32(return_data.size))]), address(this.address), block.timestamp + 15
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * arg1.length) + (6 * ceil32(return_data.size)) + 320 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (32 * arg1.length) + (7 * ceil32(return_data.size)) + 320
        ...
        require mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416] <= 4294967296 and mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416]) + 32 <= return_data.size
        require 1 < mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 416]
        _3100 = mem[mem[(32 * arg1.length) + (7 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + (32 * arg1.length) + (7 * ceil32(return_data.size)) + 480]
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 416] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 420] = ext_call.return_data[0]
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 452] = _3100
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 516] = this.address
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 548] = block.timestamp + 15
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 484] = 160
        mem[(32 * arg1.length) + (8 * ceil32(return_data.size)) + 580] = 2
