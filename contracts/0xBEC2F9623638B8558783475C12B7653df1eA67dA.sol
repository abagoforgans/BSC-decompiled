...
address sub_5e4940c6Address;
address sub_dc9f153bAddress;
uint256 buyFee;
uint256 sub_a6d4767a;
uint256 setFee;
mapping of uint256 stor11;
mapping of uint8 stor12;
uint256 rewardsFee;
uint256 sub_8c291661;
uint8 tradeEnabled;
...
function sub_5e4940c6(?) {
    return sub_5e4940c6Address
}
...
function sub_dc9f153b(?) {
    return sub_dc9f153bAddress
}
...
function sub_a6104794(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}

function sub_bb3d9b30(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}

function sub_d8f0c051(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}
...
function excludeWallet(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}
...
function blacklistAddress(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
}
...
function changeMaxWallet(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    setFee = arg1
                    ...
                    if 326159487 == setFee:
                        ...
                        if block.number - stor11[address(arg1)] < 2:
                            if not arg3:
                                ...
                                if arg3 and sub_a6d4767a > -1 / arg3:
                                    revert with 0, 17
                                if not arg3:
                                    revert with 0, 18
                                if arg3 * sub_a6d4767a / arg3 != sub_a6d4767a:
                                    revert with 0, 'SafeMath: multiplication overflow'
                                if arg3 * sub_a6d4767a / 100 > arg3:
                                    revert with 0, 'SafeMath: subtraction overflow', 0
                                if arg3 < arg3 * sub_a6d4767a / 100:
                                    revert with 0, 17
                                if not arg1:
                                    revert with 0, 'ERC20: transfer from the zero address'
                                if not this.address:
                                    revert with 0, 'ERC20: transfer to the zero address'
                                if arg3 * sub_a6d4767a / 100 > balanceOf[address(arg1)]:
                                    revert with 0, 32, 38, 0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, mem[358 len 26] >> 48, 0
                                if balanceOf[address(arg1)] < arg3 * sub_a6d4767a / 100:
                                    revert with 0, 17
                                balanceOf[address(arg1)] -= arg3 * sub_a6d4767a / 100
                                if balanceOf[this.address] > !(arg3 * sub_a6d4767a / 100):
                                    revert with 0, 17
                                if balanceOf[this.address] + (arg3 * sub_a6d4767a / 100) < balanceOf[this.address]:
                                    revert with 0, 'SafeMath: addition overflow'
                                balanceOf[address(this.address)] = balanceOf[this.address] + (arg3 * sub_a6d4767a / 100)
                                emit Transfer((arg3 * sub_a6d4767a / 100), arg1, this.address);
                                if not arg1:
                                    revert with 0, 'ERC20: transfer from the zero address'
                                if not arg2:
                                    revert with 0, 'ERC20: transfer to the zero address'
                                if arg3 - (arg3 * sub_a6d4767a / 100) > balanceOf[address(arg1)]:
                                    revert with 0, 32, 38, 0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, mem[454 len 26] >> 48, 0
                                if balanceOf[address(arg1)] < arg3 - (arg3 * sub_a6d4767a / 100):
                                    revert with 0, 17
                                balanceOf[address(arg1)] = balanceOf[address(arg1)] - arg3 + (arg3 * sub_a6d4767a / 100)
                                if balanceOf[arg2] > !(arg3 - (arg3 * sub_a6d4767a / 100)):
                                    revert with 0, 17
                                if balanceOf[arg2] + arg3 - (arg3 * sub_a6d4767a / 100) < balanceOf[arg2]:
                                    revert with 0, 'SafeMath: addition overflow'
                                balanceOf[address(arg2)] = balanceOf[arg2] + arg3 - (arg3 * sub_a6d4767a / 100)
                                emit Transfer((arg3 - (arg3 * sub_a6d4767a / 100)), arg1, arg2);
                            if arg3 > allowance[address(arg1)][msg.sender]:
...
function _fallback() payable {
    ...
    if unknown_0x7d1db4a5(?????) <= uint32(call.func_hash) >> 224:
        if unknown_0xbb3d9b30(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xdd62ed3e(?????) > uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != unknown_0xbb3d9b30(?????):
                    if uint32(call.func_hash) >> 224 != unknown_0xd543dbeb(?????):
                        if unknown_0xd621e813(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            return bool(tradeEnabled)
                        if uint32(call.func_hash) >> 224 != unknown_0xd8f0c051(?????):
                            require unknown_0xdc9f153b(?????) == uint32(call.func_hash) >> 224
                            require not msg.value
                            return sub_dc9f153bAddress
                require not msg.value
                require calldata.size - 4 >= 32
                ...
                if unknown_0xdd62ed3e(?????) == uint32(call.func_hash) >> 224:
                    ...
                    return allowance[address(arg1)][address(arg2)]
                if unknown_0xea497b79(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 32
                    if owner != msg.sender:
                        revert with 0, 'Ownable: caller is not the owner'
                    ...
                    if unknown_0xf275f64b(?????) == uint32(call.func_hash) >> 224:
                        ...
                        if uint32(call.func_hash) >> 224 != unknown_0xf2fde38b(?????):
                            require unknown_0xff029d1d(?????) == uint32(call.func_hash) >> 224
                            require not msg.value
                            require calldata.size - 4 >= 32
                            if owner != msg.sender:
                                revert with 0, 'Ownable: caller is not the owner'
        ...
        if unknown_0x9a8baedf(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x7d1db4a5(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return _maxTxAmount
            if unknown_0x8c291661(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return sub_8c291661
        ...
        if unknown_0xa457c2d7(?????) == uint32(call.func_hash) >> 224:
            ...
            if unknown_0xa6104794(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 32
                if owner != msg.sender:
                    revert with 0, 'Ownable: caller is not the owner'
            if unknown_0xa6d4767a(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return sub_a6d4767a
            ...
            if not arg2:
                ...
                if sub_5e4940c6Address == msg.sender:
                    if not stor11[address(arg1)]:
                        stor11[address(arg1)] = block.number
                else:
                    if sub_dc9f153bAddress == msg.sender:
                        if not stor11[address(arg1)]:
                            stor11[address(arg1)] = block.number
                if stor12[address(arg1)]:
                    if not msg.sender:
                    ...
                    if stor12[address(msg.sender)]:
                        ...
                        if sub_5e4940c6Address == address(arg1):
                            if 326159487 == setFee:
                                if not tradeEnabled:
                                    revert with 0, 'Trade is disabled'
                                if setFee < 326159389:
                                ...
                                if block.number - stor11[address(msg.sender)] < 2:
                                    if not arg2:
                                        ...
                                        if arg2 and sub_a6d4767a > -1 / arg2:
                                            revert with 0, 17
                                        if not arg2:
                                            revert with 0, 18
                                        if arg2 * sub_a6d4767a / arg2 != sub_a6d4767a:
                                            revert with 0, 'SafeMath: multiplication overflow'
                                        if arg2 * sub_a6d4767a / 100 > arg2:
                                            revert with 0, 'SafeMath: subtraction overflow', 0
                                        if arg2 < arg2 * sub_a6d4767a / 100:
                                            revert with 0, 17
                                        if not msg.sender:
                                            revert with 0, 'ERC20: transfer from the zero address'
                                        if not this.address:
                                            revert with 0, 'ERC20: transfer to the zero address'
                                        if arg2 * sub_a6d4767a / 100 > balanceOf[address(msg.sender)]:
                                            revert with 0, 32, 38, 0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, mem[390 len 26] >> 48, 0
                                        if balanceOf[address(msg.sender)] < arg2 * sub_a6d4767a / 100:
                                            revert with 0, 17
                                        balanceOf[address(msg.sender)] -= arg2 * sub_a6d4767a / 100
                                        if balanceOf[this.address] > !(arg2 * sub_a6d4767a / 100):
                                            revert with 0, 17
                                        if balanceOf[this.address] + (arg2 * sub_a6d4767a / 100) < balanceOf[this.address]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[address(this.address)] = balanceOf[this.address] + (arg2 * sub_a6d4767a / 100)
                                        emit Transfer((arg2 * sub_a6d4767a / 100), msg.sender, this.address);
                                        if not msg.sender:
                                            revert with 0, 'ERC20: transfer from the zero address'
                                        if not address(arg1):
                                            revert with 0, 'ERC20: transfer to the zero address'
                                        if arg2 - (arg2 * sub_a6d4767a / 100) > balanceOf[address(msg.sender)]:
                                            revert with 0, 32, 38, 0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, mem[486 len 26] >> 48, 0
                                        if balanceOf[address(msg.sender)] < arg2 - (arg2 * sub_a6d4767a / 100):
                                            revert with 0, 17
                                        balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - arg2 + (arg2 * sub_a6d4767a / 100)
                                        if balanceOf[address(arg1)] > !(arg2 - (arg2 * sub_a6d4767a / 100)):
                                            revert with 0, 17
                                        if balanceOf[address(arg1)] + arg2 - (arg2 * sub_a6d4767a / 100) < balanceOf[address(arg1)]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (arg2 * sub_a6d4767a / 100)
                                        emit Transfer((arg2 - (arg2 * sub_a6d4767a / 100)), msg.sender, address(arg1));
                                else:
                                    if stor11[address(msg.sender)] > block.number:
                                        revert with 0, 'SafeMath: subtraction overflow', 0
                                    if block.number < stor11[address(msg.sender)]:
                            ...
                            if sub_dc9f153bAddress != address(arg1):
                                if sub_5e4940c6Address == msg.sender:
                                    if not arg2:
                                        if 0 > arg2:
                                            revert with 0, 'SafeMath: subtraction overflow', 0
        ...
        if unknown_0x313ce567(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0x5e4940c6(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0x5e4940c6(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return sub_5e4940c6Address
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x39509351(?????):
                if unknown_0x3d18678e(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x460fb492(?????):
                        require unknown_0x47062402(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        return buyFee
                    require not msg.value
                    require calldata.size - 4 >= 32
            ...
            if unknown_0x1fbe1979(?????) > uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != name():
                    if uint32(call.func_hash) >> 224 != approve(address arg1, uint256 arg2):
                        if changeMaxWallet(uint256 arg1) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            require calldata.size - 4 >= 32
                            if owner != msg.sender:
                                revert with 0, 'Ownable: caller is not the owner'
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x23b872dd(?????):
                if uint32(call.func_hash) >> 224 != unknown_0x266388c4(?????):
                    if unknown_0x2bb14e1d(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        return rewardsFee
                    require unknown_0x2ded3227(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    return setFee
                require not msg.value
                require calldata.size - 4 >= 64
            ...
            if not arg3:
                ...
                if stor12[address(arg2)]:
                    ...
                    if stor12[address(arg1)]:
                        ...
                        if sub_5e4940c6Address == address(arg2):
                            if 326159487 == setFee:
                                if not tradeEnabled:
                                    revert with 0, 'Trade is disabled'
                                if setFee < 326159389:
                                ...
                                if block.number - stor11[address(arg1)] < 2:
                                    if not arg3:
                                        ...
                                        if balanceOf[this.address] + (arg3 * sub_a6d4767a / 100) < balanceOf[this.address]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[address(this.address)] = balanceOf[this.address] + (arg3 * sub_a6d4767a / 100)
                                        emit Transfer((arg3 * sub_a6d4767a / 100), address(arg1), this.address);
                                        if not address(arg1):
                                            revert with 0, 'ERC20: transfer from the zero address'
                                        if not address(arg2):
                                            revert with 0, 'ERC20: transfer to the zero address'
                                        ...
                                        if balanceOf[address(arg1)] < arg3 - (arg3 * sub_a6d4767a / 100):
                                            revert with 0, 17
                                        balanceOf[address(arg1)] = balanceOf[address(arg1)] - arg3 + (arg3 * sub_a6d4767a / 100)
                                        if balanceOf[address(arg2)] > !(arg3 - (arg3 * sub_a6d4767a / 100)):
                                            revert with 0, 17
                                        if balanceOf[address(arg2)] + arg3 - (arg3 * sub_a6d4767a / 100) < balanceOf[address(arg2)]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (arg3 * sub_a6d4767a / 100)
                                        emit Transfer((arg3 - (arg3 * sub_a6d4767a / 100)), address(arg1), address(arg2));
                                    if arg3 > allowance[address(arg1)][msg.sender]:
                            ...
                            if sub_dc9f153bAddress != address(arg2):
                                if sub_5e4940c6Address == address(arg1):
                                    if not arg3:
                                        if 0 > arg3:
                                            revert with 0, 'SafeMath: subtraction overflow', 0
