...
function sub_3247d940(?) payable {
    ...
    if ('cd', 4).length:
        mem[128 len 32 * ('cd', 4).length] = code.data[11950 len 32 * ('cd', 4).length]
...
function sub_89b27b0b(?) payable {
    if not stor0.length:
        ...
        return 128, 
               ...
               mem[256 len 3968]
    mem[96] = stor0.length
    mem[128 len 32 * stor0.length] = code.data[11950 len 32 * stor0.length]
    mem[(32 * stor0.length) + 128] = stor0.length
    mem[(32 * stor0.length) + 160 len 32 * stor0.length] = code.data[11950 len 32 * stor0.length]
    mem[(64 * stor0.length) + 160] = stor0.length
    mem[(64 * stor0.length) + 192 len 32 * stor0.length] = code.data[11950 len 32 * stor0.length]
    mem[(98 * stor0.length) + 192] = stor0.length
    mem[64] = (131 * stor0.length) + 224
    mem[(98 * stor0.length) + 224 len 32 * stor0.length] = code.data[11950 len 32 * stor0.length]
    idx = 0
    ...
    while idx < _68:
        ...
        t = t + 32
        continue 
    mem[mem[64] + 64] = (32 * _45) + (32 * _68) + 192
    _82 = mem[(64 * stor0.length) + 160]
    mem[mem[64] + (32 * _45) + (32 * _68) + 192] = mem[(64 * stor0.length) + 160]
    mem[mem[64] + (32 * _45) + (32 * _68) + 224 len 32 * _82] = mem[(64 * stor0.length) + 192 len 32 * _82]
    mem[mem[64] + 96] = (32 * _45) + (32 * _68) + (32 * _82) + 224
    _90 = mem[(98 * stor0.length) + 192]
    mem[mem[64] + (32 * _45) + (32 * _68) + (32 * _82) + 224] = mem[(98 * stor0.length) + 192]
    mem[mem[64] + (32 * _45) + (32 * _68) + (32 * _82) + 256 len 32 * _90] = mem[(98 * stor0.length) + 224 len 32 * _90]
    return 128, 
           (32 * _45) + 160,
           (32 * _45) + (32 * _68) + 192,
           (32 * _45) + (32 * _68) + (32 * _82) + 224,
           mem[mem[64] + 128 len (32 * _45) + (32 * _68) + (32 * _82) + (32 * _90) + 128]
}
