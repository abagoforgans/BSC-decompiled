...
function safeMint(address arg1) payable {
    ...
    if not var49001:
        if var49002 <= 0:
            revert with 0, 'tokenId error'
        if ownerOf[var49002]:
            revert with 0, 'nonexistent token'
        stor11 = var49002
        if mintTotal > -2:
            revert with 'NH{q', 17
        if mintTotal + 1 > totalSupply:
            revert with 0, 'Token is full'
        if mintTotal > -2:
            revert with 'NH{q', 17
        mintTotal++
        if not arg1:
        ...
        stor9[var49002] = tokenByIndex.length
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length] = var49002
        if arg1:
            tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)]] = var49002
            stor7[var49002] = balanceOf[address(arg1)]
        else:
            if tokenByIndex.length < 1:
                revert with 'NH{q', 17
            if tokenByIndex.length - 1 >= tokenByIndex.length:
                revert with 'NH{q', 50
            if stor9[var49002] >= tokenByIndex.length:
                revert with 'NH{q', 50
            tokenByIndex[stor9[var49002]] = tokenByIndex[tokenByIndex.length]
            stor9[stor8[stor8.length]] = stor9[var49002]
            stor9[var49002] = 0
            if not tokenByIndex.length:
                revert with 'NH{q', 49
            tokenByIndex[tokenByIndex.length] = 0
        ...
        if balanceOf[address(arg1)] > -2:
            revert with 'NH{q', 17
        balanceOf[address(arg1)]++
        ownerOf[var49002] = arg1
        emit Transfer(0, arg1, var49002);
        if ext_code.size(arg1) > 0:
            require ext_code.size(arg1)
            call arg1.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, uint32(msg.sender), 0, var49002, 128, 0
            if not ext_call.success:
                if not return_data.size:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                if not return_data.size:
    ...
    if var75001:
        ...
        if ownerOf[var75002]:
            revert with 0, 'ERC721: token already minted'
        stor9[var75002] = tokenByIndex.length
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length] = var75002
        if arg1:
            tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)]] = var75002
            stor7[var75002] = balanceOf[address(arg1)]
        else:
            if tokenByIndex.length < 1:
                revert with 'NH{q', 17
            if tokenByIndex.length - 1 >= tokenByIndex.length:
                revert with 'NH{q', 50
            if stor9[var75002] >= tokenByIndex.length:
                revert with 'NH{q', 50
            tokenByIndex[stor9[var75002]] = tokenByIndex[tokenByIndex.length]
            stor9[stor8[stor8.length]] = stor9[var75002]
            stor9[var75002] = 0
            if not tokenByIndex.length:
                revert with 'NH{q', 49
            tokenByIndex[tokenByIndex.length] = 0
        ...
        if balanceOf[address(arg1)] > -2:
            revert with 'NH{q', 17
        balanceOf[address(arg1)]++
        ownerOf[var75002] = arg1
        emit Transfer(0, arg1, var75002);
        if ext_code.size(arg1) > 0:
            require ext_code.size(arg1)
            call arg1.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, uint32(msg.sender), 0, var75002, 128, 0
            if not ext_call.success:
                if not return_data.size:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                if not return_data.size:
