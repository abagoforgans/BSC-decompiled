...
function rewardOf(address arg1) payable {
    ...
    if stakeOf[address(arg1)]:
        return (stor1[address(arg1)] + ((block.timestamp * stakeOf[address(arg1)]) - (stor2[address(arg1)] * stakeOf[address(arg1)]) / 300000))
    else:
        return 0
}
...
function harvest() payable {
    ...
    call stor14.0xae2fe633 with:
        ...
        args msg.sender, stor1[address(msg.sender)] + ((block.timestamp * stakeOf[address(msg.sender)]) - (stor2[address(msg.sender)] * stakeOf[address(msg.sender)]) / 300000)
...
function stake(uint256 arg1) payable {
    ...
    if stakeOf[address(msg.sender)] > 0:
        stor1[address(msg.sender)] += (block.timestamp * stakeOf[address(msg.sender)]) - (stor2[address(msg.sender)] * stakeOf[address(msg.sender)]) / 300000
