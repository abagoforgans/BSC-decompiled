...
function sub_cd8472a5(?) {
    require msg.sender == erc677token['owner']
    require ext_code.size(erc677token[Mask(88, 0, 'erc677token', 0)])
    call erc677token[Mask(88, 0, 'erc677token', 0)].setBurnRate(uint256 rg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function addWhitelistedAddress(address arg1) {
    require msg.sender == erc677token['owner']
    require ext_code.size(erc677token[Mask(88, 0, 'erc677token', 0)])
    call erc677token[Mask(88, 0, 'erc677token', 0)].0x46b26646 with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeWhitelistedAddress(address arg1) {
    require msg.sender == erc677token['owner']
    require ext_code.size(erc677token[Mask(88, 0, 'erc677token', 0)])
    call erc677token[Mask(88, 0, 'erc677token', 0)].0x6d57487c with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
