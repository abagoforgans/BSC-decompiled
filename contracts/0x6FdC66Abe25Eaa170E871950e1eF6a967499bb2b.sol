...
#
const name = 'METAVERSAGE', 0

const totalSupply = 10000000000 * 10^18

const decimals = 18

const symbol = 'MSAGE', 0
...
function getCirculatingSupply() {
    if balanceOf[57005] > 10000000000 * 10^18:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if 10000000000 * 10^18 < balanceOf[57005]:
        revert with 'NH{q', 17
    if balanceOf[0] > -balanceOf[57005] + 10000000000 * 10^18:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if -balanceOf[57005] + 10000000000 * 10^18 < balanceOf[0]:
        revert with 'NH{q', 17
    return (-balanceOf[57005] + -balanceOf[0] + 10000000000 * 10^18)
}
...
function setBuyFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    if arg4 < 0:
        revert with 0, 'SafeMath: addition overflow'
    if arg1 + arg3 + arg4 > -arg2 - 1:
        revert with 'NH{q', 17
    if arg2 < 0:
        revert with 0, 'SafeMath: addition overflow'
    stor14 = arg1 + arg3 + arg4 + arg2
    stor25 = arg5
}
...
function getTotalFee(bool arg1) {
    ...
    if block.timestamp < launchTimestamp:
        revert with 'NH{q', 17
    if block.timestamp - launchTimestamp >= stor27:
        if not arg1:
            return stor14
    else:
        if not arg1:
