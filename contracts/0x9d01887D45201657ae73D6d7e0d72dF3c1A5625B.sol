...
address stor31;
address stor32;
mapping of uint256 sub_acdb33ae;
...
function sub_7f3f8677(?) payable {
    return sub_7f3f8677[address(msg.sender)]
}
...
function sub_acdb33ae(?) payable {
    return sub_acdb33ae[address(msg.sender)]
}
...
function sub_555054b1(?) payable {
    if not sub_acdb33ae[msg.sender]:
        revert with 0, 'No Tokens to be Claimed !'
    call stor32.0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, sub_acdb33ae[msg.sender]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    sub_acdb33ae[address(msg.sender)] = 0
}
...
function sub_354f4aaf(?) payable {
    if not sub_7f3f8677[msg.sender]:
        revert with 0, 'No Tokens to be Claimed !'
    if not tokenPrice:
        revert with 0, 18
    if sub_7f3f8677[address(msg.sender)] / tokenPrice > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    call stor32.0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, 10^18 * sub_7f3f8677[address(msg.sender)] / tokenPrice
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    sub_7f3f8677[address(msg.sender)] = 0
}
...
function sub_78abf992(?) payable {
    ...
    stor5[arg1] = 0
    emit 0xfe7cc135: arg1
    if sub_eb19feac[stor18[arg1]]:
        if 168 * 24 * 3600 > !sub_eb19feac[stor18[arg1]]:
            revert with 0, 17
        if block.timestamp < sub_eb19feac[stor18[arg1]] + (168 * 24 * 3600):
            revert with 0, 'time restricted'
    if arg2 > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    if sub_acdb33ae[stor18[arg1]] > !(10^18 * arg2):
        revert with 0, 17
    if sub_acdb33ae[stor18[arg1]] + (10^18 * arg2) < sub_acdb33ae[stor18[arg1]]:
        revert with 0, 'SafeMath: addition overflow'
    sub_acdb33ae[stor18[arg1]] += 10^18 * arg2
...
function sub_62af1d6c(?) payable {
    ...
    stor5[arg1] = 0
    emit 0xfe7cc135: arg1
    if sub_5abbb528[stor18[arg1]]:
        if 36 * 3600 > !sub_5abbb528[stor18[arg1]]:
            revert with 0, 17
        if block.timestamp < sub_5abbb528[stor18[arg1]] + (36 * 3600):
            revert with 0, 'time restricted'
    if arg2 > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    ...
    if 10^18 * arg2 / tokenPrice > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    if sub_acdb33ae[stor18[arg1]] > !(10^18 * 10^18 * arg2 / tokenPrice):
        revert with 0, 17
    if sub_acdb33ae[stor18[arg1]] + (10^18 * 10^18 * arg2 / tokenPrice) < sub_acdb33ae[stor18[arg1]]:
        revert with 0, 'SafeMath: addition overflow'
    sub_acdb33ae[stor18[arg1]] += 10^18 * 10^18 * arg2 / tokenPrice
...
function sub_61e7f8bf(?) payable {
    ...
    while idx < ('cd', 36).length:
        ...
        mem[32] = 34
        sub_7f3f8677[mem[(32 * idx) + 140 len 20]] = mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129]
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        continue 
...
function sub_e20ef1dd(?) payable {
    ...
    while idx < ('cd', 36).length:
        ...
        mem[0] = mem[(32 * idx) + 140 len 20]
        mem[32] = 33
        sub_acdb33ae[mem[(32 * idx) + 140 len 20]] = mem[(32 * idx) + ceil32(32 * ('cd', 4).length) + 129]
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        continue 
...
function sub_0375aab3(?) payable {
    if bool(stor24.length):
        ...
        if ceil32(uint255(stor24.length) * 0.5) > uint255(stor24.length) * 0.5:
            mem[ceil32(uint255(stor24.length) * 0.5) + (uint255(stor24.length) * 0.5) + 192] = 0
