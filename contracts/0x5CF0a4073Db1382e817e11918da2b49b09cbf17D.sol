    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = approve(address rg1, uint256 rg2), 0xe7f9a439aa7292719ac81779, 0, ext_call.return_data[0 len 28]
                mem[488 len 0] = 0
            call wantAddress.0x35934aaf with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.return_data[0]:
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), 0xe7f9a439aa7292719ac81779, 0, ext_call.return_data[0 len 28]
