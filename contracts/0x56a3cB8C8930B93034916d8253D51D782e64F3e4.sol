...
function sub_e0d380e5(?) payable {
    ...
    mem[196] = arg1
    mem[228] = 0
    mem[292] = 0xd99634869e239b4ffc3b4071f806a020c1fcbe9
    mem[324] = block.timestamp + 500
    mem[260] = 160
    mem[356] = 2
    mem[388 len 0] = None
    ...
    call pancakeRouterAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg1, 0, 160, 0xd99634869e239b4ffc3b4071f806a020c1fcbe9, block.timestamp + 500, 2, mem[388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
