...
function sub_906731d2(?) payable {
    ...
    while idx < arg1.length:
        ...
        mem[64] = mem[64] + 96
        mem[_37] = 38
        mem[_37 + 32 len 38] = 0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63
        mem[32] = 1
        if _36 > balanceOf[address(msg.sender)]:
            _41 = mem[64]
            ...
            idx = 0
            while idx < 38:
                mem[_41 + idx + 68] = mem[_37 + idx + 32]
                idx = idx + 32
                continue 
            mem[_41 + 100] = mem[_41 + 126 len 6]
            revert with memory
              from mem[64]
               len _41 + -mem[64] + 132
        balanceOf[address(msg.sender)] -= _36
        require idx < mem[(32 * arg1.length) + 128]
        require idx < mem[96]
        ...
        emit Transfer(mem[mem[64]], msg.sender, address(_60));
        idx = idx + 1
        continue 
    return 1
}
