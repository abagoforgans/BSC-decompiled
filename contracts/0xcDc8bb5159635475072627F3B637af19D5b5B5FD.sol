    ...
    while idx < poolInfo.length:
        ...
        if block.number <= bonusEndBlock:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _584 + 68] = mem[idx + _570 + 32]
                        idx = idx + 32
                        continue 
                    mem[_584 + 68] = mem[_584 + 74 len 26]
                    revert with memory
                      from mem[64]
                       len _584 + -mem[64] + 100
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _720 + 68] = mem[idx + _681 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _746 + 68] = mem[idx + _699 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER):
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _594 + 68] = mem[idx + _577 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _743 + 68] = mem[idx + _698 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _773 + 68] = mem[idx + _719 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * BONUS_MULTIPLIER * cakePerBlock) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * cakePerBlock):
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _770 + 68] = mem[idx + _718 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _794 + 68] = mem[idx + _742 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _611 + 68] = mem[idx + _593 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * BONUS_MULTIPLIER * cakePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * cakePerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _791 + 68] = mem[idx + _741 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _807 + 68] = mem[idx + _769 + 32]
                idx = idx + 32
                continue 
        ...
        if poolInfo[idx].field_512 >= bonusEndBlock:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _564 + 68] = mem[idx + _559 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _660 + 68] = mem[idx + _643 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _676 + 68] = mem[idx + _652 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * cakePerBlock) - (poolInfo[idx].field_512 * cakePerBlock):
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _567 + 68] = mem[idx + _562 + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _673 + 68] = mem[idx + _651 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _692 + 68] = mem[idx + _659 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _571 + 68] = mem[idx + _563 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * cakePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * cakePerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _689 + 68] = mem[idx + _658 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _709 + 68] = mem[idx + _672 + 32]
                idx = idx + 32
                continue 
            mem[_709 + 68] = mem[_709 + 74 len 26]
            revert with memory
              from mem[64]
               len _709 + -mem[64] + 100
        _500 = mem[64]
        ...
        if not bonusEndBlock - poolInfo[idx].field_512:
            ...
            if not block.number - bonusEndBlock:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _655 + 68] = mem[idx + _640 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _887 + 68] = mem[idx + _861 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * cakePerBlock) - (bonusEndBlock * cakePerBlock):
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _884 + 68] = mem[idx + _860 + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _900 + 68] = mem[idx + _872 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _685 + 68] = mem[idx + _654 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * cakePerBlock * poolInfo[idx].field_256) - (bonusEndBlock * cakePerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _897 + 68] = mem[idx + _871 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _911 + 68] = mem[idx + _883 + 32]
                idx = idx + 32
                continue 
        ...
        if not block.number - bonusEndBlock + (bonusEndBlock * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER):
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _666 + 68] = mem[idx + _647 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not 0 / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _880 + 68] = mem[idx + _857 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _894 + 68] = mem[idx + _870 + 32]
                idx = idx + 32
                continue 
        ...
        if not (block.number * cakePerBlock) - (bonusEndBlock * cakePerBlock) + (bonusEndBlock * BONUS_MULTIPLIER * cakePerBlock) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * cakePerBlock):
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _682 + 68] = mem[idx + _653 + 32]
                    idx = idx + 32
                    continue 
            ...
            if not 0 / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _891 + 68] = mem[idx + _869 + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[idx + _907 + 68] = mem[idx + _879 + 32]
                idx = idx + 32
                continue 
        ...
        if not totalAllocPoint:
            ...
            idx = 0
            while idx < 26:
                mem[idx + _700 + 68] = mem[idx + _665 + 32]
                idx = idx + 32
                continue 
        ...
        if not (block.number * cakePerBlock * poolInfo[idx].field_256) - (bonusEndBlock * cakePerBlock * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * cakePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * cakePerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            ...
            idx = 0
            while idx < 26:
                mem[idx + _904 + 68] = mem[idx + _878 + 32]
                idx = idx + 32
                continue 
        ...
        idx = 0
        while idx < 26:
            mem[idx + _918 + 68] = mem[idx + _890 + 32]
            idx = idx + 32
            continue 
