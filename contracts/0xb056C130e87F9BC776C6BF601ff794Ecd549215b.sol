...
function sub_66afd595(?) payable {
    ...
    call sub_fa11e27c[arg1].field_1024.transferFrom(address arg1, address arg2, uint256 arg3) with:
...
function sub_2532f1e8(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if sub_f5db18a9[mem[(32 * idx) + 128]].field_768 == sub_fa11e27c[stor102[mem[(32 * idx) + 128]].field_256].field_2816:
            ...
            mem[mem[64]] = 2
            mem[64] = mem[64] + 96
            mem[_94 + 32 len 64] = call.data[calldata.size len 64]
            if sub_fa11e27c[stor1[_86]][8][1].field_0 + sub_fa11e27c[stor1[_86]][8][2].field_0:
                mem[0] = 1
                mem[32] = sha3(stor1[_86], 101) + 8
                if not sub_fa11e27c[stor1[_86]][8][1].field_0:
                    if 0 >= mem[_94]:
                        revert with 0, 50
                    mem[_94 + 32] = 0
                else:
                    mem[0] = 1
                    mem[32] = sha3(stor1[_86], 101) + 8
                    if sub_fa11e27c[stor1[_86]][8][1].field_0 + sub_fa11e27c[stor1[_86]][8][2].field_0 > 0x44b82fa09b5a52cb98b405447c4a98187eebb22f008d5d64f9c394ae9:
                        revert with 0, 17
                    if not sub_fa11e27c[stor1[_86]][8][1].field_0:
                        revert with 0, 18
                    if 0 >= mem[_94]:
                        revert with 0, 50
                    mem[_94 + 32] = (10^9 * sub_fa11e27c[stor1[_86]][8][1].field_0) + (10^9 * sub_fa11e27c[stor1[_86]][8][2].field_0) / sub_fa11e27c[stor1[_86]][8][1].field_0
                mem[0] = 2
                mem[32] = sha3(stor1[_86], 101) + 8
                if 0 == sub_fa11e27c[stor1[_86]][8][2].field_0:
                    if 1 >= mem[_94]:
                        revert with 0, 50
                    mem[_94 + 64] = 0
                else:
                    ...
                    if sub_fa11e27c[stor1[_86]][8][1].field_0 + sub_fa11e27c[stor1[_86]][8][2].field_0 > 0x44b82fa09b5a52cb98b405447c4a98187eebb22f008d5d64f9c394ae9:
                        revert with 0, 17
                    if not sub_fa11e27c[stor1[_86]][8][2].field_0:
                        revert with 0, 18
                    if 1 >= mem[_94]:
                        revert with 0, 50
                    mem[_94 + 64] = (10^9 * sub_fa11e27c[stor1[_86]][8][1].field_0) + (10^9 * sub_fa11e27c[stor1[_86]][8][2].field_0) / sub_fa11e27c[stor1[_86]][8][2].field_0
            if stor3[_86] < 1:
                revert with 0, 17
            if stor3[_86] - 1 >= mem[_94]:
                revert with 0, 50
            if stor4[_86] and mem[(32 * stor3[_86] - 1) + _94 + 32] > -1 / stor4[_86]:
                revert with 0, 17
            if 0 > !(stor4[_86] * mem[(32 * stor3[_86] - 1) + _94 + 32] / 10^9):
                revert with 0, 17
            mem[0] = stor1[_86]
            mem[32] = 101
        if idx == -1:
...
function sub_3d695c52(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        require ext_code.size(sub_fa11e27c[stor1[_138]].field_1024)
        call sub_fa11e27c[stor1[_138]].field_1024.transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
