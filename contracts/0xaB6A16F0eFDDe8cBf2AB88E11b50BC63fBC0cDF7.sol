...
function init(uint8 arg1) payable {
    ...
    if adminAddress != msg.sender:
        revert with 0, 'only admin can do this!'
    require ext_code.size(0x637d9c7d4851f777fecb40b9be0f155978c12af8)
    delegate 0x637d9c7d4851f777fecb40b9be0f155978c12af8.0x73cf14bd with:
...
function sub_8c825ce8(?) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x637d9c7d4851f777fecb40b9be0f155978c12af8)
    delegate 0x637d9c7d4851f777fecb40b9be0f155978c12af8.0x80ff93e4 with:
         gas gas_remaining wei
    ...
    require ext_code.size(0x637d9c7d4851f777fecb40b9be0f155978c12af8)
    delegate 0x637d9c7d4851f777fecb40b9be0f155978c12af8.0xa74b0fff with:
         gas gas_remaining wei
...
function sub_3feb3fa1(?) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xd5abce396baec1d84db6379bacb42055ac5b020e)
    delegate 0xd5abce396baec1d84db6379bacb42055ac5b020e.0x3d37f8b2 with:
         gas gas_remaining wei
...
function sub_851a6b0f(?) payable {
    ...
    if delegate.return_data[0]:
        require ext_code.size(0x637d9c7d4851f777fecb40b9be0f155978c12af8)
        delegate 0x637d9c7d4851f777fecb40b9be0f155978c12af8.0xea71c720 with:
             gas gas_remaining wei
...
function sub_e0627ed2(?) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(0x637d9c7d4851f777fecb40b9be0f155978c12af8)
    delegate 0x637d9c7d4851f777fecb40b9be0f155978c12af8.0x8c5494df with:
         gas gas_remaining wei
        args 0, 10^18, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_96e973f5(?) payable {
    ...
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0x508537afa509eb8859d5503da3fe669d17b2f911)
    delegate 0x508537afa509eb8859d5503da3fe669d17b2f911.0xf7c99fe with:
         gas gas_remaining wei
    ...
    require return_data.size >= 32
    require ext_code.size(0xd5abce396baec1d84db6379bacb42055ac5b020e)
    delegate 0xd5abce396baec1d84db6379bacb42055ac5b020e.0xb0ed1d3a with:
         gas gas_remaining wei
        args 0, delegate.return_data[0]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
