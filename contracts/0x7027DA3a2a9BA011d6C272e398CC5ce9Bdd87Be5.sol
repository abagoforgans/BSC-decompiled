...
const InitialSupply = 6000000000000 * 10^18

const BalanceLimitDivider = 34
...
function getBurnedTokens() {
    if 6000000000000 * 10^18 < totalSupply:
        revert with 0, 17
    return (-totalSupply + 6000000000000 * 10^18 / 10^9)
}

function sub_c9f26fc6(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor20 = arg1
...
function sub_7a75bf39(?) {
    require calldata.size - 4 >= 32
    require arg1 == bool(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(208, 0, stor19.field_48) = Mask(208, 0, bool(arg1))
}
...
function TeamCreateLPandBNB() {
    ...
    if uint8(stor19.field_32) > -uint8(stor19.field_40) + 255:
        revert with 0, 17
    if balanceOf[this.address] >= 15000000000 * 10^18:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            if uint8(stor19.field_32) > 0x548291fb81004359d94389cf5d82c6a97cf43caad:
                revert with 0, 17
            if not uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 18
            if 15000000000 * 10^18 < 15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 17
            if 15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) < 15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2:
                revert with 0, 17
            if (15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > !(-(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) + 15000000000 * 10^18):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not stor22:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor22].field_0 = -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18
            emit Approval((-(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18), this.address, stor22);
            ...
            mem[ceil32(return_data.size) + 196] = -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18
            idx = 0
            s = 128
            ...
            call stor22.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18:
                revert with 0, 18
            if totalLPBNB > !(0 / -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18):
                revert with 0, 17
            totalLPBNB += 0 / -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18
            if not this.address:
                revert with 0, 'Approve from zero'
            if not stor22:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor22].field_0 = 15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][stor22].field_255 = 0
            emit Approval((15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, stor22);
            require ext_code.size(stor22)
            call stor22.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18 wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, 15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
