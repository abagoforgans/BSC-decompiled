    ...
    if ext_call.return_data[0] >= arg1:
        if not withdrawalFee:
            ...
            call wantAddress with:
               funct uint32(stor3)
                 gas gas_remaining wei
                args Mask(480, -256, transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0) << 256, mem[324 len 4]
            if not return_data.size:
                if not ext_call.success:
            ...
            if not arg1:
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0
                call wantAddress with:
                   funct uint32(stor3)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 489 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, withdrawalFee * arg1 / 10000) >> 32
                mem[388 len 0] = 0
                call wantAddress with:
                   funct uint32(stor3)
                     gas gas_remaining wei
        ...
        if not withdrawalFee:
            ...
            call wantAddress with:
               funct uint32(stor3)
                 gas gas_remaining wei
                args Mask(480, -256, transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0) << 256, mem[388 len 4]
            if not return_data.size:
                require not ext_call.success
            ...
            if arg1:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, withdrawalFee * arg1 / 10000) >> 32
                call wantAddress with:
                   funct uint32(stor3)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0
                mem[452 len 0] = 0
                call wantAddress with:
                   funct uint32(stor3)
                     gas gas_remaining wei
                    args Mask(480, -256, transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), 0) << 256, mem[452 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: subtraction overflow'
                mem[420 len return_data.size] = ext_call.return_data[0 len return_data.size]
