...
function decreaseAllowance(address arg1, uint256 arg2) payable {
    ...
    if arg2 > allowance[address(msg.sender)][address(arg1)]:
        revert with 0, 'decreased allowance below zero', 0
...
function sub_7fba0ef1(?) payable {
    if block.timestamp < stor11:
        revert with 0, 'Can't release roy tokens yet'
    if uint8(stor4.field_8):
        revert with 0, 'Royaltiz tokens already released'
    Mask(248, 0, stor4.field_8) = 1
    if not stor6:
        revert with 0, 'mint to the zero address'
    if totalSupply > -stor10 - 1:
        revert with 'NH{q', 17
    if totalSupply + stor10 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += stor10
    if balanceOf[stor6] > -stor10 - 1:
        revert with 'NH{q', 17
    if balanceOf[stor6] + stor10 < balanceOf[stor6]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[stor6] += stor10
    emit Transfer(stor10, 0, stor6);
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    require arg2 == arg2
    if not msg.sender:
        revert with 0, 'transfer from the 0 address'
    if not arg1:
        revert with 0, 'transfer to the 0 address'
...
function sub_152e5712(?) payable {
    if block.timestamp < stor9:
        revert with 0, 'Can't release talent tokens yet'
    if uint8(stor4.field_0):
        revert with 0, 'Talent tokens already released'
    uint8(stor4.field_0) = 1
    if not address(stor4.field_24):
        revert with 0, 'mint to the zero address'
    if totalSupply > -stor8 - 1:
        revert with 'NH{q', 17
    if totalSupply + stor8 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += stor8
    if balanceOf[address(stor4.field_0)] > -stor8 - 1:
        revert with 'NH{q', 17
    if balanceOf[address(stor4.field_0)] + stor8 < balanceOf[address(stor4.field_0)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(stor4.field_0)] += stor8
    emit Transfer(stor8, 0, address(stor4.field_24));
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if arg3 > allowance[address(arg1)][address(msg.sender)]:
        revert with 0, 32, 33, 0xfe7472616e7366657220616d6f756e74206578636565647320616c6c6f77616e63, mem[225 len 31] / 0.00390625, 0
