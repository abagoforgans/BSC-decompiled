...
function sub_101226e6(?) {
    ...
    if uint8(arg1) > -uint8(arg2) + 255:
        revert with 'NH{q', 17
    if uint8(uint8(arg1) + uint8(arg2)) > -uint8(arg3) + 255:
        revert with 'NH{q', 17
    if uint8(uint8(uint8(arg1) + uint8(arg2)) + uint8(arg3)) > 25:
    ...
    if uint8(uint8(arg1) + uint8(arg2)) > -uint8(arg3) + 255:
        revert with 'NH{q', 17
    uint8(stor24.field_0) = uint8(uint8(uint8(arg1) + uint8(arg2)) + uint8(arg3))
...
function sub_a58107ef(?) {
    ...
    if uint8(uint8(arg1) + uint8(arg2)) > -uint8(arg3) + 255:
        revert with 'NH{q', 17
    uint8(stor28.field_0) = uint8(uint8(uint8(arg1) + uint8(arg2)) + uint8(arg3))
    Mask(248, 0, stor28.field_8) = 0
    emit 0xdcf601f6: arg1 << 248, arg2 << 248, uint8(arg3)
}

function claimDividend() {
    if stor6[address(msg.sender)] > -sub_6b492b7d - 1:
        revert with 'NH{q', 17
    if stor6[address(msg.sender)] + sub_6b492b7d > block.timestamp:
...
function sub_fadf9aaf(?) {
    ...
    if totalShares < shares[address(arg1)].field_0:
        revert with 'NH{q', 17
    if totalShares - shares[address(arg1)].field_0 > -balanceOf[address(arg1)] - 1:
        revert with 'NH{q', 17
...
function sub_e836e590(?) {
    ...
    mem[0] = this.address
    mem[32] = 3
    if balanceOf[address(this.address)] >= sub_bec90112:
        if not arg1:
            if uint256(stor25.field_0) > -uint256(stor21.field_0) - 1:
                revert with 'NH{q', 17
            if uint256(stor28.field_0) > -uint256(stor24.field_0) - 1:
                revert with 'NH{q', 17
            ...
            if (uint256(stor25.field_0) * sub_bec90112) + (uint256(stor21.field_0) * sub_bec90112) / uint256(stor28.field_0) + uint256(stor24.field_0) < (uint256(stor25.field_0) * sub_bec90112) + (uint256(stor21.field_0) * sub_bec90112) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2:
                revert with 'NH{q', 17
            if sub_bec90112 > ((uint256(stor25.field_0) * sub_bec90112) + (uint256(stor21.field_0) * sub_bec90112) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2) - 1:
                revert with 'NH{q', 17
            mem[96] = 2
            ...
            call routerAddress.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / sub_bec90112 - ((uint256(stor25.field_0) * sub_bec90112) + (uint256(stor21.field_0) * sub_bec90112) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2) wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, (uint256(stor25.field_0) * sub_bec90112) + (uint256(stor21.field_0) * sub_bec90112) / uint256(stor28.field_0) + uint256(stor24.field_0)), 0, 0, owner, block.timestamp
            ...
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 'NH{q', 17
            if uint256(stor27.field_0) > -uint256(stor23.field_0) - 1:
                revert with 'NH{q', 17
            if uint256(stor26.field_0) > -uint256(stor22.field_0) - 1:
                revert with 'NH{q', 17
            if uint256(stor28.field_0) > -uint256(stor24.field_0) - 1:
                revert with 'NH{q', 17
            ...
            if not uint256(stor28.field_0) + uint256(stor24.field_0):
                revert with 'NH{q', 18
            if 0 / uint256(stor28.field_0) + uint256(stor24.field_0) > 0:
                ...
                call routerAddress.mem[mem[64] len 4] with:
                   value 0 / uint256(stor28.field_0) + uint256(stor24.field_0) wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len (6 * ceil32(return_data.size)) + (32 * mem[(4 * ceil32(return_data.size)) + 192]) + -mem[64] + 448]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if mem[_250] < ext_call.return_data[0]:
                    revert with 'NH{q', 17
                if totalDividends > -mem[_250] + ext_call.return_data[0] - 1:
                    revert with 'NH{q', 17
                totalDividends = totalDividends + mem[_250] - ext_call.return_data[0]
                if dividendsPerShareAccuracyFactor and mem[_250] - ext_call.return_data[0] > -1 / dividendsPerShareAccuracyFactor:
                    revert with 'NH{q', 17
                if not totalShares:
                    revert with 'NH{q', 18
                if dividendsPerShare > -((mem[_250] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares) - 1:
                    revert with 'NH{q', 17
                dividendsPerShare += (mem[_250] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares
                if 0 / uint256(stor28.field_0) + uint256(stor24.field_0) > 0:
                    call stor29 with:
                       value 0 / uint256(stor28.field_0) + uint256(stor24.field_0) wei
                         gas 30000 wei
    ...
    if uint256(stor28.field_0) > -uint256(stor24.field_0) - 1:
        revert with 'NH{q', 17
    if balanceOf[address(this.address)] and uint256(stor25.field_0) + uint256(stor21.field_0) > -1 / balanceOf[address(this.address)]:
        revert with 'NH{q', 17
    if not uint256(stor28.field_0) + uint256(stor24.field_0):
        revert with 'NH{q', 18
    if balanceOf[address(this.address)] < (uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0):
        revert with 'NH{q', 17
    if (uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) < (uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2:
        revert with 'NH{q', 17
    if balanceOf[address(this.address)] > ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2) - 1:
        revert with 'NH{q', 17
    mem[96] = 2
    mem[128] = this.address
    require ext_code.size(routerAddress)
    ...
    mem[160] = ext_call.return_data[12 len 20]
    mem[ceil32(return_data.size) + 192] = 0x791ac94700000000000000000000000000000000000000000000000000000000
    mem[ceil32(return_data.size) + 196] = balanceOf[address(this.address)] - ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2)
    idx = 0
    s = 128
    t = ceil32(return_data.size) + 388
    while idx < 2:
    ...
    call routerAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args balanceOf[address(this.address)] - ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2), 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if eth.balance(this.address) < eth.balance(this.address):
        revert with 'NH{q', 17
    if False and ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0)) - ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2) > 0:
        revert with 'NH{q', 17
    if not balanceOf[address(this.address)] - ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2):
        revert with 'NH{q', 18
    Mask(96, 0, stor34.field_160) = 1
    mem[ceil32(return_data.size) + 260] = 0
    mem[ceil32(return_data.size) + 292] = 0
    ...
    require ext_code.size(routerAddress)
    call routerAddress.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
       value 0 / balanceOf[address(this.address)] - ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2) wei
         gas gas_remaining wei
        args address(this.address), Mask(255, 1, (uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0)), 0, 0, owner, block.timestamp
    mem[ceil32(return_data.size) + 192 len 96] = ext_call.return_data[0 len 96]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    ...
    require ext_call.return_data[64] == ext_call.return_data[64]
    Mask(96, 0, stor34.field_160) = 0
    mem[(2 * ceil32(return_data.size)) + 224] = 0 / balanceOf[address(this.address)] - ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2)
    emit LiquidityAdded(Mask(255, 1, (uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0)), 0 / balanceOf[address(this.address)] - ((uint256(stor25.field_0) * balanceOf[address(this.address)]) + (uint256(stor21.field_0) * balanceOf[address(this.address)]) / uint256(stor28.field_0) + uint256(stor24.field_0) / 2));
    if eth.balance(this.address) < eth.balance(this.address):
        revert with 'NH{q', 17
    if uint256(stor27.field_0) > -uint256(stor23.field_0) - 1:
        revert with 'NH{q', 17
