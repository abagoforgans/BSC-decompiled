...
uint256 stor2;
address sub_6bd46787Address;

function sub_6bd46787(?) {
    return sub_6bd46787Address
}
...
function bakeryRouter() {
    return address(bakeryRouterAddress)
}
...
function sub_66f28d10(?) payable {
    ...
    mem[420] = 2
    mem[452 len 0] = None
    require ext_code.size(sub_6bd46787Address)
    call sub_6bd46787Address.swapExactETHForTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
       value msg.value wei
         gas gas_remaining wei
        args arg3, Array(len=2, data=mem[452 len 64]), address(this.address), block.timestamp
    ...
    if not ext_call.return_data[0]:
        mem[(32 * _208) + ceil32(return_data.size) + 356] = address(bakeryRouterAddress)
        mem[(32 * _208) + ceil32(return_data.size) + 388] = ext_call.return_data[0]
        mem[(32 * _208) + ceil32(return_data.size) + 320] = 68
        mem[(32 * _208) + ceil32(return_data.size) + 356 len 28] = Mask(224, 0, stor2)
        ...
        mem[(32 * _208) + ceil32(return_data.size) + 484 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
        mem[(32 * _208) + ceil32(return_data.size) + 576 len 4] = 0
        mem[(32 * _208) + ceil32(return_data.size) + 548 len 0] = 0
    else:
        require ext_code.size(arg2)
        staticcall arg2.0xdd62ed3e with:
                gas gas_remaining wei
               args address(this.address), address(bakeryRouterAddress)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
    ...
    require ext_code.size(address(bakeryRouterAddress))
    call address(bakeryRouterAddress).0x5d616c5b with:
         gas gas_remaining wei
