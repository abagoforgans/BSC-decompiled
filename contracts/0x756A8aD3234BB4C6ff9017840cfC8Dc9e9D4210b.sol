...
function sub_7452df57(?) {
    ...
    while idx < stor4.length:
        ...
        mem[0] = 4
        mem[_82] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]
        require idx < stor5.length
        mem[_82 + 32] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]
        require idx < stor6.length
        mem[_82 + 64] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor6', 6))[uint8(idx)]
        require idx < stor7.length
        mem[_82 + 96] = stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)]
        mem[_82 + 128] = arg1
        mem[_82 + 160] = 0
        require idx < stor4.length
        ...
        staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]].field_0).mem[mem[64] len 4] with:
               ...
               args mem[mem[64] + 4 len _89 + (32 * _90) + -mem[64] + 96]
        if not ext_call.success:
            require mem[96] - 1 < mem[96]
            mem[(32 * mem[96] - 1) + 128] = _82
        else:
            _140 = mem[64]
            ...
            if 99 == stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)]:
                require _144 - 1 < _144
                mem[_82 + 160] = mem[(32 * _144 - 1) + _140 + ceil32(return_data.size) + 32]
            else:
                require idx < stor6.length
                require idx < stor7.length
                require stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor6', 6))[uint8(idx)] < tokens.length
                ...
                mem[0] = 1
                require _144 - 1 < _144
                _191 = mem[(32 * _144 - 1) + _140 + ceil32(return_data.size) + 32]
                _192 = mem[64]
                mem[mem[64]] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = _191
                mem[mem[64] + 36] = 64
                ...
                staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor5', 5))[uint8(idx)]].field_0).mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _192 + (32 * _193) + -mem[64] + 96]
                if ext_call.success:
                    _210 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    ...
                    require return_data.size >= _211 + (32 * _214) + 32
                    t = _210 + _211 + 32
                    ...
                    while s < _214:
                        ...
                        continue 
                    require _214 - 1 < _214
                    mem[_82 + 160] = mem[(32 * _214 - 1) + _210 + ceil32(return_data.size) + 32]
                require mem[96] - 1 < mem[96]
                mem[(32 * mem[96] - 1) + 128] = _82
        idx = idx + 1
        continue 
