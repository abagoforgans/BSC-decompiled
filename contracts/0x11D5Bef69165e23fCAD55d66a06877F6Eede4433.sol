...
#  - sub_c39bbb43(?)
#
const name = 'Baby Chinese New Year', 0

const decimals = 9

const symbol = 'BABYCNY', 0
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not totalSupply - balanceOf[57005] - balanceOf[0]:
        revert with 'NH{q', 18
    return (arg1 * 2 * balanceOf[address(stor21.field_0)] / totalSupply - balanceOf[57005] - balanceOf[0])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[57005] - balanceOf[0]:
        revert with 'NH{q', 18
    return (arg2 * 2 * balanceOf[address(stor21.field_0)] / totalSupply - balanceOf[57005] - balanceOf[0] > arg1)
}
