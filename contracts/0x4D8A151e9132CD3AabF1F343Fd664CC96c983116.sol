...
function setBotProtectionDisableForever() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require not uint8(stor6.field_184)
    Mask(72, 0, stor6.field_184) = 1
}

function setBpEnabled(bool arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function setBPAddress(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if address(stor6.field_16):
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not uint8(stor6.field_176):
        ...
        if uint8(stor6.field_184):
            ...
            call address(stor6.field_16).protect(address arg1, address arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args msg.sender, address(arg1), arg2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if arg2 > balanceOf[address(msg.sender)]:
                revert with 0, 32, 38, 0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, Mask(208, 32, arg2) >> 32, 0
    ...
    if not uint8(stor6.field_176):
        ...
        if uint8(stor6.field_184):
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if arg3 > balanceOf[address(arg1)]:
                revert with 0, 32, 38, 0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, Mask(208, 32, arg3) >> 32, 0
