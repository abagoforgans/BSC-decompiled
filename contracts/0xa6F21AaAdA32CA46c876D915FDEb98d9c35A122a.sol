...
function queryStakeInfo() payable {
    ...
    staticcall governanceAddress.balanceOf(address rg1) with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function queryLiquidityList() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        while idx < ext_call.return_data[0]:
            ...
            staticcall address(_93).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args msg.sender
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
            ...
            staticcall mem[_78 + 12 len 20].totalSupply() with:
                    gas gas_remaining wei
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    ...
    while idx < ext_call.return_data[0]:
        ...
        staticcall address(_181).balanceOf(address rg1) with:
                gas gas_remaining wei
               args msg.sender
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        staticcall mem[_169 + 12 len 20].totalSupply() with:
                gas gas_remaining wei
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0]:
            ...
            while idx < ext_call.return_data[0]:
                ...
                staticcall address(_248).symbol() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _273 = mem[64]
                ...
                if ceil32(_284) <= _284:
                    ...
                    staticcall mem[_221 + 12 len 20].decimals() with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    staticcall address(_470).balanceOf(address rg1) with:
                            gas gas_remaining wei
                           args msg.sender
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    staticcall address(_487).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                           args msg.sender, platformAddress
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    staticcall address(_514).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                    ...
                    require ext_code.size(mem[_221 + 12 len 20])
                    staticcall mem[_221 + 12 len 20].totalSupply() with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    staticcall address(_475).balanceOf(address rg1) with:
                            gas gas_remaining wei
                           args msg.sender
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    staticcall address(_498).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                           args msg.sender, platformAddress
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    staticcall address(_517).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                           args msg.sender, governanceAddress
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
            ...
            while idx < ext_call.return_data[0]:
                ...
                staticcall address(_635).symbol() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _651 = mem[64]
                ...
                if ceil32(_653) <= _653:
                    ...
                    staticcall mem[_612 + 12 len 20].decimals() with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    staticcall address(_756).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                           args msg.sender, platformAddress
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    staticcall address(_766).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                           args msg.sender, governanceAddress
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    require ext_code.size(mem[_612 + 12 len 20])
                    staticcall mem[_612 + 12 len 20].totalSupply() with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    staticcall address(_749).balanceOf(address rg1) with:
                            gas gas_remaining wei
                           args msg.sender
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    staticcall address(_759).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                           args msg.sender, platformAddress
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    staticcall address(_769).allowance(address rg1, address rg2) with:
                            gas gas_remaining wei
                           args msg.sender, governanceAddress
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
...
function queryPairListInfo(address[] arg1) payable {
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            t = t + 32
            continue 
        mem[(32 * arg1.length) + 192] = (64 * arg1.length) + 192
        mem[(98 * arg1.length) + 320] = arg1.length
        mem[(98 * arg1.length) + 352 len 32 * arg1.length] = mem[128 len 32 * arg1.length]
        mem[(32 * arg1.length) + 224] = (98 * arg1.length) + 224
        mem[(131 * arg1.length) + 352] = arg1.length
        mem[(131 * arg1.length) + 384 len 32 * arg1.length] = mem[128 len 32 * arg1.length]
        var39001 = arg1.length
        var39002 = (32 * arg1.length) + 128
        var39007 = (164 * arg1.length) + 384
        return memory
          from (32 * arg1.length) + 128
           len (195 * arg1.length) + 256
    require arg1.length <= test266151307()
    if not arg1.length:
        require arg1.length <= test266151307()
        ...
        if not arg1.length:
            ...
            if not arg1.length:
                ...
                if not arg1.length:
                    ...
                    while idx < arg1.length:
                        ...
                        mem[(32 * idx) + (131 * arg1.length) + 256] = mem[_1598 + 32]
                    ...
                    while idx < _1241:
                        ...
                        t = t + 32
                        continue 
                    mem[_1208 + 32] = (32 * _1241) + 160
                    _1712 = mem[(64 * arg1.length) + 160]
                    mem[_1208 + (32 * _1241) + 160] = mem[(64 * arg1.length) + 160]
                    idx = 0
                    s = (64 * arg1.length) + 192
                    t = _1208 + (32 * _1241) + 192
                    while idx < _1712:
                        mem[t] = mem[s + 12 len 20]
                        idx = idx + 1
                        s = s + 32
                        t = t + 32
                        continue 
                    mem[_1208 + 64] = (32 * _1241) + (32 * _1712) + 192
                    _1846 = mem[(98 * arg1.length) + 192]
                    mem[_1208 + (32 * _1241) + (32 * _1712) + 192] = mem[(98 * arg1.length) + 192]
                    mem[_1208 + (32 * _1241) + (32 * _1712) + 224 len 32 * _1846] = mem[(98 * arg1.length) + 224 len 32 * _1846]
                    mem[_1208 + 96] = (32 * _1241) + (32 * _1712) + (32 * _1846) + 224
                    _1946 = mem[(131 * arg1.length) + 224]
                    mem[_1208 + (32 * _1241) + (32 * _1712) + (32 * _1846) + 224] = mem[(131 * arg1.length) + 224]
                    mem[_1208 + (32 * _1241) + (32 * _1712) + (32 * _1846) + 256 len 32 * _1946] = mem[(131 * arg1.length) + 256 len 32 * _1946]
                    return memory
                      from mem[64]
                       len _1208 + (32 * _1241) + (32 * _1712) + (32 * _1846) + (32 * _1946) + -mem[64] + 256
                ...
                while idx < arg1.length:
                    ...
                    require idx < mem[(98 * arg1.length) + 192]
                    require idx < mem[(131 * arg1.length) + 224]
                    mem[(32 * idx) + (131 * arg1.length) + 256] = mem[_1599 + 32]
                ...
                while idx < _1242:
                    ...
                    t = t + 32
                    continue 
                mem[mem[64] + 32] = (32 * _1242) + 160
                _1713 = mem[(64 * arg1.length) + 160]
                mem[mem[64] + (32 * _1242) + 160] = mem[(64 * arg1.length) + 160]
                idx = 0
                s = (64 * arg1.length) + 192
                t = mem[64] + (32 * _1242) + 192
                while idx < _1713:
                    mem[t] = mem[s + 12 len 20]
                    idx = idx + 1
                    s = s + 32
                    t = t + 32
                    continue 
                mem[mem[64] + 64] = (32 * _1242) + (32 * _1713) + 192
                _1847 = mem[(98 * arg1.length) + 192]
                mem[mem[64] + (32 * _1242) + (32 * _1713) + 192] = mem[(98 * arg1.length) + 192]
                mem[mem[64] + (32 * _1242) + (32 * _1713) + 224 len 32 * _1847] = mem[(98 * arg1.length) + 224 len 32 * _1847]
                mem[mem[64] + 96] = (32 * _1242) + (32 * _1713) + (32 * _1847) + 224
                _1947 = mem[(131 * arg1.length) + 224]
                mem[mem[64] + (32 * _1242) + (32 * _1713) + (32 * _1847) + 224] = mem[(131 * arg1.length) + 224]
                mem[mem[64] + (32 * _1242) + (32 * _1713) + (32 * _1847) + 256 len 32 * _1947] = mem[(131 * arg1.length) + 256 len 32 * _1947]
                return 128, 
                       (32 * _1242) + 160,
                       (32 * _1242) + (32 * _1713) + 192,
                       (32 * _1242) + (32 * _1713) + (32 * _1847) + 224,
                       mem[mem[64] + 128 len (32 * _1242) + (32 * _1713) + (32 * _1847) + (32 * _1947) + 128]
            ...
            if not arg1.length:
                ...
                while idx < arg1.length:
                    ...
                    require idx < mem[(98 * arg1.length) + 192]
                    require idx < mem[(131 * arg1.length) + 224]
                    mem[(32 * idx) + (131 * arg1.length) + 256] = mem[_1600 + 32]
                ...
                _1948 = mem[(131 * arg1.length) + 224]
                mem[_1210 + (32 * _1243) + (32 * _1714) + (32 * _1848) + 224] = mem[(131 * arg1.length) + 224]
                mem[_1210 + (32 * _1243) + (32 * _1714) + (32 * _1848) + 256 len 32 * _1948] = mem[(131 * arg1.length) + 256 len 32 * _1948]
                return memory
                  from mem[64]
            ...
            while idx < arg1.length:
                ...
                require idx < mem[(98 * arg1.length) + 192]
                require idx < mem[(131 * arg1.length) + 224]
                mem[(32 * idx) + (131 * arg1.length) + 256] = mem[_1601 + 32]
            ...
            while idx < _1244:
                ...
                t = t + 32
                continue 
            mem[mem[64] + 32] = (32 * _1244) + 160
            _1715 = mem[(64 * arg1.length) + 160]
            mem[mem[64] + (32 * _1244) + 160] = mem[(64 * arg1.length) + 160]
            idx = 0
            s = (64 * arg1.length) + 192
            t = mem[64] + (32 * _1244) + 192
            while idx < _1715:
                mem[t] = mem[s + 12 len 20]
                idx = idx + 1
                s = s + 32
                t = t + 32
                continue 
            mem[mem[64] + 64] = (32 * _1244) + (32 * _1715) + 192
            _1849 = mem[(98 * arg1.length) + 192]
            mem[mem[64] + (32 * _1244) + (32 * _1715) + 192] = mem[(98 * arg1.length) + 192]
            mem[mem[64] + (32 * _1244) + (32 * _1715) + 224 len 32 * _1849] = mem[(98 * arg1.length) + 224 len 32 * _1849]
            mem[mem[64] + 96] = (32 * _1244) + (32 * _1715) + (32 * _1849) + 224
            _1949 = mem[(131 * arg1.length) + 224]
            mem[mem[64] + (32 * _1244) + (32 * _1715) + (32 * _1849) + 224] = mem[(131 * arg1.length) + 224]
            mem[mem[64] + (32 * _1244) + (32 * _1715) + (32 * _1849) + 256 len 32 * _1949] = mem[(131 * arg1.length) + 256 len 32 * _1949]
            return 128, 
                   (32 * _1244) + 160,
                   (32 * _1244) + (32 * _1715) + 192,
                   (32 * _1244) + (32 * _1715) + (32 * _1849) + 224,
                   mem[mem[64] + 128 len (32 * _1244) + (32 * _1715) + (32 * _1849) + (32 * _1949) + 128]
        ...
        if not arg1.length:
            ...
            while idx < _1247:
                ...
                t = t + 32
                continue 
            mem[mem[64] + 32] = (32 * _1247) + 160
            _1718 = mem[(64 * arg1.length) + 160]
            mem[mem[64] + (32 * _1247) + 160] = mem[(64 * arg1.length) + 160]
            idx = 0
            s = (64 * arg1.length) + 192
            t = mem[64] + (32 * _1247) + 192
            while idx < _1718:
                mem[t] = mem[s + 12 len 20]
                idx = idx + 1
                s = s + 32
                t = t + 32
                continue 
            mem[mem[64] + 64] = (32 * _1247) + (32 * _1718) + 192
            _1852 = mem[(98 * arg1.length) + 192]
            mem[mem[64] + (32 * _1247) + (32 * _1718) + 192] = mem[(98 * arg1.length) + 192]
            mem[mem[64] + (32 * _1247) + (32 * _1718) + 224 len 32 * _1852] = mem[(98 * arg1.length) + 224 len 32 * _1852]
            mem[mem[64] + 96] = (32 * _1247) + (32 * _1718) + (32 * _1852) + 224
            _1952 = mem[(128 * arg1.length) + 224]
            mem[mem[64] + (32 * _1247) + (32 * _1718) + (32 * _1852) + 224] = mem[(128 * arg1.length) + 224]
            mem[mem[64] + (32 * _1247) + (32 * _1718) + (32 * _1852) + 256 len 32 * _1952] = mem[(128 * arg1.length) + 256 len 32 * _1952]
            return 128, 
                   (32 * _1247) + 160,
                   (32 * _1247) + (32 * _1718) + 192,
                   (32 * _1247) + (32 * _1718) + (32 * _1852) + 224,
                   mem[mem[64] + 128 len (32 * _1247) + (32 * _1718) + (32 * _1852) + (32 * _1952) + 128]
        mem[(128 * arg1.length) + 256 len 32 * arg1.length] = call.data[calldata.size len 32 * arg1.length]
        idx = 0
        while idx < arg1.length:
            require idx < mem[96]
    ...
    if not arg1.length:
        ...
        if not arg1.length:
            ...
            if not arg1.length:
                ...
                while idx < _1249:
                    ...
                    t = t + 32
                    continue 
                mem[mem[64] + 32] = (32 * _1249) + 160
                _1720 = mem[(64 * arg1.length) + 160]
                mem[mem[64] + (32 * _1249) + 160] = mem[(64 * arg1.length) + 160]
                idx = 0
                s = (64 * arg1.length) + 192
                t = mem[64] + (32 * _1249) + 192
                while idx < _1720:
                    mem[t] = mem[s + 12 len 20]
                    idx = idx + 1
                    s = s + 32
                    t = t + 32
                    continue 
                mem[mem[64] + 64] = (32 * _1249) + (32 * _1720) + 192
                _1854 = mem[(98 * arg1.length) + 192]
                mem[mem[64] + (32 * _1249) + (32 * _1720) + 192] = mem[(98 * arg1.length) + 192]
                mem[mem[64] + (32 * _1249) + (32 * _1720) + 224 len 32 * _1854] = mem[(98 * arg1.length) + 224 len 32 * _1854]
                mem[mem[64] + 96] = (32 * _1249) + (32 * _1720) + (32 * _1854) + 224
                _1954 = mem[(131 * arg1.length) + 224]
                mem[mem[64] + (32 * _1249) + (32 * _1720) + (32 * _1854) + 224] = mem[(131 * arg1.length) + 224]
                mem[mem[64] + (32 * _1249) + (32 * _1720) + (32 * _1854) + 256 len 32 * _1954] = mem[(131 * arg1.length) + 256 len 32 * _1954]
                return 128, 
                       (32 * _1249) + 160,
                       (32 * _1249) + (32 * _1720) + 192,
                       (32 * _1249) + (32 * _1720) + (32 * _1854) + 224,
                       mem[mem[64] + 128 len (32 * _1249) + (32 * _1720) + (32 * _1854) + (32 * _1954) + 128]
            mem[(131 * arg1.length) + 256 len 32 * arg1.length] = call.data[calldata.size len 32 * arg1.length]
            idx = 0
            while idx < arg1.length:
                require idx < mem[96]
            ...
            while idx < _1250:
                ...
                t = t + 32
                continue 
            mem[mem[64] + 32] = (32 * _1250) + 160
            _1721 = mem[(64 * arg1.length) + 160]
            mem[mem[64] + (32 * _1250) + 160] = mem[(64 * arg1.length) + 160]
            idx = 0
            s = (64 * arg1.length) + 192
            t = mem[64] + (32 * _1250) + 192
            while idx < _1721:
                mem[t] = mem[s + 12 len 20]
                idx = idx + 1
                s = s + 32
        ...
        if not arg1.length:
            ...
            while idx < _1251:
                ...
                t = t + 32
                continue 
            mem[_1218 + 32] = (32 * _1251) + 160
            _1722 = mem[(64 * arg1.length) + 160]
            mem[_1218 + (32 * _1251) + 160] = mem[(64 * arg1.length) + 160]
            idx = 0
            s = (64 * arg1.length) + 192
            t = _1218 + (32 * _1251) + 192
            while idx < _1722:
                mem[t] = mem[s + 12 len 20]
                idx = idx + 1
                s = s + 32
    ...
    if not arg1.length:
        ...
        while idx < _1254:
            ...
            t = t + 32
            continue 
        mem[_1221 + 32] = (32 * _1254) + 160
        _1725 = mem[(64 * arg1.length) + 160]
        mem[_1221 + (32 * _1254) + 160] = mem[(64 * arg1.length) + 160]
        idx = 0
        s = (64 * arg1.length) + 192
        t = _1221 + (32 * _1254) + 192
        while idx < _1725:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
    ...
    if not arg1.length:
        ...
        while idx < _1255:
            ...
            t = t + 32
            continue 
        mem[mem[64] + 32] = (32 * _1255) + 160
        _1726 = mem[(64 * arg1.length) + 160]
        mem[mem[64] + (32 * _1255) + 160] = mem[(64 * arg1.length) + 160]
        idx = 0
        s = (64 * arg1.length) + 192
        t = mem[64] + (32 * _1255) + 192
        while idx < _1726:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
    ...
    while idx < _1256:
        ...
        t = t + 32
        continue 
    mem[mem[64] + 32] = (32 * _1256) + 160
    _1727 = mem[(64 * arg1.length) + 160]
    mem[mem[64] + (32 * _1256) + 160] = mem[(64 * arg1.length) + 160]
    idx = 0
    s = (64 * arg1.length) + 192
    t = mem[64] + (32 * _1256) + 192
    while idx < _1727:
        mem[t] = mem[s + 12 len 20]
        idx = idx + 1
        s = s + 32
