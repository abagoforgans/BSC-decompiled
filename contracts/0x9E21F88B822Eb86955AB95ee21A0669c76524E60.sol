...
function sub_71c93461(?) {
    ...
    if not return_data.size:
        ...
        while idx < stor18.length:
            ...
            _393 = mem[64]
            mem[64] = mem[64] + 96
            mem[_393] = stor18[idx].field_0
            mem[_393 + 32] = stor18[idx].field_256
            _394 = mem[64]
            mem[64] = mem[64] + (32 * stor18[idx].field_512) + 32
            mem[_394] = stor18[idx].field_512
            if not stor18[idx].field_512:
                mem[_393 + 64] = _394
                if ext_call.return_data[0] < stor18[idx].field_0:
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    continue 
                if ext_call.return_data[0] >= stor18[idx].field_256:
                    if idx == -1:
                        revert with 'NH{q', 17
                    idx = idx + 1
                    continue 
                if stor18[idx].field_512 <= 0:
                ...
                s = 0
                t = 0
                while s < stor18[idx].field_512:
                    if s >= stor18[idx].field_512:
                        revert with 'NH{q', 50
                ...
                mem[0] = (3 * idx) + sha3(18) + 2
                mem[_394 + 32] = stor[sha3((3 * idx) + ('name', 'stor18', 18) + 2)].field_0
                s = _394 + 32
                t = sha3(mem[0])
                while _394 + (32 * stor18[idx].field_512) > s:
        ...
        while idx < stor18.length:
            ...
            _398 = mem[64]
            mem[64] = mem[64] + 96
            mem[_398] = stor18[idx].field_0
            mem[_398 + 32] = stor18[idx].field_256
            _399 = mem[64]
            mem[64] = mem[64] + (32 * stor18[idx].field_512) + 32
            mem[_399] = stor18[idx].field_512
            if not stor18[idx].field_512:
                mem[_398 + 64] = _399
                if ext_call.return_data[0] < stor18[idx].field_0:
                    if idx == -1:
                ...
                mem[0] = (3 * idx) + sha3(18) + 2
                mem[_399 + 32] = stor[sha3((3 * idx) + ('name', 'stor18', 18) + 2)].field_0
                s = _399 + 32
                t = sha3(mem[0])
                while _399 + (32 * stor18[idx].field_512) > s:
                    mem[s + 32] = uint256(stor1[t])
                    s = s + 32
                    t = t + 1
                    continue 
