            ...
            if settlementPrice <= priceCap:
                ...
                if not collateralPerUnit:
                    ...
                    while u >= 32:
                        ...
                        u = u - 32
                        continue 
                    mem[_215 + floor32(mem[_216]) + 100] = mem[_216 + -(mem[_216] % 32) + floor32(mem[_216]) + 64 len mem[_216] % 32] or Mask(8 * -(mem[_216] % 32) + 32, -(8 * -(mem[_216] % 32) + 32) + 256, mem[_215 + floor32(mem[_216]) + 100])
                    call collateralTokenAddress.mem[_215 + 100 len 4] with:
                         gas gas_remaining wei
                        args mem[_215 + 104 len _240 - 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if mem[96] > 0:
                        ...
                        mem[64] = _215 + ceil32(return_data.size) + 101
                        mem[_215 + 100] = return_data.size
                        mem[_215 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size > 0:
                            require return_data.size >= 32
                            if not mem[_215 + 132]:
                                revert with 0, 
                                            ...
                                            42,
                                            0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[_215 + ceil32(return_data.size) + 211 len 22]
                else:
                    require collateralPerUnit
                    if collateralPerUnit * ext_call.return_data[0] / collateralPerUnit != ext_call.return_data[0]:
                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
