...
function initialize(uint256 arg1, address[] arg2, address arg3) {
    ...
    emit OwnershipTransferred(owner['owner', 0 % 1099511627776], arg3);
    ...
    while idx < arg2.length:
        ...
        while s >= 32:
            ...
            s = s - 32
            continue 
        mem[_679 + floor32(mem[_680]) + 62] = 256^(-(mem[_680] % 32) + 32) - 1 and mem[_679 + floor32(mem[_680]) + 62] or mem[_680 + floor32(mem[_680]) + 32] and !(256^(-(mem[_680] % 32) + 32) - 1)
        mem[0] = sha3(mem[_679 + 62 len _682])
        mem[32] = 4
        stor4[mem[0]] = 1
        require idx < mem[96]
