...
function sub_23c67f42(?) {
    require calldata.size - 4 >= 32
    require ext_code.size(stor113)
    staticcall stor113.ownerOf(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
            ...
            if infos[arg2].field_2304 >= infos[arg2].field_0 * sub_5af04ce5:
                ...
                if sub_e900d358[arg2].field_0:
                    ...
                    while (32 * sub_e900d358[arg2].field_0) + 512 > idx:
                        ...
                        s = s + 1
                        continue 
                    if 300 > !sub_5ed2b032[arg2]:
                        revert with 0, 17
                    if 300 > !sub_5ed2b032[arg2]:
                        revert with 0, 17
                    if block.timestamp <= sub_5ed2b032[arg2] + 300:
                        if block.timestamp <= sub_5ed2b032[arg2] + 300:
                            if block.timestamp <= sub_5ed2b032[arg2] + 300:
                                return 32, infos[arg2].field_1024 > block.timestamp - (240 * 24 * 3600), 
                                       ...
                                       416,
                                       sub_5ed2b032[arg2],
                                       block.timestamp <= sub_5ed2b032[arg2] + 300,
                                       block.timestamp > sub_5ed2b032[arg2] + 300,
                                       10000,
                                       0,
                                       sub_e900d358[arg2].field_0,
                ...
                if block.timestamp <= sub_5ed2b032[arg2] + 300:
                    if block.timestamp <= sub_5ed2b032[arg2] + 300:
                        ...
                        mem[(32 * sub_e900d358[arg2].field_0) + ceil32(return_data.size) + 864] = block.timestamp <= sub_5ed2b032[arg2] + 300
                        mem[(32 * sub_e900d358[arg2].field_0) + ceil32(return_data.size) + 896] = block.timestamp > sub_5ed2b032[arg2] + 300
            ...
            if not sub_e900d358[arg2].field_0:
                ...
                if block.timestamp <= sub_5ed2b032[arg2] + 300:
                    if block.timestamp <= sub_5ed2b032[arg2] + 300:
                        ...
                        mem[(2 * ceil32(return_data.size)) + (32 * sub_e900d358[arg2].field_0) + 864] = block.timestamp <= sub_5ed2b032[arg2] + 300
                        mem[(2 * ceil32(return_data.size)) + (32 * sub_e900d358[arg2].field_0) + 896] = block.timestamp > sub_5ed2b032[arg2] + 300
