...
function getTokenPrice(address arg1) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if 0xe9e7cea3dedca5984780bafc599bd69add087d56 == address(ext_call.return_data[0]):
        ...
        if Mask(112, 0, ext_call.return_data[0]) * 10^ext_call.return_data[0]:
            return (Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]) * 10^ext_call.return_data[0])
    revert
}
