...
const multi = 0xa7836e73c956e2ba9c9df53295c124b89740f18a
...
const shareRewardPool = 0x762c3434f9f3e108b11180700ad09ec06d4693f4
...
uint256 stor4;
array of address sub_302dfc57;
array of address sub_2edeed95;
array of address sub_46e64fd7;
array of address sub_490f5912;

function sub_2edeed95(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_2edeed95.length
    return sub_2edeed95[arg1]
}

function sub_302dfc57(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_302dfc57.length
    return sub_302dfc57[arg1]
}
...
function sub_46e64fd7(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_46e64fd7.length
    return sub_46e64fd7[arg1]
}

function sub_490f5912(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_490f5912.length
    return sub_490f5912[arg1]
}
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(0x762c3434f9f3e108b11180700ad09ec06d4693f4)
        call 0x762c3434f9f3e108b11180700ad09ec06d4693f4.0xa694fc3a with:
             gas gas_remaining wei
...
function balanceOf() payable {
    require ext_code.size(0x762c3434f9f3e108b11180700ad09ec06d4693f4)
    staticcall 0x762c3434f9f3e108b11180700ad09ec06d4693f4.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if ext_call.return_data[0] > arg1:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(0x762c3434f9f3e108b11180700ad09ec06d4693f4)
        call 0x762c3434f9f3e108b11180700ad09ec06d4693f4.0x2e1a7d4d with:
             gas gas_remaining wei
