...
address blacksmithAddress; offset 16
...
function sub_04677cf7(?) payable {
    require calldata.size - 4 >= 32
    if blacksmithAddress != msg.sender:
        revert with 0, 'SAFU: caller not blacksmith'
...
function mint(address arg1, uint256 arg2) payable {
    ...
    if not uint8(stor6.field_8):
        revert with 0, 'Insure: not released'
    if blacksmithAddress != msg.sender:
        revert with 0, 'SAFU: caller not Blacksmith'
    if not arg1:
...
function release(address arg1, address arg2) payable {
    ...
    if uint8(stor6.field_8):
        revert with 0, 'SAFU: already released'
    Mask(248, 0, stor6.field_8) = 1
    blacksmithAddress = arg2
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 950 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 950 * 10^18
    if balanceOf[address(arg1)] + 950 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 950 * 10^18
    emit Transfer(950 * 10^18, 0, arg1);
}
