...
#
const name = 'CBURG TOKEN', 0

const InitialSupply = 100000000 * 10^18

const decimals = 18

const TeamWallet = 0x1c8a827eeb807c5d4a5e0e3b255cce5778f72356

const symbol = 'CBURG', 0
...
function getBurnedTokens() {
    if 100000000 * 10^18 < totalSupply:
        revert with 'NH{q', 17
    return (-totalSupply + 100000000 * 10^18 / 10^18)
}
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x1c8a827eeb807c5d4a5e0e3b255cce5778f72356 with:
