            ...
            if ext_call.return_data[0]:
                if poolInfo[arg1].field_256:
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        call sub_ae62161eAddress.0x40c10f19 with:
                             gas gas_remaining wei
        ...
        while idx < poolInfo.length:
            ...
            if sub_ae62161eAddress != poolInfo[idx].field_0:
                ...
                if poolInfo[idx].field_512 > block.number:
                    ...
                    idx = 0
                    while idx < 30:
                        mem[idx + _243 + 68] = mem[idx + _241 + 32]
                        idx = idx + 32
                        continue 
                    mem[_243 + 98] = 0
                    revert with memory
                ...
                if not block.number - poolInfo[idx].field_512:
                    ...
                    if not totalAllocPoint:
                        ...
                        idx = 0
                        while idx < 26:
                            mem[idx + _262 + 68] = mem[idx + _258 + 32]
                            idx = idx + 32
                            continue 
                        mem[_262 + 94] = 0
                        revert with memory
                    ...
                    if not 0 / totalAllocPoint:
                        ...
                        if _237:
                            if poolInfo[idx].field_768 > !(0 / _237):
                                revert with 0, 17
                            if poolInfo[idx].field_768 + (0 / _237) < poolInfo[idx].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[idx].field_768 += 0 / _237
                            poolInfo[idx].field_512 = block.number
                            if idx == -1:
                                revert with 0, 17
                            idx = idx + 1
                        ...
                        idx = 0
                        while idx < 26:
                            mem[idx + _325 + 68] = mem[idx + _321 + 32]
                            idx = idx + 32
                            continue 
                        mem[_325 + 94] = 0
                        revert with memory
                    ...
                    if _237:
                        if poolInfo[idx].field_768 > !(10^12 * 0 / totalAllocPoint / _237):
                            revert with 0, 17
                        if poolInfo[idx].field_768 + (10^12 * 0 / totalAllocPoint / _237) < poolInfo[idx].field_768:
                            revert with 0, 'SafeMath: addition overflow'
                        poolInfo[idx].field_768 += 10^12 * 0 / totalAllocPoint / _237
                        poolInfo[idx].field_512 = block.number
                        if idx == -1:
                            revert with 0, 17
                        idx = idx + 1
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _348 + 68] = mem[idx + _341 + 32]
                        idx = idx + 32
                        continue 
                    mem[_348 + 94] = 0
                    revert with memory
                ...
                if not (block.number * sub_c8986cee) - (poolInfo[idx].field_512 * sub_c8986cee):
                    ...
                    if not totalAllocPoint:
                        ...
                        idx = 0
                        while idx < 26:
                            mem[idx + _271 + 68] = mem[idx + _268 + 32]
                            idx = idx + 32
                            continue 
                        mem[_271 + 94] = 0
                        revert with memory
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _375 + 68] = mem[idx + _366 + 32]
                        idx = idx + 32
                        continue 
                    mem[_375 + 94] = 0
                    revert with memory
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _289 + 68] = mem[idx + _286 + 32]
                        idx = idx + 32
                        continue 
                    mem[_289 + 94] = 0
                    revert with memory
                ...
                if not (block.number * sub_c8986cee * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_c8986cee * poolInfo[idx].field_256) / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _374 + 68] = mem[idx + _365 + 32]
                        idx = idx + 32
                        continue 
                    mem[_374 + 94] = 0
                    revert with memory
                ...
                if _237:
                    if poolInfo[idx].field_768 > !(10^12 * (block.number * sub_c8986cee * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_c8986cee * poolInfo[idx].field_256) / totalAllocPoint / _237):
                        revert with 0, 17
                    if poolInfo[idx].field_768 + (10^12 * (block.number * sub_c8986cee * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_c8986cee * poolInfo[idx].field_256) / totalAllocPoint / _237) < poolInfo[idx].field_768:
                        revert with 0, 'SafeMath: addition overflow'
                    poolInfo[idx].field_768 += 10^12 * (block.number * sub_c8986cee * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_c8986cee * poolInfo[idx].field_256) / totalAllocPoint / _237
                    poolInfo[idx].field_512 = block.number
                    if idx == -1:
                        revert with 0, 17
                    idx = idx + 1
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _407 + 68] = mem[idx + _397 + 32]
                    idx = idx + 32
                    continue 
                mem[_407 + 94] = 0
                revert with memory
            ...
            if poolInfo[idx].field_512 > block.number:
                ...
                idx = 0
                while idx < 30:
                    mem[idx + _246 + 68] = mem[idx + _242 + 32]
                    idx = idx + 32
                    continue 
                mem[_246 + 98] = 0
                revert with memory
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _265 + 68] = mem[idx + _261 + 32]
                        idx = idx + 32
                        continue 
                    mem[_265 + 94] = 0
                    revert with memory
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[idx + _327 + 68] = mem[idx + _324 + 32]
                        idx = idx + 32
                        continue 
                    mem[_327 + 94] = 0
                    revert with memory
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _354 + 68] = mem[idx + _346 + 32]
                    idx = idx + 32
                    continue 
                mem[_354 + 94] = 0
                revert with memory
            ...
            if not (block.number * sub_c8986cee) - (poolInfo[idx].field_512 * sub_c8986cee):
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _384 + 68] = mem[idx + _372 + 32]
                    idx = idx + 32
                    continue 
                mem[_384 + 94] = 0
                revert with memory
            ...
            if not totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[idx + _294 + 68] = mem[idx + _288 + 32]
                    idx = idx + 32
                    continue 
                mem[_294 + 94] = 0
                revert with memory
            ...
            idx = 0
            while idx < 26:
                mem[idx + _415 + 68] = mem[idx + _404 + 32]
                idx = idx + 32
                continue 
            mem[_415 + 94] = 0
            revert with memory
