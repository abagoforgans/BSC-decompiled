    ...
    if not decimals:
        ...
        if bool(bool(decimals < 78)) or bool(bool(decimals < 32)):
            ...
            if arg1 and 10^decimals > -1 / arg1:
                revert with 'NH{q', 17
            if balanceOf[address(msg.sender)] < arg1 * 10^decimals:
                revert with 'NH{q', 17
            ...
            if arg1 and t * s > -1 / arg1:
                revert with 'NH{q', 17
            if balanceOf[address(msg.sender)] < arg1 * t * s:
                revert with 'NH{q', 17
            balanceOf[address(msg.sender)] += -1 * arg1 * t * s
    if not decimals:
        if arg1 and 1 > -1 / arg1:
            revert with 'NH{q', 17
        if balanceOf[57005] > -arg1 - 1:
            revert with 'NH{q', 17
        ...
        if bool(bool(decimals < 78)) or bool(bool(decimals < 32)):
            ...
            if arg1 and 10^decimals > -1 / arg1:
                revert with 'NH{q', 17
            if balanceOf[57005] > (-1 * arg1 * 10^decimals) - 1:
                revert with 'NH{q', 17
            balanceOf[57005] += arg1 * 10^decimals
        else:
            s = 10
            t = 1
            idx = decimals
            ...
            if arg1 and t * s > -1 / arg1:
                revert with 'NH{q', 17
            if balanceOf[57005] > (-1 * arg1 * t * s) - 1:
                revert with 'NH{q', 17
            balanceOf[57005] += arg1 * t * s
}
