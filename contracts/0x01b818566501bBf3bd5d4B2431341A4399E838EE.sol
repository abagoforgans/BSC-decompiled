...
function sub_63b5c805(?) payable {
    ...
    if not block.timestamp - stor16[msg.sender].field_512:
        ...
        if not 2 * ext_call.return_data[0]:
            ...
            require (ext_call.return_data[0] * block.timestamp * stor16[msg.sender].field_0) + (ext_call.return_data[0] * block.timestamp * stor16[msg.sender].field_0) - (ext_call.return_data[0] * stor16[msg.sender].field_512 * stor16[msg.sender].field_0) - (ext_call.return_data[0] * stor16[msg.sender].field_512 * stor16[msg.sender].field_0) / 2 * ext_call.return_data[0] == (block.timestamp * stor16[msg.sender].field_0) - (stor16[msg.sender].field_512 * stor16[msg.sender].field_0)
            require stor12 > 0
            if stor12:
                return ((ext_call.return_data[0] * block.timestamp * stor16[msg.sender].field_0) + (ext_call.return_data[0] * block.timestamp * stor16[msg.sender].field_0) - (ext_call.return_data[0] * stor16[msg.sender].field_512 * stor16[msg.sender].field_0) - (ext_call.return_data[0] * stor16[msg.sender].field_512 * stor16[msg.sender].field_0) / stor12)
...
function stake(uint256 arg1, bytes arg2) payable {
    ...
    if totalStakingShares <= 0:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require (stor15 * arg1) + stor16[address(msg.sender)].field_0 >= stor16[address(msg.sender)].field_0
        stor16[address(msg.sender)].field_0 += stor15 * arg1
        stor16[address(msg.sender)].field_512 = block.timestamp
        stor17[address(msg.sender)].field_0++
        stor17[address(msg.sender)][stor17[address(msg.sender)].field_0].field_0 = stor15 * arg1
        stor17[address(msg.sender)][stor17[address(msg.sender)].field_0].field_256 = block.timestamp
        require (stor15 * arg1) + totalStakingShares >= totalStakingShares
        totalStakingShares += stor15 * arg1
    else:
        require ext_code.size(_stakingPoolAddress)
        staticcall _stakingPoolAddress.balance() with:
                gas gas_remaining wei
        ...
        if not totalStakingShares:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (0 / ext_call.return_data[0]) + stor16[address(msg.sender)].field_0 >= stor16[address(msg.sender)].field_0
            stor16[address(msg.sender)].field_0 += 0 / ext_call.return_data[0]
            stor16[address(msg.sender)].field_512 = block.timestamp
            stor17[address(msg.sender)].field_0++
            stor17[address(msg.sender)][stor17[address(msg.sender)].field_0].field_0 = 0 / ext_call.return_data[0]
            stor17[address(msg.sender)][stor17[address(msg.sender)].field_0].field_256 = block.timestamp
            require (0 / ext_call.return_data[0]) + totalStakingShares >= totalStakingShares
            totalStakingShares += 0 / ext_call.return_data[0]
        else:
            require arg1 * totalStakingShares / totalStakingShares == arg1
            require ext_call.return_data[0] > 0
            require ext_call.return_data[0]
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (arg1 * totalStakingShares / ext_call.return_data[0]) + stor16[address(msg.sender)].field_0 >= stor16[address(msg.sender)].field_0
            stor16[address(msg.sender)].field_0 += arg1 * totalStakingShares / ext_call.return_data[0]
            stor16[address(msg.sender)].field_512 = block.timestamp
            stor17[address(msg.sender)].field_0++
            stor17[address(msg.sender)][stor17[address(msg.sender)].field_0].field_0 = arg1 * totalStakingShares / ext_call.return_data[0]
            stor17[address(msg.sender)][stor17[address(msg.sender)].field_0].field_256 = block.timestamp
            require (arg1 * totalStakingShares / ext_call.return_data[0]) + totalStakingShares >= totalStakingShares
    ...
    if totalStakingShares <= 0:
        ...
        if not ext_call.return_data[0]:
            ...
            require stor16[address(msg.sender)].field_0 * ext_call.return_data[0] / ext_call.return_data[0] == stor16[address(msg.sender)].field_0
            require totalStakingShares > 0
            require totalStakingShares
            emit Staked(address rg1, uint256 rg2, uint256 rg3, bytes rg4):
                        arg1,
                        stor16[address(msg.sender)].field_0 * ext_call.return_data[0] / totalStakingShares,
                        96,
                        0,
                        mem[352],
                        msg.sender,
