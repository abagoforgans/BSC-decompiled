...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if stor4[arg2]:
        ...
        if ext_code.size(arg1) > 0:
            ...
            if ext_code.size(arg1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[708 len 160] = unknown_0x150b7a02(?????), msg.sender, msg.sender, arg2, 128, 0
            mem[896 len 4] = 0
            call arg1.0x80 with:
                 gas gas_remaining wei
                args 0, mem[868 len 4]
        ...
        if ext_code.size(arg1) > 0:
            ...
            if ext_code.size(arg1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[772 len 160] = unknown_0x150b7a02(?????), msg.sender, msg.sender, arg2, 128, 0
            mem[960 len 4] = 0
            call arg1.0x80 with:
                 gas gas_remaining wei
                args 0, mem[932 len 4]
...
function issueToken(address arg1, string arg2) payable {
    ...
    if stor4[stor11]:
        ...
        if ext_code.size(arg1) <= 0:
            ...
            if ext_code.size(arg1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(arg2.length) + 452 len 160] = unknown_0x150b7a02(?????), msg.sender, 0, stor11, 128, 0
        ...
        if ext_code.size(arg1) <= 0:
            ...
            if ext_code.size(arg1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(arg2.length) + 516 len 160] = unknown_0x150b7a02(?????), msg.sender, 0, stor11, 128, 0
            mem[ceil32(arg2.length) + 704 len 4] = 0
            call arg1.0x80 with:
                 gas gas_remaining wei
                args 0, mem[ceil32(arg2.length) + 676 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if arg2.length > 0:
                        revert with arg2[all]
                ...
                if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 
                                ...
                                mem[ceil32(arg2.length) + 502 len 14]
                if not stor4[stor11]:
                    revert with 0, 'nERC721Metadata: URI set of nonexistent tokeemente', mem[ceil32(arg2.length) + 502 len 14]
            else:
