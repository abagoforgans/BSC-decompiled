...
function sub_89b27b0b(?) payable {
    if not stor0.length:
        ...
        return 128, 
               ...
               mem[256 len 3968]
    mem[96] = stor0.length
    mem[128 len 32 * stor0.length] = code.data[11864 len 32 * stor0.length]
    mem[(32 * stor0.length) + 128] = stor0.length
    mem[(32 * stor0.length) + 160 len 32 * stor0.length] = code.data[11864 len 32 * stor0.length]
    mem[(64 * stor0.length) + 160] = stor0.length
    mem[(64 * stor0.length) + 192 len 32 * stor0.length] = code.data[11864 len 32 * stor0.length]
    mem[(98 * stor0.length) + 192] = stor0.length
    mem[64] = (131 * stor0.length) + 224
    mem[(98 * stor0.length) + 224 len 32 * stor0.length] = code.data[11864 len 32 * stor0.length]
    idx = 0
    ...
    while stor0.length < 32 * _84:
        mem[stor0.length + (32 * mem[96]) + mem[64] + 192] = mem[(34 * stor0.length) + 160]
        s = stor0.length + 32
        continue 
    mem[_52 + 64] = (32 * _84) + (32 * mem[96]) + 192
...
function sub_3247d940(?) payable {
    ...
    if arg1.length:
        mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 256 len 32 * arg1.length] = code.data[11864 len 32 * arg1.length]
...
function sub_08c8d5fe(?) payable {
    ...
    mem[(64 * arg3.length) + (32 * arg4.length) + floor32((32 * arg3.length) + 196) + -((32 * arg3.length) + 196 % 32) + 548 len (32 * arg3.length) + 196 % 32] = mem[(32 * arg4.length) + (32 * arg3.length) + floor32((32 * arg3.length) + 196) + -((32 * arg3.length) + 196 % 32) + 352 len (32 * arg3.length) + 196 % 32]
    call stor1[address(arg1)].mem[(32 * arg4.length) + (32 * arg3.length) + floor32((32 * arg3.length) + 196) + 288 len 4] with:
         gas gas_remaining wei
        args mem[(64 * arg3.length) + (32 * arg4.length) + 520 len (32 * arg3.length) + 192]
    if not return_data.size:
        ...
        mem[(64 * arg4.length) + (32 * _295) + (64 * arg3.length) + floor32((32 * arg4.length) + 196) + -((32 * arg4.length) + 196 % 32) + 936 len (32 * arg4.length) + 196 % 32] = mem[(32 * _295) + (64 * arg3.length) + (2 * floor32((32 * arg4.length) + 196)) + -((32 * arg4.length) + 196 % 32) + 512 len (32 * arg4.length) + 196 % 32]
        delegate stor1[address(arg2)].mem[(32 * _295) + (64 * arg3.length) + (32 * arg4.length) + floor32((32 * arg4.length) + 196) + 676 len 4] with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            mem[64] = (32 * mem[mem[128] + 128]) + (64 * arg4.length) + (32 * _295) + (64 * arg3.length) + 936
        ...
        mem[64] = (64 * arg3.length) + (32 * arg4.length) + ceil32(return_data.size) + 517
        ...
        mem[(64 * arg4.length) + (32 * _296) + (64 * arg3.length) + ceil32(return_data.size) + floor32((32 * arg4.length) + 196) + -((32 * arg4.length) + 196 % 32) + 937 len (32 * arg4.length) + 196 % 32] = mem[(32 * _296) + (64 * arg3.length) + ceil32(return_data.size) + (2 * floor32((32 * arg4.length) + 196)) + -((32 * arg4.length) + 196 % 32) + 513 len (32 * arg4.length) + 196 % 32]
        delegate stor1[address(arg2)].mem[(32 * _296) + (64 * arg3.length) + (32 * arg4.length) + ceil32(return_data.size) + floor32((32 * arg4.length) + 196) + 677 len 4] with:
             gas gas_remaining wei
