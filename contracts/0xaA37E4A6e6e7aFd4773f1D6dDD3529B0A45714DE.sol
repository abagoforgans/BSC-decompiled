        ...
        if ext_call.return_data[0]:
            if block.number <= bonusEndBlock:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(srxAddress)
                    call srxAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if not (10 * block.number) - (10 * poolInfo[arg1].field_512):
                        ...
                        if (10 * block.number * srxPerBlock) - (10 * poolInfo[arg1].field_512 * srxPerBlock) / (10 * block.number) - (10 * poolInfo[arg1].field_512) != srxPerBlock:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (10 * block.number * srxPerBlock) - (10 * poolInfo[arg1].field_512 * srxPerBlock):
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(srxAddress)
                            call srxAddress.0x40c10f19 with:
                            ...
                            if (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / (10 * block.number * srxPerBlock) - (10 * poolInfo[arg1].field_512 * srxPerBlock) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(srxAddress)
                            call srxAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(srxAddress)
                            call srxAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args this.address, (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if 10^12 * (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (10^12 * (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
            else:
                if poolInfo[arg1].field_512 >= bonusEndBlock:
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if (block.number * srxPerBlock) - (poolInfo[arg1].field_512 * srxPerBlock) / block.number - poolInfo[arg1].field_512 != srxPerBlock:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (block.number * srxPerBlock) - (poolInfo[arg1].field_512 * srxPerBlock):
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(srxAddress)
                            call srxAddress.0x40c10f19 with:
                            ...
                            if (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / (block.number * srxPerBlock) - (poolInfo[arg1].field_512 * srxPerBlock) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_code.size(srxAddress)
                            call srxAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(srxAddress)
                            call srxAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args this.address, (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if 10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                else:
                    ...
                    if not bonusEndBlock - poolInfo[arg1].field_512:
                        ...
                        if not block.number - bonusEndBlock:
                            ...
                            if (block.number * srxPerBlock) - (bonusEndBlock * srxPerBlock) / block.number - bonusEndBlock != srxPerBlock:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            if not (block.number * srxPerBlock) - (bonusEndBlock * srxPerBlock):
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_code.size(srxAddress)
                                call srxAddress.0x40c10f19 with:
                                ...
                                if (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / (block.number * srxPerBlock) - (bonusEndBlock * srxPerBlock) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_code.size(srxAddress)
                                call srxAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devaddr, (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(srxAddress)
                                call srxAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args this.address, (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    ...
                                    if 10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                    else:
                        ...
                        if not block.number + (9 * bonusEndBlock) - (10 * poolInfo[arg1].field_512):
                            ...
                            if (block.number * srxPerBlock) + (9 * bonusEndBlock * srxPerBlock) - (10 * poolInfo[arg1].field_512 * srxPerBlock) / block.number + (9 * bonusEndBlock) - (10 * poolInfo[arg1].field_512) != srxPerBlock:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                            if not (block.number * srxPerBlock) + (9 * bonusEndBlock * srxPerBlock) - (10 * poolInfo[arg1].field_512 * srxPerBlock):
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_code.size(srxAddress)
                                call srxAddress.0x40c10f19 with:
                                ...
                                if (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / (block.number * srxPerBlock) + (9 * bonusEndBlock * srxPerBlock) - (10 * poolInfo[arg1].field_512 * srxPerBlock) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_code.size(srxAddress)
                                call srxAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devaddr, (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(srxAddress)
                                call srxAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args this.address, (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    ...
                                    if 10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function pendingSrx(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if block.number <= bonusEndBlock:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            if userInfo[arg1][address(arg2)].field_256 > 0:
                revert with 0, 'SafeMath: subtraction overflow'
            return -userInfo[arg1][address(arg2)].field_256
        if (10^12 * (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (10^12 * (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((10^12 * (10 * block.number * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if poolInfo[arg1].field_512 >= bonusEndBlock:
        if poolInfo[arg1].field_512 > block.number:
            revert with 0, 'SafeMath: subtraction overflow'
        if not block.number - poolInfo[arg1].field_512:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            if userInfo[arg1][address(arg2)].field_256 > 0:
                revert with 0, 'SafeMath: subtraction overflow'
            return -userInfo[arg1][address(arg2)].field_256
        if (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if bonusEndBlock > block.number:
        revert with 0, 'SafeMath: subtraction overflow'
    if poolInfo[arg1].field_512 > bonusEndBlock:
        revert with 0, 'SafeMath: subtraction overflow'
    if not bonusEndBlock - poolInfo[arg1].field_512:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            if userInfo[arg1][address(arg2)].field_256 > 0:
                revert with 0, 'SafeMath: subtraction overflow'
            return -userInfo[arg1][address(arg2)].field_256
        if (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if (10 * bonusEndBlock) - (10 * poolInfo[arg1].field_512) / bonusEndBlock - poolInfo[arg1].field_512 != 10:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
    if block.number + (9 * bonusEndBlock) < 10 * bonusEndBlock:
        revert with 0, 'SafeMath: addition overflow'
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        if userInfo[arg1][address(arg2)].field_256 > 0:
            revert with 0, 'SafeMath: subtraction overflow'
        return -userInfo[arg1][address(arg2)].field_256
    if (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
    ...
    while idx < poolInfo.length:
        ...
        if block.number <= bonusEndBlock:
            ...
            if not (10 * block.number) - (10 * poolInfo[idx].field_512):
                ...
                revert with memory
                  from mem[64]
                   len _856 + -mem[64] + 100
            if (10 * block.number * srxPerBlock) - (10 * poolInfo[idx].field_512 * srxPerBlock) / (10 * block.number) - (10 * poolInfo[idx].field_512) != srxPerBlock:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            if not (10 * block.number * srxPerBlock) - (10 * poolInfo[idx].field_512 * srxPerBlock):
                _620 = mem[64]
                mem[64] = mem[64] + 64
                mem[_620] = 26
                ...
                revert with memory
                  from mem[64]
                   len _873 + -mem[64] + 100
            if (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / (10 * block.number * srxPerBlock) - (10 * poolInfo[idx].field_512 * srxPerBlock) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _629 = mem[64]
            mem[64] = mem[64] + 64
            mem[_629] = 26
            ...
            call srxAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(srxAddress)
            call srxAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                _831 = mem[64]
                mem[64] = mem[64] + 64
                mem[_831] = 26
                ...
                revert with memory
                  from mem[64]
                   len _870 + -mem[64] + 100
            if 10^12 * (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _852 = mem[64]
            mem[64] = mem[64] + 64
            mem[_852] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (10 * block.number * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _885 = mem[64]
        ...
        if poolInfo[idx].field_512 >= bonusEndBlock:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                revert with memory
                  from mem[64]
                   len _777 + -mem[64] + 100
            if (block.number * srxPerBlock) - (poolInfo[idx].field_512 * srxPerBlock) / block.number - poolInfo[idx].field_512 != srxPerBlock:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            if not (block.number * srxPerBlock) - (poolInfo[idx].field_512 * srxPerBlock):
                _601 = mem[64]
                mem[64] = mem[64] + 64
                mem[_601] = 26
                ...
                revert with memory
                  from mem[64]
                   len _790 + -mem[64] + 100
            if (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / (block.number * srxPerBlock) - (poolInfo[idx].field_512 * srxPerBlock) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _602 = mem[64]
            mem[64] = mem[64] + 64
            mem[_602] = 26
            ...
            call srxAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(srxAddress)
            call srxAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                _764 = mem[64]
                mem[64] = mem[64] + 64
                mem[_764] = 26
                ...
                revert with memory
                  from mem[64]
                   len _787 + -mem[64] + 100
            if 10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _773 = mem[64]
            mem[64] = mem[64] + 64
            mem[_773] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _804 = mem[64]
        ...
        if not bonusEndBlock - poolInfo[idx].field_512:
            ...
            if not (block.number * srxPerBlock) - (bonusEndBlock * srxPerBlock):
                ...
                revert with memory
                  from mem[64]
                   len _978 + -mem[64] + 100
            if (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / (block.number * srxPerBlock) - (bonusEndBlock * srxPerBlock) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _685 = mem[64]
            mem[64] = mem[64] + 64
            mem[_685] = 26
            ...
            call srxAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(srxAddress)
            call srxAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                _949 = mem[64]
                mem[64] = mem[64] + 64
                mem[_949] = 26
                ...
                revert with memory
                  from mem[64]
                   len _975 + -mem[64] + 100
            if 10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
            _961 = mem[64]
            mem[64] = mem[64] + 64
            mem[_961] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) - (bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _989 = mem[64]
        ...
        if not block.number + (9 * bonusEndBlock) - (10 * poolInfo[idx].field_512):
            ...
            revert with memory
              from mem[64]
               len _972 + -mem[64] + 100
        if (block.number * srxPerBlock) + (9 * bonusEndBlock * srxPerBlock) - (10 * poolInfo[idx].field_512 * srxPerBlock) / block.number + (9 * bonusEndBlock) - (10 * poolInfo[idx].field_512) != srxPerBlock:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * srxPerBlock) + (9 * bonusEndBlock * srxPerBlock) - (10 * poolInfo[idx].field_512 * srxPerBlock):
            _684 = mem[64]
            mem[64] = mem[64] + 64
            mem[_684] = 26
            ...
            revert with memory
              from mem[64]
               len _985 + -mem[64] + 100
        if (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / (block.number * srxPerBlock) + (9 * bonusEndBlock * srxPerBlock) - (10 * poolInfo[idx].field_512 * srxPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _693 = mem[64]
        mem[64] = mem[64] + 64
        mem[_693] = 26
        ...
        call srxAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devaddr, (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(srxAddress)
        call srxAddress.0x40c10f19 with:
             gas gas_remaining wei
            args this.address, (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _956 = mem[64]
            mem[64] = mem[64] + 64
            mem[_956] = 26
            ...
            revert with memory
              from mem[64]
               len _982 + -mem[64] + 100
        if 10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _968 = mem[64]
        mem[64] = mem[64] + 64
        mem[_968] = 26
        ...
        if ext_call.return_data[0]:
            if (10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * srxPerBlock * poolInfo[idx].field_256) + (9 * bonusEndBlock * srxPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * srxPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _996 = mem[64]
        ...
        if not userInfo[arg1][msg.sender].field_0:
            ...
            if not userInfo[arg1][msg.sender].field_0:
                if userInfo[arg1][msg.sender].field_256 > 0:
                    revert with 0, 'SafeMath: subtraction overflow'
                require ext_code.size(srxAddress)
                staticcall srxAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
                    call srxAddress.0xa9059cbb with:
                         gas gas_remaining wei
                ...
                if poolInfo[arg1].field_512 >= bonusEndBlock:
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not (block.number * srxPerBlock) - (poolInfo[arg1].field_512 * srxPerBlock):
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if 10^12 * (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * srxPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * srxPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
