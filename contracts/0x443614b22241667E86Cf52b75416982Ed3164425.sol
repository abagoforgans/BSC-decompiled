...
function sub_ad1d5f2b(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] > 0x1745d1745d1745d1745d1745d1745d1745d1745d1745d1745d1745d1745d1745:
        revert with 0, 17
    ...
    call 0x2bc4eb013ddee29d37920938b96d353171289b7c.flashLoan(address arg1, address arg2, uint256 arg3, bytes arg4) with:
         gas gas_remaining wei
        args this.address, this.address, Mask(255, 1, 11 * ext_call.return_data[0] / 10), 128, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) {
    ...
    if address(originAddress) != tx.origin:
