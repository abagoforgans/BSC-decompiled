...
function tokenReceiver() payable {
...
function recoverBNB(uint256 arg1) payable {
...
function recoverTokens(address arg1, uint256 arg2) payable {
...
function convert() payable {
    ...
    call oldTokenAddress.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, tokenReceiverAddress, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    if ext_call.return_data[0] < ext_call.return_data[0]:
        revert with 0, 'No enough tokens'
