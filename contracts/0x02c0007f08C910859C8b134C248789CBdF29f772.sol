...
#
const name = 'HydrogenSonataCoin', 0

const InitialSupply = 10^17

const decimals = 8

const TeamWallet = 0xcf2cb5d47575bf82eef58372974edbf7b312b7cd

const sub_82c5c107(?) = 0x783765e82b6d18a4487be507cf5f73f47e4edfff
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0xcf2cb5d47575bf82eef58372974edbf7b312b7cd with:
...
function TeamCreateLPandBNB() {
    ...
    if balanceOf[address(this.address)] >= stor10:
        if uint8(uint8(stor12.field_32) + uint8(stor12.field_40)):
            ...
            call 0xcf2cb5d47575bf82eef58372974edbf7b312b7cd with:
                 gas 30000 wei
            call 0x783765e82b6d18a4487be507cf5f73f47e4edfff with:
                 gas 30000 wei
