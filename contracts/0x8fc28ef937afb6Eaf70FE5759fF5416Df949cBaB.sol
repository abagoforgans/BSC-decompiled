...
function TeamCreateLPandBNB() {
    ...
    if balanceOf[this.address] >= 15000000000 * 10^18:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            ...
            if not stor20:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor20].field_0 = -(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18
            emit Approval((-(15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 15000000000 * 10^18), this.address, stor20);
            ...
            if not stor20:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor20].field_0 = 15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][stor20].field_255 = 0
            emit Approval((15000000000 * 10^18 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, stor20);
            require ext_code.size(stor20)
