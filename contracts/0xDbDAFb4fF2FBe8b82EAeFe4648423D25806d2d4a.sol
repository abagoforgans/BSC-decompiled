    ...
    if 0 == ':':
        ...
        if 0 == 'p':
            ...
            while idx < calldata.size - 2:
                ...
                idx = idx + 1
                continue 
            emit 0x2b4cf48d: msg.value, 96, 0, 3, 'BNB', 0, msg.sender
        else:
            if 0 >= calldata.size:
                revert with 'NH{q', 50
            if 0 == 'r':
                ...
                if floor32(calldata.size + 29) <= calldata.size - 2:
                    emit 0x3d084832: msg.value, 96, 160, 3, 'BNB', 0, calldata.size - 2, call.data[2 len calldata.size - 2], Mask(8 * floor32(calldata.size + 29) + -calldata.size + 2, -(8 * floor32(calldata.size + 29) + -calldata.size + 2) + 256, 0) >> -(8 * floor32(calldata.size + 29) + -calldata.size + 2) + 256, msg.sender
                else:
                    emit 0x3d084832: msg.value, 96, 160, 3, 'BNB', 0, calldata.size - 2, Mask(8 * calldata.size - 2, -(8 * calldata.size - 2) + 256, call.data[2 len calldata.size - 2], Mask(8 * floor32(calldata.size + 29) + -calldata.size + 2, -(8 * floor32(calldata.size + 29) + -calldata.size + 2) + 256, 0) >> -(8 * floor32(calldata.size + 29) + -calldata.size + 2) + 256) << (8 * calldata.size - 2) - 256, Mask(8 * floor32(calldata.size + 29) + -calldata.size + 2, -(8 * floor32(calldata.size + 29) + -calldata.size + 2) + 256, 0) >> -(8 * floor32(calldata.size + 29) + -calldata.size + 2) + 256, msg.sender
}
...
function sub_444a8d3f(?) {
    ...
    mem[ceil32(arg4.length) + 259 len ceil32(arg4.length)] = arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]
    if ceil32(arg4.length) > arg4.length:
        mem[ceil32(arg4.length) + arg4.length + 259] = 0
    if sha3(Mask(8 * arg4.length, -(8 * arg4.length) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * arg4.length) - 256) == sha3('BNB'):
        if eth.balance(this.address) < arg3:
            revert with 0, 'balance not enough'
    else:
        mem[ceil32(arg4.length) + arg4.length + 259 len ceil32(arg4.length)] = arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]
        mem[ceil32(arg4.length) + (2 * arg4.length) + 259] = 2
        if not stor[mem[(2 * ceil32(arg4.length)) + arg4.length + 259 len arg4.length + -ceil32(arg4.length) + 32]][Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256]:
            revert with 0, 'Invalid symbol'
        mem[ceil32(arg4.length) + arg4.length + 259 len ceil32(arg4.length)] = arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]
        mem[ceil32(arg4.length) + (2 * arg4.length) + 259] = 2
        require ext_code.size(stor[mem[(2 * ceil32(arg4.length)) + arg4.length + 259 len arg4.length + -ceil32(arg4.length) + 32]][Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256])
        staticcall stor[mem[(2 * ceil32(arg4.length)) + arg4.length + 259 len arg4.length + -ceil32(arg4.length) + 32]][Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256].0x70a08231 with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
