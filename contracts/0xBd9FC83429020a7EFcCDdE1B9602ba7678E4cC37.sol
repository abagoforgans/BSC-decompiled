...
function lfi() payable {
    return lfiAddress
}

function sub_25402171(?) payable {
    return sub_25402171Address
}
...
function stake(uint256 arg1) payable {
    ...
    if not totalSupply:
        ...
        if not msg.sender:
            ...
            if not ext_code.hash(sub_25402171Address):
                revert with 0, 'SafeERC20: call to non-contract'
            if ext_code.hash(sub_25402171Address) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[228 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
            mem[352 len 4] = uint32(arg1)
            call sub_25402171Address with:
