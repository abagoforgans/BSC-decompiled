...
function testArray() payable {
    mem[96 len 552] = code.data[5677 len 552]
    create contract with 0 wei
                    code: code.data[5677 len 552]
...
function sub_c7f33d36(?) payable {
    mem[64] = 96
    idx = 0
    s = 96
    while idx < 2:
        mem[mem[64] len 552] = code.data[5677 len 552]
        create contract with 0 wei
                        code: code.data[5677 len 552]
        if not create.new_address:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        _29 = mem[_28]
        require mem[_28] <= 4294967296
        require mem[_28] + 32 <= return_data.size
        require mem[mem[_28] + _28] <= 4294967296 and mem[_28] + (32 * mem[mem[_28] + _28]) + 32 <= return_data.size
        mem[_28 + ceil32(return_data.size)] = mem[mem[_28] + _28]
        _32 = mem[_29 + _28]
        s = 0
        while s < 32 * _32:
            mem[_28 + ceil32(return_data.size) + s + 32] = mem[_29 + _28 + s + 32]
            s = s + 32
            continue 
        mem[64] = (32 * _32) + _28 + ceil32(return_data.size) + 32
        idx = idx + 1
        s = _28 + ceil32(return_data.size)
        continue 
    mem[mem[64]] = 32
    mem[mem[64] + 32] = mem[s]
    _18 = mem[s]
    mem[mem[64] + 64 len floor32(mem[s])] = mem[s + 32 len floor32(mem[s])]
    return 32, mem[mem[64] + 32 len (32 * _18) + 32]
}
...
function sub_11897c9a(?) payable {
    ...
    if not ext_call.success:
        if not arg1.length:
            ...
            mem[(32 * arg1.length) + 160 len 32 * arg1.length] = code.data[5677 len 32 * arg1.length]
            mem[(64 * arg1.length) + 160] = 32
            mem[(64 * arg1.length) + 192] = arg1.length
            mem[(64 * arg1.length) + 224 len floor32(arg1.length)] = code.data[5677 len floor32(arg1.length)]
        return memory
    ...
    while idx <= arg1.length:
        ...
        if idx != mem[96]:
            ...
            if not ext_call.success:
                ...
                if not _369:
                    ...
                    continue 
                mem[(32 * _162) + _154 + ceil32(return_data.size) + 64 len 32 * _369] = code.data[5677 len 32 * _369]
                require mem[(32 * _162) + _154 + ceil32(return_data.size) + 32] - 1 < mem[(32 * _162) + _154 + ceil32(return_data.size) + 32]
        ...
        if not ext_call.success:
            ...
            if not _373:
                ...
                continue 
            mem[(32 * _171) + _163 + ceil32(return_data.size) + 64 len 32 * _373] = code.data[5677 len 32 * _373]
            require mem[(32 * _171) + _163 + ceil32(return_data.size) + 32] - 1 < mem[(32 * _171) + _163 + ceil32(return_data.size) + 32]
