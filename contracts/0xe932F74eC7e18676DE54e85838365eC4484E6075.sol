...
function sub_f2f5ec3a(?) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg5 > 5:
        revert with 0, 'Liquidity fees can't exceed 5%'
    if arg6 > 5:
        revert with 0, 'Liquidity fees can't exceed 5%'
    if arg1 > 3:
        revert with 0, 'Burn fees can't exceed 3%'
    if arg2 > 3:
        revert with 0, 'Burn fees can't exceed 3%'
    if arg7 > 7:
        revert with 0, 'Reward fees cannot exceed 7%'
    if arg8 > 7:
        revert with 0, 'Reward fees cannot exceed 7%'
    if arg3 > 10:
        revert with 0, 'Marketing fees can't exceed 10%'
    if arg4 > 10:
        revert with 0, 'Marketing fees can't exceed 10%'
    sub_5c234bb6 = arg1
    sub_5124f874 = arg3
    ...
    if sub_77a3b609 > !buyLiquidityFee:
        revert with 0, 17
    if sub_77a3b609 + buyLiquidityFee < sub_77a3b609:
        revert with 0, 'SafeMath: addition overflow'
    if sub_77a3b609 + buyLiquidityFee > !sub_5c234bb6:
        revert with 0, 17
    if sub_5c234bb6 < 0:
        revert with 0, 'SafeMath: addition overflow'
    if sub_77a3b609 + buyLiquidityFee + sub_5c234bb6 > !sub_5124f874:
        revert with 0, 17
    if sub_5124f874 < 0:
        revert with 0, 'SafeMath: addition overflow'
    stor13 = sub_77a3b609 + buyLiquidityFee + sub_5c234bb6 + sub_5124f874
    emit 0x16405318: sub_8ca2923a, sub_95451c29, sellLiquidityFee, sub_bb8d5131, sub_5c234bb6, sub_5124f874, buyLiquidityFee, sub_77a3b609
}
