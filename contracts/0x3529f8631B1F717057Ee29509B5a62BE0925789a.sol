...
function withdrawAll() payable {
    ...
    if ext_call.return_data[0] >= ext_call.return_data[0]:
        if not ext_call.return_data[0]:
            ...
            if return_data.size:
                ...
                if not return_data.size:
                    ...
                    if ext_code.hash(shortTokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[(32 * _9) + (4 * ceil32(return_data.size)) + 430 len 64] = 0, controllerAddress, ext_call.return_data[0 len 28]
                    call shortTokenAddress with:
                       funct uint32(stor6.field_0)
                         gas gas_remaining wei
                        args ext_call.return_data[0], Mask(224, 32, controllerAddress, ext_call.return_data[0 len 28]) >> 32, mem[(32 * _9) + (4 * ceil32(return_data.size)) + 494 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                        if mem[96]:
        ...
        if not ext_call.return_data[0]:
            ...
            call shortTokenAddress with:
               funct uint32(stor6.field_0), mem[(32 * _9) + (4 * ceil32(return_data.size)) + 398 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                 gas gas_remaining wei
