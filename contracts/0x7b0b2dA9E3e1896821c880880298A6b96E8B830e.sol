...
const TeamWallet = 0x3360ea9ded7972c86de8d4d5252b49c13268bf1c
...
function getBurnedTokens() {
    if 10 * 10^18 < totalSupply:
        revert with 'NH{q', 17
    return (-totalSupply + 10 * 10^18 / 100 * 10^6)
}
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x3360ea9ded7972c86de8d4d5252b49c13268bf1c with:
