...
function sub_39c8a6a2(?) {
    ...
    if not arg4.length:
        ...
        while stor3.length + 31 / 32 > idx:
            ...
            idx = idx + 1
            continue 
    sub_6ab13e7f = uint8(arg5)
    Mask(232, 0, stor12.field_24) = Mask(232, 0, arg6)
    Mask(224, 0, stor12.field_32) = 0
    Mask(224, 0, stor12.field_32) = Mask(224, 16, arg5) >> 16
}
    ...
    while idx < stor4.length:
        ...
        if not stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)]:
            ...
            staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]].field_0).mem[mem[64] len 4] with:
                   ...
                   args mem[mem[64] + 4 len (32 * _512) + _510 + -mem[64] + 96]
            if not ext_call.success:
                idx = idx + 1
                s = s
                t = t
    ...
    while idx < arg1.length:
        ...
        while t < stor4.length:
            ...
            if not stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor7', 7))[uint8(t)]:
                ...
                idx = 0
                while idx < 32 * _1012:
                    mem[idx + mem[64] + 100] = mem[idx + _499 + 384]
                    idx = idx + 32
                    continue 
                ...
                staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor4', 4))[uint8(t)]].field_0).mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len (32 * _1012) + _1010 + -mem[64] + 96]
                if not ext_call.success:
                    t = t + 1
                    u = u
                    v = v
                ...
                require return_data.size >= 32
                _1474 = mem[_1471]
                require mem[_1471] <= 4294967296
                require mem[_1471] + 32 <= return_data.size
                require mem[_1471 + mem[_1471]] <= 4294967296 and mem[_1471] + (32 * mem[_1471 + mem[_1471]]) + 32 <= return_data.size
                mem[_1471 + ceil32(return_data.size)] = mem[_1471 + mem[_1471]]
                _1479 = mem[_1471 + _1474]
                idx = 0
                while idx < 32 * _1479:
                    mem[idx + _1471 + ceil32(return_data.size) + 32] = mem[idx + _1471 + _1474 + 32]
                    idx = idx + 32
                    continue 
                mem[64] = (32 * _1479) + _1471 + ceil32(return_data.size) + 32
                require t < stor8.length
                ...
                if not stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor9', 9))[uint8(t)]:
                    ...
                    mem[0] = 1
                    require mem[_1471 + ceil32(return_data.size)] - 1 < mem[_1471 + ceil32(return_data.size)]
                    _1952 = mem[(32 * mem[_1471 + ceil32(return_data.size)] - 1) + _1471 + ceil32(return_data.size) + 32]
                    mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                    mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 36] = _1952
                    mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 68] = 64
                    mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 100] = mem[_499 + 352]
                    _1955 = mem[_499 + 352]
                    idx = 0
                    while idx < 32 * _1955:
                        mem[idx + (32 * _1479) + _1471 + ceil32(return_data.size) + 132] = mem[idx + _499 + 384]
                        idx = idx + 32
                        continue 
                    ...
                    staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)]].field_0).getAmountsOut(uint256 rg1, address[] rg2) with:
                            gas gas_remaining wei
                           args _1952, 64, mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 100 len (32 * _1955) + 32]
                    if not ext_call.success:
                        t = t + 1
                        u = u
                        v = _499 + 352
                        w = _499 + 352
                        continue 
                    mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    mem[64] = (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32
                    require return_data.size >= 32
                    _2366 = mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1952) >> 32
                    require mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1952) >> 32 <= 4294967296
                    require mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1952) >> 32 + 32 <= return_data.size
                    require mem[(32 * _1479) + _1471 + ceil32(return_data.size) + mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1952) >> 32 + 32] <= 4294967296 and mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1952) >> 32 + (32 * mem[(32 * _1479) + _1471 + ceil32(return_data.size) + mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1952) >> 32 + 32]) + 32 <= return_data.size
                    mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _1479) + _1471 + ceil32(return_data.size) + mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1952) >> 32 + 32]
                    _2375 = mem[(32 * _1479) + _1471 + ceil32(return_data.size) + _2366 + 32]
                    idx = 0
                    while idx < 32 * _2375:
                        mem[idx + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64] = mem[idx + (32 * _1479) + _1471 + ceil32(return_data.size) + _2366 + 64]
                        idx = idx + 32
                        continue 
                    mem[64] = (32 * _2375) + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64
                    require mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32]
                    _2743 = mem[(32 * mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64]
                    if not isDebug:
                        if mem[(32 * mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64] <= _498:
                            t = t + 1
                            u = u
                            v = _499 + 352
                            w = _499 + 352
                            continue 
                    if not isDebug:
                        if mem[(32 * mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64] - _498 <= u:
                            t = t + 1
                            u = u
                            v = _499 + 352
                            w = _499 + 352
                    ...
                    require 0 < mem[_1471 + ceil32(return_data.size)]
                    require 6 < mem[_499]
                    mem[_499 + 224] = mem[_1471 + ceil32(return_data.size) + 32]
                    require mem[_1471 + ceil32(return_data.size)] - 1 < mem[_1471 + ceil32(return_data.size)]
                    require 7 < mem[_499]
                    mem[_499 + 256] = mem[(32 * mem[_1471 + ceil32(return_data.size)] - 1) + _1471 + ceil32(return_data.size) + 32]
                    require 8 < mem[_499]
                    mem[_499 + 288] = _2743
                    require 9 < mem[_499]
                    mem[_499 + 320] = _2743 - _498
                    t = t + 1
                    u = _2743 - _498
                    v = _499 + 352
                    w = _499 + 352
                ...
                mem[0] = 1
                require mem[_1471 + ceil32(return_data.size)] - 1 < mem[_1471 + ceil32(return_data.size)]
                _1966 = mem[(32 * mem[_1471 + ceil32(return_data.size)] - 1) + _1471 + ceil32(return_data.size) + 32]
                mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 36] = _1966
                mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 68] = 64
                mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 100] = mem[_499 + 448]
                _1969 = mem[_499 + 448]
                idx = 0
                while idx < 32 * _1969:
                    mem[idx + (32 * _1479) + _1471 + ceil32(return_data.size) + 132] = mem[idx + _499 + 480]
                    idx = idx + 32
                    continue 
                require ext_code.size(address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)]].field_0))
                staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)]].field_0).getAmountsOut(uint256 rg1, address[] rg2) with:
                        gas gas_remaining wei
                       args _1966, 64, mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 100 len (32 * _1969) + 32]
                if not ext_call.success:
                    t = t + 1
                    u = u
                    v = _499 + 448
                ...
                mem[64] = (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32
                require return_data.size >= 32
                _2364 = mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1966) >> 32
                require mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1966) >> 32 <= 4294967296
                require mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1966) >> 32 + 32 <= return_data.size
                require mem[(32 * _1479) + _1471 + ceil32(return_data.size) + mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1966) >> 32 + 32] <= 4294967296 and mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1966) >> 32 + (32 * mem[(32 * _1479) + _1471 + ceil32(return_data.size) + mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1966) >> 32 + 32]) + 32 <= return_data.size
                mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _1479) + _1471 + ceil32(return_data.size) + mem[(32 * _1479) + _1471 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1966) >> 32 + 32]
                _2374 = mem[(32 * _1479) + _1471 + ceil32(return_data.size) + _2364 + 32]
                idx = 0
                while idx < 32 * _2374:
                    mem[idx + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64] = mem[idx + (32 * _1479) + _1471 + ceil32(return_data.size) + _2364 + 64]
                    idx = idx + 32
                    continue 
                mem[64] = (32 * _2374) + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64
                require mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32]
                _2742 = mem[(32 * mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64]
                if not isDebug:
                    if mem[(32 * mem[(32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1479) + _1471 + (2 * ceil32(return_data.size)) + 64] <= _498:
                        t = t + 1
                        u = u
            ...
            idx = 0
            while idx < 32 * _1017:
                mem[idx + mem[64] + 100] = mem[idx + _499 + 480]
                idx = idx + 32
                continue 
            require ext_code.size(address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor4', 4))[uint8(t)]].field_0))
            staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor4', 4))[uint8(t)]].field_0).mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len (32 * _1017) + _1015 + -mem[64] + 96]
            if not ext_call.success:
                t = t + 1
                u = u
                v = v
            ...
            require mem[_1470 + mem[_1470]] <= 4294967296 and mem[_1470] + (32 * mem[_1470 + mem[_1470]]) + 32 <= return_data.size
            mem[_1470 + ceil32(return_data.size)] = mem[_1470 + mem[_1470]]
            _1478 = mem[_1470 + _1472]
            idx = 0
            while idx < 32 * _1478:
                mem[idx + _1470 + ceil32(return_data.size) + 32] = mem[idx + _1470 + _1472 + 32]
                idx = idx + 32
                continue 
            mem[64] = (32 * _1478) + _1470 + ceil32(return_data.size) + 32
            require t < stor8.length
            require t < stor9.length
            require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor8', 8))[uint8(t)] < tokens.length
            if not stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor9', 9))[uint8(t)]:
                ...
                require stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)] < contracts.length
                mem[0] = 1
                require mem[_1470 + ceil32(return_data.size)] - 1 < mem[_1470 + ceil32(return_data.size)]
                _1947 = mem[(32 * mem[_1470 + ceil32(return_data.size)] - 1) + _1470 + ceil32(return_data.size) + 32]
                mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 36] = _1947
                mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 68] = 64
                mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 100] = mem[_499 + 352]
                _1950 = mem[_499 + 352]
                idx = 0
                while idx < 32 * _1950:
                    mem[idx + (32 * _1478) + _1470 + ceil32(return_data.size) + 132] = mem[idx + _499 + 384]
                    idx = idx + 32
                    continue 
                require ext_code.size(address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)]].field_0))
                staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)]].field_0).getAmountsOut(uint256 rg1, address[] rg2) with:
                        gas gas_remaining wei
                       args _1947, 64, mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 100 len (32 * _1950) + 32]
                if not ext_call.success:
                    t = t + 1
                    u = u
                    v = _499 + 352
                    w = _499 + 448
                    continue 
                mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32
                require return_data.size >= 32
                _2362 = mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1947) >> 32
                require mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1947) >> 32 <= 4294967296
                require mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1947) >> 32 + 32 <= return_data.size
                require mem[(32 * _1478) + _1470 + ceil32(return_data.size) + mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1947) >> 32 + 32] <= 4294967296 and mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1947) >> 32 + (32 * mem[(32 * _1478) + _1470 + ceil32(return_data.size) + mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1947) >> 32 + 32]) + 32 <= return_data.size
                mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _1478) + _1470 + ceil32(return_data.size) + mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1947) >> 32 + 32]
                _2373 = mem[(32 * _1478) + _1470 + ceil32(return_data.size) + _2362 + 32]
                idx = 0
                while idx < 32 * _2373:
                    mem[idx + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64] = mem[idx + (32 * _1478) + _1470 + ceil32(return_data.size) + _2362 + 64]
                    idx = idx + 32
                    continue 
                mem[64] = (32 * _2373) + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64
                require mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32]
                _2741 = mem[(32 * mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64]
                if not isDebug:
                    if mem[(32 * mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64] <= _498:
                        t = t + 1
                        u = u
                        v = _499 + 352
                        w = _499 + 448
                        continue 
                if not isDebug:
                    if mem[(32 * mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64] - _498 <= u:
                        t = t + 1
                        u = u
                        v = _499 + 352
                        w = _499 + 448
                ...
                require 5 < mem[_499]
                mem[_499 + 192] = stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor9', 9))[uint8(t)]
                require 0 < mem[_1470 + ceil32(return_data.size)]
                require 6 < mem[_499]
                mem[_499 + 224] = mem[_1470 + ceil32(return_data.size) + 32]
                require mem[_1470 + ceil32(return_data.size)] - 1 < mem[_1470 + ceil32(return_data.size)]
                require 7 < mem[_499]
                mem[_499 + 256] = mem[(32 * mem[_1470 + ceil32(return_data.size)] - 1) + _1470 + ceil32(return_data.size) + 32]
                require 8 < mem[_499]
                mem[_499 + 288] = _2741
                require 9 < mem[_499]
                mem[_499 + 320] = _2741 - _498
                t = t + 1
                u = _2741 - _498
                v = _499 + 352
                w = _499 + 448
            ...
            mem[0] = 1
            require mem[_1470 + ceil32(return_data.size)] - 1 < mem[_1470 + ceil32(return_data.size)]
            _1960 = mem[(32 * mem[_1470 + ceil32(return_data.size)] - 1) + _1470 + ceil32(return_data.size) + 32]
            mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 36] = _1960
            mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 68] = 64
            mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 100] = mem[_499 + 448]
            _1963 = mem[_499 + 448]
            idx = 0
            while idx < 32 * _1963:
                mem[idx + (32 * _1478) + _1470 + ceil32(return_data.size) + 132] = mem[idx + _499 + 480]
                idx = idx + 32
                continue 
            require ext_code.size(address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)]].field_0))
            staticcall address(contracts[stor('array', ('div', 0.03125, ('var', 2)), ('name', 'stor5', 5))[uint8(t)]].field_0).getAmountsOut(uint256 rg1, address[] rg2) with:
                    gas gas_remaining wei
                   args _1960, 64, mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 100 len (32 * _1963) + 32]
            if not ext_call.success:
                t = t + 1
                u = u
                v = _499 + 448
            ...
            mem[64] = (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32
            require return_data.size >= 32
            _2360 = mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1960) >> 32
            require mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1960) >> 32 <= 4294967296
            require mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1960) >> 32 + 32 <= return_data.size
            require mem[(32 * _1478) + _1470 + ceil32(return_data.size) + mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1960) >> 32 + 32] <= 4294967296 and mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1960) >> 32 + (32 * mem[(32 * _1478) + _1470 + ceil32(return_data.size) + mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1960) >> 32 + 32]) + 32 <= return_data.size
            mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] = mem[(32 * _1478) + _1470 + ceil32(return_data.size) + mem[(32 * _1478) + _1470 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, _1960) >> 32 + 32]
            _2372 = mem[(32 * _1478) + _1470 + ceil32(return_data.size) + _2360 + 32]
            idx = 0
            while idx < 32 * _2372:
                mem[idx + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64] = mem[idx + (32 * _1478) + _1470 + ceil32(return_data.size) + _2360 + 64]
                idx = idx + 32
                continue 
            mem[64] = (32 * _2372) + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64
            require mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] - 1 < mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32]
            _2740 = mem[(32 * mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64]
            if not isDebug:
                if mem[(32 * mem[(32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _1478) + _1470 + (2 * ceil32(return_data.size)) + 64] <= _498:
                    t = t + 1
                    u = u
...
function getContracts() {
        ...
        if not tokens.length:
            if not stor4.length:
                if not stor5.length:
                    ...
                    return Array(len=contracts.length, data=mem[128 len floor32(contracts.length)], mem[(32 * contracts.length) + (32 * tokens.length) + (32 * stor4.length) + (32 * stor5.length) + floor32(contracts.length) + 416 len (32 * contracts.length) + (32 * tokens.length) + (32 * stor5.length) + (32 * stor4.length) + -floor32(contracts.length) + 96]), 
    ...
    if not tokens.length:
        ...
        if not stor5.length:
            ...
            mem[(64 * stor4.length) + (64 * tokens.length) + (64 * contracts.length) + (32 * stor5.length) + 480] = stor5.length
            mem[(64 * stor4.length) + (64 * tokens.length) + (64 * contracts.length) + (32 * stor5.length) + 512 len floor32(stor5.length)] = mem[(32 * contracts.length) + (32 * tokens.length) + (32 * stor4.length) + 224 len floor32(stor5.length)]
            return Array(len=contracts.length, data=mem[128 len floor32(contracts.length)], mem[(32 * contracts.length) + (32 * tokens.length) + (32 * stor4.length) + (32 * stor5.length) + floor32(contracts.length) + 416 len (32 * contracts.length) + (32 * stor4.length) + (32 * stor5.length) + (32 * tokens.length) + -floor32(contracts.length) + 96]), 
                   (32 * contracts.length) + 192,
                   (32 * tokens.length) + (32 * contracts.length) + 224,
                   (32 * stor4.length) + (32 * tokens.length) + (32 * contracts.length) + 256,
                   baseToken
