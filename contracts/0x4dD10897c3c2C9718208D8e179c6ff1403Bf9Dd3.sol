...
function sub_dace9967(?) payable {
    return sub_dace9967Address
}
...
function sub_250e6de0(?) payable {
    ...
    call stakingTokenAddress.approve(address arg1, uint256 arg2) with:
        ...
        args sub_dace9967Address, 1000000 * 10^18
...
function sub_377c58bf(?) payable {
    ...
    if stor0 == 2:
        revert with 0, 'ReentrancyGuard: reentrant call'
    stor0 = 2
    require ext_code.size(sub_dace9967Address)
    call sub_dace9967Address.leaveStaking(uint256 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    mem[ceil32(return_data.size) + 132] = 520 * 10^18
    require ext_code.size(stakingTokenAddress)
    call stakingTokenAddress.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    mem[(2 * ceil32(return_data.size)) + 292 len 128] = unknown_0x23b872dd(?????), address(this.address) << 64, 0, address(stor1.field_0), ext_call.return_data[0], 0
    mem[(2 * ceil32(return_data.size)) + 392] = 0
    call stakingTokenAddress with:
       funct Mask(32, 224, unknown_0x23b872dd(?????), address(this.address) << 64, 0, address(stor1.field_0), ext_call.return_data[0], 0) >> 224
         gas gas_remaining wei
        args (Mask(768, -544, unknown_0x23b872dd(?????), address(this.address) << 64, 0, address(stor1.field_0), ext_call.return_data[0], 0) << 544)
...
function withdrawPrincipal() payable {
    ...
    call sub_dace9967Address.leaveStaking(uint256 arg1) with:
         gas gas_remaining wei
        args stakedBalance[0][address(msg.sender)].field_0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_fafd5239(?) payable {
    ...
    require ext_code.size(sub_dace9967Address)
    staticcall sub_dace9967Address.pendingCake(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args 0, this.address
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    mem[(2 * ceil32(return_data.size)) + 132] = 520 * 10^18
    require ext_code.size(stakingTokenAddress)
    call stakingTokenAddress.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args address(this.address), 520 * 10^18
    ...
    mem[(4 * ceil32(return_data.size)) + 164] = owner
    mem[(4 * ceil32(return_data.size)) + 196] = ext_call.return_data[0]
    mem[(4 * ceil32(return_data.size)) + 96] = 100
    mem[(4 * ceil32(return_data.size)) + 132 len 28] = address(this.address) << 64
    ...
    if ext_code.size(stakingTokenAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[(4 * ceil32(return_data.size)) + 292 len 128] = unknown_0x23b872dd(?????), address(this.address) << 64, 0, address(stor1.field_0), ext_call.return_data[0], 0
