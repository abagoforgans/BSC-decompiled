...
function sub_1906d23f(?) payable {
    require ext_code.size(burnrateAddress)
    staticcall burnrateAddress.currentBurnPercent() with:
...
function enter(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        if not totalSupply:
            if not msg.sender:
                revert with 0, 'BEP20: mint to the zero address'
            if arg1 - (ext_call.return_data[0] * arg1 / 100) + totalSupply < totalSupply:
                revert with 0, 'SafeMath: addition overflow'
            totalSupply = arg1 - (ext_call.return_data[0] * arg1 / 100) + totalSupply
            if arg1 - (ext_call.return_data[0] * arg1 / 100) + balanceOf[address(msg.sender)] < balanceOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(msg.sender)] = arg1 - (ext_call.return_data[0] * arg1 / 100) + balanceOf[address(msg.sender)]
            emit Transfer((arg1 - (ext_call.return_data[0] * arg1 / 100)), 0, msg.sender);
        else:
            if not ext_call.return_data[0]:
                if not msg.sender:
                    revert with 0, 'BEP20: mint to the zero address'
                ...
                if not arg1 - (ext_call.return_data[0] * arg1 / 100):
                    if not ext_call.return_data[0]:
                        revert with 0, 'SafeMath: division by zero'
                    if not msg.sender:
                        revert with 0, 'BEP20: mint to the zero address'
                    ...
                    if (arg1 * totalSupply) - (ext_call.return_data[0] * arg1 / 100 * totalSupply) / arg1 - (ext_call.return_data[0] * arg1 / 100) != totalSupply:
                        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                    if not ext_call.return_data[0]:
                        revert with 0, 'SafeMath: division by zero'
                    if not msg.sender:
                        revert with 0, 'BEP20: mint to the zero address'
                    if ((arg1 * totalSupply) - (ext_call.return_data[0] * arg1 / 100 * totalSupply) / ext_call.return_data[0]) + totalSupply < totalSupply:
                        revert with 0, 'SafeMath: addition overflow'
                    totalSupply += (arg1 * totalSupply) - (ext_call.return_data[0] * arg1 / 100 * totalSupply) / ext_call.return_data[0]
                    if ((arg1 * totalSupply) - (ext_call.return_data[0] * arg1 / 100 * totalSupply) / ext_call.return_data[0]) + balanceOf[address(msg.sender)] < balanceOf[address(msg.sender)]:
                        revert with 0, 'SafeMath: addition overflow'
                    balanceOf[address(msg.sender)] += (arg1 * totalSupply) - (ext_call.return_data[0] * arg1 / 100 * totalSupply) / ext_call.return_data[0]
                    emit Transfer(((arg1 * totalSupply) - (ext_call.return_data[0] * arg1 / 100 * totalSupply) / ext_call.return_data[0]), 0, msg.sender);
    require ext_code.size(thugsAddress)
