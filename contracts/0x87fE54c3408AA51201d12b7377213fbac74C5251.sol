        ...
        if sub_64cc79bd[arg1]:
            if not sub_64cc79bd[arg1]:
                ...
                if txFeeRatio * sub_64cc79bd[arg1] / 10^18 > sub_64cc79bd[arg1]:
                    revert with 0, 'SafeMath: subtraction overflow', 0
                if sub_64cc79bd[arg1] < miningDifficulty:
                    if sub_64cc79bd[arg1] - (txFeeRatio * sub_64cc79bd[arg1] / 10^18):
                        call address(stor53[arg1].field_0) with:
                        ...
                        if sub_a5b6260e:
                            ...
                            call 0x7a250d5630b4cf539739df2c5dacb4c659f2488d.swapExactETHForTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
                               value txFeeRatio * sub_64cc79bd[arg1] / 10^18 wei
                                 gas gas_remaining wei
                                args 0, 128, 57005, block.timestamp + 1200, mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 1124 len (32 * mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + 896]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            ...
                            require return_data.size >= 32
                            require mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 992 len 4], 0 <= test266151307()
                            require ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + return_data.size + 992 > ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 992 len 4], 0 + 1023
                            require mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 992 len 4], 0 + 992] <= test266151307()
                            require (32 * mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 992 len 4], 0 + 992]) + 32 >= 0 and ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + (2 * ceil32(return_data.size)) + (32 * mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 992 len 4], 0 + 992]) + 1024 <= test266151307()
                            require return_data.size >= mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 992 len 4], 0 + (32 * mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + mem[ceil32(stor[('name', 'stor53', 53) + (10 * arg1) + 1].length) + ceil32(return_data.size) + 992 len 4], 0 + 992]) + 32
                else:
                    require ext_code.size(address(sub_d41620d1Address))
                    call address(sub_d41620d1Address).0xba167067 with:
                         gas gas_remaining wei
                    ...
                    if not sub_64cc79bd[arg1] - (txFeeRatio * sub_64cc79bd[arg1] / 10^18):
                        if txFeeRatio * sub_64cc79bd[arg1] / 10^18:
                            if sub_a5b6260e:
                                ...
                                require return_data.size >= 32
                                require mem[_771] <= test266151307()
                                require _771 + return_data.size > _771 + mem[_771] + 31
                                require mem[_771 + mem[_771]] <= test266151307()
                                require (32 * mem[_771 + mem[_771]]) + 32 >= 0 and _771 + ceil32(return_data.size) + (32 * mem[_771 + mem[_771]]) + 32 <= test266151307()
                                require return_data.size >= mem[_771] + (32 * mem[_771 + mem[_771]]) + 32
                    else:
                        call address(stor53[arg1].field_0) with:
                           value sub_64cc79bd[arg1] - (txFeeRatio * sub_64cc79bd[arg1] / 10^18) wei
                             gas 2300 * is_zero(value) wei
