...
function substring(string arg1, uint256 arg2, uint256 arg3) {
    ...
    mem[ceil32(arg1.length) + 160 len arg3 - arg2] = code.data[13164 len arg3 - arg2]
    idx = arg2
    while idx < arg3:
        require idx < mem[96]
        require idx - arg2 < mem[ceil32(arg1.length) + 128]
...
function sub_d8c981a3(?) {
    ...
    mem[arg1.length + ceil32(arg1.length) + 192 len 2] = code.data[13164 len 2]
    idx = 0
    while idx < 2:
        require idx < arg1.length
        require idx < 2
