...
#  - uri(uint256 arg1)
#
const contractURI = Array(len=46, data=0x4568747470733a2f2f6273632e747278737761702e696e666f2f636f6e74726163742f766573742d657263313135, mem[174 len 18], mem[210 len 14])
...
function balanceOfBatch(address[] arg1, uint256[] arg2) payable {
    ...
    if arg1.length:
        mem[(32 * arg1.length) + (32 * arg2.length) + 192 len 32 * arg1.length] = code.data[10771 len 32 * arg1.length]
    idx = 0
