    ...
    if calldata.size < 4:
        ...
        if unknown_0xc0d78655(?????) > uint32(call.func_hash) >> 224:
            ...
            if unknown_0x9f654fa4(?????) == uint32(call.func_hash) >> 224:
                ...
                mem[64] = ceil32(return_data.size) + 224
                require return_data.size >= 32
                _173 = mem[224 len 4], 0
                require mem[224 len 4], 0 <= test266151307()
                require mem[224 len 4], 0 + 255 < return_data.size + 224
                _177 = mem[mem[224 len 4], 0 + 224]
                if mem[mem[224 len 4], 0 + 224] > test266151307():
                    revert with 0, 65
                if ceil32(return_data.size) + ceil32(32 * mem[mem[224 len 4], 0 + 224]) + 225 > test266151307() or ceil32(32 * mem[mem[224 len 4], 0 + 224]) + 1 < 0:
                    revert with 0, 65
                ...
                mem[ceil32(return_data.size) + 256 len ceil32(32 * _177)] = mem[_173 + 256 len ceil32(32 * _177)]
                staticcall stor2.latestRoundData() with:
                        gas gas_remaining wei
                mem[mem[64] len 160] = ext_call.return_data[0 len 160]
                if not ext_call.success:
            ...
            if unknown_0xc0d78655(?????) == uint32(call.func_hash) >> 224:
                ...
                if unknown_0xc63f959e(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0xd5132dd2(?????):
                        ...
                        require return_data.size >= 32
                        _175 = mem[(2 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28]
                        ...
                        mem[(4 * ceil32(return_data.size)) + 256 len ceil32(32 * _179)] = mem[(2 * ceil32(return_data.size)) + _175 + 256 len ceil32(32 * _179)]
                        staticcall stor2.latestRoundData() with:
                                gas gas_remaining wei
                        mem[mem[64] len 160] = ext_call.return_data[0 len 160]
                        if not ext_call.success:
