...
function claimDividend() {
    ...
    call stor37.claimDividend(address arg1) with:
...
function getUnpaidEarnings(address arg1) {
    ...
    require arg1 == arg1
    require ext_code.size(stor37)
    staticcall stor37.0x28fd3198 with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setAutoBuybackSettings(bool arg1, uint256 arg2, uint256 arg3, uint256 arg4, bool arg5) {
    ...
    Mask(248, 0, stor31.field_8) = Mask(248, 0, arg5)
    Mask(240, 0, stor31.field_16) = Mask(240, 16, arg1) >> 16
}
...
function getMultipliedFee() {
    if stor29 > !stor30:
        revert with 0, 17
    if stor29 + stor30 < stor29:
        revert with 0, 'SafeMath: addition overflow'
    if block.timestamp > stor29 + stor30:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if stor29 + stor30 < block.timestamp:
        revert with 0, 17
    if not stor18:
        if not stor28:
            revert with 0, 'SafeMath: division by zero', 0
        ...
        if not (0 / stor28) - stor18:
            ...
            if stor18 > !(0 / stor30):
                revert with 0, 17
            if stor18 + (0 / stor30) < stor18:
                revert with 0, 'SafeMath: addition overflow'
            return (stor18 + (0 / stor30))
        if (0 / stor28) - stor18 and stor29 + stor30 - block.timestamp > -1 / (0 / stor28) - stor18:
            revert with 0, 17
        if not (0 / stor28) - stor18:
            revert with 0, 18
        if (stor29 * 0 / stor28) + (stor30 * 0 / stor28) - (block.timestamp * 0 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / (0 / stor28) - stor18 != stor29 + stor30 - block.timestamp:
            revert with 0, 'SafeMath: multiplication overflow'
        if not stor30:
            revert with 0, 'SafeMath: division by zero', 0
        if stor18 > !((stor29 * 0 / stor28) + (stor30 * 0 / stor28) - (block.timestamp * 0 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / stor30):
            revert with 0, 17
        if stor18 + ((stor29 * 0 / stor28) + (stor30 * 0 / stor28) - (block.timestamp * 0 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / stor30) < stor18:
            revert with 0, 'SafeMath: addition overflow'
        return (stor18 + ((stor29 * 0 / stor28) + (stor30 * 0 / stor28) - (block.timestamp * 0 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / stor30))
    if stor18 and stor27 > -1 / stor18:
        revert with 0, 17
    if not stor18:
        revert with 0, 18
    if stor18 * stor27 / stor18 != stor27:
        revert with 0, 'SafeMath: multiplication overflow'
    if not stor28:
        revert with 0, 'SafeMath: division by zero', 0
    if stor18 > stor18 * stor27 / stor28:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if stor18 * stor27 / stor28 < stor18:
        revert with 0, 17
    if not (stor18 * stor27 / stor28) - stor18:
        if not stor30:
            revert with 0, 'SafeMath: division by zero', 0
        if stor18 > !(0 / stor30):
            revert with 0, 17
        if stor18 + (0 / stor30) < stor18:
            revert with 0, 'SafeMath: addition overflow'
        return (stor18 + (0 / stor30))
    if (stor18 * stor27 / stor28) - stor18 and stor29 + stor30 - block.timestamp > -1 / (stor18 * stor27 / stor28) - stor18:
        revert with 0, 17
    if not (stor18 * stor27 / stor28) - stor18:
        revert with 0, 18
    if (stor29 * stor18 * stor27 / stor28) + (stor30 * stor18 * stor27 / stor28) - (block.timestamp * stor18 * stor27 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / (stor18 * stor27 / stor28) - stor18 != stor29 + stor30 - block.timestamp:
        revert with 0, 'SafeMath: multiplication overflow'
    if not stor30:
        revert with 0, 'SafeMath: division by zero', 0
    if stor18 > !((stor29 * stor18 * stor27 / stor28) + (stor30 * stor18 * stor27 / stor28) - (block.timestamp * stor18 * stor27 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / stor30):
        revert with 0, 17
    if stor18 + ((stor29 * stor18 * stor27 / stor28) + (stor30 * stor18 * stor27 / stor28) - (block.timestamp * stor18 * stor27 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / stor30) < stor18:
        revert with 0, 'SafeMath: addition overflow'
    return (stor18 + ((stor29 * stor18 * stor27 / stor28) + (stor30 * stor18 * stor27 / stor28) - (block.timestamp * stor18 * stor27 / stor28) - (stor29 * stor18) - (stor30 * stor18) + (block.timestamp * stor18) / stor30))
}
