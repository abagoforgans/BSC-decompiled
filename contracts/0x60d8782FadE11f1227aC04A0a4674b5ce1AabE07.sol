...
function sub_be67c6c1(?) {
    ...
    require ext_code.size(0xfff5088c362572589d5a197d37f4c8439c8cf22a)
    delegate 0xfff5088c362572589d5a197d37f4c8439c8cf22a.0xcd7db54c with:
...
function sub_31f17857(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(0x51f114809288e0b6c4a76df08c560631e00bcae)
    delegate 0x51f114809288e0b6c4a76df08c560631e00bcae.0x13d674fe with:
         gas gas_remaining wei
...
function sub_b97c41a5(?) {
    if not sub_26f05442Address:
        return 100 * 10^6
    require ext_code.size(0xfff5088c362572589d5a197d37f4c8439c8cf22a)
    delegate 0xfff5088c362572589d5a197d37f4c8439c8cf22a.0xcc23f384 with:
         gas gas_remaining wei
...
function approve(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1)
    delegate 0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0xbfab77ea93f8de9bc59e7048617718f1a0b61a55)
        delegate 0xbfab77ea93f8de9bc59e7048617718f1a0b61a55.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2 == arg2
    require ext_code.size(0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1)
    delegate 0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_acd3a308(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0x144d5ee with:
             gas gas_remaining wei
...
function sub_5116bffe(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0xbdfadbdd with:
             gas gas_remaining wei
...
function sub_82ae9696(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xe146e37de04717f1d58175ade4aa1f93811b5612)
        delegate 0xe146e37de04717f1d58175ade4aa1f93811b5612.0x84c20628 with:
             gas gas_remaining wei
...
function sub_5126dad7(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xed6ccbd906ca922c7173965a1e445983c817591b)
        delegate 0xed6ccbd906ca922c7173965a1e445983c817591b.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_f090df5d(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xed6ccbd906ca922c7173965a1e445983c817591b)
        delegate 0xed6ccbd906ca922c7173965a1e445983c817591b.0xc2d5b6ab with:
             gas gas_remaining wei
...
function sub_528f6b54(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x67f255783889d2c7193b67a62fae071e2263452d)
        delegate 0x67f255783889d2c7193b67a62fae071e2263452d.0xa7b9a567 with:
             gas gas_remaining wei
...
function sub_a9f1866b(?) {
    require ext_code.size(0xfff5088c362572589d5a197d37f4c8439c8cf22a)
    delegate 0xfff5088c362572589d5a197d37f4c8439c8cf22a.0x5bb709aa with:
         gas gas_remaining wei
        args 3, 30
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_594161f8(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0xbfab77ea93f8de9bc59e7048617718f1a0b61a55)
        delegate 0xbfab77ea93f8de9bc59e7048617718f1a0b61a55.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1)
            delegate 0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_c8d49a06(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x67f255783889d2c7193b67a62fae071e2263452d)
        delegate 0x67f255783889d2c7193b67a62fae071e2263452d.mem[ceil32(arg1.length) + ceil32(arg2.length) + 160 len 4] with:
             gas gas_remaining wei
...
function sub_d32ea8b6(?) {
    ...
    mem[516] = arg1
    require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
    delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_c1f53e53(?) {
    ...
    require ext_code.size(0x42ae1b5bd75e6400d066ebc00acb6e464e952904)
    delegate 0x42ae1b5bd75e6400d066ebc00acb6e464e952904.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_ed3db462(?) {
    ...
    require ('cd', 4)[12] == address(('cd', 4)[12])
    require ext_code.size(0x42ae1b5bd75e6400d066ebc00acb6e464e952904)
    delegate 0x42ae1b5bd75e6400d066ebc00acb6e464e952904.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0xbfab77ea93f8de9bc59e7048617718f1a0b61a55)
        delegate 0xbfab77ea93f8de9bc59e7048617718f1a0b61a55.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
        delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_4dc26ae8(?) {
    ...
    mem[132] = 19
    require ext_code.size(0x67f255783889d2c7193b67a62fae071e2263452d)
    delegate 0x67f255783889d2c7193b67a62fae071e2263452d.0x45d85d80 with:
         gas gas_remaining wei
        args 19
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) {
    ...
    mem[132] = 14
    require ext_code.size(0xb482678da3d0a6afc43cde1a94788ae28364c19)
    delegate 0xb482678da3d0a6afc43cde1a94788ae28364c19.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    ...
    mem[388] = arg1
    require ext_code.size(0x51f114809288e0b6c4a76df08c560631e00bcae)
    delegate 0x51f114809288e0b6c4a76df08c560631e00bcae.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1)
    delegate 0x5b9313bcb1011c61c433a8ea3d69c59ceea714b1.0xc5bb51da with:
         gas gas_remaining wei
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[1] <= 0:
            if ('cd', 4)[4] <= 0:
                ...
                require ext_code.size(0x42ae1b5bd75e6400d066ebc00acb6e464e952904)
                delegate 0x42ae1b5bd75e6400d066ebc00acb6e464e952904.mem[mem[64] len 4] with:
                     gas gas_remaining wei
