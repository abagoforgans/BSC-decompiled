...
#  - uri(uint256 arg1)
#
const contractURI = Array(len=56, data=0x7368747470733a2f2f6170692e6179616b612e6d6f652f7933642d696e666f2f636f6e74726163742f736574312f793364736574312d6e66, mem[184 len 8], Mask(192, -256, mem[184 len 8]) << 256)
...
function setBaseMetadataURI(string arg1) payable {
    ...
    if not stor5[address(msg.sender)]:
        revert with 0, 
                    32,
                    64,
                    0x7457686974656c69737441646d696e526f6c653a2063616c6c657220646f6573206e6f742068617665207468652057686974656c69737441646d696e20726f6c
...
function balanceOfBatch(address[] arg1, uint256[] arg2) payable {
    ...
    if arg1.length:
        mem[(32 * arg1.length) + (32 * arg2.length) + 192 len 32 * arg1.length] = code.data[10825 len 32 * arg1.length]
    idx = 0
