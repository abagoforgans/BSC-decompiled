...
#  - getMultipliedFee()
#
const name = 'BABY TRUCKS INU', 0

const decimals = 18

const symbol = 'BBTRIN', 0
...
function enableAntiBot(uint256 arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
