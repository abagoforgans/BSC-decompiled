...
function rewardOf(address arg1) payable {
    ...
    if stakeOf[address(arg1)]:
        return (stor1[address(arg1)] + ((25 * block.timestamp * stakeOf[address(arg1)]) - (25 * stor2[address(arg1)] * stakeOf[address(arg1)]) / 6900000))
    else:
        return 0
}
...
function harvest() payable {
    ...
    call stor14.0xae2fe633 with:
        ...
        args msg.sender, stor1[address(msg.sender)] + ((25 * block.timestamp * stakeOf[address(msg.sender)]) - (25 * stor2[address(msg.sender)] * stakeOf[address(msg.sender)]) / 6900000)
...
function sub_80dbd3f2(?) payable {
    ...
    if arg2 != 1:
        call stor15.transferFrom(address rg1, address rg2, uint256 rg3) with:
             gas gas_remaining wei
            args address(arg1), stor13, arg2
    else:
        staticcall stor15.balanceOf(address rg1) with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function unStake() payable {
    ...
    require ext_code.size(stor15)
    call stor15.transfer(address rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function stake(uint256 arg1) payable {
    ...
    if stakeOf[address(msg.sender)] > 0:
        stor1[address(msg.sender)] += (25 * block.timestamp * stakeOf[address(msg.sender)]) - (25 * stor2[address(msg.sender)] * stakeOf[address(msg.sender)]) / 6900000
