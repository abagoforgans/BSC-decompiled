...
function setAntiBotTime(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function addBotlisted(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function removeBotlisted(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if bool(stor4[address(msg.sender)]) != 1:
        if block.timestamp < stor3[address(msg.sender)]:
            revert with 'NH{q', 17
        if block.timestamp - stor3[address(msg.sender)] <= stor8:
            revert with 'NH{q', 1
    if bool(stor4[address(arg1)]) != 1:
        if block.timestamp < stor3[address(arg1)]:
            revert with 'NH{q', 17
        if block.timestamp - stor3[address(arg1)] <= stor8:
            revert with 'NH{q', 1
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if bool(stor4[address(arg2)]) != 1:
        if block.timestamp < stor3[address(arg2)]:
            revert with 'NH{q', 17
        if block.timestamp - stor3[address(arg2)] <= stor8:
            revert with 'NH{q', 1
    if balanceOf[address(arg1)] < arg3:
        revert with 'NH{q', 1
    balanceOf[address(arg1)] -= arg3
    stor3[address(arg1)] = block.timestamp
    stor3[address(arg2)] = block.timestamp
...
function mint(address arg1, uint256 arg2) payable {
    ...
    if stor14:
        ...
        if block.timestamp < stor12:
            revert with 'NH{q', 17
        if block.timestamp - stor12 <= 168 * 24 * 3600:
            revert with 'NH{q', 1
        if arg2 > -stor11 - 1:
            revert with 'NH{q', 17
        if arg2 + stor11 < stor13:
            if stor11 > -arg2 - 1:
                revert with 'NH{q', 17
            stor11 += arg2
            if stor11 > stor13:
            ...
            if arg2 + stor11 < stor13:
                revert with 'NH{q', 17
            if stor11 > -arg2 + -stor11 + stor13 - 1:
                revert with 'NH{q', 17
            stor11 = (2 * stor11) + arg2 - stor13
            if stor11 > stor13:
                stor12 = block.timestamp
            if totalSupply > -arg2 + -stor11 + stor13 - 1:
                revert with 'NH{q', 17
            totalSupply = totalSupply + arg2 + stor11 - stor13
            if balanceOf[address(arg1)] > -arg2 + -stor11 + stor13 - 1:
                revert with 'NH{q', 17
            balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 + stor11 - stor13
            emit Transfer((arg2 + stor11 - stor13), 0, arg1);
}
