...
#
const name = 'HumpyPumpty', 0

const MarketingWallet = 0x68f6886828418b962e1cac272927567478ac3ea0

const decimals = 9

const sub_504762e7(?) = 10^18

const symbol = 'Hpumpty', 0
...
function sub_218f8a1d(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x68f6886828418b962e1cac272927567478ac3ea0 with:
