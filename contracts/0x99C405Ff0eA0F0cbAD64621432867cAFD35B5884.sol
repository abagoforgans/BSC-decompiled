...
function sub_3dea73af(?) {
    ...
    if ext_call.return_data[32] >= 3 * 10^15:
        ...
        _62 = mem[_59 + 192]
        mem[ceil32(return_data.size) + 224 len floor32(mem[_59 + 192])] = mem[_59 + 224 len floor32(mem[_59 + 192])]
        require 1 < mem[ceil32(return_data.size) + 192]
        _89 = mem[ceil32(return_data.size) + 256]
        mem[(32 * _62) + ceil32(return_data.size) + 228] = arg2
        mem[(32 * _62) + ceil32(return_data.size) + 260] = _89
        require ext_code.size(arg3)
        call arg3.approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args address(arg2), _89
        mem[(32 * _62) + ceil32(return_data.size) + 224] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        mem[160] = wethAddress
        require 1 < mem[ceil32(return_data.size) + 192]
        _99 = mem[ceil32(return_data.size) + 256]
        mem[(32 * _62) + ceil32(return_data.size) + 224] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
        mem[(32 * _62) + ceil32(return_data.size) + 228] = _99
        mem[(32 * _62) + ceil32(return_data.size) + 260] = 0
        mem[(32 * _62) + ceil32(return_data.size) + 324] = this.address
        ...
        call arg2.swapExactTokensForETH(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args _99, 0, 160, address(this.address), block.timestamp + 100, 2, mem[(32 * _62) + ceil32(return_data.size) + 420 len 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require mem[(32 * _62) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _99) >> 32 <= 4294967296
        require mem[(32 * _62) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _99) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * _62) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _99) >> 32 + (32 * _62) + ceil32(return_data.size) + 224] <= 4294967296 and mem[(32 * _62) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _99) >> 32 + (32 * mem[mem[(32 * _62) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _99) >> 32 + (32 * _62) + ceil32(return_data.size) + 224]) + 32 <= return_data.size
}
