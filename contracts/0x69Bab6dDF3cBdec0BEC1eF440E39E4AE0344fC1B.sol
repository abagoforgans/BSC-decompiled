...
function _fallback() payable {
    ...
    if calldata.size < 4:
        ...
        if unknown_0x1116be35(?????) == uint32(call.func_hash) >> 224:
            require not msg.value
            require calldata.size - 4 >= 64
        ...
        if unknown_0x36568abe(?????) == uint32(call.func_hash) >> 224:
            ...
            if unknown_0x74970200(?????) == uint32(call.func_hash) >> 224:
                require calldata.size - 4 >= 32
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x7fd12ca4(?????):
                    if unknown_0x81dfad99(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 32
                        require cd[4] <= test266151307()
                        require cd[4] + 35 < calldata.size
