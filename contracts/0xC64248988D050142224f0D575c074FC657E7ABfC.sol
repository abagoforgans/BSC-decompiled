...
function getInfo() {
    ...
    if stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0 and 24 * 3600 > -1 / stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0:
        revert with 'NH{q', 17
    if stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0 > (-86400 * stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0) - 1:
        revert with 'NH{q', 17
    return stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0, 
           ...
           block.timestamp,
           block.timestamp < stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0 + (24 * 3600 * stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0)
}
...
function withdraw() {
    ...
    if stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0 > (-86400 * stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0) - 1:
        revert with 'NH{q', 17
    if block.timestamp < stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0 + (24 * 3600 * stor[(3 * investorsMap[address(msg.sender)].field_1792) + ('array', 7, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'investorsMap', 6)))].field_0):
