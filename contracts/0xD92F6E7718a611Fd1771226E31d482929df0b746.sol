...
function addPartner(address arg1) {
    ...
    checkOwnerShare[address(arg1)] = 5
...
function buy(address arg1) payable {
    ...
    while idx < stor4.length:
        ...
        if msg.value:
            require msg.value
            require checkOwnerShare[stor4[idx]] * msg.value / msg.value == checkOwnerShare[stor4[idx]]
        require checkOwnerShare[stor4[idx]] * msg.value == (100 * checkOwnerShare[stor4[idx]] * msg.value / 100) + (checkOwnerShare[stor4[idx]] * msg.value % 100)
        require idx < stor4.length
        call stor4[idx] with:
           value checkOwnerShare[stor4[idx]] * msg.value / 100 wei
        ...
        if stor4[idx] != owner:
            ...
            if checkOwnerShare[stor4[idx]] > 0:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        s = checkOwnerShare[stor4[idx]] * msg.value / 100
