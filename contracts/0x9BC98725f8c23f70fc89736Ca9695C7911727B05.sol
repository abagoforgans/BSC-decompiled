...
function swapV2Call(address arg1, uint256 arg2, uint256 arg3, bytes arg4) {
    ...
    _64 = mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + 224 len 4], Mask(224, 32, arg3) >> 32
    ...
    _67 = mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + _64 + 224]
    mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len floor32(mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + _64 + 224])] = mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + _64 + 256 len floor32(mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + _64 + 224])]
    require 0 < mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 224]
    _114 = mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256]
    ...
    require return_data.size >= 32
    if not cd[(arg4 + 228)]:
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 260] = arg3
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 292] = _114
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 356] = this.address
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 388] = block.timestamp + (240 * 24 * 3600)
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 324] = 160
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 420] = Mask(8 * -ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + cd[(arg4 + cd[(arg4 + 260)] + 36)] + 32, 0, 0), mem[cd[(arg4 + cd[(arg4 + 260)] + 36)] + 160 len -cd[(arg4 + cd[(arg4 + 260)] + 36)] + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)])]
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 452 len floor32(Mask(8 * -ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + cd[(arg4 + cd[(arg4 + 260)] + 36)] + 32, 0, 0), mem[cd[(arg4 + cd[(arg4 + 260)] + 36)] + 160 len -cd[(arg4 + cd[(arg4 + 260)] + 36)] + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)])])] = mem[ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + 160 len floor32(Mask(8 * -ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + cd[(arg4 + cd[(arg4 + 260)] + 36)] + 32, 0, 0), mem[cd[(arg4 + cd[(arg4 + 260)] + 36)] + 160 len -cd[(arg4 + cd[(arg4 + 260)] + 36)] + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)])])]
        ...
        call address(cd[(arg4 + 132)]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 260 len (32 * Mask(8 * -ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + cd[(arg4 + cd[(arg4 + 260)] + 36)] + 32, 0, 0), mem[cd[(arg4 + cd[(arg4 + 260)] + 36)] + 160 len -cd[(arg4 + cd[(arg4 + 260)] + 36)] + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)])]) + 192]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 256
        require return_data.size >= 32
        _162 = mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32
        require mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 <= 4294967296
        require mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 32 <= return_data.size
        require mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 256] <= 4294967296 and mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + (32 * mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 256]) + 32 <= return_data.size
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 256] = mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 256]
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 288 len floor32(mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + _162 + 256])] = mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + _162 + 288 len floor32(mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + _162 + 256])]
        require 1 < mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 256]
        require ext_code.size(address(cd[(arg4 + 164)]))
        call address(cd[(arg4 + 164)]).0xa9059cbb with:
             gas gas_remaining wei
            args address(cd[(arg4 + 36)]), _114
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(address(cd[(arg4 + 164)]))
        call address(cd[(arg4 + 164)]).0xa9059cbb with:
             gas gas_remaining wei
            args tx.origin, mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 320] - _114
    else:
        require -cd[(arg4 + 228)] + 1000
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 260] = arg3
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 292] = (arg3 * cd[(arg4 + 228)] / -cd[(arg4 + 228)] + 1000) + _114 + 1
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 356] = this.address
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 388] = block.timestamp + (240 * 24 * 3600)
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 324] = 160
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 420] = Mask(8 * -ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + cd[(arg4 + cd[(arg4 + 260)] + 36)] + 32, 0, 0), mem[cd[(arg4 + cd[(arg4 + 260)] + 36)] + 160 len -cd[(arg4 + cd[(arg4 + 260)] + 36)] + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)])]
        ...
        mem[64] = (32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 256
        require return_data.size >= 32
        _164 = mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32
        require mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 <= 4294967296
        require mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 32 <= return_data.size
        require mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 256] <= 4294967296 and mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + (32 * mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 256]) + 32 <= return_data.size
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 256] = mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + 256 len 4], Mask(224, 32, arg3) >> 32 + 256]
        mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 288 len floor32(mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + _164 + 256])] = mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + _164 + 288 len floor32(mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + ceil32(return_data.size) + _164 + 256])]
        require 1 < mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 256]
        require ext_code.size(address(cd[(arg4 + 164)]))
        call address(cd[(arg4 + 164)]).0xa9059cbb with:
             gas gas_remaining wei
            args address(cd[(arg4 + 36)]), (arg3 * cd[(arg4 + 228)] / -cd[(arg4 + 228)] + 1000) + _114 + 1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(address(cd[(arg4 + 164)]))
        call address(cd[(arg4 + 164)]).0xa9059cbb with:
             gas gas_remaining wei
            args tx.origin, mem[(32 * _67) + ceil32(cd[(arg4 + cd[(arg4 + 260)] + 36)]) + (2 * ceil32(return_data.size)) + 320] + -(arg3 * cd[(arg4 + 228)] / -cd[(arg4 + 228)] + 1000) + -_114 - 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
