...
function burnForAllowance(address arg1, address arg2, uint256 arg3) {
    ...
    require arg3 <= balanceOf[address(arg1)]
    balanceOf[address(arg1)] -= arg3
    require (2 * arg3 / 10) + balanceOf[arg2] >= balanceOf[arg2]
    balanceOf[address(arg2)] = (2 * arg3 / 10) + balanceOf[arg2]
    emit 0xfeddf252: (arg3 - (2 * arg3 / 10)), arg1, 0
    emit 0xfeddf252: (2 * arg3 / 10), arg1, msg.sender
    return 1
}
