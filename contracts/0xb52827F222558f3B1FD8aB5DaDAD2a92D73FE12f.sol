        ...
        while idx < threshold:
            ...
            if not threshold:
                ...
                while t < _4916:
                    ...
                    continue 
                if not _4916 % 32:
                    mem[_4914 + 36] = _4916 + 96
                    mem[_4916 + _4914 + 100] = mem[ceil32(arg3.length) + _4723 + 642]
                    _9431 = mem[ceil32(arg3.length) + _4723 + 642]
                    t = 0
                    while t < _9431:
                        mem[_4916 + _4914 + t + 132] = mem[ceil32(arg3.length) + _4723 + t + 674]
                        t = t + 32
                        continue 
                    if not _9431 % 32:
                    ...
                    mem[floor32(_4916) + _4914 + 100] = mem[floor32(_4916) + _4914 + -(_4916 % 32) + 132 len _4916 % 32]
                    mem[_4914 + 36] = floor32(_4916) + 128
                ...
                while t < _4927:
                    ...
                    continue 
                if not _4927 % 32:
                    mem[_4925 + 36] = _4927 + 96
                    mem[_4927 + _4925 + 100] = mem[ceil32(arg3.length) + _4723 + 642]
                    _9428 = mem[ceil32(arg3.length) + _4723 + 642]
                    t = 0
                    while t < _9428:
                        mem[_4927 + _4925 + t + 132] = mem[ceil32(arg3.length) + _4723 + t + 674]
                        t = t + 32
                        continue 
                    if not _9428 % 32:
                        require ext_code.size(address(_4722))
                    ...
                    mem[floor32(_4927) + _4925 + 100] = mem[floor32(_4927) + _4925 + -(_4927 % 32) + 132 len _4927 % 32]
                    mem[_4925 + 36] = floor32(_4927) + 128
        ...
        while idx < threshold:
            ...
            if not threshold:
                ...
                while t < _4911:
                    ...
                    continue 
                if not _4911 % 32:
                    mem[_4909 + 36] = _4911 + 96
                    mem[_4911 + _4909 + 100] = mem[ceil32(arg3.length) + _4720 + 642]
                    _9425 = mem[ceil32(arg3.length) + _4720 + 642]
                    t = 0
                    while t < _9425:
                        mem[_4911 + _4909 + t + 132] = mem[ceil32(arg3.length) + _4720 + t + 674]
                        t = t + 32
                        continue 
                    if not _9425 % 32:
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9425 + _4911 + _4909 + -mem[64] + 128]
                    else:
                        mem[floor32(_9425) + _4911 + _4909 + 132] = mem[floor32(_9425) + _4911 + _4909 + -(_9425 % 32) + 164 len _9425 % 32]
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9425) + _4911 + _4909 + -mem[64] + 160]
                else:
                    mem[floor32(_4911) + _4909 + 100] = mem[floor32(_4911) + _4909 + -(_4911 % 32) + 132 len _4911 % 32]
                    mem[_4909 + 36] = floor32(_4911) + 128
                    mem[floor32(_4911) + _4909 + 132] = mem[ceil32(arg3.length) + _4720 + 642]
                    _9436 = mem[ceil32(arg3.length) + _4720 + 642]
                    t = 0
                    while t < _9436:
                        mem[floor32(_4911) + _4909 + t + 164] = mem[ceil32(arg3.length) + _4720 + t + 674]
                        t = t + 32
                        continue 
                    if not _9436 % 32:
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9436 + floor32(_4911) + _4909 + -mem[64] + 160]
                    else:
                        mem[floor32(_9436) + floor32(_4911) + _4909 + 164] = mem[floor32(_9436) + floor32(_4911) + _4909 + -(_9436 % 32) + 196 len _9436 % 32]
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9436) + floor32(_4911) + _4909 + -mem[64] + 192]
            else:
                require threshold
                require 65 * threshold / threshold == 65
                if mem[ceil32(arg3.length) + (65 * idx) + 674] < 65 * threshold:
                ...
                while t < _4921:
                    ...
                    continue 
                if not _4921 % 32:
                    mem[_4919 + 36] = _4921 + 96
                    mem[_4921 + _4919 + 100] = mem[ceil32(arg3.length) + _4720 + 642]
                    _9422 = mem[ceil32(arg3.length) + _4720 + 642]
                    t = 0
                    while t < _9422:
                        mem[_4921 + _4919 + t + 132] = mem[ceil32(arg3.length) + _4720 + t + 674]
                        t = t + 32
                        continue 
                    if not _9422 % 32:
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9422 + _4921 + _4919 + -mem[64] + 128]
                    else:
                        mem[floor32(_9422) + _4921 + _4919 + 132] = mem[floor32(_9422) + _4921 + _4919 + -(_9422 % 32) + 164 len _9422 % 32]
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9422) + _4921 + _4919 + -mem[64] + 160]
                else:
                    mem[floor32(_4921) + _4919 + 100] = mem[floor32(_4921) + _4919 + -(_4921 % 32) + 132 len _4921 % 32]
                    mem[_4919 + 36] = floor32(_4921) + 128
                    mem[floor32(_4921) + _4919 + 132] = mem[ceil32(arg3.length) + _4720 + 642]
                    _9434 = mem[ceil32(arg3.length) + _4720 + 642]
                    t = 0
                    while t < _9434:
                        mem[floor32(_4921) + _4919 + t + 164] = mem[ceil32(arg3.length) + _4720 + t + 674]
                        t = t + 32
                        continue 
                    if not _9434 % 32:
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9434 + floor32(_4921) + _4919 + -mem[64] + 160]
                    else:
                        mem[floor32(_9434) + floor32(_4921) + _4919 + 164] = mem[floor32(_9434) + floor32(_4921) + _4919 + -(_9434 % 32) + 196 len _9434 % 32]
                        require ext_code.size(address(_4719))
                        staticcall address(_4719).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9434) + floor32(_4921) + _4919 + -mem[64] + 192]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
