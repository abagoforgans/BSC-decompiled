...
function sub_f2c682ad(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_f2c682ad.length
    return sub_f2c682ad[arg1]
}
...
function setInsuranceFee(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    insuranceFee = arg1
...
function balanceOfShares() payable {
    require ext_code.size(sharesAddress)
    staticcall sharesAddress.0x70a08231 with:
...
function pullRewards() payable {
    ...
    require ext_code.size(address(farmingContractAddress))
    call address(farmingContractAddress).claimReward() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function sub_727595c1(?) payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(wbnbAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, address(sub_f8bc2efeAddress), 0
        ...
        if ext_code.size(wbnbAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = 0, address(sub_f8bc2efeAddress), 0
        call wbnbAddress with:
           funct uint32(stor11)
             gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    if arg1 <= ext_call.return_data[0]:
        if eth.balance(this.address) < 0:
            revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[366 len 26]
        if ext_code.size(sharesAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        ...
        if ext_code.size(sharesAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        if ext_call.return_data[0] <= arg1:
            mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1.field_0), uint32(stor1.field_0), ext_call.return_data[0 len 28]
            mem[388 len 0] = 0
            call sharesAddress with:
               funct uint32(stor1.field_0)
                 gas gas_remaining wei
            ...
            mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1.field_0), uint32(stor1.field_0), Mask(224, 32, arg1) >> 32
            mem[388 len 0] = 0
            call sharesAddress with:
               funct uint32(stor1.field_0)
                 gas gas_remaining wei
    ...
    if ext_call.return_data[0] > 0:
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0]:
                require ext_code.size(sharesAddress)
                staticcall sharesAddress.0xdd62ed3e with:
                        gas gas_remaining wei
...
function approveRouter() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(cashAddress)
    staticcall cashAddress.0xdd62ed3e with:
            gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if ext_code.size(wbnbAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, address(sub_f8bc2efeAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call wbnbAddress with:
           funct uint32(stor11)
             gas gas_remaining wei
        ...
        if return_data.size <= 0:
            ...
            if ext_code.size(wbnbAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, address(sub_f8bc2efeAddress), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            call wbnbAddress with:
               funct uint32(stor11)
                 gas gas_remaining wei
