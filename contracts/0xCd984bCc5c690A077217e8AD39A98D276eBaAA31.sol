...
function create(address arg1, address[] arg2, uint256[] arg3, uint256[] arg4, uint256 arg5, bool arg6) payable {
    ...
    while idx < arg2.length:
        ...
        call address(cd[((32 * idx) + arg2 + 36)]).transferFrom(address rg1, address rg2, uint256 rg3) with:
             gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            revert with 0, 'ERR_TRANSFER_FAILED'
        require ext_code.size(address(cd[((32 * idx) + arg2 + 36)]))
        staticcall address(cd[((32 * idx) + arg2 + 36)]).allowance(address rg1, address rg2) with:
                gas gas_remaining wei
...
function joinPool(address arg1, uint256 arg2, uint256[] arg3) payable {
    ...
    while idx < mem[ceil32(return_data.size) + 96]:
        ...
        _122 = mem[(32 * idx) + ceil32(return_data.size) + 128]
        require idx < arg3.length
        mem[(32 * _7) + ceil32(return_data.size) + 196] = cd[((32 * idx) + arg3 + 36)]
        require ext_code.size(address(_122))
        call address(_122).transferFrom(address rg1, address rg2, uint256 rg3) with:
             gas gas_remaining wei
            args msg.sender, address(this.address), cd[((32 * idx) + arg3 + 36)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not ext_call.return_data[0]:
            revert with 0, 'ERR_TRANSFER_FAILED'
        require ext_code.size(address(_122))
        staticcall address(_122).allowance(address rg1, address rg2) with:
                gas gas_remaining wei
               args this.address, arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] > 0:
            require ext_code.size(address(_122))
            call address(_122).approve(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args address(arg1), 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    ...
    while idx < mem[ceil32(return_data.size) + 96]:
        ...
        staticcall address(_173).balanceOf(address rg1) with:
                gas gas_remaining wei
        ...
        if ext_call.return_data[0] > 0:
            ...
            require ext_code.size(address(_173))
            call address(_173).transfer(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args msg.sender, ext_call.return_data[0]
            mem[(32 * _7) + ceil32(return_data.size) + 128] = ext_call.return_data[0]
            if not ext_call.success:
...
function setTokens(address arg1, address[] arg2, uint256[] arg3, uint256[] arg4) payable {
    ...
    while idx < arg2.length:
        ...
        if ext_call.return_data[0] > 0:
            ...
            require ext_code.size(address(cd[((32 * idx) + arg2 + 36)]))
            call address(cd[((32 * idx) + arg2 + 36)]).transfer(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args msg.sender, ext_call.return_data[0]
            mem[96] = ext_call.return_data[0]
            if not ext_call.success:
