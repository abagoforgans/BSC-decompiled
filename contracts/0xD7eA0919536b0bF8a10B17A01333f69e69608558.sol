...
const unisave_factory = 0x32ce36f6ea8d97f9fc19aab83b9c6d2f52d74470
...
function whiteListVault(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
...
function addWhiteListVault(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
...
function removeWhiteListVault(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if msg.sender != this.address:
        revert with 0, 'ONLY_WALLET_ERROR'
...
function getConfirmations(uint256 arg1) {
    ...
    mem[96] = owners.length
    if owners.length:
        mem[128 len 32 * owners.length] = code.data[13460 len 32 * owners.length]
    idx = 0
    s = 0
    while idx < owners.length:
        mem[0] = address(owners[idx].field_0)
    ...
    if s:
        mem[(32 * owners.length) + 160 len 32 * s] = code.data[13460 len 32 * s]
    t = 0
    while t < s:
...
function depositAll1(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if not stor3[msg.sender]:
        revert with 0, 'OWNER_EXISTS_ERROR'
    ...
    staticcall 0x32ce36f6ea8d97f9fc19aab83b9c6d2f52d74470.getPair(address rg1, address rg2) with:
            gas gas_remaining wei
    ...
    if ext_call.return_data[12 len 20] != arg1:
        revert with 0, 'only unisave pair'
    require ext_code.size(arg1)
    call arg1.depositAll1() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}

function depositAll0(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if not stor3[msg.sender]:
        revert with 0, 'OWNER_EXISTS_ERROR'
    ...
    if ext_call.return_data[12 len 20] != arg1:
        revert with 0, 'only unisave pair'
    require ext_code.size(arg1)
    call arg1.depositAll0() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}

function setFee(address arg1, uint16 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if not stor3[msg.sender]:
    ...
    if ext_call.return_data[12 len 20] != arg1:
        revert with 0, 'only unisave pair'
    require ext_code.size(arg1)
    call arg1.setFee(uint16 rg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function depositSome1(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if not stor3[msg.sender]:
    ...
    if ext_call.return_data[12 len 20] != arg1:
        revert with 0, 'only unisave pair'
    require ext_code.size(arg1)
    call arg1.depositSome1(uint256 rg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function depositSome0(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if not stor3[msg.sender]:
    ...
    if ext_call.return_data[12 len 20] != arg1:
        revert with 0, 'only unisave pair'
    require ext_code.size(arg1)
    call arg1.depositSome0(uint256 rg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setY0(address arg1, address arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if not stor3[msg.sender]:
    ...
    if not stor9[address(arg2)]:
        revert with 0, 'only whitelist vault'
    require ext_code.size(arg1)
    staticcall arg1.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
    ...
    if ext_call.return_data[12 len 20] != arg1:
        revert with 0, 'only unisave pair'
    require ext_code.size(arg1)
    call arg1.setY0(address rg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setY1(address arg1, address arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if not stor3[msg.sender]:
    ...
    if ext_call.return_data[12 len 20] != arg1:
        revert with 0, 'only unisave pair'
    require ext_code.size(arg1)
    call arg1.setY1(address rg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
