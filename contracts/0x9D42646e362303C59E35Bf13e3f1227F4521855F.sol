...
function sub_889a8cfb(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[_84] = cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)]
        mem[_84 + 32 len cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)]] = call.data[cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 68 len cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)]]
        mem[_84 + cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)] + 32] = 0
        ...
        if ceil32(cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)]) <= cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)]:
            call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)] + _89 + -mem[64] - 4]
        ...
        mem[_89 + cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)]] = 0
        call address(cd[((32 * idx) + cd[4] + 36)]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len cd[(cd[36] + cd[(cd[36] + (32 * idx) + 36)] + 36)] + _89 + -mem[64] - 4]
        if not return_data.size:
