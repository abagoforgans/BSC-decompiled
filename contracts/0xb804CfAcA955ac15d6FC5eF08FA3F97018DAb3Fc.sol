...
function sub_be67c6c1(?) {
    ...
    require ext_code.size(0xf838802ae35dfd82f75b464ddce9b5d29ad57edc)
    delegate 0xf838802ae35dfd82f75b464ddce9b5d29ad57edc.0xcd7db54c with:
...
function sub_31f17857(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(0xbb990c05386c89ec4ab3fa6392a8316230644043)
    delegate 0xbb990c05386c89ec4ab3fa6392a8316230644043.0x13d674fe with:
         gas gas_remaining wei
...
function sub_b97c41a5(?) {
    if not sub_26f05442Address:
        return 100 * 10^6
    require ext_code.size(0xf838802ae35dfd82f75b464ddce9b5d29ad57edc)
    delegate 0xf838802ae35dfd82f75b464ddce9b5d29ad57edc.0xcc23f384 with:
         gas gas_remaining wei
...
function approve(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e)
    delegate 0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0xc2bb74b248252a19a087dc00bcd31979a8fdb676)
        delegate 0xc2bb74b248252a19a087dc00bcd31979a8fdb676.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2 == arg2
    require ext_code.size(0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e)
    delegate 0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_5126dad7(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
        delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
        delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x8bfe0e42369aba35abcf9476d5617186665444a5)
        delegate 0x8bfe0e42369aba35abcf9476d5617186665444a5.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_a9f1866b(?) {
    require ext_code.size(0xf838802ae35dfd82f75b464ddce9b5d29ad57edc)
    delegate 0xf838802ae35dfd82f75b464ddce9b5d29ad57edc.0x5bb709aa with:
         gas gas_remaining wei
        args 3, 30
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_594161f8(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0xc2bb74b248252a19a087dc00bcd31979a8fdb676)
        delegate 0xc2bb74b248252a19a087dc00bcd31979a8fdb676.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
        delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e)
            delegate 0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
        delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
        delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_a05e1c7d(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < cd[(cd[4] + ('cd', 4)[5] + 4)]:
            ...
            continue 
        require ('cd', 4)[13] < 21
        require ext_code.size(0xb218cd80dc782d8b8d31072ac8a7c16ae8983b1c)
        delegate 0xb218cd80dc782d8b8d31072ac8a7c16ae8983b1c.0x3b7e41e6 with:
             gas gas_remaining wei
...
function sub_3367ad09(?) {
    ...
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0xb218cd80dc782d8b8d31072ac8a7c16ae8983b1c)
    delegate 0xb218cd80dc782d8b8d31072ac8a7c16ae8983b1c.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0xb218cd80dc782d8b8d31072ac8a7c16ae8983b1c)
    delegate 0xb218cd80dc782d8b8d31072ac8a7c16ae8983b1c.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0xc2bb74b248252a19a087dc00bcd31979a8fdb676)
        delegate 0xc2bb74b248252a19a087dc00bcd31979a8fdb676.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
        delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d32ea8b6(?) {
    ...
    mem[516] = arg1
    require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
    delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) {
    ...
    mem[132] = 14
    require ext_code.size(0xff990c691db15ffb9fa05866f071ec564fb4885d)
    delegate 0xff990c691db15ffb9fa05866f071ec564fb4885d.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    ...
    mem[388] = arg1
    require ext_code.size(0xbb990c05386c89ec4ab3fa6392a8316230644043)
    delegate 0xbb990c05386c89ec4ab3fa6392a8316230644043.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e)
    delegate 0x750d83f4ea14ec6e9b64d3996a8e92ec2121af9e.0xc5bb51da with:
         gas gas_remaining wei
