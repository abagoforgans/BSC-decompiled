...
#
address owner;
address sub_c7eac24dAddress;
address devaddr;
uint256 bonusEndBlock;
uint256 sub_b0936ac4;
...
function sub_c7eac24d(?) payable {
    return sub_c7eac24dAddress
}
        ...
        if ext_call.return_data[0]:
            if block.number <= bonusEndBlock:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    if not sub_be279845:
                        revert with 0, 'SafeMath: division by zero'
                    require ext_code.size(sub_c7eac24dAddress)
                    call sub_c7eac24dAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if not (block.number * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER):
                        ...
                        if (block.number * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) / (block.number * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER) != sub_b0936ac4:
                            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[261 len 31]
                        if not (block.number * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4):
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            if not sub_be279845:
                                revert with 0, 'SafeMath: division by zero'
                            ...
                            if (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / (block.number * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[261 len 31]
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            if not sub_be279845:
                            ...
                            call sub_c7eac24dAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / sub_be279845
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(sub_c7eac24dAddress)
                            call sub_c7eac24dAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args this.address, (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint:
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if 10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
            else:
                if poolInfo[arg1].field_512 >= bonusEndBlock:
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if (block.number * sub_b0936ac4) - (poolInfo[arg1].field_512 * sub_b0936ac4) / block.number - poolInfo[arg1].field_512 != sub_b0936ac4:
                            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[261 len 31]
                        if not (block.number * sub_b0936ac4) - (poolInfo[arg1].field_512 * sub_b0936ac4):
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            if not sub_be279845:
                                revert with 0, 'SafeMath: division by zero'
                            ...
                            if (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / (block.number * sub_b0936ac4) - (poolInfo[arg1].field_512 * sub_b0936ac4) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[261 len 31]
                            if not totalAllocPoint:
                                revert with 0, 'SafeMath: division by zero'
                            if not sub_be279845:
                            ...
                            call sub_c7eac24dAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / sub_be279845
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(sub_c7eac24dAddress)
                            call sub_c7eac24dAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args this.address, (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint:
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if 10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[389 len 31]
                                if not ext_call.return_data[0]:
                                    revert with 0, 'SafeMath: division by zero'
                                if (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                else:
                    ...
                    if not bonusEndBlock - poolInfo[arg1].field_512:
                        ...
                        if not block.number - bonusEndBlock:
                            ...
                            if (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) / block.number - bonusEndBlock != sub_b0936ac4:
                                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[325 len 31]
                            if not (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4):
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                if not sub_be279845:
                                    revert with 0, 'SafeMath: division by zero'
                                ...
                                if (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[325 len 31]
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                if not sub_be279845:
                                ...
                                call sub_c7eac24dAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devaddr, (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / sub_be279845
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(sub_c7eac24dAddress)
                                call sub_c7eac24dAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args this.address, (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    ...
                                    if 10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[453 len 31]
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                    else:
                        ...
                        if not block.number - bonusEndBlock + (bonusEndBlock * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER):
                            ...
                            if (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) / block.number - bonusEndBlock + (bonusEndBlock * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER) != sub_b0936ac4:
                                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[325 len 31]
                            if not (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4):
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                if not sub_be279845:
                                    revert with 0, 'SafeMath: division by zero'
                                ...
                                if (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) != poolInfo[arg1].field_256:
                                    revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[325 len 31]
                                if not totalAllocPoint:
                                    revert with 0, 'SafeMath: division by zero'
                                if not sub_be279845:
                                ...
                                call sub_c7eac24dAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devaddr, (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / sub_be279845
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(sub_c7eac24dAddress)
                                call sub_c7eac24dAddress.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args this.address, (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint:
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (0 / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    ...
                                    if 10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                        revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[453 len 31]
                                    if not ext_call.return_data[0]:
                                        revert with 0, 'SafeMath: division by zero'
                                    if (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768 < poolInfo[arg1].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[arg1].field_768 += 10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function sub_96b98e30(?) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if block.number <= bonusEndBlock:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            if userInfo[arg1][address(arg2)].field_256 > 0:
                revert with 0, 'SafeMath: subtraction overflow'
            return -userInfo[arg1][address(arg2)].field_256
        if (10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[389 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if poolInfo[arg1].field_512 >= bonusEndBlock:
        if poolInfo[arg1].field_512 > block.number:
            revert with 0, 'SafeMath: subtraction overflow'
        if not block.number - poolInfo[arg1].field_512:
        ...
        if not userInfo[arg1][address(arg2)].field_0:
            if userInfo[arg1][address(arg2)].field_256 > 0:
                revert with 0, 'SafeMath: subtraction overflow'
            return -userInfo[arg1][address(arg2)].field_256
        if (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[389 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if bonusEndBlock > block.number:
        revert with 0, 'SafeMath: subtraction overflow'
    if poolInfo[arg1].field_512 > bonusEndBlock:
        revert with 0, 'SafeMath: subtraction overflow'
    if not bonusEndBlock - poolInfo[arg1].field_512:
        ...
        if (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[453 len 31]
        if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
            revert with 0, 'SafeMath: subtraction overflow'
        return (((10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if (bonusEndBlock * BONUS_MULTIPLIER) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER) / bonusEndBlock - poolInfo[arg1].field_512 != BONUS_MULTIPLIER:
        revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[325 len 31]
    if block.number - bonusEndBlock < 0:
        revert with 0, 'SafeMath: addition overflow'
    ...
    if (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[arg1].field_768:
        revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[453 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((10^12 * (block.number * sub_b0936ac4 * poolInfo[arg1].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[arg1].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) + (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if block.number <= bonusEndBlock:
            ...
            if (block.number * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) / (block.number * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER) != sub_b0936ac4:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            if not (block.number * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4):
                _711 = mem[64]
                mem[64] = mem[64] + 64
                mem[_711] = 26
            ...
            if (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / (block.number * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            _720 = mem[64]
            mem[64] = mem[64] + 64
            mem[_720] = 26
            ...
            call sub_c7eac24dAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / sub_be279845
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(sub_c7eac24dAddress)
            call sub_c7eac24dAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint:
                _1012 = mem[64]
                mem[64] = mem[64] + 64
                mem[_1012] = 26
            ...
            if 10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            _1034 = mem[64]
            mem[64] = mem[64] + 64
            mem[_1034] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _1067 = mem[64]
        ...
        if poolInfo[idx].field_512 >= bonusEndBlock:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                revert with memory
                  from mem[64]
                   len _940 + -mem[64] + 100
            if (block.number * sub_b0936ac4) - (poolInfo[idx].field_512 * sub_b0936ac4) / block.number - poolInfo[idx].field_512 != sub_b0936ac4:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            if not (block.number * sub_b0936ac4) - (poolInfo[idx].field_512 * sub_b0936ac4):
                _692 = mem[64]
                mem[64] = mem[64] + 64
                mem[_692] = 26
                ...
                revert with memory
                  from mem[64]
                   len _960 + -mem[64] + 100
            if (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / (block.number * sub_b0936ac4) - (poolInfo[idx].field_512 * sub_b0936ac4) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            _693 = mem[64]
            mem[64] = mem[64] + 64
            mem[_693] = 26
            ...
            call sub_c7eac24dAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / sub_be279845
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(sub_c7eac24dAddress)
            call sub_c7eac24dAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint:
                _920 = mem[64]
                mem[64] = mem[64] + 64
                mem[_920] = 26
                ...
                revert with memory
                  from mem[64]
                   len _957 + -mem[64] + 100
            if 10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            _936 = mem[64]
            mem[64] = mem[64] + 64
            mem[_936] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _981 = mem[64]
        ...
        if not bonusEndBlock - poolInfo[idx].field_512:
            ...
            if (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) != poolInfo[idx].field_256:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            _806 = mem[64]
            mem[64] = mem[64] + 64
            mem[_806] = 26
            ...
            call sub_c7eac24dAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args devaddr, (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / sub_be279845
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
            require ext_code.size(sub_c7eac24dAddress)
            call sub_c7eac24dAddress.0x40c10f19 with:
                 gas gas_remaining wei
                args this.address, (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint:
                _1131 = mem[64]
                mem[64] = mem[64] + 64
                mem[_1131] = 26
            ...
            if 10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
                revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
            _1143 = mem[64]
            mem[64] = mem[64] + 64
            mem[_1143] = 26
            ...
            if ext_call.return_data[0]:
                if (10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                    revert with 0, 'SafeMath: addition overflow'
                poolInfo[idx].field_768 += 10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
                poolInfo[idx].field_512 = block.number
                idx = idx + 1
                continue 
            _1171 = mem[64]
        ...
        if (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) / block.number - bonusEndBlock + (bonusEndBlock * BONUS_MULTIPLIER) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER) != sub_b0936ac4:
            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
        if not (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4):
            _805 = mem[64]
            mem[64] = mem[64] + 64
            mem[_805] = 26
        ...
        if (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / (block.number * sub_b0936ac4) - (bonusEndBlock * sub_b0936ac4) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
        _821 = mem[64]
        mem[64] = mem[64] + 64
        mem[_821] = 26
        ...
        call sub_c7eac24dAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devaddr, (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / sub_be279845
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(sub_c7eac24dAddress)
        call sub_c7eac24dAddress.0x40c10f19 with:
             gas gas_remaining wei
            args this.address, (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint:
            _1138 = mem[64]
            mem[64] = mem[64] + 64
            mem[_1138] = 26
        ...
        if 10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f00, mem[mem[64] + 101 len 31]
        _1150 = mem[64]
        mem[64] = mem[64] + 64
        mem[_1150] = 26
        ...
        if ext_call.return_data[0]:
            if (10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * sub_b0936ac4 * poolInfo[idx].field_256) - (bonusEndBlock * sub_b0936ac4 * poolInfo[idx].field_256) + (bonusEndBlock * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * BONUS_MULTIPLIER * sub_b0936ac4 * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _1178 = mem[64]
        ...
        if not userInfo[arg1][msg.sender].field_0:
            ...
            if not userInfo[arg1][msg.sender].field_0:
                ...
                if -userInfo[arg1][msg.sender].field_256:
                    require ext_code.size(sub_c7eac24dAddress)
                    staticcall sub_c7eac24dAddress.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if -userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
                        call sub_c7eac24dAddress.0xa9059cbb with:
                             gas gas_remaining wei
