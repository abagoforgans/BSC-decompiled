...
const bts = 0xc2e1acef50ae55661855e8dcb72adb182a3cc259

const wbnb = 0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c

const rewards = 0xd54307a8edfa93b1794861f091c714d752400d13

const shareRewardPool = 0x61c7305c1588186e31ff9aa2f23c5354427aaf58

const REWARDS_FEE = 665

const WITHDRAWAL_MAX = 10000

const STRATEGIST_FEE = 112

const TREASURY_FEE = 112
...
array of address btsToWbnbRoute;
array of address btsToLp0Route;
array of address btsToLp1Route;

function btsToLp1Route(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < btsToLp1Route.length
    return btsToLp1Route[arg1]
}
...
function btsToWbnbRoute(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < btsToWbnbRoute.length
    return btsToWbnbRoute[arg1]
}
...
function btsToLp0Route(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < btsToLp0Route.length
    return btsToLp0Route[arg1]
}
...
function balanceOfPool() payable {
    require ext_code.size(0x61c7305c1588186e31ff9aa2f23c5354427aaf58)
    staticcall 0x61c7305c1588186e31ff9aa2f23c5354427aaf58.userInfo(uint256 rg1, address rg2) with:
            gas gas_remaining wei
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(0x61c7305c1588186e31ff9aa2f23c5354427aaf58)
        call 0x61c7305c1588186e31ff9aa2f23c5354427aaf58.deposit(uint256 rg1, uint256 rg2) with:
             gas gas_remaining wei
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(0x61c7305c1588186e31ff9aa2f23c5354427aaf58)
    call 0x61c7305c1588186e31ff9aa2f23c5354427aaf58.emergencyWithdraw(uint256 rg1) with:
         gas gas_remaining wei
        args poolId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if ext_call.return_data[0] > arg1:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(0x61c7305c1588186e31ff9aa2f23c5354427aaf58)
        call 0x61c7305c1588186e31ff9aa2f23c5354427aaf58.withdraw(uint256 rg1, uint256 rg2) with:
             gas gas_remaining wei
