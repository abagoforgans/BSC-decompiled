...
function withdraw(address arg1) payable {
    ...
    if not ext_code.hash(arg1):
        revert with 0, 'SafeERC20: call to non-contract'
    mem[196 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), ext_call.return_data[0 len 28]
    call arg1 with:
       funct uint32(stor4)
         gas gas_remaining wei
...
function withdrawAll() payable {
    ...
    if not return_data.size:
        ...
        if not ext_code.hash(0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c):
            revert with 0, 'SafeERC20: call to non-contract'
        mem[296 len 64] = transfer(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, ext_call.return_data[0 len 28]
    ...
    if not ext_code.hash(0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c):
        revert with 0, 'SafeERC20: call to non-contract'
    mem[ceil32(return_data.size) + 297 len 64] = transfer(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, ext_call.return_data[0 len 28]
...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'SafeERC20: call to non-contract'
            mem[296 len 64] = approve(address rg1, uint256 rg2), 0x73feaa1ee314f8c655e35423, 2479481422, ext_call.return_data[0 len 28]
            call wantAddress.0x93c9e24e with:
                 gas gas_remaining wei
                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[360 len 4]
            if not return_data.size:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'SafeERC20: call to non-contract'
            mem[ceil32(return_data.size) + 297 len 64] = approve(address rg1, uint256 rg2), 0x73feaa1ee314f8c655e35423, 2479481422, ext_call.return_data[0 len 28]
            mem[ceil32(return_data.size) + 389 len 4] = ext_call.return_data[20 len 4]
            call wantAddress.0x93c9e24e with:
                 gas gas_remaining wei
                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[ceil32(return_data.size) + 361 len 4]
            if not return_data.size:
                ...
                call 0x73feaa1ee314f8c655e354234017be2193c9e24e.deposit(uint256 rg1, uint256 rg2) with:
                     gas gas_remaining wei
                    args cakeChefPid, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 366 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
