...
#
const name = 'MMatrixMoon INC', 0

const decimals = 9

const symbol = 'MatrixMoon', 0
...
function getMultipliedFee() {
    ...
    if not stor30:
        ...
        if not stor43:
            revert with 'NH{q', 18
        if stor30 > -((stor42 * 0 / stor41) + (stor43 * 0 / stor41) - (block.timestamp * 0 / stor41) - (stor42 * stor30) - (stor43 * stor30) + (block.timestamp * stor30) / stor43) - 1:
            revert with 'NH{q', 17
    ...
    if not stor43:
        revert with 'NH{q', 18
    if stor30 > -((stor42 * stor30 * stor40 / stor41) + (stor43 * stor30 * stor40 / stor41) - (block.timestamp * stor30 * stor40 / stor41) - (stor42 * stor30) - (stor43 * stor30) + (block.timestamp * stor30) / stor43) - 1:
        revert with 'NH{q', 17
