...
function liquidate(address arg1, address arg2, uint256 arg3) payable {
    ...
    staticcall sub_eb4b3e88[address(arg2)].balanceOf(address rg1) with:
            gas gas_remaining wei
...
function pancakeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    if not cd[(arg4 + 100)]:
        ...
        call sub_eb4b3e88[address(cd[(arg4 + 68)])].transfer(address rg1, uint256 rg2) with:
             gas gas_remaining wei
    ...
    require ext_code.size(sub_eb4b3e88[address(cd[(arg4 + 68)])])
    staticcall sub_eb4b3e88[address(cd[(arg4 + 68)])].balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
