...
function getRewards(address arg1, uint256 arg2) payable {
    ...
    if stor9[address(arg1)][arg2].field_256 and tier[stor9[address(arg1)][arg2].field_0] > -1 / stor9[address(arg1)][arg2].field_256:
        revert with 'NH{q', 17
    if stor9[address(arg1)][arg2].field_256 * tier[stor9[address(arg1)][arg2].field_0] / 100 and block.timestamp - stor9[address(arg1)][arg2].field_512 > -1 / stor9[address(arg1)][arg2].field_256 * tier[stor9[address(arg1)][arg2].field_0] / 100:
        revert with 'NH{q', 17
    return ((block.timestamp * stor9[address(arg1)][arg2].field_256 * tier[stor9[address(arg1)][arg2].field_0] / 100) - (stor9[address(arg1)][arg2].field_512 * stor9[address(arg1)][arg2].field_256 * tier[stor9[address(arg1)][arg2].field_0] / 100) / 8760 * 24 * 3600)
}
...
function getUserDetails(address arg1, uint256 arg2) payable {
    ...
    return stor9[address(arg1)][arg2].field_0, 
           ...
           stor9[address(arg1)][arg2].field_1280,
           bool(stor9[address(arg1)][arg2].field_1536),
           (block.timestamp * stor9[address(arg1)][arg2].field_256 * tier[stor9[address(arg1)][arg2].field_0] / 100) - (stor9[address(arg1)][arg2].field_512 * stor9[address(arg1)][arg2].field_256 * tier[stor9[address(arg1)][arg2].field_0] / 100) / 8760 * 24 * 3600
}
...
function withdraw(uint256 arg1) payable {
    ...
    if not stor9[address(msg.sender)][arg1].field_1536:
        ...
        if block.timestamp < stor9[address(msg.sender)][arg1].field_512:
            revert with 0, 'Time exceeds'
        if stor9[address(msg.sender)][arg1].field_256 and tier[stor9[address(msg.sender)][arg1].field_0] > -1 / stor9[address(msg.sender)][arg1].field_256:
            revert with 'NH{q', 17
        if stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100 and block.timestamp - stor9[address(msg.sender)][arg1].field_512 > -1 / stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100:
            revert with 'NH{q', 17
        if (block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600 > -stor9[address(msg.sender)][arg1].field_256 - 1:
            revert with 'NH{q', 17
        require ext_code.size(tokenAddress)
        if not uint8(stor8.field_0):
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, ((block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600) + stor9[address(msg.sender)][arg1].field_256
        else:
            call tokenAddress.0x23b872dd with:
                 gas gas_remaining wei
                args address(stor8.field_0), msg.sender, ((block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600) + stor9[address(msg.sender)][arg1].field_256
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        ...
        totalStaked -= stor9[address(msg.sender)][arg1].field_256
        stor9[address(msg.sender)][arg1].field_256 = 0
        if stor9[address(msg.sender)][arg1].field_1024 > -((block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600) - 1:
            revert with 'NH{q', 17
        stor9[address(msg.sender)][arg1].field_1024 += (block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600
        if stor9[address(msg.sender)][arg1].field_1280 > -((block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600) + -stor9[address(msg.sender)][arg1].field_256 - 1:
            revert with 'NH{q', 17
        stor9[address(msg.sender)][arg1].field_1280 = stor9[address(msg.sender)][arg1].field_1280 + ((block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600) + stor9[address(msg.sender)][arg1].field_256
        stor9[address(msg.sender)][arg1].field_1536 = 0
        if totalRewardsDistributed > -((block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600) - 1:
            revert with 'NH{q', 17
        totalRewardsDistributed += (block.timestamp * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) - (stor9[address(msg.sender)][arg1].field_512 * stor9[address(msg.sender)][arg1].field_256 * tier[stor9[address(msg.sender)][arg1].field_0] / 100) / 8760 * 24 * 3600
    return 1
}
