...
const name = 'CRYPTOHORSE', 0

const decimals = 18

const symbol = 'CHORSE', 0
        ...
        if ext_call.return_data[18 len 14] > 0:
            if ext_call.return_data[50 len 14] > 0:
                ...
                if arg2 == stor1:
                    ...
                    staticcall stor1.0xad5c4648 with:
                            gas gas_remaining wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                ...
                if not ext_call.success:
                    ...
                    if ext_call.return_data[18 len 14] <= 0:
                        ...
                        if ext_call.return_data[50 len 14] <= 0:
                            ...
                            if msg.sender == stor1:
                                if stor7[address(arg1)] > -arg2 - 1:
                                    revert with 'NH{q', 17
                                else:
                                    stor7[address(arg1)] += arg2
                                    if arg1 == stor1:
                                        if stor8[address(msg.sender)] > -arg2 - 1:
                                            revert with 'NH{q', 17
                                        else:
                                                    ...
                                                    if not ext_call.success:
                                                        ...
                                                        if ext_call.return_data[12 len 20] != address(ext_call.return_data[0]):
                                                            ...
                                                            if not ext_call.success:
                                                                ...
                                                                require return_data.size >= 32
                                                                require ext_call.return_data[0] == ext_call.return_data[0]
                                                                if stor9[address(msg.sender)] > -ext_call.return_data[0] - 1:
                                                                    revert with 'NH{q', 17
                                                                else:
                                                                    stor9[address(msg.sender)] += ext_call.return_data[0]
                                                                    if balanceOf[address(msg.sender)] < arg2:
                                                                        revert with 0, 'ERC20: transfer amount exceeds balance'
                                                                    else:
                                                                        if balanceOf[address(msg.sender)] < arg2:
                                    ...
                                    if ext_call.return_data[12 len 20] != address(ext_call.return_data[0]):
                                        ...
                                        if not ext_call.success:
                                            ...
                                            if stor8[address(msg.sender)] > -arg2 - 1:
                                                ...
                                                if stor7[address(msg.sender)] < stor8[address(msg.sender)] + arg2:
                                                    return 1
                                                else:
                                                    if stor9[address(msg.sender)] > -ext_call.return_data[0] - 1:
                                                        revert with 'NH{q', 17
                                                    else:
                                                        if stor11 < stor9[address(msg.sender)] + ext_call.return_data[0]:
                                                            return 1
                                                        else:
                                                            if eth.balance(msg.sender) < stor12:
                                                                return 1
                                                            else:
                                                                if not msg.sender:
                                                                    revert with 0, 'ERC20: transfer from the zero address'
