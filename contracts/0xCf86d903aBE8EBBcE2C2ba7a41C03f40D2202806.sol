        ...
        if stor7[idx] <= stor5[address(arg1)]:
            if idx != stor9:
                if idx >= stor9:
                    ...
                    continue 
                if idx:
                    return (s + (stakeOf[address(arg1)] * stor7[idx + 1] - stor5[address(arg1)] / 3 * 3600 / idx) + stor4[address(arg1)])
            else:
                mem[0] = arg1
                mem[32] = 3
                if idx:
                    idx = idx - 1
                    s = s + (stakeOf[address(arg1)] * block.timestamp - stor5[address(arg1)] / 3 * 3600 / idx)
                    continue 
        else:
            if idx != stor9:
                if idx >= stor9:
                    ...
                    continue 
                if idx:
                    return (s + (stakeOf[address(arg1)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(arg1)])
            else:
                mem[0] = arg1
                mem[32] = 3
                if idx:
                    idx = idx - 1
                    s = s + (stakeOf[address(arg1)] * block.timestamp - stor7[idx] / 3 * 3600 / idx)
                    continue 
        ('iszero', ('var', 0))
        revert
        ...
        while idx >= 1:
            ...
            if stor7[idx] <= stor5[address(msg.sender)]:
                if idx == stor9:
                    ...
                    require idx
                    idx = idx - 1
                    s = s + (stakeOf[address(msg.sender)] * block.timestamp - stor5[address(msg.sender)] / 3 * 3600 / idx)
                    continue 
                if idx >= stor9:
                    idx = idx - 1
                    s = s
                    continue 
                require idx
                stor4[address(msg.sender)] = s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            else:
                if idx == stor9:
                    mem[0] = msg.sender
                    mem[32] = 3
                    require idx
                    idx = idx - 1
                    s = s + (stakeOf[address(msg.sender)] * block.timestamp - stor7[idx] / 3 * 3600 / idx)
                    continue 
                if idx >= stor9:
                    idx = idx - 1
                    s = s
                    continue 
                require idx
                stor4[address(msg.sender)] = s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)]
    ...
    while idx >= 1:
        ...
        if stor7[idx] <= stor5[address(msg.sender)]:
            ...
            if idx >= stor9:
                ...
                continue 
            require idx
            if balanceOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)] < balanceOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            stor5[address(msg.sender)] = block.timestamp
            stor4[address(msg.sender)] = 0
            totalSupply = totalSupply + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            totalReward = totalReward + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            if totalRewardOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)] < totalRewardOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            totalRewardOf[address(msg.sender)] = totalRewardOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            require stor14 - totalReward
            if stor14 / stor14 - totalReward > stor9:
                stor9 = stor14 / stor14 - totalReward
                stor7[stor9] = block.timestamp
            emit Transfer((s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor5[address(msg.sender)] / 3 * 3600 / idx) + stor4[address(msg.sender)]), this.address, msg.sender);
        else:
            if idx == stor9:
                mem[0] = msg.sender
                mem[32] = 3
            ...
            if idx >= stor9:
                ...
                continue 
            require idx
            if balanceOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)] < balanceOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            stor5[address(msg.sender)] = block.timestamp
            stor4[address(msg.sender)] = 0
            totalSupply = totalSupply + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            totalReward = totalReward + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            if totalRewardOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)] < totalRewardOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            totalRewardOf[address(msg.sender)] = totalRewardOf[address(msg.sender)] + s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)]
            require stor14 - totalReward
            if stor14 / stor14 - totalReward > stor9:
                stor9 = stor14 / stor14 - totalReward
                stor7[stor9] = block.timestamp
            emit Transfer((s + (stakeOf[address(msg.sender)] * stor7[idx + 1] - stor7[idx] / 3 * 3600 / idx) + stor4[address(msg.sender)]), this.address, msg.sender);
        return 1
