...
const TeamWallet = 0x862d47994490b90baee8dbc4da39a836d388c1d6
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x862d47994490b90baee8dbc4da39a836d388c1d6 with:
...
function TeamCreateLPandBNB() {
    ...
    if uint8(stor12.field_32) > -uint8(stor12.field_40) + 255:
        revert with 0, 17
    if balanceOf[this.address] >= stor10:
        if uint8(uint8(stor12.field_40) + uint8(stor12.field_32)):
            ...
            if not uint8(uint8(stor12.field_40) + uint8(stor12.field_32)):
                revert with 0, 18
            if stor10 < stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)):
                revert with 0, 17
            if stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) < stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2:
                revert with 0, 17
            if (stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32))) - (stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) > !(stor10 - (stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)))):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not stor13:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor13].field_0 = -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10
            emit Approval((-(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10), this.address, stor13);
            ...
            mem[ceil32(return_data.size) + 196] = -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10
            idx = 0
            ...
            call stor13.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32))) - (stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10:
                revert with 0, 18
            if totalLPBNB > !(0 / -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10):
                revert with 0, 17
            totalLPBNB += 0 / -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10
            if not this.address:
                revert with 0, 'Approve from zero'
            if not stor13:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor13].field_0 = stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2
            allowance[address(this.address)][stor13].field_255 = 0
            emit Approval((stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2), this.address, stor13);
            require ext_code.size(stor13)
            call stor13.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / -(stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32)) / 2) + stor10 wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, stor10 * uint8(stor12.field_32) / uint8(uint8(stor12.field_40) + uint8(stor12.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
