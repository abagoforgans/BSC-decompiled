...
function mint(address arg1, uint256 arg2) payable {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 'Ownable: caller is not the owner'
    if arg2 <= 0:
        revert with 0, 'AccessToken: amount is zero'
    if totalSupply > -arg2 - 1:
        revert with 'NH{q', 17
    if totalSupply + arg2 < totalSupply:
        revert with 0, 'AccessToken: Arithmetic Overflow'
...
function burn(address arg1, uint256 arg2) payable {
    ...
    if arg2 <= 0:
        revert with 0, 'AccessToken: amount is zero'
    if totalSupply < arg2:
        revert with 0, 'AccessToken: Insufficient TotalSupply'
    if balanceOf[address(arg1)] < arg2:
        revert with 0, 'AccessToken: Insufficient Balance'
    staticcall stor0.0x2f54bf6e with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
    ...
    if not ext_call.return_data[0]:
        if 0 < arg2:
            revert with 0, 'AccessToken: Insufficient Allowance'
    else:
        if balanceOf[address(arg1)] < arg2:
            revert with 0, 'AccessToken: Insufficient Allowance'
    if balanceOf[address(arg1)] < arg2:
    ...
    if totalSupply < arg2:
        revert with 'NH{q', 17
    totalSupply -= arg2
    emit Burned(arg2, msg.sender, arg1);
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if balanceOf[address(arg2)] > -arg3 - 1:
        revert with 'NH{q', 17
    if balanceOf[address(arg2)] + arg3 < arg3:
        revert with 0, 'AccessToken: Arithmetic Overflow'
    staticcall stor0.0x2f54bf6e with:
            gas gas_remaining wei
           args msg.sender
