...
function emergencyWithdraw(uint256 arg1) payable {
    ...
    if not userInfo[arg1][address(msg.sender)].field_0:
        ...
        if return_data.size <= 0:
            ...
            if not ext_code.hash(poolInfo[arg1].field_0):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 553 len 64] = 0, address(devaddr), userInfo[arg1][address(msg.sender)].field_32
            call poolInfo[arg1].field_0 with:
               funct uint32(stor2)
                 gas gas_remaining wei
        ...
        if return_data.size <= 0:
            ...
            if not ext_code.hash(poolInfo[arg1].field_0):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), Mask(224, 32, userInfo[arg1][address(msg.sender)].field_0 - (99 * userInfo[arg1][address(msg.sender)].field_0 / 100)) >> 32
            mem[ceil32(return_data.size) + 617 len 0] = 0
            call poolInfo[arg1].field_0 with:
               funct uint32(stor2)
                 gas gas_remaining wei
                args Mask(224, 32, userInfo[arg1][address(msg.sender)].field_0 - (99 * userInfo[arg1][address(msg.sender)].field_0 / 100)) << 224, mem[ceil32(return_data.size) + 617 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 'SafeMath: division by zero'
            mem[ceil32(return_data.size) + 585 len return_data.size] = ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    if not block.timestamp - userInfo[arg1][address(msg.sender)].field_256:
        ...
        if arg2 > 0:
            ...
            if arg2 > poolInfo[arg1].field_768:
                revert with 0, 'SafeMath: subtraction overflow'
        ...
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if not userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12:
                ...
                if userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12 * poolInfo[arg1].field_256 / 100 <= 0:
                    ...
                    if ext_code.hash(sub_dd25b795Address) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                        revert with 0, 'Address: call to non-contract'
                    if not ext_code.hash(sub_dd25b795Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[612 len 96] = unknown_0x23b872dd(?????), Mask(224, 0, stor3), uint32(stor3), address(devaddr), Mask(224, 32, userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12 * poolInfo[arg1].field_256 / 100 / 100) >> 32
                    mem[736 len 4] = 0
                    mem[708 len 0] = 0
                    call sub_dd25b795Address with:
                       funct uint32(stor2)
                         gas gas_remaining wei
                        args Mask(224, 32, userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12 * poolInfo[arg1].field_256 / 100 / 100) << 480, mem[708 len 4]
                    if not return_data.size:
                        require not ext_call.success
                        revert with 'SafeMath: subtraction overflow'
                    ...
                    if return_data.size <= 0:
                        ...
                        if not ext_code.hash(sub_dd25b795Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 809 len 96] = 0, address(sub_3485c2f3Address), msg.sender, Mask(224, 32, userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12 * poolInfo[arg1].field_256 / 100) >> 32
                        mem[ceil32(return_data.size) + 933 len 4] = 0
                        call sub_dd25b795Address with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12 * poolInfo[arg1].field_256 / 100, mem[ceil32(return_data.size) + 745 len 60], mem[ceil32(return_data.size) + 905 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: subtraction overflow'
                        ...
                        if arg2 > 0:
                            ...
                            if not ext_code.hash(poolInfo[arg1].field_0):
                                revert with 0, 'Address: call to non-contract'
                            mem[(2 * ceil32(return_data.size)) + 1038 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg2) >> 32
                            mem[(2 * ceil32(return_data.size)) + 1102 len 0] = 0
                            call poolInfo[arg1].field_0 with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, arg2) << 224, mem[(2 * ceil32(return_data.size)) + 1102 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: subtraction overflow'
                            ...
                            if return_data.size > 0:
                                ...
                                if not mem[(2 * ceil32(return_data.size)) + 1070]:
                                    revert with 0, 
                                                ...
                                                42,
                                                0xfe5361666542455032303a204245503230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 1149 len 22]
                            if arg2 > poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: subtraction overflow'
                            poolInfo[arg1].field_768 -= arg2
                    else:
                        ...
                        call sub_dd25b795Address with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12 * poolInfo[arg1].field_256 / 100, 32, Mask(224, 32, 'SafeBEP20: low-level call failed') >> 32, mem[ceil32(return_data.size) + 905 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: subtraction overflow'
                        mem[ceil32(return_data.size) + 841 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        if arg2 > 0:
                            ...
                            if not ext_code.hash(poolInfo[arg1].field_0):
                                revert with 0, 'Address: call to non-contract'
                            mem[(2 * ceil32(return_data.size)) + 1038 len 64] = 0, msg.sender, Mask(224, 32, arg2) >> 32
                            call poolInfo[arg1].field_0 with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args arg2, mem[(2 * ceil32(return_data.size)) + 974 len 28], mem[(2 * ceil32(return_data.size)) + 1102 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: subtraction overflow'
                            mem[(2 * ceil32(return_data.size)) + 1070 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if userInfo[arg1][address(msg.sender)].field_0 * (10^12 * block.timestamp) - (10^12 * userInfo[arg1][address(msg.sender)].field_256) / 8760 * 24 * 3600 / 10^12 * poolInfo[arg1].field_256 / 100 <= 0:
                        ...
                        if return_data.size <= 0:
                            if arg2 > 0:
                                ...
                                if not ext_code.hash(poolInfo[arg1].field_0):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 745 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, arg2) >> 32
                                mem[ceil32(return_data.size) + 869 len 4] = 0
                                call poolInfo[arg1].field_0 with:
                                     gas gas_remaining wei
                                    args arg2, mem[ceil32(return_data.size) + 681 len 60], mem[ceil32(return_data.size) + 841 len 4]
                                if not return_data.size:
                                    require not ext_call.success
                                    revert with 'SafeMath: subtraction overflow'
