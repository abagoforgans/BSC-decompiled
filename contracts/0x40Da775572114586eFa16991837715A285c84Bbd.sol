            ...
            if ext_call.return_data[0]:
                ...
                if stor4 != stor4:
                    ...
                    if ext_call.return_data[0] >= 0:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[64] = (6 * ceil32(return_data.size)) + 388
                        require return_data.size >= 32
                        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                        ...
                        call stor9.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args 0, 0, 160, address(this.address), block.timestamp, mem[(6 * ceil32(return_data.size)) + 552 len (32 * mem[(4 * ceil32(return_data.size)) + 292]) + 32]
                    else:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[64] = (7 * ceil32(return_data.size)) + 388
                        require return_data.size >= 32
                        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                        ...
                        mem[(7 * ceil32(return_data.size)) + 424] = 0
                        mem[(7 * ceil32(return_data.size)) + 456] = 160
                        mem[(7 * ceil32(return_data.size)) + 552] = 2
                        idx = 0
                        s = (6 * ceil32(return_data.size)) + 324
                        t = (7 * ceil32(return_data.size)) + 584
                        while idx < mem[(6 * ceil32(return_data.size)) + 292]:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            t = t + 32
                        ...
                        call stor9.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args 0, 0, 160, address(this.address), block.timestamp, mem[(7 * ceil32(return_data.size)) + 552 len (32 * mem[(6 * ceil32(return_data.size)) + 292]) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if 100 < sub_1f927dcb:
                        revert with 0, 17
                ...
                if ext_call.return_data[0] >= eth.balance(this.address) - ext_call.return_data[0]:
                    ...
                    if stor4 == address(arg1):
                        ...
                        while idx < mem[(4 * ceil32(return_data.size)) + 388]:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            t = t + 32
                            continue 
                        mem[(6 * ceil32(return_data.size)) + 552] = msg.sender
                        mem[(6 * ceil32(return_data.size)) + 584] = block.timestamp
                        require ext_code.size(stor10)
                        call stor10.mem[mem[64] len 4] with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len (6 * ceil32(return_data.size)) + (32 * mem[(4 * ceil32(return_data.size)) + 388]) + -mem[64] + 644]
                else:
                    ...
                    call stor9.mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len (6 * ceil32(return_data.size)) + (32 * mem[(4 * ceil32(return_data.size)) + 292]) + -mem[64] + 580]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if 100 < sub_1f927dcb:
                        revert with 0, 17
                    ...
                    if stor4 == address(arg1):
                        ...
                        if 0 >= mem[_2074]:
                            revert with 0, 50
                        mem[_2074 + 32] = ext_call.return_data[12 len 20]
                        if 1 >= mem[_2074]:
                            revert with 0, 50
                        mem[_2074 + 64] = address(arg1)
                        mem[_2074 + ceil32(return_data.size) + 96] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                        mem[_2074 + ceil32(return_data.size) + 100] = 0
                        mem[_2074 + ceil32(return_data.size) + 132] = 128
                        mem[_2074 + ceil32(return_data.size) + 228] = mem[_2074]
                        idx = 0
                        s = _2074 + 32
                        t = _2074 + ceil32(return_data.size) + 260
                        while idx < mem[_2074]:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                        ...
                        call stor10.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args 0, 128, msg.sender, block.timestamp, mem[_2074 + ceil32(return_data.size) + 228 len (32 * mem[_2074]) + 32]
            else:
                if stor4 == stor4:
                    if eth.balance(this.address) < ext_call.return_data[0]:
                        revert with 0, 17
                    ...
                    if ext_call.return_data[0] >= eth.balance(this.address) - ext_call.return_data[0]:
                        ...
                        call stor9.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + 292]) + -mem[64] + 580]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if 100 < sub_1f927dcb:
                            revert with 0, 17
                        ...
                        if stor4 == address(arg1):
                            ...
                            if 0 >= mem[_2059]:
                                revert with 0, 50
                            mem[_2059 + 32] = ext_call.return_data[12 len 20]
                            if 1 >= mem[_2059]:
                                revert with 0, 50
                            mem[_2059 + 64] = address(arg1)
                            mem[_2059 + ceil32(return_data.size) + 96] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                            mem[_2059 + ceil32(return_data.size) + 100] = 0
                            mem[_2059 + ceil32(return_data.size) + 132] = 128
                            mem[_2059 + ceil32(return_data.size) + 228] = mem[_2059]
                            idx = 0
                            s = _2059 + 32
                            t = _2059 + ceil32(return_data.size) + 260
                            while idx < mem[_2059]:
                                mem[t] = mem[s + 12 len 20]
                                idx = idx + 1
                                s = s + 32
                                t = t + 32
                                continue 
                            mem[_2059 + ceil32(return_data.size) + 164] = msg.sender
                            mem[_2059 + ceil32(return_data.size) + 196] = block.timestamp
                            require ext_code.size(stor10)
                            call stor10.mem[mem[64] len 4] with:
                               value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _2059 + ceil32(return_data.size) + (32 * mem[_2059]) + -mem[64] + 256]
                    else:
                        mem[(2 * ceil32(return_data.size)) + 296] = address(arg2)
                        mem[(2 * ceil32(return_data.size)) + 328] = stor1
                        call stor4.approve(address arg1, uint256 arg2) with:
                        ...
                        call stor9.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args eth.balance(this.address) - ext_call.return_data[0], 0, 160, address(this.address), block.timestamp, mem[(6 * ceil32(return_data.size)) + 552 len (32 * mem[(4 * ceil32(return_data.size)) + 292]) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if 100 < sub_1f927dcb:
                            revert with 0, 17
                        ...
                        if stor4 == address(arg1):
                            ...
                            while idx < mem[(6 * ceil32(return_data.size)) + 388]:
                                mem[t] = mem[s + 12 len 20]
                                idx = idx + 1
                                s = s + 32
                                t = t + 32
                            ...
                            call stor10.mem[mem[64] len 4] with:
                               value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len (7 * ceil32(return_data.size)) + (32 * mem[(6 * ceil32(return_data.size)) + 388]) + -mem[64] + 644]
                else:
                    mem[ceil32(return_data.size) + 296] = this.address
                    staticcall stor4.0x70a08231 with:
                            gas gas_remaining wei
                    ...
                    while idx < mem[(6 * ceil32(return_data.size)) + 292]:
                        ...
                        t = t + 32
                        continue 
                    mem[(7 * ceil32(return_data.size)) + 488] = this.address
                    mem[(7 * ceil32(return_data.size)) + 520] = block.timestamp
                    require ext_code.size(stor9)
                    call stor9.mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len (7 * ceil32(return_data.size)) + (32 * mem[(6 * ceil32(return_data.size)) + 292]) + -mem[64] + 580]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if 100 < sub_1f927dcb:
                        revert with 0, 17
                    ...
                    if stor4 == address(arg1):
                        ...
                        if 0 >= mem[_2056]:
                            revert with 0, 50
                        mem[_2056 + 32] = ext_call.return_data[12 len 20]
                        if 1 >= mem[_2056]:
                            revert with 0, 50
                        mem[_2056 + 64] = address(arg1)
                        mem[_2056 + ceil32(return_data.size) + 96] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                        mem[_2056 + ceil32(return_data.size) + 100] = 0
                        mem[_2056 + ceil32(return_data.size) + 132] = 128
                        mem[_2056 + ceil32(return_data.size) + 228] = mem[_2056]
                        idx = 0
                        s = _2056 + 32
                        t = _2056 + ceil32(return_data.size) + 260
                        while idx < mem[_2056]:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            t = t + 32
                            continue 
                        mem[_2056 + ceil32(return_data.size) + 164] = msg.sender
                        mem[_2056 + ceil32(return_data.size) + 196] = block.timestamp
                        require ext_code.size(stor10)
                        call stor10.mem[mem[64] len 4] with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _2056 + ceil32(return_data.size) + (32 * mem[_2056]) + -mem[64] + 256]
        else:
            ...
            if not return_data.size:
                if stor4 == stor4:
                    ...
                    if ext_call.return_data[0] >= eth.balance(this.address) - ext_call.return_data[0]:
                        ...
                        call stor9.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len (4 * ceil32(return_data.size)) + ceil32(return_data.size) + (32 * mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 293]) + -mem[64] + 581]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if 100 < sub_1f927dcb:
                            revert with 0, 17
                        ...
                        if stor4 == address(arg1):
                            ...
                            if 0 >= mem[_2083]:
                                revert with 0, 50
                            mem[_2083 + 32] = ext_call.return_data[12 len 20]
                            if 1 >= mem[_2083]:
                                revert with 0, 50
                            mem[_2083 + 64] = address(arg1)
                            mem[_2083 + ceil32(return_data.size) + 96] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                            mem[_2083 + ceil32(return_data.size) + 100] = 0
                            mem[_2083 + ceil32(return_data.size) + 132] = 128
                            mem[_2083 + ceil32(return_data.size) + 228] = mem[_2083]
                            idx = 0
                            s = _2083 + 32
                            t = _2083 + ceil32(return_data.size) + 260
                            while idx < mem[_2083]:
                                mem[t] = mem[s + 12 len 20]
                                idx = idx + 1
                                s = s + 32
                            ...
                            call stor10.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                               value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                                 gas gas_remaining wei
                                args 0, 128, msg.sender, block.timestamp, mem[_2083 + ceil32(return_data.size) + 228 len (32 * mem[_2083]) + 32]
                    else:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[64] = (6 * ceil32(return_data.size)) + ceil32(return_data.size) + 389
                        require return_data.size >= 32
                        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                        ...
                        mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 425] = 0
                        mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 457] = 160
                        ...
                        while idx < mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 293]:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            t = t + 32
                        ...
                        call stor9.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args eth.balance(this.address) - ext_call.return_data[0], 0, 160, address(this.address), block.timestamp, mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 553 len (32 * mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 293]) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if 100 < sub_1f927dcb:
                            revert with 0, 17
                        ...
                        if stor4 == address(arg1):
                            ...
                            while idx < mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 389]:
                                mem[t] = mem[s + 12 len 20]
                                idx = idx + 1
                                s = s + 32
                                t = t + 32
                            ...
                            call stor10.mem[mem[64] len 4] with:
                               value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len (7 * ceil32(return_data.size)) + ceil32(return_data.size) + (32 * mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 389]) + -mem[64] + 645]
                else:
                    mem[ceil32(return_data.size) + ceil32(return_data.size) + 297] = this.address
                    staticcall stor4.0x70a08231 with:
                            gas gas_remaining wei
                    ...
                    if ext_call.return_data[0] >= 0:
                        ...
                        call stor9.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args 0, 0, 160, address(this.address), block.timestamp, mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 553 len (32 * mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 293]) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if 100 < sub_1f927dcb:
                            revert with 0, 17
                    ...
                    while idx < mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 293]:
                        ...
                        t = t + 32
                        continue 
                    mem[(7 * ceil32(return_data.size)) + ceil32(return_data.size) + 489] = this.address
                    mem[(7 * ceil32(return_data.size)) + ceil32(return_data.size) + 521] = block.timestamp
                    require ext_code.size(stor9)
                    call stor9.mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len (7 * ceil32(return_data.size)) + ceil32(return_data.size) + (32 * mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 293]) + -mem[64] + 581]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if 100 < sub_1f927dcb:
                        revert with 0, 17
                    ...
                    if stor4 == address(arg1):
                        ...
                        if 0 >= mem[_2080]:
                            revert with 0, 50
                        mem[_2080 + 32] = ext_call.return_data[12 len 20]
                        if 1 >= mem[_2080]:
                            revert with 0, 50
                        mem[_2080 + 64] = address(arg1)
                        mem[_2080 + ceil32(return_data.size) + 96] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                        mem[_2080 + ceil32(return_data.size) + 100] = 0
                        mem[_2080 + ceil32(return_data.size) + 132] = 128
                        mem[_2080 + ceil32(return_data.size) + 228] = mem[_2080]
                        idx = 0
                        s = _2080 + 32
                        t = _2080 + ceil32(return_data.size) + 260
                        while idx < mem[_2080]:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                        ...
                        call stor10.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args 0, 128, msg.sender, block.timestamp, mem[_2080 + ceil32(return_data.size) + 228 len (32 * mem[_2080]) + 32]
            else:
                require return_data.size >= 32
                ...
                if stor4 == stor4:
                    ...
                    if ext_call.return_data[0] >= eth.balance(this.address) - ext_call.return_data[0]:
                        ...
                        if stor4 == address(arg1):
                            ...
                            while idx < mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 389]:
                                ...
                                t = t + 32
                                continue 
                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 553] = msg.sender
                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 585] = block.timestamp
                            require ext_code.size(stor10)
                            call stor10.mem[mem[64] len 4] with:
                               value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len (6 * ceil32(return_data.size)) + ceil32(return_data.size) + (32 * mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 389]) + -mem[64] + 645]
                    else:
                        mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(arg2)
                        mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = stor1
                        call stor4.approve(address arg1, uint256 arg2) with:
                        ...
                        call stor9.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len (6 * ceil32(return_data.size)) + ceil32(return_data.size) + (32 * mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 293]) + -mem[64] + 581]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if 100 < sub_1f927dcb:
                            revert with 0, 17
                        ...
                        if stor4 == address(arg1):
                            ...
                            if 0 >= mem[_2098]:
                                revert with 0, 50
                            mem[_2098 + 32] = ext_call.return_data[12 len 20]
                            if 1 >= mem[_2098]:
                                revert with 0, 50
                            mem[_2098 + 64] = address(arg1)
                            mem[_2098 + ceil32(return_data.size) + 96] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                            mem[_2098 + ceil32(return_data.size) + 100] = 0
                            mem[_2098 + ceil32(return_data.size) + 132] = 128
                            mem[_2098 + ceil32(return_data.size) + 228] = mem[_2098]
                            idx = 0
                            s = _2098 + 32
                            t = _2098 + ceil32(return_data.size) + 260
                            while idx < mem[_2098]:
                                mem[t] = mem[s + 12 len 20]
                                idx = idx + 1
                                s = s + 32
                                t = t + 32
                                continue 
                            mem[_2098 + ceil32(return_data.size) + 164] = msg.sender
                            mem[_2098 + ceil32(return_data.size) + 196] = block.timestamp
                            require ext_code.size(stor10)
                            call stor10.mem[mem[64] len 4] with:
                               value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _2098 + ceil32(return_data.size) + (32 * mem[_2098]) + -mem[64] + 256]
                else:
                    mem[ceil32(return_data.size) + ceil32(return_data.size) + 297] = this.address
                    staticcall stor4.0x70a08231 with:
                            gas gas_remaining wei
                    ...
                    if stor4 == address(arg1):
                        ...
                        if 0 >= mem[_2092]:
                            revert with 0, 50
                        mem[_2092 + 32] = ext_call.return_data[12 len 20]
                        if 1 >= mem[_2092]:
                            revert with 0, 50
                        mem[_2092 + 64] = address(arg1)
                        mem[_2092 + ceil32(return_data.size) + 96] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                        mem[_2092 + ceil32(return_data.size) + 100] = 0
                        mem[_2092 + ceil32(return_data.size) + 132] = 128
                        mem[_2092 + ceil32(return_data.size) + 228] = mem[_2092]
                        idx = 0
                        s = _2092 + 32
                        t = _2092 + ceil32(return_data.size) + 260
                        while idx < mem[_2092]:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            t = t + 32
                            continue 
                        mem[_2092 + ceil32(return_data.size) + 164] = msg.sender
                        mem[_2092 + ceil32(return_data.size) + 196] = block.timestamp
                        require ext_code.size(stor10)
                        call stor10.mem[mem[64] len 4] with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _2092 + ceil32(return_data.size) + (32 * mem[_2092]) + -mem[64] + 256]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    sub_e1598e4c = eth.balance(this.address)
}
