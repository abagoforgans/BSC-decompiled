...
function totalSupply() payable {
    ...
    staticcall sub_d56022d7Address.totalSupply(uint256 rg1) with:
...
function decimals() payable {
    require ext_code.size(sub_d56022d7Address)
    staticcall sub_d56022d7Address.decimals(uint256 rg1) with:
            gas gas_remaining wei
           args tokenId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function approve(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(sub_d56022d7Address)
    call sub_d56022d7Address.setApprovalForAll(address rg1, bool rg2) with:
         gas gas_remaining wei
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    mem[260] = 0
    require ext_code.size(sub_d56022d7Address)
    call sub_d56022d7Address.safeTransferFrom(address rg1, address rg2, uint256 rg3, uint256 rg4, bytes rg5) with:
         gas gas_remaining wei
...
function symbol() payable {
    ...
    mem[100] = tokenId
    require ext_code.size(sub_d56022d7Address)
    staticcall sub_d56022d7Address.symbol(uint256 rg1) with:
            gas gas_remaining wei
           args tokenId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
