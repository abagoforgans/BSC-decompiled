...
function sub_8839f533(?) payable {
    ...
    if block.timestamp < endPresale:
        ...
        if not ext_code.size(sub_126b88feAddress):
            revert with 0, 'Address: call to non-contract'
        mem[836 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, 0
    ...
    if startClaim <= block.timestamp:
        ...
        if not ext_code.size(sub_126b88feAddress):
            revert with 0, 'Address: call to non-contract'
        mem[836 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, userInfo[address(arg1)].field_1056
        call sub_126b88feAddress with:
             gas gas_remaining wei
            args userInfo[address(arg1)].field_1024, mem[900 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
        else:
    ...
    if userInfo[address(arg1)].field_768:
        ...
        if not ext_code.size(sub_126b88feAddress):
            revert with 0, 'Address: call to non-contract'
        mem[1028 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, Mask(224, 32, userInfo[address(arg1)].field_1024 - ((startClaim * userInfo[address(arg1)].field_768) - (block.timestamp * userInfo[address(arg1)].field_768) / startClaim - endPresale)) >> 32
        call sub_126b88feAddress with:
             gas gas_remaining wei
            args Mask(224, 32, userInfo[address(arg1)].field_1024 - ((startClaim * userInfo[address(arg1)].field_768) - (block.timestamp * userInfo[address(arg1)].field_768) / startClaim - endPresale)) << 224, mem[1092 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
        else:
    ...
    if not ext_code.size(sub_126b88feAddress):
        revert with 0, 'Address: call to non-contract'
    mem[1028 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, Mask(224, 32, userInfo[address(arg1)].field_1024 - (0 / startClaim - endPresale)) >> 32
    mem[1092 len 0] = 0
    call sub_126b88feAddress with:
         gas gas_remaining wei
        args Mask(224, 32, userInfo[address(arg1)].field_1024 - (0 / startClaim - endPresale)) << 224, mem[1092 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with 0, 'SafeERC20: low-level call failed'
    else:
            ...
            if _2391 * None >= sub_fa1ec3f9:
                ...
                if not return_data.size:
                    ...
                    if not return_data.size:
                        ...
                        if arg1 + totalAmountInvested < totalAmountInvested:
                            revert with 0, 'SafeMath: addition overflow'
    ('ge', ('add', ('param', 'arg1'), ('stor', ('name', 'totalAmountInvested', 13))), ('stor', ('name', 'totalAmountInvested', 13)))
