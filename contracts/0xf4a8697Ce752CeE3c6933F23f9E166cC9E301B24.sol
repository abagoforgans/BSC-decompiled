...
uint256 currentFee;
uint256 sub_f7c91366;
uint256 sub_0deaf49b;
uint256 totalMinted;
uint256 totalBurned;
address sub_cb9db06fAddress;
address sub_a23d9296Address;
...
function sub_a23d9296(?) payable {
    return sub_a23d9296Address
}
...
function getCurrentFee() payable {
    return currentFee
}

function sub_f7c91366(?) payable {
    return sub_f7c91366
}
...
function sub_7c282f55(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    sub_a23d9296Address = address(arg1)
    return 1
}
...
function setBurn(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if sub_f7c91366 <= 20:
        sub_f7c91366 = arg1
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if 100 < currentFee:
        revert with 'NH{q', 17
    if arg3 / 100 and -currentFee + 100 > -1 / arg3 / 100:
        revert with 'NH{q', 17
    if balances[address(arg2)] > (-100 * arg3 / 100) + (currentFee * arg3 / 100) - 1:
        revert with 'NH{q', 17
    balances[address(arg2)] = balances[address(arg2)] + (100 * arg3 / 100) - (currentFee * arg3 / 100)
    if arg3 / 100 and currentFee > -1 / arg3 / 100:
        revert with 'NH{q', 17
    if arg3 / 100 * currentFee < sub_f7c91366:
        revert with 'NH{q', 17
    if arg3 / 100 and sub_f7c91366 > -1 / arg3 / 100:
        revert with 'NH{q', 17
    if totalBurned > (-1 * arg3 / 100 * sub_f7c91366) - 1:
        revert with 'NH{q', 17
    totalBurned += arg3 / 100 * sub_f7c91366
    ...
    if balances[stor17] > (-1 * arg3 / 100 * currentFee) + sub_f7c91366 - 1:
        revert with 'NH{q', 17
    balances[stor17] = balances[stor17] + (arg3 / 100 * currentFee) - sub_f7c91366
    if sub_050b489f > (-1 * arg3 / 100 * currentFee) + sub_f7c91366 - 1:
        revert with 'NH{q', 17
    sub_050b489f = sub_050b489f + (arg3 / 100 * currentFee) - sub_f7c91366
    return 1
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if 100 < currentFee:
        revert with 'NH{q', 17
    if arg2 / 100 and -currentFee + 100 > -1 / arg2 / 100:
        revert with 'NH{q', 17
    if balances[address(arg1)] > (-100 * arg2 / 100) + (currentFee * arg2 / 100) - 1:
        revert with 'NH{q', 17
    balances[address(arg1)] = balances[address(arg1)] + (100 * arg2 / 100) - (currentFee * arg2 / 100)
    if arg2 / 100 and currentFee > -1 / arg2 / 100:
        revert with 'NH{q', 17
    if arg2 / 100 * currentFee < sub_f7c91366:
        revert with 'NH{q', 17
    if arg2 / 100 and sub_f7c91366 > -1 / arg2 / 100:
        revert with 'NH{q', 17
    if totalBurned > (-1 * arg2 / 100 * sub_f7c91366) - 1:
        revert with 'NH{q', 17
    totalBurned += arg2 / 100 * sub_f7c91366
    if arg2 / 100 and sub_f7c91366 > -1 / arg2 / 100:
        revert with 'NH{q', 17
    if balances[stor18] > (-1 * arg2 / 100 * sub_f7c91366) - 1:
        revert with 'NH{q', 17
    balances[stor18] += arg2 / 100 * sub_f7c91366
    ...
    if not balances[address(msg.sender)]:
        ...
        if not totalHolders:
            revert with 'NH{q', 17
        totalHolders--
    if msg.sender == sub_a23d9296Address:
        if totalAvailableCoins / 10^6 and 4851 > -1 / totalAvailableCoins / 10^6:
            revert with 'NH{q', 17
        if balances[stor17] >= 4851 * totalAvailableCoins / 10^6:
            if balances[stor17] < 4851 * totalAvailableCoins / 10^6:
            ...
            if sub_0deaf49b > (-4851 * totalAvailableCoins / 10^6) - 1:
                revert with 'NH{q', 17
            sub_0deaf49b += 4851 * totalAvailableCoins / 10^6
    if balances[stor17] > (-1 * arg2 / 100 * currentFee) + sub_f7c91366 - 1:
        revert with 'NH{q', 17
    balances[stor17] = balances[stor17] + (arg2 / 100 * currentFee) - sub_f7c91366
    if sub_050b489f > (-1 * arg2 / 100 * currentFee) + sub_f7c91366 - 1:
        revert with 'NH{q', 17
    sub_050b489f = sub_050b489f + (arg2 / 100 * currentFee) - sub_f7c91366
    return 1
}
