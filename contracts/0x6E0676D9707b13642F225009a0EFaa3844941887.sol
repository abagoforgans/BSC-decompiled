...
#
const name = 'GrimaceCoin', 0

const InitialSupply = 10^17

const decimals = 8

const TeamWallet = 0x31ada618eb51a20f324cb46a44e2eb9da87131ac

const symbol = 'GRIMACE', 0
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x31ada618eb51a20f324cb46a44e2eb9da87131ac with:
