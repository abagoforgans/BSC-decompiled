            ...
            if not arg1:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not sub_9a68480e.length:
                        ...
                        mem[(32 * _721) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        mem[(32 * _3483) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                ...
                if not 100 * arg1:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[(32 * _733) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                            ...
                            mem[(32 * _3480) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[(32 * _744) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                            ...
                            mem[(32 * _3477) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
            ...
            if not arg1:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not sub_9a68480e.length:
                        ...
                        mem[(32 * _727) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        mem[(32 * _3471) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                ...
                if not 100 * arg1:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[(32 * _3468) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * arg1 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[(32 * _754) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                            ...
                            mem[(32 * _3465) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
            ...
            if not balanceOf[address(msg.sender)]:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not sub_9a68480e.length:
                        ...
                        mem[64] = ceil32(return_data.size) + 640
                        require return_data.size >= 32
                        _661 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                        _722 = mem[_661 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_661 + 640])] = mem[_661 + 672 len floor32(mem[_661 + 640])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _722) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        mem[(32 * _722) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _722) + ceil32(return_data.size) + 900 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _722) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _722) + ceil32(return_data.size) + 868]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _722) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                    else:
                        mem[0] = 9
                        mem[836] = address(sub_9a68480e.field_0)
                        idx = 836
                        ...
                        mem[64] = ceil32(return_data.size) + 640
                        require return_data.size >= 32
                        _3371 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                        _3484 = mem[_3371 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_3371 + 640])] = mem[_3371 + 672 len floor32(mem[_3371 + 640])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _3484) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        mem[(32 * _3484) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _3484) + ceil32(return_data.size) + 900 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _3484) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _3484) + ceil32(return_data.size) + 868]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _3484) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
            else:
                ...
                if not 100 * balanceOf[address(msg.sender)]:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _684 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _734 = mem[_684 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_684 + 640])] = mem[_684 + 672 len floor32(mem[_684 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _734) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _734) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _734) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _734) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _734) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _734) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3363 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3481 = mem[_3363 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3363 + 640])] = mem[_3363 + 672 len floor32(mem[_3363 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3481) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _3481) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _3481) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3481) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3481) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3481) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                else:
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100:
                        ...
                        mem[640] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                        mem[644] = -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100
                        mem[676] = 0
                        mem[740] = msg.sender
                        mem[772] = block.timestamp
                        mem[708] = 160
                        ...
                        if not sub_9a68480e.length:
                            ...
                            call pancakeRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                 gas gas_remaining wei
                                args -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100, 0, 160, msg.sender, block.timestamp, sub_9a68480e.length
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[640 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _702 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _745 = mem[_702 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_702 + 640])] = mem[_702 + 672 len floor32(mem[_702 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _745) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _745) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _745) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _745) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _745) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _745) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            call pancakeRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                 gas gas_remaining wei
                                args -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100, 0, 160, msg.sender, block.timestamp, sub_9a68480e.length, mem[836 len 32 * sub_9a68480e.length]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[640 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3355 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3478 = mem[_3355 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3355 + 640])] = mem[_3355 + 672 len floor32(mem[_3355 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3478) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _3478) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _3478) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3478) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3478) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3478) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
    else:
            ...
            if not balanceOf[address(msg.sender)]:
                ...
                if not -0 / userInfo[msg.sender].field_256 / 100:
                    ...
                    if not sub_9a68480e.length:
                        ...
                        mem[64] = ceil32(return_data.size) + 640
                        require return_data.size >= 32
                        _677 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                        _728 = mem[_677 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_677 + 640])] = mem[_677 + 672 len floor32(mem[_677 + 640])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _728) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        mem[(32 * _728) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _728) + ceil32(return_data.size) + 900 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _728) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _728) + ceil32(return_data.size) + 868]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _728) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                    else:
                        mem[0] = 9
                        mem[836] = address(sub_9a68480e.field_0)
                        idx = 836
                        ...
                        mem[64] = ceil32(return_data.size) + 640
                        require return_data.size >= 32
                        _3339 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                        require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                        require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                        _3472 = mem[_3339 + 640]
                        mem[ceil32(return_data.size) + 672 len floor32(mem[_3339 + 640])] = mem[_3339 + 672 len floor32(mem[_3339 + 640])]
                        require ext_code.size(tokenAddress)
                        staticcall tokenAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        ...
                        if not ext_code.size(tokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(32 * _3472) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                        mem[(32 * _3472) + ceil32(return_data.size) + 900 len 0] = 0
                        call tokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _3472) + ceil32(return_data.size) + 900 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(32 * _3472) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            if not mem[(32 * _3472) + ceil32(return_data.size) + 868]:
                                revert with 0, 
                                            32,
                                            42,
                                            0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(32 * _3472) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
            else:
                if 100 * balanceOf[address(msg.sender)] / balanceOf[address(msg.sender)] != 100:
                    revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[485 len 31]
                if not 100 * balanceOf[address(msg.sender)]:
                    ...
                    if not -0 / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _691 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _740 = mem[_691 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_691 + 640])] = mem[_691 + 672 len floor32(mem[_691 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _740) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _740) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _740) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _740) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _740) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _740) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3331 = mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -0 / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3469 = mem[_3331 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3331 + 640])] = mem[_3331 + 672 len floor32(mem[_3331 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3469) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _3469) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _3469) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3469) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3469) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3469) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                else:
                    if 100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / 100 * balanceOf[address(msg.sender)] != userInfo[msg.sender].field_0:
                        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[485 len 31]
                    mem[384] = 26
                    ...
                    if not -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100:
                        ...
                        if not sub_9a68480e.length:
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _714 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _755 = mem[_714 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_714 + 640])] = mem[_714 + 672 len floor32(mem[_714 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _755) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _755) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _755) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _755) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _755) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _755) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
                        else:
                            mem[0] = 9
                            mem[836] = address(sub_9a68480e.field_0)
                            idx = 836
                            ...
                            mem[64] = ceil32(return_data.size) + 640
                            require return_data.size >= 32
                            _3323 = mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 <= 4294967296
                            require mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 32 <= return_data.size
                            require mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640] <= 4294967296 and mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + (32 * mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]) + 32 <= return_data.size
                            mem[ceil32(return_data.size) + 640] = mem[mem[640 len 4], Mask(224, 32, -100 * userInfo[msg.sender].field_0 * balanceOf[address(msg.sender)] / userInfo[msg.sender].field_256 / 100) >> 32 + 640]
                            _3466 = mem[_3323 + 640]
                            mem[ceil32(return_data.size) + 672 len floor32(mem[_3323 + 640])] = mem[_3323 + 672 len floor32(mem[_3323 + 640])]
                            require ext_code.size(tokenAddress)
                            staticcall tokenAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            if not ext_code.size(tokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[(32 * _3466) + ceil32(return_data.size) + 836 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
                            mem[(32 * _3466) + ceil32(return_data.size) + 900 len 0] = 0
                            call tokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * _3466) + ceil32(return_data.size) + 900 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[(32 * _3466) + ceil32(return_data.size) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[(32 * _3466) + ceil32(return_data.size) + 868]:
                                    revert with 0, 
                                                32,
                                                42,
                                                0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                mem[(32 * _3466) + ceil32(return_data.size) + ceil32(return_data.size) + 947 len 22]
