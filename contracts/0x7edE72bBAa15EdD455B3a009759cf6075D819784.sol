...
function sub_144ff370(?) {
    ...
    while idx < ('cd', 36).length:
        if cd[68] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
            revert with 0, 17
        mem[mem[64] + 4] = 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e
        mem[mem[64] + 36] = 10^18 * cd[68]
        require ext_code.size(address(cd[4]))
        call address(cd[4]).approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e, 10^18 * cd[68]
        ...
        mem[mem[64] + 68] = 10^18 * cd[68]
        require ext_code.size(address(cd[4]))
        call address(cd[4]).0x23b872dd with:
             gas gas_remaining wei
            args 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e, address(_40), 10^18 * cd[68]
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _43 = mem[64]
...
function doAirdrop(address arg1, address[] arg2, uint256[] arg3) {
    ...
    while idx < arg2.length:
        if idx >= mem[ceil32(32 * arg2.length) + 97]:
            revert with 0, 50
        _64 = mem[(32 * idx) + ceil32(32 * arg2.length) + 129]
        if mem[(32 * idx) + ceil32(32 * arg2.length) + 129] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
            revert with 0, 17
        mem[mem[64] + 4] = 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e
        mem[mem[64] + 36] = 10^18 * _64
        require ext_code.size(arg1)
        call arg1.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e, 10^18 * _64
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _68 = mem[64]
        ...
        if idx >= mem[ceil32(32 * arg2.length) + 97]:
            revert with 0, 50
        _73 = mem[(32 * idx) + ceil32(32 * arg2.length) + 129]
        if mem[(32 * idx) + ceil32(32 * arg2.length) + 129] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
            revert with 0, 17
        mem[mem[64] + 4] = 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e
        mem[mem[64] + 36] = address(_71)
        mem[mem[64] + 68] = 10^18 * _73
        require ext_code.size(arg1)
        call arg1.0x23b872dd with:
             gas gas_remaining wei
            args 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e, address(_71), 10^18 * _73
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _76 = mem[64]
                ...
                if stor19[address(msg.sender)]:
                    ...
                    if owner == msg.sender:
                        ...
                        if owner == arg1:
                            ...
                            call this.address.0xa9059cbb with:
                                 gas gas_remaining wei
                                args 57005, balanceOf[this.address] * sub_c4a522c8 / totalFees
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    if unknown_0x871c128d(?????) <= uint32(call.func_hash) >> 224:
        ...
        if unknown_0x23b872dd(?????) > uint32(call.func_hash) >> 224:
            ...
            while idx < ('cd', 36).length:
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_13918] == bool(mem[_13918])
                if idx >= mem[128]:
                    revert with 0, 50
                _13929 = mem[(32 * idx) + 160]
                if cd[68] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
                    revert with 0, 17
                mem[mem[64] + 4] = 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e
                mem[mem[64] + 36] = address(_13929)
                mem[mem[64] + 68] = 10^18 * cd[68]
                require ext_code.size(address(cd[4]))
                call address(cd[4]).0x23b872dd with:
                     gas gas_remaining wei
                    args 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e, address(_13929), 10^18 * cd[68]
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _13933 = mem[64]
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_13933] == bool(mem[_13933])
                if idx > -2:
                    revert with 0, 17
                idx = idx + 1
                continue 
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x23b872dd(?????):
                ...
                while idx < ('cd', 36).length:
                    if idx >= mem[ceil32(32 * ('cd', 36).length) + 129]:
                        revert with 0, 50
                    _13946 = mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161]
                    if mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
                        revert with 0, 17
                    mem[mem[64] + 4] = 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e
                    mem[mem[64] + 36] = 10^18 * _13946
                    require ext_code.size(address(cd[4]))
                    call address(cd[4]).approve(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e, 10^18 * _13946
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _13950 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_13950] == bool(mem[_13950])
                    if idx >= mem[128]:
                        revert with 0, 50
                    _13953 = mem[(32 * idx) + 160]
                    if idx >= mem[ceil32(32 * ('cd', 36).length) + 129]:
                        revert with 0, 50
                    _13955 = mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161]
                    if mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
                        revert with 0, 17
                    mem[mem[64] + 4] = 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e
                    mem[mem[64] + 36] = address(_13953)
                    mem[mem[64] + 68] = 10^18 * _13955
                    require ext_code.size(address(cd[4]))
                    call address(cd[4]).0x23b872dd with:
                         gas gas_remaining wei
                        args 0xc5b9b80e87570bb1e2051cca559a557a3ce5061e, address(_13953), 10^18 * _13955
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _13958 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_13958] == bool(mem[_13958])
                    if idx > -2:
                        revert with 0, 17
                    idx = idx + 1
                    continue 
