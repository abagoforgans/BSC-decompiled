...
function updateStatus(bool arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require msg.sender == stor7
    status = uint8(arg1)
...
function sub_8f839153(?) payable {
    ...
    if arg1 < sub_4ba9d382:
        revert with 0, 'Enough gems'
    ...
    if balanceOf[address(arg2)] > -2:
        revert with 'NH{q', 17
    balanceOf[address(arg2)]++
    ownerOf[stor8] = address(arg2)
    emit Transfer(0, address(arg2), stor8);
    ...
    if stor6[stor8].field_0:
        if stor6[stor8].field_0 == stor6[stor8].field_1 < 32:
            revert with 'NH{q', 34
        if arg3.length:
            stor6[stor8][].field_0 = Array(len=arg3.length, data=arg3[all])
        else:
        ...
        if arg3.length:
            ...
            while stor6[stor8].field_1 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
    emit Minted(address(arg2), stor8);
    return stor8
}
