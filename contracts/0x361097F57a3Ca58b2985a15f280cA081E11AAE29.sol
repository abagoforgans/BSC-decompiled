        ...
        if return_data.size <= 0:
            ...
            if not msg.sender:
                if lastSnapshotIndexOf[address(msg.sender)].field_256 > 0:
                    ...
                    if ext_code.size(stor6) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = 0, msg.sender, lastSnapshotIndexOf[address(msg.sender)].field_288
                    call stor6 with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args lastSnapshotIndexOf[address(msg.sender)].field_256, mem[ceil32(return_data.size) + 489 len 28], mem[ceil32(return_data.size) + 617 len 4]
                    if not return_data.size:
                        require not ext_call.success
                        revert with 'SafeMath: subtraction overflow'
                ...
                if not balanceOf[address(msg.sender)].field_0:
                    ...
                    if lastSnapshotIndexOf[address(msg.sender)].field_256 > 0:
                        ...
                        if ext_code.size(stor6) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 1321 len 64] = 0, msg.sender, lastSnapshotIndexOf[address(msg.sender)].field_288
                        call stor6 with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args lastSnapshotIndexOf[address(msg.sender)].field_256, mem[ceil32(return_data.size) + 1257 len 28], mem[ceil32(return_data.size) + 1385 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: subtraction overflow'
                        ...
                        if not ext_call.success:
                            ...
                            revert with 0, 
                                        ...
                                        mem[(2 * ceil32(return_data.size)) + 1422 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if return_data.size > 0:
                            require return_data.size >= 32
                        ...
                        if return_data.size > 0:
                            ...
                            if not mem[ceil32(return_data.size) + 1353]:
                                revert with 0, 
                                            ...
                                            42,
                                            0x745361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                            mem[(2 * ceil32(return_data.size)) + 1432 len 22]
                        emit RewardPaid(lastSnapshotIndexOf[address(msg.sender)].field_256, msg.sender);
        else:
            require return_data.size >= 32
            if not mem[420]:
            ...
            if not return_data.size:
                ...
                if not msg.sender:
                    if lastSnapshotIndexOf[address(msg.sender)].field_256 > 0:
                        ...
                        if ext_code.size(stor6) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[1320 len 64] = 0, msg.sender, lastSnapshotIndexOf[address(msg.sender)].field_288
                        call stor6 with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args lastSnapshotIndexOf[address(msg.sender)].field_256, mem[1256 len 28], mem[1384 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                        else:
                    ...
                    if lastSnapshotIndexOf[address(msg.sender)].field_256 > 0:
                        ...
                        if ext_code.size(stor6) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[2088 len 64] = 0, msg.sender, lastSnapshotIndexOf[address(msg.sender)].field_288
                        call stor6 with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args lastSnapshotIndexOf[address(msg.sender)].field_256, mem[2024 len 28], mem[2152 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                        else:
                ...
                if return_data.size <= 0:
                    ...
                    if not msg.sender:
                        ...
                        if lastSnapshotIndexOf[address(msg.sender)].field_256 > 0:
                            ...
                            if ext_code.size(stor6) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 2089 len 64] = 0, msg.sender, lastSnapshotIndexOf[address(msg.sender)].field_288
                            call stor6 with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args lastSnapshotIndexOf[address(msg.sender)].field_256, mem[ceil32(return_data.size) + 2025 len 28], mem[ceil32(return_data.size) + 2153 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                            else:
                                ...
                                if not ext_call.success:
                                    ...
                                    revert with 0, 
                                                'SafeERC20: low-level call failed',
                                                mem[(2 * ceil32(return_data.size)) + 2190 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                                if return_data.size > 0:
                                    require return_data.size >= 32
                                ...
                                if return_data.size > 0:
                                    ...
                                    if not mem[ceil32(return_data.size) + 2121]:
                                        revert with 0, 
                                                    ...
                                                    42,
                                                    0x745361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                                    mem[(2 * ceil32(return_data.size)) + 2200 len 22]
                            emit RewardPaid(lastSnapshotIndexOf[address(msg.sender)].field_256, msg.sender);
        else:
            require balanceOf[address(msg.sender)].field_0
            if (rewardPerShare[rewardPerShare.length].field_0 * balanceOf[address(msg.sender)].field_0) - (rewardPerShare[stor7[address(msg.sender)].field_0].field_512 * balanceOf[address(msg.sender)].field_0) / balanceOf[address(msg.sender)].field_0 != rewardPerShare[rewardPerShare.length].field_0 - rewardPerShare[stor7[address(msg.sender)].field_0].field_512:
