...
function mint(address arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        mem[64] = ceil32(s) + 128
        if s:
            mem[128 len s] = code.data[9637 len s]
        t = s - 1
        idx = arg2
        while idx:
            require t < mem[96]
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if 1 > tokenOfOwnerByIndex[address(arg1)].field_0:
        revert with 0, 'SafeMath: subtraction overflow'
    if tokenOfOwnerByIndex[address(arg1)].field_0 - 1 != stor6[arg3]:
...
function burn(uint256 arg1) payable {
    ...
    if 1 > tokenOfOwnerByIndex[stor1[arg1]].field_0:
        revert with 0, 'SafeMath: subtraction overflow'
    if tokenOfOwnerByIndex[stor1[arg1]].field_0 - 1 != stor6[arg1]:
    ...
    if tokenByIndex.length > tokenByIndex.length - 1:
        ...
        while tokenByIndex.length > idx:
            ...
            continue 
    stor8[arg1] = 0
    if Mask(255, 1, stor12[arg1].field_0 and (256 * not stor12[arg1].field_0) - 1):
...
function safeMint(address arg1, uint256 arg2) payable {
    ...
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(arg1):
        if not arg2:
            ...
            mem[64] = ceil32(s) + 160
            if s:
                mem[160 len s] = code.data[9637 len s]
            t = s - 1
            idx = arg2
            while idx:
                require t < mem[128]
        ...
        if not ext_code.hash(arg1):
            ...
            if not arg2:
                ...
                while idx:
                    ...
                    continue 
                if s:
                    mem[ceil32(return_data.size) + 357 len s] = code.data[9637 len s]
                t = s - 1
                idx = arg2
                while idx:
                    require t < s
                    mem[ceil32(return_data.size) + t + 357 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
                    t = t - 1
                    idx = idx / 10
                    continue 
                if not ownerOf[arg2]:
...
function safeMint(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(arg1):
        if not arg2:
            ...
            if s:
                mem[ceil32(arg3.length) + 160 len s] = code.data[9637 len s]
            t = s - 1
            idx = arg2
            while idx:
        ...
        if not ext_code.hash(arg1):
            ...
            if not arg3.length % 32:
                ...
                _170 = Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)]
                ...
                call arg1.mem[arg3.length + ceil32(arg3.length) + 324 len 4] with:
                     gas gas_remaining wei
                    args mem[arg3.length + ceil32(arg3.length) + 328 len _170 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg3.length:
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[arg3.length + ceil32(arg3.length) + 356 len s] = code.data[9637 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[arg3.length + ceil32(arg3.length) + ceil32(return_data.size) + 357 len s] = code.data[9637 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                ...
                mem[ceil32(arg3.length) + 164 len 28] = Mask(224, 32, msg.sender) >> 32
                mem[ceil32(arg3.length) + 160 len 4] = onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4)
                _175 = Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)]
                ...
                call arg1.mem[floor32(arg3.length) + ceil32(arg3.length) + 356 len 4] with:
                     gas gas_remaining wei
                    args mem[floor32(arg3.length) + ceil32(arg3.length) + 360 len _175 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg3.length:
                            revert with arg3[all]
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[floor32(arg3.length) + ceil32(arg3.length) + 388 len s] = code.data[9637 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[floor32(arg3.length) + ceil32(arg3.length) + ceil32(return_data.size) + 389 len s] = code.data[9637 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
