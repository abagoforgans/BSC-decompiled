...
#  - CreateLPandBNB(uint16 arg1, bool arg2)
#  - transfer(address arg1, uint256 arg2)
#  - _fallback()
#
const name = 'HomelessGrimace', 0

const sub_2ba4b81c(?) = 2

const decimals = 18

const _totalSupply = 1000000 * 10^18

const symbol = 'HomGrimace', 0
...
function blacklistEnabled() {
    return bool(uint8(stor14.field_160))
}
...
function liquidityAdded() {
    return bool(uint8(stor14.field_168))
}
...
function getTotalShares() {
    if stor24 < 1000000 * 10^18:
        revert with 0, 17
    return (stor24 - 1000000 * 10^18)
}

function getBurntTokens() {
    if 1000000 * 10^18 < _circulatingSupply:
        revert with 0, 17
    return (-_circulatingSupply + 1000000 * 10^18)
}
...
function sub_2aea52ab(?) {
    ...
    if owner != msg.sender:
        if marketingWalletAddress != msg.sender:
            if stor13 != msg.sender:
                revert with 0, 'Caller not authorized'
    Mask(96, 0, stor14.field_160) = Mask(96, 0, bool(arg1))
