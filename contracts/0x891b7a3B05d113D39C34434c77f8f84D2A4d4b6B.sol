...
address sub_63eb6ff8Address;
uint256 sub_e6d61723;
bool stor34;
...
function sub_63eb6ff8(?) {
    return sub_63eb6ff8Address
}

function sub_64c0a2f8(?) {
    return bool(sub_64c0a2f8)
}
...
function setBuyBackEnabled(bool arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_64c0a2f8 = uint8(arg1)
    emit 0x569d448e: arg1
}
...
function prepareForPresale() {
    ...
    sub_e6d61723 = totalSupply
    sub_207a3c47 = totalSupply
...
function sub_bffda982(?) {
    ...
    if 10^15 * arg1:
        ...
        while idx < 2:
            ...
            t = t + 32
            continue 
        mem[ceil32(return_data.size) + 260] = burnAddress
        mem[ceil32(return_data.size) + 292] = block.timestamp + 300
        require ext_code.size(swapRouterAddress)
        call swapRouterAddress.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
           value 10^15 * arg1 wei
             gas gas_remaining wei
            args 0, 128, burnAddress, block.timestamp + 300, 2, mem[ceil32(return_data.size) + 356 len 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
