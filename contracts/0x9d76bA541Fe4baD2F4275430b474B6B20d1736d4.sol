...
function sub_76105e52(?) payable {
    ...
    while idx < _73:
        ...
        if 0 == idx:
            ...
            call address(_77).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args cd[68], 0, 160, address(this.address), block.timestamp + (24 * 3600), mem[mem[64] + 164 len (32 * _98) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _120 = mem[64]
        ...
        call address(_77).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args _84, 0, 160, address(this.address), block.timestamp + (24 * 3600), mem[mem[64] + 164 len (32 * _101) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _119 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    while idx < _121:
        ...
        if 0 == idx:
            ...
            call address(_126).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args cd[(arg5 + cd[(arg5 + 100)] + 100)], 0, 160, address(this.address), block.timestamp + (24 * 3600), mem[mem[64] + 164 len (32 * _148) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _170 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        call address(_126).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args _134, 0, 160, address(this.address), block.timestamp + (24 * 3600), mem[mem[64] + 164 len (32 * _151) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _169 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
