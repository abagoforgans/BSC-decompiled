    ...
    if balanceOf[this.address] < sub_bec90112:
        if arg1:
            ...
            if 0 / uint256(stor31.field_0) + uint256(stor26.field_0):
                ...
                require return_data.size >= 32
                if mem[_721] < ext_call.return_data[0]:
                    revert with 0, 17
                if totalDividends > !(mem[_721] - ext_call.return_data[0]):
                    revert with 0, 17
                totalDividends = totalDividends + mem[_721] - ext_call.return_data[0]
                if dividendsPerShareAccuracyFactor and mem[_721] - ext_call.return_data[0] > -1 / dividendsPerShareAccuracyFactor:
                    revert with 0, 17
                if not totalShares:
                    revert with 0, 18
                if dividendsPerShare > !((mem[_721] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares):
                    revert with 0, 17
                dividendsPerShare += (mem[_721] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares
                if 0 / uint256(stor31.field_0) + uint256(stor26.field_0):
                    call stor32 with:
                       value 0 / uint256(stor31.field_0) + uint256(stor26.field_0) wei
                         gas 30000 wei
        ...
        if not arg1:
            ...
            if 0 / uint256(stor31.field_0) + uint256(stor26.field_0):
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                if mem[_722] < ext_call.return_data[0]:
                    revert with 0, 17
                if totalDividends > !(mem[_722] - ext_call.return_data[0]):
                    revert with 0, 17
                totalDividends = totalDividends + mem[_722] - ext_call.return_data[0]
                if dividendsPerShareAccuracyFactor and mem[_722] - ext_call.return_data[0] > -1 / dividendsPerShareAccuracyFactor:
                    revert with 0, 17
                if not totalShares:
                    revert with 0, 18
                if dividendsPerShare > !((mem[_722] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares):
                    revert with 0, 17
                dividendsPerShare += (mem[_722] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares
                if 0 / uint256(stor31.field_0) + uint256(stor26.field_0):
                    call stor32 with:
                       value 0 / uint256(stor31.field_0) + uint256(stor26.field_0) wei
                         gas 30000 wei
