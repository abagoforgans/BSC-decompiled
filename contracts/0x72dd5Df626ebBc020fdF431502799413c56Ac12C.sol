...
function withdrawETH(uint256 arg1) {
    ...
    if not 2 * ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] >= 0 / totalSupply:
            require ext_code.size(tokenAddress)
            call tokenAddress.0x2e1a7d4d with:
                 gas gas_remaining wei
                args (0 / totalSupply)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] >= (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalSupply:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            call msg.sender with:
               value (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalSupply wei
                 gas 2300 * is_zero(value) wei
        else:
            if ext_call.return_data[0] > (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalSupply:
                revert with 0, 'SafeMath: subtraction overflow'
    ...
    if not 2 * ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] >= (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            call msg.sender with:
               value (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply wei
                 gas 2300 * is_zero(value) wei
        else:
            if ext_call.return_data[0] > (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply:
                revert with 0, 'SafeMath: subtraction overflow'
...
function depositETH() payable {
    ...
    if not totalSupply:
        ...
        if not ext_call.return_data[0]:
            ...
            if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), 0
            call tokenAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
                args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[388 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 0, 'SafeERC20: low-level call failed'
            ...
            if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, min * ext_call.return_data[0] / 10000) >> 32
            call tokenAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            ...
            if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), 0
            call tokenAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
                args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[452 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 0, 'SafeERC20: low-level call failed'
            ...
            if ext_code.hash(tokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, min * ext_call.return_data[0] / 10000) >> 32
            call tokenAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
                args Mask(224, 32, min * ext_call.return_data[0] / 10000) << 224, mem[452 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 0, 'SafeERC20: low-level call failed'
            mem[420 len return_data.size] = ext_call.return_data[0 len return_data.size]
