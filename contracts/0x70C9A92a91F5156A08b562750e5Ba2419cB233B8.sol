...
function sub_31f17857(?) payable {
    ...
    require ext_code.size(0xd8a84b9395b527f4c4d901c4ce6e5caf0b3758be)
    delegate 0xd8a84b9395b527f4c4d901c4ce6e5caf0b3758be.0x13d674fe with:
...
function sub_7f2f97b1(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0xae76b88fce395ab24878765d23c29922fd21a7c3)
        delegate 0xae76b88fce395ab24878765d23c29922fd21a7c3.0xfb960466 with:
             gas gas_remaining wei
...
function sub_5126dad7(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
        delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
        delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) payable {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xeb52c6d5f56af6a61bb2c46394ef7cd98078143b)
        delegate 0xeb52c6d5f56af6a61bb2c46394ef7cd98078143b.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_f090df5d(?) payable {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0xeb52c6d5f56af6a61bb2c46394ef7cd98078143b)
        delegate 0xeb52c6d5f56af6a61bb2c46394ef7cd98078143b.0xc2d5b6ab with:
             gas gas_remaining wei
...
function sub_528f6b54(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x1a1551174447cea038da4687ba24307e004f828c)
        delegate 0x1a1551174447cea038da4687ba24307e004f828c.0xa7b9a567 with:
             gas gas_remaining wei
...
function sub_594161f8(?) payable {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0xae76b88fce395ab24878765d23c29922fd21a7c3)
        delegate 0xae76b88fce395ab24878765d23c29922fd21a7c3.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
        delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x1aaef342c5cf15f0adef6ab676b8bad3e280841f)
            delegate 0x1aaef342c5cf15f0adef6ab676b8bad3e280841f.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
        delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) payable {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
        delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_c8d49a06(?) payable {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x1a1551174447cea038da4687ba24307e004f828c)
        delegate 0x1a1551174447cea038da4687ba24307e004f828c.0x0 with:
             gas gas_remaining wei
...
function sub_d32ea8b6(?) payable {
    ...
    mem[516] = arg1
    require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
    delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_3367ad09(?) payable {
    ...
    require ('cd', 4)[13] < 21
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0xfa82007a5ae80353a2fbad0890702f823405a78f)
    delegate 0xfa82007a5ae80353a2fbad0890702f823405a78f.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) payable {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0xfa82007a5ae80353a2fbad0890702f823405a78f)
    delegate 0xfa82007a5ae80353a2fbad0890702f823405a78f.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) payable {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0xae76b88fce395ab24878765d23c29922fd21a7c3)
        delegate 0xae76b88fce395ab24878765d23c29922fd21a7c3.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) payable {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
        delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_4dc26ae8(?) payable {
    ...
    mem[132] = 19
    require ext_code.size(0x1a1551174447cea038da4687ba24307e004f828c)
    delegate 0x1a1551174447cea038da4687ba24307e004f828c.0x45d85d80 with:
         gas gas_remaining wei
        args 19
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) payable {
    ...
    mem[132] = 14
    require ext_code.size(0xc2e33ef2b636ea01415f4fec03040d10b85b34fd)
    delegate 0xc2e33ef2b636ea01415f4fec03040d10b85b34fd.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_a05e1c7d(?) payable {
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[4] <= 0:
            ...
            require ext_code.size(0xfa82007a5ae80353a2fbad0890702f823405a78f)
            delegate 0xfa82007a5ae80353a2fbad0890702f823405a78f.mem[mem[64] len 4] with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0xfa82007a5ae80353a2fbad0890702f823405a78f)
            delegate 0xfa82007a5ae80353a2fbad0890702f823405a78f.mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 640 len 4] with:
                 gas gas_remaining wei
...
function sub_a89a8884(?) payable {
    ...
    require ext_code.size(0xd8a84b9395b527f4c4d901c4ce6e5caf0b3758be)
    delegate 0xd8a84b9395b527f4c4d901c4ce6e5caf0b3758be.0x2d130914 with:
         gas gas_remaining wei
