...
function sub_3a2ee252(?) payable {
    ...
    if not return_data.size:
        ...
        if not arg1:
            ...
            if arg1 * sub_d296345e / arg1 != sub_d296345e:
                revert with 0, 
                            ...
                            uint32(arg1),
                            mem[356 len 4]
            mem[392 len 64] = 0, address(arg2), Mask(224, 32, arg1 * sub_d296345e / 10000) >> 32
            call sub_1ff51c86Address with:
                 gas gas_remaining wei
                args arg1 * sub_d296345e / 10000, Mask(224, 32, address(arg2), Mask(224, 32, arg1 * sub_d296345e / 10000) >> 32) >> 32, mem[456 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'TransferHelper: TRANSFER_FAILED'
            if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not arg1:
            ...
            mem[ceil32(return_data.size) + 393 len 64] = 0, address(arg2), Mask(224, 32, arg1 * sub_d296345e / 10000) >> 32
            call sub_1ff51c86Address with:
                 gas gas_remaining wei
                args arg1 * sub_d296345e / 10000, Mask(224, 32, address(arg2), Mask(224, 32, arg1 * sub_d296345e / 10000) >> 32) >> 32, mem[ceil32(return_data.size) + 457 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'TransferHelper: TRANSFER_FAILED'
            if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
