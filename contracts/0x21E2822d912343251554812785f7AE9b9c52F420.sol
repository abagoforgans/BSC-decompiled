...
function pick_winner() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if ext_code.size(tokenAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(32 * players.length) + ceil32(return_data.size) + 649 len 64] = unknown_0xa9059cbb(?????), 0, 0, ext_call.return_data[0 len 28]
        mem[(32 * players.length) + ceil32(return_data.size) + 741 len 4] = 0
        call tokenAddress.0xdead with:
             gas gas_remaining wei
            args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[(32 * players.length) + ceil32(return_data.size) + 713 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 'SafeMath: division by zero'
        mem[(32 * players.length) + ceil32(return_data.size) + 681 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            if return_data.size > 0:
                revert with ext_call.return_data[0 len return_data.size]
            revert with 0, 'SafeERC20: low-level call failed'
        if return_data.size > 0:
            require return_data.size >= 32
            if not mem[(32 * players.length) + ceil32(return_data.size) + 681]:
                revert with 0, 
                            32,
                            42,
                            0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                            mem[(32 * players.length) + (2 * ceil32(return_data.size)) + 760 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 22]
        emit LotteryWinner(address rg1, uint256 rg2):
                           0,
                           mem[(32 * players.length) + (2 * ceil32(return_data.size)) + 682 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))],
                           players[sha3(block.difficulty, block.timestamp, mem[320 len 32 * players.length]) % players.length].field_0,
        ...
        if ext_code.size(tokenAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[(32 * players.length) + ceil32(return_data.size) + 649 len 64] = unknown_0xa9059cbb(?????), 0, 0, Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 100)) >> 32
        mem[(32 * players.length) + ceil32(return_data.size) + 713 len 0] = 0
        call tokenAddress.0xdead with:
             gas gas_remaining wei
            args Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 100)) << 224, mem[(32 * players.length) + ceil32(return_data.size) + 713 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 'SafeMath: division by zero'
        mem[(32 * players.length) + ceil32(return_data.size) + 681 len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if return_data.size > 0:
            ...
            if not mem[(32 * players.length) + ceil32(return_data.size) + 681]:
                revert with 0, 
                            ...
                            42,
                            0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                            mem[(32 * players.length) + (2 * ceil32(return_data.size)) + 760 len 22]
