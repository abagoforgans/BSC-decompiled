        ...
        if unknown_0x64d62353(?????) > uint32(call.func_hash) >> 224:
            ...
            if unknown_0xb1c5f427(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x64d62353(?????) == uint32(call.func_hash) >> 224:
                    ...
                    _555 = sha3(Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64]), (32 * ('cd', 4).length) + 192, (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224, cd[100], cd[132])
                    if timestamp[Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64])][(32 * ('cd', 4).length) + 192][(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224][cd[100]][cd[132]] > 0:
                        revert with 0, 'TimelockController: operation already scheduled'
                    if cd[164] < minDelay:
                        revert with 0, 'TimelockController: insufficient delay'
                    if block.timestamp > !cd[164]:
                        revert with 0, 17
                    timestamp[Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64])][(32 * ('cd', 4).length) + 192][(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224][cd[100]][cd[132]] = block.timestamp + cd[164]
                    idx = 0
                    while idx < ('cd', 4).length:
                ...
                if unknown_0xb1c5f427(?????) == uint32(call.func_hash) >> 224:
                    ...
                    while idx < ('cd', 68).length:
                        ...
                        u = u + 32
                        continue 
                    return sha3(Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64]), (32 * ('cd', 4).length) + 192, (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224, cd[100], cd[132])
                ...
                if roleAdmin[0xd8aa0f3194971a2a116679f7c2090f6939c8d4e01a2a8d7e41d55e5351469e63][0].field_0:
                    ...
                    mem[64] = (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 416
                    _567 = sha3(Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64]), (32 * ('cd', 4).length) + 192, (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224, cd[100], cd[132])
                    mem[0] = sha3(Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64]), (32 * ('cd', 4).length) + 192, (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224, cd[100], cd[132])
                    if timestamp[Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64])][(32 * ('cd', 4).length) + 192][(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224][cd[100]][cd[132]] <= 1:
                        revert with 0, 'TimelockController: operation is not ready'
                    if timestamp[Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64])][(32 * ('cd', 4).length) + 192][(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224][cd[100]][cd[132]] > block.timestamp:
                        revert with 0, 'TimelockController: operation is not ready'
                    if not cd[100]:
                        idx = 0
                        while idx < ('cd', 4).length:
                    ...
                    mem[128] = (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 256
                    mem[64] = (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 416
                    _570 = sha3(Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64]), (32 * ('cd', 4).length) + 192, (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224, cd[100], cd[132])
                    mem[0] = sha3(Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64]), (32 * ('cd', 4).length) + 192, (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224, cd[100], cd[132])
                    if timestamp[Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64])][(32 * ('cd', 4).length) + 192][(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224][cd[100]][cd[132]] <= 1:
                        revert with 0, 'TimelockController: operation is not ready'
                    if timestamp[Array(len=('cd', 4).length, data=mem[352 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (32 * ('cd', 68).length) + (32 * ('cd', 68).length) + 64])][(32 * ('cd', 4).length) + 192][(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 224][cd[100]][cd[132]] > block.timestamp:
