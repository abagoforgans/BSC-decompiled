...
const name = 'WinterGames'

const decimals = 9

const symbol = 'WinterGames'
...
function sub_69ec98b2(?) {
    ...
    if stor4[msg.sender]:
        if stor4[msg.sender]:
            if 10 > stor4[address(arg1)]:
                revert with 0, 'SafeMath: subtraction overflow'
            if stor4[address(arg1)] - 10:
                if stor4[address(arg1)] + stor4[msg.sender] - 10 < stor4[msg.sender]:
                    revert with 0, 'SafeMath: addition overflow'
                stor4[msg.sender] = stor4[address(arg1)] + stor4[msg.sender] - 10
...
function sub_4efd98ba(?) payable {
    ...
    if ext_call.return_data[0] > ext_call.return_data[0]:
        revert with 0, 'SafeMath: subtraction overflow'
    if stor4[msg.sender] < stor4[msg.sender]:
        revert with 0, 'SafeMath: addition overflow'
}
