...
function sub_5bdcdd54(?) payable {
    ...
    if stor4 == stor4:
        ...
        if stor4 == address(arg1):
            ...
            call stor8.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                 gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                if stor4 != stor4:
                    ...
                    if ext_call.return_data[0] >= 0:
                        ...
                        call stor7.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                ...
                if ext_call.return_data[0] >= eth.balance(this.address) - ext_call.return_data[0]:
                    ...
                    if stor4 == address(arg1):
                        ...
                        call stor8.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args 0, 128, msg.sender, block.timestamp, mem[_2059 + ceil32(return_data.size) + 228 len (32 * mem[_2059]) + 32]
                else:
                    ...
                    if stor4 == address(arg1):
                        ...
                        call stor8.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args 0, 128, msg.sender, block.timestamp, mem[(7 * ceil32(return_data.size)) + 616 len (32 * mem[(6 * ceil32(return_data.size)) + 388]) + 32]
            else:
                ...
                if ext_call.return_data[0] >= eth.balance(this.address) - ext_call.return_data[0]:
                    ...
                    if stor4 == address(arg1):
                        ...
                        call stor8.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args 0, 128, msg.sender, block.timestamp, mem[(6 * ceil32(return_data.size)) + 616 len (32 * mem[(4 * ceil32(return_data.size)) + 388]) + 32]
                else:
                    mem[(2 * ceil32(return_data.size)) + 296] = address(arg2)
                    mem[(2 * ceil32(return_data.size)) + 328] = stor1
                    call stor4.approve(address arg1, uint256 arg2) with:
                ...
                if ext_call.return_data[0] >= eth.balance(this.address) - ext_call.return_data[0]:
                    ...
                    if stor4 == address(arg1):
                        ...
                        call stor8.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value (100 * eth.balance(this.address)) - (sub_1f927dcb * eth.balance(this.address)) - (100 * sub_e1598e4c) + (sub_1f927dcb * sub_e1598e4c) / 100 wei
                             gas gas_remaining wei
                            args 0, 128, msg.sender, block.timestamp, mem[(7 * ceil32(return_data.size)) + ceil32(return_data.size) + 617 len (32 * mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 389]) + 32]
            else:
                if stor4 == stor4:
                    if eth.balance(this.address) < ext_call.return_data[0]:
                        revert with 0, 17
