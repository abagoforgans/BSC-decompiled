...
function sub_f62911ba(?) payable {
    ...
    mem[(32 * _40) + ceil32(return_data.size) + 324] = this.address
    mem[(32 * _40) + ceil32(return_data.size) + 356] = block.timestamp + 10
    ...
    call arg1.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args 10^10, 1, 160, address(this.address), block.timestamp + 10, 2, mem[(32 * _40) + ceil32(return_data.size) + 420 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(arg2)
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(32 * _40) + ceil32(return_data.size) + 256] = ext_call.return_data[0]
    mem[(32 * _40) + ceil32(return_data.size) + 224] = 64
    mem[(32 * _40) + ceil32(return_data.size) + 288] = mem[ceil32(return_data.size) + 192]
    mem[(32 * _40) + ceil32(return_data.size) + 320 len floor32(mem[ceil32(return_data.size) + 192])] = mem[ceil32(return_data.size) + 224 len floor32(mem[ceil32(return_data.size) + 192])]
    emit 0x12767ca5: 64, ext_call.return_data[0], mem[(32 * _40) + ceil32(return_data.size) + 288 len (32 * mem[ceil32(return_data.size) + 192]) + 32]
    return 0
}
