...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] > ext_call.return_data[0]:
        revert with 0, 'SafeMath: subtraction overflow'
    if not ext_code.size(friesAddress):
        revert with 0, 'Address: call to non-contract'
    mem[548 len 64] = unknown_0xa9059cbb(?????), msg.sender, 0
    call friesAddress with:
...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if not totalSupply:
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[520 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8.field_0), uint32(stor8.field_0), ext_call.return_data[0 len 28]
            mem[584 len 0] = 0
            call tokenAddress with:
               funct uint32(stor8.field_0)
                 gas gas_remaining wei
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[584 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8.field_0), uint32(stor8.field_0), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor8.field_0)
                 gas gas_remaining wei
        ...
        if not totalSupply:
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 521 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8.field_0), uint32(stor8.field_0), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor8.field_0)
                 gas gas_remaining wei
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 585 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8.field_0), uint32(stor8.field_0), ext_call.return_data[0 len 28]
