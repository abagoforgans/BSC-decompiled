...
function sub_9c6d21c6(?) {
    return sub_9c6d21c6Address
}
...
function transferBNB(uint256 arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function withdraw() {
    ...
    require ext_code.size(sub_9c6d21c6Address)
    staticcall sub_9c6d21c6Address.0x70a08231 with:
