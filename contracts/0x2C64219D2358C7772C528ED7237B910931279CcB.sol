...
function sub_d30b57c2(?) payable {
    return sub_d30b57c2Address
}
...
function sub_d118dd43(?) payable {
    ...
    staticcall _factoryAddress.0x57d911a3 with:
    ...
    require ext_code.size(sub_d30b57c2Address)
    call sub_d30b57c2Address.0xdd9a140e with:
         gas gas_remaining wei
