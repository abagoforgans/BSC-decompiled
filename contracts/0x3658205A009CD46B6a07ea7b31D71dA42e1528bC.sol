...
uint256 _fundFee;
uint256 sub_52412346;
uint256 _taxFee;
uint256 _destroyFee;
address sub_8230af5aAddress;
address sub_eff4c3b3Address;
address sub_49976395Address;
address sub_014453a7Address;
...
function sub_014453a7(?) {
    return sub_014453a7Address
}
...
function sub_49976395(?) {
    return sub_49976395Address
}
...
function sub_eff4c3b3(?) {
    return sub_eff4c3b3Address
}
...
function sub_2fc1b8ae(?) {
    call sub_8230af5aAddress with:
...
function sub_17e2003a(?) {
    ...
    call uniswapV2RouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args _maxTxAmount, 0, 160, address(this.address), block.timestamp, 2, mem[388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
