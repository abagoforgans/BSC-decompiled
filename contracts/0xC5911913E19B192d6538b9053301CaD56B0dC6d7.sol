...
const BUSD = 0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5
...
function sub_2b457b10(?) {
    ...
    require ext_code.size(0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5)
    call 0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5.0x23b872dd with:
         gas gas_remaining wei
...
function swapTokensForCake(uint256 arg1) {
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    mem[160] = ext_call.return_data[12 len 20]
    mem[192] = 0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5
    if not this.address:
        revert with 0, 'ERC20: approve from the zero address'
    if not uniswapV2RouterAddress:
        revert with 0, 'ERC20: approve to the zero address'
...
function sub_ef9f445c(?) {
    ...
    require ext_code.size(0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5)
    staticcall 0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[ceil32(return_data.size) + 192] = 0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5
    if not this.address:
    ...
    if ext_call.return_data[0] > _46:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if _46 < ext_call.return_data[0]:
        revert with 0, 17
    mem[mem[64] + 4] = address(arg2)
    mem[mem[64] + 36] = _46 - ext_call.return_data[0]
    require ext_code.size(0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5)
    call 0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5.0xa9059cbb with:
         gas gas_remaining wei
        args address(arg2), _46 - ext_call.return_data[0]
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _55 = mem[64]
    ...
    if mem[_55]:
        emit 0x5ca4f37e: arg1, _46 - ext_call.return_data[0]
}
...
function swapAndSendDividends(uint256 arg1) {
    ...
    if ext_call.return_data[0] > _48:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if _48 < ext_call.return_data[0]:
        revert with 0, 17
    mem[mem[64] + 4] = dividendTrackerAddress
    mem[mem[64] + 36] = _48 - ext_call.return_data[0]
    require ext_code.size(0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5)
    call 0xd500e3cf845cc41aba54bb1dd426bd3485bd8cd5.0xa9059cbb with:
         gas gas_remaining wei
        args dividendTrackerAddress, _48 - ext_call.return_data[0]
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _57 = mem[64]
    ...
    if mem[_57]:
        ...
        call dividendTrackerAddress.distributeCAKEDividends(uint256 arg1) with:
             gas gas_remaining wei
            args (_48 - ext_call.return_data[0])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        emit SendDividends(arg1, _48 - ext_call.return_data[0]);
}
