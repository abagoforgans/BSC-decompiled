...
function sub_f62911ba(?) payable {
    ...
    mem[(32 * _39) + ceil32(return_data.size) + 260] = 1
    mem[(32 * _39) + ceil32(return_data.size) + 324] = this.address
    mem[(32 * _39) + ceil32(return_data.size) + 356] = block.timestamp + 10
    mem[(32 * _39) + ceil32(return_data.size) + 292] = 160
    mem[(32 * _39) + ceil32(return_data.size) + 388] = 2
    mem[(32 * _39) + ceil32(return_data.size) + 420 len 0] = None
    require ext_code.size(arg1)
    call arg1.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args 10^10, 1, 160, address(this.address), block.timestamp + 10, 2, mem[(32 * _39) + ceil32(return_data.size) + 420 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _39) + ceil32(return_data.size) + 228] = this.address
    require ext_code.size(arg2)
    staticcall arg2.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    mem[(32 * _39) + ceil32(return_data.size) + 224] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
