...
function sub_59937d4b(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        _35 = mem[(32 * cd[(cd[4] + cd[(cd[4] + (32 * idx + 1) + 36)] + 36)] - 1) + _32 + 32]
...
function sub_bffebd89(?) {
    ...
    staticcall address(cd[(cd[4] + ('cd', 4)[1] + 68)]).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
...
function sub_cfeb21cb(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        staticcall address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]).0x70a08231 with:
                gas gas_remaining wei
               args address(this.address)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        while s < cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 36)]:
            ...
            require cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + (32 * s + 1) + 68)] + 68)] - 1 < cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + (32 * s + 1) + 68)] + 68)]
            _91 = mem[(32 * cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + (32 * s + 1) + 68)] + 68)] - 1) + _88 + 32]
            mem[mem[64] + 4] = this.address
            require ext_code.size(address(_91))
            staticcall address(_91).0x70a08231 with:
                    gas gas_remaining wei
                   args address(this.address)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
            ...
            staticcall address(_122).0x70a08231 with:
                    gas gas_remaining wei
                   args address(this.address)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
...
function demaxCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) {
    ...
    staticcall address(_134).0x70a08231 with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    while idx < _256:
        ...
        staticcall address(_273).0x70a08231 with:
                gas gas_remaining wei
               args address(this.address)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
...
function sub_9fd06780(?) {
    ...
    if ext_call.return_data[12 len 20] == address(cd[(cd[4] + ('cd', 4)[1] + 68)]):
        ...
        if ext_call.return_data[12 len 20] == address(cd[(cd[4] + ('cd', 4)[1] + 68)]):
            ...
            staticcall address(cd[(cd[4] + ('cd', 4)[3] + 68)]).0x70a08231 with:
                    gas gas_remaining wei
                   args this.address
...
function sub_e644cc41(?) {
    ...
    require 1 < cd[(cd[4] + ('cd', 4)[1] + 36)]
    require cd[(cd[4] + ('cd', 4)[1] + 100)] == address(cd[(cd[4] + ('cd', 4)[1] + 100)])
    mem[ceil32(return_data.size) + 100] = address(cd[(cd[4] + ('cd', 4)[1] + 68)])
    mem[ceil32(return_data.size) + 132] = address(cd[(cd[4] + ('cd', 4)[1] + 100)])
    require ext_code.size(address(cd[68]))
    staticcall address(cd[68]).getPair(address rg1, address rg2) with:
            gas gas_remaining wei
           args address(cd[(cd[4] + ('cd', 4)[1] + 68)]), address(cd[(cd[4] + ('cd', 4)[1] + 100)])
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    mem[(7 * ceil32(return_data.size)) + 100] = cd[36]
    if ext_call.return_data[12 len 20] == address(cd[(cd[4] + ('cd', 4)[1] + 68)]):
        ...
        if ext_call.return_data[12 len 20] == address(cd[(cd[4] + ('cd', 4)[1] + 68)]):
            ...
            require return_data.size >= 32
            require ext_call.return_data[0] == ext_call.return_data[0]
            mem[(11 * ceil32(return_data.size)) + 128] = cd[36]
            mem[(11 * ceil32(return_data.size)) + 160] = ext_call.return_data[0]
            mem[(11 * ceil32(return_data.size)) + 192] = address(cd[68])
            mem[(11 * ceil32(return_data.size)) + 224] = 128
            mem[(11 * ceil32(return_data.size)) + 256] = ('cd', 4).length
            if address(cd[(cd[4] + ('cd', 4)[1] + 68)]) != ext_call.return_data[12 len 20]:
                idx = 0
                s = cd[4] + 36
                t = (11 * ceil32(return_data.size)) + (32 * ('cd', 4).length) + 288
                u = (11 * ceil32(return_data.size)) + 288
                while idx < ('cd', 4).length:
                    mem[u] = t + (-11 * ceil32(return_data.size)) - 288
                    require cd[s] < calldata.size + -cd[4] - 67
                    require cd[(cd[s] + cd[4] + 36)] <= test266151307()
                    require cd[4] + 36 <= calldata.size - (32 * cd[(cd[s] + cd[4] + 36)])
                    mem[t] = cd[(cd[s] + cd[4] + 36)]
                ...
                _263 = mem[_247]
                mem[t + 132] = mem[_247]
                mem[t + 164 len ceil32(_263)] = mem[_247 + 32 len ceil32(_263)]
                if ceil32(_263) > _263:
                    mem[t + _263 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], 0, address(this.address), 128, mem[t + 132 len ceil32(_263) + 32]
            else:
                idx = 0
                s = cd[4] + 36
                t = (11 * ceil32(return_data.size)) + (32 * ('cd', 4).length) + 288
                ...
                _264 = mem[_249]
                mem[t + 132] = mem[_249]
                mem[t + 164 len ceil32(_264)] = mem[_249 + 32 len ceil32(_264)]
                if ceil32(_264) > _264:
                    mem[t + _264 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args 0, ext_call.return_data[0], address(this.address), 128, mem[t + 132 len ceil32(_264) + 32]
        else:
            ...
            if address(cd[(cd[4] + ('cd', 4)[1] + 68)]) != ext_call.return_data[12 len 20]:
                ...
                _265 = mem[_251]
                mem[t + 132] = mem[_251]
                mem[t + 164 len ceil32(_265)] = mem[_251 + 32 len ceil32(_265)]
                if ceil32(_265) > _265:
                    mem[t + _265 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], 0, address(this.address), 128, mem[t + 132 len ceil32(_265) + 32]
            else:
                idx = 0
                s = cd[4] + 36
                t = (11 * ceil32(return_data.size)) + (32 * ('cd', 4).length) + 288
                ...
                _266 = mem[_253]
                mem[t + 132] = mem[_253]
                mem[t + 164 len ceil32(_266)] = mem[_253 + 32 len ceil32(_266)]
                if ceil32(_266) > _266:
                    mem[t + _266 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args 0, ext_call.return_data[0], address(this.address), 128, mem[t + 132 len ceil32(_266) + 32]
    else:
        ...
        if ext_call.return_data[12 len 20] == address(cd[(cd[4] + ('cd', 4)[1] + 68)]):
            ...
            if address(cd[(cd[4] + ('cd', 4)[1] + 68)]) != ext_call.return_data[12 len 20]:
                ...
                _267 = mem[_255]
                mem[t + 132] = mem[_255]
                mem[t + 164 len ceil32(_267)] = mem[_255 + 32 len ceil32(_267)]
                if ceil32(_267) > _267:
                    mem[t + _267 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], 0, address(this.address), 128, mem[t + 132 len ceil32(_267) + 32]
            else:
                idx = 0
                s = cd[4] + 36
                t = (11 * ceil32(return_data.size)) + (32 * ('cd', 4).length) + 288
                ...
                _268 = mem[_257]
                mem[t + 132] = mem[_257]
                mem[t + 164 len ceil32(_268)] = mem[_257 + 32 len ceil32(_268)]
                if ceil32(_268) > _268:
                    mem[t + _268 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args 0, ext_call.return_data[0], address(this.address), 128, mem[t + 132 len ceil32(_268) + 32]
        else:
            mem[(7 * ceil32(return_data.size)) + 164] = Mask(112, 0, ext_call.return_data[0])
            require ext_code.size(address(cd[(cd[4] + ('cd', 4)[0] + 68)]))
            staticcall address(cd[(cd[4] + ('cd', 4)[0] + 68)]).getAmountOut(uint256 rg1, uint256 rg2, uint256 rg3) with:
            ...
            if address(cd[(cd[4] + ('cd', 4)[1] + 68)]) != ext_call.return_data[12 len 20]:
                ...
                _269 = mem[_259]
                mem[t + 132] = mem[_259]
                mem[t + 164 len ceil32(_269)] = mem[_259 + 32 len ceil32(_269)]
                if ceil32(_269) > _269:
                    mem[t + _269 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], 0, address(this.address), 128, mem[t + 132 len ceil32(_269) + 32]
            else:
                idx = 0
                s = cd[4] + 36
                t = (11 * ceil32(return_data.size)) + (32 * ('cd', 4).length) + 288
                ...
                _270 = mem[_261]
                mem[t + 132] = mem[_261]
                mem[t + 164 len ceil32(_270)] = mem[_261 + 32 len ceil32(_270)]
                if ceil32(_270) > _270:
                    mem[t + _270 + 164] = 0
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                     gas gas_remaining wei
                    args 0, ext_call.return_data[0], address(this.address), 128, mem[t + 132 len ceil32(_270) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require 1 < ('cd', 4).length
    require ('cd', 4)[1] < calldata.size + -cd[4] - 67
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_201 + 12 len 20] == address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]):
            ...
            if mem[_207 + 12 len 20] == address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]):
                ...
                staticcall address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 164)] + 100)]).0x70a08231 with:
                        gas gas_remaining wei
                       args address(this.address)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
...
function sub_6141d7d9(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        staticcall mem[_259 + 12 len 20].getReserves() with:
                gas gas_remaining wei
        mem[mem[64] len 96] = ext_call.return_data[0 len 96]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)] == address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)])
        require ext_code.size(address(_260))
        staticcall address(_260).token0() with:
                gas gas_remaining wei
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if mem[_269 + 12 len 20] == address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]):
            _275 = mem[64]
            mem[64] = mem[64] + ceil32(return_data.size)
            require return_data.size >= 32
            require mem[_275] == mem[_275 + 12 len 20]
            mem[mem[64] + 4] = cd[((32 * idx) + cd[36] + 36)]
            mem[mem[64] + 36] = Mask(112, 0, _264)
            if mem[_275 + 12 len 20] == address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]):
                mem[mem[64] + 68] = Mask(112, 0, _265)
                require ext_code.size(address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]))
                staticcall address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]).getAmountOut(uint256 rg1, uint256 rg2, uint256 rg3) with:
                        gas gas_remaining wei
                       args cd[((32 * idx) + cd[36] + 36)], _264 << 144, Mask(112, 0, _265)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _287 = mem[64]
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]) != mem[_303 + 12 len 20]:
                    _327 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    _335 = mem[_327]
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args _291, 0, address(this.address), 128, mem[u + 132 len ceil32(_383) + 32]
                else:
                    _328 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args 0, _291, address(this.address), 128, mem[u + 132 len ceil32(_384) + 32]
            else:
                mem[mem[64] + 68] = Mask(112, 0, _264)
                require ext_code.size(address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]))
                staticcall address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]).getAmountOut(uint256 rg1, uint256 rg2, uint256 rg3) with:
                        gas gas_remaining wei
                       args cd[((32 * idx) + cd[36] + 36)], _264 << 144, Mask(112, 0, _264)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _288 = mem[64]
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]) != mem[_304 + 12 len 20]:
                    _329 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    _337 = mem[_329]
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args _292, 0, address(this.address), 128, mem[u + 132 len ceil32(_385) + 32]
                else:
                    _330 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args 0, _292, address(this.address), 128, mem[u + 132 len ceil32(_386) + 32]
        else:
            _276 = mem[64]
            mem[64] = mem[64] + ceil32(return_data.size)
            require return_data.size >= 32
            ...
            mem[mem[64] + 4] = cd[((32 * idx) + cd[36] + 36)]
            mem[mem[64] + 36] = Mask(112, 0, _265)
            if mem[_276 + 12 len 20] == address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]):
                mem[mem[64] + 68] = Mask(112, 0, _265)
                require ext_code.size(address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]))
                staticcall address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]).getAmountOut(uint256 rg1, uint256 rg2, uint256 rg3) with:
                        gas gas_remaining wei
                       args cd[((32 * idx) + cd[36] + 36)], _265 << 144, Mask(112, 0, _265)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _289 = mem[64]
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]) != mem[_305 + 12 len 20]:
                    _331 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    _339 = mem[_331]
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args _293, 0, address(this.address), 128, mem[u + 132 len ceil32(_387) + 32]
                else:
                    _332 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args 0, _293, address(this.address), 128, mem[u + 132 len ceil32(_388) + 32]
            else:
                mem[mem[64] + 68] = Mask(112, 0, _264)
                require ext_code.size(address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]))
                staticcall address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 68)] + 100)]).getAmountOut(uint256 rg1, uint256 rg2, uint256 rg3) with:
                        gas gas_remaining wei
                       args cd[((32 * idx) + cd[36] + 36)], _265 << 144, Mask(112, 0, _264)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _290 = mem[64]
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] + 100)]) != mem[_306 + 12 len 20]:
                    _333 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    _341 = mem[_333]
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args _294, 0, address(this.address), 128, mem[u + 132 len ceil32(_389) + 32]
                else:
                    _334 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    ...
                    call address(_260).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                         gas gas_remaining wei
                        args 0, _294, address(this.address), 128, mem[u + 132 len ceil32(_390) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require 1 < cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 36)]
        require cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)] < calldata.size + -cd[4] + -cd[(cd[4] + (32 * idx) + 36)] - 99
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        if ext_call.return_data[0] <= _254:
            revert with 0, 'qL'
        idx = idx + 1
        continue 
}
