...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not balanceOf[stor19]:
        revert with 0, 18
    if 2 * balanceOf[stor19] / balanceOf[stor19] != 2:
        revert with 0, 'SafeMath: multiplication overflow'
    if not arg1:
        if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
            revert with 0, 'SafeMath: division by zero', 0
    ...
    if not arg1:
        revert with 0, 18
    if arg1 * 2 * balanceOf[stor19] / arg1 != 2 * balanceOf[stor19]:
        revert with 0, 'SafeMath: multiplication overflow'
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero', 0
    return (arg1 * 2 * balanceOf[stor19] / totalSupply - balanceOf[stor3] - balanceOf[stor4])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not arg2:
        revert with 0, 18
    if arg2 * 2 * balanceOf[stor19] / arg2 != 2 * balanceOf[stor19]:
        revert with 0, 'SafeMath: multiplication overflow'
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero', 0
    return (arg2 * 2 * balanceOf[stor19] / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
}
