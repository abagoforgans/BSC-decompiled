...
function sub_b7fbb49c(?) {
    ...
    call address(bonusTokenAddress).transfer(address rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function initialize(address arg1) {
    ...
    uint256(stor2CC6) = 0x98945bc69a554f8b129b09ac8afdc2cc2431c48e
...
function sub_7327ad74(?) payable {
    ...
    if sub_05c0fd31[stor65[address(msg.sender)]] - sub_3d812727[stor65[address(msg.sender)]]:
        ...
        call sub_50539f55[stor65[address(msg.sender)]].transfer(address rg1, uint256 rg2) with:
             gas gas_remaining wei
...
function sub_b3b60a53(?) payable {
    ...
    if not arg2:
        ...
        mem[ceil32(arg1.length) + 384 len ceil32(arg1.length)] = arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]
        if not arg1.length % 32:
            emit 0xe98fe843: 0, Mask(224, 0, msg.sender), 224, address(arg2), address(arg3), arg4, arg5, arg6 + block.timestamp, arg1.length, Mask(8 * arg1.length, -(8 * arg1.length) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * arg1.length) - 256
        else:
            mem[floor32(arg1.length) + ceil32(arg1.length) + 384] = mem[floor32(arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 416 len arg1.length % 32]
            emit 0xe98fe843: 0, Mask(224, 0, msg.sender), 224, address(arg2), address(arg3), arg4, arg5, arg6 + block.timestamp, arg1.length, Mask(8 * ceil32(arg1.length), -(8 * ceil32(arg1.length)) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * ceil32(arg1.length)) - 256, mem[(2 * ceil32(arg1.length)) + 384 len floor32(arg1.length) + -ceil32(arg1.length) + 32]
}
