...
function sub_281a320f(?) {
    ...
    if _76 - 1 >= mem[ceil32(return_data.size) + 192]:
        revert with 'NH{q', 50
    mem[mem[64]] = mem[(32 * _76 - 1) + ceil32(return_data.size) + 224]
    return memory
      from mem[64]
       len 32
}
...
function sub_47f7cb48(?) {
    ...
    if not arg1:
        ...
        if _183 - 1 >= mem[ceil32(return_data.size) + 192]:
            revert with 'NH{q', 50
        _215 = mem[(32 * _183 - 1) + ceil32(return_data.size) + 224]
        ...
        mem[_217 + 100] = arg2
        mem[_217 + 132] = (10000 * _215) - (stor6 * _215) / 10000
        mem[_217 + 164] = 160
        ...
        mem[(2 * ceil32(return_data.size)) + 192] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, ext_call.return_data[0] / arg1) >> 32 + 192]
