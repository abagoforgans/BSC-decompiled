    ...
    if WETHAddress < arg2:
        ...
        if WETHAddress != arg2:
            ...
            if not Mask(112, 0, ext_call.return_data[32]):
                ...
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args Mask(1248, -1024, swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4), (9975 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) - (9975 * Mask(112, 0, ext_call.return_data[0]) * Mask(112, 0, ext_call.return_data[32])) / (25 * Mask(112, 0, ext_call.return_data[0])) + (9975 * ext_call.return_data[0]), 0, this.address, 128, 0) << 1024, mem[484 len 4]
    else:
        if not arg2:
            revert with 0, 'PancakeLibrary: ZERO_ADDRESS'
        require ext_code.size(arg2)
