    ...
    if cd[(arg4 + 68)]:
        ...
        if not mem[224]:
            call mem[172 len 20].liquidateBorrow(address rg1, uint256 rg2, address rg3) with:
                 gas gas_remaining wei
                args ext_call.return_data[0] << 160, cd[(arg4 + 164)], mem[204 len 20]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            if mem[256]:
                call mem[172 len 20].liquidateBorrow(address rg1, address rg2) with:
                   value cd[(arg4 + 164)] wei
                     gas gas_remaining wei
                    args ext_call.return_data[0] << 160, mem[204 len 20]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ext_code.size(mem[172 len 20])
        ...
        if address(cd[(arg4 + 100)]) == stor3:
            ...
            call stor3.0xd0e30db0 with:
               value cd[(arg4 + 164)] + (3 * cd[(arg4 + 164)] / 997) + 1 wei
                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        ...
        if cd[(arg4 + 36)]:
            ...
            if mem[224]:
                ...
                if mem[256]:
                    ...
                    require return_data.size >= 32
                    require 0 < 0, 2
                    mem[ceil32(cd[(arg4 + cd[(arg4 + 196)] + 36)]) + 160] = address(ext_call.return_data[0])
                    require 1 < 0, 2
                    ...
                    mem[ceil32(cd[(arg4 + cd[(arg4 + 196)] + 36)]) + 260] = (1000 * ext_call.return_data[0] * cd[(arg4 + 164)] / 997 * ext_call.return_data[0]) + 1
        ...
        if address(cd[(arg4 + 132)]) == stor3:
            require ext_code.size(stor3)
            call stor3.0xd0e30db0 with:
               value (1000 * ext_call.return_data[0] * cd[(arg4 + 164)] / 997 * ext_call.return_data[0]) + 1 wei
                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(address(cd[(arg4 + 132)]))
...
function sub_f0c890af(?) {
    ...
    if cd[4]:
        ...
        call address(('cd', 68)[2]).underlying() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(address(('cd', 68)[1]))
        call address(('cd', 68)[1]).underlying() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        mem[ceil32(('cd', 68).length) + 224] = address(ext_call.return_data[0])
        mem[ceil32(('cd', 68).length) + 256] = address(ext_call.return_data[0])
