...
uint256 stor8;
mapping of uint256 sub_7e3731a1;
...
function sub_7e3731a1(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return sub_7e3731a1[arg1]
}
...
function sub_5e315f8b(?) payable {
    ...
    if msg.value <= stor7[arg3]:
        revert with 0, 'Minimum Amount to mint is less than what is required'
    if totalSupply[arg2]:
        revert with 0, 'Token Already Minted'
    if sub_7e3731a1[arg3] > stor8:
        revert with 0, 'Max Limit for item type reached'
    if arg3 > stor6:
        revert with 0, 'Can only mint from defined  types'
    stor10.length++
    stor10[stor10.length].field_0 = arg2
    if not address(arg1):
        revert with 0, 'ERC1155: transfer to the zero address'
    revert with 0, 'Sender cannot be from zero address'
}
