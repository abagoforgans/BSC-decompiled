...
#  - harvest()
#
const autoVaultContract = 0x895196562c7868c5be92459fae7f877ed450452

const treasury = 0x305b0ecf72634825f7231058444c65d885e1f327

const WITHDRAWAL_MAX = 10000

const TREASURY_FEE = 15
...
function balanceOfPool() payable {
    require ext_code.size(0x895196562c7868c5be92459fae7f877ed450452)
    staticcall 0x895196562c7868c5be92459fae7f877ed450452.userInfo(uint256 rg1, address rg2) with:
            gas gas_remaining wei
...
function panic() payable {
    ...
    emit Paused(msg.sender);
    require ext_code.size(0x895196562c7868c5be92459fae7f877ed450452)
    call 0x0895196562c7868c5be92459fae7f877ed450452.emergencyWithdraw(uint256 rg1) with:
         gas gas_remaining wei
        args poolId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        mem[260 len 64] = approve(address rg1, uint256 rg2), 0x895196562c7868c5be92459, 0, 0
        mem[324 len 0] = 0
        call lpPairAddress.0xed450452 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), 0x895196562c7868c5be92459, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), 0x895196562c7868c5be92459, 0, 0
            if not approve(address rg1, uint256 rg2), 0x895196562c7868c5be92459:
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if ext_call.return_data[0]:
                require ext_code.size(lpPairAddress)
                staticcall lpPairAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args address(this.address), 0x895196562c7868c5be92459fae7f877ed450452
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0x895196562c7868c5be92459fae7f877ed450452, ext_call.return_data[0 len 28]
            call lpPairAddress.0xed450452 with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0x895196562c7868c5be92459fae7f877ed450452)
            call 0x0895196562c7868c5be92459fae7f877ed450452.deposit(uint256 rg1, uint256 rg2) with:
                 gas gas_remaining wei
            ...
            if return_data.size <= 0:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = 0, 0x895196562c7868c5be92459fae7f877ed450452, ext_call.return_data[0 len 28]
                ...
                if not return_data.size:
                    ...
                    call 0x0895196562c7868c5be92459fae7f877ed450452.deposit(uint256 rg1, uint256 rg2) with:
                         gas gas_remaining wei
                        args stor1, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 494 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            else:
                require return_data.size >= 32
                if not mem[292]:
                    revert with 0, 
        ...
        if not ext_call.success:
            ...
            if ext_call.return_data[0] >= arg1:
                                        ...
                                        if return_data.size <= 0:
                                            if 50 * ext_call.return_data[0] / 10000 > ext_call.return_data[0]:
                                                ...
                                                if ext_code.size(lpPairAddress) <= 0:
                                                    ...
                                                    mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 10000)) >> 32
                                    ...
                                    if return_data.size <= 0:
                                        if 0 > ext_call.return_data[0]:
                                            ...
                                            if ext_code.size(lpPairAddress) <= 0:
                                                ...
                                                mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
                                                call lpPairAddress with:
                                                   funct uint32(stor2)
                                                     gas gas_remaining wei
                                        ...
                                        if return_data.size <= 0:
                                            if 50 * arg1 / 10000 > arg1:
                                                ...
                                                if ext_code.size(lpPairAddress) <= 0:
                                                    ...
                                                    mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), Mask(224, 32, arg1 - (50 * arg1 / 10000)) >> 32
                                                    call lpPairAddress with:
                                                       funct uint32(stor2)
                                                         gas gas_remaining wei
                ...
                if ext_call.return_data[0] > arg1:
                    ...
                    require ext_code.size(0x895196562c7868c5be92459fae7f877ed450452)
                    call 0x0895196562c7868c5be92459fae7f877ed450452.withdraw(uint256 rg1, uint256 rg2) with:
                         gas gas_remaining wei
                        args stor1, arg1 - ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    else:
                        require ext_code.size(lpPairAddress)
                                                ...
                                                if return_data.size <= 0:
                                                    if 0 > ext_call.return_data[0]:
                                                        ...
                                                        if ext_code.size(lpPairAddress) <= 0:
                                                            ...
                                                            mem[ceil32(return_data.size) + 617 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2), uint32(stor2), ext_call.return_data[0 len 28]
                                                            call lpPairAddress with:
                                                               funct uint32(stor2)
                                                                 gas gas_remaining wei
