...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not balanceOf[address(stor29.field_0)]:
        ...
        if balanceOf[address(stor29.field_0)]:
            ...
            if not arg1:
                ...
                if arg1:
                    ...
                    if totalSupply - balanceOf[stor3] - balanceOf[stor4] <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    if totalSupply - balanceOf[stor3] - balanceOf[stor4]:
                        return (arg1 * 2 * balanceOf[address(stor29.field_0)] / totalSupply - balanceOf[stor3] - balanceOf[stor4])
    revert
}
            ...
            if not arg2:
                ...
                if arg2:
                    ...
                    if totalSupply - balanceOf[stor3] - balanceOf[stor4] <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    if totalSupply - balanceOf[stor3] - balanceOf[stor4]:
                        return (arg2 * 2 * balanceOf[address(stor29.field_0)] / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
    revert
}
...
function multiTransfer_fixed(address arg1, address[] arg2, uint256 arg3) payable {
    ...
    while idx < arg2.length:
        ...
        mem[64] = mem[64] + 64
        mem[_36] = 20
        mem[_36 + 32] = 'Insufficient Balance'
        mem[32] = 8
...
function multiTransfer(address arg1, address[] arg2, uint256[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        mem[64] = mem[64] + 64
        mem[_65] = 20
        mem[_65 + 32] = 'Insufficient Balance'
        mem[32] = 8
