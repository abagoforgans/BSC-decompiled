...
function spellNameAndSymbol(address arg1, address arg2, uint256 arg3, uint256 arg4) payable {
    ...
    return 64, 128, 31, 256 * 'Helmet.Insure Long Option Token', 4, 0
}

function exercise() payable {
    require ext_code.size(factoryAddress)
    call factoryAddress.0x96c5a36f with:
         gas gas_remaining wei
        args msg.sender, creatorAddress, collateralAddress, underlyingAddress, strikePrice, expiry, balanceOf[address(msg.sender)], 256, 0
...
function exercise(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(factoryAddress)
    call factoryAddress.0x96c5a36f with:
         gas gas_remaining wei
        args msg.sender, creatorAddress, collateralAddress, underlyingAddress, strikePrice, expiry, arg1, 256, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    return ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64]
...
function exercise(uint256 arg1, address[] arg2) payable {
    require calldata.size - 4 >= 64
    require arg2 <= 4294967296
    require arg2 + 36 <= calldata.size
    require arg2.length <= 4294967296 and arg2 + (32 * arg2.length) + 36 <= calldata.size
    mem[(32 * arg2.length) + 420 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
    require ext_code.size(factoryAddress)
    call factoryAddress.0x96c5a36f with:
         gas gas_remaining wei
        args msg.sender, creatorAddress, collateralAddress, underlyingAddress, strikePrice, expiry, arg1, Array(len=arg2.length, data=call.data[arg2 + 36 len floor32(arg2.length)], mem[(32 * arg2.length) + floor32(arg2.length) + 420 len (32 * arg2.length) - floor32(arg2.length)])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    return ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64]
...
function sub_91911002(?) payable {
    ...
    call factoryAddress.0x96c5a36f with:
         gas gas_remaining wei
        args msg.sender, creatorAddress, collateralAddress, underlyingAddress, strikePrice, expiry, balanceOf[address(msg.sender)], Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + floor32(arg1.length) + 420 len (32 * arg1.length) - floor32(arg1.length)])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    return ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64]
...
function initialize(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5) payable {
            ...
            if not uint8(stor0.field_8):
                ...
                if not uint8(stor0.field_8):
                    ...
                    if not uint8(stor0.field_8):
                        ...
                        Mask(248, 0, stor0.field_8) = 0
    bool(name.length) = 0
    name.length.field_1 = 31
    name.length.field_8 = 'Helmet.Insure Long Option Token'
    idx = 0
    ...
    symbol.length.field_224 = 1282371175
    idx = 0
