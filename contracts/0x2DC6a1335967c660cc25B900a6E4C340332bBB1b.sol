...
function getMultipliedFee() {
    ...
    if not stor15:
        ...
        if not stor28:
            revert with 0, 'SafeMath: division by zero', 0
        if stor15 > !((stor27 * 0 / stor26) + (stor28 * 0 / stor26) - (block.timestamp * 0 / stor26) - (stor27 * stor15) - (stor28 * stor15) + (block.timestamp * stor15) / stor28):
            revert with 0, 17
    ...
    if not stor28:
        revert with 0, 'SafeMath: division by zero', 0
    if stor15 > !((stor27 * stor15 * stor25 / stor26) + (stor28 * stor15 * stor25 / stor26) - (block.timestamp * stor15 * stor25 / stor26) - (stor27 * stor15) - (stor28 * stor15) + (block.timestamp * stor15) / stor28):
        revert with 0, 17
