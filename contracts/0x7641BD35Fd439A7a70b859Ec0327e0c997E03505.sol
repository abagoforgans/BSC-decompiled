                    ...
                    if Mask(112, 0, ext_call.return_data[32]):
                        if uint32(uint32(block.timestamp) - uint32(stor6.field_0)):
                            ...
                            if Mask(32, 112, (10^6 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) >> 112:
                                return (10^6 * Mask(32, 112, (10^9 * ext_call.return_data[0]) - (10^9 * stor1) / uint32(uint32(block.timestamp) - stor3)) >> 112 / Mask(32, 80, (10^6 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) >> 80)
    else:
        if Mask(112, 0, ext_call.return_data[0]) <= 0:
            revert with 0, 'FixedPoint: DIV_BY_ZERO'
        if Mask(112, 0, ext_call.return_data[0]):
                    ...
                    if uint32(block.timestamp) == ext_call.return_data[92 len 4]:
                        if uint32(uint32(block.timestamp) - uint32(stor6.field_0)):
                            if Mask(224, 0, (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) != Mask(224, 0, (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))):
                                revert with 0, 32, 35, 0xfe4669786564506f696e743a204d554c5449504c49434154494f4e5f4f564552464c4f, mem[551 len 29]
                            if Mask(32, 112, (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) >> 112:
                                return (10^6 * Mask(32, 112, (10^9 * Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^9 * ext_call.return_data[0]) - (10^9 * stor1) / uint32(uint32(block.timestamp) - stor3)) >> 112 / Mask(32, 80, (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) >> 80)
                    else:
                        if Mask(112, 0, ext_call.return_data[0]) <= 0:
                            revert with 0, 'FixedPoint: DIV_BY_ZERO'
                        if Mask(112, 0, ext_call.return_data[0]):
                            ...
                            if Mask(112, 0, ext_call.return_data[32]):
                                if uint32(uint32(block.timestamp) - uint32(stor6.field_0)):
                                    if Mask(224, 0, (10^6 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) != Mask(224, 0, (10^6 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))):
                                        revert with 0, 32, 35, 0xfe4669786564506f696e743a204d554c5449504c49434154494f4e5f4f564552464c4f, mem[679 len 29]
                                    if Mask(32, 112, (10^6 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) >> 112:
                                        return (10^6 * Mask(32, 112, (10^9 * Mask(224, 0, Mask(112, 0, ext_call.return_data[32]) << 112 / Mask(112, 0, ext_call.return_data[0])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^9 * ext_call.return_data[0]) - (10^9 * stor1) / uint32(uint32(block.timestamp) - stor3)) >> 112 / Mask(32, 80, (10^6 * Mask(224, 0, Mask(112, 0, ext_call.return_data[0]) << 112 / Mask(112, 0, ext_call.return_data[32])) * uint32(uint32(block.timestamp) - ext_call.return_data[64])) + (10^6 * ext_call.return_data[0]) - (10^6 * stor5) / uint32(uint32(block.timestamp) - uint32(stor6.field_0))) >> 80)
    revert
}
