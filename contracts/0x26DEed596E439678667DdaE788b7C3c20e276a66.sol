...
function pairAddress(address arg1) payable {
    require calldata.size - 4 >= 32
    return bool(stor15[arg1])
}

function sub_b91854f4(?) payable {
    return sub_b91854f4
}
...
function addPairAddress(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'tOwnable: caller is not the owne'
...
function removePairAddress(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'tOwnable: caller is not the owne'
            ...
            if not stor15[address(arg1)]:
                ...
                if not arg2:
                    ...
                    if 0 > arg2 + balanceOf[address(arg1)]:
                        revert with 0, 'Insufficient Balance'
                    balanceOf[address(arg1)] += arg2
                    emit 0x65ddf252: 0, msg.sender, this.address
                    if 0 > arg2:
                        revert with 0, 'SafeMath: subtraction overflow'
                    emit 0x65ddf252: arg2, msg.sender, arg1
                else:
                    ...
                    emit 0x65ddf252: (buybackFee * arg2 / 100), msg.sender, this.address
                ...
                if balanceOf[this.address] > swapLimit:
                    ...
                    call routerAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                        ...
                        args balanceOf[this.address], 0, 160, address(this.address), block.timestamp, 2, mem[644 len 64]
                        ...
                        if eth.balance(this.address) >= buybackLimit:
                            ...
                            call routerAddress.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                               value eth.balance(this.address) wei
                                 gas gas_remaining wei
                                args 0, 128, address(this.address), 0, block.timestamp, 2, mem[708 len 64]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if balanceOf[this.address] > balanceOf[this.address]:
                                revert with 0, 'SafeMath: subtraction overflow'
                            if not msg.sender:
                                revert with 0, '', 33, 0xef45524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[709 len 31]
                ...
                if not stor15[address(arg2)]:
                    ...
                    if not arg3:
                        ...
                        if 0 > arg3 + balanceOf[address(arg2)]:
                            revert with 0, 'Insufficient Balance'
                        balanceOf[address(arg2)] += arg3
                        emit 0x65ddf252: 0, arg1, this.address
                        if 0 > arg3:
                            revert with 0, 'SafeMath: subtraction overflow'
                        emit 0x65ddf252: arg3, arg1, arg2
                    else:
                        ...
                        emit 0x65ddf252: (buybackFee * arg3 / 100), arg1, this.address
            ...
            if not buybackFee:
                ...
                if not stor15[address(arg2)]:
                    ...
                    if balanceOf[this.address] > swapLimit:
                        ...
                        call routerAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args balanceOf[this.address], 0, 160, address(this.address), block.timestamp, 2, mem[708 len 64]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if sub_b91854f4 + sub_5a53c1fb <= block.number:
                            if eth.balance(this.address) >= buybackLimit:
                                ...
                                call routerAddress.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                                   value eth.balance(this.address) wei
                                     gas gas_remaining wei
                                    args 0, 128, address(this.address), 0, block.timestamp, 2, mem[772 len 64]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if balanceOf[this.address] > balanceOf[this.address]:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                if not msg.sender:
                                    revert with 0, '', 33, 0xef45524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[773 len 31]
                                if 0 > balanceOf[address(msg.sender)]:
                                    revert with 0, 
                                                32,
                                                34,
