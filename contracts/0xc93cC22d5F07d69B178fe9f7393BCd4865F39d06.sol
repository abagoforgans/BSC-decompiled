...
uint256 stor351;
array of uint256 stor352;
address blacklisterAddress;
mapping of uint8 stor354;
...
function isBlacklisted(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return bool(stor354[address(arg1)])
}
...
function unBlacklist(address arg1) payable {
    ...
    stor354[address(arg1)] = 0
    emit UnBlacklisted(arg1);
}

function sub_e2866566(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    require msg.sender == blacklisterAddress
    stor354[address(arg1)] = 1
    emit Blacklisted(address(arg1));
}
...
function burn(uint256 arg1) payable {
    ...
    if paused:
        revert with 0, 'Pausable: paused'
    if stor354[stor103[arg1]]:
        revert with 0, 'Owner is on blacklist'
    if not ownerOf[arg1]:
...
function setURI(string arg1) payable {
    ...
    if roleAdmin[0][address(msg.sender)].field_0:
        if bool(stor352.length):
            if bool(stor352.length) == stor352.length.field_1 < 32:
                revert with 'NH{q', 34
            if arg1.length:
                stor352[].field_0 = Array(len=arg1.length, data=arg1[all])
            else:
                stor352.length = 0
                idx = 0
                while stor352.length.field_1 + 31 / 32 > idx:
                    stor352[idx].field_0 = 0
                    idx = idx + 1
                    continue 
        else:
            if bool(stor352.length) == stor352.length.field_1 < 32:
    ...
    if roleAdmin[0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6][address(msg.sender)].field_0:
        ...
        while uint8(idx) < arg1.length:
            ...
            if mem[(32 * uint8(idx)) + 140 len 20]:
                tokenOfOwnerByIndex[address(mem[(32 * uint8(idx)) + 128])][stor104[address(mem[(32 * uint8(idx)) + 128])]] = stor351
                stor152[stor351] = balanceOf[address(mem[(32 * uint8(idx)) + 128])]
            else:
                if tokenByIndex.length < 1:
                    revert with 'NH{q', 17
                if tokenByIndex.length - 1 >= tokenByIndex.length:
            ...
            mem[0] = stor351
            mem[32] = 103
            ownerOf[stor351] = mem[(32 * uint8(idx)) + 140 len 20]
            emit Transfer(0, mem[(32 * uint8(idx)) + 140 len 20], stor351);
            if uint8(idx) == 255:
                revert with 'NH{q', 17
            idx = uint8(idx) + 1
            continue 
