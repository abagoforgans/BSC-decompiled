...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        ...
        call wantAddress.mem[160 len 4] with:
             gas gas_remaining wei
            args 0, Mask(224, 32, 0, ext_call.return_data[12 len 20], 0) >> 32, mem[260 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
            if not 0, mem[132 len 28]:
            ...
            if ext_code.hash(wantAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
            mem[296 len 64] = approve(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, ext_call.return_data[0 len 28]
            ...
            if not return_data.size:
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.hash(wantAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[ceil32(return_data.size) + 297 len 64] = approve(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, ext_call.return_data[0 len 28]
                    ...
                    if not return_data.size:
                        ...
                        call 0x0cea0832e9cdbb5d476040d58ea07ecfbebb7672.deposit(address rg1, uint256 rg2) with:
                             gas gas_remaining wei
                            args wantAddress, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 366 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                else:
                    require ext_code.size(wantAddress)
                    staticcall wantAddress.0xdd62ed3e with:
                            gas gas_remaining wei
