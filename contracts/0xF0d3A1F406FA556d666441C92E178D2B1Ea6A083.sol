...
function balanceOfBatch(address[] arg1, uint256[] arg2) {
    ...
    if arg1.length:
        mem[(32 * arg1.length) + (32 * arg2.length) + 192 len 32 * arg1.length] = code.data[15341 len 32 * arg1.length]
    idx = 0
    ...
    if ext_code.hash(arg1):
        if ext_code.hash(arg1) != 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
            ...
            if not arg4.length % 32:
                ...
                call arg1.onERC1155BatchReceived(address rg1, address rg2, uint256[] rg3, uint256[] rg4, bytes rg5) with:
                     gas gas_remaining wei
                    args msg.sender, 0, 160, (32 * arg2.length) + 192, (32 * arg3.length) + (32 * arg2.length) + 224, arg2.length, call.data[arg2 + 36 len floor32(arg2.length)], mem[(32 * arg2.length) + (32 * arg3.length) + ceil32(arg4.length) + floor32(arg2.length) + 388 len (32 * arg2.length) + (32 * arg3.length) + -floor32(arg2.length) + 32], arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[(32 * arg2.length) + (32 * arg3.length) + arg4.length + 192 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[(64 * arg2.length) + (64 * arg3.length) + (2 * ceil32(arg4.length)) + 452 len floor32(arg4.length) + -ceil32(arg4.length) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
