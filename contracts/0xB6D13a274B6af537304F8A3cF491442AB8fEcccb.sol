...
function sub_d66517d4(?) {
    ...
    if msg.sender == stor6:
        ...
        staticcall address(_23).balanceOf(address arg1) with:
                gas gas_remaining wei
               args address(cd[4])
    else:
        require msg.sender == stor7
        ...
        staticcall address(_26).balanceOf(address arg1) with:
                gas gas_remaining wei
               args address(cd[4])
...
function sub_9b4a29a3(?) {
    ...
    if msg.sender == stor6:
        ...
        while idx < stor11:
            ...
            staticcall address(_56).balanceOf(address arg1) with:
                    gas gas_remaining wei
        ...
        while idx < stor11:
            ...
            staticcall address(_57).balanceOf(address arg1) with:
                    gas gas_remaining wei
                   args stor9[idx].field_0
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
        ...
        if stor4 == address(arg1):
            ...
            if not arg6:
                ...
                while idx < _2654:
                    ...
                    continue 
                mem[_2646 + 100] = stor8
                mem[_2646 + 132] = block.timestamp + 15
                require ext_code.size(stor2)
                call stor2.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _2646 + (32 * _2654) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        ...
        if stor4 == address(arg1):
            ...
            if not arg7:
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _754 + (32 * _766) + -mem[64] + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1382 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        if mem[_3594 + ceil32(return_data.size) + 32] < arg6:
                            ...
                            call stor9[idx].field_0.0x6023e966 with:
                               value _3778 * arg4 wei
                                 gas gas_remaining wei
                                args 128, arg4, _3799, stor9[idx].field_0, mem[mem[64] + 132 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    if idx == -1:
                        revert with 0, 17
