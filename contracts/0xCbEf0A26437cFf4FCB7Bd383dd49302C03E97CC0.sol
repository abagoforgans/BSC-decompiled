...
function sub_60c6a3c8(?) payable {
    ...
    if controllerAddress != msg.sender:
        revert with 0, 'This is not controller.'
    if stor10 >= sub_3bc274a4:
        revert with 0, 'The token can not mint anymore.'
    stor10++
    if not address(arg4):
    ...
    ownerOf[stor10] = address(arg4)
    emit Transfer(0, address(arg4), stor10);
    ...
    if arg3:
        ...
        royaltyInfo[stor10].field_0 = address(arg2)
        royaltyInfo[stor10].field_256 = arg3
    emit 0xcae919fa: stor10, address(arg4)
}
