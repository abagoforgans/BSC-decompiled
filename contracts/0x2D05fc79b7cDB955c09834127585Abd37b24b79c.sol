...
function sub_8946f650(?) {
    ...
    while idx < arg1.length:
        ...
        staticcall mem[(32 * idx) + 140 len 20].0xc45a0155 with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
...
function sub_06755799(?) {
    ...
    if not sub_451ae8ea:
        ...
        while var105003 < var105001 + 1:
            ...
            while sub_691b5245 > 0:
                ...
                _1457 = mem[mem[(32 * arg1.length) + 1184]]
                _1459 = mem[mem[(32 * arg1.length) + 1184] + 32]
                ...
                staticcall address(_1455).getAmountOut(uint256 rg1, uint256 rg2, uint256 rg3) with:
                        gas gas_remaining wei
                       args s / sub_691b5245, _1457 << 144, Mask(112, 0, _1459)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                _1478 = mem[(32 * arg1.length) + 1280]
                _1480 = mem[mem[(32 * arg1.length) + 1312] + 32]
                _1482 = mem[mem[(32 * arg1.length) + 1312]]
                ...
                if ext_call.return_data[0] - (s / sub_691b5245) < mem[_173]:
                    mem[_173 + 64] = (32 * arg1.length) + 1152
                    mem[_173 + 96] = (32 * arg1.length) + 1280
                    _1513 = mem[_173 + 32]
                    mem[mem[64]] = mem[_173]
                ...
                if ext_call.return_data[0] - (s / sub_691b5245) <= mem[_173]:
                    ...
                    mem[_173] = ext_call.return_data[0] - (s / sub_691b5245)
                    mem[_173 + 32] = s / sub_691b5245
                    if not sub_451ae8ea:
                        _1446 = mem[64]
                        mem[64] = mem[64] + 64
                        mem[_1446] = 26
                    ...
                    if sub_451ae8ea * sub_691b5245 / sub_451ae8ea != sub_691b5245:
                        revert with 0, 32, 33, 0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                    if t >= sub_451ae8ea * sub_691b5245:
                        return ext_call.return_data[0] - (s / sub_691b5245), s / sub_691b5245
                ('lt', ('var', 2), ('mul', ('stor', ('name', 'sub_451ae8ea', 1)), ('stor', ('name', 'sub_691b5245', 2))))
    ...
    while sub_691b5245 > 0:
        ...
        _1640 = mem[mem[(32 * arg1.length) + 1184]]
        _1642 = mem[mem[(32 * arg1.length) + 1184] + 32]
        mem[mem[64] + 4] = s / sub_691b5245
        ...
        staticcall address(_1638).getAmountOut(uint256 rg1, uint256 rg2, uint256 rg3) with:
                gas gas_remaining wei
               args s / sub_691b5245, _1640 << 144, Mask(112, 0, _1642)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        _1650 = mem[(32 * arg1.length) + 1280]
        _1652 = mem[mem[(32 * arg1.length) + 1312] + 32]
        _1654 = mem[mem[(32 * arg1.length) + 1312]]
        mem[mem[64] + 4] = ext_call.return_data[0]
    ...
    revert with memory
      from mem[64]
       len floor32(_1636) + _1634 + -mem[64] + 100
}
