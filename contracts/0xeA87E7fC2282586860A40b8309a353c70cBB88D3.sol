...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x70480275(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xac2eceea(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x91d14854(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x957476af(?????):
                        ...
                        if unknown_0xa4b5fa56(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            return blacklistAddress
                        require unknown_0xab397b46(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        return ticketOfficeAddress
                    require not msg.value
                    require calldata.size - 4 >= 64
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x70480275(?????):
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x7bb7bed1(?????):
                        require unknown_0x8da5cb5b(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        return owner
                    require not msg.value
                    require calldata.size - 4 >= 32
                    require cd[4] < rewardTokens.length
                    return address(rewardTokens[cd[4]])
                require not msg.value
                require calldata.size - 4 >= 32
            ...
            if unknown_0xe30ac74e(?????) <= uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != unknown_0xe30ac74e(?????):
                ...
                if uint32(call.func_hash) >> 224 != unknown_0xac2eceea(?????):
                    if uint32(call.func_hash) >> 224 != unknown_0xd547741f(?????):
                        if unknown_0xd5ed4d5a(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            return ticketTokenAddress
                        require unknown_0xe06174e4(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        return settingsAddress
                    require not msg.value
                    require calldata.size - 4 >= 64
            ...
            if unknown_0x2f2ff15d(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x1785f53c(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x1a86b550(?????):
                        if uint32(call.func_hash) >> 224 != unknown_0x201e81a8(?????):
                        ...
                        rewardTokens.length = ('cd', 4).length
                        if not ('cd', 4).length:
                            idx = 0
            ...
            if unknown_0x5c975abb(?????) > uint32(call.func_hash) >> 224:
                ...
                if unknown_0x36568abe(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x3f09f195(?????):
                        require unknown_0x43d726d6(?????) == uint32(call.func_hash) >> 224
                        if roleAdmin[0x426270edb7c868f86fda4adedba75108201087268ea345934db8bad688e1feb9][address(msg.sender)].field_0:
                            selfdestruct(msg.sender)
                        idx = 41
                        s = address(msg.sender)
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x660071dd(?????):
                    if uint32(call.func_hash) >> 224 != unknown_0x6735b3a7(?????):
                        if unknown_0x6817031b(?????) == uint32(call.func_hash) >> 224:
                            ...
                            require unknown_0x6ff1c9bc(?????) == uint32(call.func_hash) >> 224
                            require not msg.value
                            require calldata.size - 4 >= 32
                            require cd[4] == address(cd[4])
                            if not roleAdmin[0x426270edb7c868f86fda4adedba75108201087268ea345934db8bad688e1feb9][address(msg.sender)].field_0:
                ...
                call ticketOfficeAddress.0xab5b4456 with:
                     gas gas_remaining wei
                    args cd[4]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if mem[160] > 0:
                    ...
                    mem[ceil32(32 * ('cd', 36).length) + ceil32(return_data.size) + 257 len 4] = unknown_0x23b872dd(?????)
                    ...
                    if not ext_code.size(address(rewardTokens)):
                    ...
                    call address(rewardTokens) with:
...
function setRewardTokens(address[] arg1) {
    require calldata.size - 4 >= 32
    require arg1 <= test266151307()
    ...
    if not roleAdmin[0xfedf8b4c520ffe197c5343c6f5aec59570151ef9a492f2c624fd45ddde6135ec][address(msg.sender)].field_0:
        revert with 0, 'only admin'
    rewardTokens.length = arg1.length
    if not arg1.length:
        idx = 0
        while rewardTokens.length > idx:
            uint256(rewardTokens[idx]) = 0
