...
function takeOff(uint32 arg1, uint256 arg2, address arg3) payable {
    ...
    call wearableAddress.0xf242432a with:
         gas gas_remaining wei
        args 0, uint32(this.address), msg.sender, alpacaOutfit[arg2][arg1 << 224], 1, 160, 0, ext_call.return_data[196]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0x99fe5df7: address(msg.sender), alpacaOutfit[arg2][arg1 << 224], arg1 << 224, arg2
    stor2 = 1
}
