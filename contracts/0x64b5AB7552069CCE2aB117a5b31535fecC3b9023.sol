            ...
            if not stor7:
                ...
                if (balanceOf[address(arg1)] * stor7) + stor8[address(arg1)].field_0 < stor8[address(arg1)].field_0:
                    ...
                    if (balanceOf[address(arg1)] * stor7) + stor8[address(arg1)].field_0 >= stor8[address(arg1)].field_0:
                        revert with 0, 'add is not success'
                stor8[address(arg1)].field_0 += balanceOf[address(arg1)] * stor7
    require ext_code.size(0xe505b448a2e7dece5df7567f80b45bd6a038aabc)
    delegate 0xe505b448a2e7dece5df7567f80b45bd6a038aabc.0x4c60db9c with:
    ...
    if not stor16[address(arg1)]:
        if arg2 < minimumTokenBalanceForDividends:
            ...
            if arg2 > balanceOf[address(arg1)]:
                ...
                require ext_code.size(0xe505b448a2e7dece5df7567f80b45bd6a038aabc)
                delegate 0xe505b448a2e7dece5df7567f80b45bd6a038aabc.0xbc2b405c with:
                     gas gas_remaining wei
...
function getAccount(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xe505b448a2e7dece5df7567f80b45bd6a038aabc)
    delegate 0xe505b448a2e7dece5df7567f80b45bd6a038aabc.0x17e142d1 with:
         gas gas_remaining wei
        args 11, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getAccountAtIndex(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xe505b448a2e7dece5df7567f80b45bd6a038aabc)
    delegate 0xe505b448a2e7dece5df7567f80b45bd6a038aabc.0xdeb3d896 with:
         gas gas_remaining wei
        args 11
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(0xe505b448a2e7dece5df7567f80b45bd6a038aabc)
    delegate 0xe505b448a2e7dece5df7567f80b45bd6a038aabc.0xd1aa9e7e with:
         gas gas_remaining wei
        args 11, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
