...
function TeamWithdrawALLMarketingBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor25 = 0
    if stor25 > 0x333333333333333333333333333333333333333333333333333333333333333:
        revert with 0, 17
    call stor13 with:
       value 80 * stor25 / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if stor25 > 0xccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc:
        revert with 0, 17
    call stor14 with:
       value 20 * stor25 / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
