...
function myStats() {
    ...
    return stor1[address(msg.sender)].field_0, ext_call.return_data[0], stor5
}
...
function leave() {
    ...
    if block.number <= stor1[address(msg.sender)].field_512:
        if 0 > stor5:
            revert with 0, 'SafeMath sub error'
        require ext_code.size(stor6)
        call stor6.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, 0
        ...
        if not stor1[address(msg.sender)].field_0:
            ...
            if not 0 / stor3 / stor4:
                ...
                if 3 * 0 / stor3 / stor4 < ext_call.return_data[0]:
                    if 3 * 0 / stor3 / stor4 > stor5:
                        revert with 0, 'SafeMath sub error'
                    stor5 += -3 * 0 / stor3 / stor4
                    require ext_code.size(stor6)
                    call stor6.0xa9059cbb with:
                         gas gas_remaining wei
            ...
            if not (block.number * stor1[address(msg.sender)].field_0) - (stor1[address(msg.sender)].field_512 * stor1[address(msg.sender)].field_0) / stor3 / stor4:
                ...
                if 3 * (block.number * stor1[address(msg.sender)].field_0) - (stor1[address(msg.sender)].field_512 * stor1[address(msg.sender)].field_0) / stor3 / stor4 < ext_call.return_data[0]:
                    if 3 * (block.number * stor1[address(msg.sender)].field_0) - (stor1[address(msg.sender)].field_512 * stor1[address(msg.sender)].field_0) / stor3 / stor4 > stor5:
                        revert with 0, 'SafeMath sub error'
                    stor5 += -3 * (block.number * stor1[address(msg.sender)].field_0) - (stor1[address(msg.sender)].field_512 * stor1[address(msg.sender)].field_0) / stor3 / stor4
                    require ext_code.size(stor6)
                    call stor6.0xa9059cbb with:
                         gas gas_remaining wei
