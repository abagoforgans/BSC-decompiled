...
function sub_a5c5c671(?) {
    ...
    if address(arg1) == 0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c:
        ...
        call sandwichRouterAddress.sandwichExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg2, arg4, Array(len=2, data=mem[(2 * ceil32(return_data.size)) + 388 len 64]), administratorAddress, block.timestamp + 120
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(2 * ceil32(return_data.size)) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (4 * ceil32(return_data.size)) + 192
        require return_data.size >= 32
        _46 = mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg2) >> 32
        ...
        _48 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg2) >> 32 + 192]
        ...
        idx = 0
        s = (2 * ceil32(return_data.size)) + _46 + 224
        t = (4 * ceil32(return_data.size)) + 224
        while idx < _48:
            require mem[s] == mem[s]
            mem[t] = mem[s]
        ...
        call sandwichRouterAddress.sandwichExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg2, arg4, Array(len=3, data=mem[(2 * ceil32(return_data.size)) + 420 len 96]), administratorAddress, block.timestamp + 120
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        _47 = mem[(2 * ceil32(return_data.size)) + 224 len 4], Mask(224, 32, arg2) >> 32
        ...
        _49 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], Mask(224, 32, arg2) >> 32 + 224]
        ...
        idx = 0
        s = (2 * ceil32(return_data.size)) + _47 + 256
