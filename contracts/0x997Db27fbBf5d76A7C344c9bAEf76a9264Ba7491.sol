...
function sub_7a72e80c(?) payable {
    ...
    if not arg5 % 9418:
        ...
        if 1 < mem[ceil32(return_data.size) + 384]:
            ...
            mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 484] = _638
            ...
            call arg3.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args arg5, _638, Array(len=2, data=mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 644 len 64]), address(this.address), block.timestamp + 10
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if 1 < mem[ceil32(return_data.size) + 384]:
                ...
                if 1 < mem[ceil32(return_data.size) + 384]:
                    if 1 < mem[(32 * _172) + (2 * ceil32(return_data.size)) + 416]:
                        ...
                        mem[(32 * _758) + (32 * _475) + (32 * _172) + (4 * ceil32(return_data.size)) + 516] = _862
                        ...
                        call arg3.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args mem[ceil32(return_data.size) + 448], _862, Array(len=2, data=mem[(32 * _758) + (32 * _475) + (32 * _172) + (4 * ceil32(return_data.size)) + 676 len 64]), address(this.address), block.timestamp + 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
        ...
        if 1 < mem[(32 * _172) + (2 * ceil32(return_data.size)) + 416]:
            ...
            if 1 < mem[ceil32(return_data.size) + 384]:
                ...
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 448] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 452] = arg5
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 484] = _646
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 548] = this.address
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 580] = block.timestamp + 10
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 516] = 160
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 612] = 2
                ...
                call arg3.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args arg5, _646, Array(len=2, data=mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 644 len 64]), address(this.address), block.timestamp + 10
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(32 * _475) + (32 * _172) + (2 * ceil32(return_data.size)) + 448 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = (32 * _475) + (32 * _172) + (4 * ceil32(return_data.size)) + 448
                ...
                if 1 < mem[ceil32(return_data.size) + 384]:
                    ...
                    if 1 < mem[ceil32(return_data.size) + 384]:
                        if 1 < mem[(32 * _172) + (2 * ceil32(return_data.size)) + 416]:
                            ...
                            mem[(32 * _759) + (32 * _475) + (32 * _172) + (4 * ceil32(return_data.size)) + 516] = _866
                            ...
                            call arg3.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                 gas gas_remaining wei
                                args mem[ceil32(return_data.size) + 448], _866, Array(len=2, data=mem[(32 * _759) + (32 * _475) + (32 * _172) + (4 * ceil32(return_data.size)) + 676 len 64]), address(this.address), block.timestamp + 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
