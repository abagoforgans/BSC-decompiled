...
#
const name = 'Prince Inu', 0

const MarketingWallet = 0xe7e6c0969dbab5beddc6dae1eea213a76ceb2ee7

const decimals = 9

const sub_504762e7(?) = 1000 * 10^18

const symbol = '$PRINCE', 0
...
function sub_218f8a1d(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0xe7e6c0969dbab5beddc6dae1eea213a76ceb2ee7 with:
