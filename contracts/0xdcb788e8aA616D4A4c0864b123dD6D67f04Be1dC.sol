...
function mint(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if not mintable:
        revert with 0, 'this token is not mintable'
    if not msg.sender:
...
function initialize(string arg1, string arg2, uint8 arg3, uint256 arg4, bool arg5, address arg6) payable {
    ...
    decimals = arg3
    stor6 = Mask(88, 0, arg5)
    if not arg6:
        revert with 0, 'BEP20: mint to the zero address'
    if arg4 + totalSupply < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += arg4
    if arg4 + balanceOf[address(arg6)] < balanceOf[address(arg6)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg6)] += arg4
