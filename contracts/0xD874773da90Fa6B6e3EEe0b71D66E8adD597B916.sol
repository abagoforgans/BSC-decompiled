...
#
const name = 'FalconTeam', 0

const InitialSupply = 10000000 * 10^18

const decimals = 18

const TeamWallet = 0x3a79460b27a8d3278bb71af6fe70d97bbd7e8bd2

const symbol = 'Falcon', 0
...
function getBurnedTokens() {
    if 10000000 * 10^18 < totalSupply:
        revert with 'NH{q', 17
    return (-totalSupply + 10000000 * 10^18 / 10^18)
}
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x3a79460b27a8d3278bb71af6fe70d97bbd7e8bd2 with:
