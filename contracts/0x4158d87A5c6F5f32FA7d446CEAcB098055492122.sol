...
function setswapEnabled(bool arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    uint8(stor20.field_0) = uint8(arg1)
}
...
function addFixedSaleEarlyParticipants(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 30
        stor30[address(cd[((32 * idx) + arg1 + 36)])] = 1
        idx = idx + 1
        continue 
            ...
            if not 0 / totalFees:
                ...
                if not uint8(stor20.field_8):
                    if balanceOf[address(this.address)] - (0 / totalFees):
                        ...
                        allowance[address(this.address)][stor8].field_0 = balanceOf[address(this.address)] - (0 / totalFees)
                        ...
                        if not balanceOf[address(this.address)] - (0 / totalFees):
                            ...
                            if not 0 / totalFees:
                                ...
                                if balanceOf[address(this.address)] - (2 * 0 / totalFees):
                                    ...
                                    allowance[address(this.address)][stor8].field_0 = balanceOf[address(this.address)] - (2 * 0 / totalFees)
                                ...
                                allowance[address(this.address)][stor8].field_0 = 0 / totalFees / 2
                                ...
                                allowance[address(this.address)][stor8].field_0 = (0 / totalFees) - (0 / totalFees / 2)
                            ...
                            if not (balanceOf[address(this.address)] * liquidityFee) - (0 / totalFees * liquidityFee) / totalFees:
                                ...
                                if balanceOf[address(this.address)] - (0 / totalFees) - ((balanceOf[address(this.address)] * liquidityFee) - (0 / totalFees * liquidityFee) / totalFees):
                                    ...
                                    if not uniswapV2RouterAddress:
                                        revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[550 len 30]
                                    allowance[address(this.address)][stor8].field_0 = balanceOf[address(this.address)] - (0 / totalFees) - ((balanceOf[address(this.address)] * liquidityFee) - (0 / totalFees * liquidityFee) / totalFees)
                                ...
                                if not uniswapV2RouterAddress:
                                    revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[614 len 30]
                                allowance[address(this.address)][stor8].field_0 = (balanceOf[address(this.address)] * liquidityFee) - (0 / totalFees * liquidityFee) / totalFees / 2
                                allowance[address(this.address)][stor8].field_255 = 0
                                ...
                                if not uniswapV2RouterAddress:
                                    revert with 0, 'sERC20: approve to the zero addres'
                                allowance[address(this.address)][stor8].field_0 = ((balanceOf[address(this.address)] * liquidityFee) - (0 / totalFees * liquidityFee) / totalFees) - ((balanceOf[address(this.address)] * liquidityFee) - (0 / totalFees * liquidityFee) / totalFees / 2)
                ...
                allowance[address(this.address)][stor8].field_0 = 0 / totalFees
            ...
            if not marketFee * balanceOf[address(this.address)] / totalFees:
                ...
                if not uint8(stor20.field_8):
                    if balanceOf[address(this.address)] - (marketFee * balanceOf[address(this.address)] / totalFees):
                        ...
                        if not uniswapV2RouterAddress:
                            revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[422 len 30]
                        allowance[address(this.address)][stor8].field_0 = balanceOf[address(this.address)] - (marketFee * balanceOf[address(this.address)] / totalFees)
                        ...
                        if not balanceOf[address(this.address)] - (marketFee * balanceOf[address(this.address)] / totalFees):
                            ...
                            if not 0 / totalFees:
                                ...
                                if balanceOf[address(this.address)] - (marketFee * balanceOf[address(this.address)] / totalFees) - (0 / totalFees):
                                    ...
                                    if not uniswapV2RouterAddress:
                                        revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[550 len 30]
                                    allowance[address(this.address)][stor8].field_0 = balanceOf[address(this.address)] - (marketFee * balanceOf[address(this.address)] / totalFees) - (0 / totalFees)
                            ...
                            if not (balanceOf[address(this.address)] * liquidityFee) - (marketFee * balanceOf[address(this.address)] / totalFees * liquidityFee) / totalFees:
                                ...
                                if balanceOf[address(this.address)] - (marketFee * balanceOf[address(this.address)] / totalFees) - ((balanceOf[address(this.address)] * liquidityFee) - (marketFee * balanceOf[address(this.address)] / totalFees * liquidityFee) / totalFees):
                                    ...
                                    if not uniswapV2RouterAddress:
                                        revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[550 len 30]
                                    allowance[address(this.address)][stor8].field_0 = balanceOf[address(this.address)] - (marketFee * balanceOf[address(this.address)] / totalFees) - ((balanceOf[address(this.address)] * liquidityFee) - (marketFee * balanceOf[address(this.address)] / totalFees * liquidityFee) / totalFees)
                                ...
                                if not uniswapV2RouterAddress:
                                    revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[614 len 30]
                                allowance[address(this.address)][stor8].field_0 = (balanceOf[address(this.address)] * liquidityFee) - (marketFee * balanceOf[address(this.address)] / totalFees * liquidityFee) / totalFees / 2
                                allowance[address(this.address)][stor8].field_255 = 0
                                ...
                                if not uniswapV2RouterAddress:
                                    revert with 0, 'sERC20: approve to the zero addres'
                                allowance[address(this.address)][stor8].field_0 = ((balanceOf[address(this.address)] * liquidityFee) - (marketFee * balanceOf[address(this.address)] / totalFees * liquidityFee) / totalFees) - ((balanceOf[address(this.address)] * liquidityFee) - (marketFee * balanceOf[address(this.address)] / totalFees * liquidityFee) / totalFees / 2)
                ...
                if not uniswapV2RouterAddress:
                    revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[358 len 30]
                allowance[address(this.address)][stor8].field_0 = marketFee * balanceOf[address(this.address)] / totalFees
