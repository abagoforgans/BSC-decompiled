...
function sub_11897c9a(?) payable {
    ...
    if not ext_call.success:
        if not arg1.length:
            ...
            mem[(32 * arg1.length) + 160 len 32 * arg1.length] = code.data[7069 len 32 * arg1.length]
            mem[(64 * arg1.length) + 160] = 32
            mem[(64 * arg1.length) + 192] = arg1.length
            mem[(64 * arg1.length) + 224 len floor32(arg1.length)] = code.data[7069 len floor32(arg1.length)]
        return memory
...
function sub_8db8bc90(?) payable {
    ...
    while idx <= arg1.length:
        mem[mem[64] len 552] = code.data[7069 len 552]
        create contract with 0 wei
                        code: code.data[7069 len 552]
        ...
        if idx == mem[96]:
            ...
            if not ext_call.success:
                ...
                if not _369:
                    ...
                    continue 
                mem[(32 * _162) + _154 + ceil32(return_data.size) + 64 len 32 * _369] = code.data[7069 len 32 * _369]
                require mem[(32 * _162) + _154 + ceil32(return_data.size) + 32] - 1 < mem[(32 * _162) + _154 + ceil32(return_data.size) + 32]
        ...
        if not ext_call.success:
            ...
            if not _373:
                ...
                continue 
            mem[(32 * _171) + _163 + ceil32(return_data.size) + 64 len 32 * _373] = code.data[7069 len 32 * _373]
            require mem[(32 * _171) + _163 + ceil32(return_data.size) + 32] - 1 < mem[(32 * _171) + _163 + ceil32(return_data.size) + 32]
