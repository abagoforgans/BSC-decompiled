...
function withdrawDividend() payable {
    ...
    if Mask(128, 128, (stor152 * balanceOf[address(msg.sender)]) + stor153[address(msg.sender)]) >> 128 < withdrawnDividendOf[address(msg.sender)].field_0:
        revert with 'NH{q', 17
    if (Mask(128, 128, (stor152 * balanceOf[address(msg.sender)]) + stor153[address(msg.sender)]) >> 128) - withdrawnDividendOf[address(msg.sender)].field_0 > 0:
        if withdrawnDividendOf[address(msg.sender)].field_0 > -(Mask(128, 128, (stor152 * balanceOf[address(msg.sender)]) + stor153[address(msg.sender)]) >> 128) + withdrawnDividendOf[address(msg.sender)].field_0 - 1:
            revert with 'NH{q', 17
