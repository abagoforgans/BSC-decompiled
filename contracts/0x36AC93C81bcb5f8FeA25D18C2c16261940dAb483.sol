...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if not arg1:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[520 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 31, ext_call.return_data[0]) >> 31
            call wantAddress with:
               funct uint32(stor4)
                 gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if not arg1:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 521 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 31, ext_call.return_data[0]) >> 31
