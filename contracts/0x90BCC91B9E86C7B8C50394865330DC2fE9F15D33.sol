...
function approveTokens() payable {
    ...
    while idx < stor4.length:
        ...
        mem[mem[64] + 36] = 0x8a1e9d3aebbbd5ba2a64d3355a48dd5e9b511256
        require ext_code.size(stor4[idx])
        staticcall stor4[idx].allowance(address rg1, address rg2) with:
                gas gas_remaining wei
               args address(this.address), 0x8a1e9d3aebbbd5ba2a64d3355a48dd5e9b511256
        ...
        if mem[_16] != -1:
            ...
            mem[0] = 4
            mem[mem[64] + 4] = 0x8a1e9d3aebbbd5ba2a64d3355a48dd5e9b511256
            mem[mem[64] + 36] = -1
            require ext_code.size(stor4[idx])
            call stor4[idx].approve(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args 0x8a1e9d3aebbbd5ba2a64d3355a48dd5e9b511256, -1
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _21 = mem[64]
...
function sub_ddfb3ccf(?) payable {
    ...
    if ('cd', 4).length:
        mem[128 len 32 * ('cd', 4).length] = code.data[17681 len 32 * ('cd', 4).length]
