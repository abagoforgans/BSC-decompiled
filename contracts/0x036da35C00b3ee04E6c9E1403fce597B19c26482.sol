...
#  - exit()
#
const sub_5767d534(?) = 0x55d398326f99059ff775485246999027b3197955
...
function unApprove(address arg1) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        revert with 0, 'only commander'
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0x55d398326f99059ff775485246999027b3197955):
        revert with 0, 'SafeERC20: call to non-contract'
    if not ext_code.hash(0x55d398326f99059ff775485246999027b3197955):
        revert with 0, 'SafeERC20: call to non-contract'
    mem[196 len 64] = approve(address rg1, uint256 rg2), address(arg1) << 64, 0, 0
    call 0x55d398326f99059ff775485246999027b3197955 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), address(arg1) << 64, 0, 0) << 256, mem[260 len 4]
...
function newMission(address arg1) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        revert with 0, 'only commander'
    require ext_code.size(0x55d398326f99059ff775485246999027b3197955)
    staticcall 0x55d398326f99059ff775485246999027b3197955.allowance(address rg1, address rg2) with:
            gas gas_remaining wei
