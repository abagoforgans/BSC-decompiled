...
function rewardOf(address arg1) {
    ...
    if stakeOf[address(arg1)]:
        return (stor1[address(arg1)] + ((block.timestamp * stakeOf[address(arg1)]) - (stor2[address(arg1)] * stakeOf[address(arg1)]) / 960))
    else:
        return 0
}
...
function harvest() {
    ...
    call stor14.0xae2fe633 with:
        ...
        args msg.sender, stor1[address(msg.sender)] + ((block.timestamp * stakeOf[address(msg.sender)]) - (stor2[address(msg.sender)] * stakeOf[address(msg.sender)]) / 960)
...
function _fallback() payable {
    ...
    if stakeOf[address(msg.sender)] > 0:
        stor1[address(msg.sender)] += (block.timestamp * stakeOf[address(msg.sender)]) - (stor2[address(msg.sender)] * stakeOf[address(msg.sender)]) / 960
