...
function setFeeManager(address arg1) {
    require calldata.size - 4 >= 32
    if msg.sender != 0xc2e5e94f4a0523f6fb2090f899b09d6d03886a55:
        revert with 0, 'no u bro'
    stor5 = arg1
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    if not stor5:
        ...
        call stor5.getTrueAmount(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
            args msg.sender, address(arg1), arg2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] + balanceOf[address(arg1)] < balanceOf[address(arg1)]:
            revert with 0, 'SafeMath: addition overflow'
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if not stor5:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] + balanceOf[address(arg2)] < balanceOf[address(arg2)]:
            revert with 0, 'SafeMath: addition overflow'
