...
mapping of uint256 sub_f84b4b28;
mapping of uint256 sub_fc7ec651;
address sub_97277f82Address;
uint256 stor656F;
...
function sub_97277f82(?) payable {
    return sub_97277f82Address
}
...
function sub_f84b4b28(?) payable {
    require calldata.size - 4 >= 32
    return sub_f84b4b28[arg1]
}

function sub_fc7ec651(?) payable {
    require calldata.size - 4 >= 32
    return sub_fc7ec651[arg1]
}
...
function sub_8ec98ed4(?) payable {
    ...
    stor656F -= arg2
    emit 0x64ddf252: arg2, 57005, arg1
}
...
function sub_adef155e(?) payable {
    ...
    if not stor101[stor203]:
        ...
        if (0 / arg1) + stor656F < stor656F:
            revert with 0, 'SafeMath: addition overflow'
        stor656F += 0 / arg1
        emit 0x64ddf252: (0 / arg1), sub_226d2c64Address, 57005
    else:
        ...
        emit 0x64ddf252: (-stor101[stor203] + (arg1 * stor101[stor203]) / arg1), sub_226d2c64Address, 57005
...
function sub_89ed18d7(?) payable {
    ...
    if not stor101[stor203]:
        ...
        if (0 / arg1 + 100) + stor656F < stor656F:
            revert with 0, 'SafeMath: addition overflow'
        stor656F += 0 / arg1 + 100
        emit 0x64ddf252: (0 / arg1 + 100), sub_226d2c64Address, 57005
    else:
        ...
        emit 0x64ddf252: (arg1 * stor101[stor203] / arg1 + 100), sub_226d2c64Address, 57005
    require ext_code.size(sub_226d2c64Address)
    call sub_226d2c64Address.sync() with:
         gas gas_remaining wei
    if not ext_call.success:
