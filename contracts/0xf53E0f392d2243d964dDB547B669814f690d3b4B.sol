                    ...
                    if not idx:
                        ...
                        if idx != arg2.length - 1:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_1753 + floor32(mem[_1754]) + 66] = 256^(-(mem[_1754] % 32) + 32) - 1 and mem[_1753 + floor32(mem[_1754]) + 66] or mem[_1754 + floor32(mem[_1754]) + 32] and !(256^(-(mem[_1754] % 32) + 32) - 1)
                            mem[0] = sha3(mem[_1753 + 66 len _1756])
                            mem[32] = 2
                            nextValidator[mem[0]] = 0xffffffffffffffffffffffffffffffffffffffff
                else:
                    _841 = mem[64]
