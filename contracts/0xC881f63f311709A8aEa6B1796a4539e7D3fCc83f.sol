...
function batchMint(address arg1, uint256[] arg2, uint256[] arg3, bytes arg4) {
    ...
    if this.address != msg.sender:
        ...
        mem[mem[64] + (32 * _967) + 228 len 32 * _1085] = mem[(32 * arg2.length) + 160 len 32 * _1085]
        mem[mem[64] + 132] = (32 * _967) + (32 * _1085) + 224
        _1199 = mem[(32 * arg2.length) + (32 * arg3.length) + 160]
        mem[mem[64] + (32 * _967) + (32 * _1085) + 228] = mem[(32 * arg2.length) + (32 * arg3.length) + 160]
        mem[mem[64] + (32 * _967) + (32 * _1085) + 260 len ceil32(_1199)] = mem[(32 * arg2.length) + (32 * arg3.length) + 192 len ceil32(_1199)]
        if ceil32(_1199) <= _1199:
            ...
            call arg1.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
                 gas gas_remaining wei
                args msg.sender, 0, 160, mem[mem[64] + 100], (32 * _967) + (32 * _1085) + 224, mem[mem[64] + 164 len (32 * _967) + (32 * _1085) + ceil32(_1199) + 96]
            ...
            revert with memory
              from mem[64]
               len _1359 + ceil32(_1375) + -mem[64] + 68
        mem[mem[64] + (32 * _967) + (32 * _1085) + _1199 + 260] = 0
        require ext_code.size(arg1)
        call arg1.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
             gas gas_remaining wei
            args msg.sender, 0, 160, mem[mem[64] + 100], (32 * _967) + (32 * _1085) + 224, mem[mem[64] + 164 len (32 * _967) + (32 * _1085) + ceil32(_1199) + 96]
        ...
        revert with memory
          from mem[64]
           len _1368 + ceil32(_1382) + -mem[64] + 68
    _529 = mem[64]
    mem[64] = mem[64] + ceil32(calldata.size) + 32
    ...
    mem[mem[64] + (32 * _968) + (32 * _1086) + 260 len ceil32(_1200)] = mem[(32 * arg2.length) + (32 * arg3.length) + 192 len ceil32(_1200)]
    if ceil32(_1200) <= _1200:
        require ext_code.size(arg1)
        call arg1.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
             gas gas_remaining wei
            args address(_530), 0, 160, mem[mem[64] + 100 len (32 * _968) + (32 * _1086) + ceil32(_1200) + 160]
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            _1314 = mem[64]
            mem[64] = mem[64] + ceil32(return_data.size)
    ...
    mem[mem[64] + (32 * _968) + (32 * _1086) + _1200 + 260] = 0
    require ext_code.size(arg1)
    call arg1.onERC1155BatchReceived(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) with:
         gas gas_remaining wei
        args address(_530), 0, 160, mem[mem[64] + 100 len (32 * _968) + (32 * _1086) + ceil32(_1200) + 160]
