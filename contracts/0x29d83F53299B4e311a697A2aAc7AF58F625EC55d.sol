...
function sub_5b3a7b35(?) payable {
    ...
    if address(cd[36]) != 4100:
        ...
        while idx < _572:
            ...
            if idx <= 0:
                ...
                staticcall address(_580).allowance(address rg1, address rg2) with:
                        gas gas_remaining wei
    ...
    while idx < _573:
        ...
        if idx <= 0:
            ...
            staticcall address(_582).allowance(address rg1, address rg2) with:
                    gas gas_remaining wei
    ...
    if not s:
        ...
        if address(cd[68]) == 4100:
            ...
            call address(cd[68]).transfer(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args msg.sender, s
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
