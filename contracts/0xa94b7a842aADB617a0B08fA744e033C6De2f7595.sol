...
function sub_decd3f2a(?) payable {
    if totalSupply > 5 * 10^13:
        return 0
    return 1
}
        ...
        if totalSupply <= 5 * 10^13:
            ...
            if not mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent:
                ...
                if not mem[(32 * idx) + (32 * arg1.length) + 160] + basePercent - 1 / basePercent * basePercent:
                    ...
                    emit Transfer(mem[(32 * arg1.length) + (32 * arg2.length) + 160], msg.sender, address(_41));
                    mem[(32 * arg1.length) + (32 * arg2.length) + 160] = _43 + basePercent - 1 / basePercent * basePercent * basePercent / 5000
                    emit Transfer((_43 + basePercent - 1 / basePercent * basePercent * basePercent / 5000), msg.sender, 0);
        idx = idx + 1
        continue 
}
