        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    call snowAddress.mint(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        require block.number - poolInfo[arg1].field_512
                        if (block.number * snowPerBlock) - (poolInfo[arg1].field_512 * snowPerBlock) / block.number - poolInfo[arg1].field_512 != snowPerBlock:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (block.number * snowPerBlock) - (poolInfo[arg1].field_512 * snowPerBlock):
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            require ext_code.size(snowAddress)
                            ...
                            require (block.number * snowPerBlock) - (poolInfo[arg1].field_512 * snowPerBlock)
                            if (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / (block.number * snowPerBlock) - (poolInfo[arg1].field_512 * snowPerBlock) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            ...
                            call snowAddress.mint(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(snowAddress)
                            call snowAddress.mint(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args address(this.address), (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                ...
                                require (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if 10^12 * (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function sub_dd62ab30(?) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * snowPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * snowPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            revert with memory
              from mem[64]
               len _261 + -mem[64] + 100
        require block.number - poolInfo[idx].field_512
        if (block.number * snowPerBlock) - (poolInfo[idx].field_512 * snowPerBlock) / block.number - poolInfo[idx].field_512 != snowPerBlock:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * snowPerBlock) - (poolInfo[idx].field_512 * snowPerBlock):
            _184 = mem[64]
            mem[64] = mem[64] + 64
            mem[_184] = 26
            ...
            revert with memory
              from mem[64]
               len _277 + -mem[64] + 100
        require (block.number * snowPerBlock) - (poolInfo[idx].field_512 * snowPerBlock)
        if (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / (block.number * snowPerBlock) - (poolInfo[idx].field_512 * snowPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _191 = mem[64]
        mem[64] = mem[64] + 64
        mem[_191] = 26
        ...
        call snowAddress.mint(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args devaddr, (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(snowAddress)
        call snowAddress.mint(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args address(this.address), (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _256 = mem[64]
            mem[64] = mem[64] + 64
            mem[_256] = 26
            ...
            revert with memory
              from mem[64]
               len _274 + -mem[64] + 100
        require (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^12 * (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _273 = mem[64]
        mem[64] = mem[64] + 64
        mem[_273] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^12 * (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * snowPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * snowPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _292 = mem[64]
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if -userInfo[arg1][address(msg.sender)].field_256 <= 0:
                ...
                require ext_code.size(snowAddress)
                staticcall snowAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
