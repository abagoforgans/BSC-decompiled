    ...
    if arg1 <= ext_call.return_data[0]:
        ...
        if not wantLockedTotal:
            ...
            if 0 / wantLockedTotal <= sharesTotal:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor5), uint32(stor5), Mask(224, 0, stor10.field_32)
                call wantAddress with:
                   funct uint32(stor5)
                     gas gas_remaining wei
...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if wantLockedTotal <= 0:
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 31, ext_call.return_data[0]) >> 31
            call wantAddress with:
               funct uint32(stor4)
                 gas gas_remaining wei
        ...
        if not arg1:
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[584 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 31, ext_call.return_data[0]) >> 31
            call wantAddress with:
               funct uint32(stor4)
                 gas gas_remaining wei
        ...
        if return_data.size <= 0:
            if wantLockedTotal <= 0:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 31, ext_call.return_data[0]) >> 31
            ...
            if not arg1:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 585 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 31, ext_call.return_data[0]) >> 31
            ...
            if not arg1 * sharesTotal:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                return (0 / wantLockedTotal / entranceFeeFactorMax)
        ('iszero', ('iszero', ('mul', ('param', 'arg1'), ('stor', ('name', 'sharesTotal', 11)))))
        require arg1 * sharesTotal
        if arg1 * sharesTotal * entranceFeeFactor / arg1 * sharesTotal != entranceFeeFactor:
            revert with 0, 
                        32,
