...
#
const name = 'MetaPay', 0

const InitialSupply = 10^16

const decimals = 8

const TeamWallet = 0x33a531330fc84829a56a250b9126766c02b55581

const symbol = 'METAPAY', 0
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x33a531330fc84829a56a250b9126766c02b55581 with:
