...
function betBear(uint256 arg1) payable {
    ...
    if msg.value < minBetAmount:
        revert with 0, 'Bet amount must be greater than minBetAmount'
...
function betBull(uint256 arg1) payable {
    ...
    if msg.value < minBetAmount:
        staticcall 'console.log'.log(string arg1) with:
                gas gas_remaining wei
               args 0, 'LogMinBetAmountLarger', 0
        emit 0xed395714: msg.value, minBetAmount
    else:
        staticcall 'console.log'.log(string arg1) with:
                gas gas_remaining wei
               args 0, 'LogMsgValueLarger', 0
        emit 0x47fffbdc: msg.value, minBetAmount
