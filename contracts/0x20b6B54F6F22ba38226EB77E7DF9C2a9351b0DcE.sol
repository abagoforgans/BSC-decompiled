...
array of uint256 stor67072331549493647622825787457569556318728415786901242217649037894484240406166;
...
function changeRuleAddress(uint256 arg1, address arg2) payable {
    ...
    address(stor25[arg1].field_0) = arg2
}
...
function sub_eabe98e4(?) payable {
    ...
    while idx < arg2.length:
        ...
        mem[32] = 30
        require idx < arg2.length
        uint256(stor30[arg1].field_0)++
        mem[0] = sha3(arg1, 30)
        address(stor30[arg1][uint256(stor30[arg1].field_0)].field_0) = mem[(32 * idx) + 140 len 20]
        idx = idx + 1
        continue 
}
...
function sub_f18e9af4(?) payable {
    ...
    idx = 96
    while 224 > idx:
        uint256(stor25[arg1].field_256) = mem[idx + 31 len 1] * 256^s or !(255 * 256^s) and uint256(stor25[arg1].field_256)
...
function removeExcluded(uint256 arg1, address arg2) payable {
    ...
    if not arg2:
        revert with 0, 'tZero address not allowed'
    idx = 0
    while idx < uint256(stor30[arg1].field_0):
        mem[32] = 30
        require idx < uint256(stor30[arg1].field_0)
        mem[0] = sha3(arg1, 30)
        if address(stor30[arg1][idx].field_0) == arg2:
            require uint256(stor30[arg1].field_0) - 1 < uint256(stor30[arg1].field_0)
            require idx < uint256(stor30[arg1].field_0)
            address(stor30[arg1][idx].field_0) = address(stor30[arg1][uint256(stor30[arg1].field_0)].field_0)
            mem[32] = 30
            require uint256(stor30[arg1].field_0)
            mem[0] = sha3(arg1, 30)
            address(stor30[arg1][uint256(stor30[arg1].field_0)].field_0) = 0
            uint256(stor30[arg1].field_0)--
        idx = idx + 1
        continue 
}
...
function getExcluded(uint256 arg1) payable {
    ...
    if arg1 >= 4:
        revert with 0, 'Wrong index'
    if not uint256(stor30[arg1].field_0):
        mem[(32 * uint256(stor30[arg1].field_0)) + 128] = 32
        mem[(32 * uint256(stor30[arg1].field_0)) + 160] = uint256(stor30[arg1].field_0)
        mem[(32 * uint256(stor30[arg1].field_0)) + 192 len floor32(uint256(stor30[arg1].field_0))] = mem[128 len floor32(uint256(stor30[arg1].field_0))]
        return memory
          from (32 * uint256(stor30[arg1].field_0)) + 128
           len (96 * uint256(stor30[arg1].field_0)) + 64
    mem[128] = address(stor30[arg1].field_0)
    idx = 128
    s = 0
    while (32 * uint256(stor30[arg1].field_0)) + 96 > idx:
        mem[idx + 32] = address(stor30[arg1][s].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[(32 * uint256(stor30[arg1].field_0)) + 192 len floor32(uint256(stor30[arg1].field_0))] = mem[128 len floor32(uint256(stor30[arg1].field_0))]
    return Array(len=uint256(stor30[arg1].field_0), data=mem[128 len floor32(uint256(stor30[arg1].field_0))], mem[(32 * uint256(stor30[arg1].field_0)) + floor32(uint256(stor30[arg1].field_0)) + 192 len (32 * uint256(stor30[arg1].field_0)) - floor32(uint256(stor30[arg1].field_0))]), 
}
...
function sub_94b3241e(?) payable {
    ...
    idx = 96
    while 224 > idx:
        stor9449[stor25.length] = mem[idx + 31 len 1] * 256^s or !(255 * 256^s) and stor9449[stor25.length]
        s = s + -(s + 1 / 32) + (-1 * s * s + 1 / 32) + 1
        idx = idx + 32
        continue 
    idx = 4
    s = (3 * stor25.length) - 0x6bb667d8c1b884b6aebb04786b36ebe680c334b941d6ff0b96702f108bc3696a
    while idx:
        uint256(stor[s]) = !(255 * 256^idx) and uint256(stor[s])
        idx = idx + -(idx + 1 / 32) + (-1 * idx * idx + 1 / 32) + 1
        s = (idx + 1 / 32) + s
        continue 
    idx = (3 * stor25.length) + (-2 * None + 3 / 32) + (None * None + 3 / 32) - 0x6bb667d8c1b884b6aebb04786b36ebe680c334b941d6ff0b96702f108bc3696a
    while (3 * stor25.length) - 0x6bb667d8c1b884b6aebb04786b36ebe680c334b941d6ff0b96702f108bc36969 > idx:
        uint8(stor[idx]) = 0
        idx = idx + 1
        continue 
    uint256(stor[sha3((3 * stor25.length) - 0x6bb667d8c1b884b6aebb04786b36ebe680c334b941d6ff0b96702f108bc36969)][]) = Array(len=arg2.length, data=arg2[all])
...
function getRule(uint256 arg1) payable {
    ...
    require arg1 < stor25.length
    mem[224] = uint8(stor25[arg1].field_256)
    idx = 224
    s = 0
    while 352 > idx + 32:
        mem[idx + 32] = stor((3 * arg1) + ('name', 'stor25', 25) + 1)[-(0.03125 / s + 1) + s + (-1 * 0.03125 / s + 1 * s) + 1]
        idx = idx + 32
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        continue 
    mem[64] = ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 384
    mem[352] = stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length
    mem[0] = (3 * arg1) + sha3(25) + 2
    mem[384] = uint256(stor[sha3((3 * arg1) + ('name', 'stor25', 25) + 2)].field_0)
    idx = 384
    s = 0
    while stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length + 352 > idx:
        mem[idx + 32] = uint256(stor[s + sha3((3 * arg1) + ('name', 'stor25', 25) + 2)].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 384] = address(stor25[arg1].field_0)
    mem[ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 416 len 128] = uint8(stor25[arg1].field_256), mem[256 len 96]
    mem[ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 544] = 192
    mem[ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 576] = stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length
    mem[ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 608 len ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length)] = mem[384 len ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length)]
    if not stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length % 32:
        return address(stor25[arg1].field_0), 
               mem[256 len 96] >> 768,
               192,
               stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length,
               mem[384 len stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length]
    mem[floor32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 608] = mem[floor32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + -stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length % 32 + 640 len stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length % 32]
    return address(stor25[arg1].field_0), 
           mem[256 len 96] >> 768,
           192,
           stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length,
           mem[384 len ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length)],
           mem[(2 * ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length)) + 608 len floor32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + -ceil32(stor[(3 * arg1) + ('name', 'stor25', 25) + 2].length) + 32]
}
    ...
    while idx < 4:
        if mem[(32 * idx) + 127 len 1]:
            ...
            if sub_3e4661a5[idx] != block.timestamp:
                ...
                mem[32] = 30
                s = 0
                while s < uint256(stor30[idx].field_0):
                    require idx < 4
                    mem[32] = 30
                    require s < uint256(stor30[idx].field_0)
                    mem[0] = sha3(idx, 30)
                    mem[356] = address(stor30[idx][s].field_0)
                    require ext_code.size(sub_a30fb020[idx])
                    staticcall sub_a30fb020[idx].0x70a08231 with:
                            gas gas_remaining wei
                           args address(stor30[idx][s].field_0)
                    ...
                    if sub_57eaef05[idx]:
                        require s < uint256(stor30[idx].field_0)
                        mem[0] = address(stor30[idx][s].field_0)
                        mem[32] = sha3(idx, 29)
                        if stor29[idx][address(stor30[idx][s].field_0)]:
                            require idx < 4
                            mem[32] = 30
                            require s < uint256(stor30[idx].field_0)
                            mem[0] = sha3(idx, 30)
...
function getBallot(uint256 arg1) payable {
    ...
    mem[224 len 128] = call.data[calldata.size len 128]
    require arg1 < participantsNumber.length
    mem[352] = stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length
    mem[0] = (17 * arg1) + sha3(26) + 2
    mem[384] = uint256(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 2)].field_0)
    idx = 384
    s = 0
    while stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length + 352 > idx:
        mem[idx + 32] = uint256(stor[s + sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 2)].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 384] = uint256(participantsNumber[arg1].field_2048)
    idx = ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 384
    s = (17 * arg1) + 8
    while ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 512 > idx + 32:
        mem[idx + 32] = uint256(participantsNumber[s].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[64] = ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 640
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 512] = uint256(participantsNumber[arg1].field_1024)
    idx = ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 512
    s = (17 * arg1) + 4
    while ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 640 > idx + 32:
        mem[idx + 32] = uint256(participantsNumber[s].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 640] = uint256(participantsNumber[arg1].field_0)
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 672] = uint256(participantsNumber[arg1].field_256)
    require uint8(participantsNumber[arg1].field_768) <= 4
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 736] = uint8(participantsNumber[arg1].field_768)
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 768] = address(participantsNumber[arg1].field_776)
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 800 len 128] = uint256(participantsNumber[arg1].field_2048), mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 416 len 96]
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 928 len 128] = uint256(participantsNumber[arg1].field_1024), mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 544 len 96]
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 704] = 416
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 1056] = stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length
    mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 1088 len ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length)] = mem[384 len ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length)]
    if not stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length % 32:
        return uint256(participantsNumber[arg1].field_0), 
               ...
               mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 416 len 96] >> 768,
               mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 544 len 96] >> 768,
               stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length,
               mem[384 len stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length]
    mem[floor32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 1088] = mem[floor32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + -stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length % 32 + 1120 len stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length % 32]
    return uint256(participantsNumber[arg1].field_0), 
           uint256(participantsNumber[arg1].field_256),
           416,
           uint8(participantsNumber[arg1].field_768),
           ...
           mem[ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 544 len 96] >> 768,
           stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length,
           mem[384 len ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length)],
           mem[(2 * ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length)) + 1088 len floor32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + -ceil32(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 2].length) + 32]
}
...
function vote(uint256 arg1, uint8 arg2) payable {
    ...
    mem[96 len 128] = call.data[calldata.size len 128]
    require uint256(participantsNumber[arg1].field_256) < stor25.length
    mem[224] = uint8(stor25[uint256(stor26[arg1].field_256)].field_256)
    mem[256] = uint8(stor25[uint256(stor26[arg1].field_256)].field_264)
    idx = 256
    s = 1
    while 352 > idx + 32:
        mem[idx + 32] = stor(('name', 'stor25', 25) + (3 * Mask(256, 256, stor[('array', ('mul', 17, ('param', 'arg1')), ('name', 'stor26', 26))])) + 1)[-(0.03125 / s + 1) + s + (-1 * 0.03125 / s + 1 * s) + 1]
        idx = idx + 32
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        continue 
    ...
    if stor28[address(ext_call.return_data[0])]:
    ...
    if not address(ext_call.return_data[0]):
            ...
            if not sub_57eaef05[idx]:
                ...
                while t < _1106:
                    ...
                    if sub_57eaef05[idx]:
                        ...
                        mem[32] = sha3(idx, 29)
                        if stor29[idx][mem[(32 * t) + 524 len 20]]:
                            require idx < 4
                            require t < mem[480]
                            _1347 = mem[(32 * t) + 512]
                            mem[516] = mem[(32 * t) + 524 len 20]
                ...
                mem[0] = msg.sender
                mem[32] = sha3(idx, 29)
                if not stor29[idx][address(msg.sender)]:
                    _1107 = mem[480]
                    t = 0
                    while t < _1107:
                        require idx < 4
        ...
        require uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(msg.sender)].field_0) <= 2
        if uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(msg.sender)].field_0):
            require arg2 <= 2
            require uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(msg.sender)].field_0) <= 2
            if uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(msg.sender)].field_0) != arg2:
                require arg2 <= 2
                uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(msg.sender)].field_0) = arg2
                idx = 0
                while idx < 4:
                    if mem[(32 * idx) + 352] > 0:
                        require arg2 <= 2
                        require idx < 4
                        if arg2 != 1:
                            uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_1024) -= uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(msg.sender)][idx].field_0)
                        else:
                            uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_1024) += mem[(32 * idx) + 352]
                        uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_2048) = uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_2048) + mem[(32 * idx) + 352] - uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(msg.sender)][idx].field_0)
                        mem[0] = idx
                        mem[32] = sha3(address(msg.sender), (17 * arg1) + sha3(26) + 15)
                        uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(msg.sender)][idx].field_0) = mem[(32 * idx) + 352]
                    idx = idx + 1
                    continue 
                emit ChangeVote(msg.sender, msg.sender, arg1);
            require uint256(participantsNumber[arg1].field_256) < stor25.length
            mem[512] = uint8(stor25[uint256(stor26[arg1].field_256)].field_256)
            idx = 512
            s = 0
            while 640 > idx + 32:
                mem[idx + 32] = stor(('name', 'stor25', 25) + (3 * Mask(256, 256, stor[('array', ('mul', 17, ('param', 'arg1')), ('name', 'stor26', 26))])) + 1)[-(0.03125 / s + 1) + s + (-1 * 0.03125 / s + 1 * s) + 1]
            ...
            address(stor[uint256(participantsNumber[arg1].field_3072) + sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12)].field_0) = msg.sender
            require arg2 <= 2
            uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(msg.sender)].field_0) = arg2
            idx = 0
            while idx < 4:
                if mem[(32 * idx) + 352] > 0:
                    ...
                    mem[32] = sha3(address(msg.sender), (17 * arg1) + sha3(26) + 15)
                    uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(msg.sender)][idx].field_0) = mem[(32 * idx) + 352]
                    uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_2048) += mem[(32 * idx) + 352]
                    require arg2 <= 2
                    if arg2 == 1:
                        require idx < 4
                        uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_1024) += mem[(32 * idx) + 352]
                ...
                continue 
            require uint256(participantsNumber[arg1].field_256) < stor25.length
            if uint8(stor25[uint256(stor26[arg1].field_256)].field_256) < sub_66987206:
                ...
                t = 0
                while 640 > s + 32:
                    mem[s + 32] = stor(('name', 'stor25', 25) + (3 * Mask(256, 256, stor[('array', ('mul', 17, ('param', 'arg1')), ('name', 'stor26', 26))])) + 1)[-(0.03125 / t + 1) + t + (-1 * 0.03125 / t + 1 * t) + 1]
                    s = s + 32
        ...
        require return_data.size >= 32
        _380 = mem[480 len 4], address(ext_call.return_data[0]) << 64
        ...
        _397 = mem[_380 + 480]
        mem[ceil32(return_data.size) + 512 len floor32(mem[_380 + 480])] = mem[_380 + 512 len floor32(mem[_380 + 480])]
        idx = 0
        s = 0
        while idx < 4:
            if not mem[(32 * idx) + 255 len 1]:
                ...
                continue 
            require idx < 4
            mem[(32 * _397) + ceil32(return_data.size) + 516] = address(ext_call.return_data[0])
            require ext_code.size(sub_a30fb020[idx])
            staticcall sub_a30fb020[idx].0x70a08231 with:
                    gas gas_remaining wei
                   args address(ext_call.return_data[0])
            mem[(32 * _397) + ceil32(return_data.size) + 512] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require idx < 4
            ...
            require idx < 4
            if not sub_57eaef05[idx]:
                _1497 = mem[ceil32(return_data.size) + 480]
                t = 0
                while t < _1497:
                    require idx < 4
                    require t < mem[ceil32(return_data.size) + 480]
                    _1532 = mem[(32 * t) + ceil32(return_data.size) + 512]
                    mem[(32 * _397) + ceil32(return_data.size) + 516] = mem[(32 * t) + ceil32(return_data.size) + 524 len 20]
                    require ext_code.size(sub_a30fb020[idx])
                    staticcall sub_a30fb020[idx].0x70a08231 with:
                            gas gas_remaining wei
                           args address(_1532)
                    ...
                    if sub_57eaef05[idx]:
                        ...
                        mem[32] = sha3(idx, 29)
                        if stor29[idx][mem[(32 * t) + ceil32(return_data.size) + 524 len 20]]:
                            require idx < 4
                            require t < mem[ceil32(return_data.size) + 480]
                            _1670 = mem[(32 * t) + ceil32(return_data.size) + 512]
                            mem[(32 * _397) + ceil32(return_data.size) + 516] = mem[(32 * t) + ceil32(return_data.size) + 524 len 20]
                            require ext_code.size(sub_57eaef05[idx])
                            staticcall sub_57eaef05[idx].0x70a08231 with:
                                    gas gas_remaining wei
                ...
                mem[0] = address(ext_call.return_data[0])
                mem[32] = sha3(idx, 29)
                if not stor29[idx][address(ext_call.return_data[0])]:
                    _1498 = mem[ceil32(return_data.size) + 480]
                    t = 0
                    while t < _1498:
                        require idx < 4
                        require t < mem[ceil32(return_data.size) + 480]
                        _1535 = mem[(32 * t) + ceil32(return_data.size) + 512]
                        mem[(32 * _397) + ceil32(return_data.size) + 516] = mem[(32 * t) + ceil32(return_data.size) + 524 len 20]
                        require ext_code.size(sub_a30fb020[idx])
                        staticcall sub_a30fb020[idx].0x70a08231 with:
                                gas gas_remaining wei
                        ...
                        if sub_57eaef05[idx]:
                            ...
                            if stor29[idx][mem[(32 * t) + ceil32(return_data.size) + 524 len 20]]:
                                require idx < 4
                                require t < mem[ceil32(return_data.size) + 480]
                                _1673 = mem[(32 * t) + ceil32(return_data.size) + 512]
                                mem[(32 * _397) + ceil32(return_data.size) + 516] = mem[(32 * t) + ceil32(return_data.size) + 524 len 20]
                                require ext_code.size(sub_57eaef05[idx])
                                staticcall sub_57eaef05[idx].0x70a08231 with:
                                        gas gas_remaining wei
                    ...
                    require idx < 4
                    mem[(32 * idx) + 352] = ext_call.return_data[0] + mem[(32 * idx) + 352]
                    _1499 = mem[ceil32(return_data.size) + 480]
                    t = 0
                    while t < _1499:
                        require idx < 4
                        require t < mem[ceil32(return_data.size) + 480]
                        _1538 = mem[(32 * t) + ceil32(return_data.size) + 512]
                        mem[(32 * _397) + ceil32(return_data.size) + 516] = mem[(32 * t) + ceil32(return_data.size) + 524 len 20]
                        require ext_code.size(sub_a30fb020[idx])
                        staticcall sub_a30fb020[idx].0x70a08231 with:
                                gas gas_remaining wei
                        ...
                        if sub_57eaef05[idx]:
                            ...
                            if stor29[idx][mem[(32 * t) + ceil32(return_data.size) + 524 len 20]]:
                                require idx < 4
                                require t < mem[ceil32(return_data.size) + 480]
                                _1676 = mem[(32 * t) + ceil32(return_data.size) + 512]
                                mem[(32 * _397) + ceil32(return_data.size) + 516] = mem[(32 * t) + ceil32(return_data.size) + 524 len 20]
                                require ext_code.size(sub_57eaef05[idx])
                                staticcall sub_57eaef05[idx].0x70a08231 with:
                                        gas gas_remaining wei
        ...
        if not s:
            revert with 0, 'No voting power'
        require uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(ext_call.return_data[0])].field_0) <= 2
        if uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(ext_call.return_data[0])].field_0):
            require arg2 <= 2
            require uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(ext_call.return_data[0])].field_0) <= 2
            if uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(ext_call.return_data[0])].field_0) != arg2:
                require arg2 <= 2
                uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(ext_call.return_data[0])].field_0) = arg2
                idx = 0
                while idx < 4:
                    if mem[(32 * idx) + 352] > 0:
                        require arg2 <= 2
                        require idx < 4
                        if arg2 != 1:
                            uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_1024) -= uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(ext_call.return_data[0])][idx].field_0)
                        else:
                            uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_1024) += mem[(32 * idx) + 352]
                        uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_2048) = uint256(stor[idx + (17 * arg1) + ('name', 'participantsNumber', 26)].field_2048) + mem[(32 * idx) + 352] - uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(ext_call.return_data[0])][idx].field_0)
                        mem[0] = idx
                        mem[32] = sha3(address(ext_call.return_data[0]), (17 * arg1) + sha3(26) + 15)
                        uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(ext_call.return_data[0])][idx].field_0) = mem[(32 * idx) + 352]
                    idx = idx + 1
                    continue 
                emit ChangeVote(msg.sender, address(ext_call.return_data[0]), arg1);
            require uint256(participantsNumber[arg1].field_256) < stor25.length
            mem[(32 * _397) + ceil32(return_data.size) + 512] = uint8(stor25[uint256(stor26[arg1].field_256)].field_256)
            idx = (32 * _397) + ceil32(return_data.size) + 512
            s = 0
            while (32 * _397) + ceil32(return_data.size) + 640 > idx + 32:
                mem[idx + 32] = stor(('name', 'stor25', 25) + (3 * Mask(256, 256, stor[('array', ('mul', 17, ('param', 'arg1')), ('name', 'stor26', 26))])) + 1)[-(0.03125 / s + 1) + s + (-1 * 0.03125 / s + 1 * s) + 1]
                idx = idx + 32
                s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
                continue 
            mem[(32 * _397) + ceil32(return_data.size) + 640] = uint256(participantsNumber[arg1].field_1024)
            idx = (32 * _397) + ceil32(return_data.size) + 640
            s = (17 * arg1) + 4
            while (32 * _397) + ceil32(return_data.size) + 768 > idx + 32:
                mem[idx + 32] = uint256(participantsNumber[s].field_256)
                idx = idx + 32
                s = s + 1
                continue 
            ...
            uint256(participantsNumber[arg1].field_3072)++
            address(stor[uint256(participantsNumber[arg1].field_3072) + sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12)].field_0) = address(ext_call.return_data[0])
            require arg2 <= 2
            uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(ext_call.return_data[0])].field_0) = arg2
            idx = 0
            while idx < 4:
            ...
            if uint8(stor25[uint256(stor26[arg1].field_256)].field_256) < sub_66987206:
                ...
                require uint256(participantsNumber[arg1].field_256) < stor25.length
                mem[(32 * _397) + ceil32(return_data.size) + 512] = uint8(stor25[uint256(stor26[arg1].field_256)].field_256)
                s = (32 * _397) + ceil32(return_data.size) + 512
                t = 0
                while (32 * _397) + ceil32(return_data.size) + 640 > s + 32:
                    mem[s + 32] = stor(('name', 'stor25', 25) + (3 * Mask(256, 256, stor[('array', ('mul', 17, ('param', 'arg1')), ('name', 'stor26', 26))])) + 1)[-(0.03125 / t + 1) + t + (-1 * 0.03125 / t + 1 * t) + 1]
                    s = s + 32
                    t = -(t + 1 / 32) + t + (-1 * t + 1 / 32 * t) + 1
                    continue 
                mem[(32 * _397) + ceil32(return_data.size) + 640] = uint256(participantsNumber[arg1].field_1024)
                s = (32 * _397) + ceil32(return_data.size) + 640
                t = (17 * arg1) + 4
                while (32 * _397) + ceil32(return_data.size) + 768 > s + 32:
                    mem[s + 32] = uint256(participantsNumber[t].field_256)
                    s = s + 32
                    t = t + 1
                    continue 
                ...
                while (32 * _397) + ceil32(return_data.size) + 768 > idx + 32:
                    ...
                    s = s + 1
                    continue 
        mem[(32 * _397) + ceil32(return_data.size) + 768] = uint256(participantsNumber[arg1].field_2048)
        idx = (32 * _397) + ceil32(return_data.size) + 768
        s = (17 * arg1) + 8
        while (32 * _397) + ceil32(return_data.size) + 896 > idx + 32:
            mem[idx + 32] = uint256(participantsNumber[s].field_256)
            idx = idx + 32
            s = s + 1
            continue 
        ...
        t = 0
        while idx < 4:
            if not mem[(32 * idx) + (32 * _397) + ceil32(return_data.size) + 543 len 1]:
                idx = idx + 1
                s = s
                t = t
                continue 
            require idx < 4
            if 2 * mem[(32 * idx) + (32 * _397) + ceil32(return_data.size) + 640] > sub_30eba8de[idx]:
                idx = idx + 1
                s = s + 1
                t = t + 1
                continue 
...
function getParticipants(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if not arg3:
        ...
        if not arg3:
            ...
            if not arg3:
                    ...
                    if not arg3:
                        if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
                            ...
                            while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
                                ...
                                require idx < mem[96]
                                mem[(32 * idx) + 128] = address(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12) + arg2 + idx].field_0)
                                require idx < mem[96]
                                require idx < mem[(32 * arg3) + 128]
                                mem[(32 * idx) + (32 * arg3) + 160] = uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12) + arg2 + idx].field_0)][0].field_0)
                                require idx < mem[96]
                                require idx < mem[(64 * arg3) + 160]
                                mem[(32 * idx) + (64 * arg3) + 192] = uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12) + arg2 + idx].field_0)][1].field_0)
                                require idx < mem[96]
                                require idx < mem[(98 * arg3) + 192]
                                mem[(32 * idx) + (98 * arg3) + 224] = uint256(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 15][address(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12) + arg2 + idx].field_0)][2].field_0)
                                require idx < mem[96]
                                mem[0] = address(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12) + arg2 + idx].field_0)
                                mem[32] = (17 * arg1) + sha3(26) + 14
                                require idx < mem[(131 * arg3) + 224]
                                require uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12) + arg2 + idx].field_0)].field_0) <= 2
                                mem[(32 * idx) + (131 * arg3) + 256] = uint8(stor[(17 * arg1) + ('name', 'participantsNumber', 26) + 14][address(stor[sha3((17 * arg1) + ('name', 'participantsNumber', 26) + 12) + arg2 + idx].field_0)].field_0)
                                idx = idx + 1
                                continue 
                        ...
                        return 160, mem[mem[64] + 32 len (32 * _7010) + (32 * _6498) + (32 * _5794) + (32 * _4898) + (32 * _2467) + 288]
                ...
                if not arg3:
                    ...
                    mem[(32 * _5806) + (32 * _4910) + (32 * _2487) + mem[64] + 256] = mem[(98 * arg3) + 192]
                    _6510 = mem[(98 * arg3) + 192]
                    mem[(32 * _5806) + (32 * _4910) + (32 * _2487) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
                    mem[mem[64] + 128] = (32 * _6510) + (32 * _5806) + (32 * _4910) + (32 * _2487) + 288
                    ...
                    return 160, 
                           ...
                           (32 * _6510) + (32 * _5806) + (32 * _4910) + (32 * _2487) + 288,
                           mem[mem[64] + 160 len (32 * _7022) + (32 * _6510) + (32 * _5806) + (32 * _4910) + (32 * _2487) + 160]
                mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
                if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
                    idx = 0
                    while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
            ...
            if not arg3:
                ...
                mem[(32 * _5824) + (32 * _4928) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
            ...
            if not arg3:
                ...
                mem[(32 * _5830) + (32 * _4934) + (32 * _2527) + mem[64] + 256] = mem[(98 * arg3) + 192]
            ...
            mem[(32 * _5836) + (32 * _4940) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
            _6540 = mem[(98 * arg3) + 192]
            mem[(32 * _5836) + (32 * _4940) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
            mem[mem[64] + 128] = (32 * _6540) + (32 * _5836) + (32 * _4940) + (32 * mem[96]) + 288
            ...
            return 160, mem[mem[64] + 32 len (32 * _7052) + (32 * _6540) + (32 * _5836) + (32 * _4940) + (32 * _2537) + 288]
        ...
        if not arg3:
            ...
            if not arg3:
                ...
                if not arg3:
                    ...
                    return 160, mem[mem[64] + 32 len (32 * _7058) + (32 * _6546) + (32 * _5842) + (32 * _4946) + (32 * _2547) + 288]
                mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
                if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
                    idx = 0
                    while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
                    ...
                    mem[(32 * mem[(98 * arg3) + 192]) + (32 * _5851) + (32 * mem[(32 * arg3) + 128]) + (32 * mem[96]) + (164 * arg3) + 576 len floor32(mem[(131 * arg3) + 224])] = mem[(131 * arg3) + 256 len floor32(mem[(131 * arg3) + 224])]
                    return 160, 
                ...
                mem[(32 * _5848) + (32 * _4952) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
                _6552 = mem[(98 * arg3) + 192]
                mem[(32 * _5848) + (32 * _4952) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
                mem[mem[64] + 128] = (32 * _6552) + (32 * _5848) + (32 * _4952) + (32 * mem[96]) + 288
                ...
                return 160, mem[mem[64] + 32 len (32 * _7064) + (32 * _6552) + (32 * _5848) + (32 * _4952) + (32 * _2557) + 288]
            mem[(98 * arg3) + 224 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
            require arg3 <= test266151307()
            mem[(131 * arg3) + 224] = arg3
            mem[64] = (164 * arg3) + 256
            ...
            mem[(32 * _5860) + (32 * _4964) + (32 * _2577) + mem[64] + 256] = mem[(98 * arg3) + 192]
        ...
        if not arg3:
            ...
            if not arg3:
                ...
                return 160, mem[mem[64] + 32 len (32 * _7082) + (32 * _6570) + (32 * _5866) + (32 * _4970) + (32 * _2587) + 288]
            mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
            if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
                idx = 0
                while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
        ...
        if not arg3:
            ...
            mem[(32 * _5878) + (32 * _4982) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
            _6582 = mem[(98 * arg3) + 192]
            mem[(32 * _5878) + (32 * _4982) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
            mem[mem[64] + 128] = (32 * _6582) + (32 * _5878) + (32 * _4982) + (32 * mem[96]) + 288
            ...
            return 160, mem[mem[64] + 32 len (32 * _7094) + (32 * _6582) + (32 * _5878) + (32 * _4982) + (32 * _2607) + 288]
        mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
        if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
            idx = 0
            while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
        ...
        mem[(32 * _5884) + (32 * _4988) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
        mem[mem[64] + 128] = (32 * _6588) + (32 * _5884) + (32 * _4988) + (32 * mem[96]) + 288
        ...
        return 160, mem[mem[64] + 32 len (32 * _7100) + (32 * _6588) + (32 * _5884) + (32 * _4988) + (32 * _2617) + 288]
    ...
    if not arg3:
        ...
        if not arg3:
            ...
            if not arg3:
                ...
                if not arg3:
                    ...
                    mem[(32 * _5890) + (32 * _4994) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
                    mem[mem[64] + 128] = (32 * _6594) + (32 * _5890) + (32 * _4994) + (32 * mem[96]) + 288
                ...
                mem[(32 * _5896) + (32 * _5000) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
            ...
            if not arg3:
                ...
                return 160, mem[mem[64] + 32 len (32 * _7118) + (32 * _6606) + (32 * _5902) + (32 * _5006) + (32 * _2647) + 288]
            mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
            if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
                idx = 0
                while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
            ...
            mem[(32 * _5908) + (32 * _5012) + (32 * _2657) + mem[64] + 256] = mem[(98 * arg3) + 192]
            _6612 = mem[(98 * arg3) + 192]
            mem[(32 * _5908) + (32 * _5012) + (32 * _2657) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
            mem[mem[64] + 128] = (32 * _6612) + (32 * _5908) + (32 * _5012) + (32 * _2657) + 288
            ...
            return 160, 
                   mem[mem[64] + 32 len 96],
                   (32 * _6612) + (32 * _5908) + (32 * _5012) + (32 * _2657) + 288,
                   mem[mem[64] + 160 len (32 * _7124) + (32 * _6612) + (32 * _5908) + (32 * _5012) + (32 * _2657) + 160]
        mem[(64 * arg3) + 192 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
        require arg3 <= test266151307()
        mem[(98 * arg3) + 192] = arg3
        if not arg3:
        ...
        mem[(32 * _5932) + (32 * _5036) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
        _6636 = mem[(98 * arg3) + 192]
        mem[(32 * _5932) + (32 * _5036) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
        mem[mem[64] + 128] = (32 * _6636) + (32 * _5932) + (32 * _5036) + (32 * mem[96]) + 288
        ...
        return 160, mem[mem[64] + 32 len (32 * _7148) + (32 * _6636) + (32 * _5932) + (32 * _5036) + (32 * _2697) + 288]
    mem[(32 * arg3) + 160 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
    require arg3 <= test266151307()
    mem[(64 * arg3) + 160] = arg3
    if not arg3:
        ...
        if not arg3:
            ...
            if not arg3:
                ...
                mem[(32 * _5938) + (32 * _5042) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
                mem[mem[64] + 128] = (32 * _6642) + (32 * _5938) + (32 * _5042) + (32 * mem[96]) + 288
                ...
                return 160, mem[mem[64] + 32 len (32 * _7154) + (32 * _6642) + (32 * _5938) + (32 * _5042) + (32 * _2707) + 288]
            mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
            if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
                idx = 0
                while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
            ...
            mem[(32 * _5944) + (32 * _5048) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
            mem[mem[64] + 128] = (32 * _6648) + (32 * _5944) + (32 * _5048) + (32 * mem[96]) + 288
            ...
            return 160, mem[mem[64] + 32 len (32 * _7160) + (32 * _6648) + (32 * _5944) + (32 * _5048) + (32 * _2717) + 288]
        mem[(98 * arg3) + 224 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
        require arg3 <= test266151307()
        mem[(131 * arg3) + 224] = arg3
        mem[64] = (164 * arg3) + 256
        if not arg3:
            ...
            mem[(32 * _5950) + (32 * _5054) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
            _6654 = mem[(98 * arg3) + 192]
            mem[(32 * _5950) + (32 * _5054) + (32 * mem[96]) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
            mem[mem[64] + 128] = (32 * _6654) + (32 * _5950) + (32 * _5054) + (32 * mem[96]) + 288
            ...
            return 160, mem[mem[64] + 32 len (32 * _7166) + (32 * _6654) + (32 * _5950) + (32 * _5054) + (32 * _2727) + 288]
        mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
        if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
            idx = 0
            while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
    ...
    if not arg3:
        ...
        if not arg3:
            ...
            mem[(32 * _5962) + (32 * _5066) + (32 * _2747) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
            mem[mem[64] + 128] = (32 * _6666) + (32 * _5962) + (32 * _5066) + (32 * _2747) + 288
            ...
            return 160, 
                   mem[mem[64] + 32 len 96],
                   (32 * _6666) + (32 * _5962) + (32 * _5066) + (32 * _2747) + 288,
                   mem[mem[64] + 160 len (32 * _7178) + (32 * _6666) + (32 * _5962) + (32 * _5066) + (32 * _2747) + 160]
        mem[(131 * arg3) + 256 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
        if arg3 + arg2 > uint256(participantsNumber[arg1].field_3072):
            idx = 0
            while idx < uint256(participantsNumber[arg1].field_3072) - arg2:
        ...
        mem[(32 * _5968) + (32 * _5072) + (32 * _2757) + mem[64] + 256] = mem[(98 * arg3) + 192]
        _6672 = mem[(98 * arg3) + 192]
        mem[(32 * _5968) + (32 * _5072) + (32 * _2757) + mem[64] + 288 len floor32(mem[(98 * arg3) + 192])] = mem[(98 * arg3) + 224 len floor32(mem[(98 * arg3) + 192])]
        mem[mem[64] + 128] = (32 * _6672) + (32 * _5968) + (32 * _5072) + (32 * _2757) + 288
        ...
        return 160, 
               mem[mem[64] + 32 len 96],
               (32 * _6672) + (32 * _5968) + (32 * _5072) + (32 * _2757) + 288,
               mem[mem[64] + 160 len (32 * _7184) + (32 * _6672) + (32 * _5968) + (32 * _5072) + (32 * _2757) + 160]
    mem[(98 * arg3) + 224 len 32 * arg3] = call.data[calldata.size len 32 * arg3]
    require arg3 <= test266151307()
    mem[(131 * arg3) + 224] = arg3
    mem[64] = (164 * arg3) + 256
    ...
    mem[(32 * _5980) + (32 * _5084) + (32 * mem[96]) + mem[64] + 256] = mem[(98 * arg3) + 192]
