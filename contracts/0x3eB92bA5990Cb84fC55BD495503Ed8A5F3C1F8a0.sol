...
function sub_fb08f53e(?) {
    ...
    if 666 == (sha3(arg1, block.number, block.coinbase, block.gas_limit, block.timestamp, block.hash(block.number - 1)) % 1000) + 1000:
    ...
    emit 0x3079f931: sub_e136ef76[arg2 - 1].field_0, sub_e136ef76[arg2 - 1].field_1792, sub_e136ef76[arg2 - 1].field_256, sub_e136ef76[arg2 - 1].field_1536, block.timestamp, sub_e136ef76[arg2 - 1].field_1280
