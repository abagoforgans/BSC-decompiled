...
function Migration(address[] arg1, uint256[] arg2) {
    require calldata.size - 4 >= 64
    require arg1 <= test266151307()
    require arg1 + 35 < calldata.size
    ...
    while idx < arg2.length:
        ...
        if not decimals:
            if idx >= mem[ceil32(32 * arg1.length) + 97]:
                revert with 0, 50
            _230 = mem[(32 * idx) + ceil32(32 * arg1.length) + 129]
            ...
            if bool(bool(decimals < 78)) or bool(bool(decimals < 32)):
                if idx >= mem[ceil32(32 * arg1.length) + 97]:
                    revert with 0, 50
                _232 = mem[(32 * idx) + ceil32(32 * arg1.length) + 129]
                if mem[(32 * idx) + ceil32(32 * arg1.length) + 129] and 10^decimals > -1 / mem[(32 * idx) + ceil32(32 * arg1.length) + 129]:
                    revert with 0, 17
                if not owner:
                    revert with 0, 'ERC20: transfer from the zero address'
                if not mem[(32 * idx) + 140 len 20]:
                ...
                if idx >= mem[ceil32(32 * arg1.length) + 97]:
                    revert with 0, 50
                _305 = mem[(32 * idx) + ceil32(32 * arg1.length) + 129]
