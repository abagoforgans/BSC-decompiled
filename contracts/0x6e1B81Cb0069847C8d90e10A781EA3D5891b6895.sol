...
const bifi = 0x4b0f1812e5df2a09796481ff14017e6005508003
...
uint256 stor1;
array of struct wbnbToBifiRoute;
...
function wbnbToBifiRoute(uint256 arg1) payable {
    ...
    return wbnbToBifiRoute[arg1].field_0
}
...
function deposit() payable {
    ...
    staticcall 0x4b0f1812e5df2a09796481ff14017e6005508003.0x70a08231 with:
...
function pause() payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(0x4b0f1812e5df2a09796481ff14017e6005508003) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address rg1, uint256 rg2), 0x453d4ba9a2d594314df88564, 0, 0
        call 0x4b0f1812e5df2a09796481ff14017e6005508003.0xd74d6b2c with:
             gas gas_remaining wei
            ...
            if return_data.size > 0:
                ...
                if not mem[456]:
                    revert with 0, 
                                ...
                                mem[ceil32(return_data.size) + 535 len 22]
        require ext_code.size(0x453d4ba9a2d594314df88564248497f7d74d6b2c)
        staticcall 0x453d4ba9a2d594314df88564248497f7d74d6b2c.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] > arg1:
            if not arg1:
                ...
                call 0x4b0f1812e5df2a09796481ff14017e6005508003 with:
                   funct uint32(stor1)
                     gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(0x4b0f1812e5df2a09796481ff14017e6005508003) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, ext_call.return_data[0] - (5 * ext_call.return_data[0] / 10000)) >> 32
                mem[452 len 0] = 0
                call 0x4b0f1812e5df2a09796481ff14017e6005508003 with:
                   funct uint32(stor1)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            ...
            if not arg1:
                ...
                if ext_code.size(0x4b0f1812e5df2a09796481ff14017e6005508003) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[452 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, arg1 - (5 * arg1 / 10000)) >> 32
                call 0x4b0f1812e5df2a09796481ff14017e6005508003 with:
                   funct uint32(stor1)
                     gas gas_remaining wei
...
function unpause() payable {
    ...
    if not return_data.size:
        ...
        if not approve(address rg1, uint256 rg2), 0x3bc677674df90a9e5d741f28:
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        require ext_code.size(0x4b0f1812e5df2a09796481ff14017e6005508003)
        staticcall 0x4b0f1812e5df2a09796481ff14017e6005508003.0xdd62ed3e with:
                gas gas_remaining wei
...
function harvest() payable {
    ...
    require ext_code.size(0x453d4ba9a2d594314df88564248497f7d74d6b2c)
    call 0x453d4ba9a2d594314df88564248497f7d74d6b2c.getReward() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c)
    ...
    if ext_call.return_data[0]:
        ...
        mem[196] = msg.sender
        mem[228] = 5 * ext_call.return_data[0] / 1000
        mem[160] = 68
        ...
        if ext_code.size(0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[324 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 5 * ext_call.return_data[0] / 1000) >> 32
        mem[416 len 4] = 0
        call 0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args Mask(224, 32, 5 * ext_call.return_data[0] / 1000) << 224, mem[388 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 'SafeMath: division by zero'
        ...
        if return_data.size <= 0:
            if not ext_call.return_data[0]:
                ...
                mem[ceil32(return_data.size) + 425] = 0x453d4ba9a2d594314df88564248497f7d74d6b2c
                mem[ceil32(return_data.size) + 457] = 0
                mem[ceil32(return_data.size) + 389] = 68
                mem[ceil32(return_data.size) + 425 len 28] = 0x453d4ba9a2d594314df88564248497f7
                mem[ceil32(return_data.size) + 421 len 4] = unknown_0xa9059cbb(?????)
                mem[ceil32(return_data.size) + 489] = 32
                mem[ceil32(return_data.size) + 521] = 'SafeERC20: low-level call failed'
                if ext_code.size(0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), 0x453d4ba9a2d594314df88564, 0, 0
                mem[ceil32(return_data.size) + 645 len 4] = 0
                call 0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c.0xd74d6b2c with:
                     gas gas_remaining wei
                ...
                mem[ceil32(return_data.size) + 357] = 'SafeMath: division by zero'
                mem[ceil32(return_data.size) + 425] = 0x453d4ba9a2d594314df88564248497f7d74d6b2c
                mem[ceil32(return_data.size) + 457] = 5 * ext_call.return_data[0] / 1000
                mem[ceil32(return_data.size) + 389] = 68
                mem[ceil32(return_data.size) + 425 len 28] = 0x453d4ba9a2d594314df88564248497f7
                mem[ceil32(return_data.size) + 421 len 4] = unknown_0xa9059cbb(?????)
                mem[ceil32(return_data.size) + 489] = 32
                ...
                if ext_code.size(0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), 0x453d4ba9a2d594314df88564, 0, Mask(224, 32, 5 * ext_call.return_data[0] / 1000) >> 32
                mem[ceil32(return_data.size) + 645 len 4] = 0
                call 0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c.0xd74d6b2c with:
                     gas gas_remaining wei
                    args Mask(224, 32, 5 * ext_call.return_data[0] / 1000) << 224, mem[ceil32(return_data.size) + 617 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 'SafeMath: division by zero'
            ...
            mem[(2 * ceil32(return_data.size)) + 718] = wbnbToBifiRoute.length
            if not wbnbToBifiRoute.length:
                require ext_code.size(0x3bc677674df90a9e5d741f28f6ca303357d0e4ec)
                call 0x3bc677674df90a9e5d741f28f6ca303357d0e4ec.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp + 600, wbnbToBifiRoute.length, mem[(2 * ceil32(return_data.size)) + 750 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            else:
                mem[0] = 2
                mem[(2 * ceil32(return_data.size)) + 750] = address(wbnbToBifiRoute.field_0)
                idx = (2 * ceil32(return_data.size)) + 750
                s = 0
                while (2 * ceil32(return_data.size)) + (32 * wbnbToBifiRoute.length) + 750 > idx + 32:
                    mem[idx + 32] = wbnbToBifiRoute[s].field_256
                    idx = idx + 32
                    s = s + 1
                    continue 
                require ext_code.size(0x3bc677674df90a9e5d741f28f6ca303357d0e4ec)
                call 0x3bc677674df90a9e5d741f28f6ca303357d0e4ec.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp + 600, wbnbToBifiRoute.length, mem[(2 * ceil32(return_data.size)) + 750 len (2 * ceil32(return_data.size)) + (32 * wbnbToBifiRoute.length) - (2 * ceil32(return_data.size))]
        else:
            require return_data.size >= 32
            if not mem[356]:
                revert with 0, 
            ...
            if ext_call.return_data[0]:
                ...
                if not wbnbToBifiRoute.length:
                    ...
                    call 0x3bc677674df90a9e5d741f28f6ca303357d0e4ec.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp + 600, wbnbToBifiRoute.length
                else:
                    mem[0] = 2
                    mem[(2 * ceil32(return_data.size)) + 750] = address(wbnbToBifiRoute.field_0)
                    idx = (2 * ceil32(return_data.size)) + 750
                    ...
                    call 0x3bc677674df90a9e5d741f28f6ca303357d0e4ec.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp + 600, wbnbToBifiRoute.length, mem[(2 * ceil32(return_data.size)) + 750 len 32 * wbnbToBifiRoute.length]
            else:
                mem[ceil32(return_data.size) + 325] = 26
                mem[ceil32(return_data.size) + 357] = 'SafeMath: division by zero'
                mem[ceil32(return_data.size) + 425] = 0x453d4ba9a2d594314df88564248497f7d74d6b2c
        ...
        if return_data.size <= 0:
            if not ext_call.return_data[0]:
                ...
                call 0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c.0xd74d6b2c with:
                     gas gas_remaining wei
                    args Mask(480, -256, unknown_0xa9059cbb(?????), 0x453d4ba9a2d594314df88564, 0, 0) << 256, mem[ceil32(return_data.size) + 617 len 4]
            else:
                require ext_call.return_data[0]
                if 5 * ext_call.return_data[0] / ext_call.return_data[0] != 5:
                    revert with 0, 
