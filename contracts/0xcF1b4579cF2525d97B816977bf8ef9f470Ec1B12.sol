...
address stor6;
address stor8;
uint256 sub_55e5f585;
uint256 sub_38cf99b3;
uint256 tag;

function sub_38cf99b3(?) payable {
    return sub_38cf99b3
}

function tag() payable {
    return tag
}

function sub_55e5f585(?) payable {
    return sub_55e5f585
}
...
function approve(address arg1) payable {
    ...
    call stor4.setApprovalForAll(address arg1, bool arg2) with:
...
function sub_c170157b(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(stor8)
    staticcall stor8.0x4877547e with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_f03062ce(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(stor6)
    staticcall stor6.0x4877547e with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
