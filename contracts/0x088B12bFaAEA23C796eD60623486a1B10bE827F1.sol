...
function getMultipliedFee() {
    ...
    if not stor37:
        ...
        if not stor48:
            revert with 'NH{q', 18
        if stor37 > -((stor47 * 0 / stor46) + (stor48 * 0 / stor46) - (block.timestamp * 0 / stor46) - (stor47 * stor37) - (stor48 * stor37) + (block.timestamp * stor37) / stor48) - 1:
            revert with 'NH{q', 17
    ...
    if not stor48:
        revert with 'NH{q', 18
    if stor37 > -((stor47 * stor37 * stor45 / stor46) + (stor48 * stor37 * stor45 / stor46) - (block.timestamp * stor37 * stor45 / stor46) - (stor47 * stor37) - (stor48 * stor37) + (block.timestamp * stor37) / stor48) - 1:
        revert with 'NH{q', 17
