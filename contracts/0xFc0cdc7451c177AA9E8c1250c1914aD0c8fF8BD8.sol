...
function sub_8e426779(?) payable {
    ...
    if bool(stor8[msg.sender]) != 1:
        revert with 0, 'metaitem: only minter'
    if stor10 > -2:
        revert with 0, 17
    stor10++
    if not address(arg1):
    ...
    if balanceOf[address(arg1)] > -2:
        revert with 0, 17
    balanceOf[address(arg1)]++
    ownerOf[stor10] = address(arg1)
    emit Transfer(0, address(arg1), stor10);
    stor9[stor10].field_0 = stor10
    if stor9[stor10].field_256:
        if stor9[stor10].field_256 == uint255(stor9[stor10].field_256) * 0.5 < 32:
            revert with 0, 34
        if arg4.length:
            stor9[stor10][1][].field_0 = Array(len=arg4.length, data=arg4[all])
        else:
            stor9[stor10].field_256 = 0
            idx = 0
            while (uint255(stor9[stor10].field_256) * 0.5) + 31 / 32 > idx:
                stor9[stor10][idx + 1].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor9[stor10].field_256 == stor9[stor10].field_257 < 32:
            revert with 0, 34
        if arg4.length:
            stor9[stor10][1][].field_0 = Array(len=arg4.length, data=arg4[all])
        else:
            stor9[stor10].field_256 = 0
            idx = 0
            while stor9[stor10].field_257 + 31 / 32 > idx:
                stor9[stor10][idx + 1].field_0 = 0
                idx = idx + 1
                continue 
    stor9[stor10].field_512 = arg2
    stor9[stor10].field_768 = arg3
    stor9[stor10].field_1024 = arg5
    stor9[stor10].field_1280 = arg6
    stor9[stor10].field_1536 = block.number
    return stor10
}
...
function itemInfo(uint256 arg1) payable {
    require calldata.size - 4 >= 32
        ...
        if stor9[arg1].field_256:
            ...
            if Mask(256, -1, stor9[arg1].field_256):
                if 31 >= uint255(stor9[arg1].field_256) * 0.5:
                    mem[576] = 256 * stor9[arg1].field_264
                else:
                    mem[576] = stor9[arg1][1].field_0
                    idx = 576
                    s = 0
                    while (uint255(stor9[arg1].field_256) * 0.5) + 544 > idx:
            ...
            if stor9[arg1].field_257:
                if 31 >= stor9[arg1].field_257:
                    ...
                    idx = 576
                    s = 0
                    while stor9[arg1].field_257 + 544 > idx:
                        mem[idx + 32] = stor9[arg1][s + 1].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        return 32, stor9[arg1].field_0, 
               224,
               ...
               2 * Mask(256, -1, stor9[arg1].field_256),
               mem[576 len ceil32(uint255(stor9[arg1].field_256) * 0.5)]
    if stor9[arg1].field_256 == stor9[arg1].field_257 < 32:
        revert with 0, 34
    if stor9[arg1].field_256:
        if stor9[arg1].field_256 == uint255(stor9[arg1].field_256) * 0.5 < 32:
    ...
    return 32, stor9[arg1].field_0, 
           ...
           mem[576 len ceil32(stor9[arg1].field_257)]
}
