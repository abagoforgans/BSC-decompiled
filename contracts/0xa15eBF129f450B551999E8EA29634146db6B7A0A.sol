...
function join() payable {
    ...
    if not contractCodeHash:
        contractCodeHash = sha3(code.data[2344 len 18658])
    create2 contract with 0 wei
                    salt: sha3(sub_60aec0f0Address, sub_5234e2dcAddress, sub_4efeb558Address, msg.sender, OWNER_ADDRESS)
                    code: code.data[2344 len 18658]
    users[address(msg.sender)] = address(create2.new_address)
