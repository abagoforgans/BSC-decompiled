...
#
const name = 'MetaFist', 0

const InitialSupply = 100000000000 * 10^18

const decimals = 18

const TeamWallet = 0x9418463259c1a54c48da0256dfdf3ad9ea81126a
...
function getBurnedTokens() {
    if 100000000000 * 10^18 < totalSupply:
        revert with 'NH{q', 17
    return (-totalSupply + 100000000000 * 10^18 / 10^18)
}
...
function sendBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x9418463259c1a54c48da0256dfdf3ad9ea81126a with:
