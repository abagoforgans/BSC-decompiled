...
function mint(address arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        mem[64] = ceil32(s) + 128
        if s:
            mem[128 len s] = code.data[9353 len s]
        t = s - 1
        idx = arg2
        while idx:
            require t < mem[96]
...
function safeMint(address arg1, uint256 arg2) payable {
    ...
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(arg1):
        if not arg2:
            ...
            mem[64] = ceil32(s) + 160
            if s:
                mem[160 len s] = code.data[9353 len s]
            t = s - 1
            idx = arg2
            while idx:
                require t < mem[128]
        ...
        if not ext_code.hash(arg1):
            ...
            if not arg2:
                ...
                while idx:
                    ...
                    continue 
                if s:
                    mem[ceil32(return_data.size) + 357 len s] = code.data[9353 len s]
                t = s - 1
                idx = arg2
                while idx:
                    require t < s
...
function safeMint(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(arg1):
        if not arg2:
            ...
            if s:
                mem[ceil32(arg3.length) + 160 len s] = code.data[9353 len s]
            t = s - 1
            idx = arg2
            while idx:
        ...
        if not ext_code.hash(arg1):
            ...
            if not arg3.length % 32:
                ...
                call arg1.mem[arg3.length + ceil32(arg3.length) + 324 len 4] with:
                     gas gas_remaining wei
                    args mem[arg3.length + ceil32(arg3.length) + 328 len Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)] - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg3.length:
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[arg3.length + ceil32(arg3.length) + 356 len s] = code.data[9353 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[arg3.length + ceil32(arg3.length) + ceil32(return_data.size) + 357 len s] = code.data[9353 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                ...
                mem[ceil32(arg3.length) + 164 len 28] = Mask(224, 32, msg.sender) >> 32
                mem[ceil32(arg3.length) + 160 len 4] = onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4)
                _172 = Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)]
                ...
                call arg1.mem[floor32(arg3.length) + ceil32(arg3.length) + 356 len 4] with:
                     gas gas_remaining wei
                    args mem[floor32(arg3.length) + ceil32(arg3.length) + 360 len _172 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg3.length:
                            revert with arg3[all]
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[floor32(arg3.length) + ceil32(arg3.length) + 388 len s] = code.data[9353 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
                    ...
                    if not arg2:
                        ...
                        while idx:
                            ...
                            continue 
                        if s:
                            mem[floor32(arg3.length) + ceil32(arg3.length) + ceil32(return_data.size) + 389 len s] = code.data[9353 len s]
                        t = s - 1
                        idx = arg2
                        while idx:
                            require t < s
