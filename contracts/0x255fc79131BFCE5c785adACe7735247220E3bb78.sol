...
function mint(address arg1, uint256 arg2) payable {
    ...
    if totalSupply + 100000000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 100000000 * 10^18
    if balanceOf[0xabc242469d795c0cadf3e61e23c5520235d1ae19] + 100000000 * 10^18 < balanceOf[0xabc242469d795c0cadf3e61e23c5520235d1ae19]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[0xabc242469d795c0cadf3e61e23c5520235d1ae19] += 100000000 * 10^18
    emit Transfer(address rg1, address rg2, uint256 rg3):
                  100000000 * 10^18,
    emit 0x0: 100000000 * 10^18
    emit 0xabc24246: 100000000 * 10^18
}
