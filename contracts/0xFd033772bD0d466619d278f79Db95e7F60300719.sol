...
uint8 decimals;
address sub_a0e0e13cAddress; offset 8
...
function sub_a0e0e13c(?) payable {
    return sub_a0e0e13cAddress
}
...
function leave(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(sub_a0e0e13cAddress)
    staticcall sub_a0e0e13cAddress.0x70a08231 with:
    ...
    if not arg1:
        ...
        require ext_code.size(sub_a0e0e13cAddress)
        call sub_a0e0e13cAddress.0xa9059cbb with:
             gas gas_remaining wei
...
function enter(uint256 arg1) payable {
    ...
    require ext_code.size(sub_a0e0e13cAddress)
    call sub_a0e0e13cAddress.0x23b872dd with:
         gas gas_remaining wei
