...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        if not return_data.size:
            ...
            if ext_code.size(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, address(sub_fcde5e1cAddress), ext_call.return_data[0 len 28]
            call 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82 with:
               funct uint32(stor6)
                 gas gas_remaining wei
            ...
            if ext_code.size(0xe09fabb73bd3ade0a17ecc321fd13a19e81ce82) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, address(sub_fcde5e1cAddress), ext_call.return_data[0 len 28]
            call 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82 with:
               funct uint32(stor6)
                 gas gas_remaining wei
                ...
                if return_data.size > 0:
                    ...
                    if not mem[ceil32(return_data.size) + 457]:
                        revert with 0, 
                                    ...
                                    mem[(2 * ceil32(return_data.size)) + 536 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 22]
        require ext_code.size(address(sub_fcde5e1cAddress))
        call address(sub_fcde5e1cAddress).deposit(uint256 rg1) with:
             gas gas_remaining wei
