...
function sub_be67c6c1(?) {
    ...
    require ext_code.size(0x5822c2fc8f20381843fa6cc1ecca80e83af2f6a6)
    delegate 0x5822c2fc8f20381843fa6cc1ecca80e83af2f6a6.0xcd7db54c with:
...
function sub_31f17857(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(0x14216f873e4f3698f583fc22d7a82ff1442a9285)
    delegate 0x14216f873e4f3698f583fc22d7a82ff1442a9285.0x13d674fe with:
         gas gas_remaining wei
...
function sub_b97c41a5(?) {
    if not sub_26f05442Address:
        return -1
    require ext_code.size(0x5822c2fc8f20381843fa6cc1ecca80e83af2f6a6)
    delegate 0x5822c2fc8f20381843fa6cc1ecca80e83af2f6a6.0xcc23f384 with:
         gas gas_remaining wei
...
function approve(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x6ada744de3b08be1ee5316cc08f05f5b217c46)
    delegate 0x6ada744de3b08be1ee5316cc08f05f5b217c46.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0x9ff08fe0289e230bf56f3883d43900bf24970b9c)
        delegate 0x9ff08fe0289e230bf56f3883d43900bf24970b9c.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2 == arg2
    require ext_code.size(0x6ada744de3b08be1ee5316cc08f05f5b217c46)
    delegate 0x6ada744de3b08be1ee5316cc08f05f5b217c46.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_5126dad7(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
        delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
        delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) {
    ...
    while idx < stor1.length:
        ...
        if readOnly:
            revert with 0, 'Read-only'
        require ext_code.size(0x23d72c30df13ad1130181a1945554b0ed36a8166)
        delegate 0x23d72c30df13ad1130181a1945554b0ed36a8166.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_a9f1866b(?) {
    require ext_code.size(0x5822c2fc8f20381843fa6cc1ecca80e83af2f6a6)
    delegate 0x5822c2fc8f20381843fa6cc1ecca80e83af2f6a6.0x5bb709aa with:
         gas gas_remaining wei
        args 3, 30
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_594161f8(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0x9ff08fe0289e230bf56f3883d43900bf24970b9c)
        delegate 0x9ff08fe0289e230bf56f3883d43900bf24970b9c.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
        delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x6ada744de3b08be1ee5316cc08f05f5b217c46)
            delegate 0x6ada744de3b08be1ee5316cc08f05f5b217c46.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
        delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
        delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_d32ea8b6(?) {
    ...
    mem[516] = arg1
    require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
    delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_3367ad09(?) {
    ...
    require ('cd', 4)[13] < 21
    mem[1156] = ('cd', 4)[13]
    require ext_code.size(0x48555185a01500e98a69f384a5cae4c5e188a604)
    delegate 0x48555185a01500e98a69f384a5cae4c5e188a604.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_e5a6f3d0(?) {
    ...
    require ('cd', 4)[13] < 21
    require ext_code.size(0x48555185a01500e98a69f384a5cae4c5e188a604)
    delegate 0x48555185a01500e98a69f384a5cae4c5e188a604.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0x9ff08fe0289e230bf56f3883d43900bf24970b9c)
        delegate 0x9ff08fe0289e230bf56f3883d43900bf24970b9c.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
        delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) {
    ...
    mem[132] = 14
    require ext_code.size(0x709897bf0feb38ca7f509ffcdccd45ea30c08d58)
    delegate 0x709897bf0feb38ca7f509ffcdccd45ea30c08d58.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    ...
    mem[388] = arg1
    require ext_code.size(0x14216f873e4f3698f583fc22d7a82ff1442a9285)
    delegate 0x14216f873e4f3698f583fc22d7a82ff1442a9285.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x6ada744de3b08be1ee5316cc08f05f5b217c46)
    delegate 0x6ada744de3b08be1ee5316cc08f05f5b217c46.0xc5bb51da with:
         gas gas_remaining wei
...
function sub_a05e1c7d(?) {
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[4] <= 0:
            ...
            require ext_code.size(0x48555185a01500e98a69f384a5cae4c5e188a604)
            delegate 0x48555185a01500e98a69f384a5cae4c5e188a604.mem[mem[64] len 4] with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0x48555185a01500e98a69f384a5cae4c5e188a604)
            delegate 0x48555185a01500e98a69f384a5cae4c5e188a604.mem[(32 * cd[(cd[4] + ('cd', 4)[2] + 4)]) + (32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 640 len 4] with:
                 gas gas_remaining wei
