...
uint8 strategyFinalized; offset 160
uint32 stor6;
...
function withdraw(uint256 arg1) payable {
    ...
    if not userInfo[msg.sender].field_256 - arg1:
        userInfo[msg.sender].field_0 = 0
}
                                                        ...
                                                        if not userInfo[msg.sender].field_0:
                                                                        ...
                                                                        if not ext_call.success:
                                                                            ...
                                                                            if not return_data.size:
                                                                                if balanceOf[address(msg.sender)] > userInfo[msg.sender].field_256:
                                                                                    ...
                                                                                    if userInfo[msg.sender].field_256 - balanceOf[address(msg.sender)]:
                                                                                    else:
                                                                                        userInfo[msg.sender].field_0 = 0
                                                                            else:
                                                                                require return_data.size >= 32
                                                            ...
                                                            if balanceOf[address(msg.sender)]:
                                                                if 100 * balanceOf[address(msg.sender)] / balanceOf[address(msg.sender)] != 100:
                                                                    ...
                                                                    if 100 * balanceOf[address(msg.sender)]:
