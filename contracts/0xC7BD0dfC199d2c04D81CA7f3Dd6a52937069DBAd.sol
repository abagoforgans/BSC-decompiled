...
function isNotInSwap() {
    return not bool(uint8(stor35.field_8))
}
...
function sub_8e766f7d(?) {
    ...
    if owner != msg.sender:
        revert with 0, '!OWNER'
    Mask(80, 0, stor30.field_176) = Mask(80, 0, arg1)
    return arg1
}
...
function getCirculatingSupply() {
    if stor5[stor3] > 0xffffffffffffffffffffffffffffffffffffffffffffffe731bf092fde600000:
        revert with 0, 'SafeMath: subtraction overflow'
    if stor5[stor4] > -stor5[stor3] - 457584007913129639936:
        revert with 0, 'SafeMath: subtraction overflow'
    if not rate:
        revert with 0, 'SafeMath: division by zero'
    return (-stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate)
}
...
function setMaxTxPercent_base1000(uint256 arg1) {
    ...
    if owner != msg.sender:
        revert with 0, '!OWNER'
    if 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0df06974e20bc0000 * arg1 / 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0df06974e20bc0000 != arg1:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    _maxTxAmount = 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0df06974e20bc0000 * arg1
}
...
function setMaxWalletPercent_base1000(uint256 arg1) {
    ...
    if 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0df06974e20bc0000 * arg1 / 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0df06974e20bc0000 != arg1:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    _maxWalletToken = 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0df06974e20bc0000 * arg1
}
...
function setSwapBackSettings(bool arg1, uint256 arg2) {
    ...
    if 0x68db8bac710cb295e9e1b089a027525460aa64c2f837b4980a8bb03460000 * arg2 / 0x68db8bac710cb295e9e1b089a027525460aa64c2f837b4980a8bb03460000 != arg2:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    swapThreshold = 0x68db8bac710cb295e9e1b089a027525460aa64c2f837b4980a8bb03460000 * arg2
}
...
function rebase(uint256 arg1, int256 arg2) {
    ...
    if arg2:
        ...
        if not _totalSupply:
            revert with 0, 'SafeMath: division by zero'
        rate = 0xffffffffffffffffffffffffffffffffffffffffffffffe731bf092fde600000 / _totalSupply
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not stor5[stor29] / rate:
        ...
        if not -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate:
            revert with 0, 'SafeMath: division by zero'
        return (0 / -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate)
    ...
    if not -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate:
        revert with 0, 'SafeMath: division by zero'
    return (2 * stor5[stor29] / rate * arg1 / -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate)
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not stor5[stor29] / rate:
        ...
        if not -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate:
            revert with 0, 'SafeMath: division by zero'
        return (0 / -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate > arg1)
    if 2 * stor5[stor29] / rate / stor5[stor29] / rate != 2:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
    if not arg2:
        if not -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate:
    ...
    if not -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate:
        revert with 0, 'SafeMath: division by zero'
    return (2 * stor5[stor29] / rate * arg2 / -stor5[stor3] + -stor5[stor4] - 457584007913129639936 / rate > arg1)
}
