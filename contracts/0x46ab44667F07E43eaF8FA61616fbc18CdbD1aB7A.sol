...
#
const name = 'King Vigina Token', 0

const MarketingWallet = 0x9a681140c2447487bb2f089ce597d8fc8a8a079

const decimals = 9

const sub_504762e7(?) = 10^17
...
function sub_218f8a1d(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    call 0x09a681140c2447487bb2f089ce597d8fc8a8a079 with:
