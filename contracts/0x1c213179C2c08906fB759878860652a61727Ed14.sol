...
const getTokenInterfacesVersion = 2, 2, 0
...
function burn(uint256 arg1) {
    ...
    emit code.data[5269 len 32]: arg1, msg.sender, 0
}
...
function mint(address arg1, uint256 arg2) {
    ...
    emit Mint(arg2, arg1);
    emit code.data[5269 len 32]: arg2, 0, arg1
    return 1
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    emit code.data[5269 len 32]: arg2, msg.sender, arg1
    if ext_code.size(arg1) > 0:
        mem[292 len 0] = None
        mem[292 len 160] = onTokenTransfer(address rg1, uint256 rg2, bytes rg3), msg.sender, arg2, 96, 0, mem[292 len 28]
        mem[420] = mem[448 len 4]
        call arg1.mem[292 len 4] with:
             gas gas_remaining wei
            args mem[296 len 156]
        if not ext_call.success:
            require arg1 != bridgeContractAddress
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    emit code.data[5269 len 32]: arg3, arg1, arg2
    if ext_code.size(arg2) > 0:
        mem[292 len 0] = None
        mem[292 len 160] = onTokenTransfer(address rg1, uint256 rg2, bytes rg3), address(arg1) << 64, 0, arg3, 96, 0, mem[292 len 28]
        mem[420] = mem[448 len 4]
        call arg2.mem[292 len 4] with:
             gas gas_remaining wei
            args mem[296 len 156]
        if not ext_call.success:
            require arg2 != bridgeContractAddress
            emit ContractFallbackCallFailed(address(arg1), address(arg2), arg3);
    return 1
}
    ...
    if not arg1:
        ...
        if not ext_call.success:
            create contract with ('balance', 'address') wei
                            code: code.data[5236 len 33], arg2
...
function transferAndCall(address arg1, uint256 arg2, bytes arg3) {
    ...
    if ext_code.size(arg1) > 0:
        ...
        if not arg3.length % 32:
            mem[arg3.length + ceil32(arg3.length) + 292 len floor32(arg3.length + 163)] = onTokenTransfer(address rg1, uint256 rg2, bytes rg3), msg.sender, arg2, 96, arg3.length, Mask(8 * ceil32(arg3.length), -(8 * ceil32(arg3.length)) + 256, arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]) << (8 * ceil32(arg3.length)) - 256, mem[(2 * ceil32(arg3.length)) + 292 len floor32(arg3.length + 163) + -ceil32(arg3.length) - 132]
