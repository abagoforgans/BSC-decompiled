...
function sub_8db8bc90(?) payable {
    ...
    while idx <= arg1.length:
        ...
        call 0x0.push(address rg1) with:
             gas gas_remaining wei
            args address(arg2)
        if not ext_call.success:
        ...
        if idx != mem[96]:
            ...
            if not ext_call.success:
                ...
                require mem[_150 + ceil32(return_data.size)] <= test266151307()
                ...
                if not _365:
                    ...
                    _423 = mem[_401 + (32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64]
                    s = 0
                    while s < 32 * _423:
                        mem[(32 * _158) + _150 + (2 * ceil32(return_data.size)) + (32 * _365) + s + 96] = mem[_401 + (32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + s + 96]
                        s = s + 32
                        continue 
                    mem[64] = (32 * _423) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + (32 * _365) + 96
                    idx = idx + 1
                    s = _381
                    t = (32 * _158) + _150 + ceil32(return_data.size) + 32
                    u = (32 * _158) + _150 + (2 * ceil32(return_data.size)) + (32 * _365) + 64
                    continue 
                mem[(32 * _158) + _150 + ceil32(return_data.size) + 64 len 32 * _365] = call.data[calldata.size len 32 * _365]
                require mem[(32 * _158) + _150 + ceil32(return_data.size) + 32] - 1 < mem[(32 * _158) + _150 + ceil32(return_data.size) + 32]
                _391 = mem[(32 * mem[(32 * _158) + _150 + ceil32(return_data.size) + 32] - 1) + (32 * _158) + _150 + ceil32(return_data.size) + 64]
                if mem[(32 * mem[(32 * _158) + _150 + ceil32(return_data.size) + 32] - 1) + (32 * _158) + _150 + ceil32(return_data.size) + 64] <= s:
                    idx = idx + 1
                    s = s
                    t = t
                ...
                mem[64] = (32 * _158) + _150 + (2 * ceil32(return_data.size)) + (32 * _365) + 64
                require return_data.size >= 32
                _411 = mem[(32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64]
                require mem[(32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64] <= 4294967296
                require mem[(32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64] + 32 <= return_data.size
                require mem[mem[(32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64] + (32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64] <= 4294967296 and mem[(32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64] + (32 * mem[mem[(32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64] + (32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64]) + 32 <= return_data.size
                mem[(32 * _158) + _150 + (2 * ceil32(return_data.size)) + (32 * _365) + 64] = mem[mem[(32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64] + (32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64]
                _427 = mem[_411 + (32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + 64]
                s = 0
                while s < 32 * _427:
                    mem[(32 * _158) + _150 + (2 * ceil32(return_data.size)) + (32 * _365) + s + 96] = mem[_411 + (32 * _158) + _150 + ceil32(return_data.size) + (32 * _365) + s + 96]
                    s = s + 32
                    continue 
            ...
            require return_data.size >= 32
            _366 = mem[(32 * _158) + _150 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, arg4) >> 32
            ...
            _375 = mem[_366 + (32 * _158) + _150 + ceil32(return_data.size) + 32]
            v = 0
            while v < 32 * _375:
                mem[(32 * _158) + _150 + (2 * ceil32(return_data.size)) + v + 64] = mem[_366 + (32 * _158) + _150 + ceil32(return_data.size) + v + 64]
                v = v + 32
                continue 
            mem[64] = (32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64
            ...
            if mem[(32 * mem[(32 * _158) + _150 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] <= s:
                ...
                u = u
                continue 
            mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] = 0x6d4ce63c00000000000000000000000000000000000000000000000000000000
            require ext_code.size(0)
            staticcall 0x0.get() with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (32 * _375) + (32 * _158) + _150 + (4 * ceil32(return_data.size)) + 64
            require return_data.size >= 32
            _463 = mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64]
            require mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] <= 4294967296
            require mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] + 32 <= return_data.size
            require mem[mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] + (32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] <= 4294967296 and mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] + (32 * mem[mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] + (32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64]) + 32 <= return_data.size
            mem[(32 * _375) + (32 * _158) + _150 + (4 * ceil32(return_data.size)) + 64] = mem[mem[(32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64] + (32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64]
            _469 = mem[_463 + (32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 64]
            s = 0
            while s < 32 * _469:
                mem[(32 * _375) + (32 * _158) + _150 + (4 * ceil32(return_data.size)) + s + 96] = mem[_463 + (32 * _375) + (32 * _158) + _150 + (2 * ceil32(return_data.size)) + s + 96]
                s = s + 32
                continue 
            mem[64] = (32 * _469) + (32 * _375) + (32 * _158) + _150 + (4 * ceil32(return_data.size)) + 96
            idx = idx + 1
            s = _455
            t = (32 * _158) + _150 + (2 * ceil32(return_data.size)) + 32
            u = (32 * _375) + (32 * _158) + _150 + (4 * ceil32(return_data.size)) + 64
            continue 
        require idx < mem[96]
        require ext_code.size(0)
        call 0x0.push(address rg1) with:
        ...
        if not ext_call.success:
            _368 = mem[_159 + ceil32(return_data.size)]
            require mem[_159 + ceil32(return_data.size)] <= test266151307()
            ...
            if not _368:
                ...
                _385 = mem[(32 * mem[(32 * _167) + _159 + ceil32(return_data.size) + 32] - 1) + (32 * _167) + _159 + ceil32(return_data.size) + 64]
                if mem[(32 * mem[(32 * _167) + _159 + ceil32(return_data.size) + 32] - 1) + (32 * _167) + _159 + ceil32(return_data.size) + 64] <= s:
                    ...
                    u = u
                    continue 
                mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] = 0x6d4ce63c00000000000000000000000000000000000000000000000000000000
                require ext_code.size(0)
                staticcall 0x0.get() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
                mem[64] = (32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 64
                require return_data.size >= 32
                _406 = mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]
                require mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] <= 4294967296
                require mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + 32 <= return_data.size
                require mem[mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] <= 4294967296 and mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * mem[mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]) + 32 <= return_data.size
                mem[(32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 64] = mem[mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]
                _425 = mem[_406 + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]
                s = 0
                while s < 32 * _425:
                    mem[(32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + s + 96] = mem[_406 + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + s + 96]
                    s = s + 32
                    continue 
                mem[64] = (32 * _425) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 96
                idx = idx + 1
                s = _385
                t = (32 * _167) + _159 + ceil32(return_data.size) + 32
                u = (32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 64
                continue 
            mem[(32 * _167) + _159 + ceil32(return_data.size) + 64 len 32 * _368] = call.data[calldata.size len 32 * _368]
            require mem[(32 * _167) + _159 + ceil32(return_data.size) + 32] - 1 < mem[(32 * _167) + _159 + ceil32(return_data.size) + 32]
            _394 = mem[(32 * mem[(32 * _167) + _159 + ceil32(return_data.size) + 32] - 1) + (32 * _167) + _159 + ceil32(return_data.size) + 64]
            if mem[(32 * mem[(32 * _167) + _159 + ceil32(return_data.size) + 32] - 1) + (32 * _167) + _159 + ceil32(return_data.size) + 64] <= s:
                idx = idx + 1
                s = s
                t = t
            ...
            mem[64] = (32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 64
            require return_data.size >= 32
            _414 = mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]
            require mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] <= 4294967296
            require mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + 32 <= return_data.size
            require mem[mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] <= 4294967296 and mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * mem[mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]) + 32 <= return_data.size
            mem[(32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 64] = mem[mem[(32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64] + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]
            _429 = mem[_414 + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + 64]
            s = 0
            while s < 32 * _429:
                mem[(32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + s + 96] = mem[_414 + (32 * _167) + _159 + ceil32(return_data.size) + (32 * _368) + s + 96]
                s = s + 32
                continue 
            mem[64] = (32 * _429) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 96
            idx = idx + 1
            s = _394
            t = (32 * _167) + _159 + ceil32(return_data.size) + 32
            u = (32 * _167) + _159 + (2 * ceil32(return_data.size)) + (32 * _368) + 64
        ...
        require return_data.size >= 32
        _369 = mem[(32 * _167) + _159 + ceil32(return_data.size) + 32 len 4], Mask(224, 32, arg4) >> 32
        ...
        _376 = mem[_369 + (32 * _167) + _159 + ceil32(return_data.size) + 32]
        v = 0
        while v < 32 * _376:
            mem[(32 * _167) + _159 + (2 * ceil32(return_data.size)) + v + 64] = mem[_369 + (32 * _167) + _159 + ceil32(return_data.size) + v + 64]
            v = v + 32
            continue 
        mem[64] = (32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64
        ...
        if mem[(32 * mem[(32 * _167) + _159 + (2 * ceil32(return_data.size)) + 32] - 1) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] <= s:
            ...
            u = u
            continue 
        mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] = 0x6d4ce63c00000000000000000000000000000000000000000000000000000000
        require ext_code.size(0)
        staticcall 0x0.get() with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (32 * _376) + (32 * _167) + _159 + (4 * ceil32(return_data.size)) + 64
        require return_data.size >= 32
        _465 = mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64]
        require mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] <= 4294967296
        require mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] + 32 <= return_data.size
        require mem[mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] + (32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] <= 4294967296 and mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] + (32 * mem[mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] + (32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64]) + 32 <= return_data.size
        mem[(32 * _376) + (32 * _167) + _159 + (4 * ceil32(return_data.size)) + 64] = mem[mem[(32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64] + (32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64]
        _470 = mem[_465 + (32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 64]
        s = 0
        while s < 32 * _470:
            mem[(32 * _376) + (32 * _167) + _159 + (4 * ceil32(return_data.size)) + s + 96] = mem[_465 + (32 * _376) + (32 * _167) + _159 + (2 * ceil32(return_data.size)) + s + 96]
            s = s + 32
            continue 
        mem[64] = (32 * _470) + (32 * _376) + (32 * _167) + _159 + (4 * ceil32(return_data.size)) + 96
        idx = idx + 1
        s = _456
        t = (32 * _167) + _159 + (2 * ceil32(return_data.size)) + 32
        u = (32 * _376) + (32 * _167) + _159 + (4 * ceil32(return_data.size)) + 64
        continue 
    _133 = mem[64]
    mem[mem[64]] = 64
    mem[mem[64] + 64] = mem[u]
