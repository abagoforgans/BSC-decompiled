...
function withdrawDividend() payable {
    ...
    if stor153[address(msg.sender)] > (-1 * stor152 * balanceOf[address(msg.sender)]) + 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff and stor152 * balanceOf[address(msg.sender)] >= 0:
        revert with 0, 17
