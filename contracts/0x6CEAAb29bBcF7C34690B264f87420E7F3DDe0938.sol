...
function sub_589a1fbf(?) {
    ...
    staticcall stor2.getRoundData(uint80 arg1) with:
            gas gas_remaining wei
...
function sub_a1943bd1(?) {
    ...
    call ROUTERAddress.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp + 100, 2, mem[(2 * ceil32(return_data.size)) + 388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    mem[64] = mem[64] + ceil32(return_data.size)
    require return_data.size >= 160
    require mem[_49] == mem[_49 + 22 len 10]
    require mem[_49 + 128] == mem[_49 + 150 len 10]
    sub_004c0978 = mem[_49 + 22 len 10]
    sub_1fcbc407 = 1
}
...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x856c1da1(?????) > uint32(call.func_hash) >> 224:
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x589a1fbf(?????):
                if unknown_0x6769a17f(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 32
                    if owner != msg.sender:
                        revert with 0, 'Ownable: caller is not the owner'
        ...
        if unknown_0xc0d78655(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xc0d78655(?????) == uint32(call.func_hash) >> 224:
                ...
                if unknown_0xc63f959e(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0xd5132dd2(?????):
                        ...
                        mem[64] = ceil32(return_data.size) + 224
                        require return_data.size >= 32
                        _175 = mem[224 len 4], 0
                        require mem[224 len 4], 0 <= test266151307()
                        require mem[224 len 4], 0 + 255 < return_data.size + 224
                        _179 = mem[mem[224 len 4], 0 + 224]
                        if mem[mem[224 len 4], 0 + 224] > test266151307():
                            revert with 0, 65
                        if ceil32(return_data.size) + ceil32(32 * mem[mem[224 len 4], 0 + 224]) + 225 > test266151307() or ceil32(32 * mem[mem[224 len 4], 0 + 224]) + 1 < 0:
                            revert with 0, 65
                        ...
                        require (32 * _179) + _175 + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 256 len ceil32(32 * _179)] = mem[_175 + 256 len ceil32(32 * _179)]
                        staticcall stor2.latestRoundData() with:
                                gas gas_remaining wei
                        mem[mem[64] len 160] = ext_call.return_data[0 len 160]
                        if not ext_call.success:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 160
                        require mem[_213] == mem[_213 + 22 len 10]
                        require mem[_213 + 128] == mem[_213 + 150 len 10]
                        sub_004c0978 = mem[_213 + 22 len 10]
                        sub_1fcbc407 = 0
        else:
            if unknown_0x856c1da1(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
            ...
            if unknown_0x9f654fa4(?????) == uint32(call.func_hash) >> 224:
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                mem[(2 * ceil32(return_data.size)) + 224] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
                ...
                call ROUTERAddress.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0], 0, 160, address(this.address), block.timestamp + 100, 2, mem[(2 * ceil32(return_data.size)) + 420 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                require return_data.size >= 32
                _173 = mem[(2 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28]
                ...
                _177 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]
                ...
                require (32 * _177) + _173 + 32 <= return_data.size
                mem[(4 * ceil32(return_data.size)) + 256 len ceil32(32 * _177)] = mem[(2 * ceil32(return_data.size)) + _173 + 256 len ceil32(32 * _177)]
                staticcall stor2.latestRoundData() with:
                        gas gas_remaining wei
                mem[mem[64] len 160] = ext_call.return_data[0 len 160]
                if not ext_call.success:
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 160
                require mem[_212] == mem[_212 + 22 len 10]
                require mem[_212 + 128] == mem[_212 + 150 len 10]
                sub_004c0978 = mem[_212 + 22 len 10]
                sub_1fcbc407 = 1
}
