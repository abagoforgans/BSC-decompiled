...
function initialize(address arg1, address arg2) payable {
    ...
    if factoryAddress != msg.sender:
        revert with 0, 'SugarswapV2: FORBIDDEN'
    token0Address = arg1
    token1Address = arg2
}
...
function permit(address arg1, address arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) payable {
    ...
    if arg4 < block.timestamp:
        revert with 0, 'SugarswapV2: EXPIRED'
    nonces[address(arg1)]++
    ...
    if not address(signer):
        revert with 0, 'SugarswapV2: INVALID_SIGNATURE'
...
function sync() payable {
    if stor12 != 1:
        revert with 0, 'SugarswapV2: LOCKED'
    stor12 = 0
    ...
    if ext_call.return_data[0] > test266151307():
        revert with 0, 'SugarswapV2: OVERFLOW'
    if ext_call.return_data[0] > test266151307():
        revert with 0, 'SugarswapV2: OVERFLOW'
...
function skim(address arg1) payable {
    ...
    if not return_data.size:
        ...
        revert with 0, 'SugarswapV2: TRANSFER_FAILED'
