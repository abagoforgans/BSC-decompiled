...
function unfreeze(uint256 arg1) payable {
    ...
    require totalFrozen
    stor3 += 5 * arg1 / 100 << 64 / totalFrozen
    totalFrozen -= arg1
    frozenOf[address(msg.sender)].field_256 -= 5 * arg1 / 100
    frozenOf[address(msg.sender)].field_512 -= arg1
    frozenOf[address(msg.sender)].field_1024 += -1 * arg1 * stor3
    emit Transfer((arg1 - (5 * arg1 / 100)), this.address, msg.sender);
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if totalSupply - (5 * arg2 / 100) < 125000 * 10^18:
        ...
        if frozenOf[address(msg.sender)].field_0:
            ...
            frozenOf[address(arg1)].field_256 = frozenOf[address(arg1)].field_256 + arg2 - (5 * arg2 / 100)
            emit Transfer((arg2 - (5 * arg2 / 100)), msg.sender, arg1);
            if 5 * arg2 / 100 > 0:
                if totalFrozen <= 0:
                    totalSupply -= 5 * arg2 / 100
                    emit Transfer((5 * arg2 / 100), msg.sender, 0);
                    emit Burn((5 * arg2 / 100));
                else:
                    require totalFrozen
                    stor3 += Mask(192, 1, 5 * arg2 / 100) << 63 / totalFrozen
                    emit Transfer((5 * arg2 / 100 / 2), msg.sender, this.address);
                    totalSupply -= 5 * arg2 / 100 / 2
                    emit Transfer((5 * arg2 / 100 / 2), msg.sender, 0);
                    emit Burn((5 * arg2 / 100 / 2));
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if totalSupply - (5 * arg3 / 100) < 125000 * 10^18:
        ...
        if frozenOf[address(arg1)].field_0:
            ...
            frozenOf[address(arg2)].field_256 = frozenOf[address(arg2)].field_256 + arg3 - (5 * arg3 / 100)
            emit Transfer((arg3 - (5 * arg3 / 100)), arg1, arg2);
            if 5 * arg3 / 100 > 0:
                if totalFrozen <= 0:
                    totalSupply -= 5 * arg3 / 100
                    emit Transfer((5 * arg3 / 100), arg1, 0);
                    emit Burn((5 * arg3 / 100));
                else:
                    require totalFrozen
                    stor3 += Mask(192, 1, 5 * arg3 / 100) << 63 / totalFrozen
                    emit Transfer((5 * arg3 / 100 / 2), arg1, this.address);
                    totalSupply -= 5 * arg3 / 100 / 2
                    emit Transfer((5 * arg3 / 100 / 2), arg1, 0);
                    emit Burn((5 * arg3 / 100 / 2));
    return 1
}
...
function bulkTransfer(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 2
        if totalSupply - (5 * cd[((32 * idx) + arg2 + 36)] / 100) < 125000 * 10^18:
            ...
            if frozenOf[address(msg.sender)].field_0:
                ...
                frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256 = frozenOf[address(cd[((32 * idx) + arg1 + 36)])].field_256 + cd[((32 * idx) + arg2 + 36)] - (5 * cd[((32 * idx) + arg2 + 36)] / 100)
                mem[96] = cd[((32 * idx) + arg2 + 36)] - (5 * cd[((32 * idx) + arg2 + 36)] / 100)
                emit Transfer((cd[((32 * idx) + arg2 + 36)] - (5 * cd[((32 * idx) + arg2 + 36)] / 100)), msg.sender, address(cd[((32 * idx) + arg1 + 36)]));
                if 5 * cd[((32 * idx) + arg2 + 36)] / 100 > 0:
                    if totalFrozen <= 0:
                        totalSupply -= 5 * cd[((32 * idx) + arg2 + 36)] / 100
                        emit Transfer((5 * cd[((32 * idx) + arg2 + 36)] / 100), msg.sender, 0);
                        mem[96] = 5 * cd[((32 * idx) + arg2 + 36)] / 100
                        emit Burn((5 * cd[((32 * idx) + arg2 + 36)] / 100));
                    else:
                        require totalFrozen
                        stor3 += Mask(192, 1, 5 * cd[((32 * idx) + arg2 + 36)] / 100) << 63 / totalFrozen
                        emit Transfer((5 * cd[((32 * idx) + arg2 + 36)] / 100 / 2), msg.sender, this.address);
                        totalSupply -= 5 * cd[((32 * idx) + arg2 + 36)] / 100 / 2
                        emit Transfer((5 * cd[((32 * idx) + arg2 + 36)] / 100 / 2), msg.sender, 0);
                        mem[96] = 5 * cd[((32 * idx) + arg2 + 36)] / 100 / 2
                        emit Burn((5 * cd[((32 * idx) + arg2 + 36)] / 100 / 2));
        idx = idx + 1
        continue 
}
    ...
    if totalSupply - (5 * arg2 / 100) < 125000 * 10^18:
        ...
        if frozenOf[address(msg.sender)].field_0:
            ...
            if uint32(ext_code.size(arg1)) > 0:
                ...
                call arg1.tokenCallback(address rg1, uint256 rg2, bytes rg3) with:
                     gas gas_remaining wei
                    args 0, uint32(msg.sender), arg2 - (5 * arg2 / 100), 96, arg3.length, arg3[all], mem[arg3.length + 228 len ceil32(arg3.length) - arg3.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0]
