...
function sub_c9ec965c(?) payable {
    ...
    mem[(32 * _53) + ceil32(return_data.size) + 356] = msg.value
    ...
    call stor0.swapExactTokensForETH(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args mem[ceil32(return_data.size) + 224], msg.value, Array(len=2, data=mem[(32 * _53) + ceil32(return_data.size) + 516 len 64]), msg.sender, arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
