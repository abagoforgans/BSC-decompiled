...
#  - _fallback()
#
const name = 'Mrs Cleopatrau', 0

const decimals = 9

const symbol = 'MrsCleopatra', 0
...
function sub_6cd5c056(?) {
    ...
    if arg1 > !arg2:
        revert with 0, 17
    if arg1 + arg2 < arg1:
        revert with 0, 'SafeMath: additions overflow'
    if arg1 + arg2 > !arg3:
        revert with 0, 17
    if arg3 < 0:
        revert with 0, 'SafeMath: additions overflow'
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if balanceOf[stor18] and 2 > -1 / balanceOf[stor18]:
        revert with 0, 17
    if not balanceOf[stor18]:
        revert with 0, 18
    if 2 * balanceOf[stor18] / balanceOf[stor18] != 2:
        revert with 0, 'SafeMath: multiplication overflow'
    if not arg1:
        if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
            revert with 0, 'SafeMath: division by zero', 0
        return (0 / totalSupply - balanceOf[stor3] - balanceOf[stor4])
    if arg1 and 2 * balanceOf[stor18] > -1 / arg1:
        revert with 0, 17
    if not arg1:
        revert with 0, 18
    if arg1 * 2 * balanceOf[stor18] / arg1 != 2 * balanceOf[stor18]:
        revert with 0, 'SafeMath: multiplication overflow'
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero', 0
    return (arg1 * 2 * balanceOf[stor18] / totalSupply - balanceOf[stor3] - balanceOf[stor4])
}

function sub_e08ec4c8(?) {
    require calldata.size - 4 >= 64
    if balanceOf[stor3] > totalSupply:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if totalSupply < balanceOf[stor3]:
    ...
    if not arg2:
        if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
            revert with 0, 'SafeMath: division by zero', 0
        return (0 / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
    if arg2 and 2 * balanceOf[stor18] > -1 / arg2:
        revert with 0, 17
    if not arg2:
        revert with 0, 18
    if arg2 * 2 * balanceOf[stor18] / arg2 != 2 * balanceOf[stor18]:
        revert with 0, 'SafeMath: multiplication overflow'
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero', 0
    return (arg2 * 2 * balanceOf[stor18] / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
}
