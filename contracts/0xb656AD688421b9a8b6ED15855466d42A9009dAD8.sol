...
function sub_c9ec965c(?) payable {
    ...
    mem[(32 * _55) + ceil32(return_data.size) + 324] = 2 * 10^18
    mem[(32 * _55) + ceil32(return_data.size) + 356] = 5 * 10^16
    ...
    call stor0.swapExactTokensForETH(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args 2 * 10^18, 5 * 10^16, 160, msg.sender, arg3, 2, mem[(32 * _55) + ceil32(return_data.size) + 516 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require mem[(32 * _55) + ceil32(return_data.size) + 320 len 4], 465661287 <= 4294967296
    require mem[(32 * _55) + ceil32(return_data.size) + 320 len 4], 465661287 + 32 <= return_data.size
    require mem[mem[(32 * _55) + ceil32(return_data.size) + 320 len 4], 465661287 + (32 * _55) + ceil32(return_data.size) + 320] <= 4294967296 and mem[(32 * _55) + ceil32(return_data.size) + 320 len 4], 465661287 + (32 * mem[mem[(32 * _55) + ceil32(return_data.size) + 320 len 4], 465661287 + (32 * _55) + ceil32(return_data.size) + 320]) + 32 <= return_data.size
    require ext_code.size(address(ext_call.return_data[12 len 20]))
    call address(ext_call.return_data[12 len 20]).0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, 5 * 10^16
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return 0
