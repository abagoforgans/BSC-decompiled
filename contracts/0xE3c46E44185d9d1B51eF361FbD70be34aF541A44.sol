...
function sub_be67c6c1(?) {
    ...
    require ext_code.size(0x985f5fcd302969aa926ec295a1a0a0984265120e)
    delegate 0x985f5fcd302969aa926ec295a1a0a0984265120e.0xcd7db54c with:
...
function sub_31f17857(?) {
    require calldata.size - 4 >= 64
    require ext_code.size(0x57163e879d7a3b002df50de07f8d4656a675fac)
    delegate 0x57163e879d7a3b002df50de07f8d4656a675fac.0x13d674fe with:
         gas gas_remaining wei
...
function sub_b97c41a5(?) {
    if not sub_26f05442Address:
        return 100 * 10^6
    require ext_code.size(0x985f5fcd302969aa926ec295a1a0a0984265120e)
    delegate 0x985f5fcd302969aa926ec295a1a0a0984265120e.0xcc23f384 with:
         gas gas_remaining wei
...
function approve(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require ext_code.size(0x1617e9dbbee5fceebeffeefe916767f01ddedb39)
    delegate 0x1617e9dbbee5fceebeffeefe916767f01ddedb39.0x5e4a87c7 with:
         gas gas_remaining wei
...
function sub_7f2f97b1(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            idx = idx + 1
            continue 
        require ext_code.size(0x2dce69e16e78bd27607317ffdff57ae794a69b9d)
        delegate 0x2dce69e16e78bd27607317ffdff57ae794a69b9d.0xfb960466 with:
             gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2 == arg2
    require ext_code.size(0x1617e9dbbee5fceebeffeefe916767f01ddedb39)
    delegate 0x1617e9dbbee5fceebeffeefe916767f01ddedb39.0xc7e5f9cb with:
         gas gas_remaining wei
...
function sub_acd3a308(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0x144d5ee with:
             gas gas_remaining wei
...
function sub_5116bffe(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0xbdfadbdd with:
             gas gas_remaining wei
...
function sub_82ae9696(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x9a6995335ab0145f310929bf4910e4f6c81a3fdf)
        delegate 0x9a6995335ab0145f310929bf4910e4f6c81a3fdf.0x84c20628 with:
             gas gas_remaining wei
...
function sub_5126dad7(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0x7cc1af3d with:
             gas gas_remaining wei
...
function sub_06389736(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0x22e7249c with:
             gas gas_remaining wei
...
function sub_a8bd9968(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x2dcaa57458d58374452d73b89521c6e9707cd757)
        delegate 0x2dcaa57458d58374452d73b89521c6e9707cd757.0x5b4c66e6 with:
             gas gas_remaining wei
...
function sub_f090df5d(?) {
    ...
    while idx < stor1.length:
        ...
        if stor2:
            revert with 0, 'Read-only'
        require ext_code.size(0x2dcaa57458d58374452d73b89521c6e9707cd757)
        delegate 0x2dcaa57458d58374452d73b89521c6e9707cd757.0xc2d5b6ab with:
             gas gas_remaining wei
...
function sub_528f6b54(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x4b0e918fe9d148d7c0cdf3c7a1ebee370a80b5c7)
        delegate 0x4b0e918fe9d148d7c0cdf3c7a1ebee370a80b5c7.0xa7b9a567 with:
             gas gas_remaining wei
...
function sub_a9f1866b(?) {
    require ext_code.size(0x985f5fcd302969aa926ec295a1a0a0984265120e)
    delegate 0x985f5fcd302969aa926ec295a1a0a0984265120e.0x5bb709aa with:
         gas gas_remaining wei
        args 3, 30
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_594161f8(?) {
    ...
    while idx < stor1.length:
        ...
        if stor1[idx].field_0 != tx.origin:
            ...
            continue 
        require ext_code.size(0x2dce69e16e78bd27607317ffdff57ae794a69b9d)
        delegate 0x2dce69e16e78bd27607317ffdff57ae794a69b9d.0x71391791 with:
             gas gas_remaining wei
...
function sub_62bcf387(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0xb7c746ae with:
             gas gas_remaining wei
...
function whitelistMany(address[] arg1) {
    ...
    while idx < stor1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0x1617e9dbbee5fceebeffeefe916767f01ddedb39)
            delegate 0x1617e9dbbee5fceebeffeefe916767f01ddedb39.0xf27c7576 with:
                 gas gas_remaining wei
...
function sub_4737065b(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < ('cd', 100).length:
            ...
            continue 
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0x76bf0519 with:
             gas gas_remaining wei
...
function sub_6fc351b3(?) {
    ...
    while idx < stor1.length:
        ...
        require arg2 < 3
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0x6bd692fa with:
             gas gas_remaining wei
...
function sub_c8d49a06(?) {
    ...
    while idx < stor1.length:
        ...
        require ext_code.size(0x4b0e918fe9d148d7c0cdf3c7a1ebee370a80b5c7)
        delegate 0x4b0e918fe9d148d7c0cdf3c7a1ebee370a80b5c7.mem[ceil32(arg1.length) + ceil32(arg2.length) + 160 len 4] with:
             gas gas_remaining wei
...
function sub_c1f53e53(?) {
    ...
    require ext_code.size(0xf12b1205ece34c623c4ac533064714600834de1e)
    delegate 0xf12b1205ece34c623c4ac533064714600834de1e.0x54b1d857 with:
         gas gas_remaining wei
...
function sub_ed3db462(?) {
    ...
    require ('cd', 4)[12] == address(('cd', 4)[12])
    require ext_code.size(0xf12b1205ece34c623c4ac533064714600834de1e)
    delegate 0xf12b1205ece34c623c4ac533064714600834de1e.0x9751bd26 with:
         gas gas_remaining wei
...
function sub_564b8528(?) {
    ...
    while idx < stor1.length:
        ...
        mem[_61 + 132] = cd[100]
        require ext_code.size(0x2dce69e16e78bd27607317ffdff57ae794a69b9d)
        delegate 0x2dce69e16e78bd27607317ffdff57ae794a69b9d.mem[mem[64] len 4] with:
             gas gas_remaining wei
...
function sub_017cbc35(?) {
    ...
    while idx < stor1.length:
        ...
        while idx < _141:
            ...
            continue 
        require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
        delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len u + -mem[64] - 4]
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d32ea8b6(?) {
    ...
    mem[516] = arg1
    require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
    delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0x42da213b with:
         gas gas_remaining wei
        args 3, 14, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_4dc26ae8(?) {
    ...
    mem[132] = 19
    require ext_code.size(0x4b0e918fe9d148d7c0cdf3c7a1ebee370a80b5c7)
    delegate 0x4b0e918fe9d148d7c0cdf3c7a1ebee370a80b5c7.0x45d85d80 with:
         gas gas_remaining wei
        args 19
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e4b3aef(?) {
    ...
    mem[132] = 14
    require ext_code.size(0x175834fce268fb2969abfe111e7c50b808071ab8)
    delegate 0x175834fce268fb2969abfe111e7c50b808071ab8.0x93ff6d1 with:
         gas gas_remaining wei
        args 14
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    ...
    mem[388] = arg1
    require ext_code.size(0x57163e879d7a3b002df50de07f8d4656a675fac)
    delegate 0x57163e879d7a3b002df50de07f8d4656a675fac.0x2d130914 with:
         gas gas_remaining wei
        args 3, 14, 19, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) {
    ...
    mem[mem[64] + 196] = arg2
    require ext_code.size(0x1617e9dbbee5fceebeffeefe916767f01ddedb39)
    delegate 0x1617e9dbbee5fceebeffeefe916767f01ddedb39.0xc5bb51da with:
         gas gas_remaining wei
    ...
    while idx < stor1.length:
        ...
        if ('cd', 4)[1] <= 0:
            if ('cd', 4)[4] <= 0:
                ...
                require ext_code.size(0xf12b1205ece34c623c4ac533064714600834de1e)
                delegate 0xf12b1205ece34c623c4ac533064714600834de1e.mem[mem[64] len 4] with:
                     gas gas_remaining wei
