...
function sub_f87f7144(?) payable {
    ...
    create contract with 0 wei
                    code: code.data[12913 len 6467], address(arg1), arg2, ext_call.return_data[0], stor1, arg4, arg5, bool(sub_83e19ec6), stor4
...
function sub_dbc50686(?) payable {
    ...
    sub_0788af29 += sub_683f0b84
    create contract with 0 wei
                    code: code.data[5587 len 7326], address(arg1), address(arg2), arg3, ext_call.return_data[0], stor1, arg5, arg6, bool(sub_83e19ec6), stor4
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(arg1))
    call address(arg1).0x23b872dd with:
