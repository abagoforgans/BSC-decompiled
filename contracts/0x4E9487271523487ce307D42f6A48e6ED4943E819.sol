...
function sub_9ec46018(?) {
            ...
            if bool(stor154[cd[36]].field_0):
                ...
                if not bool(stor154[cd[36]].field_0):
                    ...
                    if bool(stor154[cd[36]].field_0) != 1:
                        ...
                        mem[_134 + 100] = 0
                        require ext_code.size(sub_cb3e1eb8Address)
                        call sub_cb3e1eb8Address.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _134 + ceil32(uint255(stor154[cd[36]].field_1)) + -mem[64] + 160]
            else:
                ...
                if not bool(stor154[cd[36]].field_0):
                    ...
                    if bool(stor154[cd[36]].field_0) != 1:
                        ...
                        call sub_cb3e1eb8Address.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _134 + ceil32(stor154[cd[36]].field_1 % 128) + -mem[64] + 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if s == -1:
                revert with 'NH{q', 17
    ...
    if bool(stor154[cd[36]].field_0):
        if bool(stor154[cd[36]].field_0) == uint255(stor154[cd[36]].field_1) < 32:
            revert with 'NH{q', 34
        mem[mem[64] + 128] = uint255(stor154[cd[36]].field_1)
        if not bool(stor154[cd[36]].field_0):
            ...
            if bool(stor154[cd[36]].field_0) != 1:
                ...
                s = 0
                while idx < uint255(stor154[cd[36]].field_1):
                    mem[mem[64] + idx + 160] = stor154[cd[36]][s].field_0
                    idx = idx + 32
                    s = s + 1
                    continue 
                mem[_104 + 32] = bool(uint8(stor154[cd[36]].field_256))
                mem[_104 + 64] = stor154[cd[36]].field_768
                mem[_104 + 96] = stor154[cd[36]].field_1024
                emit 0x997e5d95: mem[mem[64] len _104 + ceil32(uint255(stor154[cd[36]].field_1)) + -mem[64] + 160], stor154[cd[36]].field_512
    else:
        if bool(stor154[cd[36]].field_0) == stor154[cd[36]].field_1 % 128 < 32:
            revert with 'NH{q', 34
        mem[mem[64] + 128] = stor154[cd[36]].field_1 % 128
        if not bool(stor154[cd[36]].field_0):
            ...
            if bool(stor154[cd[36]].field_0) != 1:
                ...
                mem[_104 + 64] = stor154[cd[36]].field_768
                mem[_104 + 96] = stor154[cd[36]].field_1024
                emit 0x997e5d95: mem[mem[64] len _104 + ceil32(stor154[cd[36]].field_1 % 128) + -mem[64] + 160], stor154[cd[36]].field_512
    stor51 = 1
}
