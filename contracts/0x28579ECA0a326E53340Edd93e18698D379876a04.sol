...
function withdrawBEP20(address arg1) payable {
    ...
    mem[(2 * ceil32(return_data.size)) + 260 len 96] = approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 2 * ext_call.return_data[0], 0
    mem[(2 * ceil32(return_data.size)) + 328] = 0
    call arg1 with:
       funct Mask(32, 224, approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 2 * ext_call.return_data[0], 0) >> 224
         gas gas_remaining wei
        args (Mask(512, -288, approve(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), 2 * ext_call.return_data[0], 0) << 288)
...
function executeBatch(address[] arg1, uint256[] arg2, bytes[] arg3, bytes32 arg4, bytes32 arg5) payable {
    ...
    if roleAdmin[0xd8aa0f3194971a2a116679f7c2090f6939c8d4e01a2a8d7e41d55e5351469e63][1][address(msg.sender)].field_0:
        ...
        while idx < arg3.length:
            ...
            continue 
        mem[64] = (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 384
        _187 = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + 32], call.data[arg2 + 36 len 32 * arg2.length], arg3.length, mem[(32 * arg1.length) + (32 * arg2.length) + 384 len 64 * arg3.length]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if not arg4:
            idx = 0
            while idx < arg1.length:
                require cd[((32 * idx) + arg1 + 36)] == address(cd[((32 * idx) + arg1 + 36)])
        ...
        while idx < arg3.length:
            ...
            continue 
        mem[64] = (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 384
        _190 = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + 32], call.data[arg2 + 36 len 32 * arg2.length], arg3.length, mem[(32 * arg1.length) + (32 * arg2.length) + 384 len 64 * arg3.length]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if not arg4:
            idx = 0
            while idx < arg1.length:
                require cd[((32 * idx) + arg1 + 36)] == address(cd[((32 * idx) + arg1 + 36)])
