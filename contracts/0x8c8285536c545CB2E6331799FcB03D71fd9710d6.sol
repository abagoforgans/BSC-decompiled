...
function sub_55cbeaa5(?) payable {
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_e05a6aad(?) payable {
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_67a2ce7f(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
}

function sub_5d2c6c81(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    stor5 = arg1
