...
function sub_2af8a5db(?) {
    ...
    emit 0xfe35277c: uint256(auction[arg1].field_256), arg1
}

function sub_fce401b2(?) payable {
    ...
    emit 0xefc9487f: arg2, uint256(auction[arg1].field_256), arg1
}

function sub_f7066513(?) payable {
    require calldata.size - 4 >= 32
    if paused:
        revert with 0, 'Pausable: paused'
...
function sub_286e5026(?) payable {
    ...
    emit 0x5ef491d2: arg2, sub_8282c7f7 + 1, arg1, msg.sender
}
...
function sub_329af780(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0x24a22848: msg.sender, uint256(auction[arg1].field_512), uint256(auction[arg1].field_256), arg1, auction[arg1].field_0
}
