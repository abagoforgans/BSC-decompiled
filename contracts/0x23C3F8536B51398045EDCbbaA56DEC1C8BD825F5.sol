    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0]:
            ...
            if not swap2TokenRouting.length:
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 0, 0, 160, address(this.address), block.timestamp + 300, swap2TokenRouting.length
            else:
                mem[420] = address(swap2TokenRouting.field_0)
                idx = 420
                s = 0
                while (32 * swap2TokenRouting.length) + 420 > idx + 32:
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 0, 0, 160, address(this.address), block.timestamp + 300, swap2TokenRouting.length, mem[420 len 32 * swap2TokenRouting.length]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if block.timestamp + 300 < block.timestamp:
                revert with 0, 'SafeMath: addition overflow'
            if not sub_b1dcffad.length:
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 0, 0, 160, address(this.address), block.timestamp + 300, sub_b1dcffad.length
            else:
                mem[420] = address(sub_b1dcffad.field_0)
                idx = 420
                s = 0
                while (32 * sub_b1dcffad.length) + 420 > idx + 32:
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 0, 0, 160, address(this.address), block.timestamp + 300, sub_b1dcffad.length, mem[420 len 32 * sub_b1dcffad.length]
        else:
            ...
            if not sub_b1dcffad.length:
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 5 * ext_call.return_data[0] / 100, 0, 160, address(this.address), block.timestamp + 300, sub_b1dcffad.length
            else:
                mem[420] = address(sub_b1dcffad.field_0)
                idx = 420
                s = 0
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 5 * ext_call.return_data[0] / 100, 0, 160, address(this.address), block.timestamp + 300, sub_b1dcffad.length, mem[420 len 32 * sub_b1dcffad.length]
    else:
        if 95 * ext_call.return_data[0] / ext_call.return_data[0] != 95:
        ...
        if not ext_call.return_data[0]:
            ...
            if not swap2TokenRouting.length:
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 95 * ext_call.return_data[0] / 100, 0, 160, address(this.address), block.timestamp + 300, swap2TokenRouting.length
            else:
                mem[420] = address(swap2TokenRouting.field_0)
                idx = 420
                s = 0
                ...
                call unirouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args 95 * ext_call.return_data[0] / 100, 0, 160, address(this.address), block.timestamp + 300, swap2TokenRouting.length, mem[420 len 32 * swap2TokenRouting.length]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if block.timestamp + 300 < block.timestamp:
                revert with 0, 'SafeMath: addition overflow'
    ...
    if ext_call.return_data[0] >= arg1:
        if not withdrawalFee:
            ...
            if arg1:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, withdrawalFee * arg1 / 10000) >> 32
                call wantAddress with:
                   funct uint32(stor3)
                     gas gas_remaining wei
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) >> 32
                call wantAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
                    args Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) << 224, mem[ceil32(return_data.size) + 617 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: division by zero'
        ...
        if not withdrawalFee:
            ...
            if not arg1:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, withdrawalFee * arg1 / 10000) >> 32
                mem[452 len 0] = 0
                call wantAddress with:
                   funct uint32(stor3)
                     gas gas_remaining wei
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 617 len 64] = 0, address(vaultAddress), Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) >> 32
                call wantAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
                    args arg1 - (withdrawalFee * arg1 / 10000), mem[ceil32(return_data.size) + 553 len 28], mem[ceil32(return_data.size) + 681 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: subtraction overflow'
                mem[ceil32(return_data.size) + 649 len return_data.size] = ext_call.return_data[0 len return_data.size]
