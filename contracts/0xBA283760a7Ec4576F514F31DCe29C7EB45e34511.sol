...
const FOREIGN_TO_HOME_FEE = code.data[24268 len 32]

const HOME_TO_FOREIGN_FEE = code.data[24236 len 32]
...
function getFee(bytes32 arg1, address arg2) {
    if arg1 != code.data[24236 len 32]:
        require arg1 == code.data[24268 len 32]
