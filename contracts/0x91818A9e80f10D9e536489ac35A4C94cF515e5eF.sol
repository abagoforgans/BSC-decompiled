...
function sub_ee61cf2d(?) {
    require calldata.size - 4 >= 64
    require arg2 == address(arg2)
    if not stor129[msg.sender]:
        revert with 0, '!admin'
    stor128[arg1][address(arg2)] = 1
    emit 0xb6dafa5a: address(arg2), 1, arg1
}
...
function sub_483ca2cf(?) {
    ...
    stor128[arg1][address(arg2)] = 1
    emit 0xd1b1dee5: address(arg2), 1, arg1
}
...
function sub_4c78e9e0(?) {
    ...
    emit 0xd1b1dee5: address(arg2), 0, arg1
}
...
function sub_e7b07f18(?) {
    if address(owner) != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if 336 * 24 * 3600 > !closingTime:
        revert with 'NH{q', 17
    if block.timestamp < closingTime + (336 * 24 * 3600):
...
function sub_0faccd3d(?) {
    ...
    while idx < ('cd', 36).length:
        ...
        stor128[cd[4]][address(mem[(32 * idx) + 128])] = 1
        mem[ceil32(32 * ('cd', 36).length) + 97] = mem[(32 * idx) + 140 len 20]
        mem[ceil32(32 * ('cd', 36).length) + 129] = 1
        emit 0xb6dafa5a: mem[ceil32(32 * ('cd', 36).length) + 97], 1, cd[4]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_41720eed(?) {
    ...
    while idx < ('cd', 36).length:
        ...
        mem[ceil32(32 * ('cd', 36).length) + 97] = mem[(32 * idx) + 140 len 20]
        mem[ceil32(32 * ('cd', 36).length) + 129] = 1
        emit 0xd1b1dee5: mem[ceil32(32 * ('cd', 36).length) + 97], 1, cd[4]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_83c02a87(?) {
    ...
    while idx < ('cd', 36).length:
        ...
        mem[0] = mem[(32 * idx) + 140 len 20]
        mem[32] = sha3(cd[4], 128)
        stor128[cd[4]][address(mem[(32 * idx) + 128])] = 0
        mem[ceil32(32 * ('cd', 36).length) + 97] = mem[(32 * idx) + 140 len 20]
        mem[ceil32(32 * ('cd', 36).length) + 129] = 0
        emit 0xd1b1dee5: mem[ceil32(32 * ('cd', 36).length) + 97], 0, cd[4]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_10c78552(?) payable {
    ...
    while idx < arg2:
        ...
        if not stor123[arg1]:
            ...
            call nftAddress.safeMint(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
