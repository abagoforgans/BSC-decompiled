...
function isClaimed(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    return (stor3[Mask(248, 8, arg1)] and 1 << uint8(arg1) == 1 << uint8(arg1))
}
...
function claim(uint256 arg1, address arg2, uint256 arg3, bytes32[] arg4) payable {
    ...
    mem[0] = arg1 / 256
    mem[32] = 3
    if stor3[Mask(248, 8, arg1)] and 1 << uint8(arg1) == 1 << uint8(arg1):
    ...
    while uint16(idx) < arg4.length:
        ...
        if bool(s) == 1:
            ...
            idx = idx + 1
            s = s / 2
            t = sha3(mem[_46 + 32 len mem[_46]])
            continue 
        _39 = mem[(32 * uint16(idx)) + 244]
