        ...
        if arg1:
            ...
            if 0 / uint256(stor31.field_0) + uint256(stor26.field_0):
                ...
                if mem[_723] < ext_call.return_data[0]:
                    revert with 0, 17
                if totalDividends > !(mem[_723] - ext_call.return_data[0]):
                    revert with 0, 17
                totalDividends = totalDividends + mem[_723] - ext_call.return_data[0]
                if dividendsPerShareAccuracyFactor and mem[_723] - ext_call.return_data[0] > -1 / dividendsPerShareAccuracyFactor:
                    revert with 0, 17
                if not totalShares:
                    revert with 0, 18
                if dividendsPerShare > !((mem[_723] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares):
                    revert with 0, 17
                dividendsPerShare += (mem[_723] * dividendsPerShareAccuracyFactor) - (ext_call.return_data[0] * dividendsPerShareAccuracyFactor) / totalShares
                if 0 / uint256(stor31.field_0) + uint256(stor26.field_0):
                    call stor32 with:
                       value 0 / uint256(stor31.field_0) + uint256(stor26.field_0) wei
                         gas 30000 wei
