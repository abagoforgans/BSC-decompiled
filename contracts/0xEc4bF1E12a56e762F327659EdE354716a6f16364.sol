...
function airdrop(address[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[64] = mem[64] + 96
        mem[_91] = 38
        mem[_91 + 32 len 38] = 0x6542455032303a207472616e7366657220616d6f756e7420657863656564732062616c616e63
        mem[32] = 1
        if _88 > balanceOf[address(msg.sender)]:
            _95 = mem[64]
            ...
            idx = 0
            while idx < 38:
                mem[_95 + idx + 68] = mem[_91 + idx + 32]
                idx = idx + 32
                continue 
            mem[_95 + 100] = mem[_95 + 126 len 6]
            revert with memory
              from mem[64]
               len _95 + -mem[64] + 132
        balanceOf[address(msg.sender)] -= _88
        if balanceOf[address(_86)] + _88 < balanceOf[address(_86)]:
            revert with 0, 'SafeMath: addition overflow'
        mem[0] = address(_86)
        mem[32] = 1
        balanceOf[address(_86)] += _88
        mem[mem[64]] = _88
        emit Transfer(_88, msg.sender, address(_86));
        idx = idx + 1
        continue 
    return 1
}
