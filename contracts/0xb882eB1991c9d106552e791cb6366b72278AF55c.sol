...
function createCollectible(address arg1, string arg2) payable {
    require calldata.size - 4 >= 64
    ...
    if tokenOfOwnerByIndex[address(arg1)][1][stor10]:
        if stor3[stor10]:
            ...
            if not ext_code.size(arg1):
                ...
                mem[ceil32(arg2.length) + 452 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenCounter, 128, 0
                mem[ceil32(arg2.length) + 640 len 4] = 0
                mem[ceil32(arg2.length) + 612 len 0] = 0
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenCounter, 128, 0) << 1024, mem[ceil32(arg2.length) + 612 len 4]
            ...
            if not ext_code.size(arg1):
                ...
                if not ext_code.size(arg1):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(arg2.length) + 516 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenCounter, 128, 0
                mem[ceil32(arg2.length) + 704 len 4] = 0
                mem[ceil32(arg2.length) + 676 len 0] = 0
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenCounter, 128, 0) << 1024, mem[ceil32(arg2.length) + 676 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg2.length:
                            revert with arg2[all]
        ...
        tokenOfOwnerByIndex[address(arg1)]++
        tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = tokenCounter
        ...
        if stor3[stor10]:
            ...
            if not ext_code.size(arg1):
                ...
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args 0, mem[ceil32(arg2.length) + 612 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg2.length:
                            revert with arg2[all]
                    ...
                    if not stor3[stor10]:
                        revert with 0, 
                                    ...
                                    44,
                                    0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                                    mem[ceil32(arg2.length) + 432 len 20]
                else:
                    mem[ceil32(arg2.length) + 484 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
