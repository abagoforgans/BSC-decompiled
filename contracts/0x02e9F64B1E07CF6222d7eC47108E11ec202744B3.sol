...
function available() payable {
    if stakeTokenAddress != yieldTokenAddress:
        if totalRewarded > sub_53b2c5fd:
        ...
        if sub_53b2c5fd - totalRewarded > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow'
        return (ext_call.return_data[0] - sub_53b2c5fd + totalRewarded)
    require ext_code.size(yieldTokenAddress)
    staticcall yieldTokenAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if totalSupply > ext_call.return_data[0]:
        revert with 0, 'SafeMath: subtraction overflow'
    if sub_53b2c5fd - totalRewarded > ext_call.return_data[0] - totalSupply:
        revert with 0, 'SafeMath: subtraction overflow'
    return (ext_call.return_data[0] - totalSupply - sub_53b2c5fd + totalRewarded)
}

function sub_b4b31758(?) payable {
    if not stor14:
        return bool(stor14)
    if totalSupply <= 0:
    ...
    if stakeTokenAddress != yieldTokenAddress:
        ...
        if sub_53b2c5fd - totalRewarded > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow'
        return (ext_call.return_data[0] - sub_53b2c5fd + totalRewarded > 0)
    require ext_code.size(yieldTokenAddress)
    staticcall yieldTokenAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if sub_53b2c5fd - totalRewarded > ext_call.return_data[0] - totalSupply:
        revert with 0, 'SafeMath: subtraction overflow'
    return (ext_call.return_data[0] - totalSupply - sub_53b2c5fd + totalRewarded > 0)
}
...
function notifyRewardAmount() payable {
    if not totalSupply:
        ...
        if stakeTokenAddress != yieldTokenAddress:
            ...
            if sub_53b2c5fd - totalRewarded > ext_call.return_data[0]:
                revert with 0, 'SafeMath: subtraction overflow'
            if ext_call.return_data[0] - sub_53b2c5fd + totalRewarded <= 0:
                revert with 0, 'No rewards'
            if ext_call.return_data[0] - sub_53b2c5fd + totalRewarded < sub_22e7a466:
                if block.timestamp >= periodFinish:
                    rewardRate = ext_call.return_data[0] - sub_53b2c5fd + totalRewarded / 24 * 3600
                else:
                    if block.timestamp > periodFinish:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if not periodFinish - block.timestamp:
                        ...
                        if (periodFinish * rewardRate) - (block.timestamp * rewardRate) < 0:
                            revert with 0, 'SafeMath: addition overflow'
                        rewardRate = (periodFinish * rewardRate) - (block.timestamp * rewardRate) + ext_call.return_data[0] - sub_53b2c5fd + totalRewarded / 24 * 3600
                if ext_call.return_data[0] + totalRewarded < sub_53b2c5fd:
                    revert with 0, 'SafeMath: addition overflow'
                sub_53b2c5fd = ext_call.return_data[0] + totalRewarded
                lastUpdateTime = block.timestamp
                if block.timestamp + (24 * 3600) < block.timestamp:
                    revert with 0, 'SafeMath: addition overflow'
                periodFinish = block.timestamp + (24 * 3600)
                emit RewardAdded((ext_call.return_data[0] - sub_53b2c5fd + totalRewarded));
            else:
                if block.timestamp >= periodFinish:
                    ...
                    if not periodFinish - block.timestamp:
                        ...
                        if (periodFinish * rewardRate) - (block.timestamp * rewardRate) / periodFinish - block.timestamp != rewardRate:
                            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                        if (periodFinish * rewardRate) - (block.timestamp * rewardRate) + sub_22e7a466 < sub_22e7a466:
                            revert with 0, 'SafeMath: addition overflow'
                        rewardRate = (periodFinish * rewardRate) - (block.timestamp * rewardRate) + sub_22e7a466 / 24 * 3600
                if sub_22e7a466 + sub_53b2c5fd < sub_53b2c5fd:
                    revert with 0, 'SafeMath: addition overflow'
            ...
            if sub_53b2c5fd - totalRewarded > ext_call.return_data[0] - totalSupply:
                revert with 0, 'SafeMath: subtraction overflow'
            if ext_call.return_data[0] - totalSupply - sub_53b2c5fd + totalRewarded <= 0:
                revert with 0, 'No rewards'
            if ext_call.return_data[0] - totalSupply - sub_53b2c5fd + totalRewarded < sub_22e7a466:
                if block.timestamp >= periodFinish:
                    rewardRate = ext_call.return_data[0] - totalSupply - sub_53b2c5fd + totalRewarded / 24 * 3600
                else:
                    if block.timestamp > periodFinish:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if not periodFinish - block.timestamp:
                        ...
                        if (periodFinish * rewardRate) - (block.timestamp * rewardRate) < 0:
                            revert with 0, 'SafeMath: addition overflow'
                        rewardRate = (periodFinish * rewardRate) - (block.timestamp * rewardRate) + ext_call.return_data[0] - totalSupply - sub_53b2c5fd + totalRewarded / 24 * 3600
                if ext_call.return_data[0] - totalSupply + totalRewarded < sub_53b2c5fd:
                    revert with 0, 'SafeMath: addition overflow'
                sub_53b2c5fd = ext_call.return_data[0] - totalSupply + totalRewarded
                lastUpdateTime = block.timestamp
                if block.timestamp + (24 * 3600) < block.timestamp:
                    revert with 0, 'SafeMath: addition overflow'
                periodFinish = block.timestamp + (24 * 3600)
                emit RewardAdded((ext_call.return_data[0] - totalSupply - sub_53b2c5fd + totalRewarded));
            else:
                if block.timestamp >= periodFinish:
                    rewardRate = sub_22e7a466 / 24 * 3600
                else:
