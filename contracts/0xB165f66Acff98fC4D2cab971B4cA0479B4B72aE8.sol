...
#
#  - sub_07f5d633(?)
#  - getUserLevelState(address arg1)
#  - _fallback()
#
...
function register() {
    if block.timestamp <= startTime:
        ...
        mem[(8 * ceil32(return_data.size)) + 320] = mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 96 len 4], 0 + mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 96 len 4], 0 + 96] + 96]
        ...
        if ceil32(_69) <= _69:
            ...
            _157 = mem[64]
            mem[mem[64]] = 96
            _167 = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 96] = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 128 len ceil32(_167)] = mem[(8 * ceil32(return_data.size)) + 352 len ceil32(_167)]
            if ceil32(_167) > _167:
                mem[_167 + _157 + 128] = 0
            ...
            emit Registered(address arg1, string arg2, uint256 arg3, bool arg4):
                            mem[mem[64] len ceil32(_167) + _157 + -mem[64] + 128],
                            msg.sender,
        else:
            ...
            _160 = mem[64]
            mem[mem[64]] = 96
            _168 = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 96] = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 128 len ceil32(_168)] = mem[(8 * ceil32(return_data.size)) + 352 len ceil32(_168)]
            if ceil32(_168) > _168:
                mem[_168 + _160 + 128] = 0
            mem[_160 + 32] = uint8(_159)
            mem[_160 + 64] = bool(uint8(stor27.field_176))
            emit Registered(address arg1, string arg2, uint256 arg3, bool arg4):
                            mem[mem[64] len ceil32(_168) + _160 + -mem[64] + 128],
                            msg.sender,
    else:
        if startTime > !duration:
            revert with 0, 17
        ...
        if ceil32(_73) <= _73:
            ...
            _163 = mem[64]
            mem[mem[64]] = 96
            _169 = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 96] = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 128 len ceil32(_169)] = mem[(8 * ceil32(return_data.size)) + 352 len ceil32(_169)]
            if ceil32(_169) > _169:
                mem[_169 + _163 + 128] = 0
            mem[_163 + 32] = uint8(_162)
            mem[_163 + 64] = bool(uint8(stor27.field_176))
            emit Registered(address arg1, string arg2, uint256 arg3, bool arg4):
                            mem[mem[64] len ceil32(_169) + _163 + -mem[64] + 128],
                            msg.sender,
        else:
            ...
            _166 = mem[64]
            mem[mem[64]] = 96
            _170 = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 96] = mem[(8 * ceil32(return_data.size)) + 320]
            mem[mem[64] + 128 len ceil32(_170)] = mem[(8 * ceil32(return_data.size)) + 352 len ceil32(_170)]
            if ceil32(_170) > _170:
                mem[_170 + _166 + 128] = 0
            mem[_166 + 32] = uint8(_165)
            mem[_166 + 64] = bool(uint8(stor27.field_176))
            emit Registered(address arg1, string arg2, uint256 arg3, bool arg4):
                            mem[mem[64] len ceil32(_170) + _166 + -mem[64] + 128],
                            msg.sender,
}
