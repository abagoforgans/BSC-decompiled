...
function balanceOfBatch(address[] arg1, uint256[] arg2) {
    ...
    if arg1.length:
        mem[128 len 32 * arg1.length] = code.data[8967 len 32 * arg1.length]
    idx = 0
...
function getFeeBps(uint256 arg1) {
    ...
    mem[_28 + 32 len 32 * _27] = code.data[8967 len 32 * _27]
    _52 = mem[96]
    idx = 0
    while idx < _52:
        require idx < mem[96]
...
function uri(uint256 arg1) {
    ...
    if tokenURIPrefix.length + stor4[arg1].length:
        mem[ceil32(stor4[arg1].length) + ceil32(tokenURIPrefix.length) + 192 len 32 * tokenURIPrefix.length + stor4[arg1].length] = code.data[8967 len 32 * tokenURIPrefix.length + stor4[arg1].length]
    idx = 0
    s = 0
