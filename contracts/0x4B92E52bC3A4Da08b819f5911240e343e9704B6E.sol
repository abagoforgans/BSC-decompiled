...
const pairCodeHash = sha3(code.data[2026 len 9338])

const INIT_CODE_PAIR_HASH = sha3(code.data[2026 len 9312], mem[18816 len 6], Mask(160, 48, code.data[11344 len 20]) >> 48)
...
function setFeeTo(address arg1) payable {
    ...
    if feeToSetterAddress != msg.sender:
        revert with 0, 'NFTSwapV2: FORBIDDEN'
    feeToAddress = arg1
}
...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'NFTSwapV2: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'NFTSwapV2: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'NFTSwapV2: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[2026 len 9338]
