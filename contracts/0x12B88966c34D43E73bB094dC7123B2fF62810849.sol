...
function setCore(address arg1) payable {
    require calldata.size - 4 >= 32
    if coreAddress != msg.sender:
        revert with 0, 'Not Authorized'
    if not arg1:
        revert with 0, 'new core the zero address'
    emit SET_CORE(coreAddress, arg1);
    coreAddress = arg1
}
...
function initialize(string arg1, string arg2, uint8 arg3, uint256 arg4, address arg5) payable {
    ...
    if uint8(stor5.field_8):
        revert with 0, 'ERR_TOKEN_HAS_INITIALIZED'
    ...
    if totalSupply + arg4 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += arg4
    if balanceOf[address(arg5)] + arg4 < balanceOf[address(arg5)]:
        revert with 0, 'SafeMath: addition overflow'
