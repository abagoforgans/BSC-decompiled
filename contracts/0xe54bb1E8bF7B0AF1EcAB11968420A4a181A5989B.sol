...
const INITIAL_DISTRIBUTION = 1700 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    stor6 = 1
    if totalSupply + 1700 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 1700 * 10^18
    if balanceOf[address(arg1)] + 1700 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 1700 * 10^18
    emit Transfer(1700 * 10^18, 0, arg1);
}
