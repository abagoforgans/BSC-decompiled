...
#  - _fallback()
#
const name = 32, 48, 0xfe43525950544f49534d59445255474d59504349534d594445414c4552414e444a45455453415245544845504f4c4943, mem[176 len 16] >> 128, 0

const SellLimitDivider = 600

const InitialSupply = 6 * 10^16

const BalanceLimitDivider = 100

const decimals = 9

const MaxSellLockTime = 20

const MaxBuyLockTime = 20
...
function getBurnedTokens() {
    if 6 * 10^16 < totalSupply:
        revert with 0, 17
    return (-totalSupply + 6 * 10^16 / 10^9)
}
...
function TeamWithdrawALLMarketingBNB() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    marketingBalance = 0
    if marketingBalance > 0x51eb851eb851eb851eb851eb851eb851eb851eb851eb851eb851eb851eb851e:
        revert with 0, 17
    call teamWalletAddress with:
       value 50 * marketingBalance / 100 wei
...
function TeamCreateLPandBNB() {
    ...
    if balanceOf[this.address] >= 10^14:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            if uint8(stor19.field_32) > 0x2d09370d42573603d4e1213067bce3251b64271d3f31ccfa00fe0:
                revert with 0, 17
            if not uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 18
            if 10^14 < 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 17
            if 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) < 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2:
                revert with 0, 17
            if (10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > !(-(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) + 10^14):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not stor20:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor20].field_0 = -(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14
            emit Approval((-(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14), this.address, stor20);
            ...
            mem[ceil32(return_data.size) + 196] = -(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14
            idx = 0
            s = 128
            ...
            call stor20.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args -(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14:
                revert with 0, 18
            if totalLPBNB > !(0 / -(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14):
                revert with 0, 17
            totalLPBNB += 0 / -(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14
            if not this.address:
                revert with 0, 'Approve from zero'
            if not stor20:
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][stor20].field_0 = 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][stor20].field_255 = 0
            emit Approval((10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, stor20);
            require ext_code.size(stor20)
            call stor20.addLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / -(10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 10^14 wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
