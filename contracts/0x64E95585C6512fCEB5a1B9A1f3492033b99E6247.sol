...
function sub_d6a5b9fe(?) payable {
    return sub_d6a5b9feAddress
}
...
function sub_f71af22b(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    _liquidityAddress = arg1
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if stor3[address(msg.sender)]:
        ...
        emit Transfer(0, msg.sender, sub_d6a5b9feAddress);
    else:
            ...
            if arg1 == this.address:
                ...
                if not arg2:
                    ...
                    if arg1 != msg.sender:
                        if balanceOf[address(msg.sender)] < arg2:
                            revert with 0, 32, 39, 0x734945524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, mem[267 len 25]
                        balanceOf[stor8] += arg2 * stor9 / 100
                        balanceOf[address(msg.sender)] -= arg2
                    else:
                        if stor3[address(msg.sender)]:
                            balanceOf[stor8] += arg2 * stor9 / 100
                            ...
                            balanceOf[stor8] += arg2 * stor9 / 100
                            balanceOf[address(msg.sender)] -= arg2
                    balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (arg2 * stor9 / 100)
                    emit Transfer((arg2 - (arg2 * stor9 / 100)), msg.sender, arg1);
                    emit Transfer((arg2 * stor9 / 100), msg.sender, sub_d6a5b9feAddress);
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if stor3[address(arg1)]:
        ...
        emit Transfer(0, arg1, sub_d6a5b9feAddress);
            ...
            if arg2 == this.address:
                ...
                if not arg3:
                    ...
                    if arg1 != arg2:
                        if balanceOf[address(arg1)] < arg3:
                            revert with 0, 32, 39, 0x734945524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, mem[267 len 25]
                        balanceOf[stor8] += arg3 * stor9 / 100
                        balanceOf[address(arg1)] -= arg3
                    else:
                        if stor3[address(msg.sender)]:
                            balanceOf[stor8] += arg3 * stor9 / 100
                            ...
                            balanceOf[stor8] += arg3 * stor9 / 100
                            balanceOf[address(arg1)] -= arg3
                    balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (arg3 * stor9 / 100)
                    emit Transfer((arg3 - (arg3 * stor9 / 100)), arg1, arg2);
                    emit Transfer((arg3 * stor9 / 100), arg1, sub_d6a5b9feAddress);
                if allowance[address(arg1)][address(msg.sender)] < arg3:
