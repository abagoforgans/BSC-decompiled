...
function sub_529d8719(?) payable {
    ...
    require return_data.size >= 32
    _36 = mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1) >> 32
    ...
    _37 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1) >> 32 + 96]
    ...
    mem[(2 * ceil32(return_data.size)) + 96] = _37
    require _36 + (32 * _37) + 32 <= return_data.size
    idx = 0
    s = ceil32(return_data.size) + _36 + 128
    ...
    if 1 >= _37:
        revert with 'NH{q', 50
    _63 = mem[(2 * ceil32(return_data.size)) + 160]
    ...
    mem[mem[64] + 4] = 9975 * 9975 * _63 / 10000 / 10000 * ext_call.return_data[0] / 10^18
    mem[mem[64] + 36] = 64
    ...
    staticcall 0x10ed43c718714eb63d5aa57b78b54704e256024e.mem[mem[64] len 4] with:
            gas gas_remaining wei
           args mem[mem[64] + 4 len _64 + (32 * stor3.length) + -mem[64] + 96]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _88 = mem[64]
    ...
    _90 = mem[_88 + mem[_88]]
    if mem[_88 + mem[_88]] > test266151307():
        revert with 'NH{q', 65
    if _88 + ceil32(return_data.size) + floor32(mem[_88 + mem[_88]]) + 1 > test266151307() or floor32(mem[_88 + mem[_88]]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = _88 + ceil32(return_data.size) + floor32(mem[_88 + mem[_88]]) + 1
    mem[_88 + ceil32(return_data.size)] = _90
    require _89 + (32 * _90) + 32 <= return_data.size
    idx = 0
    s = _88 + _89 + 32
    t = _88 + ceil32(return_data.size) + 32
    while idx < _90:
        require mem[s] == mem[s]
        mem[t] = mem[s]
        idx = idx + 1
    ...
    if 1 >= _90:
        revert with 'NH{q', 50
    _115 = mem[_88 + ceil32(return_data.size) + 64]
