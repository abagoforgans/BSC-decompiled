    ...
    if not _212:
        ...
        while idx < _212:
            ...
            while s < _329:
                ...
                continue 
            if ceil32(_329) <= _329:
                mem[mem[64] + 36] = ceil32(_329) + 96
                _414 = mem[_317]
                mem[ceil32(_329) + mem[64] + 100] = mem[_317]
                s = 0
                while s < _414:
                    mem[s + ceil32(_329) + mem[64] + 132] = mem[_317 + s + 32]
                    s = s + 32
                    continue 
                if ceil32(_414) <= _414:
                    require ext_code.size(refAddress)
                ...
                if ceil32(_415) <= _415:
                    ...
                    staticcall refAddress.0x65555bcc with:
                            gas gas_remaining wei
                           args 64, ceil32(_329) + 96, mem[mem[64] + 68 len _329 + 32], 0, mem[mem[64] + _329 + 132 len ceil32(_415) + ceil32(_329) - _329]
                    mem[mem[64] len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _507 = mem[64]
                    ...
                    mem[ceil32(_329) + mem[64] + _415 + 132] = 0
                    require ext_code.size(refAddress)
                    staticcall refAddress.0x65555bcc with:
                            gas gas_remaining wei
                           args 64, ceil32(_329) + 96, mem[mem[64] + 68 len _329 + 32], 0, mem[mem[64] + _329 + 132 len ceil32(_415) + ceil32(_329) - _329]
