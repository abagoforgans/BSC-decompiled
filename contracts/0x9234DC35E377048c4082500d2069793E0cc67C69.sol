...
function migrate(uint256 arg1) payable {
    ...
    if not ext_code.hash(poolInfo[arg1].field_0):
        revert with 0, 'SafeERC20: call to non-contract'
    mem[196 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
    call poolInfo[arg1].field_0 with:
       funct uint32(stor6)
         gas gas_remaining wei
...
function set(uint256 arg1, uint256 arg2, bool arg3) payable {
    ...
    if poolManagerAddress != msg.sender:
        revert with 0, 'set: only pool manager allowed'
    if arg3:
        idx = 0
        while idx < poolInfo.length:
            mem[0] = 7
...
function add(uint256 arg1, address arg2, uint256 arg3, bool arg4) payable {
    ...
    if poolManagerAddress != msg.sender:
        revert with 0, 'add: only pool manager allowed'
    if arg4:
        idx = 0
        while idx < poolInfo.length:
            mem[0] = 7
