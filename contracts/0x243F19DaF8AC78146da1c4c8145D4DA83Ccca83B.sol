...
function balanceOf(address arg1) {
    ...
    if ext_call.return_data[96] <= 0:
        revert with 0, 'Round not complete'
    if eth.balance(this.address) / 18 and ext_call.return_data[32] / 18 > -1 / eth.balance(this.address) / 18:
        revert with 0, 17
    if eth.balance(this.address) / 18 * ext_call.return_data[32] / 18 > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    return (10^18 * eth.balance(this.address) / 18 * ext_call.return_data[32] / 18)
}
